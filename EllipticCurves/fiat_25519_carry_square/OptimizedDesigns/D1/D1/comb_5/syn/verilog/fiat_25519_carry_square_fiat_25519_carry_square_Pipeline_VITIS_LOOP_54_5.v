...
output  [63:0] add10611_out;
output   add10611_out_ap_vld;

reg ap_idle;
reg add10611_out_ap_vld;
...
wire   [31:0] tmp_8_fu_167_p7;
wire   [3:0] tmp_9_fu_184_p10;
wire   [30:0] tmp_9_fu_184_p11;
wire   [31:0] shl_ln_fu_204_p3;
...
always @ (*) begin
    if (((icmp_ln54_fu_148_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add10611_out_ap_vld = 1'b1;
    end else begin
        add10611_out_ap_vld = 1'b0;
    end
end
...
assign add10611_out = add10611_fu_62;

assign add_ln54_fu_223_p2 = (i_fu_66 + 3'd1);

assign add_ln60_fu_217_p2 = (mul_ln60_fu_131_p2 + add10611_fu_62);
...
assign mul_ln60_fu_131_p00 = shl_ln_fu_204_p3;

assign mul_ln60_fu_131_p1 = mul_ln60_fu_131_p10;

assign mul_ln60_fu_131_p10 = tmp_8_fu_167_p7;

assign shl_ln_fu_204_p3 = {{tmp_9_fu_184_p11}, {1'd0}};

assign tmp_9_fu_184_p10 = ($signed(4'd9) - $signed(zext_ln54_fu_157_p1));
