...
using hls::sim::Byte;
extern "C" void fiat_25519_carry_square(Byte<4>*, int, int);
extern "C" void apatb_fiat_25519_carry_square_hw(volatile void * __xlx_apatb_param_out1, volatile void * __xlx_apatb_param_arg1) {
using hls::sim::createStream;
  // Collect __xlx_out1_arg1__tmp_vec
std::vector<Byte<4>> __xlx_out1_arg1__tmp_vec;
for (size_t i = 0; i < 10; ++i){
__xlx_out1_arg1__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_out1)[i]);
}
  int __xlx_size_param_out1 = 10;
  int __xlx_offset_param_out1 = 0;
  int __xlx_offset_byte_param_out1 = 0*4;
for (size_t i = 0; i < 10; ++i){
__xlx_out1_arg1__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_arg1)[i]);
}
  int __xlx_size_param_arg1 = 10;
  int __xlx_offset_param_arg1 = 10;
  int __xlx_offset_byte_param_arg1 = 10*4;
  // DUT call
  fiat_25519_carry_square(__xlx_out1_arg1__tmp_vec.data(), __xlx_offset_byte_param_out1, __xlx_offset_byte_param_arg1);
// print __xlx_apatb_param_out1
for (size_t i = 0; i < __xlx_size_param_out1; ++i) {
((Byte<4>*)__xlx_apatb_param_out1)[i] = __xlx_out1_arg1__tmp_vec[__xlx_offset_param_out1+i];
}
// print __xlx_apatb_param_arg1
for (size_t i = 0; i < __xlx_size_param_arg1; ++i) {
((Byte<4>*)__xlx_apatb_param_arg1)[i] = __xlx_out1_arg1__tmp_vec[__xlx_offset_param_arg1+i];
}
}
