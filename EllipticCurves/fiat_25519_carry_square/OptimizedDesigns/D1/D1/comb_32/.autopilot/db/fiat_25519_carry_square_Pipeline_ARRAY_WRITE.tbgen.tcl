set moduleName fiat_25519_carry_square_Pipeline_ARRAY_WRITE
set isTopModule 0
...
set C_modelName {fiat_25519_carry_square_Pipeline_ARRAY_WRITE}
set C_modelType { void 0 }
set C_modelArgList {
	{ mem int 32 regular {axi_master 1}  }
	{ sext_ln115 int 62 regular  }
	{ zext_ln103 int 26 regular  }
	{ zext_ln104 int 25 regular  }
	{ out1_w_2 int 27 regular  }
	{ zext_ln106 int 25 regular  }
	{ zext_ln107 int 26 regular  }
	{ zext_ln108 int 25 regular  }
	{ zext_ln109 int 26 regular  }
	{ zext_ln110 int 25 regular  }
	{ zext_ln111 int 26 regular  }
	{ zext_ln13 int 25 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln115", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln103", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln104", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "out1_w_2", "interface" : "wire", "bitwidth" : 27, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln106", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln107", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln108", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln109", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln110", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln111", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln13", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln115 sc_in sc_lv 62 signal 1 } 
	{ zext_ln103 sc_in sc_lv 26 signal 2 } 
	{ zext_ln104 sc_in sc_lv 25 signal 3 } 
	{ out1_w_2 sc_in sc_lv 27 signal 4 } 
	{ zext_ln106 sc_in sc_lv 25 signal 5 } 
	{ zext_ln107 sc_in sc_lv 26 signal 6 } 
	{ zext_ln108 sc_in sc_lv 25 signal 7 } 
	{ zext_ln109 sc_in sc_lv 26 signal 8 } 
	{ zext_ln110 sc_in sc_lv 25 signal 9 } 
	{ zext_ln111 sc_in sc_lv 26 signal 10 } 
	{ zext_ln13 sc_in sc_lv 25 signal 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln115", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln115", "role": "default" }} , 
 	{ "name": "zext_ln103", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln103", "role": "default" }} , 
 	{ "name": "zext_ln104", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln104", "role": "default" }} , 
 	{ "name": "out1_w_2", "direction": "in", "datatype": "sc_lv", "bitwidth":27, "type": "signal", "bundle":{"name": "out1_w_2", "role": "default" }} , 
 	{ "name": "zext_ln106", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln106", "role": "default" }} , 
 	{ "name": "zext_ln107", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln107", "role": "default" }} , 
 	{ "name": "zext_ln108", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln108", "role": "default" }} , 
 	{ "name": "zext_ln109", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln109", "role": "default" }} , 
 	{ "name": "zext_ln110", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln110", "role": "default" }} , 
 	{ "name": "zext_ln111", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln111", "role": "default" }} , 
 	{ "name": "zext_ln13", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln13", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_10_4_27_1_1_U116", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln115 { ap_none {  { sext_ln115 in_data 0 62 } } }
	zext_ln103 { ap_none {  { zext_ln103 in_data 0 26 } } }
	zext_ln104 { ap_none {  { zext_ln104 in_data 0 25 } } }
	out1_w_2 { ap_none {  { out1_w_2 in_data 0 27 } } }
	zext_ln106 { ap_none {  { zext_ln106 in_data 0 25 } } }
	zext_ln107 { ap_none {  { zext_ln107 in_data 0 26 } } }
	zext_ln108 { ap_none {  { zext_ln108 in_data 0 25 } } }
	zext_ln109 { ap_none {  { zext_ln109 in_data 0 26 } } }
	zext_ln110 { ap_none {  { zext_ln110 in_data 0 25 } } }
	zext_ln111 { ap_none {  { zext_ln111 in_data 0 26 } } }
	zext_ln13 { ap_none {  { zext_ln13 in_data 0 25 } } }
}
