...
attribute shreg_extract : string;
    ...
    signal tmp_7_fu_222_p12 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_7_reg_272 : STD_LOGIC_VECTOR (26 downto 0);
    ...
    signal tmp_7_fu_222_p1 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_7_fu_222_p2 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_7_fu_222_p4 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_7_fu_222_p5 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_7_fu_222_p6 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_7_fu_222_p7 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_7_fu_222_p8 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_7_fu_222_p9 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_7_fu_222_p10 : STD_LOGIC_VECTOR (26 downto 0);
...
begin
    mux_10_4_27_1_1_U105 : component fiat_25519_carry_square_mux_10_4_27_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 27,
        ...
        dout_WIDTH => 27)
    port map (
        din0 => tmp_7_fu_222_p1,
        din1 => tmp_7_fu_222_p2,
        din2 => out1_w_2,
        din3 => tmp_7_fu_222_p4,
        din4 => tmp_7_fu_222_p5,
        din5 => tmp_7_fu_222_p6,
        din6 => tmp_7_fu_222_p7,
        din7 => tmp_7_fu_222_p8,
        din8 => tmp_7_fu_222_p9,
        din9 => tmp_7_fu_222_p10,
        din10 => ap_sig_allocacmp_i_3,
        dout => tmp_7_fu_222_p12);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln115_fu_210_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_7_reg_272 <= tmp_7_fu_222_p12;
            end if;
        end if;
    end process;
    ...
    add_ln115_fu_216_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_3) + unsigned(ap_const_lv4_1));
    ...
    icmp_ln115_fu_210_p2 <= "1" when (ap_sig_allocacmp_i_3 = ap_const_lv4_A) else "0";
    ...
    m_axi_mem_WDATA <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_7_reg_272),32));
    ...
    tmp_7_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln103),27));
    tmp_7_fu_222_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln13),27));
    tmp_7_fu_222_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln104),27));
    tmp_7_fu_222_p4 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln106),27));
    tmp_7_fu_222_p5 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln107),27));
    tmp_7_fu_222_p6 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln108),27));
    tmp_7_fu_222_p7 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln109),27));
    tmp_7_fu_222_p8 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln110),27));
    tmp_7_fu_222_p9 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln111),27));
end behav;
