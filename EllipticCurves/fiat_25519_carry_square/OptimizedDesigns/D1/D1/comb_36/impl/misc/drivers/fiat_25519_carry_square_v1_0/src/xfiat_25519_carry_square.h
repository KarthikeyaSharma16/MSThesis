...
// 
// ==============================================================
#ifndef XFIAT_25519_CARRY_SQUARE_H
#define XFIAT_25519_CARRY_SQUARE_H
...
#include <stddef.h>
#endif
#include "xfiat_25519_carry_square_hw.h"
...
} XFiat_25519_carry_square_Config;
#endif

typedef struct {
    u64 Control_BaseAddress;
    u32 IsReady;
} XFiat_25519_carry_square;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XFiat_25519_carry_square_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XFiat_25519_carry_square_ReadReg(BaseAddress, RegOffset) \
