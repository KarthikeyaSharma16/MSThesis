...
begin
    mux_10_4_27_1_1_U82 : component fiat_25519_carry_square_mux_10_4_27_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 27,
    ...
    tmp_8_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln103),27));
    tmp_8_fu_222_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln13),27));
    tmp_8_fu_222_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln104),27));
    ...
    tmp_8_fu_222_p7 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln109),27));
