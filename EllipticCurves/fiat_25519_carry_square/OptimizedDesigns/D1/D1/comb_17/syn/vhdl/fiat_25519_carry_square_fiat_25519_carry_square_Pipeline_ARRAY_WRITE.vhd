...
begin
    mux_10_4_27_1_1_U42 : component fiat_25519_carry_square_mux_10_4_27_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 27,
    ...
    tmp_5_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln103),27));
    tmp_5_fu_222_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln13),27));
    tmp_5_fu_222_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln104),27));
    tmp_5_fu_222_p4 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln106),27));
    tmp_5_fu_222_p5 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln107),27));
    tmp_5_fu_222_p6 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln108),27));
    tmp_5_fu_222_p7 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln109),27));
    tmp_5_fu_222_p8 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln110),27));
    tmp_5_fu_222_p9 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln111),27));
end behav;
