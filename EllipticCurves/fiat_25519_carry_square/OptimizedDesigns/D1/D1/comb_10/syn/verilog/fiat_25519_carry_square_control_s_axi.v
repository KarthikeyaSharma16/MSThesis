...
// ==============================================================
`timescale 1ns/1ps
module fiat_25519_carry_square_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER         = 6'h08,
    ADDR_ISR         = 6'h0c,
    ADDR_OUT1_DATA_0 = 6'h10,
    ADDR_OUT1_DATA_1 = 6'h14,
    ADDR_OUT1_CTRL   = 6'h18,
    ADDR_ARG1_DATA_0 = 6'h1c,
    ADDR_ARG1_DATA_1 = 6'h20,
    ADDR_ARG1_CTRL   = 6'h24,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
