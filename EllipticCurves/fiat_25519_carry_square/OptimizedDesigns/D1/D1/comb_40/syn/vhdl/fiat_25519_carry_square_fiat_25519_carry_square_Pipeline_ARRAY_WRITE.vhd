...
begin
    ...
    tmp_s_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln103_1),27));
    tmp_s_fu_222_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln13),27));
    tmp_s_fu_222_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln104_1),27));
    ...
    tmp_s_fu_222_p7 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln14),27));
