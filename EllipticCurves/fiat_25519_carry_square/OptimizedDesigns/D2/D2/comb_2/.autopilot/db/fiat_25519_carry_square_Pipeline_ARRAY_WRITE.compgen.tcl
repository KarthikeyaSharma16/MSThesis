...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln90 \
    op interface \
    ports { zext_ln90 { I 25 vector } } \
} "
}
