...
set C_modelArgList {
	...
	{ sext_ln97 int 62 regular  }
	{ zext_ln85 int 26 regular  }
	{ zext_ln86 int 25 regular  }
	{ out1_w_2 int 27 regular  }
	{ zext_ln88 int 25 regular  }
	{ zext_ln89 int 26 regular  }
	{ zext_ln90 int 25 regular  }
	{ zext_ln91 int 26 regular  }
	{ zext_ln92 int 25 regular  }
	{ zext_ln93 int 26 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln97", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln85", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln86", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "out1_w_2", "interface" : "wire", "bitwidth" : 27, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln88", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln89", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln90", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln91", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln92", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln93", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln97 sc_in sc_lv 62 signal 1 } 
	{ zext_ln85 sc_in sc_lv 26 signal 2 } 
	{ zext_ln86 sc_in sc_lv 25 signal 3 } 
	{ out1_w_2 sc_in sc_lv 27 signal 4 } 
	{ zext_ln88 sc_in sc_lv 25 signal 5 } 
	{ zext_ln89 sc_in sc_lv 26 signal 6 } 
	{ zext_ln90 sc_in sc_lv 25 signal 7 } 
	{ zext_ln91 sc_in sc_lv 26 signal 8 } 
	{ zext_ln92 sc_in sc_lv 25 signal 9 } 
	{ zext_ln93 sc_in sc_lv 26 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln97", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln97", "role": "default" }} , 
 	{ "name": "zext_ln85", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln85", "role": "default" }} , 
 	{ "name": "zext_ln86", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln86", "role": "default" }} , 
 	{ "name": "out1_w_2", "direction": "in", "datatype": "sc_lv", "bitwidth":27, "type": "signal", "bundle":{"name": "out1_w_2", "role": "default" }} , 
 	{ "name": "zext_ln88", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln88", "role": "default" }} , 
 	{ "name": "zext_ln89", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln89", "role": "default" }} , 
 	{ "name": "zext_ln90", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln90", "role": "default" }} , 
 	{ "name": "zext_ln91", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln91", "role": "default" }} , 
 	{ "name": "zext_ln92", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln92", "role": "default" }} , 
 	{ "name": "zext_ln93", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln93", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_10_4_27_1_1_U113", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln97 { ap_none {  { sext_ln97 in_data 0 62 } } }
	zext_ln85 { ap_none {  { zext_ln85 in_data 0 26 } } }
	zext_ln86 { ap_none {  { zext_ln86 in_data 0 25 } } }
	out1_w_2 { ap_none {  { out1_w_2 in_data 0 27 } } }
	zext_ln88 { ap_none {  { zext_ln88 in_data 0 25 } } }
	zext_ln89 { ap_none {  { zext_ln89 in_data 0 26 } } }
	zext_ln90 { ap_none {  { zext_ln90 in_data 0 25 } } }
	zext_ln91 { ap_none {  { zext_ln91 in_data 0 26 } } }
	zext_ln92 { ap_none {  { zext_ln92 in_data 0 25 } } }
	zext_ln93 { ap_none {  { zext_ln93 in_data 0 26 } } }
