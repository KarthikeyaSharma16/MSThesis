...
module fiat_25519_carry_square_fiat_25519_carry_square_Pipeline_ARRAY_1_READ (
        ...
        sext_ln17,
        arg1_r_2_2_0220_out,
        arg1_r_2_2_0220_out_ap_vld,
        arg1_r_2_1_0219_out,
        arg1_r_2_1_0219_out_ap_vld,
        arg1_r_2_0_0218_out,
        arg1_r_2_0_0218_out_ap_vld,
        arg1_r_1_2_0217_out,
        arg1_r_1_2_0217_out_ap_vld,
        arg1_r_1_1_0216_out,
        arg1_r_1_1_0216_out_ap_vld,
        arg1_r_1_0_0215_out,
        arg1_r_1_0_0215_out_ap_vld,
        arg1_r_3_0214_out,
        arg1_r_3_0214_out_ap_vld,
        arg1_r_226_0213_out,
        arg1_r_226_0213_out_ap_vld,
        arg1_r_125_0212_out,
        arg1_r_125_0212_out_ap_vld,
        arg1_r_0_0211_out,
        arg1_r_0_0211_out_ap_vld
);
...
output  [31:0] arg1_r_2_2_0220_out;
output   arg1_r_2_2_0220_out_ap_vld;
output  [31:0] arg1_r_2_1_0219_out;
output   arg1_r_2_1_0219_out_ap_vld;
output  [31:0] arg1_r_2_0_0218_out;
output   arg1_r_2_0_0218_out_ap_vld;
output  [31:0] arg1_r_1_2_0217_out;
output   arg1_r_1_2_0217_out_ap_vld;
output  [31:0] arg1_r_1_1_0216_out;
output   arg1_r_1_1_0216_out_ap_vld;
output  [31:0] arg1_r_1_0_0215_out;
output   arg1_r_1_0_0215_out_ap_vld;
output  [31:0] arg1_r_3_0214_out;
output   arg1_r_3_0214_out_ap_vld;
output  [31:0] arg1_r_226_0213_out;
output   arg1_r_226_0213_out_ap_vld;
output  [31:0] arg1_r_125_0212_out;
output   arg1_r_125_0212_out_ap_vld;
output  [31:0] arg1_r_0_0211_out;
output   arg1_r_0_0211_out_ap_vld;

reg ap_idle;
reg m_axi_mem_RREADY;
reg arg1_r_2_2_0220_out_ap_vld;
reg arg1_r_2_1_0219_out_ap_vld;
reg arg1_r_2_0_0218_out_ap_vld;
reg arg1_r_1_2_0217_out_ap_vld;
reg arg1_r_1_1_0216_out_ap_vld;
reg arg1_r_1_0_0215_out_ap_vld;
reg arg1_r_3_0214_out_ap_vld;
reg arg1_r_226_0213_out_ap_vld;
reg arg1_r_125_0212_out_ap_vld;
reg arg1_r_0_0211_out_ap_vld;
...
reg   [3:0] phi_urem17_fu_88;
wire   [3:0] select_ln17_fu_299_p3;
wire    ap_loop_init;
reg   [3:0] ap_sig_allocacmp_phi_urem17_load;
reg   [7:0] phi_mul15_fu_92;
wire   [7:0] add_ln17_1_fu_267_p2;
reg   [7:0] ap_sig_allocacmp_phi_mul15_load;
reg   [3:0] i_fu_96;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln17_fu_252_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln1_reg_505 <= {{ap_sig_allocacmp_phi_mul15_load[7:6]}};
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_phi_mul15_load = 8'd0;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_phi_urem17_load = 4'd0;
    end else begin
...
always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_0_0211_out_ap_vld = 1'b1;
    end else begin
        arg1_r_0_0211_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_125_0212_out_ap_vld = 1'b1;
    end else begin
        arg1_r_125_0212_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_1_0_0215_out_ap_vld = 1'b1;
    end else begin
        arg1_r_1_0_0215_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_1_1_0216_out_ap_vld = 1'b1;
    end else begin
        arg1_r_1_1_0216_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_1_2_0217_out_ap_vld = 1'b1;
    end else begin
        arg1_r_1_2_0217_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_226_0213_out_ap_vld = 1'b1;
    end else begin
        arg1_r_226_0213_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_2_0_0218_out_ap_vld = 1'b1;
    end else begin
        arg1_r_2_0_0218_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_2_1_0219_out_ap_vld = 1'b1;
    end else begin
        arg1_r_2_1_0219_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_2_2_0220_out_ap_vld = 1'b1;
    end else begin
        arg1_r_2_2_0220_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_3_0214_out_ap_vld = 1'b1;
    end else begin
        arg1_r_3_0214_out_ap_vld = 1'b0;
    end
end
...
assign add_ln17_1_fu_267_p2 = (ap_sig_allocacmp_phi_mul15_load + 8'd22);

assign add_ln17_2_fu_287_p2 = (ap_sig_allocacmp_phi_urem17_load + 4'd1);

assign add_ln17_fu_258_p2 = (ap_sig_allocacmp_i_3 + 4'd1);
...
assign arg1_r_0_0211_out = arg1_r_0_1_fu_100;

assign arg1_r_125_0212_out = arg1_r_0_2_fu_104;

assign arg1_r_1_0_0215_out = arg1_r_0_5_fu_116;

assign arg1_r_1_1_0216_out = arg1_r_0_6_fu_120;

assign arg1_r_1_2_0217_out = arg1_r_0_7_fu_124;

assign arg1_r_226_0213_out = arg1_r_0_3_fu_108;

assign arg1_r_2_0_0218_out = arg1_r_0_8_fu_128;

assign arg1_r_2_1_0219_out = arg1_r_0_9_fu_132;

assign arg1_r_2_2_0220_out = arg1_r_0_10_fu_136;

assign arg1_r_3_0214_out = arg1_r_0_4_fu_112;

assign icmp_ln17_1_fu_293_p2 = ((add_ln17_2_fu_287_p2 < 4'd3) ? 1'b1 : 1'b0);

assign icmp_ln17_fu_252_p2 = ((ap_sig_allocacmp_i_3 == 4'd10) ? 1'b1 : 1'b0);
...
assign trunc_ln17_fu_273_p1 = ap_sig_allocacmp_phi_urem17_load[1:0];
