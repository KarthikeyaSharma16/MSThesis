...
module fiat_25519_carry_square_fiat_25519_carry_square_Pipeline_ARRAY_1_READ (
        ...
        sext_ln17,
        arg1_r_2_2_0252_out,
        arg1_r_2_2_0252_out_ap_vld,
        arg1_r_2_1_0251_out,
        arg1_r_2_1_0251_out_ap_vld,
        arg1_r_2_0_0250_out,
        arg1_r_2_0_0250_out_ap_vld,
        arg1_r_1_2_0249_out,
        arg1_r_1_2_0249_out_ap_vld,
        arg1_r_1_1_0248_out,
        arg1_r_1_1_0248_out_ap_vld,
        arg1_r_1_0_0247_out,
        arg1_r_1_0_0247_out_ap_vld,
        arg1_r_3_0246_out,
        arg1_r_3_0246_out_ap_vld,
        arg1_r_229_0245_out,
        arg1_r_229_0245_out_ap_vld,
        arg1_r_128_0244_out,
        arg1_r_128_0244_out_ap_vld,
        arg1_r_0_0243_out,
        arg1_r_0_0243_out_ap_vld
);
...
output  [31:0] arg1_r_2_2_0252_out;
output   arg1_r_2_2_0252_out_ap_vld;
output  [31:0] arg1_r_2_1_0251_out;
output   arg1_r_2_1_0251_out_ap_vld;
output  [31:0] arg1_r_2_0_0250_out;
output   arg1_r_2_0_0250_out_ap_vld;
output  [31:0] arg1_r_1_2_0249_out;
output   arg1_r_1_2_0249_out_ap_vld;
output  [31:0] arg1_r_1_1_0248_out;
output   arg1_r_1_1_0248_out_ap_vld;
output  [31:0] arg1_r_1_0_0247_out;
output   arg1_r_1_0_0247_out_ap_vld;
output  [31:0] arg1_r_3_0246_out;
output   arg1_r_3_0246_out_ap_vld;
output  [31:0] arg1_r_229_0245_out;
output   arg1_r_229_0245_out_ap_vld;
output  [31:0] arg1_r_128_0244_out;
output   arg1_r_128_0244_out_ap_vld;
output  [31:0] arg1_r_0_0243_out;
output   arg1_r_0_0243_out_ap_vld;

reg ap_idle;
reg m_axi_mem_RREADY;
reg arg1_r_2_2_0252_out_ap_vld;
reg arg1_r_2_1_0251_out_ap_vld;
reg arg1_r_2_0_0250_out_ap_vld;
reg arg1_r_1_2_0249_out_ap_vld;
reg arg1_r_1_1_0248_out_ap_vld;
reg arg1_r_1_0_0247_out_ap_vld;
reg arg1_r_3_0246_out_ap_vld;
reg arg1_r_229_0245_out_ap_vld;
reg arg1_r_128_0244_out_ap_vld;
reg arg1_r_0_0243_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln17_fu_252_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln1_reg_505 <= {{ap_sig_allocacmp_phi_mul21_load[7:6]}};
    end
end
...
always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_0_0243_out_ap_vld = 1'b1;
    end else begin
        arg1_r_0_0243_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_128_0244_out_ap_vld = 1'b1;
    end else begin
        arg1_r_128_0244_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_1_0_0247_out_ap_vld = 1'b1;
    end else begin
        arg1_r_1_0_0247_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_1_1_0248_out_ap_vld = 1'b1;
    end else begin
        arg1_r_1_1_0248_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_1_2_0249_out_ap_vld = 1'b1;
    end else begin
        arg1_r_1_2_0249_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_229_0245_out_ap_vld = 1'b1;
    end else begin
        arg1_r_229_0245_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_2_0_0250_out_ap_vld = 1'b1;
    end else begin
        arg1_r_2_0_0250_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_2_1_0251_out_ap_vld = 1'b1;
    end else begin
        arg1_r_2_1_0251_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_2_2_0252_out_ap_vld = 1'b1;
    end else begin
        arg1_r_2_2_0252_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln17_fu_252_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arg1_r_3_0246_out_ap_vld = 1'b1;
    end else begin
        arg1_r_3_0246_out_ap_vld = 1'b0;
    end
end
...
assign add_ln17_1_fu_267_p2 = (ap_sig_allocacmp_phi_mul21_load + 8'd22);

assign add_ln17_2_fu_287_p2 = (ap_sig_allocacmp_phi_urem23_load + 4'd1);
...
assign arg1_r_0_0243_out = arg1_r_0_1_fu_100;

assign arg1_r_128_0244_out = arg1_r_0_2_fu_104;

assign arg1_r_1_0_0247_out = arg1_r_0_5_fu_116;

assign arg1_r_1_1_0248_out = arg1_r_0_6_fu_120;

assign arg1_r_1_2_0249_out = arg1_r_0_7_fu_124;

assign arg1_r_229_0245_out = arg1_r_0_3_fu_108;

assign arg1_r_2_0_0250_out = arg1_r_0_8_fu_128;

assign arg1_r_2_1_0251_out = arg1_r_0_9_fu_132;

assign arg1_r_2_2_0252_out = arg1_r_0_10_fu_136;

assign arg1_r_3_0246_out = arg1_r_0_4_fu_112;
...
assign trunc_ln17_fu_273_p1 = ap_sig_allocacmp_phi_urem23_load[1:0];
