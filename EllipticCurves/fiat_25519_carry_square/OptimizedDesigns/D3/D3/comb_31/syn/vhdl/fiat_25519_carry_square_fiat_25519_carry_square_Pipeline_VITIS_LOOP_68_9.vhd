...
begin
    ...
    add_ln106_1_fu_524_p2 <= std_logic_vector(unsigned(mul344) + unsigned(mul353));
    ...
    add_ln83_1_fu_501_p2 <= std_logic_vector(unsigned(mul237) + unsigned(add239_127_fu_124));
    add_ln83_2_fu_506_p2 <= std_logic_vector(unsigned(add_ln83_1_fu_501_p2) + unsigned(add_ln83_fu_497_p2));
    add_ln83_fu_497_p2 <= std_logic_vector(unsigned(mul229) + unsigned(mul221));
    add_ln89_1_fu_393_p2 <= std_logic_vector(unsigned(mul254) + unsigned(mul262));
