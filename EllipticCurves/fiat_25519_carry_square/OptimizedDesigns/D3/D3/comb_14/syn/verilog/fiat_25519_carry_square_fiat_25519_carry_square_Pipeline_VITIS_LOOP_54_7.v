...
module fiat_25519_carry_square_fiat_25519_carry_square_Pipeline_VITIS_LOOP_54_7 (
        ...
        mul157,
        add180_121_out,
        add180_121_out_ap_vld,
        add151_120_out,
        add151_120_out_ap_vld,
        add131_119_out,
        add131_119_out_ap_vld,
        add118_118_out,
        add118_118_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] arr_1_load_4;
input  [63:0] arr_load_3;
input  [63:0] arr_1_load_3;
input  [63:0] arr_load_2;
...
input  [63:0] mul157;
output  [63:0] add180_121_out;
output   add180_121_out_ap_vld;
output  [63:0] add151_120_out;
output   add151_120_out_ap_vld;
output  [63:0] add131_119_out;
output   add131_119_out_ap_vld;
output  [63:0] add118_118_out;
output   add118_118_out_ap_vld;

reg ap_idle;
reg add180_121_out_ap_vld;
reg add151_120_out_ap_vld;
reg add131_119_out_ap_vld;
reg add118_118_out_ap_vld;
...
reg   [63:0] add118_118_fu_90;
wire   [63:0] add_ln60_1_fu_494_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add131_119_fu_94;
wire   [63:0] add_ln61_1_fu_506_p2;
reg   [63:0] add151_120_fu_98;
wire   [63:0] add_ln62_2_fu_558_p2;
reg   [63:0] add180_121_fu_102;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add180_121_fu_102 <= arr_1_load_4;
        end else if (((tmp_fu_282_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((tmp_fu_282_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add118_118_out_ap_vld = 1'b1;
    end else begin
        add118_118_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_282_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add131_119_out_ap_vld = 1'b1;
    end else begin
        add131_119_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_282_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add151_120_out_ap_vld = 1'b1;
    end else begin
        add151_120_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_282_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add180_121_out_ap_vld = 1'b1;
    end else begin
        add180_121_out_ap_vld = 1'b0;
    end
end
...
assign add118_118_out = add118_118_fu_90;

assign add131_119_out = add131_119_fu_94;

assign add151_120_out = add151_120_fu_98;

assign add180_121_out = add180_121_fu_102;

assign add_ln54_fu_619_p2 = (i_fu_106 + 3'd2);

assign add_ln60_1_fu_494_p2 = (add118_118_fu_90 + add_ln60_fu_488_p2);

assign add_ln60_fu_488_p2 = (mul_ln60_1_fu_226_p2 + mul_ln60_fu_222_p2);

assign add_ln61_1_fu_506_p2 = (add131_119_fu_94 + add_ln61_fu_500_p2);
...
assign add_ln62_2_fu_558_p2 = (add151_120_fu_98 + add_ln62_1_fu_552_p2);

assign add_ln62_fu_546_p2 = (mul_ln62_1_fu_238_p2 + mul_ln62_fu_250_p2);

assign add_ln64_1_fu_613_p2 = (add180_121_fu_102 + add_ln64_fu_607_p2);
...
assign shl_ln62_1_fu_512_p3 = {{tmp_s_fu_424_p5}, {1'd0}};
...
assign zext_ln60_3_fu_441_p1 = tmp_s_fu_424_p5;

assign zext_ln60_fu_316_p1 = tmp_8_fu_306_p5;

assign zext_ln62_1_fu_434_p1 = tmp_s_fu_424_p5;
