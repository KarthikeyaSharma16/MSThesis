...
input  [63:0] mul344;
input  [63:0] mul353;
output  [63:0] add23924_out;
output   add23924_out_ap_vld;
output  [63:0] add27422_out;
output   add27422_out_ap_vld;
output  [63:0] add30120_out;
output   add30120_out_ap_vld;
output  [63:0] add33718_out;
output   add33718_out_ap_vld;
output  [63:0] add37116_out;
output   add37116_out_ap_vld;
output  [63:0] add20414_out;
output   add20414_out_ap_vld;

reg ap_idle;
reg add23924_out_ap_vld;
reg add27422_out_ap_vld;
reg add30120_out_ap_vld;
reg add33718_out_ap_vld;
reg add37116_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add23924_out_ap_vld = 1'b1;
    end else begin
        add23924_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add27422_out_ap_vld = 1'b1;
    end else begin
        add27422_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add30120_out_ap_vld = 1'b1;
    end else begin
        add30120_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add33718_out_ap_vld = 1'b1;
    end else begin
        add33718_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add37116_out_ap_vld = 1'b1;
    end else begin
        add37116_out_ap_vld = 1'b0;
    end
end
...
assign add23924_out = add23924_fu_122;

assign add27422_out = add27422_fu_118;

assign add30120_out = add30120_fu_114;

assign add33718_out = add33718_fu_110;

assign add37116_out = add37116_fu_106;

assign add_ln100_1_fu_381_p2 = (mul4 + mul318);

assign add_ln100_2_fu_385_p2 = (add_ln100_fu_377_p2 + add_ln100_1_fu_381_p2);

assign add_ln100_3_fu_391_p2 = (add_ln100_2_fu_385_p2 + add33718_fu_110);

assign add_ln100_fu_377_p2 = (mul5 + mul325);

assign add_ln106_1_fu_483_p2 = (mul353 + mul344);

assign add_ln106_2_fu_487_p2 = (add_ln106_fu_479_p2 + add_ln106_1_fu_483_p2);

assign add_ln106_3_fu_493_p2 = (add_ln106_2_fu_487_p2 + add37116_fu_106);

assign add_ln106_fu_479_p2 = (mul369 + mul360);

assign add_ln78_1_fu_507_p2 = (mul202 + mul211);

assign add_ln78_fu_511_p2 = (add_ln78_1_fu_507_p2 + add20414_fu_102);

assign add_ln83_1_fu_460_p2 = (add_ln83_fu_456_p2 + mul221);

assign add_ln83_2_fu_465_p2 = (add_ln83_1_fu_460_p2 + add23924_fu_122);

assign add_ln83_fu_456_p2 = (mul229 + mul237);

assign add_ln89_1_fu_432_p2 = (mul246 + mul2);

assign add_ln89_2_fu_436_p2 = (add_ln89_fu_428_p2 + add_ln89_1_fu_432_p2);

assign add_ln89_3_fu_442_p2 = (add_ln89_2_fu_436_p2 + add27422_fu_118);

assign add_ln89_fu_428_p2 = (mul254 + mul262);

assign add_ln94_1_fu_409_p2 = (add_ln94_fu_405_p2 + mul3);

assign add_ln94_2_fu_414_p2 = (add_ln94_1_fu_409_p2 + add30120_fu_114);

assign add_ln94_fu_405_p2 = (mul299 + mul290);
