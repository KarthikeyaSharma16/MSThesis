set moduleName fiat_25519_carry_square_Pipeline_1
set isTopModule 0
...
set C_modelName {fiat_25519_carry_square_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ arr int 64 regular {array 4 { 0 3 } 0 1 }  }
	{ arr_1 int 64 regular {array 4 { 0 3 } 0 1 }  }
	{ arr_2 int 64 regular {array 4 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "arr", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "arr_1", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "arr_2", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ arr_address0 sc_out sc_lv 2 signal 0 } 
	...
	{ arr_2_address0 sc_out sc_lv 2 signal 2 } 
	{ arr_2_ce0 sc_out sc_logic 1 signal 2 } 
	{ arr_2_we0 sc_out sc_logic 1 signal 2 } 
	{ arr_2_d0 sc_out sc_lv 64 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	arr { ap_memory {  { arr_address0 mem_address 1 2 }  { arr_ce0 mem_ce 1 1 }  { arr_we0 mem_we 1 1 }  { arr_d0 mem_din 1 64 } } }
	arr_1 { ap_memory {  { arr_1_address0 mem_address 1 2 }  { arr_1_ce0 mem_ce 1 1 }  { arr_1_we0 mem_we 1 1 }  { arr_1_d0 mem_din 1 64 } } }
	arr_2 { ap_memory {  { arr_2_address0 mem_address 1 2 }  { arr_2_ce0 mem_ce 1 1 }  { arr_2_we0 mem_we 1 1 }  { arr_2_d0 mem_din 1 64 } } }
}
