...
input  [63:0] mul344;
input  [63:0] mul353;
output  [63:0] add21341_out;
output   add21341_out_ap_vld;
output  [63:0] add23936_out;
output   add23936_out_ap_vld;
output  [63:0] add27432_out;
output   add27432_out_ap_vld;
output  [63:0] add30128_out;
output   add30128_out_ap_vld;
output  [63:0] add33724_out;
output   add33724_out_ap_vld;
output  [63:0] add37120_out;
output   add37120_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;

reg ap_idle;
reg add21341_out_ap_vld;
reg add23936_out_ap_vld;
reg add27432_out_ap_vld;
reg add30128_out_ap_vld;
reg add33724_out_ap_vld;
reg add37120_out_ap_vld;
reg p_out_ap_vld;
...
reg   [63:0] ap_phi_mux_add23935_phi_fu_340_p12;
wire   [63:0] ap_phi_reg_pp0_iter1_add23935_reg_337;
wire   [2:0] i_1_load_fu_703_p1;
wire   [63:0] add_ln83_2_fu_820_p2;
reg   [63:0] ap_phi_mux_add27431_phi_fu_357_p12;
wire   [63:0] ap_phi_reg_pp0_iter1_add27431_reg_354;
wire   [63:0] add_ln89_3_fu_808_p2;
reg   [63:0] ap_phi_mux_add30127_phi_fu_374_p12;
wire   [63:0] ap_phi_reg_pp0_iter1_add30127_reg_371;
wire   [63:0] add_ln94_2_fu_787_p2;
reg   [63:0] ap_phi_mux_add33723_phi_fu_391_p12;
wire   [63:0] ap_phi_reg_pp0_iter1_add33723_reg_388;
wire   [63:0] add_ln100_3_fu_771_p2;
reg   [63:0] ap_phi_mux_add37119_phi_fu_408_p12;
wire   [63:0] ap_phi_reg_pp0_iter1_add37119_reg_405;
wire   [63:0] add_ln106_3_fu_841_p2;
reg   [63:0] ap_phi_mux_add23934_phi_fu_425_p12;
wire   [63:0] add_ln83_5_fu_897_p2;
wire   [63:0] ap_phi_reg_pp0_iter1_add23934_reg_422;
reg   [63:0] ap_phi_mux_add27430_phi_fu_447_p12;
wire   [63:0] ap_phi_reg_pp0_iter1_add27430_reg_444;
wire   [63:0] add_ln89_7_fu_885_p2;
reg   [63:0] ap_phi_mux_add30126_phi_fu_469_p12;
wire   [63:0] ap_phi_reg_pp0_iter1_add30126_reg_466;
wire   [63:0] add_ln94_5_fu_878_p2;
reg   [63:0] ap_phi_mux_add33722_phi_fu_491_p12;
wire   [63:0] ap_phi_reg_pp0_iter1_add33722_reg_488;
wire   [63:0] add_ln100_7_fu_871_p2;
reg   [63:0] ap_phi_mux_add37118_phi_fu_513_p12;
wire   [63:0] ap_phi_reg_pp0_iter1_add37118_reg_510;
wire   [63:0] add_ln106_7_fu_904_p2;
reg   [63:0] ap_phi_mux_add27429_phi_fu_535_p10;
wire   [63:0] add_ln89_11_fu_918_p2;
wire   [63:0] ap_phi_reg_pp0_iter1_add27429_reg_532;
reg   [63:0] ap_phi_mux_add30125_phi_fu_554_p10;
wire   [63:0] ap_phi_reg_pp0_iter1_add30125_reg_551;
wire   [63:0] add_ln94_8_fu_911_p2;
reg   [63:0] ap_phi_mux_add33721_phi_fu_573_p10;
wire   [63:0] ap_phi_reg_pp0_iter1_add33721_reg_570;
wire   [63:0] add_ln100_11_fu_925_p2;
reg   [63:0] ap_phi_mux_add37117_phi_fu_592_p10;
wire   [63:0] ap_phi_reg_pp0_iter1_add37117_reg_589;
...
reg   [63:0] add37120_fu_108;
reg   [63:0] add33724_fu_112;
reg   [63:0] add30128_fu_116;
reg   [63:0] add27432_fu_120;
reg   [63:0] add23936_fu_124;
reg   [63:0] add21341_fu_128;
...
always @ (*) begin
    if (((icmp_ln68_fu_751_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add21341_out_ap_vld = 1'b1;
    end else begin
        add21341_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_751_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add23936_out_ap_vld = 1'b1;
    end else begin
        add23936_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_751_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add27432_out_ap_vld = 1'b1;
    end else begin
        add27432_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_751_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add30128_out_ap_vld = 1'b1;
    end else begin
        add30128_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_751_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add33724_out_ap_vld = 1'b1;
    end else begin
        add33724_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_751_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add37120_out_ap_vld = 1'b1;
    end else begin
        add37120_out_ap_vld = 1'b0;
    end
end
...
assign add21341_out = add21341_fu_128;

assign add23936_out = add23936_fu_124;

assign add27432_out = add27432_fu_120;

assign add30128_out = add30128_fu_116;

assign add33724_out = add33724_fu_112;

assign add37120_out = add37120_fu_108;

assign add_ln100_11_fu_925_p2 = (grp_fu_620_p2 + ap_phi_mux_add33722_phi_fu_491_p12);

assign add_ln100_1_fu_761_p2 = (mul325 + add33724_fu_112);
...
assign add_ln100_7_fu_871_p2 = (grp_fu_620_p2 + ap_phi_mux_add33723_phi_fu_391_p12);

assign add_ln100_fu_757_p2 = (mul5 + mul318);

assign add_ln106_11_fu_932_p2 = (grp_fu_657_p2 + ap_phi_mux_add37118_phi_fu_513_p12);

assign add_ln106_1_fu_831_p2 = (mul344 + add37120_fu_108);
...
assign add_ln106_7_fu_904_p2 = (grp_fu_657_p2 + ap_phi_mux_add37119_phi_fu_408_p12);

assign add_ln106_fu_827_p2 = (mul360 + mul369);

assign add_ln78_1_fu_851_p2 = (mul211 + add21341_fu_128);

assign add_ln78_fu_856_p2 = (add_ln78_1_fu_851_p2 + mul202);

assign add_ln83_1_fu_815_p2 = (mul229 + add23936_fu_124);

assign add_ln83_2_fu_820_p2 = (add_ln83_1_fu_815_p2 + grp_fu_608_p2);

assign add_ln83_4_fu_892_p2 = (mul229 + ap_phi_mux_add23935_phi_fu_340_p12);

assign add_ln83_5_fu_897_p2 = (add_ln83_4_fu_892_p2 + grp_fu_608_p2);

assign add_ln89_11_fu_918_p2 = (grp_fu_643_p2 + ap_phi_mux_add27430_phi_fu_447_p12);

assign add_ln89_1_fu_798_p2 = (mul254 + add27432_fu_120);
...
assign add_ln89_7_fu_885_p2 = (grp_fu_643_p2 + ap_phi_mux_add27431_phi_fu_357_p12);

assign add_ln89_fu_794_p2 = (mul3 + mul246);

assign add_ln94_1_fu_782_p2 = (mul290 + add30128_fu_116);

assign add_ln94_2_fu_787_p2 = (add_ln94_1_fu_782_p2 + add_ln94_fu_778_p2);

assign add_ln94_5_fu_878_p2 = (grp_fu_630_p2 + ap_phi_mux_add30127_phi_fu_374_p12);

assign add_ln94_8_fu_911_p2 = (grp_fu_630_p2 + ap_phi_mux_add30126_phi_fu_469_p12);

assign add_ln94_fu_778_p2 = (mul299 + mul4);
...
assign ap_phi_reg_pp0_iter1_add23934_reg_422 = 'bx;

assign ap_phi_reg_pp0_iter1_add23935_reg_337 = 'bx;

assign ap_phi_reg_pp0_iter1_add27429_reg_532 = 'bx;

assign ap_phi_reg_pp0_iter1_add27430_reg_444 = 'bx;

assign ap_phi_reg_pp0_iter1_add27431_reg_354 = 'bx;

assign ap_phi_reg_pp0_iter1_add30125_reg_551 = 'bx;

assign ap_phi_reg_pp0_iter1_add30126_reg_466 = 'bx;

assign ap_phi_reg_pp0_iter1_add30127_reg_371 = 'bx;

assign ap_phi_reg_pp0_iter1_add33721_reg_570 = 'bx;

assign ap_phi_reg_pp0_iter1_add33722_reg_488 = 'bx;

assign ap_phi_reg_pp0_iter1_add33723_reg_388 = 'bx;

assign ap_phi_reg_pp0_iter1_add37117_reg_589 = 'bx;

assign ap_phi_reg_pp0_iter1_add37118_reg_510 = 'bx;

assign ap_phi_reg_pp0_iter1_add37119_reg_405 = 'bx;

assign grp_fu_608_p2 = (mul237 + mul221);

assign grp_fu_612_p2 = (mul5 + mul318);

assign grp_fu_616_p2 = (mul6 + mul325);

assign grp_fu_620_p2 = (grp_fu_612_p2 + grp_fu_616_p2);

assign grp_fu_626_p2 = (mul299 + mul4);

assign grp_fu_630_p2 = (grp_fu_626_p2 + mul290);

assign grp_fu_635_p2 = (mul3 + mul246);
