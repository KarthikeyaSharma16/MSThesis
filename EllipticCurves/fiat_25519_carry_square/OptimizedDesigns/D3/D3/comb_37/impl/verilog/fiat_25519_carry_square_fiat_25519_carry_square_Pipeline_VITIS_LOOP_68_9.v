...
module fiat_25519_carry_square_fiat_25519_carry_square_Pipeline_VITIS_LOOP_68_9 (
        ...
        mul221,
        add371_130_out,
        add371_130_out_ap_vld,
        add239_128_out,
        add239_128_out_ap_vld,
        add301_126_out,
        add301_126_out_ap_vld,
        add21324_out,
        add21324_out_ap_vld,
        add33721_out,
        add33721_out_ap_vld,
...
input  [63:0] mul237;
input  [63:0] mul221;
output  [63:0] add371_130_out;
output   add371_130_out_ap_vld;
output  [63:0] add239_128_out;
output   add239_128_out_ap_vld;
output  [63:0] add301_126_out;
output   add301_126_out_ap_vld;
output  [63:0] add21324_out;
output   add21324_out_ap_vld;
output  [63:0] add33721_out;
output   add33721_out_ap_vld;
output  [63:0] add27419_out;
output   add27419_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;

reg ap_idle;
reg add371_130_out_ap_vld;
reg add239_128_out_ap_vld;
reg add301_126_out_ap_vld;
reg add21324_out_ap_vld;
reg add33721_out_ap_vld;
reg add27419_out_ap_vld;
reg p_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add21324_out_ap_vld = 1'b1;
    end else begin
        add21324_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add239_128_out_ap_vld = 1'b1;
    end else begin
        add239_128_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add27419_out_ap_vld = 1'b1;
    end else begin
        add27419_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add301_126_out_ap_vld = 1'b1;
    end else begin
        add301_126_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add371_130_out_ap_vld = 1'b1;
    end else begin
        add371_130_out_ap_vld = 1'b0;
    end
end
...
assign add21324_out = add21324_fu_116;

assign add239_128_out = add239_128_fu_124;

assign add27419_out = add27419_fu_108;

assign add301_126_out = add301_126_fu_120;

assign add33721_out = add33721_fu_112;

assign add371_130_out = add371_130_fu_128;

assign add_ln100_1_fu_421_p2 = (mul5 + mul6);

assign add_ln100_2_fu_425_p2 = (add_ln100_fu_417_p2 + add_ln100_1_fu_421_p2);

assign add_ln100_3_fu_431_p2 = (add_ln100_2_fu_425_p2 + add33721_fu_112);
...
assign add_ln106_3_fu_534_p2 = (add_ln106_2_fu_528_p2 + add371_130_fu_128);

assign add_ln106_fu_520_p2 = (mul353 + mul360);

assign add_ln78_1_fu_445_p2 = (mul202 + add21324_fu_116);

assign add_ln78_fu_450_p2 = (add_ln78_1_fu_445_p2 + mul211);

assign add_ln83_1_fu_501_p2 = (mul221 + add239_128_fu_124);
...
assign add_ln89_3_fu_403_p2 = (add_ln89_2_fu_397_p2 + add27419_fu_108);

assign add_ln89_fu_389_p2 = (mul254 + mul262);

assign add_ln94_1_fu_478_p2 = (mul299 + add301_126_fu_120);
