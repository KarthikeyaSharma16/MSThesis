...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add239_127_fu_124 <= arr_2_load_4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add301_125_fu_120 <= arr_1_load_3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add371_129_fu_128 <= arr_1_load_4;
...
assign add_ln100_1_fu_421_p2 = (mul6 + mul7);
...
assign add_ln89_1_fu_393_p2 = (mul246 + mul4);
...
assign add_ln94_fu_474_p2 = (mul5 + mul290);
