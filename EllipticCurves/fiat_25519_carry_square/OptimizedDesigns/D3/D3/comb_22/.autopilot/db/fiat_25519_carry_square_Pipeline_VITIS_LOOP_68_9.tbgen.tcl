...
set C_modelArgList {
	...
	{ add371_124_out int 64 regular {pointer 1}  }
	{ add239_122_out int 64 regular {pointer 1}  }
	{ add301_120_out int 64 regular {pointer 1}  }
	{ add33718_out int 64 regular {pointer 1}  }
	{ add27416_out int 64 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "arr_load_5", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add371_124_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add239_122_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add301_120_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add33718_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add27416_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ arr_load_3 sc_in sc_lv 64 signal 4 } 
	...
	{ mul3 sc_in sc_lv 64 signal 22 } 
	{ mul229 sc_in sc_lv 64 signal 23 } 
	{ mul237 sc_in sc_lv 64 signal 24 } 
	{ mul221 sc_in sc_lv 64 signal 25 } 
	{ add371_124_out sc_out sc_lv 64 signal 26 } 
	{ add371_124_out_ap_vld sc_out sc_logic 1 outvld 26 } 
	{ add239_122_out sc_out sc_lv 64 signal 27 } 
	{ add239_122_out_ap_vld sc_out sc_logic 1 outvld 27 } 
	{ add301_120_out sc_out sc_lv 64 signal 28 } 
	{ add301_120_out_ap_vld sc_out sc_logic 1 outvld 28 } 
	{ add33718_out sc_out sc_lv 64 signal 29 } 
	{ add33718_out_ap_vld sc_out sc_logic 1 outvld 29 } 
	{ add27416_out sc_out sc_lv 64 signal 30 } 
	{ add27416_out_ap_vld sc_out sc_logic 1 outvld 30 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add371_124_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add371_124_out", "role": "default" }} , 
 	{ "name": "add371_124_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add371_124_out", "role": "ap_vld" }} , 
 	{ "name": "add239_122_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add239_122_out", "role": "default" }} , 
 	{ "name": "add239_122_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add239_122_out", "role": "ap_vld" }} , 
 	{ "name": "add301_120_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add301_120_out", "role": "default" }} , 
 	{ "name": "add301_120_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add301_120_out", "role": "ap_vld" }} , 
 	{ "name": "add33718_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add33718_out", "role": "default" }} , 
 	{ "name": "add33718_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add33718_out", "role": "ap_vld" }} , 
 	{ "name": "add27416_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add27416_out", "role": "default" }} , 
 	{ "name": "add27416_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add27416_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "add371_124_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add239_122_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add301_120_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add33718_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add27416_out", "Type" : "Vld", "Direction" : "O"},
...
set ArgLastReadFirstWriteLatency {
	fiat_25519_carry_square_Pipeline_VITIS_LOOP_68_9 {
		...
		add371_124_out {Type O LastRead -1 FirstWrite 1}
		add239_122_out {Type O LastRead -1 FirstWrite 1}
		add301_120_out {Type O LastRead -1 FirstWrite 1}
		add33718_out {Type O LastRead -1 FirstWrite 1}
		add27416_out {Type O LastRead -1 FirstWrite 1}
...
set Spec2ImplPortList { 
	...
	add371_124_out { ap_vld {  { add371_124_out out_data 1 64 }  { add371_124_out_ap_vld out_vld 1 1 } } }
	add239_122_out { ap_vld {  { add239_122_out out_data 1 64 }  { add239_122_out_ap_vld out_vld 1 1 } } }
	add301_120_out { ap_vld {  { add301_120_out out_data 1 64 }  { add301_120_out_ap_vld out_vld 1 1 } } }
	add33718_out { ap_vld {  { add33718_out out_data 1 64 }  { add33718_out_ap_vld out_vld 1 1 } } }
	add27416_out { ap_vld {  { add27416_out out_data 1 64 }  { add27416_out_ap_vld out_vld 1 1 } } }
