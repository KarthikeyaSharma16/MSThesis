...
module fiat_25519_carry_square_fiat_25519_carry_square_Pipeline_VITIS_LOOP_68_9 (
        ...
        mul221,
        add371_124_out,
        add371_124_out_ap_vld,
        add239_122_out,
        add239_122_out_ap_vld,
        add301_120_out,
        add301_120_out_ap_vld,
        add33718_out,
        add33718_out_ap_vld,
        add27416_out,
        add27416_out_ap_vld,
...
input  [63:0] mul237;
input  [63:0] mul221;
output  [63:0] add371_124_out;
output   add371_124_out_ap_vld;
output  [63:0] add239_122_out;
output   add239_122_out_ap_vld;
output  [63:0] add301_120_out;
output   add301_120_out_ap_vld;
output  [63:0] add33718_out;
output   add33718_out_ap_vld;
output  [63:0] add27416_out;
output   add27416_out_ap_vld;
output  [63:0] add20414_out;
output   add20414_out_ap_vld;

reg ap_idle;
reg add371_124_out_ap_vld;
reg add239_122_out_ap_vld;
reg add301_120_out_ap_vld;
reg add33718_out_ap_vld;
reg add27416_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add239_122_out_ap_vld = 1'b1;
    end else begin
        add239_122_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add27416_out_ap_vld = 1'b1;
    end else begin
        add27416_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add301_120_out_ap_vld = 1'b1;
    end else begin
        add301_120_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add371_124_out_ap_vld = 1'b1;
    end else begin
        add371_124_out_ap_vld = 1'b0;
    end
end
...
assign add239_122_out = add239_122_fu_118;

assign add27416_out = add27416_fu_106;

assign add301_120_out = add301_120_fu_114;

assign add33718_out = add33718_fu_110;

assign add371_124_out = add371_124_fu_122;

assign add_ln100_1_fu_403_p2 = (mul4 + mul318);

assign add_ln100_2_fu_407_p2 = (add_ln100_fu_399_p2 + add_ln100_1_fu_403_p2);

assign add_ln100_3_fu_413_p2 = (add_ln100_2_fu_407_p2 + add33718_fu_110);

assign add_ln100_fu_399_p2 = (mul5 + mul325);

assign add_ln106_1_fu_501_p2 = (mul353 + mul344);

assign add_ln106_2_fu_505_p2 = (add_ln106_fu_497_p2 + add_ln106_1_fu_501_p2);

assign add_ln106_3_fu_511_p2 = (add_ln106_2_fu_505_p2 + add371_124_fu_122);
...
assign add_ln83_1_fu_478_p2 = (mul221 + add239_122_fu_118);

assign add_ln83_2_fu_483_p2 = (add_ln83_1_fu_478_p2 + add_ln83_fu_474_p2);

assign add_ln83_fu_474_p2 = (mul229 + mul237);

assign add_ln89_1_fu_375_p2 = (mul246 + mul2);

assign add_ln89_2_fu_379_p2 = (add_ln89_fu_371_p2 + add_ln89_1_fu_375_p2);

assign add_ln89_3_fu_385_p2 = (add_ln89_2_fu_379_p2 + add27416_fu_106);

assign add_ln89_fu_371_p2 = (mul254 + mul262);

assign add_ln94_1_fu_455_p2 = (mul3 + add301_120_fu_114);

assign add_ln94_2_fu_460_p2 = (add_ln94_1_fu_455_p2 + add_ln94_fu_451_p2);

assign add_ln94_fu_451_p2 = (mul299 + mul290);
