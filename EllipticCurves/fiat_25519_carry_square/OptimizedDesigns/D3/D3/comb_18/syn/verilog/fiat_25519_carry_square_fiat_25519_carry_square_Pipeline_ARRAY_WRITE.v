...
output  [3:0] out1_w_address0;
output   out1_w_ce0;
input  [26:0] out1_w_q0;
...
reg   [0:0] icmp_ln126_reg_140;
reg   [26:0] out1_w_load_reg_154;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] i_3_cast_fu_109_p1;
wire    ap_block_pp0_stage0_01001;
reg   [3:0] i_fu_54;
wire   [3:0] add_ln126_fu_103_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln126_fu_97_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln126_reg_140 == 1'd0))) begin
        out1_w_load_reg_154 <= out1_w_q0;
    end
end

always @ (*) begin
    if (((icmp_ln126_fu_97_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln126_reg_140 == 1'd1))) begin
...
assign add_ln126_fu_103_p2 = (ap_sig_allocacmp_i_3 + 4'd1);
...
assign i_3_cast_fu_109_p1 = ap_sig_allocacmp_i_3;

assign icmp_ln126_fu_97_p2 = ((ap_sig_allocacmp_i_3 == 4'd10) ? 1'b1 : 1'b0);
...
assign m_axi_mem_WDATA = out1_w_load_reg_154;
...
assign out1_w_address0 = i_3_cast_fu_109_p1;
