...
set C_modelArgList {
	...
	{ out1_w int 27 regular {array 10 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "out1_w", "interface" : "memory", "bitwidth" : 27, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ out1_w_address0 sc_out sc_lv 4 signal 2 } 
	{ out1_w_ce0 sc_out sc_logic 1 signal 2 } 
	{ out1_w_q0 sc_in sc_lv 27 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out1_w_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "out1_w", "role": "address0" }} , 
 	{ "name": "out1_w_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out1_w", "role": "ce0" }} , 
 	{ "name": "out1_w_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":27, "type": "signal", "bundle":{"name": "out1_w", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	out1_w { ap_memory {  { out1_w_address0 mem_address 1 4 }  { out1_w_ce0 mem_ce 1 1 }  { out1_w_q0 mem_dout 0 27 } } }
}
