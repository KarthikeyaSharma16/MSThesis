...
input  [63:0] mul344;
input  [63:0] mul353;
output  [63:0] add23914_out;
output   add23914_out_ap_vld;
output  [63:0] add27412_out;
output   add27412_out_ap_vld;
output  [63:0] add30110_out;
output   add30110_out_ap_vld;
output  [63:0] add3378_out;
output   add3378_out_ap_vld;
output  [63:0] add3716_out;
output   add3716_out_ap_vld;
output  [63:0] add21319_out;
output   add21319_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;

reg ap_idle;
reg add23914_out_ap_vld;
reg add27412_out_ap_vld;
reg add30110_out_ap_vld;
reg add3378_out_ap_vld;
reg add3716_out_ap_vld;
reg add21319_out_ap_vld;
reg p_out_ap_vld;
...
reg   [63:0] add21319_fu_108;
reg   [63:0] add3716_fu_112;
wire   [63:0] add_ln106_3_fu_511_p2;
reg   [63:0] add3378_fu_116;
wire   [63:0] add_ln100_3_fu_409_p2;
reg   [63:0] add30110_fu_120;
wire   [63:0] add_ln94_2_fu_432_p2;
reg   [63:0] add27412_fu_124;
wire   [63:0] add_ln89_3_fu_460_p2;
reg   [63:0] add23914_fu_128;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add21319_fu_108 <= add11813_reload;
...
always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add21319_out_ap_vld = 1'b1;
    end else begin
        add21319_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add23914_out_ap_vld = 1'b1;
    end else begin
        add23914_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add27412_out_ap_vld = 1'b1;
    end else begin
        add27412_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add30110_out_ap_vld = 1'b1;
    end else begin
        add30110_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add3716_out_ap_vld = 1'b1;
    end else begin
        add3716_out_ap_vld = 1'b0;
    end
end
...
assign add21319_out = add21319_fu_108;

assign add23914_out = add23914_fu_128;

assign add27412_out = add27412_fu_124;

assign add30110_out = add30110_fu_120;

assign add3378_out = add3378_fu_116;

assign add3716_out = add3716_fu_112;

assign add_ln100_1_fu_399_p2 = (mul6 + mul325);

assign add_ln100_2_fu_403_p2 = (add_ln100_fu_395_p2 + add_ln100_1_fu_399_p2);

assign add_ln100_3_fu_409_p2 = (add_ln100_2_fu_403_p2 + add3378_fu_116);
...
assign add_ln106_3_fu_511_p2 = (add_ln106_2_fu_505_p2 + add3716_fu_112);

assign add_ln106_fu_497_p2 = (mul360 + mul369);

assign add_ln78_1_fu_525_p2 = (mul202 + mul211);

assign add_ln78_fu_529_p2 = (add_ln78_1_fu_525_p2 + add21319_fu_108);

assign add_ln83_1_fu_478_p2 = (add_ln83_fu_474_p2 + mul229);

assign add_ln83_2_fu_483_p2 = (add_ln83_1_fu_478_p2 + add23914_fu_128);
...
assign add_ln89_3_fu_460_p2 = (add_ln89_2_fu_454_p2 + add27412_fu_124);

assign add_ln89_fu_446_p2 = (mul3 + mul246);

assign add_ln94_1_fu_427_p2 = (add_ln94_fu_423_p2 + mul290);

assign add_ln94_2_fu_432_p2 = (add_ln94_1_fu_427_p2 + add30110_fu_120);
