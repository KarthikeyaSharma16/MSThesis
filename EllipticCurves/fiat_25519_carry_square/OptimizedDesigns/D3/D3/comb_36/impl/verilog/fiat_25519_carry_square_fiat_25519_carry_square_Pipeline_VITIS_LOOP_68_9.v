...
module fiat_25519_carry_square_fiat_25519_carry_square_Pipeline_VITIS_LOOP_68_9 (
        ...
        mul229,
        add371_125_out,
        add371_125_out_ap_vld,
        add239_123_out,
        add239_123_out_ap_vld,
        add301_121_out,
        add301_121_out_ap_vld,
        add33719_out,
        add33719_out_ap_vld,
        add27417_out,
        add27417_out_ap_vld,
...
input  [63:0] mul221;
input  [63:0] mul229;
output  [63:0] add371_125_out;
output   add371_125_out_ap_vld;
output  [63:0] add239_123_out;
output   add239_123_out_ap_vld;
output  [63:0] add301_121_out;
output   add301_121_out_ap_vld;
output  [63:0] add33719_out;
output   add33719_out_ap_vld;
output  [63:0] add27417_out;
output   add27417_out_ap_vld;
output  [63:0] add20414_out;
output   add20414_out_ap_vld;

reg ap_idle;
reg add371_125_out_ap_vld;
reg add239_123_out_ap_vld;
reg add301_121_out_ap_vld;
reg add33719_out_ap_vld;
reg add27417_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add239_123_out_ap_vld = 1'b1;
    end else begin
        add239_123_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add27417_out_ap_vld = 1'b1;
    end else begin
        add27417_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add301_121_out_ap_vld = 1'b1;
    end else begin
        add301_121_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln68_fu_362_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add371_125_out_ap_vld = 1'b1;
    end else begin
        add371_125_out_ap_vld = 1'b0;
    end
end
...
assign add239_123_out = add239_123_fu_118;

assign add27417_out = add27417_fu_106;

assign add301_121_out = add301_121_fu_114;

assign add33719_out = add33719_fu_110;

assign add371_125_out = add371_125_fu_122;

assign add_ln100_1_fu_403_p2 = (mul5 + mul6);

assign add_ln100_2_fu_407_p2 = (add_ln100_fu_399_p2 + add_ln100_1_fu_403_p2);

assign add_ln100_3_fu_413_p2 = (add_ln100_2_fu_407_p2 + add33719_fu_110);

assign add_ln100_fu_399_p2 = (mul318 + mul325);

assign add_ln106_1_fu_501_p2 = (mul360 + mul353);

assign add_ln106_2_fu_505_p2 = (add_ln106_fu_497_p2 + add_ln106_1_fu_501_p2);

assign add_ln106_3_fu_511_p2 = (add_ln106_2_fu_505_p2 + add371_125_fu_122);

assign add_ln106_fu_497_p2 = (mul344 + mul369);

assign add_ln78_1_fu_427_p2 = (mul211 + add20414_fu_102);

assign add_ln78_fu_432_p2 = (add_ln78_1_fu_427_p2 + mul202);

assign add_ln83_1_fu_478_p2 = (mul229 + add239_123_fu_118);
...
assign add_ln89_3_fu_385_p2 = (add_ln89_2_fu_379_p2 + add27417_fu_106);

assign add_ln89_fu_371_p2 = (mul3 + mul246);

assign add_ln94_1_fu_455_p2 = (mul299 + add301_121_fu_114);

assign add_ln94_2_fu_460_p2 = (add_ln94_1_fu_455_p2 + add_ln94_fu_451_p2);

assign add_ln94_fu_451_p2 = (mul290 + mul4);
