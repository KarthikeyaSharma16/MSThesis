...
input  [63:0] mul344;
input  [63:0] mul353;
output  [63:0] add21329_out;
output   add21329_out_ap_vld;
output  [63:0] add23926_out;
output   add23926_out_ap_vld;
output  [63:0] add27424_out;
output   add27424_out_ap_vld;
output  [63:0] add30122_out;
output   add30122_out_ap_vld;
output  [63:0] add33720_out;
output   add33720_out_ap_vld;
output  [63:0] add37118_out;
output   add37118_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;

reg ap_idle;
reg add21329_out_ap_vld;
reg add23926_out_ap_vld;
reg add27424_out_ap_vld;
reg add30122_out_ap_vld;
reg add33720_out_ap_vld;
reg add37118_out_ap_vld;
reg p_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add21329_out_ap_vld = 1'b1;
    end else begin
        add21329_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add23926_out_ap_vld = 1'b1;
    end else begin
        add23926_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add27424_out_ap_vld = 1'b1;
    end else begin
        add27424_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add30122_out_ap_vld = 1'b1;
    end else begin
        add30122_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add37118_out_ap_vld = 1'b1;
    end else begin
        add37118_out_ap_vld = 1'b0;
    end
end
...
assign add21329_out = add21329_fu_128;

assign add23926_out = add23926_fu_124;

assign add27424_out = add27424_fu_120;

assign add30122_out = add30122_fu_116;

assign add33720_out = add33720_fu_112;

assign add37118_out = add37118_fu_108;

assign add_ln100_1_fu_399_p2 = (mul5 + mul318);

assign add_ln100_2_fu_403_p2 = (add_ln100_fu_395_p2 + add_ln100_1_fu_399_p2);

assign add_ln100_3_fu_409_p2 = (add_ln100_2_fu_403_p2 + add33720_fu_112);

assign add_ln100_fu_395_p2 = (mul6 + mul325);

assign add_ln106_1_fu_501_p2 = (mul353 + mul344);

assign add_ln106_2_fu_505_p2 = (add_ln106_fu_497_p2 + add_ln106_1_fu_501_p2);

assign add_ln106_3_fu_511_p2 = (add_ln106_2_fu_505_p2 + add37118_fu_108);

assign add_ln106_fu_497_p2 = (mul369 + mul360);

assign add_ln78_1_fu_525_p2 = (mul202 + mul211);

assign add_ln78_fu_529_p2 = (add_ln78_1_fu_525_p2 + add21329_fu_128);

assign add_ln83_1_fu_478_p2 = (add_ln83_fu_474_p2 + mul221);

assign add_ln83_2_fu_483_p2 = (add_ln83_1_fu_478_p2 + add23926_fu_124);
...
assign add_ln89_3_fu_460_p2 = (add_ln89_2_fu_454_p2 + add27424_fu_120);

assign add_ln89_fu_446_p2 = (mul254 + mul262);

assign add_ln94_1_fu_427_p2 = (add_ln94_fu_423_p2 + mul4);

assign add_ln94_2_fu_432_p2 = (add_ln94_1_fu_427_p2 + add30122_fu_116);

assign add_ln94_fu_423_p2 = (mul299 + mul290);
