...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename out1_w \
    op interface \
    ports { out1_w_address0 { O 4 vector } out1_w_ce0 { O 1 bit } out1_w_q0 { I 27 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'out1_w'"
}
}
