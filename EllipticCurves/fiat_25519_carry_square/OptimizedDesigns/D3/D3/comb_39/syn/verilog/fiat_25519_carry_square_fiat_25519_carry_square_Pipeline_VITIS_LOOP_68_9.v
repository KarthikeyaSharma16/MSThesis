...
output  [63:0] add21320_out;
output   add21320_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln68_fu_380_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add21320_out_ap_vld = 1'b1;
    end else begin
        add21320_out_ap_vld = 1'b0;
    end
end
...
assign add21320_out = add21320_fu_108;
...
assign add_ln78_fu_529_p2 = (add_ln78_1_fu_525_p2 + add21320_fu_108);
