...
module fiat_25519_carry_square_fiat_25519_carry_square_Pipeline_VITIS_LOOP_34_3 (
        ...
        arr_ce1,
        arr_q1,
        arg1_r_136_0304_reload,
        arg1_r_0_0303_reload,
        arg1_r_1_1_0307_reload,
        arg1_r_1_0_0306_reload,
        arg1_r_2_1_0310_reload,
        arg1_r_2_0_0309_reload,
        arg1_r_3_1_0313_reload,
...
output   arr_ce1;
input  [63:0] arr_q1;
input  [31:0] arg1_r_136_0304_reload;
input  [31:0] arg1_r_0_0303_reload;
input  [31:0] arg1_r_1_1_0307_reload;
input  [31:0] arg1_r_1_0_0306_reload;
input  [31:0] arg1_r_2_1_0310_reload;
input  [31:0] arg1_r_2_0_0309_reload;
input  [31:0] arg1_r_3_1_0313_reload;
...
wire   [31:0] tmp_fu_300_p1;
wire   [31:0] tmp_fu_300_p2;
wire   [31:0] tmp_fu_300_p3;
wire   [31:0] tmp_fu_300_p4;
wire   [31:0] tmp_fu_300_p6;
...
wire   [31:0] tmp_2_fu_353_p6;
wire   [62:0] mul_ln40_fu_181_p2;
wire   [31:0] tmp_3_fu_379_p6;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln34_fu_206_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_4_reg_498 <= sub_ln37_fu_226_p2[32'd2];
        tmp_5_reg_512 <= add_ln40_1_fu_244_p2[32'd2];
...
assign add_ln34_fu_258_p2 = (ap_sig_allocacmp_i_1_load + 4'd3);
...
assign mul_ln40_1_fu_177_p10 = tmp_fu_300_p6;

assign mul_ln40_2_fu_185_p0 = zext_ln40_cast_reg_481;

assign mul_ln40_2_fu_185_p1 = mul_ln40_2_fu_185_p10;

assign mul_ln40_2_fu_185_p10 = tmp_3_fu_379_p6;

assign mul_ln40_fu_181_p0 = zext_ln40_cast_reg_481;

assign mul_ln40_fu_181_p1 = mul_ln40_fu_181_p10;

assign mul_ln40_fu_181_p10 = tmp_2_fu_353_p6;

assign select_ln40_4_fu_333_p3 = ((tmp_5_reg_512[0:0] == 1'b1) ? arg1_r_136_0304_reload : arg1_r_0_0303_reload);

assign select_ln40_5_fu_338_p3 = ((tmp_5_reg_512[0:0] == 1'b1) ? arg1_r_1_1_0307_reload : arg1_r_1_0_0306_reload);

assign select_ln40_6_fu_343_p3 = ((tmp_5_reg_512[0:0] == 1'b1) ? arg1_r_2_1_0310_reload : arg1_r_2_0_0309_reload);

assign select_ln40_7_fu_348_p3 = ((tmp_5_reg_512[0:0] == 1'b1) ? arg1_r_3_1_0313_reload : arg1_r_3_0_0312_reload);
...
assign tmp_fu_300_p1 = ((tmp_4_reg_498[0:0] == 1'b1) ? arg1_r_136_0304_reload : arg1_r_0_0303_reload);

assign tmp_fu_300_p2 = ((tmp_4_reg_498[0:0] == 1'b1) ? arg1_r_1_1_0307_reload : arg1_r_1_0_0306_reload);

assign tmp_fu_300_p3 = ((tmp_4_reg_498[0:0] == 1'b1) ? arg1_r_2_1_0310_reload : arg1_r_2_0_0309_reload);

assign tmp_fu_300_p4 = ((tmp_4_reg_498[0:0] == 1'b1) ? arg1_r_3_1_0313_reload : arg1_r_3_0_0312_reload);

assign trunc_ln34_fu_215_p1 = ap_sig_allocacmp_i_1_load[2:0];
