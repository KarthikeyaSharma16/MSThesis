...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln17_fu_251_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                trunc_ln1_reg_481 <= ap_sig_allocacmp_i_5(3 downto 2);
            end if;
        end if;
    end process;
    ...
    add_ln17_fu_257_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_5) + unsigned(ap_const_lv4_1));
    ...
    empty_fu_263_p1 <= ap_sig_allocacmp_i_5(2 - 1 downto 0);
    icmp_ln17_fu_251_p2 <= "1" when (ap_sig_allocacmp_i_5 = ap_const_lv4_A) else "0";
