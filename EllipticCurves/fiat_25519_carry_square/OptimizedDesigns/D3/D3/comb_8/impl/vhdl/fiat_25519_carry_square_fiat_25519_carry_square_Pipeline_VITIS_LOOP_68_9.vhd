...
begin
    ...
    add_ln78_1_fu_445_p2 <= std_logic_vector(unsigned(mul202) + unsigned(add21323_fu_116));
    ...
    add_ln94_1_fu_478_p2 <= std_logic_vector(unsigned(mul299) + unsigned(add301_125_fu_120));
