...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_719_out \
    op interface \
    ports { add68_719_out { O 128 vector } add68_719_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_618_out \
    op interface \
    ports { add68_618_out { O 128 vector } add68_618_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_517_out \
    op interface \
    ports { add68_517_out { O 128 vector } add68_517_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_416_out \
    op interface \
    ports { add68_416_out { O 128 vector } add68_416_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_315_out \
    op interface \
    ports { add68_315_out { O 128 vector } add68_315_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_214_out \
    op interface \
    ports { add68_214_out { O 128 vector } add68_214_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_113_out \
    op interface \
    ports { add68_113_out { O 128 vector } add68_113_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add6812_out \
    op interface \
    ports { add6812_out { O 128 vector } add6812_out_ap_vld { O 1 bit } } \
} "
}
