...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_743_out \
    op interface \
    ports { add68_743_out { O 128 vector } add68_743_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_642_out \
    op interface \
    ports { add68_642_out { O 128 vector } add68_642_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_541_out \
    op interface \
    ports { add68_541_out { O 128 vector } add68_541_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_440_out \
    op interface \
    ports { add68_440_out { O 128 vector } add68_440_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_339_out \
    op interface \
    ports { add68_339_out { O 128 vector } add68_339_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_238_out \
    op interface \
    ports { add68_238_out { O 128 vector } add68_238_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 117 \
    name add68_12137_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add68_12137_out \
    op interface \
    ports { add68_12137_out { O 128 vector } add68_12137_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add6836_out \
    op interface \
    ports { add6836_out { O 128 vector } add6836_out_ap_vld { O 1 bit } } \
} "
}
