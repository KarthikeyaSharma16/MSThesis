...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv39,
        add68_793_out,
        add68_793_out_ap_vld,
        add68_692_out,
        add68_692_out_ap_vld,
        add68_591_out,
        add68_591_out_ap_vld,
        add68_490_out,
        add68_490_out_ap_vld,
        add68_37089_out,
        add68_37089_out_ap_vld,
        add68_24588_out,
        add68_24588_out_ap_vld,
        add68_12187_out,
        add68_12187_out_ap_vld,
        add6886_out,
        add6886_out_ap_vld,
        p_out,
        p_out_ap_vld
...
input  [63:0] conv39;
output  [127:0] add68_793_out;
output   add68_793_out_ap_vld;
output  [127:0] add68_692_out;
output   add68_692_out_ap_vld;
output  [127:0] add68_591_out;
output   add68_591_out_ap_vld;
output  [127:0] add68_490_out;
output   add68_490_out_ap_vld;
output  [127:0] add68_37089_out;
output   add68_37089_out_ap_vld;
output  [127:0] add68_24588_out;
output   add68_24588_out_ap_vld;
output  [127:0] add68_12187_out;
output   add68_12187_out_ap_vld;
output  [127:0] add6886_out;
output   add6886_out_ap_vld;
output  [127:0] p_out;
output   p_out_ap_vld;

reg ap_idle;
reg add68_793_out_ap_vld;
reg add68_692_out_ap_vld;
reg add68_591_out_ap_vld;
reg add68_490_out_ap_vld;
reg add68_37089_out_ap_vld;
reg add68_24588_out_ap_vld;
reg add68_12187_out_ap_vld;
reg add6886_out_ap_vld;
reg p_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add6886_out_ap_vld = 1'b1;
    end else begin
        add6886_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_12187_out_ap_vld = 1'b1;
    end else begin
        add68_12187_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_24588_out_ap_vld = 1'b1;
    end else begin
        add68_24588_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_37089_out_ap_vld = 1'b1;
    end else begin
        add68_37089_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_490_out_ap_vld = 1'b1;
    end else begin
        add68_490_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_591_out_ap_vld = 1'b1;
    end else begin
        add68_591_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_692_out_ap_vld = 1'b1;
    end else begin
        add68_692_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_793_out_ap_vld = 1'b1;
    end else begin
        add68_793_out_ap_vld = 1'b0;
    end
end
...
assign add6886_out = add6886_fu_164;

assign add68_12187_out = add68_12187_fu_168;

assign add68_24588_out = add68_24588_fu_172;

assign add68_37089_out = add68_37089_fu_176;

assign add68_490_out = add68_490_fu_180;

assign add68_591_out = add68_591_fu_184;

assign add68_692_out = add68_692_fu_188;

assign add68_793_out = add68_793_fu_192;
...
assign add_ln54_10_fu_2767_p2 = (add68_12187_fu_168 + add_ln54_9_fu_2763_p2);
...
assign add_ln54_17_fu_2787_p2 = (add68_24588_fu_172 + add_ln54_16_fu_2782_p2);
...
assign add_ln54_25_fu_2817_p2 = (add68_37089_fu_176 + add_ln54_24_fu_2811_p2);
...
assign add_ln54_33_fu_2847_p2 = (add68_490_fu_180 + add_ln54_32_fu_2841_p2);
...
assign add_ln54_40_fu_2867_p2 = (add68_591_fu_184 + add_ln54_39_fu_2862_p2);
...
assign add_ln54_46_fu_2877_p2 = (add68_692_fu_188 + add_ln54_45_fu_2873_p2);
...
assign add_ln54_4_fu_2757_p2 = (add6886_fu_164 + add_ln54_3_fu_2753_p2);

assign add_ln54_50_fu_2883_p2 = (add_ln54_49_reg_3675 + add_ln54_47_reg_3670);

assign add_ln54_51_fu_2887_p2 = (add68_793_fu_192 + add_ln54_50_fu_2883_p2);
