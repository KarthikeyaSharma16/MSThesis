...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_744_out \
    op interface \
    ports { add68_744_out { O 128 vector } add68_744_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_643_out \
    op interface \
    ports { add68_643_out { O 128 vector } add68_643_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_542_out \
    op interface \
    ports { add68_542_out { O 128 vector } add68_542_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_441_out \
    op interface \
    ports { add68_441_out { O 128 vector } add68_441_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_340_out \
    op interface \
    ports { add68_340_out { O 128 vector } add68_340_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add68_239_out \
    op interface \
    ports { add68_239_out { O 128 vector } add68_239_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 117 \
    name add68_12238_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add68_12238_out \
    op interface \
    ports { add68_12238_out { O 128 vector } add68_12238_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add6837_out \
    op interface \
    ports { add6837_out { O 128 vector } add6837_out_ap_vld { O 1 bit } } \
} "
}
