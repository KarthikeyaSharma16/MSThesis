...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv39,
        add68_3151_1204_out,
        add68_3151_1204_out_ap_vld,
        add68_3151203_out,
        add68_3151203_out_ap_vld,
        add68_2125_1202_out,
        add68_2125_1202_out_ap_vld,
        add68_2125201_out,
        add68_2125201_out_ap_vld,
        add68_1100_1200_out,
        add68_1100_1200_out_ap_vld,
        add68_1100199_out,
        add68_1100199_out_ap_vld,
        add68_1181198_out,
        add68_1181198_out_ap_vld,
        add68197_out,
        add68197_out_ap_vld,
        p_out,
        p_out_ap_vld
...
input  [63:0] conv39;
output  [127:0] add68_3151_1204_out;
output   add68_3151_1204_out_ap_vld;
output  [127:0] add68_3151203_out;
output   add68_3151203_out_ap_vld;
output  [127:0] add68_2125_1202_out;
output   add68_2125_1202_out_ap_vld;
output  [127:0] add68_2125201_out;
output   add68_2125201_out_ap_vld;
output  [127:0] add68_1100_1200_out;
output   add68_1100_1200_out_ap_vld;
output  [127:0] add68_1100199_out;
output   add68_1100199_out_ap_vld;
output  [127:0] add68_1181198_out;
output   add68_1181198_out_ap_vld;
...
reg ap_idle;
reg add68_3151_1204_out_ap_vld;
reg add68_3151203_out_ap_vld;
reg add68_2125_1202_out_ap_vld;
reg add68_2125201_out_ap_vld;
reg add68_1100_1200_out_ap_vld;
reg add68_1100199_out_ap_vld;
reg add68_1181198_out_ap_vld;
...
reg   [127:0] add68_1181198_fu_168;
wire   [127:0] add_ln54_10_fu_2767_p2;
reg   [127:0] add68_1100199_fu_172;
wire   [127:0] add_ln54_17_fu_2787_p2;
reg   [127:0] add68_1100_1200_fu_176;
wire   [127:0] add_ln54_25_fu_2817_p2;
reg   [127:0] add68_2125201_fu_180;
wire   [127:0] add_ln54_33_fu_2847_p2;
reg   [127:0] add68_2125_1202_fu_184;
wire   [127:0] add_ln54_40_fu_2867_p2;
reg   [127:0] add68_3151203_fu_188;
wire   [127:0] add_ln54_46_fu_2877_p2;
reg   [127:0] add68_3151_1204_fu_192;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_1100199_out_ap_vld = 1'b1;
    end else begin
        add68_1100199_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_1100_1200_out_ap_vld = 1'b1;
    end else begin
        add68_1100_1200_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_1181198_out_ap_vld = 1'b1;
    end else begin
        add68_1181198_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_2125201_out_ap_vld = 1'b1;
    end else begin
        add68_2125201_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_2125_1202_out_ap_vld = 1'b1;
    end else begin
        add68_2125_1202_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_3151203_out_ap_vld = 1'b1;
    end else begin
        add68_3151203_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_3305 == 1'd1))) begin
        add68_3151_1204_out_ap_vld = 1'b1;
    end else begin
        add68_3151_1204_out_ap_vld = 1'b0;
    end
end
...
assign add68_1100199_out = add68_1100199_fu_172;

assign add68_1100_1200_out = add68_1100_1200_fu_176;

assign add68_1181198_out = add68_1181198_fu_168;

assign add68_2125201_out = add68_2125201_fu_180;

assign add68_2125_1202_out = add68_2125_1202_fu_184;

assign add68_3151203_out = add68_3151203_fu_188;

assign add68_3151_1204_out = add68_3151_1204_fu_192;
...
assign add_ln54_10_fu_2767_p2 = (add68_1181198_fu_168 + add_ln54_9_fu_2763_p2);
...
assign add_ln54_17_fu_2787_p2 = (add68_1100199_fu_172 + add_ln54_16_fu_2782_p2);
...
assign add_ln54_25_fu_2817_p2 = (add68_1100_1200_fu_176 + add_ln54_24_fu_2811_p2);
...
assign add_ln54_33_fu_2847_p2 = (add68_2125201_fu_180 + add_ln54_32_fu_2841_p2);
...
assign add_ln54_40_fu_2867_p2 = (add68_2125_1202_fu_184 + add_ln54_39_fu_2862_p2);
...
assign add_ln54_46_fu_2877_p2 = (add68_3151203_fu_188 + add_ln54_45_fu_2873_p2);
...
assign add_ln54_51_fu_2887_p2 = (add68_3151_1204_fu_192 + add_ln54_50_fu_2883_p2);
