...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv39,
        add68_3_145_out,
        add68_3_145_out_ap_vld,
        add68_344_out,
        add68_344_out_ap_vld,
        add68_2_143_out,
        add68_2_143_out_ap_vld,
        add68_242_out,
        add68_242_out_ap_vld,
        add68_1_141_out,
        add68_1_141_out_ap_vld,
        add68_140_out,
        add68_140_out_ap_vld,
        add68_12239_out,
        add68_12239_out_ap_vld,
        add6838_out,
        add6838_out_ap_vld,
        p_out,
        p_out_ap_vld
...
input  [63:0] conv39;
output  [127:0] add68_3_145_out;
output   add68_3_145_out_ap_vld;
output  [127:0] add68_344_out;
output   add68_344_out_ap_vld;
output  [127:0] add68_2_143_out;
output   add68_2_143_out_ap_vld;
output  [127:0] add68_242_out;
output   add68_242_out_ap_vld;
output  [127:0] add68_1_141_out;
output   add68_1_141_out_ap_vld;
output  [127:0] add68_140_out;
output   add68_140_out_ap_vld;
output  [127:0] add68_12239_out;
output   add68_12239_out_ap_vld;
output  [127:0] add6838_out;
output   add6838_out_ap_vld;
output  [127:0] p_out;
output   p_out_ap_vld;

reg ap_idle;
reg add68_3_145_out_ap_vld;
reg add68_344_out_ap_vld;
reg add68_2_143_out_ap_vld;
reg add68_242_out_ap_vld;
reg add68_1_141_out_ap_vld;
reg add68_140_out_ap_vld;
reg add68_12239_out_ap_vld;
reg add6838_out_ap_vld;
reg p_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add6838_fu_156 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add6838_fu_156 <= add_ln54_1_fu_940_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add68_12239_fu_160 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add68_12239_fu_160 <= add_ln54_3_fu_1022_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add68_140_fu_164 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add68_140_fu_164 <= add_ln54_5_fu_1119_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add68_1_141_fu_168 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add68_1_141_fu_168 <= add_ln54_7_fu_1216_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add68_242_fu_172 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add68_242_fu_172 <= add_ln54_9_fu_1313_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add68_2_143_fu_176 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add68_2_143_fu_176 <= add_ln54_11_fu_1420_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add68_344_fu_180 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add68_344_fu_180 <= add_ln54_13_fu_1503_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add68_3_145_fu_184 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add68_3_145_fu_184 <= add_ln54_15_fu_1572_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln36_fu_558_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_188 <= indvars_iv_next47_fu_596_p2;
...
always @ (*) begin
    if (((icmp_ln36_fu_558_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add6838_out_ap_vld = 1'b1;
    end else begin
        add6838_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_558_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add68_12239_out_ap_vld = 1'b1;
    end else begin
        add68_12239_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_558_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add68_140_out_ap_vld = 1'b1;
    end else begin
        add68_140_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_558_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add68_1_141_out_ap_vld = 1'b1;
    end else begin
        add68_1_141_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_558_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add68_242_out_ap_vld = 1'b1;
    end else begin
        add68_242_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_558_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add68_2_143_out_ap_vld = 1'b1;
    end else begin
        add68_2_143_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_558_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add68_344_out_ap_vld = 1'b1;
    end else begin
        add68_344_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_558_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add68_3_145_out_ap_vld = 1'b1;
    end else begin
        add68_3_145_out_ap_vld = 1'b0;
    end
end
...
assign add6838_out = add6838_fu_156;

assign add68_12239_out = add68_12239_fu_160;

assign add68_140_out = add68_140_fu_164;

assign add68_1_141_out = add68_1_141_fu_168;

assign add68_242_out = add68_242_fu_172;

assign add68_2_143_out = add68_2_143_fu_176;

assign add68_344_out = add68_344_fu_180;

assign add68_3_145_out = add68_3_145_fu_184;
...
assign add_ln54_11_fu_1420_p2 = (add68_2_143_fu_176 + add_ln54_10_fu_1414_p2);

assign add_ln54_12_fu_1497_p2 = (and_ln54_12_fu_1491_p2 + and_ln54_11_fu_1477_p2);

assign add_ln54_13_fu_1503_p2 = (add68_344_fu_180 + add_ln54_12_fu_1497_p2);

assign add_ln54_14_fu_1566_p2 = (and_ln54_13_fu_1560_p2 + mul_ln54_14_fu_489_p2);

assign add_ln54_15_fu_1572_p2 = (add68_3_145_fu_184 + add_ln54_14_fu_1566_p2);

assign add_ln54_1_fu_940_p2 = (add6838_fu_156 + add_ln54_fu_934_p2);

assign add_ln54_2_fu_1016_p2 = (and_ln54_2_fu_1010_p2 + and_ln54_1_fu_991_p2);

assign add_ln54_3_fu_1022_p2 = (add68_12239_fu_160 + add_ln54_2_fu_1016_p2);

assign add_ln54_4_fu_1113_p2 = (and_ln54_4_fu_1107_p2 + and_ln54_3_fu_1093_p2);

assign add_ln54_5_fu_1119_p2 = (add68_140_fu_164 + add_ln54_4_fu_1113_p2);

assign add_ln54_6_fu_1210_p2 = (and_ln54_6_fu_1204_p2 + and_ln54_5_fu_1190_p2);

assign add_ln54_7_fu_1216_p2 = (add68_1_141_fu_168 + add_ln54_6_fu_1210_p2);

assign add_ln54_8_fu_1307_p2 = (and_ln54_8_fu_1301_p2 + and_ln54_7_fu_1287_p2);

assign add_ln54_9_fu_1313_p2 = (add68_242_fu_172 + add_ln54_8_fu_1307_p2);
...
assign indvars_iv_next47_fu_596_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(4'd15));
