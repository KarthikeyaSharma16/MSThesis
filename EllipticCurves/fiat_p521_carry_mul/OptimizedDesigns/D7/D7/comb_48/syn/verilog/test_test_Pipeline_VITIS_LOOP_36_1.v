...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_cast,
        add_3_1106_out,
        add_3_1106_out_ap_vld,
        add_3105_out,
        add_3105_out_ap_vld,
        add_2_1104_out,
        add_2_1104_out_ap_vld,
        add_2103_out,
        add_2103_out_ap_vld,
        add_1_1102_out,
        add_1_1102_out_ap_vld,
        add_1101_out,
        add_1101_out_ap_vld,
        add_162100_out,
        add_162100_out_ap_vld,
        add99_out,
        add99_out_ap_vld
);
...
output  [127:0] add_3_1106_out;
output   add_3_1106_out_ap_vld;
output  [127:0] add_3105_out;
output   add_3105_out_ap_vld;
output  [127:0] add_2_1104_out;
output   add_2_1104_out_ap_vld;
output  [127:0] add_2103_out;
output   add_2103_out_ap_vld;
output  [127:0] add_1_1102_out;
output   add_1_1102_out_ap_vld;
output  [127:0] add_1101_out;
output   add_1101_out_ap_vld;
output  [127:0] add_162100_out;
output   add_162100_out_ap_vld;
output  [127:0] add99_out;
output   add99_out_ap_vld;

reg ap_idle;
reg add_3_1106_out_ap_vld;
reg add_3105_out_ap_vld;
reg add_2_1104_out_ap_vld;
reg add_2103_out_ap_vld;
reg add_1_1102_out_ap_vld;
reg add_1101_out_ap_vld;
reg add_162100_out_ap_vld;
reg add99_out_ap_vld;
...
reg   [0:0] tmp_30_reg_1167;
wire   [0:0] tmp_31_fu_434_p3;
reg   [0:0] tmp_31_reg_1172;
reg   [0:0] tmp_31_reg_1172_pp0_iter1_reg;
...
wire   [1:0] tmp_32_fu_498_p4;
wire   [3:0] zext_ln50_3_fu_514_p1;
wire   [2:0] tmp_33_fu_530_p4;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_396_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_30_reg_1167 <= ap_sig_allocacmp_i_2[32'd3];
        tmp_31_reg_1172 <= ap_sig_allocacmp_i_2[32'd3];
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add99_out_ap_vld = 1'b1;
    end else begin
        add99_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1101_out_ap_vld = 1'b1;
    end else begin
        add_1101_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_162100_out_ap_vld = 1'b1;
    end else begin
        add_162100_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1_1102_out_ap_vld = 1'b1;
    end else begin
        add_1_1102_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_2_1104_out_ap_vld = 1'b1;
    end else begin
        add_2_1104_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_3105_out_ap_vld = 1'b1;
    end else begin
        add_3105_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_3_1106_out_ap_vld = 1'b1;
    end else begin
        add_3_1106_out_ap_vld = 1'b0;
    end
end
...
assign add99_out = arr_8_fu_118;

assign add_1101_out = arr_10_fu_126;

assign add_162100_out = arr_9_fu_122;

assign add_1_1102_out = arr_11_fu_130;

assign add_2103_out = arr_12_fu_134;

assign add_2_1104_out = arr_13_fu_138;

assign add_3105_out = arr_14_fu_142;

assign add_3_1106_out = arr_15_fu_146;
...
assign icmp_ln49_3_fu_508_p2 = ((tmp_32_fu_498_p4 != 2'd0) ? 1'b1 : 1'b0);

assign icmp_ln49_4_fu_524_p2 = ((ap_sig_allocacmp_i_2 > 4'd2) ? 1'b1 : 1'b0);

assign icmp_ln49_5_fu_540_p2 = ((tmp_33_fu_530_p4 != 3'd0) ? 1'b1 : 1'b0);
...
assign select_ln49_1_fu_812_p3 = ((tmp_31_reg_1172_pp0_iter1_reg[0:0] == 1'b1) ? 128'd340282366920938463463374607431768211455 : 128'd0);
...
assign select_ln49_fu_568_p3 = ((tmp_30_reg_1167[0:0] == 1'b1) ? arg2_r_7_cast : arg2_r_8_cast);

assign select_ln50_fu_448_p3 = ((tmp_31_fu_434_p3[0:0] == 1'b1) ? 4'd7 : 4'd8);
...
assign tmp_31_fu_434_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_32_fu_498_p4 = {{ap_sig_allocacmp_i_2[3:2]}};

assign tmp_33_fu_530_p4 = {{ap_sig_allocacmp_i_2[3:1]}};
