...
module test_test_Pipeline_VITIS_LOOP_56_5 (
        ...
        arg2_r_8_reload,
        add114_7137_out,
        add114_7137_out_ap_vld,
        add114_6136_out,
        add114_6136_out_ap_vld,
        add114_5135_out,
        add114_5135_out_ap_vld,
        add114_4134_out,
        add114_4134_out_ap_vld,
        add114_3133_out,
        add114_3133_out_ap_vld,
        add114_2132_out,
        add114_2132_out_ap_vld,
        add114_1131_out,
        add114_1131_out_ap_vld,
        add114130_out,
        add114130_out_ap_vld,
        add87129_out,
        add87129_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [127:0] add_171_3145_reload;
input  [127:0] add_171_2144_reload;
input  [127:0] add_171_1143_reload;
input  [127:0] add_171142_reload;
input  [127:0] add_3117141_reload;
input  [127:0] add_2103140_reload;
input  [127:0] add_189139_reload;
input  [127:0] add138_reload;
...
output  [127:0] add114_7137_out;
output   add114_7137_out_ap_vld;
output  [127:0] add114_6136_out;
output   add114_6136_out_ap_vld;
output  [127:0] add114_5135_out;
output   add114_5135_out_ap_vld;
output  [127:0] add114_4134_out;
output   add114_4134_out_ap_vld;
output  [127:0] add114_3133_out;
output   add114_3133_out_ap_vld;
output  [127:0] add114_2132_out;
output   add114_2132_out_ap_vld;
output  [127:0] add114_1131_out;
output   add114_1131_out_ap_vld;
output  [127:0] add114130_out;
output   add114130_out_ap_vld;
output  [127:0] add87129_out;
output   add87129_out_ap_vld;

reg ap_idle;
reg add114_7137_out_ap_vld;
reg add114_6136_out_ap_vld;
reg add114_5135_out_ap_vld;
reg add114_4134_out_ap_vld;
reg add114_3133_out_ap_vld;
reg add114_2132_out_ap_vld;
reg add114_1131_out_ap_vld;
reg add114130_out_ap_vld;
reg add87129_out_ap_vld;
...
wire   [2:0] tmp_8_fu_618_p4;
wire   [3:0] zext_ln71_4_fu_634_p1;
wire   [3:0] tmp_11_fu_650_p4;
wire   [3:0] tmp_2_fu_700_p10;
wire   [63:0] tmp_2_fu_700_p11;
wire   [63:0] tmp_3_fu_720_p11;
wire   [63:0] tmp_4_fu_739_p11;
wire   [63:0] tmp_5_fu_758_p11;
wire   [63:0] tmp_6_fu_777_p11;
wire   [63:0] tmp_7_fu_796_p11;
wire   [63:0] tmp_9_fu_815_p11;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114130_out_ap_vld = 1'b1;
    end else begin
        add114130_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_1131_out_ap_vld = 1'b1;
    end else begin
        add114_1131_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_2132_out_ap_vld = 1'b1;
    end else begin
        add114_2132_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_3133_out_ap_vld = 1'b1;
    end else begin
        add114_3133_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_4134_out_ap_vld = 1'b1;
    end else begin
        add114_4134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_5135_out_ap_vld = 1'b1;
    end else begin
        add114_5135_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_6136_out_ap_vld = 1'b1;
    end else begin
        add114_6136_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_7137_out_ap_vld = 1'b1;
    end else begin
        add114_7137_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add87129_out_ap_vld = 1'b1;
    end else begin
        add87129_out_ap_vld = 1'b0;
    end
end
...
assign add114130_out = add114130_fu_144;

assign add114_1131_out = add114_1131_fu_148;

assign add114_2132_out = add114_2132_fu_152;

assign add114_3133_out = add114_3133_fu_156;

assign add114_4134_out = add114_4134_fu_160;

assign add114_5135_out = add114_5135_fu_164;

assign add114_6136_out = add114_6136_fu_168;

assign add114_7137_out = add114_7137_fu_172;

assign add87129_out = add87129_fu_140;

assign add_ln56_fu_672_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(5'd31));

assign add_ln63_fu_918_p2 = (mul_ln63_reg_1431 + add87129_fu_140);

assign add_ln70_1_fu_953_p2 = (and_ln70_1_fu_948_p2 + add114_1131_fu_148);

assign add_ln70_2_fu_971_p2 = (and_ln70_2_fu_966_p2 + add114_2132_fu_152);

assign add_ln70_3_fu_989_p2 = (and_ln70_3_fu_984_p2 + add114_3133_fu_156);

assign add_ln70_4_fu_1007_p2 = (and_ln70_4_fu_1002_p2 + add114_4134_fu_160);

assign add_ln70_5_fu_1025_p2 = (and_ln70_5_fu_1020_p2 + add114_5135_fu_164);

assign add_ln70_6_fu_1043_p2 = (and_ln70_6_fu_1038_p2 + add114_6136_fu_168);

assign add_ln70_7_fu_1061_p2 = (and_ln70_7_fu_1056_p2 + add114_7137_fu_172);

assign add_ln70_fu_935_p2 = (and_ln70_fu_930_p2 + add114130_fu_144);
...
assign icmp_ln62_fu_510_p2 = ((tmp_1_fu_500_p4 != 2'd1) ? 1'b1 : 1'b0);
...
assign icmp_ln70_3_fu_628_p2 = (($signed(tmp_8_fu_618_p4) < $signed(3'd1)) ? 1'b1 : 1'b0);
...
assign mul_ln70_fu_403_p00 = tmp_3_fu_720_p11;
...
assign tmp_1_fu_500_p4 = {{ap_sig_allocacmp_i_1[4:3]}};

assign tmp_2_fu_700_p10 = ($signed(4'd8) - $signed(trunc_ln34_reg_1348));

assign tmp_8_fu_618_p4 = {{ap_sig_allocacmp_i_1[4:2]}};

assign tmp_fu_488_p3 = ap_sig_allocacmp_i_1[32'd4];

assign trunc_ln34_fu_496_p1 = ap_sig_allocacmp_i_1[3:0];

assign zext_ln63_fu_688_p1 = tmp_s_reg_1363;
