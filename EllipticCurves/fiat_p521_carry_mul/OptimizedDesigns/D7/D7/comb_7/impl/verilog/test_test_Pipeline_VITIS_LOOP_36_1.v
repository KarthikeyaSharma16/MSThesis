...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg1_r_7_reload,
        add_3_1139_out,
        add_3_1139_out_ap_vld,
        add_3138_out,
        add_3138_out_ap_vld,
        add_2_1137_out,
        add_2_1137_out_ap_vld,
        add_2136_out,
        add_2136_out_ap_vld,
        add_179_1135_out,
        add_179_1135_out_ap_vld,
        add_179134_out,
        add_179134_out_ap_vld,
        add_195133_out,
        add_195133_out_ap_vld,
        add132_out,
        add132_out_ap_vld
);
...
output  [127:0] add_3_1139_out;
output   add_3_1139_out_ap_vld;
output  [127:0] add_3138_out;
output   add_3138_out_ap_vld;
output  [127:0] add_2_1137_out;
output   add_2_1137_out_ap_vld;
output  [127:0] add_2136_out;
output   add_2136_out_ap_vld;
output  [127:0] add_179_1135_out;
output   add_179_1135_out_ap_vld;
output  [127:0] add_179134_out;
output   add_179134_out_ap_vld;
output  [127:0] add_195133_out;
output   add_195133_out_ap_vld;
output  [127:0] add132_out;
output   add132_out_ap_vld;

reg ap_idle;
reg add_3_1139_out_ap_vld;
reg add_3138_out_ap_vld;
reg add_2_1137_out_ap_vld;
reg add_2136_out_ap_vld;
reg add_179_1135_out_ap_vld;
reg add_179134_out_ap_vld;
reg add_195133_out_ap_vld;
reg add132_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add132_out_ap_vld = 1'b1;
    end else begin
        add132_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_179134_out_ap_vld = 1'b1;
    end else begin
        add_179134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_179_1135_out_ap_vld = 1'b1;
    end else begin
        add_179_1135_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_195133_out_ap_vld = 1'b1;
    end else begin
        add_195133_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2136_out_ap_vld = 1'b1;
    end else begin
        add_2136_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2_1137_out_ap_vld = 1'b1;
    end else begin
        add_2_1137_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3138_out_ap_vld = 1'b1;
    end else begin
        add_3138_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3_1139_out_ap_vld = 1'b1;
    end else begin
        add_3_1139_out_ap_vld = 1'b0;
    end
end
...
assign add132_out = arr_8_fu_122;

assign add_179134_out = arr_10_fu_130;

assign add_179_1135_out = arr_11_fu_134;

assign add_195133_out = arr_9_fu_126;

assign add_2136_out = arr_12_fu_138;

assign add_2_1137_out = arr_13_fu_142;

assign add_3138_out = arr_14_fu_146;

assign add_3_1139_out = arr_15_fu_150;
