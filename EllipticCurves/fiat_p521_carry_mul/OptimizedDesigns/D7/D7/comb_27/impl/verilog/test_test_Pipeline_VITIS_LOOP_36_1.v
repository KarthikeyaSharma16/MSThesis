...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg1_r_1_reload,
        add_189_3163_out,
        add_189_3163_out_ap_vld,
        add_189_2162_out,
        add_189_2162_out_ap_vld,
        add_189_1161_out,
        add_189_1161_out_ap_vld,
        add_189160_out,
        add_189160_out_ap_vld,
        add_3135159_out,
        add_3135159_out_ap_vld,
        add_2121158_out,
        add_2121158_out_ap_vld,
        add_1107157_out,
        add_1107157_out_ap_vld,
        add156_out,
        add156_out_ap_vld
);
...
output  [127:0] add_189_3163_out;
output   add_189_3163_out_ap_vld;
output  [127:0] add_189_2162_out;
output   add_189_2162_out_ap_vld;
output  [127:0] add_189_1161_out;
output   add_189_1161_out_ap_vld;
output  [127:0] add_189160_out;
output   add_189160_out_ap_vld;
output  [127:0] add_3135159_out;
output   add_3135159_out_ap_vld;
output  [127:0] add_2121158_out;
output   add_2121158_out_ap_vld;
output  [127:0] add_1107157_out;
output   add_1107157_out_ap_vld;
output  [127:0] add156_out;
output   add156_out_ap_vld;

reg ap_idle;
reg add_189_3163_out_ap_vld;
reg add_189_2162_out_ap_vld;
reg add_189_1161_out_ap_vld;
reg add_189160_out_ap_vld;
reg add_3135159_out_ap_vld;
reg add_2121158_out_ap_vld;
reg add_1107157_out_ap_vld;
reg add156_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add156_out_ap_vld = 1'b1;
    end else begin
        add156_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_1107157_out_ap_vld = 1'b1;
    end else begin
        add_1107157_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_189_2162_out_ap_vld = 1'b1;
    end else begin
        add_189_2162_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_189_3163_out_ap_vld = 1'b1;
    end else begin
        add_189_3163_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_2121158_out_ap_vld = 1'b1;
    end else begin
        add_2121158_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_3135159_out_ap_vld = 1'b1;
    end else begin
        add_3135159_out_ap_vld = 1'b0;
    end
end
...
assign add156_out = arr_8_fu_120;

assign add_1107157_out = arr_9_fu_124;

assign add_189160_out = arr_12_fu_136;

assign add_189_1161_out = arr_13_fu_140;

assign add_189_2162_out = arr_14_fu_144;

assign add_189_3163_out = arr_15_fu_148;

assign add_2121158_out = arr_10_fu_128;

assign add_3135159_out = arr_11_fu_132;
