...
module test_test_Pipeline_VITIS_LOOP_56_5 (
        ...
        arg2_r_8_reload,
        add114_3_1155_out,
        add114_3_1155_out_ap_vld,
        add114_3154_out,
        add114_3154_out_ap_vld,
        add114_2_1153_out,
        add114_2_1153_out_ap_vld,
        add114_2152_out,
        add114_2152_out_ap_vld,
        add114_1_1151_out,
        add114_1_1151_out_ap_vld,
        add114_1150_out,
        add114_1150_out_ap_vld,
        add114_127149_out,
        add114_127149_out_ap_vld,
        add114148_out,
        add114148_out_ap_vld,
        add87147_out,
        add87147_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [127:0] add_189_3163_reload;
input  [127:0] add_189_2162_reload;
input  [127:0] add_189_1161_reload;
input  [127:0] add_189160_reload;
input  [127:0] add_3135159_reload;
input  [127:0] add_2121158_reload;
input  [127:0] add_1107157_reload;
input  [127:0] add156_reload;
...
output  [127:0] add114_3_1155_out;
output   add114_3_1155_out_ap_vld;
output  [127:0] add114_3154_out;
output   add114_3154_out_ap_vld;
output  [127:0] add114_2_1153_out;
output   add114_2_1153_out_ap_vld;
output  [127:0] add114_2152_out;
output   add114_2152_out_ap_vld;
output  [127:0] add114_1_1151_out;
output   add114_1_1151_out_ap_vld;
output  [127:0] add114_1150_out;
output   add114_1150_out_ap_vld;
output  [127:0] add114_127149_out;
output   add114_127149_out_ap_vld;
output  [127:0] add114148_out;
output   add114148_out_ap_vld;
output  [127:0] add87147_out;
output   add87147_out_ap_vld;

reg ap_idle;
reg add114_3_1155_out_ap_vld;
reg add114_3154_out_ap_vld;
reg add114_2_1153_out_ap_vld;
reg add114_2152_out_ap_vld;
reg add114_1_1151_out_ap_vld;
reg add114_1150_out_ap_vld;
reg add114_127149_out_ap_vld;
reg add114148_out_ap_vld;
reg add87147_out_ap_vld;
...
reg   [127:0] add87147_fu_140;
wire   [127:0] add_ln63_fu_918_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [127:0] add114148_fu_144;
wire   [127:0] add_ln70_fu_935_p2;
reg   [127:0] add114_127149_fu_148;
wire   [127:0] add_ln70_1_fu_953_p2;
reg   [127:0] add114_1150_fu_152;
wire   [127:0] add_ln70_2_fu_971_p2;
reg   [127:0] add114_1_1151_fu_156;
wire   [127:0] add_ln70_3_fu_989_p2;
reg   [127:0] add114_2152_fu_160;
wire   [127:0] add_ln70_4_fu_1007_p2;
reg   [127:0] add114_2_1153_fu_164;
wire   [127:0] add_ln70_5_fu_1025_p2;
reg   [127:0] add114_3154_fu_168;
wire   [127:0] add_ln70_6_fu_1043_p2;
reg   [127:0] add114_3_1155_fu_172;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114148_out_ap_vld = 1'b1;
    end else begin
        add114148_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_1150_out_ap_vld = 1'b1;
    end else begin
        add114_1150_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_127149_out_ap_vld = 1'b1;
    end else begin
        add114_127149_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_1_1151_out_ap_vld = 1'b1;
    end else begin
        add114_1_1151_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_2_1153_out_ap_vld = 1'b1;
    end else begin
        add114_2_1153_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_3154_out_ap_vld = 1'b1;
    end else begin
        add114_3154_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_3_1155_out_ap_vld = 1'b1;
    end else begin
        add114_3_1155_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add87147_out_ap_vld = 1'b1;
    end else begin
        add87147_out_ap_vld = 1'b0;
    end
end
...
assign add114148_out = add114148_fu_144;

assign add114_1150_out = add114_1150_fu_152;

assign add114_127149_out = add114_127149_fu_148;

assign add114_1_1151_out = add114_1_1151_fu_156;

assign add114_2152_out = add114_2152_fu_160;

assign add114_2_1153_out = add114_2_1153_fu_164;

assign add114_3154_out = add114_3154_fu_168;

assign add114_3_1155_out = add114_3_1155_fu_172;

assign add87147_out = add87147_fu_140;

assign add_ln56_fu_672_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(5'd31));

assign add_ln63_fu_918_p2 = (mul_ln63_reg_1431 + add87147_fu_140);

assign add_ln70_1_fu_953_p2 = (and_ln70_1_fu_948_p2 + add114_127149_fu_148);

assign add_ln70_2_fu_971_p2 = (and_ln70_2_fu_966_p2 + add114_1150_fu_152);

assign add_ln70_3_fu_989_p2 = (and_ln70_3_fu_984_p2 + add114_1_1151_fu_156);

assign add_ln70_4_fu_1007_p2 = (and_ln70_4_fu_1002_p2 + add114_2152_fu_160);

assign add_ln70_5_fu_1025_p2 = (and_ln70_5_fu_1020_p2 + add114_2_1153_fu_164);

assign add_ln70_6_fu_1043_p2 = (and_ln70_6_fu_1038_p2 + add114_3154_fu_168);

assign add_ln70_7_fu_1061_p2 = (and_ln70_7_fu_1056_p2 + add114_3_1155_fu_172);

assign add_ln70_fu_935_p2 = (and_ln70_fu_930_p2 + add114148_fu_144);
