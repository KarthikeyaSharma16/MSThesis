...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_7322_out \
    op interface \
    ports { add_7322_out { O 128 vector } add_7322_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_6321_out \
    op interface \
    ports { add_6321_out { O 128 vector } add_6321_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_5320_out \
    op interface \
    ports { add_5320_out { O 128 vector } add_5320_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_4319_out \
    op interface \
    ports { add_4319_out { O 128 vector } add_4319_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_3318_out \
    op interface \
    ports { add_3318_out { O 128 vector } add_3318_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_2317_out \
    op interface \
    ports { add_2317_out { O 128 vector } add_2317_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_1316_out \
    op interface \
    ports { add_1316_out { O 128 vector } add_1316_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add315_out \
    op interface \
    ports { add315_out { O 128 vector } add315_out_ap_vld { O 1 bit } } \
} "
}
