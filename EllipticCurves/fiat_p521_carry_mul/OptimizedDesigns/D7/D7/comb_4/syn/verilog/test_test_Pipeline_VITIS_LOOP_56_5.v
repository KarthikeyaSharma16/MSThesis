...
module test_test_Pipeline_VITIS_LOOP_56_5 (
        ...
        add114_2124_out,
        add114_2124_out_ap_vld,
        add114_1123_out,
        add114_1123_out_ap_vld,
        add114122_out,
...
output  [127:0] add114_2124_out;
output   add114_2124_out_ap_vld;
output  [127:0] add114_1123_out;
output   add114_1123_out_ap_vld;
output  [127:0] add114122_out;
output   add114122_out_ap_vld;
output  [127:0] add87121_out;
output   add87121_out_ap_vld;
...
reg add114_2124_out_ap_vld;
reg add114_1123_out_ap_vld;
reg add114122_out_ap_vld;
reg add87121_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_10_reg_1344 == 1'd1))) begin
        add114_1123_out_ap_vld = 1'b1;
    end else begin
        add114_1123_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_10_reg_1344 == 1'd1))) begin
        add114_2124_out_ap_vld = 1'b1;
    end else begin
        add114_2124_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_10_reg_1344 == 1'd1))) begin
        add87121_out_ap_vld = 1'b1;
    end else begin
        add87121_out_ap_vld = 1'b0;
    end
end
...
assign add114122_out = add114122_fu_144;

assign add114_1123_out = add114_1123_fu_148;

assign add114_2124_out = add114_2124_fu_152;

assign add114_3125_out = add114_3125_fu_156;

assign add114_4126_out = add114_4126_fu_160;

assign add114_5127_out = add114_5127_fu_164;

assign add114_6128_out = add114_6128_fu_168;

assign add114_7129_out = add114_7129_fu_172;

assign add87121_out = add87121_fu_140;

assign add_ln56_fu_672_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(5'd31));

assign add_ln63_fu_918_p2 = (mul_ln63_reg_1431 + add87121_fu_140);

assign add_ln70_1_fu_953_p2 = (and_ln70_1_fu_948_p2 + add114_1123_fu_148);

assign add_ln70_2_fu_971_p2 = (and_ln70_2_fu_966_p2 + add114_2124_fu_152);

assign add_ln70_3_fu_989_p2 = (and_ln70_3_fu_984_p2 + add114_3125_fu_156);

assign add_ln70_4_fu_1007_p2 = (and_ln70_4_fu_1002_p2 + add114_4126_fu_160);

assign add_ln70_5_fu_1025_p2 = (and_ln70_5_fu_1020_p2 + add114_5127_fu_164);

assign add_ln70_6_fu_1043_p2 = (and_ln70_6_fu_1038_p2 + add114_6128_fu_168);

assign add_ln70_7_fu_1061_p2 = (and_ln70_7_fu_1056_p2 + add114_7129_fu_172);

assign add_ln70_fu_935_p2 = (and_ln70_fu_930_p2 + add114122_fu_144);
