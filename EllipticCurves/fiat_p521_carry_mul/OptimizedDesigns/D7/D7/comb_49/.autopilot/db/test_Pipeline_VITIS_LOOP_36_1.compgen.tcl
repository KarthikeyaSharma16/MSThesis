...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_7108_out \
    op interface \
    ports { add_7108_out { O 128 vector } add_7108_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_6107_out \
    op interface \
    ports { add_6107_out { O 128 vector } add_6107_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_5106_out \
    op interface \
    ports { add_5106_out { O 128 vector } add_5106_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_4105_out \
    op interface \
    ports { add_4105_out { O 128 vector } add_4105_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_3104_out \
    op interface \
    ports { add_3104_out { O 128 vector } add_3104_out_ap_vld { O 1 bit } } \
} "
}
