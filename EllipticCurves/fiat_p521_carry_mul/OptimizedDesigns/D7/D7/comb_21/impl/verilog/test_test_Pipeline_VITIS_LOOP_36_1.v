...
output  [127:0] add_7160_out;
output   add_7160_out_ap_vld;
output  [127:0] add_6159_out;
output   add_6159_out_ap_vld;
output  [127:0] add_5158_out;
output   add_5158_out_ap_vld;
output  [127:0] add_4157_out;
output   add_4157_out_ap_vld;
output  [127:0] add_3156_out;
output   add_3156_out_ap_vld;
output  [127:0] add_2155_out;
output   add_2155_out_ap_vld;
output  [127:0] add_1116154_out;
output   add_1116154_out_ap_vld;
output  [127:0] add153_out;
output   add153_out_ap_vld;

reg ap_idle;
reg add_7160_out_ap_vld;
reg add_6159_out_ap_vld;
reg add_5158_out_ap_vld;
reg add_4157_out_ap_vld;
reg add_3156_out_ap_vld;
reg add_2155_out_ap_vld;
reg add_1116154_out_ap_vld;
reg add153_out_ap_vld;
...
reg   [0:0] tmp_30_reg_1642;
wire   [127:0] mul_ln49_fu_316_p2;
reg   [127:0] mul_ln49_reg_1647;
wire   [0:0] tmp_31_fu_472_p3;
reg   [0:0] tmp_31_reg_1652;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_429_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_30_reg_1642 <= ap_sig_allocacmp_i_2[32'd3];
        tmp_31_reg_1652 <= ap_sig_allocacmp_i_2[32'd3];
...
always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add153_out_ap_vld = 1'b1;
    end else begin
        add153_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1116154_out_ap_vld = 1'b1;
    end else begin
        add_1116154_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2155_out_ap_vld = 1'b1;
    end else begin
        add_2155_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3156_out_ap_vld = 1'b1;
    end else begin
        add_3156_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_4157_out_ap_vld = 1'b1;
    end else begin
        add_4157_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_5158_out_ap_vld = 1'b1;
    end else begin
        add_5158_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6159_out_ap_vld = 1'b1;
    end else begin
        add_6159_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_7160_out_ap_vld = 1'b1;
    end else begin
        add_7160_out_ap_vld = 1'b0;
    end
end
...
assign add153_out = arr_8_fu_122;

assign add_1116154_out = arr_9_fu_126;

assign add_2155_out = arr_10_fu_130;

assign add_3156_out = arr_11_fu_134;

assign add_4157_out = arr_12_fu_138;

assign add_5158_out = arr_13_fu_142;

assign add_6159_out = arr_14_fu_146;

assign add_7160_out = arr_15_fu_150;

assign add_ln36_fu_722_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(4'd14));
...
assign empty_fu_578_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(4'd15));

assign icmp_ln36_fu_429_p2 = ((ap_sig_allocacmp_i_2 == 4'd0) ? 1'b1 : 1'b0);

assign icmp_ln49_10_fu_706_p2 = (($signed(tmp_34_fu_696_p4) > $signed(3'd0)) ? 1'b1 : 1'b0);

assign icmp_ln49_1_fu_504_p2 = ((ap_sig_allocacmp_i_2 > 4'd5) ? 1'b1 : 1'b0);

assign icmp_ln49_2_fu_520_p2 = ((ap_sig_allocacmp_i_2 > 4'd4) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_546_p2 = ((tmp_32_fu_536_p4 != 2'd0) ? 1'b1 : 1'b0);

assign icmp_ln49_4_fu_562_p2 = ((ap_sig_allocacmp_i_2 > 4'd2) ? 1'b1 : 1'b0);
...
assign icmp_ln49_8_fu_664_p2 = ((tmp_33_fu_654_p4 == 2'd1) ? 1'b1 : 1'b0);

assign icmp_ln49_9_fu_680_p2 = (($signed(empty_fu_578_p2) > $signed(4'd2)) ? 1'b1 : 1'b0);

assign icmp_ln49_fu_488_p2 = ((ap_sig_allocacmp_i_2 > 4'd6) ? 1'b1 : 1'b0);
...
assign select_ln34_fu_480_p3 = ((tmp_31_fu_472_p3[0:0] == 1'b1) ? 4'd7 : 4'd8);
...
assign select_ln49_2_fu_757_p3 = ((tmp_31_reg_1652[0:0] == 1'b1) ? 128'd340282366920938463463374607431768211455 : 128'd0);
...
assign select_ln49_fu_775_p3 = ((tmp_30_reg_1642[0:0] == 1'b1) ? arg2_r_7_cast : arg2_r_8_cast);
...
assign tmp_31_fu_472_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_32_fu_536_p4 = {{ap_sig_allocacmp_i_2[3:2]}};

assign tmp_33_fu_654_p4 = {{empty_fu_578_p2[3:2]}};

assign tmp_34_fu_696_p4 = {{empty_fu_578_p2[3:1]}};
