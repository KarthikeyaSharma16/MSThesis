...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_7160_out \
    op interface \
    ports { add_7160_out { O 128 vector } add_7160_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_6159_out \
    op interface \
    ports { add_6159_out { O 128 vector } add_6159_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_5158_out \
    op interface \
    ports { add_5158_out { O 128 vector } add_5158_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_4157_out \
    op interface \
    ports { add_4157_out { O 128 vector } add_4157_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_3156_out \
    op interface \
    ports { add_3156_out { O 128 vector } add_3156_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_2155_out \
    op interface \
    ports { add_2155_out { O 128 vector } add_2155_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 77 \
    name add_1116154_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add_1116154_out \
    op interface \
    ports { add_1116154_out { O 128 vector } add_1116154_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add153_out \
    op interface \
    ports { add153_out { O 128 vector } add153_out_ap_vld { O 1 bit } } \
} "
}
