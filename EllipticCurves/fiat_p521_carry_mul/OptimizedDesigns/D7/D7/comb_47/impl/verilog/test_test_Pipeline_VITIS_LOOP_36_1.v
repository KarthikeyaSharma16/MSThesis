...
output  [127:0] add_739_out;
output   add_739_out_ap_vld;
output  [127:0] add_638_out;
output   add_638_out_ap_vld;
output  [127:0] add_537_out;
output   add_537_out_ap_vld;
output  [127:0] add_436_out;
output   add_436_out_ap_vld;
output  [127:0] add_335_out;
output   add_335_out_ap_vld;
output  [127:0] add_234_out;
output   add_234_out_ap_vld;
output  [127:0] add_133_out;
output   add_133_out_ap_vld;
output  [127:0] add32_out;
output   add32_out_ap_vld;

reg ap_idle;
reg add_739_out_ap_vld;
reg add_638_out_ap_vld;
reg add_537_out_ap_vld;
reg add_436_out_ap_vld;
reg add_335_out_ap_vld;
reg add_234_out_ap_vld;
reg add_133_out_ap_vld;
reg add32_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add32_out_ap_vld = 1'b1;
    end else begin
        add32_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_133_out_ap_vld = 1'b1;
    end else begin
        add_133_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_234_out_ap_vld = 1'b1;
    end else begin
        add_234_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_335_out_ap_vld = 1'b1;
    end else begin
        add_335_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_436_out_ap_vld = 1'b1;
    end else begin
        add_436_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_537_out_ap_vld = 1'b1;
    end else begin
        add_537_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_638_out_ap_vld = 1'b1;
    end else begin
        add_638_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_739_out_ap_vld = 1'b1;
    end else begin
        add_739_out_ap_vld = 1'b0;
    end
end
...
assign add32_out = arr_8_fu_118;

assign add_133_out = arr_9_fu_122;

assign add_234_out = arr_10_fu_126;

assign add_335_out = arr_11_fu_130;

assign add_436_out = arr_12_fu_134;

assign add_537_out = arr_13_fu_138;

assign add_638_out = arr_14_fu_142;

assign add_739_out = arr_15_fu_146;
