...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_739_out \
    op interface \
    ports { add_739_out { O 128 vector } add_739_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_638_out \
    op interface \
    ports { add_638_out { O 128 vector } add_638_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_537_out \
    op interface \
    ports { add_537_out { O 128 vector } add_537_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_436_out \
    op interface \
    ports { add_436_out { O 128 vector } add_436_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_335_out \
    op interface \
    ports { add_335_out { O 128 vector } add_335_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_234_out \
    op interface \
    ports { add_234_out { O 128 vector } add_234_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_133_out \
    op interface \
    ports { add_133_out { O 128 vector } add_133_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add32_out \
    op interface \
    ports { add32_out { O 128 vector } add32_out_ap_vld { O 1 bit } } \
} "
}
