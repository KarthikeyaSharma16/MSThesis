...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg1_r_1_reload,
        add_3192_1255_out,
        add_3192_1255_out_ap_vld,
        add_3192254_out,
        add_3192254_out_ap_vld,
        add_2177_1253_out,
        add_2177_1253_out_ap_vld,
        add_2177252_out,
        add_2177252_out_ap_vld,
        add_1162_1251_out,
        add_1162_1251_out_ap_vld,
        add_1162250_out,
        add_1162250_out_ap_vld,
        add_1210249_out,
        add_1210249_out_ap_vld,
        add248_out,
        add248_out_ap_vld
);
...
output  [127:0] add_3192_1255_out;
output   add_3192_1255_out_ap_vld;
output  [127:0] add_3192254_out;
output   add_3192254_out_ap_vld;
output  [127:0] add_2177_1253_out;
output   add_2177_1253_out_ap_vld;
output  [127:0] add_2177252_out;
output   add_2177252_out_ap_vld;
output  [127:0] add_1162_1251_out;
output   add_1162_1251_out_ap_vld;
output  [127:0] add_1162250_out;
output   add_1162250_out_ap_vld;
output  [127:0] add_1210249_out;
output   add_1210249_out_ap_vld;
output  [127:0] add248_out;
output   add248_out_ap_vld;

reg ap_idle;
reg add_3192_1255_out_ap_vld;
reg add_3192254_out_ap_vld;
reg add_2177_1253_out_ap_vld;
reg add_2177252_out_ap_vld;
reg add_1162_1251_out_ap_vld;
reg add_1162250_out_ap_vld;
reg add_1210249_out_ap_vld;
reg add248_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add248_out_ap_vld = 1'b1;
    end else begin
        add248_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_1162250_out_ap_vld = 1'b1;
    end else begin
        add_1162250_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_1162_1251_out_ap_vld = 1'b1;
    end else begin
        add_1162_1251_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_1210249_out_ap_vld = 1'b1;
    end else begin
        add_1210249_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_2177252_out_ap_vld = 1'b1;
    end else begin
        add_2177252_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_2177_1253_out_ap_vld = 1'b1;
    end else begin
        add_2177_1253_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_3192254_out_ap_vld = 1'b1;
    end else begin
        add_3192254_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_3192_1255_out_ap_vld = 1'b1;
    end else begin
        add_3192_1255_out_ap_vld = 1'b0;
    end
end
...
assign add248_out = arr_8_fu_120;

assign add_1162250_out = arr_10_fu_128;

assign add_1162_1251_out = arr_11_fu_132;

assign add_1210249_out = arr_9_fu_124;

assign add_2177252_out = arr_12_fu_136;

assign add_2177_1253_out = arr_13_fu_140;

assign add_3192254_out = arr_14_fu_144;

assign add_3192_1255_out = arr_15_fu_148;
