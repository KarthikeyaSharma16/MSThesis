...
begin
    ...
    add_ln91_fu_204_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv4_1));
    ...
    icmp_ln91_fu_198_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv4_9) else "0";
    ...
    tmp_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln80),59));
    tmp_fu_210_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln81),59));
    tmp_fu_210_p4 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln83),59));
    tmp_fu_210_p5 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln84),59));
    tmp_fu_210_p6 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln85),59));
    tmp_fu_210_p7 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln86),59));
    tmp_fu_210_p8 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln87),59));
