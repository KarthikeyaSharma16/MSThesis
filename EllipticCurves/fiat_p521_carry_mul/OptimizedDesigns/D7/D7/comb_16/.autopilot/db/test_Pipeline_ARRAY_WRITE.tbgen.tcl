...
set C_modelArgList {
	...
	{ sext_ln91 int 61 regular  }
	{ zext_ln80 int 58 regular  }
	{ zext_ln81 int 58 regular  }
	{ out1_w_2 int 59 regular  }
	{ zext_ln83 int 58 regular  }
	{ zext_ln84 int 58 regular  }
	{ zext_ln85 int 58 regular  }
	{ zext_ln86 int 58 regular  }
	{ zext_ln87 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln91", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln80", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln81", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "out1_w_2", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln83", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln84", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln85", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln86", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln87", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln91 sc_in sc_lv 61 signal 1 } 
	{ zext_ln80 sc_in sc_lv 58 signal 2 } 
	{ zext_ln81 sc_in sc_lv 58 signal 3 } 
	{ out1_w_2 sc_in sc_lv 59 signal 4 } 
	{ zext_ln83 sc_in sc_lv 58 signal 5 } 
	{ zext_ln84 sc_in sc_lv 58 signal 6 } 
	{ zext_ln85 sc_in sc_lv 58 signal 7 } 
	{ zext_ln86 sc_in sc_lv 58 signal 8 } 
	{ zext_ln87 sc_in sc_lv 58 signal 9 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln91", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln91", "role": "default" }} , 
 	{ "name": "zext_ln80", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln80", "role": "default" }} , 
 	{ "name": "zext_ln81", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln81", "role": "default" }} , 
 	{ "name": "out1_w_2", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "out1_w_2", "role": "default" }} , 
 	{ "name": "zext_ln83", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln83", "role": "default" }} , 
 	{ "name": "zext_ln84", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln84", "role": "default" }} , 
 	{ "name": "zext_ln85", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln85", "role": "default" }} , 
 	{ "name": "zext_ln86", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln86", "role": "default" }} , 
 	{ "name": "zext_ln87", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln87", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_9_4_59_1_1_U153", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln91 { ap_none {  { sext_ln91 in_data 0 61 } } }
	zext_ln80 { ap_none {  { zext_ln80 in_data 0 58 } } }
	zext_ln81 { ap_none {  { zext_ln81 in_data 0 58 } } }
	out1_w_2 { ap_none {  { out1_w_2 in_data 0 59 } } }
	zext_ln83 { ap_none {  { zext_ln83 in_data 0 58 } } }
	zext_ln84 { ap_none {  { zext_ln84 in_data 0 58 } } }
	zext_ln85 { ap_none {  { zext_ln85 in_data 0 58 } } }
	zext_ln86 { ap_none {  { zext_ln86 in_data 0 58 } } }
	zext_ln87 { ap_none {  { zext_ln87 in_data 0 58 } } }
