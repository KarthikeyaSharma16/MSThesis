...
output  [127:0] add_185_out;
output   add_185_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_185_out_ap_vld = 1'b1;
    end else begin
        add_185_out_ap_vld = 1'b0;
    end
end
...
assign add84_out = arr_8_fu_118;

assign add_185_out = arr_9_fu_122;

assign add_286_out = arr_10_fu_126;

assign add_387_out = arr_11_fu_130;

assign add_488_out = arr_12_fu_134;

assign add_589_out = arr_13_fu_138;

assign add_690_out = arr_14_fu_142;

assign add_791_out = arr_15_fu_146;
