...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_3_1251_out \
    op interface \
    ports { add_3_1251_out { O 128 vector } add_3_1251_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add_3250_out { O 128 vector } add_3250_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_2_1249_out \
    op interface \
    ports { add_2_1249_out { O 128 vector } add_2_1249_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_2248_out \
    op interface \
    ports { add_2248_out { O 128 vector } add_2248_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_1_1247_out \
    op interface \
    ports { add_1_1247_out { O 128 vector } add_1_1247_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_1246_out \
    op interface \
    ports { add_1246_out { O 128 vector } add_1246_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 64 \
    name add_1159245_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add_1159245_out \
    op interface \
    ports { add_1159245_out { O 128 vector } add_1159245_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add244_out \
    op interface \
    ports { add244_out { O 128 vector } add244_out_ap_vld { O 1 bit } } \
} "
}
