...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_3_154_out \
    op interface \
    ports { add_3_154_out { O 128 vector } add_3_154_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_353_out \
    op interface \
    ports { add_353_out { O 128 vector } add_353_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_2_152_out \
    op interface \
    ports { add_2_152_out { O 128 vector } add_2_152_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_251_out \
    op interface \
    ports { add_251_out { O 128 vector } add_251_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_1_150_out \
    op interface \
    ports { add_1_150_out { O 128 vector } add_1_150_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_149_out \
    op interface \
    ports { add_149_out { O 128 vector } add_149_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_12648_out \
    op interface \
    ports { add_12648_out { O 128 vector } add_12648_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add47_out \
    op interface \
    ports { add47_out { O 128 vector } add47_out_ap_vld { O 1 bit } } \
} "
}
