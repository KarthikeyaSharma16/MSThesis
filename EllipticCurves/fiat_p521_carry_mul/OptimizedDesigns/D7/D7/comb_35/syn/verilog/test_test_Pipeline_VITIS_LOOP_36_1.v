...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_cast,
        add_3_154_out,
        add_3_154_out_ap_vld,
        add_353_out,
        add_353_out_ap_vld,
        add_2_152_out,
        add_2_152_out_ap_vld,
        add_251_out,
        add_251_out_ap_vld,
        add_1_150_out,
        add_1_150_out_ap_vld,
        add_149_out,
        add_149_out_ap_vld,
        add_12648_out,
        add_12648_out_ap_vld,
        add47_out,
        add47_out_ap_vld
);
...
output  [127:0] add_3_154_out;
output   add_3_154_out_ap_vld;
output  [127:0] add_353_out;
output   add_353_out_ap_vld;
output  [127:0] add_2_152_out;
output   add_2_152_out_ap_vld;
output  [127:0] add_251_out;
output   add_251_out_ap_vld;
output  [127:0] add_1_150_out;
output   add_1_150_out_ap_vld;
output  [127:0] add_149_out;
output   add_149_out_ap_vld;
output  [127:0] add_12648_out;
output   add_12648_out_ap_vld;
output  [127:0] add47_out;
output   add47_out_ap_vld;

reg ap_idle;
reg add_3_154_out_ap_vld;
reg add_353_out_ap_vld;
reg add_2_152_out_ap_vld;
reg add_251_out_ap_vld;
reg add_1_150_out_ap_vld;
reg add_149_out_ap_vld;
reg add_12648_out_ap_vld;
reg add47_out_ap_vld;
...
wire   [0:0] tmp_13_fu_434_p3;
reg   [0:0] tmp_13_reg_1172;
reg   [0:0] tmp_13_reg_1172_pp0_iter1_reg;
...
reg   [127:0] arr_8_fu_118;
wire   [127:0] arr_fu_824_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [127:0] arr_9_fu_122;
wire   [127:0] arr_16_fu_842_p2;
reg   [127:0] arr_10_fu_126;
wire   [127:0] arr_17_fu_860_p2;
reg   [127:0] arr_11_fu_130;
wire   [127:0] arr_18_fu_878_p2;
reg   [127:0] arr_12_fu_134;
wire   [127:0] arr_19_fu_896_p2;
reg   [127:0] arr_13_fu_138;
wire   [127:0] arr_20_fu_914_p2;
reg   [127:0] arr_14_fu_142;
wire   [127:0] arr_21_fu_932_p2;
reg   [127:0] arr_15_fu_146;
wire   [127:0] arr_22_fu_938_p2;
reg   [3:0] i_fu_150;
...
wire   [1:0] tmp_14_fu_498_p4;
wire   [3:0] zext_ln50_3_fu_514_p1;
wire   [2:0] tmp_15_fu_530_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_13_reg_1172_pp0_iter1_reg <= tmp_13_reg_1172;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_396_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_12_reg_1167 <= ap_sig_allocacmp_i_2[32'd3];
        tmp_13_reg_1172 <= ap_sig_allocacmp_i_2[32'd3];
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add47_out_ap_vld = 1'b1;
    end else begin
        add47_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_12648_out_ap_vld = 1'b1;
    end else begin
        add_12648_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_149_out_ap_vld = 1'b1;
    end else begin
        add_149_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1_150_out_ap_vld = 1'b1;
    end else begin
        add_1_150_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_251_out_ap_vld = 1'b1;
    end else begin
        add_251_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_2_152_out_ap_vld = 1'b1;
    end else begin
        add_2_152_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_353_out_ap_vld = 1'b1;
    end else begin
        add_353_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_3_154_out_ap_vld = 1'b1;
    end else begin
        add_3_154_out_ap_vld = 1'b0;
    end
end
...
assign add47_out = arr_8_fu_118;

assign add_12648_out = arr_9_fu_122;

assign add_149_out = arr_10_fu_126;

assign add_1_150_out = arr_11_fu_130;

assign add_251_out = arr_12_fu_134;

assign add_2_152_out = arr_13_fu_138;

assign add_353_out = arr_14_fu_142;

assign add_3_154_out = arr_15_fu_146;

assign add_ln36_fu_546_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(4'd15));
...
assign arr_16_fu_842_p2 = (and_ln49_1_fu_837_p2 + arr_9_fu_122);

assign arr_17_fu_860_p2 = (and_ln49_2_fu_855_p2 + arr_10_fu_126);

assign arr_18_fu_878_p2 = (and_ln49_3_fu_873_p2 + arr_11_fu_130);

assign arr_19_fu_896_p2 = (and_ln49_4_fu_891_p2 + arr_12_fu_134);

assign arr_20_fu_914_p2 = (and_ln49_5_fu_909_p2 + arr_13_fu_138);

assign arr_21_fu_932_p2 = (and_ln49_6_fu_927_p2 + arr_14_fu_142);

assign arr_22_fu_938_p2 = (mul_ln49_7_reg_1265 + arr_15_fu_146);

assign arr_fu_824_p2 = (and_ln49_fu_819_p2 + arr_8_fu_118);

assign conv34_cast_fu_344_p1 = conv34;

assign icmp_ln36_fu_396_p2 = ((ap_sig_allocacmp_i_2 == 4'd0) ? 1'b1 : 1'b0);

assign icmp_ln49_1_fu_466_p2 = ((ap_sig_allocacmp_i_2 > 4'd5) ? 1'b1 : 1'b0);

assign icmp_ln49_2_fu_482_p2 = ((ap_sig_allocacmp_i_2 > 4'd4) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_508_p2 = ((tmp_14_fu_498_p4 != 2'd0) ? 1'b1 : 1'b0);

assign icmp_ln49_4_fu_524_p2 = ((ap_sig_allocacmp_i_2 > 4'd2) ? 1'b1 : 1'b0);

assign icmp_ln49_5_fu_540_p2 = ((tmp_15_fu_530_p4 != 3'd0) ? 1'b1 : 1'b0);

assign icmp_ln49_fu_442_p2 = ((ap_sig_allocacmp_i_2 > 4'd6) ? 1'b1 : 1'b0);
...
assign select_ln49_1_fu_812_p3 = ((tmp_13_reg_1172_pp0_iter1_reg[0:0] == 1'b1) ? 128'd340282366920938463463374607431768211455 : 128'd0);
...
assign select_ln49_fu_568_p3 = ((tmp_12_reg_1167[0:0] == 1'b1) ? arg2_r_7_cast : arg2_r_8_cast);

assign select_ln50_fu_448_p3 = ((tmp_13_fu_434_p3[0:0] == 1'b1) ? 4'd7 : 4'd8);
...
assign tmp_13_fu_434_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_14_fu_498_p4 = {{ap_sig_allocacmp_i_2[3:2]}};

assign tmp_15_fu_530_p4 = {{ap_sig_allocacmp_i_2[3:1]}};
