...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg1_r_7_reload,
        add_3_1137_out,
        add_3_1137_out_ap_vld,
        add_3136_out,
        add_3136_out_ap_vld,
        add_2_1135_out,
        add_2_1135_out_ap_vld,
        add_2134_out,
        add_2134_out_ap_vld,
        add_177_1133_out,
        add_177_1133_out_ap_vld,
        add_177132_out,
        add_177132_out_ap_vld,
        add_193131_out,
        add_193131_out_ap_vld,
        add130_out,
        add130_out_ap_vld
);
...
output  [127:0] add_3_1137_out;
output   add_3_1137_out_ap_vld;
output  [127:0] add_3136_out;
output   add_3136_out_ap_vld;
output  [127:0] add_2_1135_out;
output   add_2_1135_out_ap_vld;
output  [127:0] add_2134_out;
output   add_2134_out_ap_vld;
output  [127:0] add_177_1133_out;
output   add_177_1133_out_ap_vld;
output  [127:0] add_177132_out;
output   add_177132_out_ap_vld;
output  [127:0] add_193131_out;
output   add_193131_out_ap_vld;
output  [127:0] add130_out;
output   add130_out_ap_vld;

reg ap_idle;
reg add_3_1137_out_ap_vld;
reg add_3136_out_ap_vld;
reg add_2_1135_out_ap_vld;
reg add_2134_out_ap_vld;
reg add_177_1133_out_ap_vld;
reg add_177132_out_ap_vld;
reg add_193131_out_ap_vld;
reg add130_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add130_out_ap_vld = 1'b1;
    end else begin
        add130_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_177132_out_ap_vld = 1'b1;
    end else begin
        add_177132_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_177_1133_out_ap_vld = 1'b1;
    end else begin
        add_177_1133_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_193131_out_ap_vld = 1'b1;
    end else begin
        add_193131_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2134_out_ap_vld = 1'b1;
    end else begin
        add_2134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2_1135_out_ap_vld = 1'b1;
    end else begin
        add_2_1135_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3136_out_ap_vld = 1'b1;
    end else begin
        add_3136_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3_1137_out_ap_vld = 1'b1;
    end else begin
        add_3_1137_out_ap_vld = 1'b0;
    end
end
...
assign add130_out = arr_8_fu_122;

assign add_177132_out = arr_10_fu_130;

assign add_177_1133_out = arr_11_fu_134;

assign add_193131_out = arr_9_fu_126;

assign add_2134_out = arr_12_fu_138;

assign add_2_1135_out = arr_13_fu_142;

assign add_3136_out = arr_14_fu_146;

assign add_3_1137_out = arr_15_fu_150;
