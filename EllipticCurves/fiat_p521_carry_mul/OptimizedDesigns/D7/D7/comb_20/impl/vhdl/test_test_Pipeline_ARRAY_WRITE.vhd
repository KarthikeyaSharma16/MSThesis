...
begin
    mux_9_4_59_1_1_U112 : component test_mux_9_4_59_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 59,
    ...
    add_ln91_fu_204_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_2) + unsigned(ap_const_lv4_1));
    ...
    icmp_ln91_fu_198_p2 <= "1" when (ap_sig_allocacmp_i_2 = ap_const_lv4_9) else "0";
