...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_757_out \
    op interface \
    ports { add_757_out { O 128 vector } add_757_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_656_out \
    op interface \
    ports { add_656_out { O 128 vector } add_656_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_555_out \
    op interface \
    ports { add_555_out { O 128 vector } add_555_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_454_out \
    op interface \
    ports { add_454_out { O 128 vector } add_454_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_252_out \
    op interface \
    ports { add_252_out { O 128 vector } add_252_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_151_out \
    op interface \
    ports { add_151_out { O 128 vector } add_151_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add50_out \
    op interface \
    ports { add50_out { O 128 vector } add50_out_ap_vld { O 1 bit } } \
} "
}
