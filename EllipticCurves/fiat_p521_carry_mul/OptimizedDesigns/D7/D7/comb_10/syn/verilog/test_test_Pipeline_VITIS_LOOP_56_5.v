...
module test_test_Pipeline_VITIS_LOOP_56_5 (
        ...
        arg2_r_8_reload,
        add114_3_149_out,
        add114_3_149_out_ap_vld,
        add114_348_out,
        add114_348_out_ap_vld,
        add114_2_147_out,
        add114_2_147_out_ap_vld,
        add114_246_out,
        add114_246_out_ap_vld,
        add114_1_145_out,
        add114_1_145_out_ap_vld,
        add114_144_out,
        add114_144_out_ap_vld,
        add114_12743_out,
        add114_12743_out_ap_vld,
        add11442_out,
        add11442_out_ap_vld,
        add8741_out,
        add8741_out_ap_vld
...
output   ap_idle;
output   ap_ready;
input  [127:0] add_757_reload;
input  [127:0] add_656_reload;
input  [127:0] add_555_reload;
input  [127:0] add_454_reload;
input  [127:0] add_353_reload;
input  [127:0] add_252_reload;
input  [127:0] add_151_reload;
input  [127:0] add50_reload;
...
output  [127:0] add114_3_149_out;
output   add114_3_149_out_ap_vld;
output  [127:0] add114_348_out;
output   add114_348_out_ap_vld;
output  [127:0] add114_2_147_out;
output   add114_2_147_out_ap_vld;
output  [127:0] add114_246_out;
output   add114_246_out_ap_vld;
output  [127:0] add114_1_145_out;
output   add114_1_145_out_ap_vld;
output  [127:0] add114_144_out;
output   add114_144_out_ap_vld;
output  [127:0] add114_12743_out;
output   add114_12743_out_ap_vld;
output  [127:0] add11442_out;
output   add11442_out_ap_vld;
output  [127:0] add8741_out;
output   add8741_out_ap_vld;

reg ap_idle;
reg add114_3_149_out_ap_vld;
reg add114_348_out_ap_vld;
reg add114_2_147_out_ap_vld;
reg add114_246_out_ap_vld;
reg add114_1_145_out_ap_vld;
reg add114_144_out_ap_vld;
reg add114_12743_out_ap_vld;
reg add11442_out_ap_vld;
reg add8741_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add11442_out_ap_vld = 1'b1;
    end else begin
        add11442_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_12743_out_ap_vld = 1'b1;
    end else begin
        add114_12743_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_144_out_ap_vld = 1'b1;
    end else begin
        add114_144_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_1_145_out_ap_vld = 1'b1;
    end else begin
        add114_1_145_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_246_out_ap_vld = 1'b1;
    end else begin
        add114_246_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_2_147_out_ap_vld = 1'b1;
    end else begin
        add114_2_147_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_348_out_ap_vld = 1'b1;
    end else begin
        add114_348_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_3_149_out_ap_vld = 1'b1;
    end else begin
        add114_3_149_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add8741_out_ap_vld = 1'b1;
    end else begin
        add8741_out_ap_vld = 1'b0;
    end
end
...
assign add11442_out = add11442_fu_144;

assign add114_12743_out = add114_12743_fu_148;

assign add114_144_out = add114_144_fu_152;

assign add114_1_145_out = add114_1_145_fu_156;

assign add114_246_out = add114_246_fu_160;

assign add114_2_147_out = add114_2_147_fu_164;

assign add114_348_out = add114_348_fu_168;

assign add114_3_149_out = add114_3_149_fu_172;

assign add8741_out = add8741_fu_140;

assign add_ln56_fu_672_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(5'd31));

assign add_ln63_fu_918_p2 = (mul_ln63_reg_1431 + add8741_fu_140);

assign add_ln70_1_fu_953_p2 = (and_ln70_1_fu_948_p2 + add114_12743_fu_148);

assign add_ln70_2_fu_971_p2 = (and_ln70_2_fu_966_p2 + add114_144_fu_152);

assign add_ln70_3_fu_989_p2 = (and_ln70_3_fu_984_p2 + add114_1_145_fu_156);

assign add_ln70_4_fu_1007_p2 = (and_ln70_4_fu_1002_p2 + add114_246_fu_160);

assign add_ln70_5_fu_1025_p2 = (and_ln70_5_fu_1020_p2 + add114_2_147_fu_164);

assign add_ln70_6_fu_1043_p2 = (and_ln70_6_fu_1038_p2 + add114_348_fu_168);

assign add_ln70_7_fu_1061_p2 = (and_ln70_7_fu_1056_p2 + add114_3_149_fu_172);

assign add_ln70_fu_935_p2 = (and_ln70_fu_930_p2 + add11442_fu_144);
