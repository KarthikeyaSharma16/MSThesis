...
output  [127:0] add_757_out;
output   add_757_out_ap_vld;
output  [127:0] add_656_out;
output   add_656_out_ap_vld;
output  [127:0] add_555_out;
output   add_555_out_ap_vld;
output  [127:0] add_454_out;
output   add_454_out_ap_vld;
output  [127:0] add_353_out;
output   add_353_out_ap_vld;
output  [127:0] add_252_out;
output   add_252_out_ap_vld;
output  [127:0] add_151_out;
output   add_151_out_ap_vld;
output  [127:0] add50_out;
output   add50_out_ap_vld;

reg ap_idle;
reg add_757_out_ap_vld;
reg add_656_out_ap_vld;
reg add_555_out_ap_vld;
reg add_454_out_ap_vld;
reg add_353_out_ap_vld;
reg add_252_out_ap_vld;
reg add_151_out_ap_vld;
reg add50_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add50_out_ap_vld = 1'b1;
    end else begin
        add50_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_151_out_ap_vld = 1'b1;
    end else begin
        add_151_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_252_out_ap_vld = 1'b1;
    end else begin
        add_252_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_454_out_ap_vld = 1'b1;
    end else begin
        add_454_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_555_out_ap_vld = 1'b1;
    end else begin
        add_555_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_656_out_ap_vld = 1'b1;
    end else begin
        add_656_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_757_out_ap_vld = 1'b1;
    end else begin
        add_757_out_ap_vld = 1'b0;
    end
end
...
assign add50_out = arr_8_fu_118;

assign add_151_out = arr_9_fu_122;

assign add_252_out = arr_10_fu_126;

assign add_353_out = arr_11_fu_130;

assign add_454_out = arr_12_fu_134;

assign add_555_out = arr_13_fu_138;

assign add_656_out = arr_14_fu_142;

assign add_757_out = arr_15_fu_146;
