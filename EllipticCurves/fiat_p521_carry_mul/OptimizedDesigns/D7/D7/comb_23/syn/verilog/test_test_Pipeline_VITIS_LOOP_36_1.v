...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        add_4130_out_ap_vld,
        add_389129_out,
        add_389129_out_ap_vld,
        add_275128_out,
        add_275128_out_ap_vld,
        add_161127_out,
        add_161127_out_ap_vld,
        add126_out,
        add126_out_ap_vld
);
...
output  [127:0] add_7133_out;
output   add_7133_out_ap_vld;
output  [127:0] add_6132_out;
output   add_6132_out_ap_vld;
output  [127:0] add_5131_out;
output   add_5131_out_ap_vld;
output  [127:0] add_4130_out;
output   add_4130_out_ap_vld;
output  [127:0] add_389129_out;
output   add_389129_out_ap_vld;
output  [127:0] add_275128_out;
output   add_275128_out_ap_vld;
output  [127:0] add_161127_out;
output   add_161127_out_ap_vld;
output  [127:0] add126_out;
output   add126_out_ap_vld;

reg ap_idle;
reg add_7133_out_ap_vld;
reg add_6132_out_ap_vld;
reg add_5131_out_ap_vld;
reg add_4130_out_ap_vld;
reg add_389129_out_ap_vld;
reg add_275128_out_ap_vld;
reg add_161127_out_ap_vld;
reg add126_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add126_out_ap_vld = 1'b1;
    end else begin
        add126_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_161127_out_ap_vld = 1'b1;
    end else begin
        add_161127_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_275128_out_ap_vld = 1'b1;
    end else begin
        add_275128_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_389129_out_ap_vld = 1'b1;
    end else begin
        add_389129_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_4130_out_ap_vld = 1'b1;
    end else begin
        add_4130_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_5131_out_ap_vld = 1'b1;
    end else begin
        add_5131_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_6132_out_ap_vld = 1'b1;
    end else begin
        add_6132_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_7133_out_ap_vld = 1'b1;
    end else begin
        add_7133_out_ap_vld = 1'b0;
    end
end
...
assign add126_out = arr_8_fu_120;

assign add_161127_out = arr_9_fu_124;

assign add_275128_out = arr_10_fu_128;

assign add_389129_out = arr_11_fu_132;

assign add_4130_out = arr_12_fu_136;

assign add_5131_out = arr_13_fu_140;

assign add_6132_out = arr_14_fu_144;

assign add_7133_out = arr_15_fu_148;
