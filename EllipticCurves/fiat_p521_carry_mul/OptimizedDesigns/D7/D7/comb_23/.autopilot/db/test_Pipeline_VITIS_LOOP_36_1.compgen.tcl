...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_7133_out \
    op interface \
    ports { add_7133_out { O 128 vector } add_7133_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_6132_out \
    op interface \
    ports { add_6132_out { O 128 vector } add_6132_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_5131_out \
    op interface \
    ports { add_5131_out { O 128 vector } add_5131_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_4130_out \
    op interface \
    ports { add_4130_out { O 128 vector } add_4130_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_389129_out \
    op interface \
    ports { add_389129_out { O 128 vector } add_389129_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_275128_out \
    op interface \
    ports { add_275128_out { O 128 vector } add_275128_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_161127_out \
    op interface \
    ports { add_161127_out { O 128 vector } add_161127_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add126_out \
    op interface \
    ports { add126_out { O 128 vector } add126_out_ap_vld { O 1 bit } } \
} "
}
