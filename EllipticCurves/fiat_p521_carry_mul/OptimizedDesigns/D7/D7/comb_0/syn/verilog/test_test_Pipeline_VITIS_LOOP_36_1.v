...
output  [127:0] add_389_out;
output   add_389_out_ap_vld;
output  [127:0] add_288_out;
output   add_288_out_ap_vld;
output  [127:0] add_187_out;
output   add_187_out_ap_vld;
...
reg add_389_out_ap_vld;
reg add_288_out_ap_vld;
reg add_187_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_187_out_ap_vld = 1'b1;
    end else begin
        add_187_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_389_out_ap_vld = 1'b1;
    end else begin
        add_389_out_ap_vld = 1'b0;
    end
end
...
assign add86_out = arr_8_fu_118;

assign add_187_out = arr_9_fu_122;

assign add_288_out = arr_10_fu_126;

assign add_389_out = arr_11_fu_130;

assign add_490_out = arr_12_fu_134;

assign add_591_out = arr_13_fu_138;

assign add_692_out = arr_14_fu_142;

assign add_793_out = arr_15_fu_146;
