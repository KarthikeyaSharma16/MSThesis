...
module test_test_Pipeline_VITIS_LOOP_56_5 (
        ...
        arg2_r_8_reload,
        add114_745_out,
        add114_745_out_ap_vld,
        add114_644_out,
        add114_644_out_ap_vld,
        add114_543_out,
        add114_543_out_ap_vld,
        add114_442_out,
        add114_442_out_ap_vld,
        add114_341_out,
        add114_341_out_ap_vld,
        add114_240_out,
        add114_240_out_ap_vld,
        add114_139_out,
        add114_139_out_ap_vld,
        add11438_out,
        add11438_out_ap_vld,
        add8737_out,
        add8737_out_ap_vld
...
output   ap_idle;
output   ap_ready;
input  [127:0] add_753_reload;
input  [127:0] add_652_reload;
input  [127:0] add_551_reload;
input  [127:0] add_450_reload;
input  [127:0] add_349_reload;
input  [127:0] add_248_reload;
input  [127:0] add_12547_reload;
input  [127:0] add46_reload;
...
output  [127:0] add114_745_out;
output   add114_745_out_ap_vld;
output  [127:0] add114_644_out;
output   add114_644_out_ap_vld;
output  [127:0] add114_543_out;
output   add114_543_out_ap_vld;
output  [127:0] add114_442_out;
output   add114_442_out_ap_vld;
output  [127:0] add114_341_out;
output   add114_341_out_ap_vld;
output  [127:0] add114_240_out;
output   add114_240_out_ap_vld;
output  [127:0] add114_139_out;
output   add114_139_out_ap_vld;
output  [127:0] add11438_out;
output   add11438_out_ap_vld;
output  [127:0] add8737_out;
output   add8737_out_ap_vld;

reg ap_idle;
reg add114_745_out_ap_vld;
reg add114_644_out_ap_vld;
reg add114_543_out_ap_vld;
reg add114_442_out_ap_vld;
reg add114_341_out_ap_vld;
reg add114_240_out_ap_vld;
reg add114_139_out_ap_vld;
reg add11438_out_ap_vld;
reg add8737_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add11438_out_ap_vld = 1'b1;
    end else begin
        add11438_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_139_out_ap_vld = 1'b1;
    end else begin
        add114_139_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_240_out_ap_vld = 1'b1;
    end else begin
        add114_240_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_341_out_ap_vld = 1'b1;
    end else begin
        add114_341_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_442_out_ap_vld = 1'b1;
    end else begin
        add114_442_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_543_out_ap_vld = 1'b1;
    end else begin
        add114_543_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_644_out_ap_vld = 1'b1;
    end else begin
        add114_644_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_745_out_ap_vld = 1'b1;
    end else begin
        add114_745_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add8737_out_ap_vld = 1'b1;
    end else begin
        add8737_out_ap_vld = 1'b0;
    end
end
...
assign add11438_out = add11438_fu_144;

assign add114_139_out = add114_139_fu_148;

assign add114_240_out = add114_240_fu_152;

assign add114_341_out = add114_341_fu_156;

assign add114_442_out = add114_442_fu_160;

assign add114_543_out = add114_543_fu_164;

assign add114_644_out = add114_644_fu_168;

assign add114_745_out = add114_745_fu_172;

assign add8737_out = add8737_fu_140;

assign add_ln56_fu_672_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(5'd31));

assign add_ln63_fu_918_p2 = (mul_ln63_reg_1431 + add8737_fu_140);

assign add_ln70_1_fu_953_p2 = (and_ln70_1_fu_948_p2 + add114_139_fu_148);

assign add_ln70_2_fu_971_p2 = (and_ln70_2_fu_966_p2 + add114_240_fu_152);

assign add_ln70_3_fu_989_p2 = (and_ln70_3_fu_984_p2 + add114_341_fu_156);

assign add_ln70_4_fu_1007_p2 = (and_ln70_4_fu_1002_p2 + add114_442_fu_160);

assign add_ln70_5_fu_1025_p2 = (and_ln70_5_fu_1020_p2 + add114_543_fu_164);

assign add_ln70_6_fu_1043_p2 = (and_ln70_6_fu_1038_p2 + add114_644_fu_168);

assign add_ln70_7_fu_1061_p2 = (and_ln70_7_fu_1056_p2 + add114_745_fu_172);

assign add_ln70_fu_935_p2 = (and_ln70_fu_930_p2 + add11438_fu_144);
