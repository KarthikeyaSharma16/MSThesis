...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_753_out \
    op interface \
    ports { add_753_out { O 128 vector } add_753_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_652_out \
    op interface \
    ports { add_652_out { O 128 vector } add_652_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_551_out \
    op interface \
    ports { add_551_out { O 128 vector } add_551_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_450_out \
    op interface \
    ports { add_450_out { O 128 vector } add_450_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_349_out \
    op interface \
    ports { add_349_out { O 128 vector } add_349_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_248_out \
    op interface \
    ports { add_248_out { O 128 vector } add_248_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_12547_out \
    op interface \
    ports { add_12547_out { O 128 vector } add_12547_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add46_out \
    op interface \
    ports { add46_out { O 128 vector } add46_out_ap_vld { O 1 bit } } \
} "
}
