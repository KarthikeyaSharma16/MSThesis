...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_cast,
        add_1_3337_out,
        add_1_3337_out_ap_vld,
        add_1_2336_out,
        add_1_2336_out_ap_vld,
        add_1_1335_out,
        add_1_1335_out_ap_vld,
        add_1334_out,
        add_1334_out_ap_vld,
        add_3333_out,
        add_3333_out_ap_vld,
...
output  [127:0] add_1_3337_out;
output   add_1_3337_out_ap_vld;
output  [127:0] add_1_2336_out;
output   add_1_2336_out_ap_vld;
output  [127:0] add_1_1335_out;
output   add_1_1335_out_ap_vld;
output  [127:0] add_1334_out;
output   add_1334_out_ap_vld;
...
reg ap_idle;
reg add_1_3337_out_ap_vld;
reg add_1_2336_out_ap_vld;
reg add_1_1335_out_ap_vld;
reg add_1334_out_ap_vld;
...
reg   [127:0] add_2332_fu_126;
wire   [127:0] add_ln49_2_fu_860_p2;
reg   [127:0] add_3333_fu_130;
wire   [127:0] add_ln49_3_fu_878_p2;
reg   [127:0] add_1334_fu_134;
wire   [127:0] add_ln49_4_fu_896_p2;
reg   [127:0] add_1_1335_fu_138;
wire   [127:0] add_ln49_5_fu_914_p2;
reg   [127:0] add_1_2336_fu_142;
wire   [127:0] add_ln49_6_fu_932_p2;
reg   [127:0] add_1_3337_fu_146;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1334_out_ap_vld = 1'b1;
    end else begin
        add_1334_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1_1335_out_ap_vld = 1'b1;
    end else begin
        add_1_1335_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1_2336_out_ap_vld = 1'b1;
    end else begin
        add_1_2336_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1_3337_out_ap_vld = 1'b1;
    end else begin
        add_1_3337_out_ap_vld = 1'b0;
    end
end
...
assign add_1334_out = add_1334_fu_134;

assign add_1_1335_out = add_1_1335_fu_138;

assign add_1_2336_out = add_1_2336_fu_142;

assign add_1_3337_out = add_1_3337_fu_146;

assign add_2332_out = add_2332_fu_126;

assign add_3333_out = add_3333_fu_130;
...
assign add_ln49_2_fu_860_p2 = (and_ln49_2_fu_855_p2 + add_2332_fu_126);

assign add_ln49_3_fu_878_p2 = (and_ln49_3_fu_873_p2 + add_3333_fu_130);

assign add_ln49_4_fu_896_p2 = (and_ln49_4_fu_891_p2 + add_1334_fu_134);

assign add_ln49_5_fu_914_p2 = (and_ln49_5_fu_909_p2 + add_1_1335_fu_138);

assign add_ln49_6_fu_932_p2 = (and_ln49_6_fu_927_p2 + add_1_2336_fu_142);

assign add_ln49_7_fu_938_p2 = (mul_ln49_7_reg_1265 + add_1_3337_fu_146);
