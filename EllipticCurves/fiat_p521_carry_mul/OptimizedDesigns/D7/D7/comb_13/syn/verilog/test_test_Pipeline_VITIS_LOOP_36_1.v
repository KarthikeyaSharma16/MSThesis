...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_cast,
        add_1_3336_out,
        add_1_3336_out_ap_vld,
        add_1_2335_out,
        add_1_2335_out_ap_vld,
        add_1_1334_out,
        add_1_1334_out_ap_vld,
        add_1333_out,
        add_1333_out_ap_vld,
        add_3332_out,
        add_3332_out_ap_vld,
...
output  [127:0] add_1_3336_out;
output   add_1_3336_out_ap_vld;
output  [127:0] add_1_2335_out;
output   add_1_2335_out_ap_vld;
output  [127:0] add_1_1334_out;
output   add_1_1334_out_ap_vld;
output  [127:0] add_1333_out;
output   add_1333_out_ap_vld;
output  [127:0] add_3332_out;
output   add_3332_out_ap_vld;
output  [127:0] add_2331_out;
output   add_2331_out_ap_vld;
output  [127:0] add_1243330_out;
output   add_1243330_out_ap_vld;
output  [127:0] add329_out;
output   add329_out_ap_vld;

reg ap_idle;
reg add_1_3336_out_ap_vld;
reg add_1_2335_out_ap_vld;
reg add_1_1334_out_ap_vld;
reg add_1333_out_ap_vld;
reg add_3332_out_ap_vld;
reg add_2331_out_ap_vld;
reg add_1243330_out_ap_vld;
reg add329_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add329_out_ap_vld = 1'b1;
    end else begin
        add329_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1243330_out_ap_vld = 1'b1;
    end else begin
        add_1243330_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1333_out_ap_vld = 1'b1;
    end else begin
        add_1333_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1_1334_out_ap_vld = 1'b1;
    end else begin
        add_1_1334_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1_2335_out_ap_vld = 1'b1;
    end else begin
        add_1_2335_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1_3336_out_ap_vld = 1'b1;
    end else begin
        add_1_3336_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_2331_out_ap_vld = 1'b1;
    end else begin
        add_2331_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_3332_out_ap_vld = 1'b1;
    end else begin
        add_3332_out_ap_vld = 1'b0;
    end
end
...
assign add329_out = add329_fu_118;

assign add_1243330_out = add_1243330_fu_122;

assign add_1333_out = add_1333_fu_134;

assign add_1_1334_out = add_1_1334_fu_138;

assign add_1_2335_out = add_1_2335_fu_142;

assign add_1_3336_out = add_1_3336_fu_146;

assign add_2331_out = add_2331_fu_126;

assign add_3332_out = add_3332_fu_130;

assign add_ln36_fu_546_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(4'd15));

assign add_ln49_1_fu_842_p2 = (and_ln49_1_fu_837_p2 + add_1243330_fu_122);

assign add_ln49_2_fu_860_p2 = (and_ln49_2_fu_855_p2 + add_2331_fu_126);

assign add_ln49_3_fu_878_p2 = (and_ln49_3_fu_873_p2 + add_3332_fu_130);

assign add_ln49_4_fu_896_p2 = (and_ln49_4_fu_891_p2 + add_1333_fu_134);

assign add_ln49_5_fu_914_p2 = (and_ln49_5_fu_909_p2 + add_1_1334_fu_138);

assign add_ln49_6_fu_932_p2 = (and_ln49_6_fu_927_p2 + add_1_2335_fu_142);

assign add_ln49_7_fu_938_p2 = (mul_ln49_7_reg_1265 + add_1_3336_fu_146);

assign add_ln49_fu_824_p2 = (and_ln49_fu_819_p2 + add329_fu_118);
