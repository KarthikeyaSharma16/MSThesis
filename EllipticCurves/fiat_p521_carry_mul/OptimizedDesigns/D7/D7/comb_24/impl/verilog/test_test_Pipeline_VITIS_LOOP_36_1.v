...
output  [127:0] add_7162_out;
output   add_7162_out_ap_vld;
output  [127:0] add_6161_out;
output   add_6161_out_ap_vld;
output  [127:0] add_5160_out;
output   add_5160_out_ap_vld;
output  [127:0] add_4159_out;
output   add_4159_out_ap_vld;
output  [127:0] add_3158_out;
output   add_3158_out_ap_vld;
output  [127:0] add_2157_out;
output   add_2157_out_ap_vld;
output  [127:0] add_1117156_out;
output   add_1117156_out_ap_vld;
output  [127:0] add155_out;
output   add155_out_ap_vld;

reg ap_idle;
reg add_7162_out_ap_vld;
reg add_6161_out_ap_vld;
reg add_5160_out_ap_vld;
reg add_4159_out_ap_vld;
reg add_3158_out_ap_vld;
reg add_2157_out_ap_vld;
reg add_1117156_out_ap_vld;
reg add155_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add155_out_ap_vld = 1'b1;
    end else begin
        add155_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1117156_out_ap_vld = 1'b1;
    end else begin
        add_1117156_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2157_out_ap_vld = 1'b1;
    end else begin
        add_2157_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3158_out_ap_vld = 1'b1;
    end else begin
        add_3158_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_5160_out_ap_vld = 1'b1;
    end else begin
        add_5160_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6161_out_ap_vld = 1'b1;
    end else begin
        add_6161_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_7162_out_ap_vld = 1'b1;
    end else begin
        add_7162_out_ap_vld = 1'b0;
    end
end
...
assign add155_out = arr_8_fu_122;

assign add_1117156_out = arr_9_fu_126;

assign add_2157_out = arr_10_fu_130;

assign add_3158_out = arr_11_fu_134;

assign add_4159_out = arr_12_fu_138;

assign add_5160_out = arr_13_fu_142;

assign add_6161_out = arr_14_fu_146;

assign add_7162_out = arr_15_fu_150;
