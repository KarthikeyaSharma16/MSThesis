...
module test_test_Pipeline_VITIS_LOOP_56_5 (
        ...
        ap_idle,
        ap_ready,
        add_3119_1165_reload,
        add_3119164_reload,
        add_2104_1163_reload,
        add_2104162_reload,
        add_189_1161_reload,
        add_189160_reload,
        add_1137159_reload,
        ...
        arg2_r_8_reload,
        add114_1_3157_out,
        add114_1_3157_out_ap_vld,
        add114_1_2156_out,
        add114_1_2156_out_ap_vld,
        add114_1_1155_out,
        add114_1_1155_out_ap_vld,
        add114_1154_out,
        add114_1154_out_ap_vld,
        add114_3153_out,
        add114_3153_out_ap_vld,
        add114_2152_out,
        add114_2152_out_ap_vld,
        add114_127151_out,
        add114_127151_out_ap_vld,
        add114150_out,
        add114150_out_ap_vld,
        add87149_out,
        add87149_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [127:0] add_3119_1165_reload;
input  [127:0] add_3119164_reload;
input  [127:0] add_2104_1163_reload;
input  [127:0] add_2104162_reload;
input  [127:0] add_189_1161_reload;
input  [127:0] add_189160_reload;
input  [127:0] add_1137159_reload;
input  [127:0] add158_reload;
...
output  [127:0] add114_1_3157_out;
output   add114_1_3157_out_ap_vld;
output  [127:0] add114_1_2156_out;
output   add114_1_2156_out_ap_vld;
output  [127:0] add114_1_1155_out;
output   add114_1_1155_out_ap_vld;
output  [127:0] add114_1154_out;
output   add114_1154_out_ap_vld;
output  [127:0] add114_3153_out;
output   add114_3153_out_ap_vld;
output  [127:0] add114_2152_out;
output   add114_2152_out_ap_vld;
output  [127:0] add114_127151_out;
output   add114_127151_out_ap_vld;
output  [127:0] add114150_out;
output   add114150_out_ap_vld;
output  [127:0] add87149_out;
output   add87149_out_ap_vld;

reg ap_idle;
reg add114_1_3157_out_ap_vld;
reg add114_1_2156_out_ap_vld;
reg add114_1_1155_out_ap_vld;
reg add114_1154_out_ap_vld;
reg add114_3153_out_ap_vld;
reg add114_2152_out_ap_vld;
reg add114_127151_out_ap_vld;
reg add114150_out_ap_vld;
reg add87149_out_ap_vld;
...
reg   [127:0] add87149_fu_140;
wire   [127:0] add_ln63_fu_918_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [127:0] add114150_fu_144;
wire   [127:0] add_ln70_fu_935_p2;
reg   [127:0] add114_127151_fu_148;
wire   [127:0] add_ln70_1_fu_953_p2;
reg   [127:0] add114_2152_fu_152;
wire   [127:0] add_ln70_2_fu_971_p2;
reg   [127:0] add114_3153_fu_156;
wire   [127:0] add_ln70_3_fu_989_p2;
reg   [127:0] add114_1154_fu_160;
wire   [127:0] add_ln70_4_fu_1007_p2;
reg   [127:0] add114_1_1155_fu_164;
wire   [127:0] add_ln70_5_fu_1025_p2;
reg   [127:0] add114_1_2156_fu_168;
wire   [127:0] add_ln70_6_fu_1043_p2;
reg   [127:0] add114_1_3157_fu_172;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114150_out_ap_vld = 1'b1;
    end else begin
        add114150_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_1154_out_ap_vld = 1'b1;
    end else begin
        add114_1154_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_127151_out_ap_vld = 1'b1;
    end else begin
        add114_127151_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_1_1155_out_ap_vld = 1'b1;
    end else begin
        add114_1_1155_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_1_2156_out_ap_vld = 1'b1;
    end else begin
        add114_1_2156_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_1_3157_out_ap_vld = 1'b1;
    end else begin
        add114_1_3157_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_2152_out_ap_vld = 1'b1;
    end else begin
        add114_2152_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add114_3153_out_ap_vld = 1'b1;
    end else begin
        add114_3153_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1344 == 1'd1))) begin
        add87149_out_ap_vld = 1'b1;
    end else begin
        add87149_out_ap_vld = 1'b0;
    end
end
...
assign add114150_out = add114150_fu_144;

assign add114_1154_out = add114_1154_fu_160;

assign add114_127151_out = add114_127151_fu_148;

assign add114_1_1155_out = add114_1_1155_fu_164;

assign add114_1_2156_out = add114_1_2156_fu_168;

assign add114_1_3157_out = add114_1_3157_fu_172;

assign add114_2152_out = add114_2152_fu_152;

assign add114_3153_out = add114_3153_fu_156;

assign add87149_out = add87149_fu_140;

assign add_ln56_fu_672_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(5'd31));

assign add_ln63_fu_918_p2 = (mul_ln63_reg_1431 + add87149_fu_140);

assign add_ln70_1_fu_953_p2 = (and_ln70_1_fu_948_p2 + add114_127151_fu_148);

assign add_ln70_2_fu_971_p2 = (and_ln70_2_fu_966_p2 + add114_2152_fu_152);

assign add_ln70_3_fu_989_p2 = (and_ln70_3_fu_984_p2 + add114_3153_fu_156);

assign add_ln70_4_fu_1007_p2 = (and_ln70_4_fu_1002_p2 + add114_1154_fu_160);

assign add_ln70_5_fu_1025_p2 = (and_ln70_5_fu_1020_p2 + add114_1_1155_fu_164);

assign add_ln70_6_fu_1043_p2 = (and_ln70_6_fu_1038_p2 + add114_1_2156_fu_168);

assign add_ln70_7_fu_1061_p2 = (and_ln70_7_fu_1056_p2 + add114_1_3157_fu_172);

assign add_ln70_fu_935_p2 = (and_ln70_fu_930_p2 + add114150_fu_144);
