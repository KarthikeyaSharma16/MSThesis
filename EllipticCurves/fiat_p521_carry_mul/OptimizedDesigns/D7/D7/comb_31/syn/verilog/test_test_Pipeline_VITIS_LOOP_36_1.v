...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg1_r_1_reload,
        add_3119_1165_out,
        add_3119_1165_out_ap_vld,
        add_3119164_out,
        add_3119164_out_ap_vld,
        add_2104_1163_out,
        add_2104_1163_out_ap_vld,
        add_2104162_out,
        add_2104162_out_ap_vld,
        add_189_1161_out,
        add_189_1161_out_ap_vld,
        add_189160_out,
        add_189160_out_ap_vld,
        add_1137159_out,
        add_1137159_out_ap_vld,
        add158_out,
        add158_out_ap_vld
);
...
output  [127:0] add_3119_1165_out;
output   add_3119_1165_out_ap_vld;
output  [127:0] add_3119164_out;
output   add_3119164_out_ap_vld;
output  [127:0] add_2104_1163_out;
output   add_2104_1163_out_ap_vld;
output  [127:0] add_2104162_out;
output   add_2104162_out_ap_vld;
output  [127:0] add_189_1161_out;
output   add_189_1161_out_ap_vld;
output  [127:0] add_189160_out;
output   add_189160_out_ap_vld;
output  [127:0] add_1137159_out;
output   add_1137159_out_ap_vld;
output  [127:0] add158_out;
output   add158_out_ap_vld;

reg ap_idle;
reg add_3119_1165_out_ap_vld;
reg add_3119164_out_ap_vld;
reg add_2104_1163_out_ap_vld;
reg add_2104162_out_ap_vld;
reg add_189_1161_out_ap_vld;
reg add_189160_out_ap_vld;
reg add_1137159_out_ap_vld;
reg add158_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_470_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_18_reg_2214 <= ap_sig_allocacmp_i_2[32'd3];
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add158_out_ap_vld = 1'b1;
    end else begin
        add158_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_1137159_out_ap_vld = 1'b1;
    end else begin
        add_1137159_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_189160_out_ap_vld = 1'b1;
    end else begin
        add_189160_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_189_1161_out_ap_vld = 1'b1;
    end else begin
        add_189_1161_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_2104162_out_ap_vld = 1'b1;
    end else begin
        add_2104162_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_2104_1163_out_ap_vld = 1'b1;
    end else begin
        add_2104_1163_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_3119164_out_ap_vld = 1'b1;
    end else begin
        add_3119164_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_3119_1165_out_ap_vld = 1'b1;
    end else begin
        add_3119_1165_out_ap_vld = 1'b0;
    end
end
...
assign add158_out = arr_8_fu_120;

assign add_1137159_out = arr_9_fu_124;

assign add_189160_out = arr_10_fu_128;

assign add_189_1161_out = arr_11_fu_132;

assign add_2104162_out = arr_12_fu_136;

assign add_2104_1163_out = arr_13_fu_140;

assign add_3119164_out = arr_14_fu_144;

assign add_3119_1165_out = arr_15_fu_148;
