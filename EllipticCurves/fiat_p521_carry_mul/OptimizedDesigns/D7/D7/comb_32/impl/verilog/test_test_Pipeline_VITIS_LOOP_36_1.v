...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg1_r_7_reload,
        add_1260_3371_out,
        add_1260_3371_out_ap_vld,
        add_1260_2370_out,
        add_1260_2370_out_ap_vld,
        add_1260_1369_out,
        add_1260_1369_out_ap_vld,
        add_1260368_out,
        add_1260368_out_ap_vld,
        add_3367_out,
        add_3367_out_ap_vld,
        add_2366_out,
        add_2366_out_ap_vld,
        add_1278365_out,
        add_1278365_out_ap_vld,
        add364_out,
        add364_out_ap_vld
);
...
output  [127:0] add_1260_3371_out;
output   add_1260_3371_out_ap_vld;
output  [127:0] add_1260_2370_out;
output   add_1260_2370_out_ap_vld;
output  [127:0] add_1260_1369_out;
output   add_1260_1369_out_ap_vld;
output  [127:0] add_1260368_out;
output   add_1260368_out_ap_vld;
output  [127:0] add_3367_out;
output   add_3367_out_ap_vld;
output  [127:0] add_2366_out;
output   add_2366_out_ap_vld;
output  [127:0] add_1278365_out;
output   add_1278365_out_ap_vld;
output  [127:0] add364_out;
output   add364_out_ap_vld;

reg ap_idle;
reg add_1260_3371_out_ap_vld;
reg add_1260_2370_out_ap_vld;
reg add_1260_1369_out_ap_vld;
reg add_1260368_out_ap_vld;
reg add_3367_out_ap_vld;
reg add_2366_out_ap_vld;
reg add_1278365_out_ap_vld;
reg add364_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add364_out_ap_vld = 1'b1;
    end else begin
        add364_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1260368_out_ap_vld = 1'b1;
    end else begin
        add_1260368_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1260_1369_out_ap_vld = 1'b1;
    end else begin
        add_1260_1369_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1260_2370_out_ap_vld = 1'b1;
    end else begin
        add_1260_2370_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1260_3371_out_ap_vld = 1'b1;
    end else begin
        add_1260_3371_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1278365_out_ap_vld = 1'b1;
    end else begin
        add_1278365_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2366_out_ap_vld = 1'b1;
    end else begin
        add_2366_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3367_out_ap_vld = 1'b1;
    end else begin
        add_3367_out_ap_vld = 1'b0;
    end
end
...
assign add364_out = add364_fu_122;

assign add_1260368_out = add_1260368_fu_138;

assign add_1260_1369_out = add_1260_1369_fu_142;

assign add_1260_2370_out = add_1260_2370_fu_146;

assign add_1260_3371_out = add_1260_3371_fu_150;

assign add_1278365_out = add_1278365_fu_126;

assign add_2366_out = add_2366_fu_130;

assign add_3367_out = add_3367_fu_134;

assign add_ln36_fu_722_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(4'd14));

assign add_ln49_10_fu_1285_p2 = (add_1260_1369_fu_142 + add_ln49_9_fu_1279_p2);

assign add_ln49_11_fu_1334_p2 = (and_ln49_11_fu_1328_p2 + mul_ln49_11_fu_360_p2);

assign add_ln49_12_fu_1340_p2 = (add_1260_2370_fu_146 + add_ln49_11_fu_1334_p2);

assign add_ln49_13_fu_1375_p2 = (mul_ln49_14_fu_372_p2 + mul_ln49_13_fu_368_p2);

assign add_ln49_14_fu_1381_p2 = (add_1260_3371_fu_150 + add_ln49_13_fu_1375_p2);

assign add_ln49_1_fu_1013_p2 = (and_ln49_2_fu_1007_p2 + and_ln49_1_fu_994_p2);

assign add_ln49_2_fu_1019_p2 = (add_1278365_fu_126 + add_ln49_1_fu_1013_p2);

assign add_ln49_3_fu_1069_p2 = (and_ln49_4_fu_1063_p2 + and_ln49_3_fu_1050_p2);

assign add_ln49_4_fu_1075_p2 = (add_2366_fu_130 + add_ln49_3_fu_1069_p2);

assign add_ln49_5_fu_1140_p2 = (and_ln49_6_fu_1134_p2 + and_ln49_5_fu_1121_p2);

assign add_ln49_6_fu_1146_p2 = (add_3367_fu_134 + add_ln49_5_fu_1140_p2);

assign add_ln49_7_fu_1210_p2 = (and_ln49_8_fu_1204_p2 + and_ln49_7_fu_1191_p2);

assign add_ln49_8_fu_1216_p2 = (add_1260368_fu_138 + add_ln49_7_fu_1210_p2);

assign add_ln49_9_fu_1279_p2 = (and_ln49_10_fu_1273_p2 + and_ln49_9_fu_1260_p2);

assign add_ln49_fu_769_p2 = (and_ln49_fu_764_p2 + add364_fu_122);
