...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_774_out \
    op interface \
    ports { add55_774_out { O 128 vector } add55_774_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_673_out \
    op interface \
    ports { add55_673_out { O 128 vector } add55_673_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_572_out \
    op interface \
    ports { add55_572_out { O 128 vector } add55_572_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add55_471_out { O 128 vector } add55_471_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 102 \
    name add55_35370_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add55_35370_out \
    op interface \
    ports { add55_35370_out { O 128 vector } add55_35370_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 103 \
    name add55_23969_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add55_23969_out \
    op interface \
    ports { add55_23969_out { O 128 vector } add55_23969_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 104 \
    name add55_12568_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add55_12568_out \
    op interface \
    ports { add55_12568_out { O 128 vector } add55_12568_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add5567_out \
    op interface \
    ports { add5567_out { O 128 vector } add5567_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add30_366_out \
    op interface \
    ports { add30_366_out { O 128 vector } add30_366_out_ap_vld { O 1 bit } } \
} "
}
