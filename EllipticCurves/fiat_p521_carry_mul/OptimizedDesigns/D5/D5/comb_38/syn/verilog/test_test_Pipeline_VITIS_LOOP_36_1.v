...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_7_reload,
        add55_760_out,
        add55_760_out_ap_vld,
        add55_659_out,
        add55_659_out_ap_vld,
        add55_558_out,
        add55_558_out_ap_vld,
        add55_457_out,
        add55_457_out_ap_vld,
        add55_356_out,
        add55_356_out_ap_vld,
        add55_255_out,
        add55_255_out_ap_vld,
        add55_13954_out,
        add55_13954_out_ap_vld,
        add5553_out,
        add5553_out_ap_vld,
        add30_152_out,
        add30_152_out_ap_vld
);
...
output  [127:0] add55_760_out;
output   add55_760_out_ap_vld;
output  [127:0] add55_659_out;
output   add55_659_out_ap_vld;
output  [127:0] add55_558_out;
output   add55_558_out_ap_vld;
output  [127:0] add55_457_out;
output   add55_457_out_ap_vld;
output  [127:0] add55_356_out;
output   add55_356_out_ap_vld;
output  [127:0] add55_255_out;
output   add55_255_out_ap_vld;
output  [127:0] add55_13954_out;
output   add55_13954_out_ap_vld;
output  [127:0] add5553_out;
output   add5553_out_ap_vld;
output  [127:0] add30_152_out;
output   add30_152_out_ap_vld;

reg ap_idle;
reg add55_760_out_ap_vld;
reg add55_659_out_ap_vld;
reg add55_558_out_ap_vld;
reg add55_457_out_ap_vld;
reg add55_356_out_ap_vld;
reg add55_255_out_ap_vld;
reg add55_13954_out_ap_vld;
reg add5553_out_ap_vld;
reg add30_152_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add30_152_out_ap_vld = 1'b1;
    end else begin
        add30_152_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add5553_out_ap_vld = 1'b1;
    end else begin
        add5553_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_13954_out_ap_vld = 1'b1;
    end else begin
        add55_13954_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_255_out_ap_vld = 1'b1;
    end else begin
        add55_255_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_356_out_ap_vld = 1'b1;
    end else begin
        add55_356_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_457_out_ap_vld = 1'b1;
    end else begin
        add55_457_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_558_out_ap_vld = 1'b1;
    end else begin
        add55_558_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_659_out_ap_vld = 1'b1;
    end else begin
        add55_659_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_760_out_ap_vld = 1'b1;
    end else begin
        add55_760_out_ap_vld = 1'b0;
    end
end
...
assign add30_152_out = add30_152_fu_142;

assign add5553_out = arr_8_fu_146;

assign add55_13954_out = arr_9_fu_150;

assign add55_255_out = arr_10_fu_154;

assign add55_356_out = arr_11_fu_158;

assign add55_457_out = arr_12_fu_162;

assign add55_558_out = arr_13_fu_166;

assign add55_659_out = arr_14_fu_170;

assign add55_760_out = arr_15_fu_174;
...
assign add_ln43_2_fu_782_p2 = (add30_152_fu_142 + add_ln43_1_fu_776_p2);
