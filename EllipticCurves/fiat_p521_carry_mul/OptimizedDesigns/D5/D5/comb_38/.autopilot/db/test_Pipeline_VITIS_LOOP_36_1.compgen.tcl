...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_760_out \
    op interface \
    ports { add55_760_out { O 128 vector } add55_760_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_659_out \
    op interface \
    ports { add55_659_out { O 128 vector } add55_659_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_558_out \
    op interface \
    ports { add55_558_out { O 128 vector } add55_558_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_457_out \
    op interface \
    ports { add55_457_out { O 128 vector } add55_457_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_356_out \
    op interface \
    ports { add55_356_out { O 128 vector } add55_356_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_255_out \
    op interface \
    ports { add55_255_out { O 128 vector } add55_255_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 90 \
    name add55_13954_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add55_13954_out \
    op interface \
    ports { add55_13954_out { O 128 vector } add55_13954_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add5553_out \
    op interface \
    ports { add5553_out { O 128 vector } add5553_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add30_152_out \
    op interface \
    ports { add30_152_out { O 128 vector } add30_152_out_ap_vld { O 1 bit } } \
} "
}
