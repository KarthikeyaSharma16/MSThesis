...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_746_out \
    op interface \
    ports { add55_746_out { O 128 vector } add55_746_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_645_out \
    op interface \
    ports { add55_645_out { O 128 vector } add55_645_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_544_out \
    op interface \
    ports { add55_544_out { O 128 vector } add55_544_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_443_out \
    op interface \
    ports { add55_443_out { O 128 vector } add55_443_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_342_out \
    op interface \
    ports { add55_342_out { O 128 vector } add55_342_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_241_out \
    op interface \
    ports { add55_241_out { O 128 vector } add55_241_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_140_out \
    op interface \
    ports { add55_140_out { O 128 vector } add55_140_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add5539_out \
    op interface \
    ports { add5539_out { O 128 vector } add5539_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add3038_out \
    op interface \
    ports { add3038_out { O 128 vector } add3038_out_ap_vld { O 1 bit } } \
} "
}
