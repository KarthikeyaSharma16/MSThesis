...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_7137_out \
    op interface \
    ports { add55_7137_out { O 128 vector } add55_7137_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_6136_out \
    op interface \
    ports { add55_6136_out { O 128 vector } add55_6136_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_5135_out \
    op interface \
    ports { add55_5135_out { O 128 vector } add55_5135_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_4134_out \
    op interface \
    ports { add55_4134_out { O 128 vector } add55_4134_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_3133_out \
    op interface \
    ports { add55_3133_out { O 128 vector } add55_3133_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_2132_out \
    op interface \
    ports { add55_2132_out { O 128 vector } add55_2132_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_1131_out \
    op interface \
    ports { add55_1131_out { O 128 vector } add55_1131_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55130_out \
    op interface \
    ports { add55130_out { O 128 vector } add55130_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add30129_out { O 128 vector } add30129_out_ap_vld { O 1 bit } } \
} "
}
