...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_cast,
        add55_7137_out,
        add55_7137_out_ap_vld,
        add55_6136_out,
        add55_6136_out_ap_vld,
        add55_5135_out,
        add55_5135_out_ap_vld,
        add55_4134_out,
        add55_4134_out_ap_vld,
        add55_3133_out,
        add55_3133_out_ap_vld,
        add55_2132_out,
        add55_2132_out_ap_vld,
        add55_1131_out,
        add55_1131_out_ap_vld,
        add55130_out,
        add55130_out_ap_vld,
        add30129_out,
        add30129_out_ap_vld
...
output  [127:0] add55_7137_out;
output   add55_7137_out_ap_vld;
output  [127:0] add55_6136_out;
output   add55_6136_out_ap_vld;
output  [127:0] add55_5135_out;
output   add55_5135_out_ap_vld;
output  [127:0] add55_4134_out;
output   add55_4134_out_ap_vld;
output  [127:0] add55_3133_out;
output   add55_3133_out_ap_vld;
output  [127:0] add55_2132_out;
output   add55_2132_out_ap_vld;
output  [127:0] add55_1131_out;
output   add55_1131_out_ap_vld;
output  [127:0] add55130_out;
output   add55130_out_ap_vld;
output  [127:0] add30129_out;
output   add30129_out_ap_vld;

reg ap_idle;
reg add55_7137_out_ap_vld;
reg add55_6136_out_ap_vld;
reg add55_5135_out_ap_vld;
reg add55_4134_out_ap_vld;
reg add55_3133_out_ap_vld;
reg add55_2132_out_ap_vld;
reg add55_1131_out_ap_vld;
reg add55130_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55130_out_ap_vld = 1'b1;
    end else begin
        add55130_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_1131_out_ap_vld = 1'b1;
    end else begin
        add55_1131_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_2132_out_ap_vld = 1'b1;
    end else begin
        add55_2132_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_3133_out_ap_vld = 1'b1;
    end else begin
        add55_3133_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_4134_out_ap_vld = 1'b1;
    end else begin
        add55_4134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_5135_out_ap_vld = 1'b1;
    end else begin
        add55_5135_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_6136_out_ap_vld = 1'b1;
    end else begin
        add55_6136_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_7137_out_ap_vld = 1'b1;
    end else begin
        add55_7137_out_ap_vld = 1'b0;
    end
end
...
assign add30129_out = add30129_fu_138;

assign add55130_out = add55130_fu_142;

assign add55_1131_out = add55_1131_fu_146;

assign add55_2132_out = add55_2132_fu_150;

assign add55_3133_out = add55_3133_fu_154;

assign add55_4134_out = add55_4134_fu_158;

assign add55_5135_out = add55_5135_fu_162;

assign add55_6136_out = add55_6136_fu_166;

assign add55_7137_out = add55_7137_fu_170;

assign add_ln36_fu_738_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(4'd15));

assign add_ln43_fu_761_p2 = (mul_ln43_reg_1316 + add30129_fu_138);

assign add_ln50_1_fu_796_p2 = (and_ln50_1_fu_791_p2 + add55_1131_fu_146);

assign add_ln50_2_fu_814_p2 = (and_ln50_2_fu_809_p2 + add55_2132_fu_150);

assign add_ln50_3_fu_1036_p2 = (and_ln50_3_fu_1031_p2 + add55_3133_fu_154);

assign add_ln50_4_fu_1054_p2 = (and_ln50_4_fu_1049_p2 + add55_4134_fu_158);

assign add_ln50_5_fu_1072_p2 = (and_ln50_5_fu_1067_p2 + add55_5135_fu_162);

assign add_ln50_6_fu_1090_p2 = (and_ln50_6_fu_1085_p2 + add55_6136_fu_166);

assign add_ln50_7_fu_1096_p2 = (mul_ln50_7_reg_1409 + add55_7137_fu_170);

assign add_ln50_fu_778_p2 = (and_ln50_fu_773_p2 + add55130_fu_142);
