...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_cast,
        add55_3_161_out,
        add55_3_161_out_ap_vld,
        add55_360_out,
        add55_360_out_ap_vld,
        add55_2_159_out,
        add55_2_159_out_ap_vld,
        add55_258_out,
        add55_258_out_ap_vld,
        add55_1_157_out,
        add55_1_157_out_ap_vld,
        add55_156_out,
        add55_156_out_ap_vld,
        add55_14055_out,
...
output  [127:0] add55_3_161_out;
output   add55_3_161_out_ap_vld;
output  [127:0] add55_360_out;
output   add55_360_out_ap_vld;
output  [127:0] add55_2_159_out;
output   add55_2_159_out_ap_vld;
output  [127:0] add55_258_out;
output   add55_258_out_ap_vld;
output  [127:0] add55_1_157_out;
output   add55_1_157_out_ap_vld;
output  [127:0] add55_156_out;
output   add55_156_out_ap_vld;
...
reg ap_idle;
reg add55_3_161_out_ap_vld;
reg add55_360_out_ap_vld;
reg add55_2_159_out_ap_vld;
reg add55_258_out_ap_vld;
reg add55_1_157_out_ap_vld;
reg add55_156_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_484_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_156_out_ap_vld = 1'b1;
    end else begin
        add55_156_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_484_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_157_out_ap_vld = 1'b1;
    end else begin
        add55_1_157_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_484_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_258_out_ap_vld = 1'b1;
    end else begin
        add55_258_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_484_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2_159_out_ap_vld = 1'b1;
    end else begin
        add55_2_159_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_484_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_360_out_ap_vld = 1'b1;
    end else begin
        add55_360_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_484_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3_161_out_ap_vld = 1'b1;
    end else begin
        add55_3_161_out_ap_vld = 1'b0;
    end
end
...
assign add55_156_out = arr_10_fu_150;

assign add55_1_157_out = arr_11_fu_154;

assign add55_258_out = arr_12_fu_158;

assign add55_2_159_out = arr_13_fu_162;

assign add55_360_out = arr_14_fu_166;

assign add55_3_161_out = arr_15_fu_170;
