...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_788_out \
    op interface \
    ports { add55_788_out { O 128 vector } add55_788_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_687_out \
    op interface \
    ports { add55_687_out { O 128 vector } add55_687_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_586_out \
    op interface \
    ports { add55_586_out { O 128 vector } add55_586_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_485_out \
    op interface \
    ports { add55_485_out { O 128 vector } add55_485_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_384_out \
    op interface \
    ports { add55_384_out { O 128 vector } add55_384_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_283_out \
    op interface \
    ports { add55_283_out { O 128 vector } add55_283_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 90 \
    name add55_16782_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add55_16782_out \
    op interface \
    ports { add55_16782_out { O 128 vector } add55_16782_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add5581_out \
    op interface \
    ports { add5581_out { O 128 vector } add5581_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add30_180_out \
    op interface \
    ports { add30_180_out { O 128 vector } add30_180_out_ap_vld { O 1 bit } } \
} "
}
