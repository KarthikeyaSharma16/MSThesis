...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_7_reload,
        add55_3_1177_out,
        add55_3_1177_out_ap_vld,
        add55_3176_out,
        add55_3176_out_ap_vld,
        add55_2_1175_out,
        add55_2_1175_out_ap_vld,
        add55_2174_out,
        add55_2174_out_ap_vld,
        add55_1140_1173_out,
        add55_1140_1173_out_ap_vld,
        add55_1140172_out,
        add55_1140172_out_ap_vld,
        add55_1156171_out,
        add55_1156171_out_ap_vld,
        add55170_out,
        add55170_out_ap_vld,
        add30_1169_out,
        add30_1169_out_ap_vld
);
...
output  [127:0] add55_3_1177_out;
output   add55_3_1177_out_ap_vld;
output  [127:0] add55_3176_out;
output   add55_3176_out_ap_vld;
output  [127:0] add55_2_1175_out;
output   add55_2_1175_out_ap_vld;
output  [127:0] add55_2174_out;
output   add55_2174_out_ap_vld;
output  [127:0] add55_1140_1173_out;
output   add55_1140_1173_out_ap_vld;
output  [127:0] add55_1140172_out;
output   add55_1140172_out_ap_vld;
output  [127:0] add55_1156171_out;
output   add55_1156171_out_ap_vld;
output  [127:0] add55170_out;
output   add55170_out_ap_vld;
output  [127:0] add30_1169_out;
output   add30_1169_out_ap_vld;

reg ap_idle;
reg add55_3_1177_out_ap_vld;
reg add55_3176_out_ap_vld;
reg add55_2_1175_out_ap_vld;
reg add55_2174_out_ap_vld;
reg add55_1140_1173_out_ap_vld;
reg add55_1140172_out_ap_vld;
reg add55_1156171_out_ap_vld;
reg add55170_out_ap_vld;
reg add30_1169_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln36_reg_1871 == 1'd1))) begin
        add30_1169_out_ap_vld = 1'b1;
    end else begin
        add30_1169_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln36_reg_1871 == 1'd1))) begin
        add55170_out_ap_vld = 1'b1;
    end else begin
        add55170_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln36_reg_1871 == 1'd1))) begin
        add55_1140172_out_ap_vld = 1'b1;
    end else begin
        add55_1140172_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln36_reg_1871 == 1'd1))) begin
        add55_1140_1173_out_ap_vld = 1'b1;
    end else begin
        add55_1140_1173_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln36_reg_1871 == 1'd1))) begin
        add55_1156171_out_ap_vld = 1'b1;
    end else begin
        add55_1156171_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln36_reg_1871 == 1'd1))) begin
        add55_2174_out_ap_vld = 1'b1;
    end else begin
        add55_2174_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln36_reg_1871 == 1'd1))) begin
        add55_2_1175_out_ap_vld = 1'b1;
    end else begin
        add55_2_1175_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln36_reg_1871 == 1'd1))) begin
        add55_3176_out_ap_vld = 1'b1;
    end else begin
        add55_3176_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln36_reg_1871 == 1'd1))) begin
        add55_3_1177_out_ap_vld = 1'b1;
    end else begin
        add55_3_1177_out_ap_vld = 1'b0;
    end
end
...
assign add30_1169_out = add30_1169_fu_142;

assign add55170_out = arr_8_fu_146;

assign add55_1140172_out = arr_10_fu_154;

assign add55_1140_1173_out = arr_11_fu_158;

assign add55_1156171_out = arr_9_fu_150;

assign add55_2174_out = arr_12_fu_162;

assign add55_2_1175_out = arr_13_fu_166;

assign add55_3176_out = arr_14_fu_170;

assign add55_3_1177_out = arr_15_fu_174;
...
assign add_ln43_2_fu_815_p2 = (add30_1169_fu_142 + add_ln43_1_fu_809_p2);
