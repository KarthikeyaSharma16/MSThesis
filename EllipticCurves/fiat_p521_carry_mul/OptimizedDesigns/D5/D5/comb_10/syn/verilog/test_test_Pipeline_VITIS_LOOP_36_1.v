...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_cast,
        add55_3_190_out,
        add55_3_190_out_ap_vld,
        add55_389_out,
        add55_389_out_ap_vld,
        add55_2_188_out,
        add55_2_188_out_ap_vld,
        add55_287_out,
        add55_287_out_ap_vld,
        add55_1_186_out,
        add55_1_186_out_ap_vld,
        add55_185_out,
        add55_185_out_ap_vld,
        add55_16984_out,
        add55_16984_out_ap_vld,
        add5583_out,
        add5583_out_ap_vld,
        add3082_out,
        add3082_out_ap_vld
...
output  [127:0] add55_3_190_out;
output   add55_3_190_out_ap_vld;
output  [127:0] add55_389_out;
output   add55_389_out_ap_vld;
output  [127:0] add55_2_188_out;
output   add55_2_188_out_ap_vld;
output  [127:0] add55_287_out;
output   add55_287_out_ap_vld;
output  [127:0] add55_1_186_out;
output   add55_1_186_out_ap_vld;
output  [127:0] add55_185_out;
output   add55_185_out_ap_vld;
output  [127:0] add55_16984_out;
output   add55_16984_out_ap_vld;
output  [127:0] add5583_out;
output   add5583_out_ap_vld;
output  [127:0] add3082_out;
output   add3082_out_ap_vld;

reg ap_idle;
reg add55_3_190_out_ap_vld;
reg add55_389_out_ap_vld;
reg add55_2_188_out_ap_vld;
reg add55_287_out_ap_vld;
reg add55_1_186_out_ap_vld;
reg add55_185_out_ap_vld;
reg add55_16984_out_ap_vld;
reg add5583_out_ap_vld;
reg add3082_out_ap_vld;
...
wire   [0:0] tmp_19_fu_568_p3;
reg   [0:0] tmp_19_reg_1326;
...
reg   [127:0] add3082_fu_138;
wire   [127:0] add_ln43_fu_761_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [127:0] arr_8_fu_142;
wire   [127:0] arr_fu_778_p2;
reg   [127:0] arr_9_fu_146;
wire   [127:0] arr_16_fu_796_p2;
reg   [127:0] arr_10_fu_150;
wire   [127:0] arr_17_fu_814_p2;
reg   [127:0] arr_11_fu_154;
wire   [127:0] arr_18_fu_1036_p2;
reg   [127:0] arr_12_fu_158;
wire   [127:0] arr_19_fu_1054_p2;
reg   [127:0] arr_13_fu_162;
wire   [127:0] arr_20_fu_1072_p2;
reg   [127:0] arr_14_fu_166;
wire   [127:0] arr_21_fu_1090_p2;
reg   [127:0] arr_15_fu_170;
wire   [127:0] arr_22_fu_1096_p2;
reg   [3:0] i_fu_174;
...
wire   [1:0] tmp_20_fu_690_p4;
wire   [3:0] zext_ln51_3_fu_706_p1;
wire   [2:0] tmp_21_fu_722_p4;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_485_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_19_reg_1326 <= ap_sig_allocacmp_i_2[32'd3];
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add3082_out_ap_vld = 1'b1;
    end else begin
        add3082_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add5583_out_ap_vld = 1'b1;
    end else begin
        add5583_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_16984_out_ap_vld = 1'b1;
    end else begin
        add55_16984_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_185_out_ap_vld = 1'b1;
    end else begin
        add55_185_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_1_186_out_ap_vld = 1'b1;
    end else begin
        add55_1_186_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_287_out_ap_vld = 1'b1;
    end else begin
        add55_287_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_2_188_out_ap_vld = 1'b1;
    end else begin
        add55_2_188_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_389_out_ap_vld = 1'b1;
    end else begin
        add55_389_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_3_190_out_ap_vld = 1'b1;
    end else begin
        add55_3_190_out_ap_vld = 1'b0;
    end
end
...
assign add3082_out = add3082_fu_138;

assign add5583_out = arr_8_fu_142;

assign add55_16984_out = arr_9_fu_146;

assign add55_185_out = arr_10_fu_150;

assign add55_1_186_out = arr_11_fu_154;

assign add55_287_out = arr_12_fu_158;

assign add55_2_188_out = arr_13_fu_162;

assign add55_389_out = arr_14_fu_166;

assign add55_3_190_out = arr_15_fu_170;

assign add_ln36_fu_738_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(4'd15));

assign add_ln43_fu_761_p2 = (mul_ln43_reg_1316 + add3082_fu_138);
...
assign arr_16_fu_796_p2 = (and_ln50_1_fu_791_p2 + arr_9_fu_146);

assign arr_17_fu_814_p2 = (and_ln50_2_fu_809_p2 + arr_10_fu_150);

assign arr_18_fu_1036_p2 = (and_ln50_3_fu_1031_p2 + arr_11_fu_154);

assign arr_19_fu_1054_p2 = (and_ln50_4_fu_1049_p2 + arr_12_fu_158);

assign arr_20_fu_1072_p2 = (and_ln50_5_fu_1067_p2 + arr_13_fu_162);

assign arr_21_fu_1090_p2 = (and_ln50_6_fu_1085_p2 + arr_14_fu_166);

assign arr_22_fu_1096_p2 = (mul_ln50_7_reg_1409 + arr_15_fu_170);

assign arr_fu_778_p2 = (and_ln50_fu_773_p2 + arr_8_fu_142);

assign icmp_ln36_fu_485_p2 = ((ap_sig_allocacmp_i_2 == 4'd0) ? 1'b1 : 1'b0);

assign icmp_ln50_1_fu_658_p2 = ((ap_sig_allocacmp_i_2 > 4'd5) ? 1'b1 : 1'b0);

assign icmp_ln50_2_fu_674_p2 = ((ap_sig_allocacmp_i_2 > 4'd4) ? 1'b1 : 1'b0);

assign icmp_ln50_3_fu_700_p2 = ((tmp_20_fu_690_p4 != 2'd0) ? 1'b1 : 1'b0);

assign icmp_ln50_4_fu_716_p2 = ((ap_sig_allocacmp_i_2 > 4'd2) ? 1'b1 : 1'b0);

assign icmp_ln50_5_fu_732_p2 = ((tmp_21_fu_722_p4 != 3'd0) ? 1'b1 : 1'b0);

assign icmp_ln50_fu_597_p2 = ((ap_sig_allocacmp_i_2 > 4'd6) ? 1'b1 : 1'b0);
...
assign select_ln50_1_fu_766_p3 = ((tmp_19_reg_1326[0:0] == 1'b1) ? 128'd340282366920938463463374607431768211455 : 128'd0);
...
assign select_ln50_fu_576_p3 = ((tmp_18_fu_560_p3[0:0] == 1'b1) ? arg2_r_7_cast : arg2_r_8_cast);

assign select_ln51_fu_603_p3 = ((tmp_19_fu_568_p3[0:0] == 1'b1) ? 4'd7 : 4'd8);
...
assign tmp_18_fu_560_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_19_fu_568_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_1_fu_533_p9 = (3'd0 - trunc_ln34_fu_491_p1);

assign tmp_20_fu_690_p4 = {{ap_sig_allocacmp_i_2[3:2]}};

assign tmp_21_fu_722_p4 = {{ap_sig_allocacmp_i_2[3:1]}};

assign tmp_8_fu_960_p10 = (sub_ln34_1_fu_916_p2 - zext_ln51_5_fu_951_p1);

assign trunc_ln34_fu_491_p1 = ap_sig_allocacmp_i_2[2:0];
