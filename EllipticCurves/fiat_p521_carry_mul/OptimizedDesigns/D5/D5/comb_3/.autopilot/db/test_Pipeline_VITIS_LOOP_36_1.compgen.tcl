...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_789_out \
    op interface \
    ports { add55_789_out { O 128 vector } add55_789_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_688_out \
    op interface \
    ports { add55_688_out { O 128 vector } add55_688_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_587_out \
    op interface \
    ports { add55_587_out { O 128 vector } add55_587_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_486_out \
    op interface \
    ports { add55_486_out { O 128 vector } add55_486_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_385_out \
    op interface \
    ports { add55_385_out { O 128 vector } add55_385_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_284_out \
    op interface \
    ports { add55_284_out { O 128 vector } add55_284_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 90 \
    name add55_16883_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add55_16883_out \
    op interface \
    ports { add55_16883_out { O 128 vector } add55_16883_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add5582_out \
    op interface \
    ports { add5582_out { O 128 vector } add5582_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add30_181_out \
    op interface \
    ports { add30_181_out { O 128 vector } add30_181_out_ap_vld { O 1 bit } } \
} "
}
