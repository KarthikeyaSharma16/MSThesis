...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_7_reload,
        add55_789_out,
        add55_789_out_ap_vld,
        add55_688_out,
        add55_688_out_ap_vld,
        add55_587_out,
        add55_587_out_ap_vld,
        add55_486_out,
        add55_486_out_ap_vld,
        add55_385_out,
        add55_385_out_ap_vld,
        add55_284_out,
        add55_284_out_ap_vld,
        add55_16883_out,
        add55_16883_out_ap_vld,
        add5582_out,
        add5582_out_ap_vld,
        add30_181_out,
        add30_181_out_ap_vld
);
...
output  [127:0] add55_789_out;
output   add55_789_out_ap_vld;
output  [127:0] add55_688_out;
output   add55_688_out_ap_vld;
output  [127:0] add55_587_out;
output   add55_587_out_ap_vld;
output  [127:0] add55_486_out;
output   add55_486_out_ap_vld;
output  [127:0] add55_385_out;
output   add55_385_out_ap_vld;
output  [127:0] add55_284_out;
output   add55_284_out_ap_vld;
output  [127:0] add55_16883_out;
output   add55_16883_out_ap_vld;
output  [127:0] add5582_out;
output   add5582_out_ap_vld;
output  [127:0] add30_181_out;
output   add30_181_out_ap_vld;

reg ap_idle;
reg add55_789_out_ap_vld;
reg add55_688_out_ap_vld;
reg add55_587_out_ap_vld;
reg add55_486_out_ap_vld;
reg add55_385_out_ap_vld;
reg add55_284_out_ap_vld;
reg add55_16883_out_ap_vld;
reg add5582_out_ap_vld;
reg add30_181_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add30_181_out_ap_vld = 1'b1;
    end else begin
        add30_181_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add5582_out_ap_vld = 1'b1;
    end else begin
        add5582_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_16883_out_ap_vld = 1'b1;
    end else begin
        add55_16883_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_284_out_ap_vld = 1'b1;
    end else begin
        add55_284_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_385_out_ap_vld = 1'b1;
    end else begin
        add55_385_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_486_out_ap_vld = 1'b1;
    end else begin
        add55_486_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_587_out_ap_vld = 1'b1;
    end else begin
        add55_587_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_688_out_ap_vld = 1'b1;
    end else begin
        add55_688_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_789_out_ap_vld = 1'b1;
    end else begin
        add55_789_out_ap_vld = 1'b0;
    end
end
...
assign add30_181_out = add30_181_fu_142;

assign add5582_out = arr_8_fu_146;

assign add55_16883_out = arr_9_fu_150;

assign add55_284_out = arr_10_fu_154;

assign add55_385_out = arr_11_fu_158;

assign add55_486_out = arr_12_fu_162;

assign add55_587_out = arr_13_fu_166;

assign add55_688_out = arr_14_fu_170;

assign add55_789_out = arr_15_fu_174;
...
assign add_ln43_2_fu_782_p2 = (add30_181_fu_142 + add_ln43_1_fu_776_p2);
