...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_7_reload,
        add55_3_1183_out,
        add55_3_1183_out_ap_vld,
        add55_3182_out,
        add55_3182_out_ap_vld,
        add55_2_1181_out,
        add55_2_1181_out_ap_vld,
        add55_2180_out,
        add55_2180_out_ap_vld,
        add55_1146_1179_out,
        add55_1146_1179_out_ap_vld,
        add55_1146178_out,
        add55_1146178_out_ap_vld,
        add55_1162177_out,
        add55_1162177_out_ap_vld,
        add55176_out,
        add55176_out_ap_vld,
        add30_1175_out,
        add30_1175_out_ap_vld
);
...
output  [127:0] add55_3_1183_out;
output   add55_3_1183_out_ap_vld;
output  [127:0] add55_3182_out;
output   add55_3182_out_ap_vld;
output  [127:0] add55_2_1181_out;
output   add55_2_1181_out_ap_vld;
output  [127:0] add55_2180_out;
output   add55_2180_out_ap_vld;
output  [127:0] add55_1146_1179_out;
output   add55_1146_1179_out_ap_vld;
output  [127:0] add55_1146178_out;
output   add55_1146178_out_ap_vld;
output  [127:0] add55_1162177_out;
output   add55_1162177_out_ap_vld;
output  [127:0] add55176_out;
output   add55176_out_ap_vld;
output  [127:0] add30_1175_out;
output   add30_1175_out_ap_vld;

reg ap_idle;
reg add55_3_1183_out_ap_vld;
reg add55_3182_out_ap_vld;
reg add55_2_1181_out_ap_vld;
reg add55_2180_out_ap_vld;
reg add55_1146_1179_out_ap_vld;
reg add55_1146178_out_ap_vld;
reg add55_1162177_out_ap_vld;
reg add55176_out_ap_vld;
reg add30_1175_out_ap_vld;
...
wire   [0:0] tmp_15_fu_598_p3;
reg   [0:0] tmp_15_reg_1895;
...
reg   [127:0] add30_1175_fu_142;
wire   [127:0] add_ln43_2_fu_782_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [127:0] add55176_fu_146;
wire   [127:0] add_ln50_fu_996_p2;
reg   [127:0] add55_1162177_fu_150;
wire   [127:0] add_ln50_2_fu_828_p2;
reg   [127:0] add55_1146178_fu_154;
wire   [127:0] add_ln50_4_fu_1236_p2;
reg   [127:0] add55_1146_1179_fu_158;
wire   [127:0] add_ln50_6_fu_1307_p2;
reg   [127:0] add55_2180_fu_162;
wire   [127:0] add_ln50_8_fu_1377_p2;
reg   [127:0] add55_2_1181_fu_166;
wire   [127:0] add_ln50_10_fu_1446_p2;
reg   [127:0] add55_3182_fu_170;
wire   [127:0] add_ln50_12_fu_1501_p2;
reg   [127:0] add55_3_1183_fu_174;
wire   [127:0] add_ln50_14_fu_1542_p2;
reg   [3:0] i_fu_178;
...
wire   [127:0] add_ln50_3_fu_1230_p2;
...
wire   [127:0] add_ln50_5_fu_1301_p2;
...
wire   [127:0] add_ln50_7_fu_1371_p2;
...
wire   [127:0] add_ln50_9_fu_1440_p2;
...
wire   [127:0] add_ln50_11_fu_1495_p2;
...
wire   [127:0] add_ln50_13_fu_1536_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add55176_fu_146 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add55176_fu_146 <= add_ln50_fu_996_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add55_1146178_fu_154 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add55_1146178_fu_154 <= add_ln50_4_fu_1236_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add55_1146_1179_fu_158 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add55_1146_1179_fu_158 <= add_ln50_6_fu_1307_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add55_1162177_fu_150 <= 128'd0;
        end else if (((icmp_ln36_fu_520_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add55_1162177_fu_150 <= add_ln50_2_fu_828_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add55_2180_fu_162 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add55_2180_fu_162 <= add_ln50_8_fu_1377_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add55_2_1181_fu_166 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add55_2_1181_fu_166 <= add_ln50_10_fu_1446_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add55_3182_fu_170 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add55_3182_fu_170 <= add_ln50_12_fu_1501_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add55_3_1183_fu_174 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add55_3_1183_fu_174 <= add_ln50_14_fu_1542_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_520_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_15_reg_1895 <= i_fu_178[32'd3];
...
always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add30_1175_out_ap_vld = 1'b1;
    end else begin
        add30_1175_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55176_out_ap_vld = 1'b1;
    end else begin
        add55176_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1146178_out_ap_vld = 1'b1;
    end else begin
        add55_1146178_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1146_1179_out_ap_vld = 1'b1;
    end else begin
        add55_1146_1179_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1162177_out_ap_vld = 1'b1;
    end else begin
        add55_1162177_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2180_out_ap_vld = 1'b1;
    end else begin
        add55_2180_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2_1181_out_ap_vld = 1'b1;
    end else begin
        add55_2_1181_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3182_out_ap_vld = 1'b1;
    end else begin
        add55_3182_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3_1183_out_ap_vld = 1'b1;
    end else begin
        add55_3_1183_out_ap_vld = 1'b0;
    end
end
...
assign add30_1175_out = add30_1175_fu_142;

assign add55176_out = add55176_fu_146;

assign add55_1146178_out = add55_1146178_fu_154;

assign add55_1146_1179_out = add55_1146_1179_fu_158;

assign add55_1162177_out = add55_1162177_fu_150;

assign add55_2180_out = add55_2180_fu_162;

assign add55_2_1181_out = add55_2_1181_fu_166;

assign add55_3182_out = add55_3182_fu_170;

assign add55_3_1183_out = add55_3_1183_fu_174;
...
assign add_ln43_2_fu_782_p2 = (add30_1175_fu_142 + add_ln43_1_fu_776_p2);

assign add_ln43_fu_723_p2 = ($signed(i_fu_178) + $signed(4'd15));

assign add_ln50_10_fu_1446_p2 = (add55_2_1181_fu_166 + add_ln50_9_fu_1440_p2);

assign add_ln50_11_fu_1495_p2 = (and_ln50_11_fu_1489_p2 + mul_ln50_11_fu_447_p2);

assign add_ln50_12_fu_1501_p2 = (add55_3182_fu_170 + add_ln50_11_fu_1495_p2);

assign add_ln50_13_fu_1536_p2 = (mul_ln50_14_fu_459_p2 + mul_ln50_13_fu_455_p2);

assign add_ln50_14_fu_1542_p2 = (add55_3_1183_fu_174 + add_ln50_13_fu_1536_p2);

assign add_ln50_1_fu_822_p2 = (and_ln50_2_fu_816_p2 + and_ln50_1_fu_802_p2);

assign add_ln50_2_fu_828_p2 = (add55_1162177_fu_150 + add_ln50_1_fu_822_p2);

assign add_ln50_3_fu_1230_p2 = (and_ln50_4_fu_1224_p2 + and_ln50_3_fu_1211_p2);

assign add_ln50_4_fu_1236_p2 = (add55_1146178_fu_154 + add_ln50_3_fu_1230_p2);

assign add_ln50_5_fu_1301_p2 = (and_ln50_6_fu_1295_p2 + and_ln50_5_fu_1282_p2);

assign add_ln50_6_fu_1307_p2 = (add55_1146_1179_fu_158 + add_ln50_5_fu_1301_p2);

assign add_ln50_7_fu_1371_p2 = (and_ln50_8_fu_1365_p2 + and_ln50_7_fu_1352_p2);

assign add_ln50_8_fu_1377_p2 = (add55_2180_fu_162 + add_ln50_7_fu_1371_p2);

assign add_ln50_9_fu_1440_p2 = (and_ln50_10_fu_1434_p2 + and_ln50_9_fu_1421_p2);

assign add_ln50_fu_996_p2 = (and_ln50_fu_991_p2 + add55176_fu_146);
...
assign icmp_ln50_10_fu_926_p2 = (($signed(tmp_18_fu_916_p4) > $signed(3'd0)) ? 1'b1 : 1'b0);

assign icmp_ln50_1_fu_649_p2 = ((i_fu_178 > 4'd5) ? 1'b1 : 1'b0);

assign icmp_ln50_2_fu_665_p2 = ((i_fu_178 > 4'd4) ? 1'b1 : 1'b0);

assign icmp_ln50_3_fu_691_p2 = ((tmp_16_fu_681_p4 != 2'd0) ? 1'b1 : 1'b0);
...
assign icmp_ln50_8_fu_884_p2 = ((tmp_17_fu_874_p4 == 2'd1) ? 1'b1 : 1'b0);
...
assign select_ln34_fu_606_p3 = ((tmp_15_fu_598_p3[0:0] == 1'b1) ? 4'd7 : 4'd8);
...
assign select_ln50_2_fu_984_p3 = ((tmp_15_reg_1895[0:0] == 1'b1) ? 128'd340282366920938463463374607431768211455 : 128'd0);
...
assign select_ln50_fu_614_p3 = ((tmp_14_fu_590_p3[0:0] == 1'b1) ? arg2_r_7_cast : arg2_r_8_cast);
...
assign tmp_14_fu_590_p3 = i_fu_178[32'd3];

assign tmp_15_fu_598_p3 = i_fu_178[32'd3];

assign tmp_16_fu_681_p4 = {{i_fu_178[3:2]}};

assign tmp_17_fu_874_p4 = {{add_ln43_fu_723_p2[3:2]}};

assign tmp_18_fu_916_p4 = {{add_ln43_fu_723_p2[3:1]}};
