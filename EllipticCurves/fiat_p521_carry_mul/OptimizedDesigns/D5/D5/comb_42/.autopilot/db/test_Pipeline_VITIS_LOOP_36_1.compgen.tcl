...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_7130_out \
    op interface \
    ports { add55_7130_out { O 128 vector } add55_7130_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_6129_out \
    op interface \
    ports { add55_6129_out { O 128 vector } add55_6129_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_5128_out \
    op interface \
    ports { add55_5128_out { O 128 vector } add55_5128_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_4127_out \
    op interface \
    ports { add55_4127_out { O 128 vector } add55_4127_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_3126_out \
    op interface \
    ports { add55_3126_out { O 128 vector } add55_3126_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_2125_out \
    op interface \
    ports { add55_2125_out { O 128 vector } add55_2125_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add55_1124_out { O 128 vector } add55_1124_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add55123_out { O 128 vector } add55123_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add30122_out \
    op interface \
    ports { add30122_out { O 128 vector } add30122_out_ap_vld { O 1 bit } } \
} "
}
