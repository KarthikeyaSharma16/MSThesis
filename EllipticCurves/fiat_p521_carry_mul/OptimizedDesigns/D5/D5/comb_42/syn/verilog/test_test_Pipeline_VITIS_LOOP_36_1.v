...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_cast,
        add55_7130_out,
        add55_7130_out_ap_vld,
        add55_6129_out,
        add55_6129_out_ap_vld,
        add55_5128_out,
        add55_5128_out_ap_vld,
        add55_4127_out,
        add55_4127_out_ap_vld,
        add55_3126_out,
        add55_3126_out_ap_vld,
        add55_2125_out,
        add55_2125_out_ap_vld,
        add55_1124_out,
        add55_1124_out_ap_vld,
        add55123_out,
        add55123_out_ap_vld,
        add30122_out,
        add30122_out_ap_vld
...
output  [127:0] add55_7130_out;
output   add55_7130_out_ap_vld;
output  [127:0] add55_6129_out;
output   add55_6129_out_ap_vld;
output  [127:0] add55_5128_out;
output   add55_5128_out_ap_vld;
output  [127:0] add55_4127_out;
output   add55_4127_out_ap_vld;
output  [127:0] add55_3126_out;
output   add55_3126_out_ap_vld;
output  [127:0] add55_2125_out;
output   add55_2125_out_ap_vld;
output  [127:0] add55_1124_out;
output   add55_1124_out_ap_vld;
output  [127:0] add55123_out;
output   add55123_out_ap_vld;
output  [127:0] add30122_out;
output   add30122_out_ap_vld;

reg ap_idle;
reg add55_7130_out_ap_vld;
reg add55_6129_out_ap_vld;
reg add55_5128_out_ap_vld;
reg add55_4127_out_ap_vld;
reg add55_3126_out_ap_vld;
reg add55_2125_out_ap_vld;
reg add55_1124_out_ap_vld;
reg add55123_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55123_out_ap_vld = 1'b1;
    end else begin
        add55123_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_1124_out_ap_vld = 1'b1;
    end else begin
        add55_1124_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_2125_out_ap_vld = 1'b1;
    end else begin
        add55_2125_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_3126_out_ap_vld = 1'b1;
    end else begin
        add55_3126_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_4127_out_ap_vld = 1'b1;
    end else begin
        add55_4127_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_5128_out_ap_vld = 1'b1;
    end else begin
        add55_5128_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_6129_out_ap_vld = 1'b1;
    end else begin
        add55_6129_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_7130_out_ap_vld = 1'b1;
    end else begin
        add55_7130_out_ap_vld = 1'b0;
    end
end
...
assign add30122_out = add30122_fu_138;

assign add55123_out = add55123_fu_142;

assign add55_1124_out = add55_1124_fu_146;

assign add55_2125_out = add55_2125_fu_150;

assign add55_3126_out = add55_3126_fu_154;

assign add55_4127_out = add55_4127_fu_158;

assign add55_5128_out = add55_5128_fu_162;

assign add55_6129_out = add55_6129_fu_166;

assign add55_7130_out = add55_7130_fu_170;

assign add_ln36_fu_738_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(4'd15));

assign add_ln43_fu_761_p2 = (mul_ln43_reg_1316 + add30122_fu_138);

assign add_ln50_1_fu_796_p2 = (and_ln50_1_fu_791_p2 + add55_1124_fu_146);

assign add_ln50_2_fu_814_p2 = (and_ln50_2_fu_809_p2 + add55_2125_fu_150);

assign add_ln50_3_fu_1036_p2 = (and_ln50_3_fu_1031_p2 + add55_3126_fu_154);

assign add_ln50_4_fu_1054_p2 = (and_ln50_4_fu_1049_p2 + add55_4127_fu_158);

assign add_ln50_5_fu_1072_p2 = (and_ln50_5_fu_1067_p2 + add55_5128_fu_162);

assign add_ln50_6_fu_1090_p2 = (and_ln50_6_fu_1085_p2 + add55_6129_fu_166);

assign add_ln50_7_fu_1096_p2 = (mul_ln50_7_reg_1409 + add55_7130_fu_170);

assign add_ln50_fu_778_p2 = (and_ln50_fu_773_p2 + add55123_fu_142);
