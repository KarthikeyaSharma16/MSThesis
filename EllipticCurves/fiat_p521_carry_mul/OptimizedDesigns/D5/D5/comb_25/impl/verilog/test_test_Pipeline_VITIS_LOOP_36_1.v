...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_7_reload,
        add55_3_192_out,
        add55_3_192_out_ap_vld,
        add55_391_out,
        add55_391_out_ap_vld,
        add55_2_190_out,
        add55_2_190_out_ap_vld,
        add55_289_out,
        add55_289_out_ap_vld,
        add55_155_188_out,
        add55_155_188_out_ap_vld,
        add55_15587_out,
        add55_15587_out_ap_vld,
        add55_17186_out,
        add55_17186_out_ap_vld,
        add5585_out,
        add5585_out_ap_vld,
        add30_184_out,
        add30_184_out_ap_vld
);
...
output  [127:0] add55_3_192_out;
output   add55_3_192_out_ap_vld;
output  [127:0] add55_391_out;
output   add55_391_out_ap_vld;
output  [127:0] add55_2_190_out;
output   add55_2_190_out_ap_vld;
output  [127:0] add55_289_out;
output   add55_289_out_ap_vld;
output  [127:0] add55_155_188_out;
output   add55_155_188_out_ap_vld;
output  [127:0] add55_15587_out;
output   add55_15587_out_ap_vld;
output  [127:0] add55_17186_out;
output   add55_17186_out_ap_vld;
output  [127:0] add5585_out;
output   add5585_out_ap_vld;
output  [127:0] add30_184_out;
output   add30_184_out_ap_vld;

reg ap_idle;
reg add55_3_192_out_ap_vld;
reg add55_391_out_ap_vld;
reg add55_2_190_out_ap_vld;
reg add55_289_out_ap_vld;
reg add55_155_188_out_ap_vld;
reg add55_15587_out_ap_vld;
reg add55_17186_out_ap_vld;
reg add5585_out_ap_vld;
reg add30_184_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add30_184_out_ap_vld = 1'b1;
    end else begin
        add30_184_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add5585_out_ap_vld = 1'b1;
    end else begin
        add5585_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_15587_out_ap_vld = 1'b1;
    end else begin
        add55_15587_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_155_188_out_ap_vld = 1'b1;
    end else begin
        add55_155_188_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_17186_out_ap_vld = 1'b1;
    end else begin
        add55_17186_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_289_out_ap_vld = 1'b1;
    end else begin
        add55_289_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2_190_out_ap_vld = 1'b1;
    end else begin
        add55_2_190_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_391_out_ap_vld = 1'b1;
    end else begin
        add55_391_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3_192_out_ap_vld = 1'b1;
    end else begin
        add55_3_192_out_ap_vld = 1'b0;
    end
end
...
assign add30_184_out = add30_184_fu_142;

assign add5585_out = arr_8_fu_146;

assign add55_15587_out = arr_10_fu_154;

assign add55_155_188_out = arr_11_fu_158;

assign add55_17186_out = arr_9_fu_150;

assign add55_289_out = arr_12_fu_162;

assign add55_2_190_out = arr_13_fu_166;

assign add55_391_out = arr_14_fu_170;

assign add55_3_192_out = arr_15_fu_174;
...
assign add_ln43_2_fu_782_p2 = (add30_184_fu_142 + add_ln43_1_fu_776_p2);
