...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_7131_out \
    op interface \
    ports { add55_7131_out { O 128 vector } add55_7131_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_6130_out \
    op interface \
    ports { add55_6130_out { O 128 vector } add55_6130_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_5129_out \
    op interface \
    ports { add55_5129_out { O 128 vector } add55_5129_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_4128_out \
    op interface \
    ports { add55_4128_out { O 128 vector } add55_4128_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_3127_out \
    op interface \
    ports { add55_3127_out { O 128 vector } add55_3127_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_2126_out \
    op interface \
    ports { add55_2126_out { O 128 vector } add55_2126_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_1125_out \
    op interface \
    ports { add55_1125_out { O 128 vector } add55_1125_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55124_out \
    op interface \
    ports { add55124_out { O 128 vector } add55124_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add30123_out { O 128 vector } add30123_out_ap_vld { O 1 bit } } \
} "
}
