...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_cast,
        add55_7131_out,
        add55_7131_out_ap_vld,
        add55_6130_out,
        add55_6130_out_ap_vld,
        add55_5129_out,
        add55_5129_out_ap_vld,
        add55_4128_out,
        add55_4128_out_ap_vld,
        add55_3127_out,
        add55_3127_out_ap_vld,
        add55_2126_out,
        add55_2126_out_ap_vld,
        add55_1125_out,
        add55_1125_out_ap_vld,
        add55124_out,
        add55124_out_ap_vld,
        add30123_out,
        add30123_out_ap_vld
...
output  [127:0] add55_7131_out;
output   add55_7131_out_ap_vld;
output  [127:0] add55_6130_out;
output   add55_6130_out_ap_vld;
output  [127:0] add55_5129_out;
output   add55_5129_out_ap_vld;
output  [127:0] add55_4128_out;
output   add55_4128_out_ap_vld;
output  [127:0] add55_3127_out;
output   add55_3127_out_ap_vld;
output  [127:0] add55_2126_out;
output   add55_2126_out_ap_vld;
output  [127:0] add55_1125_out;
output   add55_1125_out_ap_vld;
output  [127:0] add55124_out;
output   add55124_out_ap_vld;
output  [127:0] add30123_out;
output   add30123_out_ap_vld;

reg ap_idle;
reg add55_7131_out_ap_vld;
reg add55_6130_out_ap_vld;
reg add55_5129_out_ap_vld;
reg add55_4128_out_ap_vld;
reg add55_3127_out_ap_vld;
reg add55_2126_out_ap_vld;
reg add55_1125_out_ap_vld;
reg add55124_out_ap_vld;
...
wire   [0:0] tmp_27_fu_568_p3;
reg   [0:0] tmp_27_reg_1326;
...
wire   [1:0] tmp_28_fu_690_p4;
wire   [3:0] zext_ln51_3_fu_706_p1;
wire   [2:0] tmp_29_fu_722_p4;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_485_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_27_reg_1326 <= ap_sig_allocacmp_i_2[32'd3];
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55124_out_ap_vld = 1'b1;
    end else begin
        add55124_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_1125_out_ap_vld = 1'b1;
    end else begin
        add55_1125_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_2126_out_ap_vld = 1'b1;
    end else begin
        add55_2126_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_3127_out_ap_vld = 1'b1;
    end else begin
        add55_3127_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_4128_out_ap_vld = 1'b1;
    end else begin
        add55_4128_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_5129_out_ap_vld = 1'b1;
    end else begin
        add55_5129_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_6130_out_ap_vld = 1'b1;
    end else begin
        add55_6130_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_7131_out_ap_vld = 1'b1;
    end else begin
        add55_7131_out_ap_vld = 1'b0;
    end
end
...
assign add30123_out = add30123_fu_138;

assign add55124_out = arr_8_fu_142;

assign add55_1125_out = arr_9_fu_146;

assign add55_2126_out = arr_10_fu_150;

assign add55_3127_out = arr_11_fu_154;

assign add55_4128_out = arr_12_fu_158;

assign add55_5129_out = arr_13_fu_162;

assign add55_6130_out = arr_14_fu_166;

assign add55_7131_out = arr_15_fu_170;

assign add_ln36_fu_738_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(4'd15));

assign add_ln43_fu_761_p2 = (mul_ln43_reg_1316 + add30123_fu_138);
...
assign icmp_ln50_3_fu_700_p2 = ((tmp_28_fu_690_p4 != 2'd0) ? 1'b1 : 1'b0);

assign icmp_ln50_4_fu_716_p2 = ((ap_sig_allocacmp_i_2 > 4'd2) ? 1'b1 : 1'b0);

assign icmp_ln50_5_fu_732_p2 = ((tmp_29_fu_722_p4 != 3'd0) ? 1'b1 : 1'b0);
...
assign select_ln50_1_fu_766_p3 = ((tmp_27_reg_1326[0:0] == 1'b1) ? 128'd340282366920938463463374607431768211455 : 128'd0);
...
assign select_ln50_fu_576_p3 = ((tmp_26_fu_560_p3[0:0] == 1'b1) ? arg2_r_7_cast : arg2_r_8_cast);

assign select_ln51_fu_603_p3 = ((tmp_27_fu_568_p3[0:0] == 1'b1) ? 4'd7 : 4'd8);
...
assign tmp_26_fu_560_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_27_fu_568_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_28_fu_690_p4 = {{ap_sig_allocacmp_i_2[3:2]}};

assign tmp_29_fu_722_p4 = {{ap_sig_allocacmp_i_2[3:1]}};
