...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        add55_370_out,
        add55_370_out_ap_vld,
        add55_269_out,
        add55_269_out_ap_vld,
        add55_168_out,
        add55_168_out_ap_vld,
        add5567_out,
        add5567_out_ap_vld,
        add3066_out,
        add3066_out_ap_vld
...
output  [127:0] add55_370_out;
output   add55_370_out_ap_vld;
output  [127:0] add55_269_out;
output   add55_269_out_ap_vld;
output  [127:0] add55_168_out;
output   add55_168_out_ap_vld;
output  [127:0] add5567_out;
output   add5567_out_ap_vld;
output  [127:0] add3066_out;
output   add3066_out_ap_vld;
...
reg add55_370_out_ap_vld;
reg add55_269_out_ap_vld;
reg add55_168_out_ap_vld;
reg add5567_out_ap_vld;
reg add3066_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add3066_out_ap_vld = 1'b1;
    end else begin
        add3066_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_168_out_ap_vld = 1'b1;
    end else begin
        add55_168_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_269_out_ap_vld = 1'b1;
    end else begin
        add55_269_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1303 == 1'd1))) begin
        add55_370_out_ap_vld = 1'b1;
    end else begin
        add55_370_out_ap_vld = 1'b0;
    end
end
...
assign add3066_out = add3066_fu_138;

assign add5567_out = arr_8_fu_142;

assign add55_168_out = arr_9_fu_146;

assign add55_269_out = arr_10_fu_150;

assign add55_370_out = arr_11_fu_154;
...
assign add_ln43_fu_761_p2 = (mul_ln43_reg_1316 + add3066_fu_138);
