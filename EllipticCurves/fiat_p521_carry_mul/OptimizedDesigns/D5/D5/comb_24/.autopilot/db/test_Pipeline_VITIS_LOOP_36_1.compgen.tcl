...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_370_out \
    op interface \
    ports { add55_370_out { O 128 vector } add55_370_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_269_out \
    op interface \
    ports { add55_269_out { O 128 vector } add55_269_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_168_out \
    op interface \
    ports { add55_168_out { O 128 vector } add55_168_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add3066_out \
    op interface \
    ports { add3066_out { O 128 vector } add3066_out_ap_vld { O 1 bit } } \
} "
}
