...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_7189_out \
    op interface \
    ports { add55_7189_out { O 128 vector } add55_7189_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_6188_out \
    op interface \
    ports { add55_6188_out { O 128 vector } add55_6188_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_5187_out \
    op interface \
    ports { add55_5187_out { O 128 vector } add55_5187_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_4186_out \
    op interface \
    ports { add55_4186_out { O 128 vector } add55_4186_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_3185_out \
    op interface \
    ports { add55_3185_out { O 128 vector } add55_3185_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_2184_out \
    op interface \
    ports { add55_2184_out { O 128 vector } add55_2184_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_1183_out \
    op interface \
    ports { add55_1183_out { O 128 vector } add55_1183_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55182_out \
    op interface \
    ports { add55182_out { O 128 vector } add55182_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add30181_out \
    op interface \
    ports { add30181_out { O 128 vector } add30181_out_ap_vld { O 1 bit } } \
} "
}
