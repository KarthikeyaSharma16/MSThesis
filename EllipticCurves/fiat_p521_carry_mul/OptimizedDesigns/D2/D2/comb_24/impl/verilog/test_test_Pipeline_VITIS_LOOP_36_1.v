...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv35,
        add47_736_out,
        add47_736_out_ap_vld,
        add47_635_out,
        add47_635_out_ap_vld,
        add47_534_out,
        add47_534_out_ap_vld,
        add47_433_out,
        add47_433_out_ap_vld,
        add47_332_out,
        add47_332_out_ap_vld,
        add47_231_out,
        add47_231_out_ap_vld,
        add47_130_out,
        add47_130_out_ap_vld,
        add4729_out,
        add4729_out_ap_vld
);
...
input  [63:0] arg2;
input  [63:0] conv35;
output  [127:0] add47_736_out;
output   add47_736_out_ap_vld;
output  [127:0] add47_635_out;
output   add47_635_out_ap_vld;
output  [127:0] add47_534_out;
output   add47_534_out_ap_vld;
output  [127:0] add47_433_out;
output   add47_433_out_ap_vld;
output  [127:0] add47_332_out;
output   add47_332_out_ap_vld;
output  [127:0] add47_231_out;
output   add47_231_out_ap_vld;
output  [127:0] add47_130_out;
output   add47_130_out_ap_vld;
output  [127:0] add4729_out;
output   add4729_out_ap_vld;

reg ap_idle;
reg m_axi_mem_ARVALID;
reg[63:0] m_axi_mem_ARADDR;
reg m_axi_mem_RREADY;
reg add47_736_out_ap_vld;
reg add47_635_out_ap_vld;
reg add47_534_out_ap_vld;
reg add47_433_out_ap_vld;
reg add47_332_out_ap_vld;
reg add47_231_out_ap_vld;
reg add47_130_out_ap_vld;
reg add4729_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        add4729_fu_128 <= add_ln52_2_fu_1096_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        add47_130_fu_132 <= 128'd0;
        ...
        add47_130_fu_132 <= add_ln52_5_fu_1303_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        add47_231_fu_136 <= 128'd0;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add4729_out_ap_vld = 1'b1;
    end else begin
        add4729_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_130_out_ap_vld = 1'b1;
    end else begin
        add47_130_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_231_out_ap_vld = 1'b1;
    end else begin
        add47_231_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_332_out_ap_vld = 1'b1;
    end else begin
        add47_332_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_433_out_ap_vld = 1'b1;
    end else begin
        add47_433_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_534_out_ap_vld = 1'b1;
    end else begin
        add47_534_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_635_out_ap_vld = 1'b1;
    end else begin
        add47_635_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_736_out_ap_vld = 1'b1;
    end else begin
        add47_736_out_ap_vld = 1'b0;
    end
end
...
assign add4729_out = add4729_fu_128;

assign add47_130_out = add47_130_fu_132;

assign add47_231_out = add47_231_fu_136;

assign add47_332_out = add47_332_fu_140;

assign add47_433_out = add47_433_fu_144;

assign add47_534_out = add47_534_fu_148;

assign add47_635_out = add47_635_fu_152;

assign add47_736_out = add47_736_fu_156;
...
assign add_ln52_11_fu_1566_p2 = (add47_332_fu_140 + add_ln52_10_fu_1561_p2);
...
assign add_ln52_14_fu_1625_p2 = (add47_433_fu_144 + add_ln52_13_fu_1620_p2);
...
assign add_ln52_17_fu_1684_p2 = (add47_534_fu_148 + add_ln52_16_fu_1679_p2);
...
assign add_ln52_20_fu_1743_p2 = (add47_635_fu_152 + add_ln52_19_fu_1738_p2);
...
assign add_ln52_23_fu_1802_p2 = (add47_736_fu_156 + add_ln52_22_fu_1797_p2);

assign add_ln52_2_fu_1096_p2 = (add4729_fu_128 + add_ln52_1_fu_1091_p2);
...
assign add_ln52_5_fu_1303_p2 = (add47_130_fu_132 + add_ln52_4_fu_1298_p2);
...
assign add_ln52_8_fu_1452_p2 = (add47_231_fu_136 + add_ln52_7_fu_1447_p2);
