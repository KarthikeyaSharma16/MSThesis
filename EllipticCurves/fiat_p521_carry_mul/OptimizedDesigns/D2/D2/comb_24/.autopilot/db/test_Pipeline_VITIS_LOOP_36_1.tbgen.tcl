...
set C_modelArgList {
	...
	{ add47_736_out int 128 regular {pointer 1}  }
	{ add47_635_out int 128 regular {pointer 1}  }
	{ add47_534_out int 128 regular {pointer 1}  }
	{ add47_433_out int 128 regular {pointer 1}  }
	{ add47_332_out int 128 regular {pointer 1}  }
	{ add47_231_out int 128 regular {pointer 1}  }
	{ add47_130_out int 128 regular {pointer 1}  }
	{ add4729_out int 128 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "add47_736_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_635_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_534_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_433_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_332_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_231_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_130_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add4729_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ arg1 sc_in sc_lv 64 signal 1 } 
	{ arg2 sc_in sc_lv 64 signal 2 } 
	{ conv35 sc_in sc_lv 64 signal 3 } 
	{ add47_736_out sc_out sc_lv 128 signal 4 } 
	{ add47_736_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ add47_635_out sc_out sc_lv 128 signal 5 } 
	{ add47_635_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ add47_534_out sc_out sc_lv 128 signal 6 } 
	{ add47_534_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ add47_433_out sc_out sc_lv 128 signal 7 } 
	{ add47_433_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ add47_332_out sc_out sc_lv 128 signal 8 } 
	{ add47_332_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ add47_231_out sc_out sc_lv 128 signal 9 } 
	{ add47_231_out_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ add47_130_out sc_out sc_lv 128 signal 10 } 
	{ add47_130_out_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ add4729_out sc_out sc_lv 128 signal 11 } 
	{ add4729_out_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add47_736_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_736_out", "role": "default" }} , 
 	{ "name": "add47_736_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_736_out", "role": "ap_vld" }} , 
 	{ "name": "add47_635_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_635_out", "role": "default" }} , 
 	{ "name": "add47_635_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_635_out", "role": "ap_vld" }} , 
 	{ "name": "add47_534_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_534_out", "role": "default" }} , 
 	{ "name": "add47_534_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_534_out", "role": "ap_vld" }} , 
 	{ "name": "add47_433_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_433_out", "role": "default" }} , 
 	{ "name": "add47_433_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_433_out", "role": "ap_vld" }} , 
 	{ "name": "add47_332_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_332_out", "role": "default" }} , 
 	{ "name": "add47_332_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_332_out", "role": "ap_vld" }} , 
 	{ "name": "add47_231_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_231_out", "role": "default" }} , 
 	{ "name": "add47_231_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_231_out", "role": "ap_vld" }} , 
 	{ "name": "add47_130_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_130_out", "role": "default" }} , 
 	{ "name": "add47_130_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_130_out", "role": "ap_vld" }} , 
 	{ "name": "add4729_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add4729_out", "role": "default" }} , 
 	{ "name": "add4729_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add4729_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "add47_736_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_635_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_534_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_433_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_332_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_231_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_130_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add4729_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	test_Pipeline_VITIS_LOOP_36_1 {
		...
		add47_736_out {Type O LastRead -1 FirstWrite 9}
		add47_635_out {Type O LastRead -1 FirstWrite 9}
		add47_534_out {Type O LastRead -1 FirstWrite 9}
		add47_433_out {Type O LastRead -1 FirstWrite 9}
		add47_332_out {Type O LastRead -1 FirstWrite 9}
		add47_231_out {Type O LastRead -1 FirstWrite 9}
		add47_130_out {Type O LastRead -1 FirstWrite 9}
		add4729_out {Type O LastRead -1 FirstWrite 9}}}
...
set Spec2ImplPortList { 
	...
	add47_736_out { ap_vld {  { add47_736_out out_data 1 128 }  { add47_736_out_ap_vld out_vld 1 1 } } }
	add47_635_out { ap_vld {  { add47_635_out out_data 1 128 }  { add47_635_out_ap_vld out_vld 1 1 } } }
	add47_534_out { ap_vld {  { add47_534_out out_data 1 128 }  { add47_534_out_ap_vld out_vld 1 1 } } }
	add47_433_out { ap_vld {  { add47_433_out out_data 1 128 }  { add47_433_out_ap_vld out_vld 1 1 } } }
	add47_332_out { ap_vld {  { add47_332_out out_data 1 128 }  { add47_332_out_ap_vld out_vld 1 1 } } }
	add47_231_out { ap_vld {  { add47_231_out out_data 1 128 }  { add47_231_out_ap_vld out_vld 1 1 } } }
	add47_130_out { ap_vld {  { add47_130_out out_data 1 128 }  { add47_130_out_ap_vld out_vld 1 1 } } }
	add4729_out { ap_vld {  { add4729_out out_data 1 128 }  { add4729_out_ap_vld out_vld 1 1 } } }
}
