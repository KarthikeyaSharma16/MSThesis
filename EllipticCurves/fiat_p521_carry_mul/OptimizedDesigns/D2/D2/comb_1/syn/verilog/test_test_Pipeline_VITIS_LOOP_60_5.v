...
output  [127:0] add122_265_out;
output   add122_265_out_ap_vld;

reg ap_idle;
reg add122_265_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add122_265_fu_80 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add122_265_fu_80 <= add_ln66_2_fu_434_p2;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln60_fu_228_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add122_265_out_ap_vld = 1'b1;
    end else begin
        add122_265_out_ap_vld = 1'b0;
    end
end
