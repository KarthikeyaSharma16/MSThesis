...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv35,
        add47_737_out,
        add47_737_out_ap_vld,
        add47_636_out,
        add47_636_out_ap_vld,
        add47_535_out,
        add47_535_out_ap_vld,
        add47_434_out,
        add47_434_out_ap_vld,
        add47_333_out,
        add47_333_out_ap_vld,
        add47_232_out,
        add47_232_out_ap_vld,
        add47_131_out,
        add47_131_out_ap_vld,
        add4730_out,
        add4730_out_ap_vld
);
...
input  [63:0] arg2;
input  [63:0] conv35;
output  [127:0] add47_737_out;
output   add47_737_out_ap_vld;
output  [127:0] add47_636_out;
output   add47_636_out_ap_vld;
output  [127:0] add47_535_out;
output   add47_535_out_ap_vld;
output  [127:0] add47_434_out;
output   add47_434_out_ap_vld;
output  [127:0] add47_333_out;
output   add47_333_out_ap_vld;
output  [127:0] add47_232_out;
output   add47_232_out_ap_vld;
output  [127:0] add47_131_out;
output   add47_131_out_ap_vld;
output  [127:0] add4730_out;
output   add4730_out_ap_vld;

reg ap_idle;
reg m_axi_mem_ARVALID;
reg[63:0] m_axi_mem_ARADDR;
reg m_axi_mem_RREADY;
reg add47_737_out_ap_vld;
reg add47_636_out_ap_vld;
reg add47_535_out_ap_vld;
reg add47_434_out_ap_vld;
reg add47_333_out_ap_vld;
reg add47_232_out_ap_vld;
reg add47_131_out_ap_vld;
reg add4730_out_ap_vld;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add4730_out_ap_vld = 1'b1;
    end else begin
        add4730_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_131_out_ap_vld = 1'b1;
    end else begin
        add47_131_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_232_out_ap_vld = 1'b1;
    end else begin
        add47_232_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_333_out_ap_vld = 1'b1;
    end else begin
        add47_333_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_434_out_ap_vld = 1'b1;
    end else begin
        add47_434_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_535_out_ap_vld = 1'b1;
    end else begin
        add47_535_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_636_out_ap_vld = 1'b1;
    end else begin
        add47_636_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_737_out_ap_vld = 1'b1;
    end else begin
        add47_737_out_ap_vld = 1'b0;
    end
end
...
assign add4730_out = arr_8_fu_128;

assign add47_131_out = arr_9_fu_132;

assign add47_232_out = arr_10_fu_136;

assign add47_333_out = arr_11_fu_140;

assign add47_434_out = arr_12_fu_144;

assign add47_535_out = arr_13_fu_148;

assign add47_636_out = arr_14_fu_152;

assign add47_737_out = arr_15_fu_156;
