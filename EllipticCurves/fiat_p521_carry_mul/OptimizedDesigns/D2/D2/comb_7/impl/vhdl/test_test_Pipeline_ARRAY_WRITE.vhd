...
begin
    mux_9_4_59_1_1_U39 : component test_mux_9_4_59_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 59,
    ...
    add_ln82_fu_204_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv4_1));
    ...
    icmp_ln82_fu_198_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv4_9) else "0";
    ...
    tmp_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln71_1),59));
    tmp_fu_210_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln72_1),59));
    tmp_fu_210_p4 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln74),59));
    tmp_fu_210_p5 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln75),59));
    tmp_fu_210_p6 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln76),59));
    tmp_fu_210_p7 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln77),59));
    tmp_fu_210_p8 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln66_18),59));
