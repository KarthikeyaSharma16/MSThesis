...
set C_modelArgList {
	{ mem int 64 regular {axi_master 0}  }
	{ p_cast_cast int 61 regular  }
	{ arg2 int 64 regular  }
	{ arg1 int 64 regular  }
	{ conv35 int 64 regular  }
	{ add47_7140_out int 128 regular {pointer 1}  }
	{ add47_6139_out int 128 regular {pointer 1}  }
	{ add47_5138_out int 128 regular {pointer 1}  }
	{ add47_4137_out int 128 regular {pointer 1}  }
	{ add47_3136_out int 128 regular {pointer 1}  }
	{ add47_262135_out int 128 regular {pointer 1}  }
	{ add47_126134_out int 128 regular {pointer 1}  }
	{ add47133_out int 128 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "p_cast_cast", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
 	{ "Name" : "arg2", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "arg1", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "conv35", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "add47_7140_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_6139_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_5138_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_4137_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_3136_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_262135_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_126134_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47133_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ arg2 sc_in sc_lv 64 signal 2 } 
	{ arg1 sc_in sc_lv 64 signal 3 } 
	{ conv35 sc_in sc_lv 64 signal 4 } 
	{ add47_7140_out sc_out sc_lv 128 signal 5 } 
	{ add47_7140_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ add47_6139_out sc_out sc_lv 128 signal 6 } 
	{ add47_6139_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ add47_5138_out sc_out sc_lv 128 signal 7 } 
	{ add47_5138_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ add47_4137_out sc_out sc_lv 128 signal 8 } 
	{ add47_4137_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ add47_3136_out sc_out sc_lv 128 signal 9 } 
	{ add47_3136_out_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ add47_262135_out sc_out sc_lv 128 signal 10 } 
	{ add47_262135_out_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ add47_126134_out sc_out sc_lv 128 signal 11 } 
	{ add47_126134_out_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ add47133_out sc_out sc_lv 128 signal 12 } 
	{ add47133_out_ap_vld sc_out sc_logic 1 outvld 12 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "arg2", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "arg2", "role": "default" }} , 
 	{ "name": "arg1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "arg1", "role": "default" }} , 
 	{ "name": "conv35", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "conv35", "role": "default" }} , 
 	{ "name": "add47_7140_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_7140_out", "role": "default" }} , 
 	{ "name": "add47_7140_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_7140_out", "role": "ap_vld" }} , 
 	{ "name": "add47_6139_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_6139_out", "role": "default" }} , 
 	{ "name": "add47_6139_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_6139_out", "role": "ap_vld" }} , 
 	{ "name": "add47_5138_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_5138_out", "role": "default" }} , 
 	{ "name": "add47_5138_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_5138_out", "role": "ap_vld" }} , 
 	{ "name": "add47_4137_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_4137_out", "role": "default" }} , 
 	{ "name": "add47_4137_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_4137_out", "role": "ap_vld" }} , 
 	{ "name": "add47_3136_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_3136_out", "role": "default" }} , 
 	{ "name": "add47_3136_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_3136_out", "role": "ap_vld" }} , 
 	{ "name": "add47_262135_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_262135_out", "role": "default" }} , 
 	{ "name": "add47_262135_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_262135_out", "role": "ap_vld" }} , 
 	{ "name": "add47_126134_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_126134_out", "role": "default" }} , 
 	{ "name": "add47_126134_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_126134_out", "role": "ap_vld" }} , 
 	{ "name": "add47133_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47133_out", "role": "default" }} , 
 	{ "name": "add47133_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47133_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "conv35", "Type" : "None", "Direction" : "I"},
			{"Name" : "add47_7140_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_6139_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_5138_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_4137_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_3136_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_262135_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_126134_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47133_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_36_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "39", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage10", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage10_subdone", "QuitState" : "ap_ST_fsm_pp0_stage19", "QuitStateIter" : "ap_enable_reg_pp0_iter0", "QuitStateBlock" : "ap_block_pp0_stage19_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
...
set ArgLastReadFirstWriteLatency {
	test_Pipeline_VITIS_LOOP_36_1 {
		mem {Type I LastRead 47 FirstWrite -1}
		p_cast_cast {Type I LastRead 0 FirstWrite -1}
		arg2 {Type I LastRead 0 FirstWrite -1}
		arg1 {Type I LastRead 0 FirstWrite -1}
		conv35 {Type I LastRead 0 FirstWrite -1}
		add47_7140_out {Type O LastRead -1 FirstWrite 19}
		add47_6139_out {Type O LastRead -1 FirstWrite 19}
		add47_5138_out {Type O LastRead -1 FirstWrite 19}
		add47_4137_out {Type O LastRead -1 FirstWrite 19}
		add47_3136_out {Type O LastRead -1 FirstWrite 19}
		add47_262135_out {Type O LastRead -1 FirstWrite 19}
		add47_126134_out {Type O LastRead -1 FirstWrite 19}
		add47133_out {Type O LastRead -1 FirstWrite 19}}}
...
set Spec2ImplPortList { 
	 { m_axi {  { m_axi_mem_AWVALID VALID 1 1 }  { m_axi_mem_AWREADY READY 0 1 }  { m_axi_mem_AWADDR ADDR 1 64 }  { m_axi_mem_AWID ID 1 1 }  { m_axi_mem_AWLEN SIZE 1 32 }  { m_axi_mem_AWSIZE BURST 1 3 }  { m_axi_mem_AWBURST LOCK 1 2 }  { m_axi_mem_AWLOCK CACHE 1 2 }  { m_axi_mem_AWCACHE PROT 1 4 }  { m_axi_mem_AWPROT QOS 1 3 }  { m_axi_mem_AWQOS REGION 1 4 }  { m_axi_mem_AWREGION USER 1 4 }  { m_axi_mem_AWUSER DATA 1 1 }  { m_axi_mem_WVALID VALID 1 1 }  { m_axi_mem_WREADY READY 0 1 }  { m_axi_mem_WDATA FIFONUM 1 64 }  { m_axi_mem_WSTRB STRB 1 8 }  { m_axi_mem_WLAST LAST 1 1 }  { m_axi_mem_WID ID 1 1 }  { m_axi_mem_WUSER DATA 1 1 }  { m_axi_mem_ARVALID VALID 1 1 }  { m_axi_mem_ARREADY READY 0 1 }  { m_axi_mem_ARADDR ADDR 1 64 }  { m_axi_mem_ARID ID 1 1 }  { m_axi_mem_ARLEN SIZE 1 32 }  { m_axi_mem_ARSIZE BURST 1 3 }  { m_axi_mem_ARBURST LOCK 1 2 }  { m_axi_mem_ARLOCK CACHE 1 2 }  { m_axi_mem_ARCACHE PROT 1 4 }  { m_axi_mem_ARPROT QOS 1 3 }  { m_axi_mem_ARQOS REGION 1 4 }  { m_axi_mem_ARREGION USER 1 4 }  { m_axi_mem_ARUSER DATA 1 1 }  { m_axi_mem_RVALID VALID 0 1 }  { m_axi_mem_RREADY READY 1 1 }  { m_axi_mem_RDATA FIFONUM 0 64 }  { m_axi_mem_RLAST LAST 0 1 }  { m_axi_mem_RID ID 0 1 }  { m_axi_mem_RFIFONUM LEN 0 9 }  { m_axi_mem_RUSER DATA 0 1 }  { m_axi_mem_RRESP RESP 0 2 }  { m_axi_mem_BVALID VALID 0 1 }  { m_axi_mem_BREADY READY 1 1 }  { m_axi_mem_BRESP RESP 0 2 }  { m_axi_mem_BID ID 0 1 }  { m_axi_mem_BUSER DATA 0 1 } } }
	p_cast_cast { ap_none {  { p_cast_cast in_data 0 61 } } }
	arg2 { ap_none {  { arg2 in_data 0 64 } } }
	arg1 { ap_none {  { arg1 in_data 0 64 } } }
	conv35 { ap_none {  { conv35 in_data 0 64 } } }
	add47_7140_out { ap_vld {  { add47_7140_out out_data 1 128 }  { add47_7140_out_ap_vld out_vld 1 1 } } }
	add47_6139_out { ap_vld {  { add47_6139_out out_data 1 128 }  { add47_6139_out_ap_vld out_vld 1 1 } } }
	add47_5138_out { ap_vld {  { add47_5138_out out_data 1 128 }  { add47_5138_out_ap_vld out_vld 1 1 } } }
	add47_4137_out { ap_vld {  { add47_4137_out out_data 1 128 }  { add47_4137_out_ap_vld out_vld 1 1 } } }
	add47_3136_out { ap_vld {  { add47_3136_out out_data 1 128 }  { add47_3136_out_ap_vld out_vld 1 1 } } }
	add47_262135_out { ap_vld {  { add47_262135_out out_data 1 128 }  { add47_262135_out_ap_vld out_vld 1 1 } } }
	add47_126134_out { ap_vld {  { add47_126134_out out_data 1 128 }  { add47_126134_out_ap_vld out_vld 1 1 } } }
	add47133_out { ap_vld {  { add47133_out out_data 1 128 }  { add47133_out_ap_vld out_vld 1 1 } } }
}
