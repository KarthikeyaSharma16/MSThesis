...
set C_modelArgList {
	...
	{ add47_7139_out int 128 regular {pointer 1}  }
	{ add47_6138_out int 128 regular {pointer 1}  }
	{ add47_5137_out int 128 regular {pointer 1}  }
	{ add47_4136_out int 128 regular {pointer 1}  }
	{ add47_3135_out int 128 regular {pointer 1}  }
	{ add47_260134_out int 128 regular {pointer 1}  }
	{ add47_125133_out int 128 regular {pointer 1}  }
	{ add47132_out int 128 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "add47_7139_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_6138_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_5137_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_4136_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_3135_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_260134_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_125133_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47132_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ add47_7139_out sc_out sc_lv 128 signal 5 } 
	{ add47_7139_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ add47_6138_out sc_out sc_lv 128 signal 6 } 
	{ add47_6138_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ add47_5137_out sc_out sc_lv 128 signal 7 } 
	{ add47_5137_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ add47_4136_out sc_out sc_lv 128 signal 8 } 
	{ add47_4136_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ add47_3135_out sc_out sc_lv 128 signal 9 } 
	{ add47_3135_out_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ add47_260134_out sc_out sc_lv 128 signal 10 } 
	{ add47_260134_out_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ add47_125133_out sc_out sc_lv 128 signal 11 } 
	{ add47_125133_out_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ add47132_out sc_out sc_lv 128 signal 12 } 
	{ add47132_out_ap_vld sc_out sc_logic 1 outvld 12 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add47_7139_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_7139_out", "role": "default" }} , 
 	{ "name": "add47_7139_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_7139_out", "role": "ap_vld" }} , 
 	{ "name": "add47_6138_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_6138_out", "role": "default" }} , 
 	{ "name": "add47_6138_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_6138_out", "role": "ap_vld" }} , 
 	{ "name": "add47_5137_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_5137_out", "role": "default" }} , 
 	{ "name": "add47_5137_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_5137_out", "role": "ap_vld" }} , 
 	{ "name": "add47_4136_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_4136_out", "role": "default" }} , 
 	{ "name": "add47_4136_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_4136_out", "role": "ap_vld" }} , 
 	{ "name": "add47_3135_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_3135_out", "role": "default" }} , 
 	{ "name": "add47_3135_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_3135_out", "role": "ap_vld" }} , 
 	{ "name": "add47_260134_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_260134_out", "role": "default" }} , 
 	{ "name": "add47_260134_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_260134_out", "role": "ap_vld" }} , 
 	{ "name": "add47_125133_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_125133_out", "role": "default" }} , 
 	{ "name": "add47_125133_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_125133_out", "role": "ap_vld" }} , 
 	{ "name": "add47132_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47132_out", "role": "default" }} , 
 	{ "name": "add47132_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47132_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "add47_7139_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_6138_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_5137_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_4136_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_3135_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_260134_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_125133_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47132_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	test_Pipeline_VITIS_LOOP_36_1 {
		...
		add47_7139_out {Type O LastRead -1 FirstWrite 19}
		add47_6138_out {Type O LastRead -1 FirstWrite 19}
		add47_5137_out {Type O LastRead -1 FirstWrite 19}
		add47_4136_out {Type O LastRead -1 FirstWrite 19}
		add47_3135_out {Type O LastRead -1 FirstWrite 19}
		add47_260134_out {Type O LastRead -1 FirstWrite 19}
		add47_125133_out {Type O LastRead -1 FirstWrite 19}
		add47132_out {Type O LastRead -1 FirstWrite 19}}}
...
set Spec2ImplPortList { 
	...
	add47_7139_out { ap_vld {  { add47_7139_out out_data 1 128 }  { add47_7139_out_ap_vld out_vld 1 1 } } }
	add47_6138_out { ap_vld {  { add47_6138_out out_data 1 128 }  { add47_6138_out_ap_vld out_vld 1 1 } } }
	add47_5137_out { ap_vld {  { add47_5137_out out_data 1 128 }  { add47_5137_out_ap_vld out_vld 1 1 } } }
	add47_4136_out { ap_vld {  { add47_4136_out out_data 1 128 }  { add47_4136_out_ap_vld out_vld 1 1 } } }
	add47_3135_out { ap_vld {  { add47_3135_out out_data 1 128 }  { add47_3135_out_ap_vld out_vld 1 1 } } }
	add47_260134_out { ap_vld {  { add47_260134_out out_data 1 128 }  { add47_260134_out_ap_vld out_vld 1 1 } } }
	add47_125133_out { ap_vld {  { add47_125133_out out_data 1 128 }  { add47_125133_out_ap_vld out_vld 1 1 } } }
	add47132_out { ap_vld {  { add47132_out out_data 1 128 }  { add47132_out_ap_vld out_vld 1 1 } } }
}
