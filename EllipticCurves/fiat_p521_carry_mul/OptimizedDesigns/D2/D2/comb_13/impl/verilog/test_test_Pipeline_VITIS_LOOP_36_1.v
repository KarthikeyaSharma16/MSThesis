...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv35,
        add47_1_372_out,
        add47_1_372_out_ap_vld,
        add47_1_271_out,
        add47_1_271_out_ap_vld,
        add47_1_170_out,
        add47_1_170_out_ap_vld,
        add47_169_out,
        add47_169_out_ap_vld,
        add47_368_out,
        add47_368_out_ap_vld,
        add47_267_out,
        add47_267_out_ap_vld,
        add47_12666_out,
...
input  [63:0] arg2;
input  [63:0] conv35;
output  [127:0] add47_1_372_out;
output   add47_1_372_out_ap_vld;
output  [127:0] add47_1_271_out;
output   add47_1_271_out_ap_vld;
output  [127:0] add47_1_170_out;
output   add47_1_170_out_ap_vld;
output  [127:0] add47_169_out;
output   add47_169_out_ap_vld;
output  [127:0] add47_368_out;
output   add47_368_out_ap_vld;
output  [127:0] add47_267_out;
output   add47_267_out_ap_vld;
...
reg add47_1_372_out_ap_vld;
reg add47_1_271_out_ap_vld;
reg add47_1_170_out_ap_vld;
reg add47_169_out_ap_vld;
reg add47_368_out_ap_vld;
reg add47_267_out_ap_vld;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_169_out_ap_vld = 1'b1;
    end else begin
        add47_169_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_1_170_out_ap_vld = 1'b1;
    end else begin
        add47_1_170_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_1_271_out_ap_vld = 1'b1;
    end else begin
        add47_1_271_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_1_372_out_ap_vld = 1'b1;
    end else begin
        add47_1_372_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_267_out_ap_vld = 1'b1;
    end else begin
        add47_267_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_368_out_ap_vld = 1'b1;
    end else begin
        add47_368_out_ap_vld = 1'b0;
    end
end
...
assign add47_169_out = add47_169_fu_144;

assign add47_1_170_out = add47_1_170_fu_148;

assign add47_1_271_out = add47_1_271_fu_152;

assign add47_1_372_out = add47_1_372_fu_156;

assign add47_267_out = add47_267_fu_136;

assign add47_368_out = add47_368_fu_140;
...
assign add_ln52_11_fu_1566_p2 = (add47_368_fu_140 + add_ln52_10_fu_1561_p2);
...
assign add_ln52_14_fu_1625_p2 = (add47_169_fu_144 + add_ln52_13_fu_1620_p2);
...
assign add_ln52_17_fu_1684_p2 = (add47_1_170_fu_148 + add_ln52_16_fu_1679_p2);
...
assign add_ln52_20_fu_1743_p2 = (add47_1_271_fu_152 + add_ln52_19_fu_1738_p2);
...
assign add_ln52_23_fu_1802_p2 = (add47_1_372_fu_156 + add_ln52_22_fu_1797_p2);
...
assign add_ln52_8_fu_1452_p2 = (add47_267_fu_136 + add_ln52_7_fu_1447_p2);
