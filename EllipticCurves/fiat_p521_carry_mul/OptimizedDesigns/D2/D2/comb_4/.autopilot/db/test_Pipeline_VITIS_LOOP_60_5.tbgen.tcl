...
set C_modelArgList {
	...
	{ add122_265_out int 128 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "arg1_r_2_reload", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add122_265_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ add122_265_out sc_out sc_lv 128 signal 18 } 
	{ add122_265_out_ap_vld sc_out sc_logic 1 outvld 18 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add122_265_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add122_265_out", "role": "default" }} , 
 	{ "name": "add122_265_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add122_265_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	add122_265_out { ap_vld {  { add122_265_out out_data 1 128 }  { add122_265_out_ap_vld out_vld 1 1 } } }
}
