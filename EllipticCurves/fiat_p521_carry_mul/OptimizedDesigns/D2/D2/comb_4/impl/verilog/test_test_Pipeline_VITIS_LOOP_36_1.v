...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv35,
        add47_1_373_out,
        add47_1_373_out_ap_vld,
        add47_1_272_out,
        add47_1_272_out_ap_vld,
        add47_1_171_out,
        add47_1_171_out_ap_vld,
        add47_170_out,
        add47_170_out_ap_vld,
        add47_369_out,
        add47_369_out_ap_vld,
        add47_268_out,
        add47_268_out_ap_vld,
        add47_12667_out,
        add47_12667_out_ap_vld,
        add4766_out,
        add4766_out_ap_vld
);
...
input  [63:0] arg2;
input  [63:0] conv35;
output  [127:0] add47_1_373_out;
output   add47_1_373_out_ap_vld;
output  [127:0] add47_1_272_out;
output   add47_1_272_out_ap_vld;
output  [127:0] add47_1_171_out;
output   add47_1_171_out_ap_vld;
output  [127:0] add47_170_out;
output   add47_170_out_ap_vld;
output  [127:0] add47_369_out;
output   add47_369_out_ap_vld;
output  [127:0] add47_268_out;
output   add47_268_out_ap_vld;
output  [127:0] add47_12667_out;
output   add47_12667_out_ap_vld;
output  [127:0] add4766_out;
output   add4766_out_ap_vld;

reg ap_idle;
reg m_axi_mem_ARVALID;
reg[63:0] m_axi_mem_ARADDR;
reg m_axi_mem_RREADY;
reg add47_1_373_out_ap_vld;
reg add47_1_272_out_ap_vld;
reg add47_1_171_out_ap_vld;
reg add47_170_out_ap_vld;
reg add47_369_out_ap_vld;
reg add47_268_out_ap_vld;
reg add47_12667_out_ap_vld;
reg add4766_out_ap_vld;
...
wire   [3:0] k_1_29_fu_756_p2;
reg   [3:0] k_1_29_reg_2052;
...
wire   [3:0] k_2_30_fu_858_p2;
reg   [3:0] k_2_30_reg_2094;
...
wire   [3:0] k_3_31_fu_960_p2;
reg   [3:0] k_3_31_reg_2141;
...
wire   [3:0] k_4_32_fu_1112_p2;
reg   [3:0] k_4_32_reg_2203;
...
wire   [3:0] k_5_33_fu_1312_p2;
reg   [3:0] k_5_33_reg_2283;
...
reg   [127:0] arr_8_fu_128;
wire   [127:0] arr_fu_1096_p2;
wire    ap_loop_init;
reg   [127:0] arr_9_fu_132;
wire   [127:0] arr_16_fu_1303_p2;
reg   [127:0] arr_10_fu_136;
wire   [127:0] arr_17_fu_1452_p2;
reg   [127:0] arr_11_fu_140;
wire   [127:0] arr_18_fu_1566_p2;
reg   [127:0] arr_12_fu_144;
wire   [127:0] arr_19_fu_1625_p2;
reg   [127:0] arr_13_fu_148;
wire   [127:0] arr_20_fu_1684_p2;
reg   [127:0] arr_14_fu_152;
wire   [127:0] arr_21_fu_1743_p2;
reg   [127:0] arr_15_fu_156;
wire   [127:0] arr_22_fu_1802_p2;
reg   [4:0] i_fu_160;
...
wire   [6:0] tmp_9_fu_516_p3;
wire   [63:0] p_cast4_fu_524_p1;
...
wire   [3:0] tmp_5_fu_1238_p4;
wire   [3:0] tmp_6_fu_1253_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        tmp_reg_1958 <= ap_sig_allocacmp_i_2[32'd4];
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add4766_out_ap_vld = 1'b1;
    end else begin
        add4766_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_12667_out_ap_vld = 1'b1;
    end else begin
        add47_12667_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_170_out_ap_vld = 1'b1;
    end else begin
        add47_170_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_1_171_out_ap_vld = 1'b1;
    end else begin
        add47_1_171_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_1_272_out_ap_vld = 1'b1;
    end else begin
        add47_1_272_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_1_373_out_ap_vld = 1'b1;
    end else begin
        add47_1_373_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_268_out_ap_vld = 1'b1;
    end else begin
        add47_268_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_369_out_ap_vld = 1'b1;
    end else begin
        add47_369_out_ap_vld = 1'b0;
    end
end
...
assign add4766_out = arr_8_fu_128;

assign add47_12667_out = arr_9_fu_132;

assign add47_170_out = arr_12_fu_144;

assign add47_1_171_out = arr_13_fu_148;

assign add47_1_272_out = arr_14_fu_152;

assign add47_1_373_out = arr_15_fu_156;

assign add47_268_out = arr_10_fu_136;

assign add47_369_out = arr_11_fu_140;

assign add_ln36_fu_544_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(5'd31));
...
assign arr_16_fu_1303_p2 = (arr_9_fu_132 + add_ln52_4_fu_1298_p2);

assign arr_17_fu_1452_p2 = (arr_10_fu_136 + add_ln52_7_fu_1447_p2);

assign arr_18_fu_1566_p2 = (arr_11_fu_140 + add_ln52_10_fu_1561_p2);

assign arr_19_fu_1625_p2 = (arr_12_fu_144 + add_ln52_13_fu_1620_p2);

assign arr_20_fu_1684_p2 = (arr_13_fu_148 + add_ln52_16_fu_1679_p2);

assign arr_21_fu_1743_p2 = (arr_14_fu_152 + add_ln52_19_fu_1738_p2);

assign arr_22_fu_1802_p2 = (arr_15_fu_156 + add_ln52_22_fu_1797_p2);

assign arr_fu_1096_p2 = (arr_8_fu_128 + add_ln52_1_fu_1091_p2);

assign conv35_cast_fu_452_p1 = conv35;

assign empty_fu_528_p2 = (p_cast4_fu_524_p1 + arg1);

assign grp_fu_434_p4 = {{i_2_reg_1940[4:3]}};

assign grp_fu_443_p4 = {{i_2_reg_1940[4:2]}};

assign icmp_ln50_1_fu_695_p2 = (($signed(i_2_reg_1940) > $signed(5'd6)) ? 1'b1 : 1'b0);

assign icmp_ln50_2_fu_798_p2 = (($signed(i_2_reg_1940) > $signed(5'd5)) ? 1'b1 : 1'b0);

assign icmp_ln50_3_fu_900_p2 = (($signed(i_2_reg_1940) > $signed(5'd4)) ? 1'b1 : 1'b0);

assign icmp_ln50_4_fu_1019_p2 = (($signed(grp_fu_443_p4) > $signed(3'd0)) ? 1'b1 : 1'b0);

assign icmp_ln50_5_fu_1182_p2 = (($signed(i_2_reg_1940) > $signed(5'd2)) ? 1'b1 : 1'b0);

assign icmp_ln50_6_fu_1247_p2 = (($signed(tmp_5_fu_1238_p4) > $signed(4'd0)) ? 1'b1 : 1'b0);

assign icmp_ln50_7_fu_1268_p2 = (($signed(i_2_reg_1940) > $signed(5'd0)) ? 1'b1 : 1'b0);

assign icmp_ln50_fu_597_p2 = ((grp_fu_434_p4 == 2'd1) ? 1'b1 : 1'b0);

assign icmp_ln52_1_fu_747_p2 = (($signed(i_2_reg_1940) < $signed(5'd7)) ? 1'b1 : 1'b0);

assign icmp_ln52_2_fu_849_p2 = (($signed(i_2_reg_1940) < $signed(5'd6)) ? 1'b1 : 1'b0);

assign icmp_ln52_3_fu_951_p2 = (($signed(i_2_reg_1940) < $signed(5'd5)) ? 1'b1 : 1'b0);

assign icmp_ln52_4_fu_1102_p2 = (($signed(grp_fu_443_p4) < $signed(3'd1)) ? 1'b1 : 1'b0);

assign icmp_ln52_5_fu_1206_p2 = (($signed(i_2_reg_1940) < $signed(5'd3)) ? 1'b1 : 1'b0);

assign icmp_ln52_6_fu_1262_p2 = (($signed(tmp_6_fu_1253_p4) < $signed(4'd1)) ? 1'b1 : 1'b0);

assign icmp_ln52_7_fu_1273_p2 = (($signed(i_2_reg_1940) < $signed(5'd1)) ? 1'b1 : 1'b0);

assign icmp_ln52_fu_636_p2 = ((grp_fu_434_p4 != 2'd1) ? 1'b1 : 1'b0);

assign k_1_29_fu_756_p2 = (k_s_reg_2010 - zext_ln53_1_fu_752_p1);

assign k_1_fu_704_p2 = (k_fu_688_p3 - zext_ln51_fu_700_p1);

assign k_2_30_fu_858_p2 = (k_1_29_reg_2052 - zext_ln53_2_fu_854_p1);

assign k_2_fu_807_p2 = (k_1_reg_2031 - zext_ln51_1_fu_803_p1);

assign k_3_31_fu_960_p2 = (k_2_30_reg_2094 - zext_ln53_3_fu_956_p1);

assign k_3_fu_909_p2 = (k_2_reg_2073 - zext_ln51_2_fu_905_p1);

assign k_4_32_fu_1112_p2 = (k_3_31_reg_2141 - zext_ln53_4_fu_1108_p1);

assign k_4_fu_1029_p2 = (k_3_reg_2115 - zext_ln51_3_fu_1025_p1);

assign k_5_33_fu_1312_p2 = (k_4_32_reg_2203 - zext_ln53_5_fu_1309_p1);

assign k_5_fu_1191_p2 = (k_4_reg_2177 - zext_ln51_4_fu_1187_p1);

assign k_6_34_fu_1461_p2 = (k_5_33_reg_2283 - zext_ln53_6_fu_1458_p1);
...
assign p_cast4_fu_524_p1 = tmp_9_fu_516_p3;
...
assign shl_ln52_2_fu_771_p3 = {{k_1_29_fu_756_p2}, {3'd0}};

assign shl_ln52_3_fu_873_p3 = {{k_2_30_fu_858_p2}, {3'd0}};

assign shl_ln52_4_fu_975_p3 = {{k_3_31_fu_960_p2}, {3'd0}};

assign shl_ln52_5_fu_1127_p3 = {{k_4_32_fu_1112_p2}, {3'd0}};

assign shl_ln52_6_fu_1327_p3 = {{k_5_33_fu_1312_p2}, {3'd0}};

assign shl_ln52_7_fu_1476_p3 = {{k_6_34_fu_1461_p2}, {3'd0}};

assign shl_ln_fu_570_p3 = {{sub_ln53_fu_555_p2}, {3'd0}};

assign sub_ln53_fu_555_p2 = (4'd7 - trunc_ln36_reg_1962);

assign tmp_5_fu_1238_p4 = {{i_2_reg_1940[4:1]}};

assign tmp_6_fu_1253_p4 = {{i_2_reg_1940[4:1]}};

assign tmp_9_fu_516_p3 = {{trunc_ln36_fu_512_p1}, {3'd0}};

assign tmp_fu_504_p3 = ap_sig_allocacmp_i_2[32'd4];

assign trunc_ln36_fu_512_p1 = ap_sig_allocacmp_i_2[3:0];
