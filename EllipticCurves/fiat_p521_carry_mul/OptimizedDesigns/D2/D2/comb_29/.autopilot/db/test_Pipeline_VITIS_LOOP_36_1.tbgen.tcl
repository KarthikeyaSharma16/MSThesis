...
set C_modelArgList {
	...
	{ add47_198_3250_out int 128 regular {pointer 1}  }
	{ add47_198_2249_out int 128 regular {pointer 1}  }
	{ add47_198_1248_out int 128 regular {pointer 1}  }
	{ add47_198247_out int 128 regular {pointer 1}  }
	{ add47_3246_out int 128 regular {pointer 1}  }
	{ add47_2172245_out int 128 regular {pointer 1}  }
	{ add47_1137244_out int 128 regular {pointer 1}  }
	{ add47243_out int 128 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "add47_198_3250_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_198_2249_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_198_1248_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_198247_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_3246_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_2172245_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_1137244_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47243_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ add47_198_3250_out sc_out sc_lv 128 signal 5 } 
	{ add47_198_3250_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ add47_198_2249_out sc_out sc_lv 128 signal 6 } 
	{ add47_198_2249_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ add47_198_1248_out sc_out sc_lv 128 signal 7 } 
	{ add47_198_1248_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ add47_198247_out sc_out sc_lv 128 signal 8 } 
	{ add47_198247_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ add47_3246_out sc_out sc_lv 128 signal 9 } 
	{ add47_3246_out_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ add47_2172245_out sc_out sc_lv 128 signal 10 } 
	{ add47_2172245_out_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ add47_1137244_out sc_out sc_lv 128 signal 11 } 
	{ add47_1137244_out_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ add47243_out sc_out sc_lv 128 signal 12 } 
	{ add47243_out_ap_vld sc_out sc_logic 1 outvld 12 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add47_198_3250_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_198_3250_out", "role": "default" }} , 
 	{ "name": "add47_198_3250_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_198_3250_out", "role": "ap_vld" }} , 
 	{ "name": "add47_198_2249_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_198_2249_out", "role": "default" }} , 
 	{ "name": "add47_198_2249_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_198_2249_out", "role": "ap_vld" }} , 
 	{ "name": "add47_198_1248_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_198_1248_out", "role": "default" }} , 
 	{ "name": "add47_198_1248_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_198_1248_out", "role": "ap_vld" }} , 
 	{ "name": "add47_198247_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_198247_out", "role": "default" }} , 
 	{ "name": "add47_198247_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_198247_out", "role": "ap_vld" }} , 
 	{ "name": "add47_3246_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_3246_out", "role": "default" }} , 
 	{ "name": "add47_3246_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_3246_out", "role": "ap_vld" }} , 
 	{ "name": "add47_2172245_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_2172245_out", "role": "default" }} , 
 	{ "name": "add47_2172245_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_2172245_out", "role": "ap_vld" }} , 
 	{ "name": "add47_1137244_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_1137244_out", "role": "default" }} , 
 	{ "name": "add47_1137244_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_1137244_out", "role": "ap_vld" }} , 
 	{ "name": "add47243_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47243_out", "role": "default" }} , 
 	{ "name": "add47243_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47243_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "add47_198_3250_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_198_2249_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_198_1248_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_198247_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_3246_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_2172245_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_1137244_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47243_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	test_Pipeline_VITIS_LOOP_36_1 {
		...
		add47_198_3250_out {Type O LastRead -1 FirstWrite 19}
		add47_198_2249_out {Type O LastRead -1 FirstWrite 19}
		add47_198_1248_out {Type O LastRead -1 FirstWrite 19}
		add47_198247_out {Type O LastRead -1 FirstWrite 19}
		add47_3246_out {Type O LastRead -1 FirstWrite 19}
		add47_2172245_out {Type O LastRead -1 FirstWrite 19}
		add47_1137244_out {Type O LastRead -1 FirstWrite 19}
		add47243_out {Type O LastRead -1 FirstWrite 19}}}
...
set Spec2ImplPortList { 
	...
	add47_198_3250_out { ap_vld {  { add47_198_3250_out out_data 1 128 }  { add47_198_3250_out_ap_vld out_vld 1 1 } } }
	add47_198_2249_out { ap_vld {  { add47_198_2249_out out_data 1 128 }  { add47_198_2249_out_ap_vld out_vld 1 1 } } }
	add47_198_1248_out { ap_vld {  { add47_198_1248_out out_data 1 128 }  { add47_198_1248_out_ap_vld out_vld 1 1 } } }
	add47_198247_out { ap_vld {  { add47_198247_out out_data 1 128 }  { add47_198247_out_ap_vld out_vld 1 1 } } }
	add47_3246_out { ap_vld {  { add47_3246_out out_data 1 128 }  { add47_3246_out_ap_vld out_vld 1 1 } } }
	add47_2172245_out { ap_vld {  { add47_2172245_out out_data 1 128 }  { add47_2172245_out_ap_vld out_vld 1 1 } } }
	add47_1137244_out { ap_vld {  { add47_1137244_out out_data 1 128 }  { add47_1137244_out_ap_vld out_vld 1 1 } } }
	add47243_out { ap_vld {  { add47243_out out_data 1 128 }  { add47243_out_ap_vld out_vld 1 1 } } }
}
