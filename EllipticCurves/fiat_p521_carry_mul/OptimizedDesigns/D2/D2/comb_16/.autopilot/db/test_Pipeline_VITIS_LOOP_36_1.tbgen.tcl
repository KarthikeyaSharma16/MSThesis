...
set C_modelArgList {
	...
	{ add47_3_173_out int 128 regular {pointer 1}  }
	{ add47_372_out int 128 regular {pointer 1}  }
	{ add47_2_171_out int 128 regular {pointer 1}  }
	{ add47_270_out int 128 regular {pointer 1}  }
	{ add47_1_169_out int 128 regular {pointer 1}  }
	{ add47_168_out int 128 regular {pointer 1}  }
	{ add47_12667_out int 128 regular {pointer 1}  }
	{ add4766_out int 128 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "add47_3_173_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_372_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_2_171_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_270_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_1_169_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_168_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_12667_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add4766_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ add47_3_173_out sc_out sc_lv 128 signal 4 } 
	{ add47_3_173_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ add47_372_out sc_out sc_lv 128 signal 5 } 
	{ add47_372_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ add47_2_171_out sc_out sc_lv 128 signal 6 } 
	{ add47_2_171_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ add47_270_out sc_out sc_lv 128 signal 7 } 
	{ add47_270_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ add47_1_169_out sc_out sc_lv 128 signal 8 } 
	{ add47_1_169_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ add47_168_out sc_out sc_lv 128 signal 9 } 
	{ add47_168_out_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ add47_12667_out sc_out sc_lv 128 signal 10 } 
	{ add47_12667_out_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ add4766_out sc_out sc_lv 128 signal 11 } 
	{ add4766_out_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add47_3_173_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_3_173_out", "role": "default" }} , 
 	{ "name": "add47_3_173_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_3_173_out", "role": "ap_vld" }} , 
 	{ "name": "add47_372_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_372_out", "role": "default" }} , 
 	{ "name": "add47_372_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_372_out", "role": "ap_vld" }} , 
 	{ "name": "add47_2_171_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_2_171_out", "role": "default" }} , 
 	{ "name": "add47_2_171_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_2_171_out", "role": "ap_vld" }} , 
 	{ "name": "add47_270_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_270_out", "role": "default" }} , 
 	{ "name": "add47_270_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_270_out", "role": "ap_vld" }} , 
 	{ "name": "add47_1_169_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_1_169_out", "role": "default" }} , 
 	{ "name": "add47_1_169_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_1_169_out", "role": "ap_vld" }} , 
 	{ "name": "add47_168_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_168_out", "role": "default" }} , 
 	{ "name": "add47_168_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_168_out", "role": "ap_vld" }} , 
 	{ "name": "add47_12667_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_12667_out", "role": "default" }} , 
 	{ "name": "add47_12667_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_12667_out", "role": "ap_vld" }} , 
 	{ "name": "add4766_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add4766_out", "role": "default" }} , 
 	{ "name": "add4766_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add4766_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "add47_3_173_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_372_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_2_171_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_270_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_1_169_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_168_out", "Type" : "Vld", "Direction" : "O"},
...
set ArgLastReadFirstWriteLatency {
	test_Pipeline_VITIS_LOOP_36_1 {
		...
		add47_3_173_out {Type O LastRead -1 FirstWrite 9}
		add47_372_out {Type O LastRead -1 FirstWrite 9}
		add47_2_171_out {Type O LastRead -1 FirstWrite 9}
		add47_270_out {Type O LastRead -1 FirstWrite 9}
		add47_1_169_out {Type O LastRead -1 FirstWrite 9}
		add47_168_out {Type O LastRead -1 FirstWrite 9}
...
set Spec2ImplPortList { 
	...
	add47_3_173_out { ap_vld {  { add47_3_173_out out_data 1 128 }  { add47_3_173_out_ap_vld out_vld 1 1 } } }
	add47_372_out { ap_vld {  { add47_372_out out_data 1 128 }  { add47_372_out_ap_vld out_vld 1 1 } } }
	add47_2_171_out { ap_vld {  { add47_2_171_out out_data 1 128 }  { add47_2_171_out_ap_vld out_vld 1 1 } } }
	add47_270_out { ap_vld {  { add47_270_out out_data 1 128 }  { add47_270_out_ap_vld out_vld 1 1 } } }
	add47_1_169_out { ap_vld {  { add47_1_169_out out_data 1 128 }  { add47_1_169_out_ap_vld out_vld 1 1 } } }
	add47_168_out { ap_vld {  { add47_168_out out_data 1 128 }  { add47_168_out_ap_vld out_vld 1 1 } } }
	add47_12667_out { ap_vld {  { add47_12667_out out_data 1 128 }  { add47_12667_out_ap_vld out_vld 1 1 } } }
	add4766_out { ap_vld {  { add4766_out out_data 1 128 }  { add4766_out_ap_vld out_vld 1 1 } } }
}
