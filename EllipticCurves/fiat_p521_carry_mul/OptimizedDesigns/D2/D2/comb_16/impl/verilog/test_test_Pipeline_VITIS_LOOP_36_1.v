...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv35,
        add47_3_173_out,
        add47_3_173_out_ap_vld,
        add47_372_out,
        add47_372_out_ap_vld,
        add47_2_171_out,
        add47_2_171_out_ap_vld,
        add47_270_out,
        add47_270_out_ap_vld,
        add47_1_169_out,
        add47_1_169_out_ap_vld,
        add47_168_out,
        add47_168_out_ap_vld,
        add47_12667_out,
...
input  [63:0] arg2;
input  [63:0] conv35;
output  [127:0] add47_3_173_out;
output   add47_3_173_out_ap_vld;
output  [127:0] add47_372_out;
output   add47_372_out_ap_vld;
output  [127:0] add47_2_171_out;
output   add47_2_171_out_ap_vld;
output  [127:0] add47_270_out;
output   add47_270_out_ap_vld;
output  [127:0] add47_1_169_out;
output   add47_1_169_out_ap_vld;
output  [127:0] add47_168_out;
output   add47_168_out_ap_vld;
...
reg add47_3_173_out_ap_vld;
reg add47_372_out_ap_vld;
reg add47_2_171_out_ap_vld;
reg add47_270_out_ap_vld;
reg add47_1_169_out_ap_vld;
reg add47_168_out_ap_vld;
...
wire   [6:0] tmp_5_fu_516_p3;
wire   [63:0] p_cast3_fu_524_p1;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_168_out_ap_vld = 1'b1;
    end else begin
        add47_168_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_1_169_out_ap_vld = 1'b1;
    end else begin
        add47_1_169_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_270_out_ap_vld = 1'b1;
    end else begin
        add47_270_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_2_171_out_ap_vld = 1'b1;
    end else begin
        add47_2_171_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_372_out_ap_vld = 1'b1;
    end else begin
        add47_372_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage9) & (1'b0 == ap_block_pp0_stage9_11001) & (tmp_reg_1958 == 1'd1))) begin
        add47_3_173_out_ap_vld = 1'b1;
    end else begin
        add47_3_173_out_ap_vld = 1'b0;
    end
end
...
assign add47_168_out = arr_10_fu_136;

assign add47_1_169_out = arr_11_fu_140;

assign add47_270_out = arr_12_fu_144;

assign add47_2_171_out = arr_13_fu_148;

assign add47_372_out = arr_14_fu_152;

assign add47_3_173_out = arr_15_fu_156;
...
assign empty_fu_528_p2 = (p_cast3_fu_524_p1 + arg1);
...
assign p_cast3_fu_524_p1 = tmp_5_fu_516_p3;
...
assign tmp_5_fu_516_p3 = {{trunc_ln36_fu_512_p1}, {3'd0}};

assign tmp_6_fu_1238_p4 = {{i_2_reg_1940[4:1]}};

assign tmp_7_fu_1253_p4 = {{i_2_reg_1940[4:1]}};
