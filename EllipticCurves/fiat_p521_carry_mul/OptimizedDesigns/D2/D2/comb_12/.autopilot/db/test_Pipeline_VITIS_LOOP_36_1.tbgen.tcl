...
set C_modelArgList {
	...
	{ add47_7141_out int 128 regular {pointer 1}  }
	{ add47_6140_out int 128 regular {pointer 1}  }
	{ add47_5139_out int 128 regular {pointer 1}  }
	{ add47_4138_out int 128 regular {pointer 1}  }
	{ add47_3137_out int 128 regular {pointer 1}  }
	{ add47_262136_out int 128 regular {pointer 1}  }
	{ add47_126135_out int 128 regular {pointer 1}  }
	{ add47134_out int 128 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "add47_7141_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_6140_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_5139_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_4138_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_3137_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_262136_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_126135_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47134_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ add47_7141_out sc_out sc_lv 128 signal 5 } 
	{ add47_7141_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ add47_6140_out sc_out sc_lv 128 signal 6 } 
	{ add47_6140_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ add47_5139_out sc_out sc_lv 128 signal 7 } 
	{ add47_5139_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ add47_4138_out sc_out sc_lv 128 signal 8 } 
	{ add47_4138_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ add47_3137_out sc_out sc_lv 128 signal 9 } 
	{ add47_3137_out_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ add47_262136_out sc_out sc_lv 128 signal 10 } 
	{ add47_262136_out_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ add47_126135_out sc_out sc_lv 128 signal 11 } 
	{ add47_126135_out_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ add47134_out sc_out sc_lv 128 signal 12 } 
	{ add47134_out_ap_vld sc_out sc_logic 1 outvld 12 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add47_7141_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_7141_out", "role": "default" }} , 
 	{ "name": "add47_7141_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_7141_out", "role": "ap_vld" }} , 
 	{ "name": "add47_6140_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_6140_out", "role": "default" }} , 
 	{ "name": "add47_6140_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_6140_out", "role": "ap_vld" }} , 
 	{ "name": "add47_5139_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_5139_out", "role": "default" }} , 
 	{ "name": "add47_5139_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_5139_out", "role": "ap_vld" }} , 
 	{ "name": "add47_4138_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_4138_out", "role": "default" }} , 
 	{ "name": "add47_4138_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_4138_out", "role": "ap_vld" }} , 
 	{ "name": "add47_3137_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_3137_out", "role": "default" }} , 
 	{ "name": "add47_3137_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_3137_out", "role": "ap_vld" }} , 
 	{ "name": "add47_262136_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_262136_out", "role": "default" }} , 
 	{ "name": "add47_262136_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_262136_out", "role": "ap_vld" }} , 
 	{ "name": "add47_126135_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_126135_out", "role": "default" }} , 
 	{ "name": "add47_126135_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_126135_out", "role": "ap_vld" }} , 
 	{ "name": "add47134_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47134_out", "role": "default" }} , 
 	{ "name": "add47134_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47134_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "add47_7141_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_6140_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_5139_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_4138_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_3137_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_262136_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_126135_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47134_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	test_Pipeline_VITIS_LOOP_36_1 {
		...
		add47_7141_out {Type O LastRead -1 FirstWrite 19}
		add47_6140_out {Type O LastRead -1 FirstWrite 19}
		add47_5139_out {Type O LastRead -1 FirstWrite 19}
		add47_4138_out {Type O LastRead -1 FirstWrite 19}
		add47_3137_out {Type O LastRead -1 FirstWrite 19}
		add47_262136_out {Type O LastRead -1 FirstWrite 19}
		add47_126135_out {Type O LastRead -1 FirstWrite 19}
		add47134_out {Type O LastRead -1 FirstWrite 19}}}
...
set Spec2ImplPortList { 
	...
	add47_7141_out { ap_vld {  { add47_7141_out out_data 1 128 }  { add47_7141_out_ap_vld out_vld 1 1 } } }
	add47_6140_out { ap_vld {  { add47_6140_out out_data 1 128 }  { add47_6140_out_ap_vld out_vld 1 1 } } }
	add47_5139_out { ap_vld {  { add47_5139_out out_data 1 128 }  { add47_5139_out_ap_vld out_vld 1 1 } } }
	add47_4138_out { ap_vld {  { add47_4138_out out_data 1 128 }  { add47_4138_out_ap_vld out_vld 1 1 } } }
	add47_3137_out { ap_vld {  { add47_3137_out out_data 1 128 }  { add47_3137_out_ap_vld out_vld 1 1 } } }
	add47_262136_out { ap_vld {  { add47_262136_out out_data 1 128 }  { add47_262136_out_ap_vld out_vld 1 1 } } }
	add47_126135_out { ap_vld {  { add47_126135_out out_data 1 128 }  { add47_126135_out_ap_vld out_vld 1 1 } } }
	add47134_out { ap_vld {  { add47134_out out_data 1 128 }  { add47134_out_ap_vld out_vld 1 1 } } }
}
