...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv35,
        add47_7141_out,
        add47_7141_out_ap_vld,
        add47_6140_out,
        add47_6140_out_ap_vld,
        add47_5139_out,
        add47_5139_out_ap_vld,
        add47_4138_out,
        add47_4138_out_ap_vld,
        add47_3137_out,
        add47_3137_out_ap_vld,
        add47_262136_out,
        add47_262136_out_ap_vld,
        add47_126135_out,
        add47_126135_out_ap_vld,
        add47134_out,
        add47134_out_ap_vld
);
...
input  [63:0] arg1;
input  [63:0] conv35;
output  [127:0] add47_7141_out;
output   add47_7141_out_ap_vld;
output  [127:0] add47_6140_out;
output   add47_6140_out_ap_vld;
output  [127:0] add47_5139_out;
output   add47_5139_out_ap_vld;
output  [127:0] add47_4138_out;
output   add47_4138_out_ap_vld;
output  [127:0] add47_3137_out;
output   add47_3137_out_ap_vld;
output  [127:0] add47_262136_out;
output   add47_262136_out_ap_vld;
output  [127:0] add47_126135_out;
output   add47_126135_out_ap_vld;
output  [127:0] add47134_out;
output   add47134_out_ap_vld;
...
reg add47_7141_out_ap_vld;
reg add47_6140_out_ap_vld;
reg add47_5139_out_ap_vld;
reg add47_4138_out_ap_vld;
reg add47_3137_out_ap_vld;
reg add47_262136_out_ap_vld;
reg add47_126135_out_ap_vld;
reg add47134_out_ap_vld;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47134_out_ap_vld = 1'b1;
    end else begin
        add47134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_126135_out_ap_vld = 1'b1;
    end else begin
        add47_126135_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_262136_out_ap_vld = 1'b1;
    end else begin
        add47_262136_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_3137_out_ap_vld = 1'b1;
    end else begin
        add47_3137_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_4138_out_ap_vld = 1'b1;
    end else begin
        add47_4138_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_5139_out_ap_vld = 1'b1;
    end else begin
        add47_5139_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_6140_out_ap_vld = 1'b1;
    end else begin
        add47_6140_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_7141_out_ap_vld = 1'b1;
    end else begin
        add47_7141_out_ap_vld = 1'b0;
    end
end
...
assign add47134_out = arr_8_fu_158;

assign add47_126135_out = arr_9_fu_162;

assign add47_262136_out = arr_10_fu_166;

assign add47_3137_out = arr_11_fu_170;

assign add47_4138_out = arr_12_fu_174;

assign add47_5139_out = arr_13_fu_178;

assign add47_6140_out = arr_14_fu_182;

assign add47_7141_out = arr_15_fu_186;
