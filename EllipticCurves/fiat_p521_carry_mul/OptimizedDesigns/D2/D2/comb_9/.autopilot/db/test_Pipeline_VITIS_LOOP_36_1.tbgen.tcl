...
set C_modelArgList {
	...
	{ add47_3_172_out int 128 regular {pointer 1}  }
	{ add47_371_out int 128 regular {pointer 1}  }
	{ add47_2_170_out int 128 regular {pointer 1}  }
	{ add47_269_out int 128 regular {pointer 1}  }
	{ add47_1_168_out int 128 regular {pointer 1}  }
	{ add47_167_out int 128 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "add47_3_172_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_371_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_2_170_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_269_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_1_168_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add47_167_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ add47_3_172_out sc_out sc_lv 128 signal 4 } 
	{ add47_3_172_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ add47_371_out sc_out sc_lv 128 signal 5 } 
	{ add47_371_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ add47_2_170_out sc_out sc_lv 128 signal 6 } 
	{ add47_2_170_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ add47_269_out sc_out sc_lv 128 signal 7 } 
	{ add47_269_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ add47_1_168_out sc_out sc_lv 128 signal 8 } 
	{ add47_1_168_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ add47_167_out sc_out sc_lv 128 signal 9 } 
	{ add47_167_out_ap_vld sc_out sc_logic 1 outvld 9 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add47_3_172_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_3_172_out", "role": "default" }} , 
 	{ "name": "add47_3_172_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_3_172_out", "role": "ap_vld" }} , 
 	{ "name": "add47_371_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_371_out", "role": "default" }} , 
 	{ "name": "add47_371_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_371_out", "role": "ap_vld" }} , 
 	{ "name": "add47_2_170_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_2_170_out", "role": "default" }} , 
 	{ "name": "add47_2_170_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_2_170_out", "role": "ap_vld" }} , 
 	{ "name": "add47_269_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_269_out", "role": "default" }} , 
 	{ "name": "add47_269_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_269_out", "role": "ap_vld" }} , 
 	{ "name": "add47_1_168_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_1_168_out", "role": "default" }} , 
 	{ "name": "add47_1_168_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_1_168_out", "role": "ap_vld" }} , 
 	{ "name": "add47_167_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "add47_167_out", "role": "default" }} , 
 	{ "name": "add47_167_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add47_167_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "add47_3_172_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_371_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_2_170_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_269_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_1_168_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "add47_167_out", "Type" : "Vld", "Direction" : "O"},
...
set ArgLastReadFirstWriteLatency {
	test_Pipeline_VITIS_LOOP_36_1 {
		...
		add47_3_172_out {Type O LastRead -1 FirstWrite 9}
		add47_371_out {Type O LastRead -1 FirstWrite 9}
		add47_2_170_out {Type O LastRead -1 FirstWrite 9}
		add47_269_out {Type O LastRead -1 FirstWrite 9}
		add47_1_168_out {Type O LastRead -1 FirstWrite 9}
		add47_167_out {Type O LastRead -1 FirstWrite 9}
...
set Spec2ImplPortList { 
	...
	add47_3_172_out { ap_vld {  { add47_3_172_out out_data 1 128 }  { add47_3_172_out_ap_vld out_vld 1 1 } } }
	add47_371_out { ap_vld {  { add47_371_out out_data 1 128 }  { add47_371_out_ap_vld out_vld 1 1 } } }
	add47_2_170_out { ap_vld {  { add47_2_170_out out_data 1 128 }  { add47_2_170_out_ap_vld out_vld 1 1 } } }
	add47_269_out { ap_vld {  { add47_269_out out_data 1 128 }  { add47_269_out_ap_vld out_vld 1 1 } } }
	add47_1_168_out { ap_vld {  { add47_1_168_out out_data 1 128 }  { add47_1_168_out_ap_vld out_vld 1 1 } } }
	add47_167_out { ap_vld {  { add47_167_out out_data 1 128 }  { add47_167_out_ap_vld out_vld 1 1 } } }
