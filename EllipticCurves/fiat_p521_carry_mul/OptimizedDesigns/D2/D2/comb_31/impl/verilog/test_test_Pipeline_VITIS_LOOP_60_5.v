...
output  [127:0] add122_2590_out;
output   add122_2590_out_ap_vld;

reg ap_idle;
reg add122_2590_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln60_fu_228_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add122_2590_out_ap_vld = 1'b1;
    end else begin
        add122_2590_out_ap_vld = 1'b0;
    end
end
