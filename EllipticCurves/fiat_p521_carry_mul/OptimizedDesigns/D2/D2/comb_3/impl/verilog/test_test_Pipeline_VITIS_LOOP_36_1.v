...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv35,
        add47_3_1251_out,
        add47_3_1251_out_ap_vld,
        add47_3250_out,
        add47_3250_out_ap_vld,
        add47_2134_1249_out,
        add47_2134_1249_out_ap_vld,
        add47_2134248_out,
        add47_2134248_out_ap_vld,
        add47_198_1247_out,
        add47_198_1247_out_ap_vld,
        add47_198246_out,
        add47_198246_out_ap_vld,
        add47_1172245_out,
        add47_1172245_out_ap_vld,
        add47244_out,
        add47244_out_ap_vld
);
...
input  [63:0] arg1;
input  [63:0] conv35;
output  [127:0] add47_3_1251_out;
output   add47_3_1251_out_ap_vld;
output  [127:0] add47_3250_out;
output   add47_3250_out_ap_vld;
output  [127:0] add47_2134_1249_out;
output   add47_2134_1249_out_ap_vld;
output  [127:0] add47_2134248_out;
output   add47_2134248_out_ap_vld;
output  [127:0] add47_198_1247_out;
output   add47_198_1247_out_ap_vld;
output  [127:0] add47_198246_out;
output   add47_198246_out_ap_vld;
output  [127:0] add47_1172245_out;
output   add47_1172245_out_ap_vld;
...
reg add47_3_1251_out_ap_vld;
reg add47_3250_out_ap_vld;
reg add47_2134_1249_out_ap_vld;
reg add47_2134248_out_ap_vld;
reg add47_198_1247_out_ap_vld;
reg add47_198246_out_ap_vld;
reg add47_1172245_out_ap_vld;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_1172245_out_ap_vld = 1'b1;
    end else begin
        add47_1172245_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_198246_out_ap_vld = 1'b1;
    end else begin
        add47_198246_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_198_1247_out_ap_vld = 1'b1;
    end else begin
        add47_198_1247_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_2134248_out_ap_vld = 1'b1;
    end else begin
        add47_2134248_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_2134_1249_out_ap_vld = 1'b1;
    end else begin
        add47_2134_1249_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_3250_out_ap_vld = 1'b1;
    end else begin
        add47_3250_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage19) & (1'b0 == ap_block_pp0_stage19_11001) & (icmp_ln36_reg_3814 == 1'd1))) begin
        add47_3_1251_out_ap_vld = 1'b1;
    end else begin
        add47_3_1251_out_ap_vld = 1'b0;
    end
end
...
assign add47_1172245_out = arr_9_fu_162;

assign add47_198246_out = arr_10_fu_166;

assign add47_198_1247_out = arr_11_fu_170;

assign add47_2134248_out = arr_12_fu_174;

assign add47_2134_1249_out = arr_13_fu_178;

assign add47_3250_out = arr_14_fu_182;

assign add47_3_1251_out = arr_15_fu_186;
