...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv112,
        add59_7233_out,
        add59_7233_out_ap_vld,
        add59_6232_out,
        add59_6232_out_ap_vld,
        add59_5231_out,
        add59_5231_out_ap_vld,
        add59_4230_out,
        add59_4230_out_ap_vld,
        add59_3229_out,
        add59_3229_out_ap_vld,
        add59_288228_out,
        add59_288228_out_ap_vld,
        add59_123227_out,
        add59_123227_out_ap_vld,
        add59226_out,
        add59226_out_ap_vld,
        add32_2225_out,
        add32_2225_out_ap_vld
);
...
input  [63:0] conv112;
output  [127:0] add59_7233_out;
output   add59_7233_out_ap_vld;
output  [127:0] add59_6232_out;
output   add59_6232_out_ap_vld;
output  [127:0] add59_5231_out;
output   add59_5231_out_ap_vld;
output  [127:0] add59_4230_out;
output   add59_4230_out_ap_vld;
output  [127:0] add59_3229_out;
output   add59_3229_out_ap_vld;
output  [127:0] add59_288228_out;
output   add59_288228_out_ap_vld;
output  [127:0] add59_123227_out;
output   add59_123227_out_ap_vld;
output  [127:0] add59226_out;
output   add59226_out_ap_vld;
output  [127:0] add32_2225_out;
output   add32_2225_out_ap_vld;

reg ap_idle;
reg add59_7233_out_ap_vld;
reg add59_6232_out_ap_vld;
reg add59_5231_out_ap_vld;
reg add59_4230_out_ap_vld;
reg add59_3229_out_ap_vld;
reg add59_288228_out_ap_vld;
reg add59_123227_out_ap_vld;
reg add59226_out_ap_vld;
reg add32_2225_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add32_2225_out_ap_vld = 1'b1;
    end else begin
        add32_2225_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59226_out_ap_vld = 1'b1;
    end else begin
        add59226_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_123227_out_ap_vld = 1'b1;
    end else begin
        add59_123227_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_288228_out_ap_vld = 1'b1;
    end else begin
        add59_288228_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_3229_out_ap_vld = 1'b1;
    end else begin
        add59_3229_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_4230_out_ap_vld = 1'b1;
    end else begin
        add59_4230_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_5231_out_ap_vld = 1'b1;
    end else begin
        add59_5231_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_6232_out_ap_vld = 1'b1;
    end else begin
        add59_6232_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_7233_out_ap_vld = 1'b1;
    end else begin
        add59_7233_out_ap_vld = 1'b0;
    end
end
...
assign add32_2225_out = add32_2225_fu_180;

assign add59226_out = add59226_fu_184;

assign add59_123227_out = add59_123227_fu_188;

assign add59_288228_out = add59_288228_fu_192;

assign add59_3229_out = add59_3229_fu_196;

assign add59_4230_out = add59_4230_fu_200;

assign add59_5231_out = add59_5231_fu_204;

assign add59_6232_out = add59_6232_fu_208;

assign add59_7233_out = add59_7233_fu_212;
...
assign add_ln44_2_fu_3326_p2 = (add32_2225_fu_180 + add_ln44_1_fu_3321_p2);
...
assign add_ln54_10_fu_4329_p2 = (add59_123227_fu_188 + add_ln54_9_fu_4325_p2);
...
assign add_ln54_18_fu_4349_p2 = (add59_3229_fu_196 + add_ln54_17_fu_4345_p2);
...
assign add_ln54_28_fu_4359_p2 = (add59_4230_fu_200 + add_ln54_27_fu_4355_p2);
...
assign add_ln54_4_fu_4319_p2 = (add59226_fu_184 + add_ln54_3_fu_4315_p2);
...
assign add_ln56_18_fu_4392_p2 = (add59_5231_fu_204 + add_ln56_17_fu_4387_p2);
...
assign add_ln56_29_fu_4479_p2 = (add59_6232_fu_208 + add_ln56_28_fu_4473_p2);
...
assign add_ln56_36_fu_4525_p2 = (add59_7233_fu_212 + add_ln56_35_fu_4520_p2);
...
assign add_ln56_6_fu_4339_p2 = (add59_288228_fu_192 + add_ln56_5_fu_4335_p2);
