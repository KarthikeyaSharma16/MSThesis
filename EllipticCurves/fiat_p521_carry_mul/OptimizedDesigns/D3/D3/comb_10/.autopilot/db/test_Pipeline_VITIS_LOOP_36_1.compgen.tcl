...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_7235_out \
    op interface \
    ports { add59_7235_out { O 128 vector } add59_7235_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_6234_out \
    op interface \
    ports { add59_6234_out { O 128 vector } add59_6234_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_5233_out \
    op interface \
    ports { add59_5233_out { O 128 vector } add59_5233_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_4232_out \
    op interface \
    ports { add59_4232_out { O 128 vector } add59_4232_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_3231_out \
    op interface \
    ports { add59_3231_out { O 128 vector } add59_3231_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 200 \
    name add59_290230_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add59_290230_out \
    op interface \
    ports { add59_290230_out { O 128 vector } add59_290230_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 201 \
    name add59_124229_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add59_124229_out \
    op interface \
    ports { add59_124229_out { O 128 vector } add59_124229_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59228_out \
    op interface \
    ports { add59228_out { O 128 vector } add59228_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add32_2227_out \
    op interface \
    ports { add32_2227_out { O 128 vector } add32_2227_out_ap_vld { O 1 bit } } \
} "
}
