...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_cast,
        add59_1_3113_out,
        add59_1_3113_out_ap_vld,
        add59_1_2112_out,
        add59_1_2112_out_ap_vld,
        add59_1_1111_out,
        add59_1_1111_out_ap_vld,
        add59_1110_out,
        add59_1110_out_ap_vld,
        add59_3109_out,
        add59_3109_out_ap_vld,
        add59_2108_out,
        add59_2108_out_ap_vld,
        add59_124107_out,
...
output  [127:0] add59_1_3113_out;
output   add59_1_3113_out_ap_vld;
output  [127:0] add59_1_2112_out;
output   add59_1_2112_out_ap_vld;
output  [127:0] add59_1_1111_out;
output   add59_1_1111_out_ap_vld;
output  [127:0] add59_1110_out;
output   add59_1110_out_ap_vld;
output  [127:0] add59_3109_out;
output   add59_3109_out_ap_vld;
output  [127:0] add59_2108_out;
output   add59_2108_out_ap_vld;
...
reg ap_idle;
reg add59_1_3113_out_ap_vld;
reg add59_1_2112_out_ap_vld;
reg add59_1_1111_out_ap_vld;
reg add59_1110_out_ap_vld;
reg add59_3109_out_ap_vld;
reg add59_2108_out_ap_vld;
...
reg   [127:0] add59_2108_fu_172;
wire   [127:0] add_ln56_10_fu_2084_p2;
reg   [127:0] add59_3109_fu_176;
wire   [127:0] add_ln56_14_fu_2158_p2;
reg   [127:0] add59_1110_fu_180;
wire   [127:0] add_ln56_18_fu_2232_p2;
reg   [127:0] add59_1_1111_fu_184;
wire   [127:0] add_ln56_22_fu_2306_p2;
reg   [127:0] add59_1_2112_fu_188;
wire   [127:0] add_ln56_26_fu_2380_p2;
reg   [127:0] add59_1_3113_fu_192;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_31_reg_2930_pp0_iter1_reg == 1'd1))) begin
        add59_1110_out_ap_vld = 1'b1;
    end else begin
        add59_1110_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_31_reg_2930_pp0_iter1_reg == 1'd1))) begin
        add59_1_1111_out_ap_vld = 1'b1;
    end else begin
        add59_1_1111_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_31_reg_2930_pp0_iter1_reg == 1'd1))) begin
        add59_1_2112_out_ap_vld = 1'b1;
    end else begin
        add59_1_2112_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_31_reg_2930_pp0_iter1_reg == 1'd1))) begin
        add59_1_3113_out_ap_vld = 1'b1;
    end else begin
        add59_1_3113_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_31_reg_2930_pp0_iter1_reg == 1'd1))) begin
        add59_2108_out_ap_vld = 1'b1;
    end else begin
        add59_2108_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_31_reg_2930_pp0_iter1_reg == 1'd1))) begin
        add59_3109_out_ap_vld = 1'b1;
    end else begin
        add59_3109_out_ap_vld = 1'b0;
    end
end
...
assign add59_1110_out = add59_1110_fu_180;

assign add59_124107_out = add59_124107_fu_168;

assign add59_1_1111_out = add59_1_1111_fu_184;

assign add59_1_2112_out = add59_1_2112_fu_188;

assign add59_1_3113_out = add59_1_3113_fu_192;

assign add59_2108_out = add59_2108_fu_172;

assign add59_3109_out = add59_3109_fu_176;

assign add_ln44_fu_906_p2 = (mul_ln44_reg_2945 + add32105_fu_160);

assign add_ln56_10_fu_2084_p2 = (add59_2108_fu_172 + add_ln56_9_fu_2078_p2);
...
assign add_ln56_14_fu_2158_p2 = (add59_3109_fu_176 + add_ln56_13_fu_2152_p2);
...
assign add_ln56_18_fu_2232_p2 = (add59_1110_fu_180 + add_ln56_17_fu_2226_p2);
...
assign add_ln56_22_fu_2306_p2 = (add59_1_1111_fu_184 + add_ln56_21_fu_2300_p2);
...
assign add_ln56_26_fu_2380_p2 = (add59_1_2112_fu_188 + add_ln56_25_fu_2374_p2);
...
assign add_ln56_29_fu_2390_p2 = (add59_1_3113_fu_192 + add_ln56_28_fu_2386_p2);
