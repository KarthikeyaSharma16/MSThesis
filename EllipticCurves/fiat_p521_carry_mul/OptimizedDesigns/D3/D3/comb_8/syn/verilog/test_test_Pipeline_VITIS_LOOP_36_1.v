...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv112,
        add59_3_1435_out,
        add59_3_1435_out_ap_vld,
        add59_3434_out,
        add59_3434_out_ap_vld,
        add59_2222_1433_out,
        add59_2222_1433_out_ap_vld,
        add59_2222432_out,
        add59_2222432_out_ap_vld,
        add59_1156_1431_out,
        add59_1156_1431_out_ap_vld,
        add59_1156430_out,
        add59_1156430_out_ap_vld,
        add59_1290429_out,
        add59_1290429_out_ap_vld,
        add59428_out,
        add59428_out_ap_vld,
        add32_2427_out,
...
input  [63:0] conv112;
output  [127:0] add59_3_1435_out;
output   add59_3_1435_out_ap_vld;
output  [127:0] add59_3434_out;
output   add59_3434_out_ap_vld;
output  [127:0] add59_2222_1433_out;
output   add59_2222_1433_out_ap_vld;
output  [127:0] add59_2222432_out;
output   add59_2222432_out_ap_vld;
output  [127:0] add59_1156_1431_out;
output   add59_1156_1431_out_ap_vld;
output  [127:0] add59_1156430_out;
output   add59_1156430_out_ap_vld;
output  [127:0] add59_1290429_out;
output   add59_1290429_out_ap_vld;
...
reg ap_idle;
reg add59_3_1435_out_ap_vld;
reg add59_3434_out_ap_vld;
reg add59_2222_1433_out_ap_vld;
reg add59_2222432_out_ap_vld;
reg add59_1156_1431_out_ap_vld;
reg add59_1156430_out_ap_vld;
reg add59_1290429_out_ap_vld;
...
reg   [127:0] add59_1290429_fu_188;
wire   [127:0] add_ln54_10_fu_4329_p2;
reg   [127:0] add59_1156430_fu_192;
wire   [127:0] add_ln56_6_fu_4339_p2;
reg   [127:0] add59_1156_1431_fu_196;
wire   [127:0] add_ln54_18_fu_4349_p2;
reg   [127:0] add59_2222432_fu_200;
wire   [127:0] add_ln54_28_fu_4359_p2;
reg   [127:0] add59_2222_1433_fu_204;
wire   [127:0] add_ln56_18_fu_4392_p2;
reg   [127:0] add59_3434_fu_208;
wire   [127:0] add_ln56_29_fu_4479_p2;
reg   [127:0] add59_3_1435_fu_212;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_1156430_out_ap_vld = 1'b1;
    end else begin
        add59_1156430_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_1156_1431_out_ap_vld = 1'b1;
    end else begin
        add59_1156_1431_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_1290429_out_ap_vld = 1'b1;
    end else begin
        add59_1290429_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_2222432_out_ap_vld = 1'b1;
    end else begin
        add59_2222432_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_2222_1433_out_ap_vld = 1'b1;
    end else begin
        add59_2222_1433_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_3434_out_ap_vld = 1'b1;
    end else begin
        add59_3434_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_69_reg_5353_pp0_iter1_reg == 1'd1))) begin
        add59_3_1435_out_ap_vld = 1'b1;
    end else begin
        add59_3_1435_out_ap_vld = 1'b0;
    end
end
...
assign add59_1156430_out = add59_1156430_fu_192;

assign add59_1156_1431_out = add59_1156_1431_fu_196;

assign add59_1290429_out = add59_1290429_fu_188;

assign add59_2222432_out = add59_2222432_fu_200;

assign add59_2222_1433_out = add59_2222_1433_fu_204;

assign add59_3434_out = add59_3434_fu_208;

assign add59_3_1435_out = add59_3_1435_fu_212;
...
assign add_ln54_10_fu_4329_p2 = (add59_1290429_fu_188 + add_ln54_9_fu_4325_p2);
...
assign add_ln54_18_fu_4349_p2 = (add59_1156_1431_fu_196 + add_ln54_17_fu_4345_p2);
...
assign add_ln54_28_fu_4359_p2 = (add59_2222432_fu_200 + add_ln54_27_fu_4355_p2);
...
assign add_ln56_18_fu_4392_p2 = (add59_2222_1433_fu_204 + add_ln56_17_fu_4387_p2);
...
assign add_ln56_29_fu_4479_p2 = (add59_3434_fu_208 + add_ln56_28_fu_4473_p2);
...
assign add_ln56_36_fu_4525_p2 = (add59_3_1435_fu_212 + add_ln56_35_fu_4520_p2);
...
assign add_ln56_6_fu_4339_p2 = (add59_1156430_fu_192 + add_ln56_5_fu_4335_p2);
