...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add59_747_out { O 128 vector } add59_747_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add59_646_out { O 128 vector } add59_646_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add59_545_out { O 128 vector } add59_545_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add59_444_out { O 128 vector } add59_444_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add59_343_out { O 128 vector } add59_343_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add59_242_out { O 128 vector } add59_242_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add59_141_out { O 128 vector } add59_141_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add5940_out \
    op interface \
    ports { add5940_out { O 128 vector } add5940_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add3239_out \
    op interface \
    ports { add3239_out { O 128 vector } add3239_out_ap_vld { O 1 bit } } \
} "
}
