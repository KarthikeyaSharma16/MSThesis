...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add59_7137_out { O 128 vector } add59_7137_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add59_6136_out { O 128 vector } add59_6136_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add59_5135_out { O 128 vector } add59_5135_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add59_4134_out { O 128 vector } add59_4134_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add59_3133_out { O 128 vector } add59_3133_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 152 \
    name add59_258132_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add59_258132_out \
    op interface \
    ports { add59_258132_out { O 128 vector } add59_258132_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 153 \
    name add59_123131_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add59_123131_out \
    op interface \
    ports { add59_123131_out { O 128 vector } add59_123131_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59130_out \
    op interface \
    ports { add59130_out { O 128 vector } add59130_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add32_2129_out \
    op interface \
    ports { add32_2129_out { O 128 vector } add32_2129_out_ap_vld { O 1 bit } } \
} "
}
