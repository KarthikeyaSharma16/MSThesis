...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_735_out \
    op interface \
    ports { add59_735_out { O 128 vector } add59_735_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_634_out \
    op interface \
    ports { add59_634_out { O 128 vector } add59_634_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_533_out \
    op interface \
    ports { add59_533_out { O 128 vector } add59_533_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_432_out \
    op interface \
    ports { add59_432_out { O 128 vector } add59_432_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_331_out \
    op interface \
    ports { add59_331_out { O 128 vector } add59_331_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_230_out \
    op interface \
    ports { add59_230_out { O 128 vector } add59_230_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_129_out \
    op interface \
    ports { add59_129_out { O 128 vector } add59_129_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add5928_out \
    op interface \
    ports { add5928_out { O 128 vector } add5928_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add3227_out \
    op interface \
    ports { add3227_out { O 128 vector } add3227_out_ap_vld { O 1 bit } } \
} "
}
