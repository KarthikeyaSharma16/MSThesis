...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv47,
        add59_7139_out,
        add59_7139_out_ap_vld,
        add59_6138_out,
        add59_6138_out_ap_vld,
        add59_5137_out,
        add59_5137_out_ap_vld,
        add59_4136_out,
        add59_4136_out_ap_vld,
        add59_3135_out,
        add59_3135_out_ap_vld,
        add59_260134_out,
        add59_260134_out_ap_vld,
        add59_124133_out,
        add59_124133_out_ap_vld,
        add59132_out,
        add59132_out_ap_vld,
        add32_2131_out,
        add32_2131_out_ap_vld
);
...
input  [63:0] conv47;
output  [127:0] add59_7139_out;
output   add59_7139_out_ap_vld;
output  [127:0] add59_6138_out;
output   add59_6138_out_ap_vld;
output  [127:0] add59_5137_out;
output   add59_5137_out_ap_vld;
output  [127:0] add59_4136_out;
output   add59_4136_out_ap_vld;
output  [127:0] add59_3135_out;
output   add59_3135_out_ap_vld;
output  [127:0] add59_260134_out;
output   add59_260134_out_ap_vld;
output  [127:0] add59_124133_out;
output   add59_124133_out_ap_vld;
output  [127:0] add59132_out;
output   add59132_out_ap_vld;
output  [127:0] add32_2131_out;
output   add32_2131_out_ap_vld;

reg ap_idle;
reg add59_7139_out_ap_vld;
reg add59_6138_out_ap_vld;
reg add59_5137_out_ap_vld;
reg add59_4136_out_ap_vld;
reg add59_3135_out_ap_vld;
reg add59_260134_out_ap_vld;
reg add59_124133_out_ap_vld;
reg add59132_out_ap_vld;
reg add32_2131_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add32_2131_out_ap_vld = 1'b1;
    end else begin
        add32_2131_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59132_out_ap_vld = 1'b1;
    end else begin
        add59132_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_124133_out_ap_vld = 1'b1;
    end else begin
        add59_124133_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_260134_out_ap_vld = 1'b1;
    end else begin
        add59_260134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_3135_out_ap_vld = 1'b1;
    end else begin
        add59_3135_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_4136_out_ap_vld = 1'b1;
    end else begin
        add59_4136_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_5137_out_ap_vld = 1'b1;
    end else begin
        add59_5137_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_6138_out_ap_vld = 1'b1;
    end else begin
        add59_6138_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_7139_out_ap_vld = 1'b1;
    end else begin
        add59_7139_out_ap_vld = 1'b0;
    end
end
...
assign add32_2131_out = add32_2131_fu_176;

assign add59132_out = add59132_fu_180;

assign add59_124133_out = add59_124133_fu_184;

assign add59_260134_out = add59_260134_fu_188;

assign add59_3135_out = add59_3135_fu_192;

assign add59_4136_out = add59_4136_fu_196;

assign add59_5137_out = add59_5137_fu_200;

assign add59_6138_out = add59_6138_fu_204;

assign add59_7139_out = add59_7139_fu_208;
...
assign add_ln44_3_fu_3260_p2 = (add32_2131_fu_176 + add_ln44_2_fu_3255_p2);
...
assign add_ln54_14_fu_3290_p2 = (add59_260134_fu_188 + add_ln54_13_fu_3286_p2);
...
assign add_ln54_20_fu_3300_p2 = (add59_3135_fu_192 + add_ln54_19_fu_3296_p2);
...
assign add_ln54_26_fu_3310_p2 = (add59_4136_fu_196 + add_ln54_25_fu_3306_p2);
...
assign add_ln54_32_fu_3320_p2 = (add59_5137_fu_200 + add_ln54_31_fu_3316_p2);
...
assign add_ln54_38_fu_3330_p2 = (add59_6138_fu_204 + add_ln54_37_fu_3326_p2);

assign add_ln54_39_fu_3202_p2 = (mul_ln54_40_fu_609_p2 + mul_ln54_41_fu_613_p2);

assign add_ln54_3_fu_3270_p2 = (add59132_fu_180 + add_ln54_2_fu_3266_p2);
...
assign add_ln54_43_fu_3340_p2 = (add59_7139_fu_208 + add_ln54_42_fu_3336_p2);
...
assign add_ln54_8_fu_3280_p2 = (add59_124133_fu_184 + add_ln54_7_fu_3276_p2);
