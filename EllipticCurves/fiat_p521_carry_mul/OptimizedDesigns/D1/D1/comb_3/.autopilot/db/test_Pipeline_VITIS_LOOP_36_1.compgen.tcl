...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_7139_out \
    op interface \
    ports { add59_7139_out { O 128 vector } add59_7139_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_6138_out \
    op interface \
    ports { add59_6138_out { O 128 vector } add59_6138_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_5137_out \
    op interface \
    ports { add59_5137_out { O 128 vector } add59_5137_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_4136_out \
    op interface \
    ports { add59_4136_out { O 128 vector } add59_4136_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_3135_out \
    op interface \
    ports { add59_3135_out { O 128 vector } add59_3135_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 152 \
    name add59_260134_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add59_260134_out \
    op interface \
    ports { add59_260134_out { O 128 vector } add59_260134_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 153 \
    name add59_124133_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add59_124133_out \
    op interface \
    ports { add59_124133_out { O 128 vector } add59_124133_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59132_out \
    op interface \
    ports { add59132_out { O 128 vector } add59132_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add32_2131_out \
    op interface \
    ports { add32_2131_out { O 128 vector } add32_2131_out_ap_vld { O 1 bit } } \
} "
}
