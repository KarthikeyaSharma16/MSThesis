...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        conv47,
        add59_3_1249_out,
        add59_3_1249_out_ap_vld,
        add59_3248_out,
        add59_3248_out_ap_vld,
        add59_2132_1247_out,
        add59_2132_1247_out_ap_vld,
        add59_2132246_out,
        add59_2132246_out_ap_vld,
        add59_196_1245_out,
        add59_196_1245_out_ap_vld,
        add59_196244_out,
        add59_196244_out_ap_vld,
        add59_1170243_out,
        add59_1170243_out_ap_vld,
        add59242_out,
        add59242_out_ap_vld,
        add32_2241_out,
...
input  [63:0] conv47;
output  [127:0] add59_3_1249_out;
output   add59_3_1249_out_ap_vld;
output  [127:0] add59_3248_out;
output   add59_3248_out_ap_vld;
output  [127:0] add59_2132_1247_out;
output   add59_2132_1247_out_ap_vld;
output  [127:0] add59_2132246_out;
output   add59_2132246_out_ap_vld;
output  [127:0] add59_196_1245_out;
output   add59_196_1245_out_ap_vld;
output  [127:0] add59_196244_out;
output   add59_196244_out_ap_vld;
output  [127:0] add59_1170243_out;
output   add59_1170243_out_ap_vld;
...
reg ap_idle;
reg add59_3_1249_out_ap_vld;
reg add59_3248_out_ap_vld;
reg add59_2132_1247_out_ap_vld;
reg add59_2132246_out_ap_vld;
reg add59_196_1245_out_ap_vld;
reg add59_196244_out_ap_vld;
reg add59_1170243_out_ap_vld;
...
reg   [127:0] add59_1170243_fu_184;
wire   [127:0] add_ln54_8_fu_3280_p2;
reg   [127:0] add59_196244_fu_188;
wire   [127:0] add_ln54_14_fu_3290_p2;
reg   [127:0] add59_196_1245_fu_192;
wire   [127:0] add_ln54_20_fu_3300_p2;
reg   [127:0] add59_2132246_fu_196;
wire   [127:0] add_ln54_26_fu_3310_p2;
reg   [127:0] add59_2132_1247_fu_200;
wire   [127:0] add_ln54_32_fu_3320_p2;
reg   [127:0] add59_3248_fu_204;
wire   [127:0] add_ln54_38_fu_3330_p2;
reg   [127:0] add59_3_1249_fu_208;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_1170243_out_ap_vld = 1'b1;
    end else begin
        add59_1170243_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_196244_out_ap_vld = 1'b1;
    end else begin
        add59_196244_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_196_1245_out_ap_vld = 1'b1;
    end else begin
        add59_196_1245_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_2132246_out_ap_vld = 1'b1;
    end else begin
        add59_2132246_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_2132_1247_out_ap_vld = 1'b1;
    end else begin
        add59_2132_1247_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_3248_out_ap_vld = 1'b1;
    end else begin
        add59_3248_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_reg_3946 == 1'd1))) begin
        add59_3_1249_out_ap_vld = 1'b1;
    end else begin
        add59_3_1249_out_ap_vld = 1'b0;
    end
end
...
assign add59_1170243_out = add59_1170243_fu_184;

assign add59_196244_out = add59_196244_fu_188;

assign add59_196_1245_out = add59_196_1245_fu_192;

assign add59_2132246_out = add59_2132246_fu_196;

assign add59_2132_1247_out = add59_2132_1247_fu_200;

assign add59_3248_out = add59_3248_fu_204;

assign add59_3_1249_out = add59_3_1249_fu_208;
...
assign add_ln54_14_fu_3290_p2 = (add59_196244_fu_188 + add_ln54_13_fu_3286_p2);
...
assign add_ln54_20_fu_3300_p2 = (add59_196_1245_fu_192 + add_ln54_19_fu_3296_p2);
...
assign add_ln54_26_fu_3310_p2 = (add59_2132246_fu_196 + add_ln54_25_fu_3306_p2);
...
assign add_ln54_32_fu_3320_p2 = (add59_2132_1247_fu_200 + add_ln54_31_fu_3316_p2);
...
assign add_ln54_38_fu_3330_p2 = (add59_3248_fu_204 + add_ln54_37_fu_3326_p2);
...
assign add_ln54_43_fu_3340_p2 = (add59_3_1249_fu_208 + add_ln54_42_fu_3336_p2);
...
assign add_ln54_8_fu_3280_p2 = (add59_1170243_fu_184 + add_ln54_7_fu_3276_p2);
