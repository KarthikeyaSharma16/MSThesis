...
set C_modelArgList {
	...
	{ sext_ln72 int 61 regular  }
	{ zext_ln61 int 58 regular  }
	{ zext_ln62 int 58 regular  }
	{ out1_w_2 int 59 regular  }
	{ zext_ln64 int 58 regular  }
	{ zext_ln65 int 58 regular  }
	{ zext_ln66 int 58 regular  }
	{ zext_ln67 int 58 regular  }
	{ zext_ln68 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln72", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln61", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln62", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "out1_w_2", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln64", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln65", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln66", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln67", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln68", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln72 sc_in sc_lv 61 signal 1 } 
	{ zext_ln61 sc_in sc_lv 58 signal 2 } 
	{ zext_ln62 sc_in sc_lv 58 signal 3 } 
	{ out1_w_2 sc_in sc_lv 59 signal 4 } 
	{ zext_ln64 sc_in sc_lv 58 signal 5 } 
	{ zext_ln65 sc_in sc_lv 58 signal 6 } 
	{ zext_ln66 sc_in sc_lv 58 signal 7 } 
	{ zext_ln67 sc_in sc_lv 58 signal 8 } 
	{ zext_ln68 sc_in sc_lv 58 signal 9 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln72", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln72", "role": "default" }} , 
 	{ "name": "zext_ln61", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln61", "role": "default" }} , 
 	{ "name": "zext_ln62", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln62", "role": "default" }} , 
 	{ "name": "out1_w_2", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "out1_w_2", "role": "default" }} , 
 	{ "name": "zext_ln64", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln64", "role": "default" }} , 
 	{ "name": "zext_ln65", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln65", "role": "default" }} , 
 	{ "name": "zext_ln66", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln66", "role": "default" }} , 
 	{ "name": "zext_ln67", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln67", "role": "default" }} , 
 	{ "name": "zext_ln68", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln68", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_9_4_59_1_1_U156", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln72 { ap_none {  { sext_ln72 in_data 0 61 } } }
	zext_ln61 { ap_none {  { zext_ln61 in_data 0 58 } } }
	zext_ln62 { ap_none {  { zext_ln62 in_data 0 58 } } }
	out1_w_2 { ap_none {  { out1_w_2 in_data 0 59 } } }
	zext_ln64 { ap_none {  { zext_ln64 in_data 0 58 } } }
	zext_ln65 { ap_none {  { zext_ln65 in_data 0 58 } } }
	zext_ln66 { ap_none {  { zext_ln66 in_data 0 58 } } }
	zext_ln67 { ap_none {  { zext_ln67 in_data 0 58 } } }
	zext_ln68 { ap_none {  { zext_ln68 in_data 0 58 } } }
