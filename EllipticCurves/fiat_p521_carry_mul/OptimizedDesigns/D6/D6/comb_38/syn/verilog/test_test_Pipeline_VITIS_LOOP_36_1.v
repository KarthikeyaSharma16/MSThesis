...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        add_4232_out_ap_vld,
        add_3213231_out,
        add_3213231_out_ap_vld,
        add_2198230_out,
        add_2198230_out_ap_vld,
        add_1183229_out,
        add_1183229_out_ap_vld,
        add228_out,
        add228_out_ap_vld
);
...
output  [127:0] add_7235_out;
output   add_7235_out_ap_vld;
output  [127:0] add_6234_out;
output   add_6234_out_ap_vld;
output  [127:0] add_5233_out;
output   add_5233_out_ap_vld;
output  [127:0] add_4232_out;
output   add_4232_out_ap_vld;
output  [127:0] add_3213231_out;
output   add_3213231_out_ap_vld;
output  [127:0] add_2198230_out;
output   add_2198230_out_ap_vld;
output  [127:0] add_1183229_out;
output   add_1183229_out_ap_vld;
output  [127:0] add228_out;
output   add228_out_ap_vld;

reg ap_idle;
reg add_7235_out_ap_vld;
reg add_6234_out_ap_vld;
reg add_5233_out_ap_vld;
reg add_4232_out_ap_vld;
reg add_3213231_out_ap_vld;
reg add_2198230_out_ap_vld;
reg add_1183229_out_ap_vld;
reg add228_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add228_out_ap_vld = 1'b1;
    end else begin
        add228_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_1183229_out_ap_vld = 1'b1;
    end else begin
        add_1183229_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_2198230_out_ap_vld = 1'b1;
    end else begin
        add_2198230_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_3213231_out_ap_vld = 1'b1;
    end else begin
        add_3213231_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_4232_out_ap_vld = 1'b1;
    end else begin
        add_4232_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_5233_out_ap_vld = 1'b1;
    end else begin
        add_5233_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_6234_out_ap_vld = 1'b1;
    end else begin
        add_6234_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_7235_out_ap_vld = 1'b1;
    end else begin
        add_7235_out_ap_vld = 1'b0;
    end
end
...
assign add228_out = arr_8_fu_120;

assign add_1183229_out = arr_9_fu_124;

assign add_2198230_out = arr_10_fu_128;

assign add_3213231_out = arr_11_fu_132;

assign add_4232_out = arr_12_fu_136;

assign add_5233_out = arr_13_fu_140;

assign add_6234_out = arr_14_fu_144;

assign add_7235_out = arr_15_fu_148;
