...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        add_4118_out_ap_vld,
        add_3100117_out,
        add_3100117_out_ap_vld,
        add_285116_out,
        add_285116_out_ap_vld,
        add_170115_out,
        add_170115_out_ap_vld,
        add114_out,
        add114_out_ap_vld
);
...
output  [127:0] add_7121_out;
output   add_7121_out_ap_vld;
output  [127:0] add_6120_out;
output   add_6120_out_ap_vld;
output  [127:0] add_5119_out;
output   add_5119_out_ap_vld;
output  [127:0] add_4118_out;
output   add_4118_out_ap_vld;
output  [127:0] add_3100117_out;
output   add_3100117_out_ap_vld;
output  [127:0] add_285116_out;
output   add_285116_out_ap_vld;
output  [127:0] add_170115_out;
output   add_170115_out_ap_vld;
output  [127:0] add114_out;
output   add114_out_ap_vld;

reg ap_idle;
reg add_7121_out_ap_vld;
reg add_6120_out_ap_vld;
reg add_5119_out_ap_vld;
reg add_4118_out_ap_vld;
reg add_3100117_out_ap_vld;
reg add_285116_out_ap_vld;
reg add_170115_out_ap_vld;
...
reg   [0:0] tmp_26_reg_2212;
reg   [0:0] tmp_26_reg_2212_pp0_iter1_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_26_reg_2212_pp0_iter1_reg <= tmp_26_reg_2212;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_470_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_26_reg_2212 <= ap_sig_allocacmp_i[32'd3];
        tmp_reg_2207 <= ap_sig_allocacmp_i[32'd3];
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_170115_out_ap_vld = 1'b1;
    end else begin
        add_170115_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_285116_out_ap_vld = 1'b1;
    end else begin
        add_285116_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_3100117_out_ap_vld = 1'b1;
    end else begin
        add_3100117_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_4118_out_ap_vld = 1'b1;
    end else begin
        add_4118_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_5119_out_ap_vld = 1'b1;
    end else begin
        add_5119_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_6120_out_ap_vld = 1'b1;
    end else begin
        add_6120_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_7121_out_ap_vld = 1'b1;
    end else begin
        add_7121_out_ap_vld = 1'b0;
    end
end
...
assign add114_out = arr_8_fu_120;

assign add_170115_out = arr_9_fu_124;

assign add_285116_out = arr_10_fu_128;

assign add_3100117_out = arr_11_fu_132;

assign add_4118_out = arr_12_fu_136;

assign add_5119_out = arr_13_fu_140;

assign add_6120_out = arr_14_fu_144;

assign add_7121_out = arr_15_fu_148;

assign add_ln36_fu_798_p2 = ($signed(ap_sig_allocacmp_i) + $signed(4'd12));
...
assign empty_32_fu_632_p2 = ($signed(ap_sig_allocacmp_i) + $signed(4'd14));

assign empty_33_fu_710_p2 = ($signed(ap_sig_allocacmp_i) + $signed(4'd13));

assign empty_fu_554_p2 = ($signed(ap_sig_allocacmp_i) + $signed(4'd15));

assign icmp_ln36_fu_470_p2 = ((ap_sig_allocacmp_i == 4'd0) ? 1'b1 : 1'b0);

assign icmp_ln49_10_fu_678_p2 = ((tmp_28_fu_668_p4 == 2'd1) ? 1'b1 : 1'b0);

assign icmp_ln49_11_fu_694_p2 = (($signed(empty_32_fu_632_p2) > $signed(4'd2)) ? 1'b1 : 1'b0);

assign icmp_ln49_12_fu_716_p2 = ((empty_33_fu_710_p2 == 4'd5) ? 1'b1 : 1'b0);

assign icmp_ln49_13_fu_740_p2 = ((tmp_29_fu_730_p4 == 2'd1) ? 1'b1 : 1'b0);

assign icmp_ln49_14_fu_756_p2 = (($signed(empty_33_fu_710_p2) > $signed(4'd2)) ? 1'b1 : 1'b0);

assign icmp_ln49_15_fu_782_p2 = (($signed(tmp_30_fu_772_p4) > $signed(3'd0)) ? 1'b1 : 1'b0);

assign icmp_ln49_1_fu_506_p2 = ((ap_sig_allocacmp_i > 4'd6) ? 1'b1 : 1'b0);

assign icmp_ln49_2_fu_522_p2 = ((ap_sig_allocacmp_i > 4'd5) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_538_p2 = ((ap_sig_allocacmp_i > 4'd4) ? 1'b1 : 1'b0);
...
assign icmp_ln49_7_fu_616_p2 = ((tmp_27_fu_606_p4 == 2'd1) ? 1'b1 : 1'b0);

assign icmp_ln49_8_fu_638_p2 = ((empty_32_fu_632_p2 == 4'd6) ? 1'b1 : 1'b0);

assign icmp_ln49_9_fu_652_p2 = (($signed(empty_32_fu_632_p2) > $signed(4'd4)) ? 1'b1 : 1'b0);

assign icmp_ln49_fu_476_p2 = ((ap_sig_allocacmp_i == 4'd8) ? 1'b1 : 1'b0);
...
assign select_ln34_fu_498_p3 = ((tmp_26_fu_490_p3[0:0] == 1'b1) ? 4'd7 : 4'd8);
...
assign select_ln49_8_fu_1798_p3 = ((tmp_26_reg_2212_pp0_iter1_reg[0:0] == 1'b1) ? 128'd340282366920938463463374607431768211455 : 128'd0);
...
assign tmp_26_fu_490_p3 = ap_sig_allocacmp_i[32'd3];

assign tmp_27_fu_606_p4 = {{empty_fu_554_p2[3:2]}};

assign tmp_28_fu_668_p4 = {{empty_32_fu_632_p2[3:2]}};

assign tmp_29_fu_730_p4 = {{empty_33_fu_710_p2[3:2]}};

assign tmp_30_fu_772_p4 = {{empty_33_fu_710_p2[3:1]}};
