...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_7205_out \
    op interface \
    ports { add_7205_out { O 128 vector } add_7205_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_6204_out \
    op interface \
    ports { add_6204_out { O 128 vector } add_6204_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_5203_out \
    op interface \
    ports { add_5203_out { O 128 vector } add_5203_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_4202_out \
    op interface \
    ports { add_4202_out { O 128 vector } add_4202_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_3201_out \
    op interface \
    ports { add_3201_out { O 128 vector } add_3201_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_2200_out \
    op interface \
    ports { add_2200_out { O 128 vector } add_2200_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 77 \
    name add_1183199_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add_1183199_out \
    op interface \
    ports { add_1183199_out { O 128 vector } add_1183199_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add198_out \
    op interface \
    ports { add198_out { O 128 vector } add198_out_ap_vld { O 1 bit } } \
} "
}
