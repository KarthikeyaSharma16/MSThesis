...
output  [127:0] add_1183199_out;
output   add_1183199_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1183199_out_ap_vld = 1'b1;
    end else begin
        add_1183199_out_ap_vld = 1'b0;
    end
end
...
assign add_1183199_out = arr_9_fu_126;
