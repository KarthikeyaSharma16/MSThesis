...
output  [127:0] add83_2196_out;
output   add83_2196_out_ap_vld;

reg ap_idle;
reg m_axi_mem_ARVALID;
reg[63:0] m_axi_mem_ARADDR;
reg m_axi_mem_RREADY;
reg add83_2196_out_ap_vld;
...
reg  signed [60:0] trunc_ln_reg_485;
...
reg   [127:0] add83_2196_fu_82;
wire   [127:0] add_ln62_9_fu_437_p2;
wire    ap_loop_init;
reg   [3:0] i_fu_86;
...
wire  signed [63:0] tmp1_cast_fu_259_p1;
wire   [63:0] empty_29_fu_263_p2;
...
assign add83_2196_out = add83_2196_fu_82;
...
assign add_ln62_9_fu_437_p2 = (add83_2196_fu_82 + add_ln62_8_fu_433_p2);
...
assign empty_29_fu_263_p2 = ($signed(tmp1_cast_fu_259_p1) + $signed(arg1));
...
assign sext_ln62_1_fu_287_p1 = trunc_ln_reg_485;
...
assign sext_ln62_fu_284_p1 = trunc_ln_reg_485;

assign tmp1_cast_fu_259_p1 = $signed(tmp1_fu_253_p2);

assign tmp1_fu_253_p2 = ($signed(p_cast_fu_249_p1) + $signed(8'd48));
