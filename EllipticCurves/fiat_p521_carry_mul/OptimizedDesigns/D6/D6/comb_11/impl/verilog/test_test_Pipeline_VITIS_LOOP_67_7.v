...
module test_test_Pipeline_VITIS_LOOP_67_7 (
        ...
        arg1_r_reload,
        add124_170_3139_out,
        add124_170_3139_out_ap_vld,
        add124_170_2138_out,
        add124_170_2138_out_ap_vld,
        add124_170_1137_out,
        add124_170_1137_out_ap_vld,
        add124_170136_out,
        add124_170136_out_ap_vld,
        add124_3112135_out,
        add124_3112135_out_ap_vld,
        add124_298134_out,
        add124_298134_out_ap_vld,
        add124_184133_out,
        add124_184133_out_ap_vld,
        add124132_out,
        add124132_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [127:0] add_3_1147_reload;
input  [127:0] add_3146_reload;
input  [127:0] add_2_1145_reload;
input  [127:0] add_2144_reload;
input  [127:0] add_1_1143_reload;
input  [127:0] add_1142_reload;
input  [127:0] add_1127141_reload;
input  [127:0] add140_reload;
...
output  [127:0] add124_170_3139_out;
output   add124_170_3139_out_ap_vld;
output  [127:0] add124_170_2138_out;
output   add124_170_2138_out_ap_vld;
output  [127:0] add124_170_1137_out;
output   add124_170_1137_out_ap_vld;
output  [127:0] add124_170136_out;
output   add124_170136_out_ap_vld;
output  [127:0] add124_3112135_out;
output   add124_3112135_out_ap_vld;
output  [127:0] add124_298134_out;
output   add124_298134_out_ap_vld;
output  [127:0] add124_184133_out;
output   add124_184133_out_ap_vld;
output  [127:0] add124132_out;
output   add124132_out_ap_vld;

reg ap_idle;
reg add124_170_3139_out_ap_vld;
reg add124_170_2138_out_ap_vld;
reg add124_170_1137_out_ap_vld;
reg add124_170136_out_ap_vld;
reg add124_3112135_out_ap_vld;
reg add124_298134_out_ap_vld;
reg add124_184133_out_ap_vld;
reg add124132_out_ap_vld;
...
reg   [127:0] add124132_fu_134;
wire   [127:0] add_ln80_3_fu_1566_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [127:0] add124_184133_fu_138;
wire   [127:0] add_ln80_7_fu_1576_p2;
reg   [127:0] add124_298134_fu_142;
wire   [127:0] add_ln80_11_fu_1586_p2;
reg   [127:0] add124_3112135_fu_146;
wire   [127:0] add_ln80_15_fu_1596_p2;
reg   [127:0] add124_170136_fu_150;
wire   [127:0] add_ln80_19_fu_1606_p2;
reg   [127:0] add124_170_1137_fu_154;
wire   [127:0] add_ln80_22_fu_1616_p2;
reg   [127:0] add124_170_2138_fu_158;
wire   [127:0] add_ln80_24_fu_1626_p2;
reg   [127:0] add124_170_3139_fu_162;
...
wire   [63:0] tmp_8_fu_821_p10;
wire   [63:0] tmp_9_fu_846_p7;
wire   [63:0] tmp_s_fu_864_p7;
wire   [63:0] tmp_1_fu_883_p11;
wire   [63:0] tmp_2_fu_902_p11;
wire   [63:0] tmp_3_fu_921_p11;
wire   [63:0] tmp_5_fu_940_p10;
wire   [63:0] tmp_6_fu_966_p7;
wire   [63:0] tmp_7_fu_983_p11;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124132_fu_134 <= add140_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124132_fu_134 <= add_ln80_3_fu_1566_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_170136_fu_150 <= add_2144_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_170136_fu_150 <= add_ln80_19_fu_1606_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_170_1137_fu_154 <= add_2_1145_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_170_1137_fu_154 <= add_ln80_22_fu_1616_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_170_2138_fu_158 <= add_3146_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_170_2138_fu_158 <= add_ln80_24_fu_1626_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_170_3139_fu_162 <= add_3_1147_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_170_3139_fu_162 <= add_ln80_25_fu_1644_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_184133_fu_138 <= add_1127141_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_184133_fu_138 <= add_ln80_7_fu_1576_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_298134_fu_142 <= add_1142_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_298134_fu_142 <= add_ln80_11_fu_1586_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_3112135_fu_146 <= add_1_1143_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_3112135_fu_146 <= add_ln80_15_fu_1596_p2;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124132_out_ap_vld = 1'b1;
    end else begin
        add124132_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_170136_out_ap_vld = 1'b1;
    end else begin
        add124_170136_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_170_1137_out_ap_vld = 1'b1;
    end else begin
        add124_170_1137_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_170_2138_out_ap_vld = 1'b1;
    end else begin
        add124_170_2138_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_170_3139_out_ap_vld = 1'b1;
    end else begin
        add124_170_3139_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_184133_out_ap_vld = 1'b1;
    end else begin
        add124_184133_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_298134_out_ap_vld = 1'b1;
    end else begin
        add124_298134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_3112135_out_ap_vld = 1'b1;
    end else begin
        add124_3112135_out_ap_vld = 1'b0;
    end
end
...
assign add124132_out = add124132_fu_134;

assign add124_170136_out = add124_170136_fu_150;

assign add124_170_1137_out = add124_170_1137_fu_154;

assign add124_170_2138_out = add124_170_2138_fu_158;

assign add124_170_3139_out = add124_170_3139_fu_162;

assign add124_184133_out = add124_184133_fu_138;

assign add124_298134_out = add124_298134_fu_142;

assign add124_3112135_out = add124_3112135_fu_146;
...
assign add_ln80_11_fu_1586_p2 = (add124_298134_fu_142 + add_ln80_10_fu_1582_p2);
...
assign add_ln80_15_fu_1596_p2 = (add124_3112135_fu_146 + add_ln80_14_fu_1592_p2);
...
assign add_ln80_19_fu_1606_p2 = (add124_170136_fu_150 + add_ln80_18_fu_1602_p2);
...
assign add_ln80_22_fu_1616_p2 = (add124_170_1137_fu_154 + add_ln80_21_fu_1612_p2);

assign add_ln80_23_fu_1622_p2 = (and_ln80_14_reg_2226 + and_ln80_13_reg_2221);

assign add_ln80_24_fu_1626_p2 = (add124_170_2138_fu_158 + add_ln80_23_fu_1622_p2);

assign add_ln80_25_fu_1644_p2 = (and_ln80_15_fu_1639_p2 + add124_170_3139_fu_162);

assign add_ln80_2_fu_1562_p2 = (add_ln80_1_reg_2166 + add_ln80_reg_2161);

assign add_ln80_3_fu_1566_p2 = (add124132_fu_134 + add_ln80_2_fu_1562_p2);
...
assign add_ln80_7_fu_1576_p2 = (add124_184133_fu_138 + add_ln80_6_fu_1572_p2);
...
assign mul_ln80_10_fu_416_p00 = tmp_1_fu_883_p11;
...
assign mul_ln80_13_fu_428_p00 = tmp_7_fu_983_p11;
...
assign mul_ln80_15_fu_436_p00 = tmp_2_fu_902_p11;
...
assign mul_ln80_19_fu_452_p00 = tmp_3_fu_921_p11;
...
assign zext_ln80_1_fu_856_p1 = tmp_9_fu_846_p7;

assign zext_ln80_21_fu_546_p1 = xor_ln70_fu_540_p2;

assign zext_ln80_2_fu_875_p1 = tmp_s_fu_864_p7;

assign zext_ln80_6_fu_956_p1 = tmp_5_fu_940_p10;

assign zext_ln80_7_fu_976_p1 = tmp_6_fu_966_p7;

assign zext_ln80_fu_837_p1 = tmp_8_fu_821_p10;
