...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg1_r_7_reload,
        add_185_3123_out,
        add_185_3123_out_ap_vld,
        add_185_2122_out,
        add_185_2122_out_ap_vld,
        add_185_1121_out,
        add_185_1121_out_ap_vld,
        add_185120_out,
        add_185120_out_ap_vld,
        add_3119_out,
        add_3119_out_ap_vld,
        add_2118_out,
        add_2118_out_ap_vld,
        add_1103117_out,
        add_1103117_out_ap_vld,
        add116_out,
        add116_out_ap_vld
);
...
output  [127:0] add_185_3123_out;
output   add_185_3123_out_ap_vld;
output  [127:0] add_185_2122_out;
output   add_185_2122_out_ap_vld;
output  [127:0] add_185_1121_out;
output   add_185_1121_out_ap_vld;
output  [127:0] add_185120_out;
output   add_185120_out_ap_vld;
output  [127:0] add_3119_out;
output   add_3119_out_ap_vld;
output  [127:0] add_2118_out;
output   add_2118_out_ap_vld;
output  [127:0] add_1103117_out;
output   add_1103117_out_ap_vld;
output  [127:0] add116_out;
output   add116_out_ap_vld;

reg ap_idle;
reg add_185_3123_out_ap_vld;
reg add_185_2122_out_ap_vld;
reg add_185_1121_out_ap_vld;
reg add_185120_out_ap_vld;
reg add_3119_out_ap_vld;
reg add_2118_out_ap_vld;
reg add_1103117_out_ap_vld;
reg add116_out_ap_vld;
...
reg   [127:0] add116_fu_122;
wire   [127:0] add_ln49_fu_1319_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [127:0] add_1103117_fu_126;
wire   [127:0] add_ln49_2_fu_1329_p2;
reg   [127:0] add_2118_fu_130;
wire   [127:0] add_ln49_4_fu_1339_p2;
reg   [127:0] add_3119_fu_134;
wire   [127:0] add_ln49_6_fu_1349_p2;
reg   [127:0] add_185120_fu_138;
wire   [127:0] add_ln49_8_fu_1359_p2;
reg   [127:0] add_185_1121_fu_142;
wire   [127:0] add_ln49_10_fu_1369_p2;
reg   [127:0] add_185_2122_fu_146;
wire   [127:0] add_ln49_12_fu_1379_p2;
reg   [127:0] add_185_3123_fu_150;
wire   [127:0] add_ln49_14_fu_1275_p2;
reg   [3:0] i_fu_154;
...
wire   [127:0] add_ln49_13_fu_1269_p2;
wire   [127:0] select_ln49_2_fu_1307_p3;
wire   [127:0] and_ln49_fu_1314_p2;
wire   [127:0] add_ln49_1_fu_1325_p2;
wire   [127:0] add_ln49_3_fu_1335_p2;
wire   [127:0] add_ln49_5_fu_1345_p2;
wire   [127:0] add_ln49_7_fu_1355_p2;
wire   [127:0] add_ln49_9_fu_1365_p2;
wire   [127:0] add_ln49_11_fu_1375_p2;
reg    ap_done_reg;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add116_out_ap_vld = 1'b1;
    end else begin
        add116_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_1103117_out_ap_vld = 1'b1;
    end else begin
        add_1103117_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_185120_out_ap_vld = 1'b1;
    end else begin
        add_185120_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_185_1121_out_ap_vld = 1'b1;
    end else begin
        add_185_1121_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_185_2122_out_ap_vld = 1'b1;
    end else begin
        add_185_2122_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_185_3123_out_ap_vld = 1'b1;
    end else begin
        add_185_3123_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_2118_out_ap_vld = 1'b1;
    end else begin
        add_2118_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_3119_out_ap_vld = 1'b1;
    end else begin
        add_3119_out_ap_vld = 1'b0;
    end
end
...
assign add116_out = add116_fu_122;

assign add_1103117_out = add_1103117_fu_126;

assign add_185120_out = add_185120_fu_138;

assign add_185_1121_out = add_185_1121_fu_142;

assign add_185_2122_out = add_185_2122_fu_146;

assign add_185_3123_out = add_185_3123_fu_150;

assign add_2118_out = add_2118_fu_130;

assign add_3119_out = add_3119_fu_134;

assign add_ln36_fu_716_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(4'd14));

assign add_ln49_10_fu_1369_p2 = (add_185_1121_fu_142 + add_ln49_9_fu_1365_p2);

assign add_ln49_11_fu_1375_p2 = (and_ln49_11_reg_1813 + mul_ln49_11_reg_1808);

assign add_ln49_12_fu_1379_p2 = (add_185_2122_fu_146 + add_ln49_11_fu_1375_p2);

assign add_ln49_13_fu_1269_p2 = (mul_ln49_14_fu_372_p2 + mul_ln49_13_fu_368_p2);

assign add_ln49_14_fu_1275_p2 = (add_185_3123_fu_150 + add_ln49_13_fu_1269_p2);

assign add_ln49_1_fu_1325_p2 = (and_ln49_2_reg_1763 + and_ln49_1_reg_1758);

assign add_ln49_2_fu_1329_p2 = (add_1103117_fu_126 + add_ln49_1_fu_1325_p2);

assign add_ln49_3_fu_1335_p2 = (and_ln49_4_reg_1773 + and_ln49_3_reg_1768);

assign add_ln49_4_fu_1339_p2 = (add_2118_fu_130 + add_ln49_3_fu_1335_p2);

assign add_ln49_5_fu_1345_p2 = (and_ln49_6_reg_1783 + and_ln49_5_reg_1778);

assign add_ln49_6_fu_1349_p2 = (add_3119_fu_134 + add_ln49_5_fu_1345_p2);

assign add_ln49_7_fu_1355_p2 = (and_ln49_8_reg_1793 + and_ln49_7_reg_1788);

assign add_ln49_8_fu_1359_p2 = (add_185120_fu_138 + add_ln49_7_fu_1355_p2);

assign add_ln49_9_fu_1365_p2 = (and_ln49_10_reg_1803 + and_ln49_9_reg_1798);

assign add_ln49_fu_1319_p2 = (and_ln49_fu_1314_p2 + add116_fu_122);
