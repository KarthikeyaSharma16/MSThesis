...
output  [127:0] add_7205_out;
output   add_7205_out_ap_vld;
output  [127:0] add_6204_out;
output   add_6204_out_ap_vld;
output  [127:0] add_5203_out;
output   add_5203_out_ap_vld;
output  [127:0] add_4202_out;
output   add_4202_out_ap_vld;
output  [127:0] add_3201_out;
output   add_3201_out_ap_vld;
output  [127:0] add_2200_out;
output   add_2200_out_ap_vld;
output  [127:0] add_1184199_out;
output   add_1184199_out_ap_vld;
output  [127:0] add198_out;
output   add198_out_ap_vld;

reg ap_idle;
reg add_7205_out_ap_vld;
reg add_6204_out_ap_vld;
reg add_5203_out_ap_vld;
reg add_4202_out_ap_vld;
reg add_3201_out_ap_vld;
reg add_2200_out_ap_vld;
reg add_1184199_out_ap_vld;
reg add198_out_ap_vld;
...
reg   [0:0] tmp_12_reg_1631;
wire   [0:0] tmp_13_fu_466_p3;
reg   [0:0] tmp_13_reg_1636;
reg   [0:0] tmp_13_reg_1636_pp0_iter1_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_13_reg_1636_pp0_iter1_reg <= tmp_13_reg_1636;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_428_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_12_reg_1631 <= ap_sig_allocacmp_i_2[32'd3];
        tmp_13_reg_1636 <= ap_sig_allocacmp_i_2[32'd3];
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add198_out_ap_vld = 1'b1;
    end else begin
        add198_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_1184199_out_ap_vld = 1'b1;
    end else begin
        add_1184199_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_2200_out_ap_vld = 1'b1;
    end else begin
        add_2200_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_3201_out_ap_vld = 1'b1;
    end else begin
        add_3201_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_4202_out_ap_vld = 1'b1;
    end else begin
        add_4202_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_5203_out_ap_vld = 1'b1;
    end else begin
        add_5203_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_6204_out_ap_vld = 1'b1;
    end else begin
        add_6204_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_7205_out_ap_vld = 1'b1;
    end else begin
        add_7205_out_ap_vld = 1'b0;
    end
end
...
assign add198_out = arr_8_fu_122;

assign add_1184199_out = arr_9_fu_126;

assign add_2200_out = arr_10_fu_130;

assign add_3201_out = arr_11_fu_134;

assign add_4202_out = arr_12_fu_138;

assign add_5203_out = arr_13_fu_142;

assign add_6204_out = arr_14_fu_146;

assign add_7205_out = arr_15_fu_150;
...
assign icmp_ln49_10_fu_700_p2 = (($signed(tmp_16_fu_690_p4) > $signed(3'd0)) ? 1'b1 : 1'b0);
...
assign icmp_ln49_3_fu_540_p2 = ((tmp_14_fu_530_p4 != 2'd0) ? 1'b1 : 1'b0);
...
assign icmp_ln49_8_fu_658_p2 = ((tmp_15_fu_648_p4 == 2'd1) ? 1'b1 : 1'b0);
...
assign select_ln34_fu_474_p3 = ((tmp_13_fu_466_p3[0:0] == 1'b1) ? 4'd7 : 4'd8);
...
assign select_ln49_2_fu_1307_p3 = ((tmp_13_reg_1636_pp0_iter1_reg[0:0] == 1'b1) ? 128'd340282366920938463463374607431768211455 : 128'd0);
...
assign select_ln49_fu_741_p3 = ((tmp_12_reg_1631[0:0] == 1'b1) ? arg2_r_7_cast : arg2_r_8_cast);
...
assign tmp_13_fu_466_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_14_fu_530_p4 = {{ap_sig_allocacmp_i_2[3:2]}};

assign tmp_15_fu_648_p4 = {{empty_fu_572_p2[3:2]}};

assign tmp_16_fu_690_p4 = {{empty_fu_572_p2[3:1]}};
