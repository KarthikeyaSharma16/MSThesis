...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg1_r_7_reload,
        add_186_3125_out,
        add_186_3125_out_ap_vld,
        add_186_2124_out,
        add_186_2124_out_ap_vld,
        add_186_1123_out,
        add_186_1123_out_ap_vld,
        add_186122_out,
        add_186122_out_ap_vld,
        add_3121_out,
        add_3121_out_ap_vld,
        add_2120_out,
        add_2120_out_ap_vld,
        add_1104119_out,
        add_1104119_out_ap_vld,
        add118_out,
        add118_out_ap_vld
);
...
output  [127:0] add_186_3125_out;
output   add_186_3125_out_ap_vld;
output  [127:0] add_186_2124_out;
output   add_186_2124_out_ap_vld;
output  [127:0] add_186_1123_out;
output   add_186_1123_out_ap_vld;
output  [127:0] add_186122_out;
output   add_186122_out_ap_vld;
output  [127:0] add_3121_out;
output   add_3121_out_ap_vld;
output  [127:0] add_2120_out;
output   add_2120_out_ap_vld;
output  [127:0] add_1104119_out;
output   add_1104119_out_ap_vld;
output  [127:0] add118_out;
output   add118_out_ap_vld;

reg ap_idle;
reg add_186_3125_out_ap_vld;
reg add_186_2124_out_ap_vld;
reg add_186_1123_out_ap_vld;
reg add_186122_out_ap_vld;
reg add_3121_out_ap_vld;
reg add_2120_out_ap_vld;
reg add_1104119_out_ap_vld;
reg add118_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add118_out_ap_vld = 1'b1;
    end else begin
        add118_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1104119_out_ap_vld = 1'b1;
    end else begin
        add_1104119_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_186122_out_ap_vld = 1'b1;
    end else begin
        add_186122_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_186_1123_out_ap_vld = 1'b1;
    end else begin
        add_186_1123_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_186_2124_out_ap_vld = 1'b1;
    end else begin
        add_186_2124_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_186_3125_out_ap_vld = 1'b1;
    end else begin
        add_186_3125_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2120_out_ap_vld = 1'b1;
    end else begin
        add_2120_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3121_out_ap_vld = 1'b1;
    end else begin
        add_3121_out_ap_vld = 1'b0;
    end
end
...
assign add118_out = arr_8_fu_122;

assign add_1104119_out = arr_9_fu_126;

assign add_186122_out = arr_12_fu_138;

assign add_186_1123_out = arr_13_fu_142;

assign add_186_2124_out = arr_14_fu_146;

assign add_186_3125_out = arr_15_fu_150;

assign add_2120_out = arr_10_fu_130;

assign add_3121_out = arr_11_fu_134;
