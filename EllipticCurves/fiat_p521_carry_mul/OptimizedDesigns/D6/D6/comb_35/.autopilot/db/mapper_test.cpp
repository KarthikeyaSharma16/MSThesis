...
using hls::sim::Byte;
extern "C" void test(Byte<8>*, int, int, int);
extern "C" void apatb_test_hw(volatile void * __xlx_apatb_param_out1, volatile void * __xlx_apatb_param_arg1, volatile void * __xlx_apatb_param_arg2) {
using hls::sim::createStream;
  // Collect __xlx_out1_arg1_arg2__tmp_vec
std::vector<Byte<8>> __xlx_out1_arg1_arg2__tmp_vec;
for (size_t i = 0; i < 9; ++i){
__xlx_out1_arg1_arg2__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_out1)[i]);
}
  int __xlx_size_param_out1 = 9;
  int __xlx_offset_param_out1 = 0;
  int __xlx_offset_byte_param_out1 = 0*8;
for (size_t i = 0; i < 9; ++i){
__xlx_out1_arg1_arg2__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_arg1)[i]);
}
  int __xlx_size_param_arg1 = 9;
  int __xlx_offset_param_arg1 = 9;
  int __xlx_offset_byte_param_arg1 = 9*8;
for (size_t i = 0; i < 9; ++i){
__xlx_out1_arg1_arg2__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_arg2)[i]);
}
  int __xlx_size_param_arg2 = 9;
  int __xlx_offset_param_arg2 = 18;
  int __xlx_offset_byte_param_arg2 = 18*8;
  // DUT call
  test(__xlx_out1_arg1_arg2__tmp_vec.data(), __xlx_offset_byte_param_out1, __xlx_offset_byte_param_arg1, __xlx_offset_byte_param_arg2);
// print __xlx_apatb_param_out1
for (size_t i = 0; i < __xlx_size_param_out1; ++i) {
((Byte<8>*)__xlx_apatb_param_out1)[i] = __xlx_out1_arg1_arg2__tmp_vec[__xlx_offset_param_out1+i];
}
// print __xlx_apatb_param_arg1
for (size_t i = 0; i < __xlx_size_param_arg1; ++i) {
((Byte<8>*)__xlx_apatb_param_arg1)[i] = __xlx_out1_arg1_arg2__tmp_vec[__xlx_offset_param_arg1+i];
}
// print __xlx_apatb_param_arg2
for (size_t i = 0; i < __xlx_size_param_arg2; ++i) {
((Byte<8>*)__xlx_apatb_param_arg2)[i] = __xlx_out1_arg1_arg2__tmp_vec[__xlx_offset_param_arg2+i];
}
}
