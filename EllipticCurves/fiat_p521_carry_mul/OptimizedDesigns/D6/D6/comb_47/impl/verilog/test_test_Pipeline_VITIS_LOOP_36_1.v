...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_cast,
        add_1_3147_out,
        add_1_3147_out_ap_vld,
        add_1_2146_out,
        add_1_2146_out_ap_vld,
        add_1_1145_out,
        add_1_1145_out_ap_vld,
        add_1144_out,
        add_1144_out_ap_vld,
        add_3143_out,
        add_3143_out_ap_vld,
...
output  [127:0] add_1_3147_out;
output   add_1_3147_out_ap_vld;
output  [127:0] add_1_2146_out;
output   add_1_2146_out_ap_vld;
output  [127:0] add_1_1145_out;
output   add_1_1145_out_ap_vld;
output  [127:0] add_1144_out;
output   add_1144_out_ap_vld;
output  [127:0] add_3143_out;
output   add_3143_out_ap_vld;
output  [127:0] add_2142_out;
output   add_2142_out_ap_vld;
output  [127:0] add_1126141_out;
output   add_1126141_out_ap_vld;
output  [127:0] add140_out;
output   add140_out_ap_vld;

reg ap_idle;
reg add_1_3147_out_ap_vld;
reg add_1_2146_out_ap_vld;
reg add_1_1145_out_ap_vld;
reg add_1144_out_ap_vld;
reg add_3143_out_ap_vld;
reg add_2142_out_ap_vld;
reg add_1126141_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1126141_out_ap_vld = 1'b1;
    end else begin
        add_1126141_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1144_out_ap_vld = 1'b1;
    end else begin
        add_1144_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1_2146_out_ap_vld = 1'b1;
    end else begin
        add_1_2146_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1_3147_out_ap_vld = 1'b1;
    end else begin
        add_1_3147_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_2142_out_ap_vld = 1'b1;
    end else begin
        add_2142_out_ap_vld = 1'b0;
    end
end
...
assign add140_out = arr_8_fu_118;

assign add_1126141_out = arr_9_fu_122;

assign add_1144_out = arr_12_fu_134;

assign add_1_1145_out = arr_13_fu_138;

assign add_1_2146_out = arr_14_fu_142;

assign add_1_3147_out = arr_15_fu_146;

assign add_2142_out = arr_10_fu_126;

assign add_3143_out = arr_11_fu_130;
