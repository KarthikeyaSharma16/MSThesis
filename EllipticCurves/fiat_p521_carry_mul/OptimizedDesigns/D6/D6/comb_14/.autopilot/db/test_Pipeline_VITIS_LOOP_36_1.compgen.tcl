...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_749_out \
    op interface \
    ports { add_749_out { O 128 vector } add_749_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_648_out \
    op interface \
    ports { add_648_out { O 128 vector } add_648_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_547_out \
    op interface \
    ports { add_547_out { O 128 vector } add_547_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_446_out \
    op interface \
    ports { add_446_out { O 128 vector } add_446_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_345_out \
    op interface \
    ports { add_345_out { O 128 vector } add_345_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_244_out \
    op interface \
    ports { add_244_out { O 128 vector } add_244_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_143_out \
    op interface \
    ports { add_143_out { O 128 vector } add_143_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add42_out \
    op interface \
    ports { add42_out { O 128 vector } add42_out_ap_vld { O 1 bit } } \
} "
}
