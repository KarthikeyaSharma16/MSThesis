...
output  [127:0] add_749_out;
output   add_749_out_ap_vld;
output  [127:0] add_648_out;
output   add_648_out_ap_vld;
output  [127:0] add_547_out;
output   add_547_out_ap_vld;
output  [127:0] add_446_out;
output   add_446_out_ap_vld;
output  [127:0] add_345_out;
output   add_345_out_ap_vld;
output  [127:0] add_244_out;
output   add_244_out_ap_vld;
output  [127:0] add_143_out;
output   add_143_out_ap_vld;
output  [127:0] add42_out;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_396_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_18_reg_1167 <= ap_sig_allocacmp_i[32'd3];
        tmp_19_reg_1172 <= ap_sig_allocacmp_i[32'd3];
...
assign add42_out = arr_8_fu_118;

assign add_143_out = arr_9_fu_122;

assign add_244_out = arr_10_fu_126;

assign add_345_out = arr_11_fu_130;

assign add_446_out = arr_12_fu_134;

assign add_547_out = arr_13_fu_138;

assign add_648_out = arr_14_fu_142;

assign add_749_out = arr_15_fu_146;
...
assign tmp_19_fu_434_p3 = ap_sig_allocacmp_i[32'd3];

assign tmp_20_fu_498_p4 = {{ap_sig_allocacmp_i[3:2]}};

assign tmp_21_fu_530_p4 = {{ap_sig_allocacmp_i[3:1]}};
