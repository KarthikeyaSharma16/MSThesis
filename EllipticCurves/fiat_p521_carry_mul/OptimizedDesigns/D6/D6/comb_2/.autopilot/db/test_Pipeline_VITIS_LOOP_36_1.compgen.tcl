...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_776_out \
    op interface \
    ports { add_776_out { O 128 vector } add_776_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_675_out \
    op interface \
    ports { add_675_out { O 128 vector } add_675_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_574_out \
    op interface \
    ports { add_574_out { O 128 vector } add_574_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_473_out \
    op interface \
    ports { add_473_out { O 128 vector } add_473_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add_372_out { O 128 vector } add_372_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_271_out \
    op interface \
    ports { add_271_out { O 128 vector } add_271_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_170_out \
    op interface \
    ports { add_170_out { O 128 vector } add_170_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add69_out \
    op interface \
    ports { add69_out { O 128 vector } add69_out_ap_vld { O 1 bit } } \
} "
}
