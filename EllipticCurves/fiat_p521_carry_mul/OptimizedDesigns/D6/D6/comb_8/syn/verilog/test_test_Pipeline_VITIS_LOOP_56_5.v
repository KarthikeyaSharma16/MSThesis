...
output  [127:0] add83_2236_out;
output   add83_2236_out_ap_vld;

reg ap_idle;
reg m_axi_mem_ARVALID;
reg[63:0] m_axi_mem_ARADDR;
reg m_axi_mem_RREADY;
reg add83_2236_out_ap_vld;
...
assign add83_2236_out = add83_2236_fu_82;
...
assign add_ln62_9_fu_437_p2 = (add83_2236_fu_82 + add_ln62_8_fu_433_p2);
...
assign empty_31_fu_263_p2 = ($signed(tmp1_cast_fu_259_p1) + $signed(arg1));
