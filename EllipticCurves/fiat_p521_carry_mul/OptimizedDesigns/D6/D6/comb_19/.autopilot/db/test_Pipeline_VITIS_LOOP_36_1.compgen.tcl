...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_762_out \
    op interface \
    ports { add_762_out { O 128 vector } add_762_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_661_out \
    op interface \
    ports { add_661_out { O 128 vector } add_661_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_560_out \
    op interface \
    ports { add_560_out { O 128 vector } add_560_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_459_out \
    op interface \
    ports { add_459_out { O 128 vector } add_459_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_358_out \
    op interface \
    ports { add_358_out { O 128 vector } add_358_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_257_out \
    op interface \
    ports { add_257_out { O 128 vector } add_257_out_ap_vld { O 1 bit } } \
} "
}
