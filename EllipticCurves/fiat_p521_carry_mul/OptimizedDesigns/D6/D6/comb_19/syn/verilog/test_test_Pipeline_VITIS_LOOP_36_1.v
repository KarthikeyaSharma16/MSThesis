...
output  [127:0] add_762_out;
output   add_762_out_ap_vld;
output  [127:0] add_661_out;
output   add_661_out_ap_vld;
output  [127:0] add_560_out;
output   add_560_out_ap_vld;
output  [127:0] add_459_out;
output   add_459_out_ap_vld;
output  [127:0] add_358_out;
output   add_358_out_ap_vld;
output  [127:0] add_257_out;
output   add_257_out_ap_vld;
output  [127:0] add_14256_out;
output   add_14256_out_ap_vld;
output  [127:0] add55_out;
output   add55_out_ap_vld;

reg ap_idle;
reg add_762_out_ap_vld;
reg add_661_out_ap_vld;
reg add_560_out_ap_vld;
reg add_459_out_ap_vld;
reg add_358_out_ap_vld;
reg add_257_out_ap_vld;
reg add_14256_out_ap_vld;
reg add55_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            add55_fu_122 <= add_ln49_fu_769_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add_14256_fu_126 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add_14256_fu_126 <= add_ln49_2_fu_1019_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add_257_fu_130 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add_257_fu_130 <= add_ln49_4_fu_1075_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add_358_fu_134 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add_358_fu_134 <= add_ln49_6_fu_1146_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add_459_fu_138 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add_459_fu_138 <= add_ln49_8_fu_1216_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add_560_fu_142 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add_560_fu_142 <= add_ln49_10_fu_1285_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add_661_fu_146 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add_661_fu_146 <= add_ln49_12_fu_1340_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add_762_fu_150 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add_762_fu_150 <= add_ln49_14_fu_1381_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_429_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_18_reg_1642 <= ap_sig_allocacmp_i_2[32'd3];
        tmp_19_reg_1652 <= ap_sig_allocacmp_i_2[32'd3];
...
always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_out_ap_vld = 1'b1;
    end else begin
        add55_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_14256_out_ap_vld = 1'b1;
    end else begin
        add_14256_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_257_out_ap_vld = 1'b1;
    end else begin
        add_257_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_358_out_ap_vld = 1'b1;
    end else begin
        add_358_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_459_out_ap_vld = 1'b1;
    end else begin
        add_459_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_560_out_ap_vld = 1'b1;
    end else begin
        add_560_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_661_out_ap_vld = 1'b1;
    end else begin
        add_661_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_762_out_ap_vld = 1'b1;
    end else begin
        add_762_out_ap_vld = 1'b0;
    end
end
...
assign add55_out = add55_fu_122;

assign add_14256_out = add_14256_fu_126;

assign add_257_out = add_257_fu_130;

assign add_358_out = add_358_fu_134;

assign add_459_out = add_459_fu_138;

assign add_560_out = add_560_fu_142;

assign add_661_out = add_661_fu_146;

assign add_762_out = add_762_fu_150;

assign add_ln36_fu_722_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(4'd14));

assign add_ln49_10_fu_1285_p2 = (add_560_fu_142 + add_ln49_9_fu_1279_p2);

assign add_ln49_11_fu_1334_p2 = (and_ln49_11_fu_1328_p2 + mul_ln49_11_fu_360_p2);

assign add_ln49_12_fu_1340_p2 = (add_661_fu_146 + add_ln49_11_fu_1334_p2);

assign add_ln49_13_fu_1375_p2 = (mul_ln49_14_fu_372_p2 + mul_ln49_13_fu_368_p2);

assign add_ln49_14_fu_1381_p2 = (add_762_fu_150 + add_ln49_13_fu_1375_p2);

assign add_ln49_1_fu_1013_p2 = (and_ln49_2_fu_1007_p2 + and_ln49_1_fu_994_p2);

assign add_ln49_2_fu_1019_p2 = (add_14256_fu_126 + add_ln49_1_fu_1013_p2);

assign add_ln49_3_fu_1069_p2 = (and_ln49_4_fu_1063_p2 + and_ln49_3_fu_1050_p2);

assign add_ln49_4_fu_1075_p2 = (add_257_fu_130 + add_ln49_3_fu_1069_p2);

assign add_ln49_5_fu_1140_p2 = (and_ln49_6_fu_1134_p2 + and_ln49_5_fu_1121_p2);

assign add_ln49_6_fu_1146_p2 = (add_358_fu_134 + add_ln49_5_fu_1140_p2);

assign add_ln49_7_fu_1210_p2 = (and_ln49_8_fu_1204_p2 + and_ln49_7_fu_1191_p2);

assign add_ln49_8_fu_1216_p2 = (add_459_fu_138 + add_ln49_7_fu_1210_p2);

assign add_ln49_9_fu_1279_p2 = (and_ln49_10_fu_1273_p2 + and_ln49_9_fu_1260_p2);

assign add_ln49_fu_769_p2 = (and_ln49_fu_764_p2 + add55_fu_122);
...
assign tmp_19_fu_472_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_20_fu_536_p4 = {{ap_sig_allocacmp_i_2[3:2]}};
