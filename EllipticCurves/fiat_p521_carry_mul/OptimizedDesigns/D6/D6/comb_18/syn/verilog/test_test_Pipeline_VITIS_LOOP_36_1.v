...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg1_r_7_reload,
        add_158_396_out,
        add_158_396_out_ap_vld,
        add_158_295_out,
        add_158_295_out_ap_vld,
        add_158_194_out,
        add_158_194_out_ap_vld,
        add_15893_out,
        add_15893_out_ap_vld,
        add_392_out,
        add_392_out_ap_vld,
        add_291_out,
        add_291_out_ap_vld,
        add_17690_out,
        add_17690_out_ap_vld,
        add89_out,
        add89_out_ap_vld
);
...
output  [127:0] add_158_396_out;
output   add_158_396_out_ap_vld;
output  [127:0] add_158_295_out;
output   add_158_295_out_ap_vld;
output  [127:0] add_158_194_out;
output   add_158_194_out_ap_vld;
output  [127:0] add_15893_out;
output   add_15893_out_ap_vld;
output  [127:0] add_392_out;
output   add_392_out_ap_vld;
output  [127:0] add_291_out;
output   add_291_out_ap_vld;
output  [127:0] add_17690_out;
output   add_17690_out_ap_vld;
output  [127:0] add89_out;
output   add89_out_ap_vld;

reg ap_idle;
reg add_158_396_out_ap_vld;
reg add_158_295_out_ap_vld;
reg add_158_194_out_ap_vld;
reg add_15893_out_ap_vld;
reg add_392_out_ap_vld;
reg add_291_out_ap_vld;
reg add_17690_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_15893_out_ap_vld = 1'b1;
    end else begin
        add_15893_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_158_194_out_ap_vld = 1'b1;
    end else begin
        add_158_194_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_158_295_out_ap_vld = 1'b1;
    end else begin
        add_158_295_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_158_396_out_ap_vld = 1'b1;
    end else begin
        add_158_396_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_17690_out_ap_vld = 1'b1;
    end else begin
        add_17690_out_ap_vld = 1'b0;
    end
end
...
assign add89_out = add89_fu_122;

assign add_15893_out = add_15893_fu_138;

assign add_158_194_out = add_158_194_fu_142;

assign add_158_295_out = add_158_295_fu_146;

assign add_158_396_out = add_158_396_fu_150;

assign add_17690_out = add_17690_fu_126;

assign add_291_out = add_291_fu_130;

assign add_392_out = add_392_fu_134;

assign add_ln36_fu_722_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(4'd14));

assign add_ln49_10_fu_1285_p2 = (add_158_194_fu_142 + add_ln49_9_fu_1279_p2);

assign add_ln49_11_fu_1334_p2 = (and_ln49_11_fu_1328_p2 + mul_ln49_11_fu_360_p2);

assign add_ln49_12_fu_1340_p2 = (add_158_295_fu_146 + add_ln49_11_fu_1334_p2);

assign add_ln49_13_fu_1375_p2 = (mul_ln49_14_fu_372_p2 + mul_ln49_13_fu_368_p2);

assign add_ln49_14_fu_1381_p2 = (add_158_396_fu_150 + add_ln49_13_fu_1375_p2);

assign add_ln49_1_fu_1013_p2 = (and_ln49_2_fu_1007_p2 + and_ln49_1_fu_994_p2);

assign add_ln49_2_fu_1019_p2 = (add_17690_fu_126 + add_ln49_1_fu_1013_p2);

assign add_ln49_3_fu_1069_p2 = (and_ln49_4_fu_1063_p2 + and_ln49_3_fu_1050_p2);

assign add_ln49_4_fu_1075_p2 = (add_291_fu_130 + add_ln49_3_fu_1069_p2);

assign add_ln49_5_fu_1140_p2 = (and_ln49_6_fu_1134_p2 + and_ln49_5_fu_1121_p2);

assign add_ln49_6_fu_1146_p2 = (add_392_fu_134 + add_ln49_5_fu_1140_p2);

assign add_ln49_7_fu_1210_p2 = (and_ln49_8_fu_1204_p2 + and_ln49_7_fu_1191_p2);

assign add_ln49_8_fu_1216_p2 = (add_15893_fu_138 + add_ln49_7_fu_1210_p2);

assign add_ln49_9_fu_1279_p2 = (and_ln49_10_fu_1273_p2 + and_ln49_9_fu_1260_p2);

assign add_ln49_fu_769_p2 = (and_ln49_fu_764_p2 + add89_fu_122);
