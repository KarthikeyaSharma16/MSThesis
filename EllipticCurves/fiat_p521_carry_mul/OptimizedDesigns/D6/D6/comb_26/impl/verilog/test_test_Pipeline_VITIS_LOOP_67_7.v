...
module test_test_Pipeline_VITIS_LOOP_67_7 (
        ...
        arg2_r_8_reload,
        add124_7123_out,
        add124_7123_out_ap_vld,
        add124_6122_out,
        add124_6122_out_ap_vld,
        add124_5121_out,
        add124_5121_out_ap_vld,
        add124_4120_out,
        add124_4120_out_ap_vld,
        add124_3119_out,
        add124_3119_out_ap_vld,
        add124_2118_out,
        add124_2118_out_ap_vld,
        add124_1117_out,
        add124_1117_out_ap_vld,
        add124116_out,
        add124116_out_ap_vld
);
...
output  [127:0] add124_7123_out;
output   add124_7123_out_ap_vld;
output  [127:0] add124_6122_out;
output   add124_6122_out_ap_vld;
output  [127:0] add124_5121_out;
output   add124_5121_out_ap_vld;
output  [127:0] add124_4120_out;
output   add124_4120_out_ap_vld;
output  [127:0] add124_3119_out;
output   add124_3119_out_ap_vld;
output  [127:0] add124_2118_out;
output   add124_2118_out_ap_vld;
output  [127:0] add124_1117_out;
output   add124_1117_out_ap_vld;
output  [127:0] add124116_out;
output   add124116_out_ap_vld;

reg ap_idle;
reg add124_7123_out_ap_vld;
reg add124_6122_out_ap_vld;
reg add124_5121_out_ap_vld;
reg add124_4120_out_ap_vld;
reg add124_3119_out_ap_vld;
reg add124_2118_out_ap_vld;
reg add124_1117_out_ap_vld;
reg add124116_out_ap_vld;
...
reg   [127:0] add124116_fu_128;
wire   [127:0] add_ln80_fu_816_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [127:0] add124_1117_fu_132;
wire   [127:0] add_ln80_1_fu_833_p2;
reg   [127:0] add124_2118_fu_136;
wire   [127:0] add_ln80_2_fu_851_p2;
reg   [127:0] add124_3119_fu_140;
wire   [127:0] add_ln80_3_fu_869_p2;
reg   [127:0] add124_4120_fu_144;
wire   [127:0] add_ln80_4_fu_887_p2;
reg   [127:0] add124_5121_fu_148;
wire   [127:0] add_ln80_5_fu_905_p2;
reg   [127:0] add124_6122_fu_152;
wire   [127:0] add_ln80_6_fu_923_p2;
reg   [127:0] add124_7123_fu_156;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124116_out_ap_vld = 1'b1;
    end else begin
        add124116_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_1117_out_ap_vld = 1'b1;
    end else begin
        add124_1117_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_2118_out_ap_vld = 1'b1;
    end else begin
        add124_2118_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_3119_out_ap_vld = 1'b1;
    end else begin
        add124_3119_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_4120_out_ap_vld = 1'b1;
    end else begin
        add124_4120_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_5121_out_ap_vld = 1'b1;
    end else begin
        add124_5121_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_6122_out_ap_vld = 1'b1;
    end else begin
        add124_6122_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_7123_out_ap_vld = 1'b1;
    end else begin
        add124_7123_out_ap_vld = 1'b0;
    end
end
...
assign add124116_out = add124116_fu_128;

assign add124_1117_out = add124_1117_fu_132;

assign add124_2118_out = add124_2118_fu_136;

assign add124_3119_out = add124_3119_fu_140;

assign add124_4120_out = add124_4120_fu_144;

assign add124_5121_out = add124_5121_fu_148;

assign add124_6122_out = add124_6122_fu_152;

assign add124_7123_out = add124_7123_fu_156;
...
assign add_ln80_1_fu_833_p2 = (and_ln80_fu_828_p2 + add124_1117_fu_132);

assign add_ln80_2_fu_851_p2 = (and_ln80_1_fu_846_p2 + add124_2118_fu_136);

assign add_ln80_3_fu_869_p2 = (and_ln80_2_fu_864_p2 + add124_3119_fu_140);

assign add_ln80_4_fu_887_p2 = (and_ln80_3_fu_882_p2 + add124_4120_fu_144);

assign add_ln80_5_fu_905_p2 = (and_ln80_4_fu_900_p2 + add124_5121_fu_148);

assign add_ln80_6_fu_923_p2 = (and_ln80_5_fu_918_p2 + add124_6122_fu_152);

assign add_ln80_7_fu_941_p2 = (and_ln80_6_fu_936_p2 + add124_7123_fu_156);

assign add_ln80_fu_816_p2 = (mul_ln80_reg_1268 + add124116_fu_128);
...
assign icmp_ln80_3_fu_556_p2 = ((tmp_10_fu_546_p4 != 2'd1) ? 1'b1 : 1'b0);

assign icmp_ln80_4_fu_572_p2 = (($signed(ap_sig_allocacmp_i_1) < $signed(4'd3)) ? 1'b1 : 1'b0);

assign icmp_ln80_5_fu_588_p2 = (($signed(tmp_11_fu_578_p4) < $signed(3'd1)) ? 1'b1 : 1'b0);
...
assign tmp_8_fu_772_p10 = (sub_ln77_1_fu_738_p2 - zext_ln81_4_fu_763_p1);
...
assign zext_ln80_fu_611_p1 = tmp_reg_1205;
