...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_7135_out \
    op interface \
    ports { add_7135_out { O 128 vector } add_7135_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_6134_out \
    op interface \
    ports { add_6134_out { O 128 vector } add_6134_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_5133_out \
    op interface \
    ports { add_5133_out { O 128 vector } add_5133_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_4132_out \
    op interface \
    ports { add_4132_out { O 128 vector } add_4132_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_3131_out \
    op interface \
    ports { add_3131_out { O 128 vector } add_3131_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_2130_out \
    op interface \
    ports { add_2130_out { O 128 vector } add_2130_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add_1129_out { O 128 vector } add_1129_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add128_out \
    op interface \
    ports { add128_out { O 128 vector } add128_out_ap_vld { O 1 bit } } \
} "
}
