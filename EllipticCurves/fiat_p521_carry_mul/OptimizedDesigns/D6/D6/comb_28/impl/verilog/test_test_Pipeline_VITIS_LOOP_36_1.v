...
output  [127:0] add_7135_out;
output   add_7135_out_ap_vld;
output  [127:0] add_6134_out;
output   add_6134_out_ap_vld;
output  [127:0] add_5133_out;
output   add_5133_out_ap_vld;
output  [127:0] add_4132_out;
output   add_4132_out_ap_vld;
output  [127:0] add_3131_out;
output   add_3131_out_ap_vld;
output  [127:0] add_2130_out;
output   add_2130_out_ap_vld;
output  [127:0] add_1129_out;
output   add_1129_out_ap_vld;
output  [127:0] add128_out;
output   add128_out_ap_vld;

reg ap_idle;
reg add_7135_out_ap_vld;
reg add_6134_out_ap_vld;
reg add_5133_out_ap_vld;
reg add_4132_out_ap_vld;
reg add_3131_out_ap_vld;
reg add_2130_out_ap_vld;
reg add_1129_out_ap_vld;
reg add128_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add128_out_ap_vld = 1'b1;
    end else begin
        add128_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_2130_out_ap_vld = 1'b1;
    end else begin
        add_2130_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_3131_out_ap_vld = 1'b1;
    end else begin
        add_3131_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_4132_out_ap_vld = 1'b1;
    end else begin
        add_4132_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_5133_out_ap_vld = 1'b1;
    end else begin
        add_5133_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_6134_out_ap_vld = 1'b1;
    end else begin
        add_6134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_7135_out_ap_vld = 1'b1;
    end else begin
        add_7135_out_ap_vld = 1'b0;
    end
end
...
assign add128_out = arr_8_fu_118;

assign add_1129_out = arr_9_fu_122;

assign add_2130_out = arr_10_fu_126;

assign add_3131_out = arr_11_fu_130;

assign add_4132_out = arr_12_fu_134;

assign add_5133_out = arr_13_fu_138;

assign add_6134_out = arr_14_fu_142;

assign add_7135_out = arr_15_fu_146;
