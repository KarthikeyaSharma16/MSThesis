...
begin
    mux_9_4_59_1_1_U29 : component test_mux_9_4_59_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 59,
    ...
    add_ln99_fu_204_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv4_1));
    ...
    icmp_ln99_fu_198_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv4_9) else "0";
    ...
    tmp_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln88),59));
    tmp_fu_210_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln89),59));
    tmp_fu_210_p4 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln91),59));
    tmp_fu_210_p5 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln92),59));
    tmp_fu_210_p6 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln93),59));
    tmp_fu_210_p7 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln94),59));
    tmp_fu_210_p8 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln95),59));
