...
module test_test_Pipeline_VITIS_LOOP_67_7 (
        ...
        arg1_r_reload,
        add124_785_out,
        add124_785_out_ap_vld,
        add124_684_out,
        add124_684_out_ap_vld,
        add124_583_out,
        add124_583_out_ap_vld,
        add124_482_out,
        add124_482_out_ap_vld,
        add124_381_out,
        add124_381_out_ap_vld,
        add124_280_out,
        add124_280_out_ap_vld,
        add124_12879_out,
        add124_12879_out_ap_vld,
        add12478_out,
        add12478_out_ap_vld
);
...
input  [127:0] add_37389_reload;
input  [127:0] add_25888_reload;
input  [127:0] add_14387_reload;
...
output  [127:0] add124_785_out;
output   add124_785_out_ap_vld;
output  [127:0] add124_684_out;
output   add124_684_out_ap_vld;
output  [127:0] add124_583_out;
output   add124_583_out_ap_vld;
output  [127:0] add124_482_out;
output   add124_482_out_ap_vld;
output  [127:0] add124_381_out;
output   add124_381_out_ap_vld;
output  [127:0] add124_280_out;
output   add124_280_out_ap_vld;
output  [127:0] add124_12879_out;
output   add124_12879_out_ap_vld;
output  [127:0] add12478_out;
output   add12478_out_ap_vld;

reg ap_idle;
reg add124_785_out_ap_vld;
reg add124_684_out_ap_vld;
reg add124_583_out_ap_vld;
reg add124_482_out_ap_vld;
reg add124_381_out_ap_vld;
reg add124_280_out_ap_vld;
reg add124_12879_out_ap_vld;
reg add12478_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add12478_out_ap_vld = 1'b1;
    end else begin
        add12478_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_12879_out_ap_vld = 1'b1;
    end else begin
        add124_12879_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_280_out_ap_vld = 1'b1;
    end else begin
        add124_280_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_381_out_ap_vld = 1'b1;
    end else begin
        add124_381_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_482_out_ap_vld = 1'b1;
    end else begin
        add124_482_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_583_out_ap_vld = 1'b1;
    end else begin
        add124_583_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_684_out_ap_vld = 1'b1;
    end else begin
        add124_684_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_785_out_ap_vld = 1'b1;
    end else begin
        add124_785_out_ap_vld = 1'b0;
    end
end
...
assign add12478_out = add12478_fu_130;

assign add124_12879_out = add124_12879_fu_134;

assign add124_280_out = add124_280_fu_138;

assign add124_381_out = add124_381_fu_142;

assign add124_482_out = add124_482_fu_146;

assign add124_583_out = add124_583_fu_150;

assign add124_684_out = add124_684_fu_154;

assign add124_785_out = add124_785_fu_158;
...
assign add_ln80_11_fu_1293_p2 = (add124_583_fu_150 + add_ln80_10_fu_1289_p2);

assign add_ln80_12_fu_1299_p2 = (and_ln80_10_reg_1742 + and_ln80_9_reg_1737);

assign add_ln80_13_fu_1303_p2 = (add124_684_fu_154 + add_ln80_12_fu_1299_p2);

assign add_ln80_14_fu_1321_p2 = (and_ln80_11_fu_1316_p2 + add124_785_fu_158);

assign add_ln80_1_fu_994_p2 = (add12478_fu_130 + add_ln80_fu_988_p2);

assign add_ln80_2_fu_1000_p2 = (mul_ln80_3_fu_392_p2 + and_ln80_reg_1649);

assign add_ln80_3_fu_1005_p2 = (add124_12879_fu_134 + add_ln80_2_fu_1000_p2);

assign add_ln80_4_fu_1011_p2 = (and_ln80_2_reg_1659 + and_ln80_1_reg_1654);

assign add_ln80_5_fu_1015_p2 = (add124_280_fu_138 + add_ln80_4_fu_1011_p2);

assign add_ln80_6_fu_1269_p2 = (and_ln80_4_reg_1712 + and_ln80_3_reg_1707);

assign add_ln80_7_fu_1273_p2 = (add124_381_fu_142 + add_ln80_6_fu_1269_p2);

assign add_ln80_8_fu_1279_p2 = (and_ln80_6_reg_1722 + and_ln80_5_reg_1717);

assign add_ln80_9_fu_1283_p2 = (add124_482_fu_146 + add_ln80_8_fu_1279_p2);
