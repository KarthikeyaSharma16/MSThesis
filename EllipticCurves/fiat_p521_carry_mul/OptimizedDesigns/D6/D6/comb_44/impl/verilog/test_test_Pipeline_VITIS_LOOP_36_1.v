...
output  [127:0] add_791_out;
output   add_791_out_ap_vld;
output  [127:0] add_690_out;
output   add_690_out_ap_vld;
output  [127:0] add_589_out;
output   add_589_out_ap_vld;
output  [127:0] add_488_out;
output   add_488_out_ap_vld;
output  [127:0] add_387_out;
output   add_387_out_ap_vld;
output  [127:0] add_286_out;
output   add_286_out_ap_vld;
output  [127:0] add_16985_out;
output   add_16985_out_ap_vld;
output  [127:0] add84_out;
output   add84_out_ap_vld;

reg ap_idle;
reg add_791_out_ap_vld;
reg add_690_out_ap_vld;
reg add_589_out_ap_vld;
reg add_488_out_ap_vld;
reg add_387_out_ap_vld;
reg add_286_out_ap_vld;
reg add_16985_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_16985_out_ap_vld = 1'b1;
    end else begin
        add_16985_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_286_out_ap_vld = 1'b1;
    end else begin
        add_286_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_387_out_ap_vld = 1'b1;
    end else begin
        add_387_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_488_out_ap_vld = 1'b1;
    end else begin
        add_488_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_589_out_ap_vld = 1'b1;
    end else begin
        add_589_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_690_out_ap_vld = 1'b1;
    end else begin
        add_690_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1622 == 1'd1))) begin
        add_791_out_ap_vld = 1'b1;
    end else begin
        add_791_out_ap_vld = 1'b0;
    end
end
...
assign add84_out = arr_8_fu_122;

assign add_16985_out = arr_9_fu_126;

assign add_286_out = arr_10_fu_130;

assign add_387_out = arr_11_fu_134;

assign add_488_out = arr_12_fu_138;

assign add_589_out = arr_13_fu_142;

assign add_690_out = arr_14_fu_146;

assign add_791_out = arr_15_fu_150;
