...
module test_test_Pipeline_VITIS_LOOP_67_7 (
        ...
        ap_idle,
        ap_ready,
        add_3117_1156_reload,
        add_3117155_reload,
        add_2102_1154_reload,
        add_2102153_reload,
        add_187_1152_reload,
        add_187151_reload,
        add_1135150_reload,
        ...
        arg2_r_8_reload,
        add124_1_3147_out,
        add124_1_3147_out_ap_vld,
        add124_1_2146_out,
        add124_1_2146_out_ap_vld,
        add124_1_1145_out,
        add124_1_1145_out_ap_vld,
        add124_1144_out,
        add124_1144_out_ap_vld,
        add124_3143_out,
        add124_3143_out_ap_vld,
        add124_2142_out,
        add124_2142_out_ap_vld,
        add124_127141_out,
        add124_127141_out_ap_vld,
        add124140_out,
        add124140_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [127:0] add_3117_1156_reload;
input  [127:0] add_3117155_reload;
input  [127:0] add_2102_1154_reload;
input  [127:0] add_2102153_reload;
input  [127:0] add_187_1152_reload;
input  [127:0] add_187151_reload;
input  [127:0] add_1135150_reload;
input  [127:0] add149_reload;
...
output  [127:0] add124_1_3147_out;
output   add124_1_3147_out_ap_vld;
output  [127:0] add124_1_2146_out;
output   add124_1_2146_out_ap_vld;
output  [127:0] add124_1_1145_out;
output   add124_1_1145_out_ap_vld;
output  [127:0] add124_1144_out;
output   add124_1144_out_ap_vld;
output  [127:0] add124_3143_out;
output   add124_3143_out_ap_vld;
output  [127:0] add124_2142_out;
output   add124_2142_out_ap_vld;
output  [127:0] add124_127141_out;
output   add124_127141_out_ap_vld;
output  [127:0] add124140_out;
output   add124140_out_ap_vld;

reg ap_idle;
reg add124_1_3147_out_ap_vld;
reg add124_1_2146_out_ap_vld;
reg add124_1_1145_out_ap_vld;
reg add124_1144_out_ap_vld;
reg add124_3143_out_ap_vld;
reg add124_2142_out_ap_vld;
reg add124_127141_out_ap_vld;
reg add124140_out_ap_vld;
...
reg   [127:0] add124140_fu_128;
wire   [127:0] add_ln80_fu_816_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [127:0] add124_127141_fu_132;
wire   [127:0] add_ln80_1_fu_833_p2;
reg   [127:0] add124_2142_fu_136;
wire   [127:0] add_ln80_2_fu_851_p2;
reg   [127:0] add124_3143_fu_140;
wire   [127:0] add_ln80_3_fu_869_p2;
reg   [127:0] add124_1144_fu_144;
wire   [127:0] add_ln80_4_fu_887_p2;
reg   [127:0] add124_1_1145_fu_148;
wire   [127:0] add_ln80_5_fu_905_p2;
reg   [127:0] add124_1_2146_fu_152;
wire   [127:0] add_ln80_6_fu_923_p2;
reg   [127:0] add124_1_3147_fu_156;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124140_fu_128 <= add149_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124140_fu_128 <= add_ln80_fu_816_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_1144_fu_144 <= add_2102153_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_1144_fu_144 <= add_ln80_4_fu_887_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_127141_fu_132 <= add_1135150_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_127141_fu_132 <= add_ln80_1_fu_833_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_1_1145_fu_148 <= add_2102_1154_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_1_1145_fu_148 <= add_ln80_5_fu_905_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_1_2146_fu_152 <= add_3117155_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_1_2146_fu_152 <= add_ln80_6_fu_923_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_1_3147_fu_156 <= add_3117_1156_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_1_3147_fu_156 <= add_ln80_7_fu_941_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_2142_fu_136 <= add_187151_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_2142_fu_136 <= add_ln80_2_fu_851_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_3143_fu_140 <= add_187_1152_reload;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_3143_fu_140 <= add_ln80_3_fu_869_p2;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124140_out_ap_vld = 1'b1;
    end else begin
        add124140_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_1144_out_ap_vld = 1'b1;
    end else begin
        add124_1144_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_127141_out_ap_vld = 1'b1;
    end else begin
        add124_127141_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_1_1145_out_ap_vld = 1'b1;
    end else begin
        add124_1_1145_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_1_2146_out_ap_vld = 1'b1;
    end else begin
        add124_1_2146_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_1_3147_out_ap_vld = 1'b1;
    end else begin
        add124_1_3147_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_2142_out_ap_vld = 1'b1;
    end else begin
        add124_2142_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_3143_out_ap_vld = 1'b1;
    end else begin
        add124_3143_out_ap_vld = 1'b0;
    end
end
...
assign add124140_out = add124140_fu_128;

assign add124_1144_out = add124_1144_fu_144;

assign add124_127141_out = add124_127141_fu_132;

assign add124_1_1145_out = add124_1_1145_fu_148;

assign add124_1_2146_out = add124_1_2146_fu_152;

assign add124_1_3147_out = add124_1_3147_fu_156;

assign add124_2142_out = add124_2142_fu_136;

assign add124_3143_out = add124_3143_fu_140;
...
assign add_ln80_1_fu_833_p2 = (and_ln80_fu_828_p2 + add124_127141_fu_132);

assign add_ln80_2_fu_851_p2 = (and_ln80_1_fu_846_p2 + add124_2142_fu_136);

assign add_ln80_3_fu_869_p2 = (and_ln80_2_fu_864_p2 + add124_3143_fu_140);

assign add_ln80_4_fu_887_p2 = (and_ln80_3_fu_882_p2 + add124_1144_fu_144);

assign add_ln80_5_fu_905_p2 = (and_ln80_4_fu_900_p2 + add124_1_1145_fu_148);

assign add_ln80_6_fu_923_p2 = (and_ln80_5_fu_918_p2 + add124_1_2146_fu_152);

assign add_ln80_7_fu_941_p2 = (and_ln80_6_fu_936_p2 + add124_1_3147_fu_156);

assign add_ln80_fu_816_p2 = (mul_ln80_reg_1268 + add124140_fu_128);
