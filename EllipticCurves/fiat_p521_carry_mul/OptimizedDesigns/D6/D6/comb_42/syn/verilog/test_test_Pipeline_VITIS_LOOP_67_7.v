...
module test_test_Pipeline_VITIS_LOOP_67_7 (
        ...
        arg1_r_1_reload,
        arg1_r_reload,
        add124_3100_1141_out,
        add124_3100_1141_out_ap_vld,
        add124_3100140_out,
        add124_3100140_out_ap_vld,
        add124_285_1139_out,
        add124_285_1139_out_ap_vld,
        add124_285138_out,
        add124_285138_out_ap_vld,
        add124_170_1137_out,
        add124_170_1137_out_ap_vld,
        add124_170136_out,
        add124_170136_out_ap_vld,
        add124_1114135_out,
        add124_1114135_out_ap_vld,
        add124134_out,
        add124134_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [127:0] add_7150_reload;
input  [127:0] add_6149_reload;
input  [127:0] add_5148_reload;
input  [127:0] add_4147_reload;
input  [127:0] add_3146_reload;
input  [127:0] add_2145_reload;
input  [127:0] add_1129144_reload;
input  [127:0] add143_reload;
...
output  [127:0] add124_3100_1141_out;
output   add124_3100_1141_out_ap_vld;
output  [127:0] add124_3100140_out;
output   add124_3100140_out_ap_vld;
output  [127:0] add124_285_1139_out;
output   add124_285_1139_out_ap_vld;
output  [127:0] add124_285138_out;
output   add124_285138_out_ap_vld;
...
output  [127:0] add124_1114135_out;
output   add124_1114135_out_ap_vld;
output  [127:0] add124134_out;
output   add124134_out_ap_vld;

reg ap_idle;
reg add124_3100_1141_out_ap_vld;
reg add124_3100140_out_ap_vld;
reg add124_285_1139_out_ap_vld;
reg add124_285138_out_ap_vld;
reg add124_170_1137_out_ap_vld;
reg add124_170136_out_ap_vld;
reg add124_1114135_out_ap_vld;
reg add124134_out_ap_vld;
...
reg   [127:0] add124134_fu_134;
wire   [127:0] add_ln80_3_fu_1566_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [127:0] add124_1114135_fu_138;
wire   [127:0] add_ln80_7_fu_1576_p2;
reg   [127:0] add124_170136_fu_142;
wire   [127:0] add_ln80_11_fu_1586_p2;
reg   [127:0] add124_170_1137_fu_146;
wire   [127:0] add_ln80_15_fu_1596_p2;
reg   [127:0] add124_285138_fu_150;
wire   [127:0] add_ln80_19_fu_1606_p2;
reg   [127:0] add124_285_1139_fu_154;
wire   [127:0] add_ln80_22_fu_1616_p2;
reg   [127:0] add124_3100140_fu_158;
wire   [127:0] add_ln80_24_fu_1626_p2;
reg   [127:0] add124_3100_1141_fu_162;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124134_out_ap_vld = 1'b1;
    end else begin
        add124134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_1114135_out_ap_vld = 1'b1;
    end else begin
        add124_1114135_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_285138_out_ap_vld = 1'b1;
    end else begin
        add124_285138_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_285_1139_out_ap_vld = 1'b1;
    end else begin
        add124_285_1139_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_3100140_out_ap_vld = 1'b1;
    end else begin
        add124_3100140_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_3100_1141_out_ap_vld = 1'b1;
    end else begin
        add124_3100_1141_out_ap_vld = 1'b0;
    end
end
...
assign add124134_out = add124134_fu_134;

assign add124_1114135_out = add124_1114135_fu_138;

assign add124_170136_out = add124_170136_fu_142;

assign add124_170_1137_out = add124_170_1137_fu_146;

assign add124_285138_out = add124_285138_fu_150;

assign add124_285_1139_out = add124_285_1139_fu_154;

assign add124_3100140_out = add124_3100140_fu_158;

assign add124_3100_1141_out = add124_3100_1141_fu_162;
...
assign add_ln80_11_fu_1586_p2 = (add124_170136_fu_142 + add_ln80_10_fu_1582_p2);
...
assign add_ln80_15_fu_1596_p2 = (add124_170_1137_fu_146 + add_ln80_14_fu_1592_p2);
...
assign add_ln80_19_fu_1606_p2 = (add124_285138_fu_150 + add_ln80_18_fu_1602_p2);
...
assign add_ln80_22_fu_1616_p2 = (add124_285_1139_fu_154 + add_ln80_21_fu_1612_p2);

assign add_ln80_23_fu_1622_p2 = (and_ln80_14_reg_2226 + and_ln80_13_reg_2221);

assign add_ln80_24_fu_1626_p2 = (add124_3100140_fu_158 + add_ln80_23_fu_1622_p2);

assign add_ln80_25_fu_1644_p2 = (and_ln80_15_fu_1639_p2 + add124_3100_1141_fu_162);

assign add_ln80_2_fu_1562_p2 = (add_ln80_1_reg_2166 + add_ln80_reg_2161);

assign add_ln80_3_fu_1566_p2 = (add124134_fu_134 + add_ln80_2_fu_1562_p2);
...
assign add_ln80_7_fu_1576_p2 = (add124_1114135_fu_138 + add_ln80_6_fu_1572_p2);
