...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg1_r_1_reload,
        add_3146_1185_out,
        add_3146_1185_out_ap_vld,
        add_3146184_out,
        add_3146184_out_ap_vld,
        add_2131_1183_out,
        add_2131_1183_out_ap_vld,
        add_2131182_out,
        add_2131182_out_ap_vld,
        add_1116_1181_out,
        add_1116_1181_out_ap_vld,
        add_1116180_out,
        add_1116180_out_ap_vld,
        add_1164179_out,
        add_1164179_out_ap_vld,
        add178_out,
        add178_out_ap_vld
);
...
output  [127:0] add_3146_1185_out;
output   add_3146_1185_out_ap_vld;
output  [127:0] add_3146184_out;
output   add_3146184_out_ap_vld;
output  [127:0] add_2131_1183_out;
output   add_2131_1183_out_ap_vld;
output  [127:0] add_2131182_out;
output   add_2131182_out_ap_vld;
output  [127:0] add_1116_1181_out;
output   add_1116_1181_out_ap_vld;
output  [127:0] add_1116180_out;
output   add_1116180_out_ap_vld;
output  [127:0] add_1164179_out;
output   add_1164179_out_ap_vld;
output  [127:0] add178_out;
output   add178_out_ap_vld;

reg ap_idle;
reg add_3146_1185_out_ap_vld;
reg add_3146184_out_ap_vld;
reg add_2131_1183_out_ap_vld;
reg add_2131182_out_ap_vld;
reg add_1116_1181_out_ap_vld;
reg add_1116180_out_ap_vld;
reg add_1164179_out_ap_vld;
reg add178_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add178_out_ap_vld = 1'b1;
    end else begin
        add178_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_1116180_out_ap_vld = 1'b1;
    end else begin
        add_1116180_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_1116_1181_out_ap_vld = 1'b1;
    end else begin
        add_1116_1181_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_1164179_out_ap_vld = 1'b1;
    end else begin
        add_1164179_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_2131182_out_ap_vld = 1'b1;
    end else begin
        add_2131182_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_2131_1183_out_ap_vld = 1'b1;
    end else begin
        add_2131_1183_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_3146184_out_ap_vld = 1'b1;
    end else begin
        add_3146184_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_3146_1185_out_ap_vld = 1'b1;
    end else begin
        add_3146_1185_out_ap_vld = 1'b0;
    end
end
...
assign add178_out = arr_8_fu_120;

assign add_1116180_out = arr_10_fu_128;

assign add_1116_1181_out = arr_11_fu_132;

assign add_1164179_out = arr_9_fu_124;

assign add_2131182_out = arr_12_fu_136;

assign add_2131_1183_out = arr_13_fu_140;

assign add_3146184_out = arr_14_fu_144;

assign add_3146_1185_out = arr_15_fu_148;
