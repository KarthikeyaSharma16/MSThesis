...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_779_out \
    op interface \
    ports { add_779_out { O 128 vector } add_779_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_678_out \
    op interface \
    ports { add_678_out { O 128 vector } add_678_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_577_out \
    op interface \
    ports { add_577_out { O 128 vector } add_577_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_476_out \
    op interface \
    ports { add_476_out { O 128 vector } add_476_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_375_out \
    op interface \
    ports { add_375_out { O 128 vector } add_375_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_274_out \
    op interface \
    ports { add_274_out { O 128 vector } add_274_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_173_out \
    op interface \
    ports { add_173_out { O 128 vector } add_173_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add72_out \
    op interface \
    ports { add72_out { O 128 vector } add72_out_ap_vld { O 1 bit } } \
} "
}
