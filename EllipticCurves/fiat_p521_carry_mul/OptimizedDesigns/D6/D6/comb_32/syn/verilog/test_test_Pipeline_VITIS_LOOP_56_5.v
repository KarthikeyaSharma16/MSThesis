...
output  [127:0] add83_271_out;
output   add83_271_out_ap_vld;

reg ap_idle;
reg m_axi_mem_ARVALID;
reg[63:0] m_axi_mem_ARADDR;
reg m_axi_mem_RREADY;
reg add83_271_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln56_reg_481_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage4) & (1'b0 == ap_block_pp0_stage4_11001))) begin
        add83_271_out_ap_vld = 1'b1;
    end else begin
        add83_271_out_ap_vld = 1'b0;
    end
end
...
assign add83_271_out = arr_fu_82;
