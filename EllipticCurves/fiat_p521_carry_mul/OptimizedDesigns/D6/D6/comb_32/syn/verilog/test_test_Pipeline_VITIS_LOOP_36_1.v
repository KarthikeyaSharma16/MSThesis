...
output  [127:0] add_779_out;
output   add_779_out_ap_vld;
output  [127:0] add_678_out;
output   add_678_out_ap_vld;
output  [127:0] add_577_out;
output   add_577_out_ap_vld;
output  [127:0] add_476_out;
output   add_476_out_ap_vld;
output  [127:0] add_375_out;
output   add_375_out_ap_vld;
output  [127:0] add_274_out;
output   add_274_out_ap_vld;
output  [127:0] add_173_out;
output   add_173_out_ap_vld;
output  [127:0] add72_out;
output   add72_out_ap_vld;

reg ap_idle;
reg add_779_out_ap_vld;
reg add_678_out_ap_vld;
reg add_577_out_ap_vld;
reg add_476_out_ap_vld;
reg add_375_out_ap_vld;
reg add_274_out_ap_vld;
reg add_173_out_ap_vld;
reg add72_out_ap_vld;
...
reg   [0:0] tmp_26_reg_1167;
wire   [0:0] tmp_27_fu_434_p3;
reg   [0:0] tmp_27_reg_1172;
reg   [0:0] tmp_27_reg_1172_pp0_iter1_reg;
...
wire   [1:0] tmp_28_fu_498_p4;
wire   [3:0] zext_ln50_3_fu_514_p1;
wire   [2:0] tmp_29_fu_530_p4;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_396_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_26_reg_1167 <= ap_sig_allocacmp_i_2[32'd3];
        tmp_27_reg_1172 <= ap_sig_allocacmp_i_2[32'd3];
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add72_out_ap_vld = 1'b1;
    end else begin
        add72_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_173_out_ap_vld = 1'b1;
    end else begin
        add_173_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_274_out_ap_vld = 1'b1;
    end else begin
        add_274_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_375_out_ap_vld = 1'b1;
    end else begin
        add_375_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_476_out_ap_vld = 1'b1;
    end else begin
        add_476_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_577_out_ap_vld = 1'b1;
    end else begin
        add_577_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_678_out_ap_vld = 1'b1;
    end else begin
        add_678_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_779_out_ap_vld = 1'b1;
    end else begin
        add_779_out_ap_vld = 1'b0;
    end
end
...
assign add72_out = arr_8_fu_118;

assign add_173_out = arr_9_fu_122;

assign add_274_out = arr_10_fu_126;

assign add_375_out = arr_11_fu_130;

assign add_476_out = arr_12_fu_134;

assign add_577_out = arr_13_fu_138;

assign add_678_out = arr_14_fu_142;

assign add_779_out = arr_15_fu_146;
...
assign icmp_ln49_3_fu_508_p2 = ((tmp_28_fu_498_p4 != 2'd0) ? 1'b1 : 1'b0);

assign icmp_ln49_4_fu_524_p2 = ((ap_sig_allocacmp_i_2 > 4'd2) ? 1'b1 : 1'b0);

assign icmp_ln49_5_fu_540_p2 = ((tmp_29_fu_530_p4 != 3'd0) ? 1'b1 : 1'b0);
...
assign select_ln49_1_fu_812_p3 = ((tmp_27_reg_1172_pp0_iter1_reg[0:0] == 1'b1) ? 128'd340282366920938463463374607431768211455 : 128'd0);
...
assign select_ln49_fu_568_p3 = ((tmp_26_reg_1167[0:0] == 1'b1) ? arg2_r_7_cast : arg2_r_8_cast);

assign select_ln50_fu_448_p3 = ((tmp_27_fu_434_p3[0:0] == 1'b1) ? 4'd7 : 4'd8);
...
assign tmp_27_fu_434_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_28_fu_498_p4 = {{ap_sig_allocacmp_i_2[3:2]}};

assign tmp_29_fu_530_p4 = {{ap_sig_allocacmp_i_2[3:1]}};
