...
module test_test_Pipeline_VITIS_LOOP_67_7 (
        ...
        arg2_r_8_reload,
        add124_3_1137_out,
        add124_3_1137_out_ap_vld,
        add124_3136_out,
        add124_3136_out_ap_vld,
        add124_2_1135_out,
        add124_2_1135_out_ap_vld,
        add124_2134_out,
        add124_2134_out_ap_vld,
        add124_1_1133_out,
        add124_1_1133_out_ap_vld,
        add124_1132_out,
        add124_1132_out_ap_vld,
        add124_127131_out,
        add124_127131_out_ap_vld,
        add124130_out,
        add124130_out_ap_vld
);
...
output  [127:0] add124_3_1137_out;
output   add124_3_1137_out_ap_vld;
output  [127:0] add124_3136_out;
output   add124_3136_out_ap_vld;
output  [127:0] add124_2_1135_out;
output   add124_2_1135_out_ap_vld;
output  [127:0] add124_2134_out;
output   add124_2134_out_ap_vld;
output  [127:0] add124_1_1133_out;
output   add124_1_1133_out_ap_vld;
output  [127:0] add124_1132_out;
output   add124_1132_out_ap_vld;
output  [127:0] add124_127131_out;
output   add124_127131_out_ap_vld;
output  [127:0] add124130_out;
output   add124130_out_ap_vld;

reg ap_idle;
reg add124_3_1137_out_ap_vld;
reg add124_3136_out_ap_vld;
reg add124_2_1135_out_ap_vld;
reg add124_2134_out_ap_vld;
reg add124_1_1133_out_ap_vld;
reg add124_1132_out_ap_vld;
reg add124_127131_out_ap_vld;
reg add124130_out_ap_vld;
...
reg   [127:0] add124130_fu_128;
wire   [127:0] add_ln80_fu_816_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [127:0] add124_127131_fu_132;
wire   [127:0] add_ln80_1_fu_833_p2;
reg   [127:0] add124_1132_fu_136;
wire   [127:0] add_ln80_2_fu_851_p2;
reg   [127:0] add124_1_1133_fu_140;
wire   [127:0] add_ln80_3_fu_869_p2;
reg   [127:0] add124_2134_fu_144;
wire   [127:0] add_ln80_4_fu_887_p2;
reg   [127:0] add124_2_1135_fu_148;
wire   [127:0] add_ln80_5_fu_905_p2;
reg   [127:0] add124_3136_fu_152;
wire   [127:0] add_ln80_6_fu_923_p2;
reg   [127:0] add124_3_1137_fu_156;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124130_out_ap_vld = 1'b1;
    end else begin
        add124130_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_1132_out_ap_vld = 1'b1;
    end else begin
        add124_1132_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_127131_out_ap_vld = 1'b1;
    end else begin
        add124_127131_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_1_1133_out_ap_vld = 1'b1;
    end else begin
        add124_1_1133_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_2134_out_ap_vld = 1'b1;
    end else begin
        add124_2134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_2_1135_out_ap_vld = 1'b1;
    end else begin
        add124_2_1135_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_3136_out_ap_vld = 1'b1;
    end else begin
        add124_3136_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_3_1137_out_ap_vld = 1'b1;
    end else begin
        add124_3_1137_out_ap_vld = 1'b0;
    end
end
...
assign add124130_out = add124130_fu_128;

assign add124_1132_out = add124_1132_fu_136;

assign add124_127131_out = add124_127131_fu_132;

assign add124_1_1133_out = add124_1_1133_fu_140;

assign add124_2134_out = add124_2134_fu_144;

assign add124_2_1135_out = add124_2_1135_fu_148;

assign add124_3136_out = add124_3136_fu_152;

assign add124_3_1137_out = add124_3_1137_fu_156;
...
assign add_ln80_1_fu_833_p2 = (and_ln80_fu_828_p2 + add124_127131_fu_132);

assign add_ln80_2_fu_851_p2 = (and_ln80_1_fu_846_p2 + add124_1132_fu_136);

assign add_ln80_3_fu_869_p2 = (and_ln80_2_fu_864_p2 + add124_1_1133_fu_140);

assign add_ln80_4_fu_887_p2 = (and_ln80_3_fu_882_p2 + add124_2134_fu_144);

assign add_ln80_5_fu_905_p2 = (and_ln80_4_fu_900_p2 + add124_2_1135_fu_148);

assign add_ln80_6_fu_923_p2 = (and_ln80_5_fu_918_p2 + add124_3136_fu_152);

assign add_ln80_7_fu_941_p2 = (and_ln80_6_fu_936_p2 + add124_3_1137_fu_156);

assign add_ln80_fu_816_p2 = (mul_ln80_reg_1268 + add124130_fu_128);
