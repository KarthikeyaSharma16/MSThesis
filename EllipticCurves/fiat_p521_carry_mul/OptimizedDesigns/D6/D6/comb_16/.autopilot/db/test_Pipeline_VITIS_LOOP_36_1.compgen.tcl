...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_733_out \
    op interface \
    ports { add_733_out { O 128 vector } add_733_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_632_out \
    op interface \
    ports { add_632_out { O 128 vector } add_632_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_531_out \
    op interface \
    ports { add_531_out { O 128 vector } add_531_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_430_out \
    op interface \
    ports { add_430_out { O 128 vector } add_430_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_329_out \
    op interface \
    ports { add_329_out { O 128 vector } add_329_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_228_out \
    op interface \
    ports { add_228_out { O 128 vector } add_228_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_127_out \
    op interface \
    ports { add_127_out { O 128 vector } add_127_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add26_out \
    op interface \
    ports { add26_out { O 128 vector } add26_out_ap_vld { O 1 bit } } \
} "
}
