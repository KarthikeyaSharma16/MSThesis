...
module test_test_Pipeline_VITIS_LOOP_67_7 (
        ...
        arg2_r_8_reload,
        add124_725_out,
        add124_725_out_ap_vld,
        add124_624_out,
        add124_624_out_ap_vld,
        add124_523_out,
        add124_523_out_ap_vld,
        add124_422_out,
        add124_422_out_ap_vld,
        add124_321_out,
        add124_321_out_ap_vld,
        add124_220_out,
        add124_220_out_ap_vld,
        add124_119_out,
        add124_119_out_ap_vld,
        add12418_out,
        add12418_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [127:0] add_733_reload;
input  [127:0] add_632_reload;
input  [127:0] add_531_reload;
input  [127:0] add_430_reload;
input  [127:0] add_329_reload;
input  [127:0] add_228_reload;
input  [127:0] add_127_reload;
input  [127:0] add26_reload;
...
output  [127:0] add124_725_out;
output   add124_725_out_ap_vld;
output  [127:0] add124_624_out;
output   add124_624_out_ap_vld;
output  [127:0] add124_523_out;
output   add124_523_out_ap_vld;
output  [127:0] add124_422_out;
output   add124_422_out_ap_vld;
output  [127:0] add124_321_out;
output   add124_321_out_ap_vld;
output  [127:0] add124_220_out;
output   add124_220_out_ap_vld;
output  [127:0] add124_119_out;
output   add124_119_out_ap_vld;
output  [127:0] add12418_out;
output   add12418_out_ap_vld;

reg ap_idle;
reg add124_725_out_ap_vld;
reg add124_624_out_ap_vld;
reg add124_523_out_ap_vld;
reg add124_422_out_ap_vld;
reg add124_321_out_ap_vld;
reg add124_220_out_ap_vld;
reg add124_119_out_ap_vld;
reg add12418_out_ap_vld;
...
wire   [63:0] tmp_8_fu_472_p10;
reg   [63:0] tmp_8_reg_1205;
...
wire   [1:0] tmp_4_fu_546_p4;
wire   [3:0] zext_ln81_2_fu_562_p1;
wire   [2:0] tmp_7_fu_578_p4;
wire   [63:0] tmp_9_fu_622_p10;
wire   [63:0] tmp_s_fu_640_p10;
wire   [63:0] tmp_1_fu_659_p11;
wire   [63:0] tmp_2_fu_678_p11;
wire   [63:0] tmp_3_fu_697_p11;
wire   [63:0] tmp_5_fu_716_p11;
wire   [3:0] zext_ln81_3_fu_735_p1;
wire   [3:0] sub_ln77_1_fu_738_p2;
wire   [63:0] tmp_6_fu_743_p11;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add12418_out_ap_vld = 1'b1;
    end else begin
        add12418_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_119_out_ap_vld = 1'b1;
    end else begin
        add124_119_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_220_out_ap_vld = 1'b1;
    end else begin
        add124_220_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_321_out_ap_vld = 1'b1;
    end else begin
        add124_321_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_422_out_ap_vld = 1'b1;
    end else begin
        add124_422_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_523_out_ap_vld = 1'b1;
    end else begin
        add124_523_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_624_out_ap_vld = 1'b1;
    end else begin
        add124_624_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_725_out_ap_vld = 1'b1;
    end else begin
        add124_725_out_ap_vld = 1'b0;
    end
end
...
assign add12418_out = add12418_fu_128;

assign add124_119_out = add124_119_fu_132;

assign add124_220_out = add124_220_fu_136;

assign add124_321_out = add124_321_fu_140;

assign add124_422_out = add124_422_fu_144;

assign add124_523_out = add124_523_fu_148;

assign add124_624_out = add124_624_fu_152;

assign add124_725_out = add124_725_fu_156;
...
assign add_ln80_1_fu_833_p2 = (and_ln80_fu_828_p2 + add124_119_fu_132);

assign add_ln80_2_fu_851_p2 = (and_ln80_1_fu_846_p2 + add124_220_fu_136);

assign add_ln80_3_fu_869_p2 = (and_ln80_2_fu_864_p2 + add124_321_fu_140);

assign add_ln80_4_fu_887_p2 = (and_ln80_3_fu_882_p2 + add124_422_fu_144);

assign add_ln80_5_fu_905_p2 = (and_ln80_4_fu_900_p2 + add124_523_fu_148);

assign add_ln80_6_fu_923_p2 = (and_ln80_5_fu_918_p2 + add124_624_fu_152);

assign add_ln80_7_fu_941_p2 = (and_ln80_6_fu_936_p2 + add124_725_fu_156);

assign add_ln80_fu_816_p2 = (mul_ln80_reg_1268 + add12418_fu_128);
...
assign icmp_ln80_3_fu_556_p2 = ((tmp_4_fu_546_p4 != 2'd1) ? 1'b1 : 1'b0);

assign icmp_ln80_4_fu_572_p2 = (($signed(ap_sig_allocacmp_i_1) < $signed(4'd3)) ? 1'b1 : 1'b0);

assign icmp_ln80_5_fu_588_p2 = (($signed(tmp_7_fu_578_p4) < $signed(3'd1)) ? 1'b1 : 1'b0);
...
assign mul_ln80_fu_370_p00 = tmp_9_fu_622_p10;
...
assign tmp_4_fu_546_p4 = {{ap_sig_allocacmp_i_1[3:2]}};

assign tmp_7_fu_578_p4 = {{ap_sig_allocacmp_i_1[3:1]}};
...
assign zext_ln80_fu_611_p1 = tmp_8_reg_1205;
