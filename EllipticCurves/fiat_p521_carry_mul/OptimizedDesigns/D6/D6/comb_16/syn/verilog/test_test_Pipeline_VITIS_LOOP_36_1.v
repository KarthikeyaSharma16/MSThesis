...
output  [127:0] add_733_out;
output   add_733_out_ap_vld;
output  [127:0] add_632_out;
output   add_632_out_ap_vld;
output  [127:0] add_531_out;
output   add_531_out_ap_vld;
output  [127:0] add_430_out;
output   add_430_out_ap_vld;
output  [127:0] add_329_out;
output   add_329_out_ap_vld;
output  [127:0] add_228_out;
output   add_228_out_ap_vld;
output  [127:0] add_127_out;
output   add_127_out_ap_vld;
output  [127:0] add26_out;
output   add26_out_ap_vld;

reg ap_idle;
reg add_733_out_ap_vld;
reg add_632_out_ap_vld;
reg add_531_out_ap_vld;
reg add_430_out_ap_vld;
reg add_329_out_ap_vld;
reg add_228_out_ap_vld;
reg add_127_out_ap_vld;
reg add26_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_396_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_8_reg_1167 <= ap_sig_allocacmp_i_2[32'd3];
        tmp_9_reg_1172 <= ap_sig_allocacmp_i_2[32'd3];
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add26_out_ap_vld = 1'b1;
    end else begin
        add26_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_127_out_ap_vld = 1'b1;
    end else begin
        add_127_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_228_out_ap_vld = 1'b1;
    end else begin
        add_228_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_329_out_ap_vld = 1'b1;
    end else begin
        add_329_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_430_out_ap_vld = 1'b1;
    end else begin
        add_430_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_531_out_ap_vld = 1'b1;
    end else begin
        add_531_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_632_out_ap_vld = 1'b1;
    end else begin
        add_632_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_733_out_ap_vld = 1'b1;
    end else begin
        add_733_out_ap_vld = 1'b0;
    end
end
...
assign add26_out = add26_fu_118;

assign add_127_out = add_127_fu_122;

assign add_228_out = add_228_fu_126;

assign add_329_out = add_329_fu_130;

assign add_430_out = add_430_fu_134;

assign add_531_out = add_531_fu_138;

assign add_632_out = add_632_fu_142;

assign add_733_out = add_733_fu_146;

assign add_ln36_fu_546_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(4'd15));

assign add_ln49_1_fu_842_p2 = (and_ln49_1_fu_837_p2 + add_127_fu_122);

assign add_ln49_2_fu_860_p2 = (and_ln49_2_fu_855_p2 + add_228_fu_126);

assign add_ln49_3_fu_878_p2 = (and_ln49_3_fu_873_p2 + add_329_fu_130);

assign add_ln49_4_fu_896_p2 = (and_ln49_4_fu_891_p2 + add_430_fu_134);

assign add_ln49_5_fu_914_p2 = (and_ln49_5_fu_909_p2 + add_531_fu_138);

assign add_ln49_6_fu_932_p2 = (and_ln49_6_fu_927_p2 + add_632_fu_142);

assign add_ln49_7_fu_938_p2 = (mul_ln49_7_reg_1265 + add_733_fu_146);

assign add_ln49_fu_824_p2 = (and_ln49_fu_819_p2 + add26_fu_118);
...
assign tmp_10_fu_498_p4 = {{ap_sig_allocacmp_i_2[3:2]}};

assign tmp_11_fu_530_p4 = {{ap_sig_allocacmp_i_2[3:1]}};

assign tmp_7_fu_759_p10 = (sub_ln34_1_fu_715_p2 - zext_ln50_5_fu_750_p1);

assign tmp_9_fu_434_p3 = ap_sig_allocacmp_i_2[32'd3];
