...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        add_4176_out_ap_vld,
        add_3157175_out,
        add_3157175_out_ap_vld,
        add_2142174_out,
        add_2142174_out_ap_vld,
        add_1127173_out,
        add_1127173_out_ap_vld,
        add172_out,
        add172_out_ap_vld
);
...
output  [127:0] add_7179_out;
output   add_7179_out_ap_vld;
output  [127:0] add_6178_out;
output   add_6178_out_ap_vld;
output  [127:0] add_5177_out;
output   add_5177_out_ap_vld;
output  [127:0] add_4176_out;
output   add_4176_out_ap_vld;
output  [127:0] add_3157175_out;
output   add_3157175_out_ap_vld;
output  [127:0] add_2142174_out;
output   add_2142174_out_ap_vld;
output  [127:0] add_1127173_out;
output   add_1127173_out_ap_vld;
output  [127:0] add172_out;
output   add172_out_ap_vld;

reg ap_idle;
reg add_7179_out_ap_vld;
reg add_6178_out_ap_vld;
reg add_5177_out_ap_vld;
reg add_4176_out_ap_vld;
reg add_3157175_out_ap_vld;
reg add_2142174_out_ap_vld;
reg add_1127173_out_ap_vld;
reg add172_out_ap_vld;
...
reg   [0:0] tmp_26_reg_2214;
reg   [0:0] tmp_26_reg_2214_pp0_iter1_reg;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_470_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_26_reg_2214 <= ap_sig_allocacmp_i_2[32'd3];
        tmp_reg_2209 <= ap_sig_allocacmp_i_2[32'd3];
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add172_out_ap_vld = 1'b1;
    end else begin
        add172_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_1127173_out_ap_vld = 1'b1;
    end else begin
        add_1127173_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_2142174_out_ap_vld = 1'b1;
    end else begin
        add_2142174_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_3157175_out_ap_vld = 1'b1;
    end else begin
        add_3157175_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_4176_out_ap_vld = 1'b1;
    end else begin
        add_4176_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_5177_out_ap_vld = 1'b1;
    end else begin
        add_5177_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_6178_out_ap_vld = 1'b1;
    end else begin
        add_6178_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2197 == 1'd1))) begin
        add_7179_out_ap_vld = 1'b1;
    end else begin
        add_7179_out_ap_vld = 1'b0;
    end
end
...
assign add172_out = arr_8_fu_120;

assign add_1127173_out = arr_9_fu_124;

assign add_2142174_out = arr_10_fu_128;

assign add_3157175_out = arr_11_fu_132;

assign add_4176_out = arr_12_fu_136;

assign add_5177_out = arr_13_fu_140;

assign add_6178_out = arr_14_fu_144;

assign add_7179_out = arr_15_fu_148;
...
assign empty_33_fu_632_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(4'd14));

assign empty_34_fu_710_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(4'd13));
...
assign icmp_ln49_11_fu_694_p2 = (($signed(empty_33_fu_632_p2) > $signed(4'd2)) ? 1'b1 : 1'b0);

assign icmp_ln49_12_fu_716_p2 = ((empty_34_fu_710_p2 == 4'd5) ? 1'b1 : 1'b0);

assign icmp_ln49_13_fu_740_p2 = ((tmp_29_fu_730_p4 == 2'd1) ? 1'b1 : 1'b0);

assign icmp_ln49_14_fu_756_p2 = (($signed(empty_34_fu_710_p2) > $signed(4'd2)) ? 1'b1 : 1'b0);
...
assign icmp_ln49_8_fu_638_p2 = ((empty_33_fu_632_p2 == 4'd6) ? 1'b1 : 1'b0);

assign icmp_ln49_9_fu_652_p2 = (($signed(empty_33_fu_632_p2) > $signed(4'd4)) ? 1'b1 : 1'b0);
...
assign select_ln49_8_fu_1815_p3 = ((tmp_26_reg_2214_pp0_iter1_reg[0:0] == 1'b1) ? 128'd340282366920938463463374607431768211455 : 128'd0);
...
assign tmp_26_fu_490_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_27_fu_606_p4 = {{empty_fu_554_p2[3:2]}};

assign tmp_28_fu_668_p4 = {{empty_33_fu_632_p2[3:2]}};

assign tmp_29_fu_730_p4 = {{empty_34_fu_710_p2[3:2]}};

assign tmp_30_fu_772_p4 = {{empty_34_fu_710_p2[3:1]}};
