...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_7190_out \
    op interface \
    ports { add_7190_out { O 128 vector } add_7190_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_6189_out \
    op interface \
    ports { add_6189_out { O 128 vector } add_6189_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_5188_out \
    op interface \
    ports { add_5188_out { O 128 vector } add_5188_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_4187_out \
    op interface \
    ports { add_4187_out { O 128 vector } add_4187_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_3186_out \
    op interface \
    ports { add_3186_out { O 128 vector } add_3186_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_2185_out \
    op interface \
    ports { add_2185_out { O 128 vector } add_2185_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_1184_out \
    op interface \
    ports { add_1184_out { O 128 vector } add_1184_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add183_out \
    op interface \
    ports { add183_out { O 128 vector } add183_out_ap_vld { O 1 bit } } \
} "
}
