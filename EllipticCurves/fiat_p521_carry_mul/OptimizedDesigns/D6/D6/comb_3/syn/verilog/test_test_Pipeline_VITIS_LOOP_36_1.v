...
output  [127:0] add_7190_out;
output   add_7190_out_ap_vld;
output  [127:0] add_6189_out;
output   add_6189_out_ap_vld;
output  [127:0] add_5188_out;
output   add_5188_out_ap_vld;
output  [127:0] add_4187_out;
output   add_4187_out_ap_vld;
output  [127:0] add_3186_out;
output   add_3186_out_ap_vld;
output  [127:0] add_2185_out;
output   add_2185_out_ap_vld;
output  [127:0] add_1184_out;
output   add_1184_out_ap_vld;
output  [127:0] add183_out;
output   add183_out_ap_vld;

reg ap_idle;
reg add_7190_out_ap_vld;
reg add_6189_out_ap_vld;
reg add_5188_out_ap_vld;
reg add_4187_out_ap_vld;
reg add_3186_out_ap_vld;
reg add_2185_out_ap_vld;
reg add_1184_out_ap_vld;
reg add183_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add183_fu_118 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add183_fu_118 <= add_ln49_fu_824_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_1184_fu_122 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_1184_fu_122 <= add_ln49_1_fu_842_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_2185_fu_126 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_2185_fu_126 <= add_ln49_2_fu_860_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_3186_fu_130 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_3186_fu_130 <= add_ln49_3_fu_878_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_4187_fu_134 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_4187_fu_134 <= add_ln49_4_fu_896_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_5188_fu_138 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_5188_fu_138 <= add_ln49_5_fu_914_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_6189_fu_142 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_6189_fu_142 <= add_ln49_6_fu_932_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_7190_fu_146 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_7190_fu_146 <= add_ln49_7_fu_938_p2;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add183_out_ap_vld = 1'b1;
    end else begin
        add183_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1184_out_ap_vld = 1'b1;
    end else begin
        add_1184_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_2185_out_ap_vld = 1'b1;
    end else begin
        add_2185_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_3186_out_ap_vld = 1'b1;
    end else begin
        add_3186_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_4187_out_ap_vld = 1'b1;
    end else begin
        add_4187_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_5188_out_ap_vld = 1'b1;
    end else begin
        add_5188_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_6189_out_ap_vld = 1'b1;
    end else begin
        add_6189_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_7190_out_ap_vld = 1'b1;
    end else begin
        add_7190_out_ap_vld = 1'b0;
    end
end
...
assign add183_out = add183_fu_118;

assign add_1184_out = add_1184_fu_122;

assign add_2185_out = add_2185_fu_126;

assign add_3186_out = add_3186_fu_130;

assign add_4187_out = add_4187_fu_134;

assign add_5188_out = add_5188_fu_138;

assign add_6189_out = add_6189_fu_142;

assign add_7190_out = add_7190_fu_146;

assign add_ln36_fu_546_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(4'd15));

assign add_ln49_1_fu_842_p2 = (and_ln49_1_fu_837_p2 + add_1184_fu_122);

assign add_ln49_2_fu_860_p2 = (and_ln49_2_fu_855_p2 + add_2185_fu_126);

assign add_ln49_3_fu_878_p2 = (and_ln49_3_fu_873_p2 + add_3186_fu_130);

assign add_ln49_4_fu_896_p2 = (and_ln49_4_fu_891_p2 + add_4187_fu_134);

assign add_ln49_5_fu_914_p2 = (and_ln49_5_fu_909_p2 + add_5188_fu_138);

assign add_ln49_6_fu_932_p2 = (and_ln49_6_fu_927_p2 + add_6189_fu_142);

assign add_ln49_7_fu_938_p2 = (mul_ln49_7_reg_1265 + add_7190_fu_146);

assign add_ln49_fu_824_p2 = (and_ln49_fu_819_p2 + add183_fu_118);
