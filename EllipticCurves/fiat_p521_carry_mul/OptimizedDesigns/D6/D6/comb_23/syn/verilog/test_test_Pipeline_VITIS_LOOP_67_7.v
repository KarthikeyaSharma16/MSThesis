...
module test_test_Pipeline_VITIS_LOOP_67_7 (
        ...
        arg1_r_reload,
        add124_3_1113_out,
        add124_3_1113_out_ap_vld,
        add124_3112_out,
        add124_3112_out_ap_vld,
        add124_2_1111_out,
        add124_2_1111_out_ap_vld,
        add124_2110_out,
        add124_2110_out_ap_vld,
        add124_142_1109_out,
        add124_142_1109_out_ap_vld,
        add124_142108_out,
        add124_142108_out_ap_vld,
        add124_156107_out,
        add124_156107_out_ap_vld,
        add124106_out,
        add124106_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [127:0] add_7122_reload;
input  [127:0] add_6121_reload;
input  [127:0] add_5120_reload;
input  [127:0] add_4119_reload;
input  [127:0] add_3101118_reload;
input  [127:0] add_286117_reload;
input  [127:0] add_171116_reload;
input  [127:0] add115_reload;
...
output  [127:0] add124_3_1113_out;
output   add124_3_1113_out_ap_vld;
output  [127:0] add124_3112_out;
output   add124_3112_out_ap_vld;
output  [127:0] add124_2_1111_out;
output   add124_2_1111_out_ap_vld;
output  [127:0] add124_2110_out;
output   add124_2110_out_ap_vld;
output  [127:0] add124_142_1109_out;
output   add124_142_1109_out_ap_vld;
output  [127:0] add124_142108_out;
output   add124_142108_out_ap_vld;
output  [127:0] add124_156107_out;
output   add124_156107_out_ap_vld;
output  [127:0] add124106_out;
output   add124106_out_ap_vld;

reg ap_idle;
reg add124_3_1113_out_ap_vld;
reg add124_3112_out_ap_vld;
reg add124_2_1111_out_ap_vld;
reg add124_2110_out_ap_vld;
reg add124_142_1109_out_ap_vld;
reg add124_142108_out_ap_vld;
reg add124_156107_out_ap_vld;
reg add124106_out_ap_vld;
...
reg   [127:0] add124106_fu_130;
wire   [127:0] add_ln80_1_fu_994_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [127:0] add124_156107_fu_134;
wire   [127:0] add_ln80_3_fu_1005_p2;
reg   [127:0] add124_142108_fu_138;
wire   [127:0] add_ln80_5_fu_1015_p2;
reg   [127:0] add124_142_1109_fu_142;
wire   [127:0] add_ln80_7_fu_1273_p2;
reg   [127:0] add124_2110_fu_146;
wire   [127:0] add_ln80_9_fu_1283_p2;
reg   [127:0] add124_2_1111_fu_150;
wire   [127:0] add_ln80_11_fu_1293_p2;
reg   [127:0] add124_3112_fu_154;
wire   [127:0] add_ln80_13_fu_1303_p2;
reg   [127:0] add124_3_1113_fu_158;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124106_out_ap_vld = 1'b1;
    end else begin
        add124106_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_142108_out_ap_vld = 1'b1;
    end else begin
        add124_142108_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_142_1109_out_ap_vld = 1'b1;
    end else begin
        add124_142_1109_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_156107_out_ap_vld = 1'b1;
    end else begin
        add124_156107_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_2110_out_ap_vld = 1'b1;
    end else begin
        add124_2110_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_2_1111_out_ap_vld = 1'b1;
    end else begin
        add124_2_1111_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_3112_out_ap_vld = 1'b1;
    end else begin
        add124_3112_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1586 == 1'd1))) begin
        add124_3_1113_out_ap_vld = 1'b1;
    end else begin
        add124_3_1113_out_ap_vld = 1'b0;
    end
end
...
assign add124106_out = add124106_fu_130;

assign add124_142108_out = add124_142108_fu_138;

assign add124_142_1109_out = add124_142_1109_fu_142;

assign add124_156107_out = add124_156107_fu_134;

assign add124_2110_out = add124_2110_fu_146;

assign add124_2_1111_out = add124_2_1111_fu_150;

assign add124_3112_out = add124_3112_fu_154;

assign add124_3_1113_out = add124_3_1113_fu_158;
...
assign add_ln80_11_fu_1293_p2 = (add124_2_1111_fu_150 + add_ln80_10_fu_1289_p2);

assign add_ln80_12_fu_1299_p2 = (and_ln80_10_reg_1742 + and_ln80_9_reg_1737);

assign add_ln80_13_fu_1303_p2 = (add124_3112_fu_154 + add_ln80_12_fu_1299_p2);

assign add_ln80_14_fu_1321_p2 = (and_ln80_11_fu_1316_p2 + add124_3_1113_fu_158);

assign add_ln80_1_fu_994_p2 = (add124106_fu_130 + add_ln80_fu_988_p2);

assign add_ln80_2_fu_1000_p2 = (mul_ln80_3_fu_392_p2 + and_ln80_reg_1649);

assign add_ln80_3_fu_1005_p2 = (add124_156107_fu_134 + add_ln80_2_fu_1000_p2);

assign add_ln80_4_fu_1011_p2 = (and_ln80_2_reg_1659 + and_ln80_1_reg_1654);

assign add_ln80_5_fu_1015_p2 = (add124_142108_fu_138 + add_ln80_4_fu_1011_p2);

assign add_ln80_6_fu_1269_p2 = (and_ln80_4_reg_1712 + and_ln80_3_reg_1707);

assign add_ln80_7_fu_1273_p2 = (add124_142_1109_fu_142 + add_ln80_6_fu_1269_p2);

assign add_ln80_8_fu_1279_p2 = (and_ln80_6_reg_1722 + and_ln80_5_reg_1717);

assign add_ln80_9_fu_1283_p2 = (add124_2110_fu_146 + add_ln80_8_fu_1279_p2);
