...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        add_4119_out_ap_vld,
        add_3101118_out,
        add_3101118_out_ap_vld,
        add_286117_out,
        add_286117_out_ap_vld,
        add_171116_out,
        add_171116_out_ap_vld,
        add115_out,
        add115_out_ap_vld
);
...
output  [127:0] add_7122_out;
output   add_7122_out_ap_vld;
output  [127:0] add_6121_out;
output   add_6121_out_ap_vld;
output  [127:0] add_5120_out;
output   add_5120_out_ap_vld;
output  [127:0] add_4119_out;
output   add_4119_out_ap_vld;
output  [127:0] add_3101118_out;
output   add_3101118_out_ap_vld;
output  [127:0] add_286117_out;
output   add_286117_out_ap_vld;
output  [127:0] add_171116_out;
output   add_171116_out_ap_vld;
output  [127:0] add115_out;
output   add115_out_ap_vld;

reg ap_idle;
reg add_7122_out_ap_vld;
reg add_6121_out_ap_vld;
reg add_5120_out_ap_vld;
reg add_4119_out_ap_vld;
reg add_3101118_out_ap_vld;
reg add_286117_out_ap_vld;
reg add_171116_out_ap_vld;
reg add115_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_470_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_18_reg_2212 <= ap_sig_allocacmp_i_2[32'd3];
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add115_out_ap_vld = 1'b1;
    end else begin
        add115_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_171116_out_ap_vld = 1'b1;
    end else begin
        add_171116_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_286117_out_ap_vld = 1'b1;
    end else begin
        add_286117_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_3101118_out_ap_vld = 1'b1;
    end else begin
        add_3101118_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_4119_out_ap_vld = 1'b1;
    end else begin
        add_4119_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_5120_out_ap_vld = 1'b1;
    end else begin
        add_5120_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_6121_out_ap_vld = 1'b1;
    end else begin
        add_6121_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_2195 == 1'd1))) begin
        add_7122_out_ap_vld = 1'b1;
    end else begin
        add_7122_out_ap_vld = 1'b0;
    end
end
...
assign add115_out = arr_8_fu_120;

assign add_171116_out = arr_9_fu_124;

assign add_286117_out = arr_10_fu_128;

assign add_3101118_out = arr_11_fu_132;

assign add_4119_out = arr_12_fu_136;

assign add_5120_out = arr_13_fu_140;

assign add_6121_out = arr_14_fu_144;

assign add_7122_out = arr_15_fu_148;
...
assign tmp_18_fu_490_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_19_fu_606_p4 = {{empty_fu_554_p2[3:2]}};

assign tmp_20_fu_668_p4 = {{empty_31_fu_632_p2[3:2]}};

assign tmp_21_fu_730_p4 = {{empty_32_fu_710_p2[3:2]}};

assign tmp_22_fu_772_p4 = {{empty_32_fu_710_p2[3:1]}};
