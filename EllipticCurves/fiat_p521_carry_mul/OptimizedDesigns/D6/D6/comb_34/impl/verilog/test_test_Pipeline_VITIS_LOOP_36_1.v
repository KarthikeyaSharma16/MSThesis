...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg1_r_7_reload,
        add_3_180_out,
        add_3_180_out_ap_vld,
        add_379_out,
        add_379_out_ap_vld,
        add_2_178_out,
        add_2_178_out_ap_vld,
        add_277_out,
        add_277_out_ap_vld,
        add_143_176_out,
        add_143_176_out_ap_vld,
        add_14375_out,
        add_14375_out_ap_vld,
        add_15974_out,
        add_15974_out_ap_vld,
        add73_out,
        add73_out_ap_vld
);
...
output  [127:0] add_3_180_out;
output   add_3_180_out_ap_vld;
output  [127:0] add_379_out;
output   add_379_out_ap_vld;
output  [127:0] add_2_178_out;
output   add_2_178_out_ap_vld;
output  [127:0] add_277_out;
output   add_277_out_ap_vld;
output  [127:0] add_143_176_out;
output   add_143_176_out_ap_vld;
output  [127:0] add_14375_out;
output   add_14375_out_ap_vld;
output  [127:0] add_15974_out;
output   add_15974_out_ap_vld;
output  [127:0] add73_out;
output   add73_out_ap_vld;

reg ap_idle;
reg add_3_180_out_ap_vld;
reg add_379_out_ap_vld;
reg add_2_178_out_ap_vld;
reg add_277_out_ap_vld;
reg add_143_176_out_ap_vld;
reg add_14375_out_ap_vld;
reg add_15974_out_ap_vld;
reg add73_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_429_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_12_reg_1642 <= ap_sig_allocacmp_i_2[32'd3];
        tmp_13_reg_1652 <= ap_sig_allocacmp_i_2[32'd3];
...
always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add73_out_ap_vld = 1'b1;
    end else begin
        add73_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_14375_out_ap_vld = 1'b1;
    end else begin
        add_14375_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_143_176_out_ap_vld = 1'b1;
    end else begin
        add_143_176_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_15974_out_ap_vld = 1'b1;
    end else begin
        add_15974_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_277_out_ap_vld = 1'b1;
    end else begin
        add_277_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2_178_out_ap_vld = 1'b1;
    end else begin
        add_2_178_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_379_out_ap_vld = 1'b1;
    end else begin
        add_379_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3_180_out_ap_vld = 1'b1;
    end else begin
        add_3_180_out_ap_vld = 1'b0;
    end
end
...
assign add73_out = arr_8_fu_122;

assign add_14375_out = arr_10_fu_130;

assign add_143_176_out = arr_11_fu_134;

assign add_15974_out = arr_9_fu_126;

assign add_277_out = arr_12_fu_138;

assign add_2_178_out = arr_13_fu_142;

assign add_379_out = arr_14_fu_146;

assign add_3_180_out = arr_15_fu_150;
...
assign tmp_13_fu_472_p3 = ap_sig_allocacmp_i_2[32'd3];

assign tmp_14_fu_536_p4 = {{ap_sig_allocacmp_i_2[3:2]}};
