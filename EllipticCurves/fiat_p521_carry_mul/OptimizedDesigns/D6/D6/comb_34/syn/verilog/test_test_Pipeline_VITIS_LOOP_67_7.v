...
module test_test_Pipeline_VITIS_LOOP_67_7 (
        ...
        arg2_r_8_reload,
        add124_771_out,
        add124_771_out_ap_vld,
        add124_670_out,
        add124_670_out_ap_vld,
        add124_569_out,
        add124_569_out_ap_vld,
        add124_468_out,
        add124_468_out_ap_vld,
        add124_367_out,
        add124_367_out_ap_vld,
        add124_266_out,
        add124_266_out_ap_vld,
        add124_165_out,
        add124_165_out_ap_vld,
        add12464_out,
        add12464_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [127:0] add_3_180_reload;
input  [127:0] add_379_reload;
input  [127:0] add_2_178_reload;
input  [127:0] add_277_reload;
input  [127:0] add_143_176_reload;
input  [127:0] add_14375_reload;
input  [127:0] add_15974_reload;
input  [127:0] add73_reload;
...
output  [127:0] add124_771_out;
output   add124_771_out_ap_vld;
output  [127:0] add124_670_out;
output   add124_670_out_ap_vld;
output  [127:0] add124_569_out;
output   add124_569_out_ap_vld;
output  [127:0] add124_468_out;
output   add124_468_out_ap_vld;
output  [127:0] add124_367_out;
output   add124_367_out_ap_vld;
output  [127:0] add124_266_out;
output   add124_266_out_ap_vld;
output  [127:0] add124_165_out;
output   add124_165_out_ap_vld;
output  [127:0] add12464_out;
output   add12464_out_ap_vld;

reg ap_idle;
reg add124_771_out_ap_vld;
reg add124_670_out_ap_vld;
reg add124_569_out_ap_vld;
reg add124_468_out_ap_vld;
reg add124_367_out_ap_vld;
reg add124_266_out_ap_vld;
reg add124_165_out_ap_vld;
reg add12464_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add12464_out_ap_vld = 1'b1;
    end else begin
        add12464_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_165_out_ap_vld = 1'b1;
    end else begin
        add124_165_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_266_out_ap_vld = 1'b1;
    end else begin
        add124_266_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_468_out_ap_vld = 1'b1;
    end else begin
        add124_468_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_569_out_ap_vld = 1'b1;
    end else begin
        add124_569_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_670_out_ap_vld = 1'b1;
    end else begin
        add124_670_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_1195 == 1'd1))) begin
        add124_771_out_ap_vld = 1'b1;
    end else begin
        add124_771_out_ap_vld = 1'b0;
    end
end
...
assign add12464_out = add12464_fu_128;

assign add124_165_out = add124_165_fu_132;

assign add124_266_out = add124_266_fu_136;

assign add124_367_out = add124_367_fu_140;

assign add124_468_out = add124_468_fu_144;

assign add124_569_out = add124_569_fu_148;

assign add124_670_out = add124_670_fu_152;

assign add124_771_out = add124_771_fu_156;
...
assign add_ln80_1_fu_833_p2 = (and_ln80_fu_828_p2 + add124_165_fu_132);

assign add_ln80_2_fu_851_p2 = (and_ln80_1_fu_846_p2 + add124_266_fu_136);

assign add_ln80_3_fu_869_p2 = (and_ln80_2_fu_864_p2 + add124_367_fu_140);

assign add_ln80_4_fu_887_p2 = (and_ln80_3_fu_882_p2 + add124_468_fu_144);

assign add_ln80_5_fu_905_p2 = (and_ln80_4_fu_900_p2 + add124_569_fu_148);

assign add_ln80_6_fu_923_p2 = (and_ln80_5_fu_918_p2 + add124_670_fu_152);

assign add_ln80_7_fu_941_p2 = (and_ln80_6_fu_936_p2 + add124_771_fu_156);

assign add_ln80_fu_816_p2 = (mul_ln80_reg_1268 + add12464_fu_128);
