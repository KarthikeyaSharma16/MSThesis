...
module test_test_Pipeline_VITIS_LOOP_67_7 (
        ...
        arg2_r_8_reload,
        add124_3_1205_out,
        add124_3_1205_out_ap_vld,
        add124_3204_out,
        add124_3204_out_ap_vld,
        add124_2_1203_out,
        add124_2_1203_out_ap_vld,
        add124_2202_out,
        add124_2202_out_ap_vld,
        add124_1_1201_out,
        add124_1_1201_out_ap_vld,
        add124_1200_out,
        add124_1200_out_ap_vld,
        add124_127199_out,
        add124_127199_out_ap_vld,
        add124198_out,
        add124198_out_ap_vld
);
...
output  [127:0] add124_3_1205_out;
output   add124_3_1205_out_ap_vld;
output  [127:0] add124_3204_out;
output   add124_3204_out_ap_vld;
output  [127:0] add124_2_1203_out;
output   add124_2_1203_out_ap_vld;
output  [127:0] add124_2202_out;
output   add124_2202_out_ap_vld;
output  [127:0] add124_1_1201_out;
output   add124_1_1201_out_ap_vld;
output  [127:0] add124_1200_out;
output   add124_1200_out_ap_vld;
output  [127:0] add124_127199_out;
output   add124_127199_out_ap_vld;
output  [127:0] add124198_out;
output   add124198_out_ap_vld;

reg ap_idle;
reg add124_3_1205_out_ap_vld;
reg add124_3204_out_ap_vld;
reg add124_2_1203_out_ap_vld;
reg add124_2202_out_ap_vld;
reg add124_1_1201_out_ap_vld;
reg add124_1200_out_ap_vld;
reg add124_127199_out_ap_vld;
reg add124198_out_ap_vld;
...
reg   [127:0] add124198_fu_128;
wire   [127:0] add_ln80_fu_816_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [127:0] add124_127199_fu_132;
wire   [127:0] add_ln80_1_fu_833_p2;
reg   [127:0] add124_1200_fu_136;
wire   [127:0] add_ln80_2_fu_851_p2;
reg   [127:0] add124_1_1201_fu_140;
wire   [127:0] add_ln80_3_fu_869_p2;
reg   [127:0] add124_2202_fu_144;
wire   [127:0] add_ln80_4_fu_887_p2;
reg   [127:0] add124_2_1203_fu_148;
wire   [127:0] add_ln80_5_fu_905_p2;
reg   [127:0] add124_3204_fu_152;
wire   [127:0] add_ln80_6_fu_923_p2;
reg   [127:0] add124_3_1205_fu_156;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124198_fu_128 <= arr_17;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124198_fu_128 <= add_ln80_fu_816_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_1200_fu_136 <= arr_19;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_1200_fu_136 <= add_ln80_2_fu_851_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_127199_fu_132 <= arr_18;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_127199_fu_132 <= add_ln80_1_fu_833_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_1_1201_fu_140 <= arr_20;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_1_1201_fu_140 <= add_ln80_3_fu_869_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_2202_fu_144 <= arr_21;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_2202_fu_144 <= add_ln80_4_fu_887_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_2_1203_fu_148 <= arr_22;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_2_1203_fu_148 <= add_ln80_5_fu_905_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_3204_fu_152 <= arr_23;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_3204_fu_152 <= add_ln80_6_fu_923_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add124_3_1205_fu_156 <= arr_24;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add124_3_1205_fu_156 <= add_ln80_7_fu_941_p2;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124198_out_ap_vld = 1'b1;
    end else begin
        add124198_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_1200_out_ap_vld = 1'b1;
    end else begin
        add124_1200_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_127199_out_ap_vld = 1'b1;
    end else begin
        add124_127199_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_1_1201_out_ap_vld = 1'b1;
    end else begin
        add124_1_1201_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_2202_out_ap_vld = 1'b1;
    end else begin
        add124_2202_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_2_1203_out_ap_vld = 1'b1;
    end else begin
        add124_2_1203_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_9_reg_1195 == 1'd1))) begin
        add124_3_1205_out_ap_vld = 1'b1;
    end else begin
        add124_3_1205_out_ap_vld = 1'b0;
    end
end
...
assign add124198_out = add124198_fu_128;

assign add124_1200_out = add124_1200_fu_136;

assign add124_127199_out = add124_127199_fu_132;

assign add124_1_1201_out = add124_1_1201_fu_140;

assign add124_2202_out = add124_2202_fu_144;

assign add124_2_1203_out = add124_2_1203_fu_148;

assign add124_3204_out = add124_3204_fu_152;

assign add124_3_1205_out = add124_3_1205_fu_156;
...
assign add_ln80_1_fu_833_p2 = (and_ln80_fu_828_p2 + add124_127199_fu_132);

assign add_ln80_2_fu_851_p2 = (and_ln80_1_fu_846_p2 + add124_1200_fu_136);

assign add_ln80_3_fu_869_p2 = (and_ln80_2_fu_864_p2 + add124_1_1201_fu_140);

assign add_ln80_4_fu_887_p2 = (and_ln80_3_fu_882_p2 + add124_2202_fu_144);

assign add_ln80_5_fu_905_p2 = (and_ln80_4_fu_900_p2 + add124_2_1203_fu_148);

assign add_ln80_6_fu_923_p2 = (and_ln80_5_fu_918_p2 + add124_3204_fu_152);

assign add_ln80_7_fu_941_p2 = (and_ln80_6_fu_936_p2 + add124_3_1205_fu_156);

assign add_ln80_fu_816_p2 = (mul_ln80_reg_1268 + add124198_fu_128);
