...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg1_r_7_reload,
        add_1144_3183_out,
        add_1144_3183_out_ap_vld,
        add_1144_2182_out,
        add_1144_2182_out_ap_vld,
        add_1144_1181_out,
        add_1144_1181_out_ap_vld,
        add_1144180_out,
        add_1144180_out_ap_vld,
        add_3179_out,
        add_3179_out_ap_vld,
        add_2178_out,
        add_2178_out_ap_vld,
        add_1162177_out,
        add_1162177_out_ap_vld,
        add176_out,
        add176_out_ap_vld
);
...
output  [127:0] add_1144_3183_out;
output   add_1144_3183_out_ap_vld;
output  [127:0] add_1144_2182_out;
output   add_1144_2182_out_ap_vld;
output  [127:0] add_1144_1181_out;
output   add_1144_1181_out_ap_vld;
output  [127:0] add_1144180_out;
output   add_1144180_out_ap_vld;
output  [127:0] add_3179_out;
output   add_3179_out_ap_vld;
output  [127:0] add_2178_out;
output   add_2178_out_ap_vld;
output  [127:0] add_1162177_out;
output   add_1162177_out_ap_vld;
output  [127:0] add176_out;
output   add176_out_ap_vld;

reg ap_idle;
reg add_1144_3183_out_ap_vld;
reg add_1144_2182_out_ap_vld;
reg add_1144_1181_out_ap_vld;
reg add_1144180_out_ap_vld;
reg add_3179_out_ap_vld;
reg add_2178_out_ap_vld;
reg add_1162177_out_ap_vld;
reg add176_out_ap_vld;
...
wire   [0:0] tmp_27_fu_472_p3;
reg   [0:0] tmp_27_reg_1652;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln36_fu_429_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_26_reg_1642 <= ap_sig_allocacmp_i[32'd3];
        tmp_27_reg_1652 <= ap_sig_allocacmp_i[32'd3];
...
always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add176_out_ap_vld = 1'b1;
    end else begin
        add176_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1144180_out_ap_vld = 1'b1;
    end else begin
        add_1144180_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1144_1181_out_ap_vld = 1'b1;
    end else begin
        add_1144_1181_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1144_2182_out_ap_vld = 1'b1;
    end else begin
        add_1144_2182_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1144_3183_out_ap_vld = 1'b1;
    end else begin
        add_1144_3183_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1162177_out_ap_vld = 1'b1;
    end else begin
        add_1162177_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2178_out_ap_vld = 1'b1;
    end else begin
        add_2178_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3179_out_ap_vld = 1'b1;
    end else begin
        add_3179_out_ap_vld = 1'b0;
    end
end
...
assign add176_out = arr_8_fu_122;

assign add_1144180_out = arr_12_fu_138;

assign add_1144_1181_out = arr_13_fu_142;

assign add_1144_2182_out = arr_14_fu_146;

assign add_1144_3183_out = arr_15_fu_150;

assign add_1162177_out = arr_9_fu_126;

assign add_2178_out = arr_10_fu_130;

assign add_3179_out = arr_11_fu_134;
...
assign icmp_ln49_10_fu_706_p2 = (($signed(tmp_30_fu_696_p4) > $signed(3'd0)) ? 1'b1 : 1'b0);
...
assign icmp_ln49_3_fu_546_p2 = ((tmp_28_fu_536_p4 != 2'd0) ? 1'b1 : 1'b0);
...
assign icmp_ln49_8_fu_664_p2 = ((tmp_29_fu_654_p4 == 2'd1) ? 1'b1 : 1'b0);
...
assign select_ln34_fu_480_p3 = ((tmp_27_fu_472_p3[0:0] == 1'b1) ? 4'd7 : 4'd8);
...
assign select_ln49_2_fu_757_p3 = ((tmp_27_reg_1652[0:0] == 1'b1) ? 128'd340282366920938463463374607431768211455 : 128'd0);
...
assign select_ln49_fu_775_p3 = ((tmp_26_reg_1642[0:0] == 1'b1) ? arg2_r_7_cast : arg2_r_8_cast);
...
assign tmp_27_fu_472_p3 = ap_sig_allocacmp_i[32'd3];

assign tmp_28_fu_536_p4 = {{ap_sig_allocacmp_i[3:2]}};

assign tmp_29_fu_654_p4 = {{empty_fu_578_p2[3:2]}};

assign tmp_30_fu_696_p4 = {{empty_fu_578_p2[3:1]}};
