...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_748_out \
    op interface \
    ports { add_748_out { O 128 vector } add_748_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_647_out \
    op interface \
    ports { add_647_out { O 128 vector } add_647_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_546_out \
    op interface \
    ports { add_546_out { O 128 vector } add_546_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_445_out \
    op interface \
    ports { add_445_out { O 128 vector } add_445_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_344_out \
    op interface \
    ports { add_344_out { O 128 vector } add_344_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_243_out \
    op interface \
    ports { add_243_out { O 128 vector } add_243_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_142_out \
    op interface \
    ports { add_142_out { O 128 vector } add_142_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add41_out \
    op interface \
    ports { add41_out { O 128 vector } add41_out_ap_vld { O 1 bit } } \
} "
}
