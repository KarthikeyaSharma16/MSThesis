...
set C_modelArgList {
	...
	{ sext_ln99 int 61 regular  }
	{ zext_ln88 int 58 regular  }
	{ zext_ln89 int 58 regular  }
	{ out1_w_2 int 59 regular  }
	{ zext_ln91 int 58 regular  }
	{ zext_ln92 int 58 regular  }
	{ zext_ln93 int 58 regular  }
	{ zext_ln94 int 58 regular  }
	{ zext_ln95 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln99", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln88", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln89", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "out1_w_2", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln91", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln92", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln93", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln94", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln95", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln99 sc_in sc_lv 61 signal 1 } 
	{ zext_ln88 sc_in sc_lv 58 signal 2 } 
	{ zext_ln89 sc_in sc_lv 58 signal 3 } 
	{ out1_w_2 sc_in sc_lv 59 signal 4 } 
	{ zext_ln91 sc_in sc_lv 58 signal 5 } 
	{ zext_ln92 sc_in sc_lv 58 signal 6 } 
	{ zext_ln93 sc_in sc_lv 58 signal 7 } 
	{ zext_ln94 sc_in sc_lv 58 signal 8 } 
	{ zext_ln95 sc_in sc_lv 58 signal 9 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln99", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln99", "role": "default" }} , 
 	{ "name": "zext_ln88", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln88", "role": "default" }} , 
 	{ "name": "zext_ln89", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln89", "role": "default" }} , 
 	{ "name": "out1_w_2", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "out1_w_2", "role": "default" }} , 
 	{ "name": "zext_ln91", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln91", "role": "default" }} , 
 	{ "name": "zext_ln92", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln92", "role": "default" }} , 
 	{ "name": "zext_ln93", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln93", "role": "default" }} , 
 	{ "name": "zext_ln94", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln94", "role": "default" }} , 
 	{ "name": "zext_ln95", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "zext_ln95", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_9_4_59_1_1_U148", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln99 { ap_none {  { sext_ln99 in_data 0 61 } } }
	zext_ln88 { ap_none {  { zext_ln88 in_data 0 58 } } }
	zext_ln89 { ap_none {  { zext_ln89 in_data 0 58 } } }
	out1_w_2 { ap_none {  { out1_w_2 in_data 0 59 } } }
	zext_ln91 { ap_none {  { zext_ln91 in_data 0 58 } } }
	zext_ln92 { ap_none {  { zext_ln92 in_data 0 58 } } }
	zext_ln93 { ap_none {  { zext_ln93 in_data 0 58 } } }
	zext_ln94 { ap_none {  { zext_ln94 in_data 0 58 } } }
	zext_ln95 { ap_none {  { zext_ln95 in_data 0 58 } } }
