...
module test_test_Pipeline_VITIS_LOOP_67_7 (
        ...
        add124_35881_out,
        add124_35881_out_ap_vld,
        add124_24380_out,
        add124_24380_out_ap_vld,
        add124_12879_out,
...
output   ap_idle;
output   ap_ready;
input  [127:0] add_3_193_reload;
input  [127:0] add_392_reload;
input  [127:0] add_2_191_reload;
input  [127:0] add_290_reload;
input  [127:0] add_1_189_reload;
input  [127:0] add_188_reload;
input  [127:0] add_17387_reload;
...
output  [127:0] add124_35881_out;
output   add124_35881_out_ap_vld;
output  [127:0] add124_24380_out;
output   add124_24380_out_ap_vld;
...
reg add124_35881_out_ap_vld;
reg add124_24380_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_24380_out_ap_vld = 1'b1;
    end else begin
        add124_24380_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_reg_2013 == 1'd1))) begin
        add124_35881_out_ap_vld = 1'b1;
    end else begin
        add124_35881_out_ap_vld = 1'b0;
    end
end
...
assign add12478_out = add12478_fu_134;

assign add124_12879_out = add124_12879_fu_138;

assign add124_24380_out = add124_24380_fu_142;

assign add124_35881_out = add124_35881_fu_146;

assign add124_482_out = add124_482_fu_150;

assign add124_583_out = add124_583_fu_154;

assign add124_684_out = add124_684_fu_158;

assign add124_785_out = add124_785_fu_162;
...
assign add_ln80_11_fu_1586_p2 = (add124_24380_fu_142 + add_ln80_10_fu_1582_p2);
...
assign add_ln80_15_fu_1596_p2 = (add124_35881_fu_146 + add_ln80_14_fu_1592_p2);
...
assign add_ln80_19_fu_1606_p2 = (add124_482_fu_150 + add_ln80_18_fu_1602_p2);
...
assign add_ln80_22_fu_1616_p2 = (add124_583_fu_154 + add_ln80_21_fu_1612_p2);

assign add_ln80_23_fu_1622_p2 = (and_ln80_14_reg_2226 + and_ln80_13_reg_2221);

assign add_ln80_24_fu_1626_p2 = (add124_684_fu_158 + add_ln80_23_fu_1622_p2);

assign add_ln80_25_fu_1644_p2 = (and_ln80_15_fu_1639_p2 + add124_785_fu_162);

assign add_ln80_2_fu_1562_p2 = (add_ln80_1_reg_2166 + add_ln80_reg_2161);

assign add_ln80_3_fu_1566_p2 = (add12478_fu_134 + add_ln80_2_fu_1562_p2);
...
assign add_ln80_7_fu_1576_p2 = (add124_12879_fu_138 + add_ln80_6_fu_1572_p2);
