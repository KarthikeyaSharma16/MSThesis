...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_761_out \
    op interface \
    ports { add_761_out { O 128 vector } add_761_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_660_out \
    op interface \
    ports { add_660_out { O 128 vector } add_660_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_559_out \
    op interface \
    ports { add_559_out { O 128 vector } add_559_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_458_out \
    op interface \
    ports { add_458_out { O 128 vector } add_458_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_357_out \
    op interface \
    ports { add_357_out { O 128 vector } add_357_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_256_out \
    op interface \
    ports { add_256_out { O 128 vector } add_256_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_14155_out \
    op interface \
    ports { add_14155_out { O 128 vector } add_14155_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add54_out \
    op interface \
    ports { add54_out { O 128 vector } add54_out_ap_vld { O 1 bit } } \
} "
}
