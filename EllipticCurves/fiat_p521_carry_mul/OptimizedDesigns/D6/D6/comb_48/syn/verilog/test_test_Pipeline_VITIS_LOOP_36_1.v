...
module test_test_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_cast,
        add_3_191_out,
        add_3_191_out_ap_vld,
        add_390_out,
        add_390_out_ap_vld,
        add_2_189_out,
        add_2_189_out_ap_vld,
        add_288_out,
        add_288_out_ap_vld,
        add_1_187_out,
        add_1_187_out_ap_vld,
        add_186_out,
        add_186_out_ap_vld,
        add_17185_out,
        add_17185_out_ap_vld,
        add84_out,
        add84_out_ap_vld
);
...
output  [127:0] add_3_191_out;
output   add_3_191_out_ap_vld;
output  [127:0] add_390_out;
output   add_390_out_ap_vld;
output  [127:0] add_2_189_out;
output   add_2_189_out_ap_vld;
output  [127:0] add_288_out;
output   add_288_out_ap_vld;
output  [127:0] add_1_187_out;
output   add_1_187_out_ap_vld;
output  [127:0] add_186_out;
output   add_186_out_ap_vld;
output  [127:0] add_17185_out;
output   add_17185_out_ap_vld;
output  [127:0] add84_out;
output   add84_out_ap_vld;

reg ap_idle;
reg add_3_191_out_ap_vld;
reg add_390_out_ap_vld;
reg add_2_189_out_ap_vld;
reg add_288_out_ap_vld;
reg add_1_187_out_ap_vld;
reg add_186_out_ap_vld;
reg add_17185_out_ap_vld;
reg add84_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            add84_fu_118 <= add_ln49_fu_824_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_17185_fu_122 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_17185_fu_122 <= add_ln49_1_fu_842_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_186_fu_126 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_186_fu_126 <= add_ln49_2_fu_860_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_1_187_fu_130 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_1_187_fu_130 <= add_ln49_3_fu_878_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_288_fu_134 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_288_fu_134 <= add_ln49_4_fu_896_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_2_189_fu_138 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_2_189_fu_138 <= add_ln49_5_fu_914_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_390_fu_142 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_390_fu_142 <= add_ln49_6_fu_932_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_3_191_fu_146 <= 128'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_3_191_fu_146 <= add_ln49_7_fu_938_p2;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add84_out_ap_vld = 1'b1;
    end else begin
        add84_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_17185_out_ap_vld = 1'b1;
    end else begin
        add_17185_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_186_out_ap_vld = 1'b1;
    end else begin
        add_186_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_1_187_out_ap_vld = 1'b1;
    end else begin
        add_1_187_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_288_out_ap_vld = 1'b1;
    end else begin
        add_288_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_2_189_out_ap_vld = 1'b1;
    end else begin
        add_2_189_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_390_out_ap_vld = 1'b1;
    end else begin
        add_390_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln36_reg_1158 == 1'd1))) begin
        add_3_191_out_ap_vld = 1'b1;
    end else begin
        add_3_191_out_ap_vld = 1'b0;
    end
end
...
assign add84_out = add84_fu_118;

assign add_17185_out = add_17185_fu_122;

assign add_186_out = add_186_fu_126;

assign add_1_187_out = add_1_187_fu_130;

assign add_288_out = add_288_fu_134;

assign add_2_189_out = add_2_189_fu_138;

assign add_390_out = add_390_fu_142;

assign add_3_191_out = add_3_191_fu_146;

assign add_ln36_fu_546_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(4'd15));

assign add_ln49_1_fu_842_p2 = (and_ln49_1_fu_837_p2 + add_17185_fu_122);

assign add_ln49_2_fu_860_p2 = (and_ln49_2_fu_855_p2 + add_186_fu_126);

assign add_ln49_3_fu_878_p2 = (and_ln49_3_fu_873_p2 + add_1_187_fu_130);

assign add_ln49_4_fu_896_p2 = (and_ln49_4_fu_891_p2 + add_288_fu_134);

assign add_ln49_5_fu_914_p2 = (and_ln49_5_fu_909_p2 + add_2_189_fu_138);

assign add_ln49_6_fu_932_p2 = (and_ln49_6_fu_927_p2 + add_390_fu_142);

assign add_ln49_7_fu_938_p2 = (mul_ln49_7_reg_1265 + add_3_191_fu_146);

assign add_ln49_fu_824_p2 = (and_ln49_fu_819_p2 + add84_fu_118);
