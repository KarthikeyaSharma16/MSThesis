...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add94_688_out \
    op interface \
    ports { add94_688_out { O 64 vector } add94_688_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add94_584_out \
    op interface \
    ports { add94_584_out { O 64 vector } add94_584_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add94_480_out \
    op interface \
    ports { add94_480_out { O 64 vector } add94_480_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add94_376_out \
    op interface \
    ports { add94_376_out { O 64 vector } add94_376_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add94_272_out \
    op interface \
    ports { add94_272_out { O 64 vector } add94_272_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add94_168_out \
    op interface \
    ports { add94_168_out { O 64 vector } add94_168_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add9464_out \
    op interface \
    ports { add9464_out { O 64 vector } add9464_out_ap_vld { O 1 bit } } \
} "
}
