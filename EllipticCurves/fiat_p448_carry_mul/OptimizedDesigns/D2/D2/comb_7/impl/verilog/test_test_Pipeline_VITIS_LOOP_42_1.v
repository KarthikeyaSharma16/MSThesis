...
module test_test_Pipeline_VITIS_LOOP_42_1 (
        ...
        add44271_out_ap_vld,
        add75_4_2269_out,
        add75_4_2269_out_ap_vld,
        add75_4_1268_out,
        add75_4_1268_out_ap_vld,
        add75_4267_out,
        add75_4267_out_ap_vld,
        add75_3_2266_out,
        add75_3_2266_out_ap_vld,
        add75_3_1265_out,
        add75_3_1265_out_ap_vld,
        add75_3264_out,
        add75_3264_out_ap_vld,
        add75_2_2263_out,
        add75_2_2263_out_ap_vld,
        add75_2_1262_out,
        add75_2_1262_out_ap_vld,
        add75_2261_out,
        add75_2261_out_ap_vld,
        add75_1_2260_out,
        add75_1_2260_out_ap_vld,
        add75_1_1259_out,
        add75_1_1259_out_ap_vld,
        add75_1258_out,
        add75_1258_out_ap_vld,
        add75_2171257_out,
        add75_2171257_out_ap_vld,
        add75_1104256_out,
        add75_1104256_out_ap_vld,
        add75255_out,
        add75255_out_ap_vld
);
...
input  [31:0] conv60;
output  [63:0] add44271_out;
output   add44271_out_ap_vld;
output  [63:0] add75_4_2269_out;
output   add75_4_2269_out_ap_vld;
output  [63:0] add75_4_1268_out;
output   add75_4_1268_out_ap_vld;
output  [63:0] add75_4267_out;
output   add75_4267_out_ap_vld;
output  [63:0] add75_3_2266_out;
output   add75_3_2266_out_ap_vld;
output  [63:0] add75_3_1265_out;
output   add75_3_1265_out_ap_vld;
output  [63:0] add75_3264_out;
output   add75_3264_out_ap_vld;
output  [63:0] add75_2_2263_out;
output   add75_2_2263_out_ap_vld;
output  [63:0] add75_2_1262_out;
output   add75_2_1262_out_ap_vld;
output  [63:0] add75_2261_out;
output   add75_2261_out_ap_vld;
output  [63:0] add75_1_2260_out;
output   add75_1_2260_out_ap_vld;
output  [63:0] add75_1_1259_out;
output   add75_1_1259_out_ap_vld;
output  [63:0] add75_1258_out;
output   add75_1258_out_ap_vld;
output  [63:0] add75_2171257_out;
output   add75_2171257_out_ap_vld;
output  [63:0] add75_1104256_out;
output   add75_1104256_out_ap_vld;
output  [63:0] add75255_out;
output   add75255_out_ap_vld;

reg ap_idle;
reg add44271_out_ap_vld;
reg add75_4_2269_out_ap_vld;
reg add75_4_1268_out_ap_vld;
reg add75_4267_out_ap_vld;
reg add75_3_2266_out_ap_vld;
reg add75_3_1265_out_ap_vld;
reg add75_3264_out_ap_vld;
reg add75_2_2263_out_ap_vld;
reg add75_2_1262_out_ap_vld;
reg add75_2261_out_ap_vld;
reg add75_1_2260_out_ap_vld;
reg add75_1_1259_out_ap_vld;
reg add75_1258_out_ap_vld;
reg add75_2171257_out_ap_vld;
reg add75_1104256_out_ap_vld;
reg add75255_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add44271_out_ap_vld = 1'b1;
    end else begin
        add44271_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75255_out_ap_vld = 1'b1;
    end else begin
        add75255_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1104256_out_ap_vld = 1'b1;
    end else begin
        add75_1104256_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1258_out_ap_vld = 1'b1;
    end else begin
        add75_1258_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_1259_out_ap_vld = 1'b1;
    end else begin
        add75_1_1259_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_2260_out_ap_vld = 1'b1;
    end else begin
        add75_1_2260_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2171257_out_ap_vld = 1'b1;
    end else begin
        add75_2171257_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2261_out_ap_vld = 1'b1;
    end else begin
        add75_2261_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_1262_out_ap_vld = 1'b1;
    end else begin
        add75_2_1262_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_2263_out_ap_vld = 1'b1;
    end else begin
        add75_2_2263_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_3264_out_ap_vld = 1'b1;
    end else begin
        add75_3264_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_3_1265_out_ap_vld = 1'b1;
    end else begin
        add75_3_1265_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_3_2266_out_ap_vld = 1'b1;
    end else begin
        add75_3_2266_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_4_1268_out_ap_vld = 1'b1;
    end else begin
        add75_4_1268_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_4_2269_out_ap_vld = 1'b1;
    end else begin
        add75_4_2269_out_ap_vld = 1'b0;
    end
end
...
assign add44271_out = arr_31_fu_260;

assign add75255_out = arr_16_fu_200;

assign add75_1104256_out = arr_17_fu_204;

assign add75_1258_out = arr_19_fu_212;

assign add75_1_1259_out = arr_20_fu_216;

assign add75_1_2260_out = arr_21_fu_220;

assign add75_2171257_out = arr_18_fu_208;

assign add75_2261_out = arr_22_fu_224;

assign add75_2_1262_out = arr_23_fu_228;

assign add75_2_2263_out = arr_24_fu_232;

assign add75_3264_out = arr_25_fu_236;

assign add75_3_1265_out = arr_26_fu_240;

assign add75_3_2266_out = arr_27_fu_244;

assign add75_4267_out = arr_28_fu_248;

assign add75_4_1268_out = arr_29_fu_252;

assign add75_4_2269_out = arr_30_fu_256;
...
assign empty_36_fu_894_p2 = ($signed(zext_ln42_fu_841_p1) + $signed(5'd25));
...
assign icmp_ln61_1_fu_1284_p2 = (($signed(empty_36_fu_894_p2) > $signed(5'd6)) ? 1'b1 : 1'b0);

assign icmp_ln61_2_fu_1296_p2 = (($signed(empty_36_fu_894_p2) > $signed(5'd5)) ? 1'b1 : 1'b0);

assign icmp_ln61_3_fu_1308_p2 = (($signed(empty_36_fu_894_p2) > $signed(5'd4)) ? 1'b1 : 1'b0);

assign icmp_ln61_4_fu_1336_p2 = (($signed(tmp_38_fu_1326_p4) > $signed(3'd0)) ? 1'b1 : 1'b0);

assign icmp_ln61_5_fu_1358_p2 = (($signed(empty_36_fu_894_p2) > $signed(5'd2)) ? 1'b1 : 1'b0);
...
assign k_1_35_fu_1486_p2 = (k_s_fu_192 + 32'd1);

assign k_2_fu_1542_p3 = ((tmp_33_reg_4075[0:0] == 1'b1) ? k_1_35_fu_1486_p2 : k_s_fu_192);
...
assign tmp_36_fu_1246_p4 = {{empty_36_fu_894_p2[4:3]}};

assign tmp_37_fu_1268_p4 = {{empty_fu_882_p2[4:3]}};

assign tmp_38_fu_1326_p4 = {{empty_36_fu_894_p2[4:2]}};
...
assign tmp_40_fu_1370_p4 = {{empty_36_fu_894_p2[4:1]}};
