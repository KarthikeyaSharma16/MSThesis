...
module test_test_Pipeline_VITIS_LOOP_42_1 (
        ...
        add44269_out_ap_vld,
        add75_4_2267_out,
        add75_4_2267_out_ap_vld,
        add75_4_1266_out,
        add75_4_1266_out_ap_vld,
        add75_4265_out,
        add75_4265_out_ap_vld,
        add75_3_2264_out,
        add75_3_2264_out_ap_vld,
        add75_3_1263_out,
        add75_3_1263_out_ap_vld,
        add75_3262_out,
        add75_3262_out_ap_vld,
        add75_2_2261_out,
        add75_2_2261_out_ap_vld,
        add75_2_1260_out,
        add75_2_1260_out_ap_vld,
        add75_2259_out,
        add75_2259_out_ap_vld,
        add75_1_2258_out,
        add75_1_2258_out_ap_vld,
        add75_1_1257_out,
        add75_1_1257_out_ap_vld,
        add75_1256_out,
        add75_1256_out_ap_vld,
        add75_2169255_out,
        add75_2169255_out_ap_vld,
        add75_1102254_out,
        add75_1102254_out_ap_vld,
        add75253_out,
        add75253_out_ap_vld
);
...
input  [31:0] conv60;
output  [63:0] add44269_out;
output   add44269_out_ap_vld;
output  [63:0] add75_4_2267_out;
output   add75_4_2267_out_ap_vld;
output  [63:0] add75_4_1266_out;
output   add75_4_1266_out_ap_vld;
output  [63:0] add75_4265_out;
output   add75_4265_out_ap_vld;
output  [63:0] add75_3_2264_out;
output   add75_3_2264_out_ap_vld;
output  [63:0] add75_3_1263_out;
output   add75_3_1263_out_ap_vld;
output  [63:0] add75_3262_out;
output   add75_3262_out_ap_vld;
output  [63:0] add75_2_2261_out;
output   add75_2_2261_out_ap_vld;
output  [63:0] add75_2_1260_out;
output   add75_2_1260_out_ap_vld;
output  [63:0] add75_2259_out;
output   add75_2259_out_ap_vld;
output  [63:0] add75_1_2258_out;
output   add75_1_2258_out_ap_vld;
output  [63:0] add75_1_1257_out;
output   add75_1_1257_out_ap_vld;
output  [63:0] add75_1256_out;
output   add75_1256_out_ap_vld;
output  [63:0] add75_2169255_out;
output   add75_2169255_out_ap_vld;
output  [63:0] add75_1102254_out;
output   add75_1102254_out_ap_vld;
output  [63:0] add75253_out;
output   add75253_out_ap_vld;

reg ap_idle;
reg add44269_out_ap_vld;
reg add75_4_2267_out_ap_vld;
reg add75_4_1266_out_ap_vld;
reg add75_4265_out_ap_vld;
reg add75_3_2264_out_ap_vld;
reg add75_3_1263_out_ap_vld;
reg add75_3262_out_ap_vld;
reg add75_2_2261_out_ap_vld;
reg add75_2_1260_out_ap_vld;
reg add75_2259_out_ap_vld;
reg add75_1_2258_out_ap_vld;
reg add75_1_1257_out_ap_vld;
reg add75_1256_out_ap_vld;
reg add75_2169255_out_ap_vld;
reg add75_1102254_out_ap_vld;
reg add75253_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add44269_out_ap_vld = 1'b1;
    end else begin
        add44269_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75253_out_ap_vld = 1'b1;
    end else begin
        add75253_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1102254_out_ap_vld = 1'b1;
    end else begin
        add75_1102254_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1256_out_ap_vld = 1'b1;
    end else begin
        add75_1256_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_1257_out_ap_vld = 1'b1;
    end else begin
        add75_1_1257_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_2258_out_ap_vld = 1'b1;
    end else begin
        add75_1_2258_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2169255_out_ap_vld = 1'b1;
    end else begin
        add75_2169255_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2259_out_ap_vld = 1'b1;
    end else begin
        add75_2259_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_1260_out_ap_vld = 1'b1;
    end else begin
        add75_2_1260_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_2261_out_ap_vld = 1'b1;
    end else begin
        add75_2_2261_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_3262_out_ap_vld = 1'b1;
    end else begin
        add75_3262_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_3_1263_out_ap_vld = 1'b1;
    end else begin
        add75_3_1263_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_3_2264_out_ap_vld = 1'b1;
    end else begin
        add75_3_2264_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_4265_out_ap_vld = 1'b1;
    end else begin
        add75_4265_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_4_1266_out_ap_vld = 1'b1;
    end else begin
        add75_4_1266_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_4_2267_out_ap_vld = 1'b1;
    end else begin
        add75_4_2267_out_ap_vld = 1'b0;
    end
end
...
assign add44269_out = arr_31_fu_260;

assign add75253_out = arr_16_fu_200;

assign add75_1102254_out = arr_17_fu_204;

assign add75_1256_out = arr_19_fu_212;

assign add75_1_1257_out = arr_20_fu_216;

assign add75_1_2258_out = arr_21_fu_220;

assign add75_2169255_out = arr_18_fu_208;

assign add75_2259_out = arr_22_fu_224;

assign add75_2_1260_out = arr_23_fu_228;

assign add75_2_2261_out = arr_24_fu_232;

assign add75_3262_out = arr_25_fu_236;

assign add75_3_1263_out = arr_26_fu_240;

assign add75_3_2264_out = arr_27_fu_244;

assign add75_4265_out = arr_28_fu_248;

assign add75_4_1266_out = arr_29_fu_252;

assign add75_4_2267_out = arr_30_fu_256;
