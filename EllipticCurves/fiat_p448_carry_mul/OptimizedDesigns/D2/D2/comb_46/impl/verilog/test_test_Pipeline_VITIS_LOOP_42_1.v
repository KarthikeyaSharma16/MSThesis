...
module test_test_Pipeline_VITIS_LOOP_42_1 (
        ...
        add44475_out_ap_vld,
        add75_4_2473_out,
        add75_4_2473_out_ap_vld,
        add75_4_1472_out,
        add75_4_1472_out_ap_vld,
        add75_4471_out,
        add75_4471_out_ap_vld,
        add75_3_2470_out,
        add75_3_2470_out_ap_vld,
        add75_3_1469_out,
        add75_3_1469_out_ap_vld,
        add75_3468_out,
        add75_3468_out_ap_vld,
        add75_2_2467_out,
        add75_2_2467_out_ap_vld,
        add75_2_1466_out,
        add75_2_1466_out_ap_vld,
        add75_2465_out,
        add75_2465_out_ap_vld,
        add75_1_2464_out,
        add75_1_2464_out_ap_vld,
        add75_1_1463_out,
        add75_1_1463_out_ap_vld,
        add75_1462_out,
        add75_1462_out_ap_vld,
        add75_2375461_out,
        add75_2375461_out_ap_vld,
        add75_1308460_out,
        add75_1308460_out_ap_vld,
        add75459_out,
        add75459_out_ap_vld
);
...
input  [31:0] conv60;
output  [63:0] add44475_out;
output   add44475_out_ap_vld;
output  [63:0] add75_4_2473_out;
output   add75_4_2473_out_ap_vld;
output  [63:0] add75_4_1472_out;
output   add75_4_1472_out_ap_vld;
output  [63:0] add75_4471_out;
output   add75_4471_out_ap_vld;
output  [63:0] add75_3_2470_out;
output   add75_3_2470_out_ap_vld;
output  [63:0] add75_3_1469_out;
output   add75_3_1469_out_ap_vld;
output  [63:0] add75_3468_out;
output   add75_3468_out_ap_vld;
output  [63:0] add75_2_2467_out;
output   add75_2_2467_out_ap_vld;
output  [63:0] add75_2_1466_out;
output   add75_2_1466_out_ap_vld;
output  [63:0] add75_2465_out;
output   add75_2465_out_ap_vld;
output  [63:0] add75_1_2464_out;
output   add75_1_2464_out_ap_vld;
output  [63:0] add75_1_1463_out;
output   add75_1_1463_out_ap_vld;
output  [63:0] add75_1462_out;
output   add75_1462_out_ap_vld;
output  [63:0] add75_2375461_out;
output   add75_2375461_out_ap_vld;
output  [63:0] add75_1308460_out;
output   add75_1308460_out_ap_vld;
output  [63:0] add75459_out;
output   add75459_out_ap_vld;

reg ap_idle;
reg add44475_out_ap_vld;
reg add75_4_2473_out_ap_vld;
reg add75_4_1472_out_ap_vld;
reg add75_4471_out_ap_vld;
reg add75_3_2470_out_ap_vld;
reg add75_3_1469_out_ap_vld;
reg add75_3468_out_ap_vld;
reg add75_2_2467_out_ap_vld;
reg add75_2_1466_out_ap_vld;
reg add75_2465_out_ap_vld;
reg add75_1_2464_out_ap_vld;
reg add75_1_1463_out_ap_vld;
reg add75_1462_out_ap_vld;
reg add75_2375461_out_ap_vld;
reg add75_1308460_out_ap_vld;
reg add75459_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add44475_out_ap_vld = 1'b1;
    end else begin
        add44475_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75459_out_ap_vld = 1'b1;
    end else begin
        add75459_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1308460_out_ap_vld = 1'b1;
    end else begin
        add75_1308460_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1462_out_ap_vld = 1'b1;
    end else begin
        add75_1462_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_1463_out_ap_vld = 1'b1;
    end else begin
        add75_1_1463_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_2464_out_ap_vld = 1'b1;
    end else begin
        add75_1_2464_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2375461_out_ap_vld = 1'b1;
    end else begin
        add75_2375461_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2465_out_ap_vld = 1'b1;
    end else begin
        add75_2465_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_1466_out_ap_vld = 1'b1;
    end else begin
        add75_2_1466_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_2467_out_ap_vld = 1'b1;
    end else begin
        add75_2_2467_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_3468_out_ap_vld = 1'b1;
    end else begin
        add75_3468_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_3_1469_out_ap_vld = 1'b1;
    end else begin
        add75_3_1469_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_3_2470_out_ap_vld = 1'b1;
    end else begin
        add75_3_2470_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_4_1472_out_ap_vld = 1'b1;
    end else begin
        add75_4_1472_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_4_2473_out_ap_vld = 1'b1;
    end else begin
        add75_4_2473_out_ap_vld = 1'b0;
    end
end
...
assign add44475_out = arr_31_fu_260;

assign add75459_out = arr_16_fu_200;

assign add75_1308460_out = arr_17_fu_204;

assign add75_1462_out = arr_19_fu_212;

assign add75_1_1463_out = arr_20_fu_216;

assign add75_1_2464_out = arr_21_fu_220;

assign add75_2375461_out = arr_18_fu_208;

assign add75_2465_out = arr_22_fu_224;

assign add75_2_1466_out = arr_23_fu_228;

assign add75_2_2467_out = arr_24_fu_232;

assign add75_3468_out = arr_25_fu_236;

assign add75_3_1469_out = arr_26_fu_240;

assign add75_3_2470_out = arr_27_fu_244;

assign add75_4471_out = arr_28_fu_248;

assign add75_4_1472_out = arr_29_fu_252;

assign add75_4_2473_out = arr_30_fu_256;
...
assign empty_39_fu_894_p2 = ($signed(zext_ln42_fu_841_p1) + $signed(5'd25));
...
assign icmp_ln61_1_fu_1284_p2 = (($signed(empty_39_fu_894_p2) > $signed(5'd6)) ? 1'b1 : 1'b0);

assign icmp_ln61_2_fu_1296_p2 = (($signed(empty_39_fu_894_p2) > $signed(5'd5)) ? 1'b1 : 1'b0);

assign icmp_ln61_3_fu_1308_p2 = (($signed(empty_39_fu_894_p2) > $signed(5'd4)) ? 1'b1 : 1'b0);

assign icmp_ln61_4_fu_1336_p2 = (($signed(tmp_38_fu_1326_p4) > $signed(3'd0)) ? 1'b1 : 1'b0);

assign icmp_ln61_5_fu_1358_p2 = (($signed(empty_39_fu_894_p2) > $signed(5'd2)) ? 1'b1 : 1'b0);
...
assign k_1_38_fu_1486_p2 = (k_s_fu_192 + 32'd1);

assign k_2_fu_1542_p3 = ((tmp_33_reg_4075[0:0] == 1'b1) ? k_1_38_fu_1486_p2 : k_s_fu_192);
...
assign tmp_36_fu_1246_p4 = {{empty_39_fu_894_p2[4:3]}};

assign tmp_37_fu_1268_p4 = {{empty_fu_882_p2[4:3]}};

assign tmp_38_fu_1326_p4 = {{empty_39_fu_894_p2[4:2]}};
...
assign tmp_40_fu_1370_p4 = {{empty_39_fu_894_p2[4:1]}};
