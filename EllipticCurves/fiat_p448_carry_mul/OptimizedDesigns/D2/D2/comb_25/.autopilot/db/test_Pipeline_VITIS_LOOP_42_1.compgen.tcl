...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add4473_out \
    op interface \
    ports { add4473_out { O 64 vector } add4473_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_1471_out \
    op interface \
    ports { add75_1471_out { O 64 vector } add75_1471_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_1370_out \
    op interface \
    ports { add75_1370_out { O 64 vector } add75_1370_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_1269_out \
    op interface \
    ports { add75_1269_out { O 64 vector } add75_1269_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_1168_out \
    op interface \
    ports { add75_1168_out { O 64 vector } add75_1168_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_1067_out \
    op interface \
    ports { add75_1067_out { O 64 vector } add75_1067_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_966_out \
    op interface \
    ports { add75_966_out { O 64 vector } add75_966_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_865_out \
    op interface \
    ports { add75_865_out { O 64 vector } add75_865_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_764_out \
    op interface \
    ports { add75_764_out { O 64 vector } add75_764_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_663_out \
    op interface \
    ports { add75_663_out { O 64 vector } add75_663_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_562_out \
    op interface \
    ports { add75_562_out { O 64 vector } add75_562_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_461_out \
    op interface \
    ports { add75_461_out { O 64 vector } add75_461_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_360_out \
    op interface \
    ports { add75_360_out { O 64 vector } add75_360_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_259_out \
    op interface \
    ports { add75_259_out { O 64 vector } add75_259_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add75_158_out \
    op interface \
    ports { add75_158_out { O 64 vector } add75_158_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add7557_out \
    op interface \
    ports { add7557_out { O 64 vector } add7557_out_ap_vld { O 1 bit } } \
} "
}
