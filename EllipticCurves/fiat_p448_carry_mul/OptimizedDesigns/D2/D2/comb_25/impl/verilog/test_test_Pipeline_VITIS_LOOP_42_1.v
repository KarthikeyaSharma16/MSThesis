...
module test_test_Pipeline_VITIS_LOOP_42_1 (
        ...
        add4473_out_ap_vld,
        add75_1471_out,
        add75_1471_out_ap_vld,
        add75_1370_out,
        add75_1370_out_ap_vld,
        add75_1269_out,
        add75_1269_out_ap_vld,
        add75_1168_out,
        add75_1168_out_ap_vld,
        add75_1067_out,
        add75_1067_out_ap_vld,
        add75_966_out,
        add75_966_out_ap_vld,
        add75_865_out,
        add75_865_out_ap_vld,
        add75_764_out,
        add75_764_out_ap_vld,
        add75_663_out,
        add75_663_out_ap_vld,
        add75_562_out,
        add75_562_out_ap_vld,
        add75_461_out,
        add75_461_out_ap_vld,
        add75_360_out,
        add75_360_out_ap_vld,
        add75_259_out,
        add75_259_out_ap_vld,
        add75_158_out,
        add75_158_out_ap_vld,
        add7557_out,
        add7557_out_ap_vld
);
...
input  [31:0] conv60;
output  [63:0] add4473_out;
output   add4473_out_ap_vld;
output  [63:0] add75_1471_out;
output   add75_1471_out_ap_vld;
output  [63:0] add75_1370_out;
output   add75_1370_out_ap_vld;
output  [63:0] add75_1269_out;
output   add75_1269_out_ap_vld;
output  [63:0] add75_1168_out;
output   add75_1168_out_ap_vld;
output  [63:0] add75_1067_out;
output   add75_1067_out_ap_vld;
output  [63:0] add75_966_out;
output   add75_966_out_ap_vld;
output  [63:0] add75_865_out;
output   add75_865_out_ap_vld;
output  [63:0] add75_764_out;
output   add75_764_out_ap_vld;
output  [63:0] add75_663_out;
output   add75_663_out_ap_vld;
output  [63:0] add75_562_out;
output   add75_562_out_ap_vld;
output  [63:0] add75_461_out;
output   add75_461_out_ap_vld;
output  [63:0] add75_360_out;
output   add75_360_out_ap_vld;
output  [63:0] add75_259_out;
output   add75_259_out_ap_vld;
output  [63:0] add75_158_out;
output   add75_158_out_ap_vld;
output  [63:0] add7557_out;
output   add7557_out_ap_vld;

reg ap_idle;
reg add4473_out_ap_vld;
reg add75_1471_out_ap_vld;
reg add75_1370_out_ap_vld;
reg add75_1269_out_ap_vld;
reg add75_1168_out_ap_vld;
reg add75_1067_out_ap_vld;
reg add75_966_out_ap_vld;
reg add75_865_out_ap_vld;
reg add75_764_out_ap_vld;
reg add75_663_out_ap_vld;
reg add75_562_out_ap_vld;
reg add75_461_out_ap_vld;
reg add75_360_out_ap_vld;
reg add75_259_out_ap_vld;
reg add75_158_out_ap_vld;
reg add7557_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add4473_out_ap_vld = 1'b1;
    end else begin
        add4473_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add7557_out_ap_vld = 1'b1;
    end else begin
        add7557_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1067_out_ap_vld = 1'b1;
    end else begin
        add75_1067_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1168_out_ap_vld = 1'b1;
    end else begin
        add75_1168_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1269_out_ap_vld = 1'b1;
    end else begin
        add75_1269_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1370_out_ap_vld = 1'b1;
    end else begin
        add75_1370_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1471_out_ap_vld = 1'b1;
    end else begin
        add75_1471_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_158_out_ap_vld = 1'b1;
    end else begin
        add75_158_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_259_out_ap_vld = 1'b1;
    end else begin
        add75_259_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_360_out_ap_vld = 1'b1;
    end else begin
        add75_360_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_461_out_ap_vld = 1'b1;
    end else begin
        add75_461_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_562_out_ap_vld = 1'b1;
    end else begin
        add75_562_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_663_out_ap_vld = 1'b1;
    end else begin
        add75_663_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_764_out_ap_vld = 1'b1;
    end else begin
        add75_764_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_865_out_ap_vld = 1'b1;
    end else begin
        add75_865_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_966_out_ap_vld = 1'b1;
    end else begin
        add75_966_out_ap_vld = 1'b0;
    end
end
...
assign add4473_out = arr_31_fu_260;

assign add7557_out = arr_16_fu_200;

assign add75_1067_out = arr_26_fu_240;

assign add75_1168_out = arr_27_fu_244;

assign add75_1269_out = arr_28_fu_248;

assign add75_1370_out = arr_29_fu_252;

assign add75_1471_out = arr_30_fu_256;

assign add75_158_out = arr_17_fu_204;

assign add75_259_out = arr_18_fu_208;

assign add75_360_out = arr_19_fu_212;

assign add75_461_out = arr_20_fu_216;

assign add75_562_out = arr_21_fu_220;

assign add75_663_out = arr_22_fu_224;

assign add75_764_out = arr_23_fu_228;

assign add75_865_out = arr_24_fu_232;

assign add75_966_out = arr_25_fu_236;
