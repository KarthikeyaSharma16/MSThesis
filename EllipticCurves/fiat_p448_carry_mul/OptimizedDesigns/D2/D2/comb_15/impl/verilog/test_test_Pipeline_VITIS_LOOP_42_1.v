...
module test_test_Pipeline_VITIS_LOOP_42_1 (
        ...
        add44233_out_ap_vld,
        add75_2_4231_out,
        add75_2_4231_out_ap_vld,
        add75_2_3230_out,
        add75_2_3230_out_ap_vld,
        add75_2_2229_out,
        add75_2_2229_out_ap_vld,
        add75_2_1228_out,
        add75_2_1228_out_ap_vld,
        add75_2227_out,
        add75_2227_out_ap_vld,
        add75_1_4226_out,
        add75_1_4226_out_ap_vld,
        add75_1_3225_out,
        add75_1_3225_out_ap_vld,
        add75_1_2224_out,
        add75_1_2224_out_ap_vld,
        add75_1_1223_out,
        add75_1_1223_out_ap_vld,
        add75_1222_out,
        add75_1222_out_ap_vld,
        add75_4221_out,
        add75_4221_out_ap_vld,
        add75_3220_out,
        add75_3220_out_ap_vld,
        add75_2138219_out,
        add75_2138219_out_ap_vld,
        add75_171218_out,
        add75_171218_out_ap_vld,
        add75217_out,
        add75217_out_ap_vld
);
...
input  [31:0] conv60;
output  [63:0] add44233_out;
output   add44233_out_ap_vld;
output  [63:0] add75_2_4231_out;
output   add75_2_4231_out_ap_vld;
output  [63:0] add75_2_3230_out;
output   add75_2_3230_out_ap_vld;
output  [63:0] add75_2_2229_out;
output   add75_2_2229_out_ap_vld;
output  [63:0] add75_2_1228_out;
output   add75_2_1228_out_ap_vld;
output  [63:0] add75_2227_out;
output   add75_2227_out_ap_vld;
output  [63:0] add75_1_4226_out;
output   add75_1_4226_out_ap_vld;
output  [63:0] add75_1_3225_out;
output   add75_1_3225_out_ap_vld;
output  [63:0] add75_1_2224_out;
output   add75_1_2224_out_ap_vld;
output  [63:0] add75_1_1223_out;
output   add75_1_1223_out_ap_vld;
output  [63:0] add75_1222_out;
output   add75_1222_out_ap_vld;
output  [63:0] add75_4221_out;
output   add75_4221_out_ap_vld;
output  [63:0] add75_3220_out;
output   add75_3220_out_ap_vld;
output  [63:0] add75_2138219_out;
output   add75_2138219_out_ap_vld;
output  [63:0] add75_171218_out;
output   add75_171218_out_ap_vld;
output  [63:0] add75217_out;
output   add75217_out_ap_vld;

reg ap_idle;
reg add44233_out_ap_vld;
reg add75_2_4231_out_ap_vld;
reg add75_2_3230_out_ap_vld;
reg add75_2_2229_out_ap_vld;
reg add75_2_1228_out_ap_vld;
reg add75_2227_out_ap_vld;
reg add75_1_4226_out_ap_vld;
reg add75_1_3225_out_ap_vld;
reg add75_1_2224_out_ap_vld;
reg add75_1_1223_out_ap_vld;
reg add75_1222_out_ap_vld;
reg add75_4221_out_ap_vld;
reg add75_3220_out_ap_vld;
reg add75_2138219_out_ap_vld;
reg add75_171218_out_ap_vld;
reg add75217_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add44233_out_ap_vld = 1'b1;
    end else begin
        add44233_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75217_out_ap_vld = 1'b1;
    end else begin
        add75217_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1222_out_ap_vld = 1'b1;
    end else begin
        add75_1222_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_171218_out_ap_vld = 1'b1;
    end else begin
        add75_171218_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_1223_out_ap_vld = 1'b1;
    end else begin
        add75_1_1223_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_2224_out_ap_vld = 1'b1;
    end else begin
        add75_1_2224_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_3225_out_ap_vld = 1'b1;
    end else begin
        add75_1_3225_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_4226_out_ap_vld = 1'b1;
    end else begin
        add75_1_4226_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2138219_out_ap_vld = 1'b1;
    end else begin
        add75_2138219_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2227_out_ap_vld = 1'b1;
    end else begin
        add75_2227_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_1228_out_ap_vld = 1'b1;
    end else begin
        add75_2_1228_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_2229_out_ap_vld = 1'b1;
    end else begin
        add75_2_2229_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_3230_out_ap_vld = 1'b1;
    end else begin
        add75_2_3230_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_4231_out_ap_vld = 1'b1;
    end else begin
        add75_2_4231_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_3220_out_ap_vld = 1'b1;
    end else begin
        add75_3220_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_4221_out_ap_vld = 1'b1;
    end else begin
        add75_4221_out_ap_vld = 1'b0;
    end
end
...
assign add44233_out = arr_31_fu_260;

assign add75217_out = arr_16_fu_200;

assign add75_1222_out = arr_21_fu_220;

assign add75_171218_out = arr_17_fu_204;

assign add75_1_1223_out = arr_22_fu_224;

assign add75_1_2224_out = arr_23_fu_228;

assign add75_1_3225_out = arr_24_fu_232;

assign add75_1_4226_out = arr_25_fu_236;

assign add75_2138219_out = arr_18_fu_208;

assign add75_2227_out = arr_26_fu_240;

assign add75_2_1228_out = arr_27_fu_244;

assign add75_2_2229_out = arr_28_fu_248;

assign add75_2_3230_out = arr_29_fu_252;

assign add75_2_4231_out = arr_30_fu_256;

assign add75_3220_out = arr_19_fu_212;

assign add75_4221_out = arr_20_fu_216;
