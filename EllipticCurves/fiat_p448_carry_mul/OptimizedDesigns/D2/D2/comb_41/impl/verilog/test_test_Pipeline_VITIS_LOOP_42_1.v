...
module test_test_Pipeline_VITIS_LOOP_42_1 (
        ...
        add44234_out_ap_vld,
        add75_2_4232_out,
        add75_2_4232_out_ap_vld,
        add75_2_3231_out,
        add75_2_3231_out_ap_vld,
        add75_2_2230_out,
        add75_2_2230_out_ap_vld,
        add75_2_1229_out,
        add75_2_1229_out_ap_vld,
        add75_2228_out,
        add75_2228_out_ap_vld,
        add75_1_4227_out,
        add75_1_4227_out_ap_vld,
        add75_1_3226_out,
        add75_1_3226_out_ap_vld,
        add75_1_2225_out,
        add75_1_2225_out_ap_vld,
        add75_1_1224_out,
        add75_1_1224_out_ap_vld,
        add75_1223_out,
        add75_1223_out_ap_vld,
        add75_4222_out,
        add75_4222_out_ap_vld,
        add75_3221_out,
        add75_3221_out_ap_vld,
        add75_2139220_out,
        add75_2139220_out_ap_vld,
        add75_172219_out,
        add75_172219_out_ap_vld,
        add75218_out,
        add75218_out_ap_vld
);
...
input  [31:0] conv60;
output  [63:0] add44234_out;
output   add44234_out_ap_vld;
output  [63:0] add75_2_4232_out;
output   add75_2_4232_out_ap_vld;
output  [63:0] add75_2_3231_out;
output   add75_2_3231_out_ap_vld;
output  [63:0] add75_2_2230_out;
output   add75_2_2230_out_ap_vld;
output  [63:0] add75_2_1229_out;
output   add75_2_1229_out_ap_vld;
output  [63:0] add75_2228_out;
output   add75_2228_out_ap_vld;
output  [63:0] add75_1_4227_out;
output   add75_1_4227_out_ap_vld;
output  [63:0] add75_1_3226_out;
output   add75_1_3226_out_ap_vld;
output  [63:0] add75_1_2225_out;
output   add75_1_2225_out_ap_vld;
output  [63:0] add75_1_1224_out;
output   add75_1_1224_out_ap_vld;
output  [63:0] add75_1223_out;
output   add75_1223_out_ap_vld;
output  [63:0] add75_4222_out;
output   add75_4222_out_ap_vld;
output  [63:0] add75_3221_out;
output   add75_3221_out_ap_vld;
output  [63:0] add75_2139220_out;
output   add75_2139220_out_ap_vld;
output  [63:0] add75_172219_out;
output   add75_172219_out_ap_vld;
output  [63:0] add75218_out;
output   add75218_out_ap_vld;

reg ap_idle;
reg add44234_out_ap_vld;
reg add75_2_4232_out_ap_vld;
reg add75_2_3231_out_ap_vld;
reg add75_2_2230_out_ap_vld;
reg add75_2_1229_out_ap_vld;
reg add75_2228_out_ap_vld;
reg add75_1_4227_out_ap_vld;
reg add75_1_3226_out_ap_vld;
reg add75_1_2225_out_ap_vld;
reg add75_1_1224_out_ap_vld;
reg add75_1223_out_ap_vld;
reg add75_4222_out_ap_vld;
reg add75_3221_out_ap_vld;
reg add75_2139220_out_ap_vld;
reg add75_172219_out_ap_vld;
reg add75218_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add44234_out_ap_vld = 1'b1;
    end else begin
        add44234_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75218_out_ap_vld = 1'b1;
    end else begin
        add75218_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1223_out_ap_vld = 1'b1;
    end else begin
        add75_1223_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_172219_out_ap_vld = 1'b1;
    end else begin
        add75_172219_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_1224_out_ap_vld = 1'b1;
    end else begin
        add75_1_1224_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_2225_out_ap_vld = 1'b1;
    end else begin
        add75_1_2225_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_3226_out_ap_vld = 1'b1;
    end else begin
        add75_1_3226_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_1_4227_out_ap_vld = 1'b1;
    end else begin
        add75_1_4227_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2139220_out_ap_vld = 1'b1;
    end else begin
        add75_2139220_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2228_out_ap_vld = 1'b1;
    end else begin
        add75_2228_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_1229_out_ap_vld = 1'b1;
    end else begin
        add75_2_1229_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_2230_out_ap_vld = 1'b1;
    end else begin
        add75_2_2230_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_3231_out_ap_vld = 1'b1;
    end else begin
        add75_2_3231_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_2_4232_out_ap_vld = 1'b1;
    end else begin
        add75_2_4232_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_3221_out_ap_vld = 1'b1;
    end else begin
        add75_3221_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln42_reg_4071 == 1'd1))) begin
        add75_4222_out_ap_vld = 1'b1;
    end else begin
        add75_4222_out_ap_vld = 1'b0;
    end
end
...
assign add44234_out = arr_31_fu_260;

assign add75218_out = arr_16_fu_200;

assign add75_1223_out = arr_21_fu_220;

assign add75_172219_out = arr_17_fu_204;

assign add75_1_1224_out = arr_22_fu_224;

assign add75_1_2225_out = arr_23_fu_228;

assign add75_1_3226_out = arr_24_fu_232;

assign add75_1_4227_out = arr_25_fu_236;

assign add75_2139220_out = arr_18_fu_208;

assign add75_2228_out = arr_26_fu_240;

assign add75_2_1229_out = arr_27_fu_244;

assign add75_2_2230_out = arr_28_fu_248;

assign add75_2_3231_out = arr_29_fu_252;

assign add75_2_4232_out = arr_30_fu_256;

assign add75_3221_out = arr_19_fu_212;

assign add75_4222_out = arr_20_fu_216;
