...
__attribute__((sdx_kernel("test", 0))) void test(uint32_t out1[16], uint32_t arg1[16], uint32_t arg2[16])
{
#line 15 "/export/hdd/scratch/km304/MSThesis/EllipticCurves/fiat_p448_carry_mul/OptimizedDesigns/D2/run_script.tcl"
#pragma HLSDIRECTIVE TOP name=test
# 4 "d2.cpp"

#line 19 "/export/hdd/scratch/km304/MSThesis/EllipticCurves/fiat_p448_carry_mul/OptimizedDesigns/D2/run_script.tcl"
#pragma HLSDIRECTIVE TOP name=test
# 4 "d2.cpp"
...
#pragma HLS PIPELINE II = 1
 VITIS_LOOP_45_2: for (int i1 = 0; i1 < 15; i1++)
    {
#pragma HLS UNROLL
 k2 = 7 + (k++);
        k3 = 15;
        ...
        VITIS_LOOP_53_3: for(int j =15; j>0; j-=15)
        {
#pragma HLS PIPELINE II = 1
 VITIS_LOOP_56_4: for (int j1 = 0; j1 < 15; j1++)
            {
#pragma HLS UNROLL
 arr[j-j1] += ((uint64_t)(arg1_r[i-i1]) * (arg2_r[k5])) * (j-j1 > 8 && j-j1 < i-i1 + 1 && i-i1 > 8);
  ...
  VITIS_LOOP_73_5: for(int i = 14; i>8; i-=3)
 {
#pragma HLS PIPELINE II = 1
 VITIS_LOOP_76_6: for (int i1 = 0; i1 < 3; i1++)
        {
#pragma HLS UNROLL
 k = 15;
            VITIS_LOOP_80_7: for(int j =15; j>0; j-=1)
            {
#pragma HLS PIPELINE II = 1
 VITIS_LOOP_83_8: for (int j1 = 0; j1 < 1; j1++)
                {
#pragma HLS UNROLL
