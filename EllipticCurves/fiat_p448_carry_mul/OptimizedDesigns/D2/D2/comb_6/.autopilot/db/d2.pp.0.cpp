...
#pragma HLS ARRAY_PARTITION variable=arr type=complete
 ...
 for (int i = 0; i < 16; i++)
 {
  ...
  VITIS_LOOP_42_1: for(int i = 15; i>0; i-=1)
  {
#pragma HLS PIPELINE II = 1
 VITIS_LOOP_45_2: for (int i1 = 0; i1 < 1; i1++)
    {
#pragma HLS UNROLL
 k2 = 7 + (k++);
        k3 = 15;
        ...
        VITIS_LOOP_53_3: for(int j =15; j>0; j-=3)
        {
#pragma HLS PIPELINE II = 1
 VITIS_LOOP_56_4: for (int j1 = 0; j1 < 3; j1++)
            {
#pragma HLS UNROLL
 arr[j-j1] += ((uint64_t)(arg1_r[i-i1]) * (arg2_r[k5])) * (j-j1 > 8 && j-j1 < i-i1 + 1 && i-i1 > 8);
  ...
  VITIS_LOOP_73_5: for(int i = 14; i>8; i-=1)
 {
#pragma HLS PIPELINE II = 1
 VITIS_LOOP_76_6: for (int i1 = 0; i1 < 1; i1++)
        {
#pragma HLS UNROLL
 k = 15;
