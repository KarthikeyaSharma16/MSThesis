...
#define XTEST_CONTROL_ADDR_OUT1_DATA 0x10
#define XTEST_CONTROL_BITS_OUT1_DATA 64
#define XTEST_CONTROL_ADDR_ARG1_DATA 0x1c
#define XTEST_CONTROL_BITS_ARG1_DATA 64
#define XTEST_CONTROL_ADDR_ARG2_DATA 0x28
#define XTEST_CONTROL_BITS_ARG2_DATA 64
