...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        arg2_r_10_reload,
        add289_2_1360_out,
        add289_2_1360_out_ap_vld,
        add289_2359_out,
        add289_2359_out_ap_vld,
        add289_1_1358_out,
        add289_1_1358_out_ap_vld,
        add289_1357_out,
        add289_1357_out_ap_vld,
        add289_175356_out,
        add289_175356_out_ap_vld,
        add289355_out,
        add289355_out_ap_vld
);
...
output  [63:0] add289_2_1360_out;
output   add289_2_1360_out_ap_vld;
output  [63:0] add289_2359_out;
output   add289_2359_out_ap_vld;
output  [63:0] add289_1_1358_out;
output   add289_1_1358_out_ap_vld;
output  [63:0] add289_1357_out;
output   add289_1357_out_ap_vld;
output  [63:0] add289_175356_out;
output   add289_175356_out_ap_vld;
output  [63:0] add289355_out;
output   add289355_out_ap_vld;

reg ap_idle;
reg add289_2_1360_out_ap_vld;
reg add289_2359_out_ap_vld;
reg add289_1_1358_out_ap_vld;
reg add289_1357_out_ap_vld;
reg add289_175356_out_ap_vld;
reg add289355_out_ap_vld;
...
wire   [31:0] tmp_61_fu_366_p9;
reg   [31:0] tmp_61_reg_932;
wire   [0:0] icmp_ln143_fu_386_p2;
reg   [0:0] icmp_ln143_reg_937;
wire   [0:0] icmp_ln143_1_fu_400_p2;
reg   [0:0] icmp_ln143_1_reg_943;
wire  signed [2:0] sub_ln35_41_fu_410_p2;
reg  signed [2:0] sub_ln35_41_reg_948;
...
reg   [63:0] add289355_fu_100;
wire   [63:0] add_ln143_fu_495_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add289_175356_fu_104;
wire   [63:0] add_ln143_1_fu_524_p2;
reg   [63:0] add289_1357_fu_108;
wire   [63:0] add_ln143_2_fu_586_p2;
reg   [63:0] add289_1_1358_fu_112;
wire   [63:0] add_ln143_3_fu_647_p2;
reg   [63:0] add289_2359_fu_116;
wire   [63:0] add_ln143_4_fu_713_p2;
reg   [63:0] add289_2_1360_fu_120;
...
always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289355_out_ap_vld = 1'b1;
    end else begin
        add289355_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1357_out_ap_vld = 1'b1;
    end else begin
        add289_1357_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_175356_out_ap_vld = 1'b1;
    end else begin
        add289_175356_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1_1358_out_ap_vld = 1'b1;
    end else begin
        add289_1_1358_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2359_out_ap_vld = 1'b1;
    end else begin
        add289_2359_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2_1360_out_ap_vld = 1'b1;
    end else begin
        add289_2_1360_out_ap_vld = 1'b0;
    end
end
...
assign add289355_out = add289355_fu_100;

assign add289_1357_out = add289_1357_fu_108;

assign add289_175356_out = add289_175356_fu_104;

assign add289_1_1358_out = add289_1_1358_fu_112;

assign add289_2359_out = add289_2359_fu_116;

assign add289_2_1360_out = add289_2_1360_fu_120;

assign add_ln130_fu_444_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(3'd7));

assign add_ln143_1_fu_524_p2 = (and_ln143_1_fu_518_p2 + add289_175356_fu_104);

assign add_ln143_2_fu_586_p2 = (and_ln143_2_fu_580_p2 + add289_1357_fu_108);

assign add_ln143_3_fu_647_p2 = (and_ln143_3_fu_641_p2 + add289_1_1358_fu_112);

assign add_ln143_4_fu_713_p2 = (and_ln143_4_fu_707_p2 + add289_2359_fu_116);

assign add_ln143_5_fu_765_p2 = (mul_ln143_5_fu_304_p2 + add289_2_1360_fu_120);

assign add_ln143_fu_495_p2 = (and_ln143_fu_489_p2 + add289355_fu_100);
...
assign sub_ln35_15_fu_426_p2 = ($signed(sub_ln35_41_fu_410_p2) - $signed(zext_ln35_10_fu_422_p1));

assign sub_ln35_16_fu_656_p2 = ($signed(sext_ln143_1_fu_592_p1) - $signed(zext_ln144_fu_653_p1));

assign sub_ln35_41_fu_410_p2 = (select_ln143_2_fu_392_p3 - zext_ln35_fu_406_p1);

assign tmp_62_fu_533_p17 = sub_ln35_41_reg_948;

assign tmp_s_fu_728_p17 = (sub_ln35_16_fu_656_p2 - zext_ln144_1_fu_719_p1);

assign zext_ln130_fu_356_p1 = ap_sig_allocacmp_i_2;

assign zext_ln143_fu_473_p1 = tmp_61_reg_932;
