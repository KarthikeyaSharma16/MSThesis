...
output  [63:0] add_6320_out;
output   add_6320_out_ap_vld;
output  [63:0] add_5319_out;
output   add_5319_out_ap_vld;
output  [63:0] add_4318_out;
output   add_4318_out_ap_vld;
output  [63:0] add_3317_out;
output   add_3317_out_ap_vld;
output  [63:0] add_2316_out;
output   add_2316_out_ap_vld;
output  [63:0] add_1315_out;
output   add_1315_out_ap_vld;
output  [63:0] add314_out;
output   add314_out_ap_vld;

reg ap_idle;
reg add_6320_out_ap_vld;
reg add_5319_out_ap_vld;
reg add_4318_out_ap_vld;
reg add_3317_out_ap_vld;
reg add_2316_out_ap_vld;
reg add_1315_out_ap_vld;
reg add314_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add314_out_ap_vld = 1'b1;
    end else begin
        add314_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1315_out_ap_vld = 1'b1;
    end else begin
        add_1315_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2316_out_ap_vld = 1'b1;
    end else begin
        add_2316_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3317_out_ap_vld = 1'b1;
    end else begin
        add_3317_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_4318_out_ap_vld = 1'b1;
    end else begin
        add_4318_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_5319_out_ap_vld = 1'b1;
    end else begin
        add_5319_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6320_out_ap_vld = 1'b1;
    end else begin
        add_6320_out_ap_vld = 1'b0;
    end
end
...
assign add314_out = arr_71_fu_100;

assign add_1315_out = arr_72_fu_104;

assign add_2316_out = arr_73_fu_108;

assign add_3317_out = arr_74_fu_112;

assign add_4318_out = arr_75_fu_116;

assign add_5319_out = arr_76_fu_120;

assign add_6320_out = arr_77_fu_124;
