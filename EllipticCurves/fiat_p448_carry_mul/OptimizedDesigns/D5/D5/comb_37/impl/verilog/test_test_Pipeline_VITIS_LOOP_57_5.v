...
module test_test_Pipeline_VITIS_LOOP_57_5 (
        ...
        arg2_r_9_reload,
        add102_6313_out,
        add102_6313_out_ap_vld,
        add102_5312_out,
        add102_5312_out_ap_vld,
        add102_4311_out,
        add102_4311_out_ap_vld,
        add102_3310_out,
        add102_3310_out_ap_vld,
        add102_2309_out,
        add102_2309_out_ap_vld,
        add102_1308_out,
        add102_1308_out_ap_vld,
        add102307_out,
        add102307_out_ap_vld
);
...
output  [63:0] add102_6313_out;
output   add102_6313_out_ap_vld;
output  [63:0] add102_5312_out;
output   add102_5312_out_ap_vld;
output  [63:0] add102_4311_out;
output   add102_4311_out_ap_vld;
output  [63:0] add102_3310_out;
output   add102_3310_out_ap_vld;
output  [63:0] add102_2309_out;
output   add102_2309_out_ap_vld;
output  [63:0] add102_1308_out;
output   add102_1308_out_ap_vld;
output  [63:0] add102307_out;
output   add102307_out_ap_vld;

reg ap_idle;
reg add102_6313_out_ap_vld;
reg add102_5312_out_ap_vld;
reg add102_4311_out_ap_vld;
reg add102_3310_out_ap_vld;
reg add102_2309_out_ap_vld;
reg add102_1308_out_ap_vld;
reg add102307_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102307_out_ap_vld = 1'b1;
    end else begin
        add102307_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_1308_out_ap_vld = 1'b1;
    end else begin
        add102_1308_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_2309_out_ap_vld = 1'b1;
    end else begin
        add102_2309_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_3310_out_ap_vld = 1'b1;
    end else begin
        add102_3310_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_4311_out_ap_vld = 1'b1;
    end else begin
        add102_4311_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_5312_out_ap_vld = 1'b1;
    end else begin
        add102_5312_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_6313_out_ap_vld = 1'b1;
    end else begin
        add102_6313_out_ap_vld = 1'b0;
    end
end
...
assign add102307_out = arr_fu_96;

assign add102_1308_out = arr_58_fu_100;

assign add102_2309_out = arr_59_fu_104;

assign add102_3310_out = arr_60_fu_108;

assign add102_4311_out = arr_61_fu_112;

assign add102_5312_out = arr_62_fu_116;

assign add102_6313_out = arr_63_fu_120;
