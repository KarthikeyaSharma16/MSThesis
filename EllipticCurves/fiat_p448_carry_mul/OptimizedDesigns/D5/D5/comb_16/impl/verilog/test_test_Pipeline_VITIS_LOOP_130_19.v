...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        add212_4237_reload,
        add212_3236_reload,
        add212_2111235_reload,
        add212_1102234_reload,
        arg1_r_2_reload,
        arg1_r_4_reload,
        arg1_r_6_reload,
        conv36,
        ...
        arg1_r_5_reload,
        add289_2_1231_out,
        add289_2_1231_out_ap_vld,
        add289_2230_out,
        add289_2230_out_ap_vld,
        add289_175_1229_out,
        add289_175_1229_out_ap_vld,
        add289_175228_out,
        add289_175228_out_ap_vld,
        add289_190227_out,
        add289_190227_out_ap_vld,
        add289226_out,
        add289226_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add212_6239_reload;
input  [63:0] add212_5238_reload;
input  [63:0] add212_4237_reload;
input  [63:0] add212_3236_reload;
input  [63:0] add212_2111235_reload;
input  [63:0] add212_1102234_reload;
...
output  [63:0] add289_2_1231_out;
output   add289_2_1231_out_ap_vld;
output  [63:0] add289_2230_out;
output   add289_2230_out_ap_vld;
output  [63:0] add289_175_1229_out;
output   add289_175_1229_out_ap_vld;
output  [63:0] add289_175228_out;
output   add289_175228_out_ap_vld;
output  [63:0] add289_190227_out;
output   add289_190227_out_ap_vld;
output  [63:0] add289226_out;
output   add289226_out_ap_vld;

reg ap_idle;
reg add289_2_1231_out_ap_vld;
reg add289_2230_out_ap_vld;
reg add289_175_1229_out_ap_vld;
reg add289_175228_out_ap_vld;
reg add289_190227_out_ap_vld;
reg add289226_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289226_out_ap_vld = 1'b1;
    end else begin
        add289226_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_175228_out_ap_vld = 1'b1;
    end else begin
        add289_175228_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_175_1229_out_ap_vld = 1'b1;
    end else begin
        add289_175_1229_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_190227_out_ap_vld = 1'b1;
    end else begin
        add289_190227_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2230_out_ap_vld = 1'b1;
    end else begin
        add289_2230_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2_1231_out_ap_vld = 1'b1;
    end else begin
        add289_2_1231_out_ap_vld = 1'b0;
    end
end
...
assign add289226_out = arr_fu_106;

assign add289_175228_out = arr_77_fu_114;

assign add289_175_1229_out = arr_78_fu_118;

assign add289_190227_out = arr_76_fu_110;

assign add289_2230_out = arr_79_fu_122;

assign add289_2_1231_out = arr_80_fu_126;
...
assign icmp_ln143_4_fu_468_p2 = ((tmp_33_fu_440_p3 == 4'd14) ? 1'b1 : 1'b0);

assign icmp_ln143_5_fu_474_p2 = ((tmp_33_fu_440_p3 > 4'd12) ? 1'b1 : 1'b0);

assign icmp_ln143_6_fu_480_p2 = ((tmp_33_fu_440_p3 > 4'd11) ? 1'b1 : 1'b0);

assign icmp_ln143_7_fu_486_p2 = ((tmp_33_fu_440_p3 > 4'd10) ? 1'b1 : 1'b0);
...
assign mul_ln143_3_fu_302_p00 = tmp_29_fu_579_p18;
...
assign mul_ln143_5_fu_310_p00 = tmp_30_fu_632_p18;
...
assign mul_ln143_7_fu_318_p00 = tmp_31_fu_680_p18;
...
assign mul_ln143_9_fu_326_p00 = tmp_32_fu_718_p18;
...
assign tmp_29_fu_579_p17 = sub_ln35_6_fu_569_p2;

assign tmp_33_fu_440_p3 = {{1'd1}, {ap_sig_allocacmp_i_4}};

assign tmp_35_fu_870_p17 = sub_ln35_9_fu_860_p2;
...
assign zext_ln143_fu_521_p1 = tmp_28_reg_1259;
