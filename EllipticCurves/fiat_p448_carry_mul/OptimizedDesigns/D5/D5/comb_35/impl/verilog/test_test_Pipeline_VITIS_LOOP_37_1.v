...
output  [63:0] add_6366_out;
output   add_6366_out_ap_vld;
output  [63:0] add_5365_out;
output   add_5365_out_ap_vld;
output  [63:0] add_4364_out;
output   add_4364_out_ap_vld;
output  [63:0] add_3363_out;
output   add_3363_out_ap_vld;
output  [63:0] add_2362_out;
output   add_2362_out_ap_vld;
output  [63:0] add_1361_out;
output   add_1361_out_ap_vld;
output  [63:0] add360_out;
output   add360_out_ap_vld;

reg ap_idle;
reg add_6366_out_ap_vld;
reg add_5365_out_ap_vld;
reg add_4364_out_ap_vld;
reg add_3363_out_ap_vld;
reg add_2362_out_ap_vld;
reg add_1361_out_ap_vld;
reg add360_out_ap_vld;
...
wire  signed [2:0] sub_ln35_11_fu_486_p2;
reg  signed [2:0] sub_ln35_11_reg_1099;
...
wire   [2:0] sub_ln35_12_fu_502_p2;
wire   [3:0] zext_ln51_fu_518_p1;
wire   [1:0] tmp_16_fu_528_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            add360_fu_100 <= add_ln50_fu_431_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add_1361_fu_104 <= 64'd0;
        end else if (((icmp_ln37_fu_346_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add_1361_fu_104 <= add_ln50_1_fu_476_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_2362_fu_108 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_2362_fu_108 <= add_ln50_2_fu_642_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_3363_fu_112 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_3363_fu_112 <= add_ln50_3_fu_699_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_4364_fu_116 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_4364_fu_116 <= add_ln50_4_fu_755_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_5365_fu_120 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_5365_fu_120 <= add_ln50_5_fu_819_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add_6366_fu_124 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add_6366_fu_124 <= add_ln50_6_fu_870_p2;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add360_out_ap_vld = 1'b1;
    end else begin
        add360_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1361_out_ap_vld = 1'b1;
    end else begin
        add_1361_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2362_out_ap_vld = 1'b1;
    end else begin
        add_2362_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3363_out_ap_vld = 1'b1;
    end else begin
        add_3363_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_4364_out_ap_vld = 1'b1;
    end else begin
        add_4364_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6366_out_ap_vld = 1'b1;
    end else begin
        add_6366_out_ap_vld = 1'b0;
    end
end
...
assign add360_out = add360_fu_100;

assign add_1361_out = add_1361_fu_104;

assign add_2362_out = add_2362_fu_108;

assign add_3363_out = add_3363_fu_112;

assign add_4364_out = add_4364_fu_116;

assign add_5365_out = add_5365_fu_120;

assign add_6366_out = add_6366_fu_124;

assign add_ln37_fu_550_p2 = ($signed(i_fu_128) + $signed(4'd15));

assign add_ln50_1_fu_476_p2 = (and_ln50_1_fu_470_p2 + add_1361_fu_104);

assign add_ln50_2_fu_642_p2 = (and_ln50_2_fu_636_p2 + add_2362_fu_108);

assign add_ln50_3_fu_699_p2 = (and_ln50_3_fu_693_p2 + add_3363_fu_112);

assign add_ln50_4_fu_755_p2 = (and_ln50_4_fu_749_p2 + add_4364_fu_116);

assign add_ln50_5_fu_819_p2 = (and_ln50_5_fu_813_p2 + add_5365_fu_120);

assign add_ln50_6_fu_870_p2 = (mul_ln50_6_fu_295_p2 + add_6366_fu_124);

assign add_ln50_fu_431_p2 = (and_ln50_fu_425_p2 + add360_fu_100);
...
assign icmp_ln50_3_fu_538_p2 = ((tmp_16_fu_528_p4 != 2'd0) ? 1'b1 : 1'b0);
...
assign select_ln50_1_fu_417_p3 = ((tmp_15_fu_409_p3[0:0] == 1'b1) ? 64'd18446744073709551615 : 64'd0);
...
assign sext_ln50_1_fu_508_p1 = $signed(sub_ln35_12_fu_502_p2);

assign sub_ln35_11_fu_486_p2 = (select_ln50_2_fu_437_p3 - zext_ln35_fu_482_p1);

assign sub_ln35_12_fu_502_p2 = ($signed(sub_ln35_11_fu_486_p2) - $signed(zext_ln35_1_fu_498_p1));
...
assign tmp_15_fu_409_p3 = empty_fu_358_p2[32'd3];

assign tmp_16_fu_528_p4 = {{empty_fu_358_p2[3:2]}};

assign tmp_3_fu_589_p17 = sub_ln35_11_reg_1099;
