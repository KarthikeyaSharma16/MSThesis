...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        arg1_r_5_reload,
        add289_5329_out,
        add289_5329_out_ap_vld,
        add289_4328_out,
        add289_4328_out_ap_vld,
        add289_3327_out,
        add289_3327_out_ap_vld,
        add289_2326_out,
        add289_2326_out_ap_vld,
        add289_1174325_out,
        add289_1174325_out_ap_vld,
        add289324_out,
        add289324_out_ap_vld
);
...
output  [63:0] add289_5329_out;
output   add289_5329_out_ap_vld;
output  [63:0] add289_4328_out;
output   add289_4328_out_ap_vld;
output  [63:0] add289_3327_out;
output   add289_3327_out_ap_vld;
output  [63:0] add289_2326_out;
output   add289_2326_out_ap_vld;
output  [63:0] add289_1174325_out;
output   add289_1174325_out_ap_vld;
output  [63:0] add289324_out;
output   add289324_out_ap_vld;

reg ap_idle;
reg add289_5329_out_ap_vld;
reg add289_4328_out_ap_vld;
reg add289_3327_out_ap_vld;
reg add289_2326_out_ap_vld;
reg add289_1174325_out_ap_vld;
reg add289324_out_ap_vld;
...
wire   [31:0] tmp_23_fu_448_p9;
reg   [31:0] tmp_23_reg_1289;
...
reg   [63:0] add289324_fu_106;
wire   [63:0] add_ln143_fu_543_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add289_1174325_fu_110;
wire   [63:0] add_ln143_2_fu_796_p2;
reg   [63:0] add289_2326_fu_114;
wire   [63:0] add_ln143_4_fu_851_p2;
reg   [63:0] add289_3327_fu_118;
wire   [63:0] add_ln143_6_fu_942_p2;
reg   [63:0] add289_4328_fu_122;
wire   [63:0] add_ln143_8_fu_1019_p2;
reg   [63:0] add289_5329_fu_126;
...
wire  signed [3:0] tmp_24_fu_870_p17;
wire   [31:0] tmp_24_fu_870_p18;
...
wire   [3:0] tmp_26_fu_1034_p17;
wire   [31:0] tmp_26_fu_1034_p18;
...
mux_16_4_32_1_1_U201(
    ...
    .din16(tmp_18_fu_579_p17),
    .dout(tmp_18_fu_579_p18)
);
...
mux_16_4_32_1_1_U205(
    ...
    .din14(arg2_r_14_reload),
    .din15(arg2_r_15_reload),
    .din16(tmp_24_fu_870_p17),
    .dout(tmp_24_fu_870_p18)
);
...
mux_16_4_32_1_1_U207(
    ...
    .din14(arg2_r_14_reload),
    .din15(arg2_r_15_reload),
    .din16(tmp_26_fu_1034_p17),
    .dout(tmp_26_fu_1034_p18)
);
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289324_fu_106 <= arr_45;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289324_fu_106 <= add_ln143_fu_543_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_1174325_fu_110 <= arr_46;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_1174325_fu_110 <= add_ln143_2_fu_796_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_2326_fu_114 <= arr_47;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_2326_fu_114 <= add_ln143_4_fu_851_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_3327_fu_118 <= arr_48;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_3327_fu_118 <= add_ln143_6_fu_942_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_4328_fu_122 <= arr_49;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_4328_fu_122 <= add_ln143_8_fu_1019_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_5329_fu_126 <= arr_50;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_5329_fu_126 <= add_ln143_10_fu_1078_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln130_fu_376_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_17_reg_1259 <= tmp_17_fu_396_p9;
        tmp_23_reg_1289 <= tmp_23_fu_448_p9;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289324_out_ap_vld = 1'b1;
    end else begin
        add289324_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1174325_out_ap_vld = 1'b1;
    end else begin
        add289_1174325_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2326_out_ap_vld = 1'b1;
    end else begin
        add289_2326_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_3327_out_ap_vld = 1'b1;
    end else begin
        add289_3327_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_4328_out_ap_vld = 1'b1;
    end else begin
        add289_4328_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_5329_out_ap_vld = 1'b1;
    end else begin
        add289_5329_out_ap_vld = 1'b0;
    end
end
...
assign add289324_out = add289324_fu_106;

assign add289_1174325_out = add289_1174325_fu_110;

assign add289_2326_out = add289_2326_fu_114;

assign add289_3327_out = add289_3327_fu_118;

assign add289_4328_out = add289_4328_fu_122;

assign add289_5329_out = add289_5329_fu_126;

assign add_ln130_fu_492_p2 = ($signed(ap_sig_allocacmp_i_3) + $signed(3'd6));

assign add_ln143_10_fu_1078_p2 = (add289_5329_fu_126 + add_ln143_9_fu_1072_p2);

assign add_ln143_1_fu_790_p2 = (and_ln143_2_fu_784_p2 + and_ln143_1_fu_771_p2);

assign add_ln143_2_fu_796_p2 = (add289_1174325_fu_110 + add_ln143_1_fu_790_p2);

assign add_ln143_3_fu_845_p2 = (and_ln143_4_fu_839_p2 + and_ln143_3_fu_826_p2);

assign add_ln143_4_fu_851_p2 = (add289_2326_fu_114 + add_ln143_3_fu_845_p2);

assign add_ln143_5_fu_936_p2 = (and_ln143_6_fu_930_p2 + and_ln143_5_fu_917_p2);

assign add_ln143_6_fu_942_p2 = (add289_3327_fu_118 + add_ln143_5_fu_936_p2);

assign add_ln143_7_fu_1013_p2 = (and_ln143_7_fu_1007_p2 + mul_ln143_7_fu_318_p2);

assign add_ln143_8_fu_1019_p2 = (add289_4328_fu_122 + add_ln143_7_fu_1013_p2);

assign add_ln143_9_fu_1072_p2 = (mul_ln143_10_fu_330_p2 + mul_ln143_9_fu_326_p2);

assign add_ln143_fu_543_p2 = (and_ln143_fu_537_p2 + add289324_fu_106);
...
assign icmp_ln143_4_fu_468_p2 = ((tmp_22_fu_440_p3 == 4'd14) ? 1'b1 : 1'b0);

assign icmp_ln143_5_fu_474_p2 = ((tmp_22_fu_440_p3 > 4'd12) ? 1'b1 : 1'b0);

assign icmp_ln143_6_fu_480_p2 = ((tmp_22_fu_440_p3 > 4'd11) ? 1'b1 : 1'b0);

assign icmp_ln143_7_fu_486_p2 = ((tmp_22_fu_440_p3 > 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln143_fu_416_p2 = ((tmp_s_fu_388_p3 == 4'd15) ? 1'b1 : 1'b0);

assign mul_ln143_10_fu_330_p0 = mul_ln143_10_fu_330_p00;

assign mul_ln143_10_fu_330_p00 = tmp_26_fu_1034_p18;
...
assign mul_ln143_3_fu_302_p00 = tmp_18_fu_579_p18;
...
assign tmp_18_fu_579_p17 = sub_ln35_6_fu_569_p2;

assign tmp_22_fu_440_p3 = {{1'd1}, {ap_sig_allocacmp_i_3}};

assign tmp_24_fu_870_p17 = sub_ln35_9_fu_860_p2;

assign tmp_26_fu_1034_p17 = ($signed(sext_ln143_10_fu_957_p1) - $signed(zext_ln144_1_fu_1025_p1));

assign tmp_s_fu_388_p3 = {{1'd1}, {empty_fu_382_p2}};

assign zext_ln143_6_fu_756_p1 = tmp_23_reg_1289;

assign zext_ln143_fu_521_p1 = tmp_17_reg_1259;
