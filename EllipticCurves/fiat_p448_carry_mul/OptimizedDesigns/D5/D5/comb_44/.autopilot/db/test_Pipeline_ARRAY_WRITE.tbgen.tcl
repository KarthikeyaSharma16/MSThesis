...
set C_modelArgList {
	...
	{ sext_ln219 int 62 regular  }
	{ zext_ln201 int 28 regular  }
	{ out1_w_1 int 29 regular  }
	{ zext_ln203 int 28 regular  }
	{ zext_ln204 int 28 regular  }
	{ zext_ln205 int 28 regular  }
	{ zext_ln206 int 28 regular  }
	{ zext_ln207 int 28 regular  }
	{ zext_ln208 int 28 regular  }
	{ zext_ln209 int 28 regular  }
	{ out1_w_9 int 29 regular  }
	{ zext_ln211 int 28 regular  }
	{ zext_ln212 int 28 regular  }
	{ zext_ln213 int 28 regular  }
	{ zext_ln214 int 28 regular  }
	{ zext_ln215 int 28 regular  }
	{ zext_ln14 int 28 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln219", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln201", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "out1_w_1", "interface" : "wire", "bitwidth" : 29, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln203", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln204", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln205", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln206", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln207", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln208", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln209", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "out1_w_9", "interface" : "wire", "bitwidth" : 29, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln211", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln212", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln213", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln214", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln215", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln14", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln219 sc_in sc_lv 62 signal 1 } 
	{ zext_ln201 sc_in sc_lv 28 signal 2 } 
	{ out1_w_1 sc_in sc_lv 29 signal 3 } 
	{ zext_ln203 sc_in sc_lv 28 signal 4 } 
	{ zext_ln204 sc_in sc_lv 28 signal 5 } 
	{ zext_ln205 sc_in sc_lv 28 signal 6 } 
	{ zext_ln206 sc_in sc_lv 28 signal 7 } 
	{ zext_ln207 sc_in sc_lv 28 signal 8 } 
	{ zext_ln208 sc_in sc_lv 28 signal 9 } 
	{ zext_ln209 sc_in sc_lv 28 signal 10 } 
	{ out1_w_9 sc_in sc_lv 29 signal 11 } 
	{ zext_ln211 sc_in sc_lv 28 signal 12 } 
	{ zext_ln212 sc_in sc_lv 28 signal 13 } 
	{ zext_ln213 sc_in sc_lv 28 signal 14 } 
	{ zext_ln214 sc_in sc_lv 28 signal 15 } 
	{ zext_ln215 sc_in sc_lv 28 signal 16 } 
	{ zext_ln14 sc_in sc_lv 28 signal 17 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln219", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln219", "role": "default" }} , 
 	{ "name": "zext_ln201", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln201", "role": "default" }} , 
 	{ "name": "out1_w_1", "direction": "in", "datatype": "sc_lv", "bitwidth":29, "type": "signal", "bundle":{"name": "out1_w_1", "role": "default" }} , 
 	{ "name": "zext_ln203", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln203", "role": "default" }} , 
 	{ "name": "zext_ln204", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln204", "role": "default" }} , 
 	{ "name": "zext_ln205", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln205", "role": "default" }} , 
 	{ "name": "zext_ln206", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln206", "role": "default" }} , 
 	{ "name": "zext_ln207", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln207", "role": "default" }} , 
 	{ "name": "zext_ln208", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln208", "role": "default" }} , 
 	{ "name": "zext_ln209", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln209", "role": "default" }} , 
 	{ "name": "out1_w_9", "direction": "in", "datatype": "sc_lv", "bitwidth":29, "type": "signal", "bundle":{"name": "out1_w_9", "role": "default" }} , 
 	{ "name": "zext_ln211", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln211", "role": "default" }} , 
 	{ "name": "zext_ln212", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln212", "role": "default" }} , 
 	{ "name": "zext_ln213", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln213", "role": "default" }} , 
 	{ "name": "zext_ln214", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln214", "role": "default" }} , 
 	{ "name": "zext_ln215", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln215", "role": "default" }} , 
 	{ "name": "zext_ln14", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln14", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_16_4_29_1_1_U294", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln219 { ap_none {  { sext_ln219 in_data 0 62 } } }
	zext_ln201 { ap_none {  { zext_ln201 in_data 0 28 } } }
	out1_w_1 { ap_none {  { out1_w_1 in_data 0 29 } } }
	zext_ln203 { ap_none {  { zext_ln203 in_data 0 28 } } }
	zext_ln204 { ap_none {  { zext_ln204 in_data 0 28 } } }
	zext_ln205 { ap_none {  { zext_ln205 in_data 0 28 } } }
	zext_ln206 { ap_none {  { zext_ln206 in_data 0 28 } } }
	zext_ln207 { ap_none {  { zext_ln207 in_data 0 28 } } }
	zext_ln208 { ap_none {  { zext_ln208 in_data 0 28 } } }
	zext_ln209 { ap_none {  { zext_ln209 in_data 0 28 } } }
	out1_w_9 { ap_none {  { out1_w_9 in_data 0 29 } } }
	zext_ln211 { ap_none {  { zext_ln211 in_data 0 28 } } }
	zext_ln212 { ap_none {  { zext_ln212 in_data 0 28 } } }
	zext_ln213 { ap_none {  { zext_ln213 in_data 0 28 } } }
	zext_ln214 { ap_none {  { zext_ln214 in_data 0 28 } } }
	zext_ln215 { ap_none {  { zext_ln215 in_data 0 28 } } }
	zext_ln14 { ap_none {  { zext_ln14 in_data 0 28 } } }
}
