...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_6433_out \
    op interface \
    ports { add_6433_out { O 64 vector } add_6433_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_5432_out \
    op interface \
    ports { add_5432_out { O 64 vector } add_5432_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_4431_out \
    op interface \
    ports { add_4431_out { O 64 vector } add_4431_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_3430_out \
    op interface \
    ports { add_3430_out { O 64 vector } add_3430_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_2429_out \
    op interface \
    ports { add_2429_out { O 64 vector } add_2429_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_1428_out \
    op interface \
    ports { add_1428_out { O 64 vector } add_1428_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add427_out \
    op interface \
    ports { add427_out { O 64 vector } add427_out_ap_vld { O 1 bit } } \
} "
}
