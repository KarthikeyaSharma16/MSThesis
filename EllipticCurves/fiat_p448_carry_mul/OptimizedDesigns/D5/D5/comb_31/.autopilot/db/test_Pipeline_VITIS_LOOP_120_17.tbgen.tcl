...
set C_modelArgList {
	...
	{ add245_1382_out int 64 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "arg1_r_9_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add245_1382_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ arg2_r_10_reload sc_in sc_lv 32 signal 8 } 
	{ arg2_r_12_reload sc_in sc_lv 32 signal 9 } 
	{ arg2_r_14_reload sc_in sc_lv 32 signal 10 } 
	{ arg1_r_8_reload sc_in sc_lv 32 signal 11 } 
	{ arg2_r_9_reload sc_in sc_lv 32 signal 12 } 
	{ arg2_r_11_reload sc_in sc_lv 32 signal 13 } 
	{ arg2_r_13_reload sc_in sc_lv 32 signal 14 } 
	{ arg2_r_15_reload sc_in sc_lv 32 signal 15 } 
	{ add245_1382_out sc_out sc_lv 64 signal 16 } 
	{ add245_1382_out_ap_vld sc_out sc_logic 1 outvld 16 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add245_1382_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add245_1382_out", "role": "default" }} , 
 	{ "name": "add245_1382_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add245_1382_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_16_4_32_1_1_U131", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_15_4_32_1_1_U132", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_16_4_32_1_1_U133", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_15_4_32_1_1_U134", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	add245_1382_out { ap_vld {  { add245_1382_out out_data 1 64 }  { add245_1382_out_ap_vld out_vld 1 1 } } }
}
