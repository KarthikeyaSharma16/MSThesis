...
output  [63:0] add_6418_out;
output   add_6418_out_ap_vld;
output  [63:0] add_5417_out;
output   add_5417_out_ap_vld;
output  [63:0] add_4416_out;
output   add_4416_out_ap_vld;
output  [63:0] add_3415_out;
output   add_3415_out_ap_vld;
output  [63:0] add_2414_out;
output   add_2414_out_ap_vld;
output  [63:0] add_1413_out;
output   add_1413_out_ap_vld;
output  [63:0] add412_out;
output   add412_out_ap_vld;

reg ap_idle;
reg add_6418_out_ap_vld;
reg add_5417_out_ap_vld;
reg add_4416_out_ap_vld;
reg add_3415_out_ap_vld;
reg add_2414_out_ap_vld;
reg add_1413_out_ap_vld;
reg add412_out_ap_vld;
...
wire  signed [2:0] sub_ln35_3_fu_486_p2;
reg  signed [2:0] sub_ln35_3_reg_1099;
...
reg   [63:0] add412_fu_100;
wire   [63:0] add_ln50_fu_431_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add_1413_fu_104;
wire   [63:0] add_ln50_1_fu_476_p2;
reg   [63:0] add_2414_fu_108;
wire   [63:0] add_ln50_2_fu_642_p2;
reg   [63:0] add_3415_fu_112;
wire   [63:0] add_ln50_3_fu_699_p2;
reg   [63:0] add_4416_fu_116;
wire   [63:0] add_ln50_4_fu_755_p2;
reg   [63:0] add_5417_fu_120;
wire   [63:0] add_ln50_5_fu_819_p2;
reg   [63:0] add_6418_fu_124;
wire   [63:0] add_ln50_6_fu_870_p2;
reg   [3:0] i_fu_128;
...
wire   [3:0] tmp_7_fu_834_p17;
wire   [31:0] tmp_7_fu_834_p18;
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add412_out_ap_vld = 1'b1;
    end else begin
        add412_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1413_out_ap_vld = 1'b1;
    end else begin
        add_1413_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2414_out_ap_vld = 1'b1;
    end else begin
        add_2414_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3415_out_ap_vld = 1'b1;
    end else begin
        add_3415_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_4416_out_ap_vld = 1'b1;
    end else begin
        add_4416_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_5417_out_ap_vld = 1'b1;
    end else begin
        add_5417_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6418_out_ap_vld = 1'b1;
    end else begin
        add_6418_out_ap_vld = 1'b0;
    end
end
...
assign add412_out = add412_fu_100;

assign add_1413_out = add_1413_fu_104;

assign add_2414_out = add_2414_fu_108;

assign add_3415_out = add_3415_fu_112;

assign add_4416_out = add_4416_fu_116;

assign add_5417_out = add_5417_fu_120;

assign add_6418_out = add_6418_fu_124;

assign add_ln37_fu_550_p2 = ($signed(i_fu_128) + $signed(4'd15));

assign add_ln50_1_fu_476_p2 = (and_ln50_1_fu_470_p2 + add_1413_fu_104);

assign add_ln50_2_fu_642_p2 = (and_ln50_2_fu_636_p2 + add_2414_fu_108);

assign add_ln50_3_fu_699_p2 = (and_ln50_3_fu_693_p2 + add_3415_fu_112);

assign add_ln50_4_fu_755_p2 = (and_ln50_4_fu_749_p2 + add_4416_fu_116);

assign add_ln50_5_fu_819_p2 = (and_ln50_5_fu_813_p2 + add_5417_fu_120);

assign add_ln50_6_fu_870_p2 = (mul_ln50_6_fu_295_p2 + add_6418_fu_124);

assign add_ln50_fu_431_p2 = (and_ln50_fu_425_p2 + add412_fu_100);
...
assign empty_fu_358_p2 = ($signed(i_fu_128) + $signed(4'd9));

assign icmp_ln37_fu_346_p2 = ((i_fu_128 > 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln50_1_fu_492_p2 = ((empty_fu_358_p2 > 4'd5) ? 1'b1 : 1'b0);

assign icmp_ln50_2_fu_512_p2 = ((empty_fu_358_p2 > 4'd4) ? 1'b1 : 1'b0);

assign icmp_ln50_3_fu_538_p2 = ((tmp_8_fu_528_p4 != 2'd0) ? 1'b1 : 1'b0);
...
assign select_ln50_1_fu_417_p3 = ((tmp_2_fu_409_p3[0:0] == 1'b1) ? 64'd18446744073709551615 : 64'd0);

assign select_ln50_2_fu_437_p3 = ((tmp_fu_401_p3[0:0] == 1'b1) ? 3'd6 : 3'd7);
...
assign select_ln50_fu_445_p3 = ((tmp_fu_401_p3[0:0] == 1'b1) ? arg2_r_14_reload : arg2_r_15_reload);

assign sext_ln50_1_fu_508_p1 = $signed(sub_ln35_4_fu_502_p2);

assign sub_ln35_1_fu_764_p2 = (sub_ln35_reg_1119 - zext_ln51_1_fu_761_p1);

assign sub_ln35_3_fu_486_p2 = (select_ln50_2_fu_437_p3 - zext_ln35_fu_482_p1);

assign sub_ln35_4_fu_502_p2 = ($signed(sub_ln35_3_fu_486_p2) - $signed(zext_ln35_1_fu_498_p1));

assign sub_ln35_fu_522_p2 = ($signed(sext_ln50_1_fu_508_p1) - $signed(zext_ln51_fu_518_p1));

assign tmp_2_fu_409_p3 = empty_fu_358_p2[32'd3];

assign tmp_3_fu_589_p17 = sub_ln35_3_reg_1099;

assign tmp_7_fu_834_p17 = (sub_ln35_1_fu_764_p2 - zext_ln51_2_fu_825_p1);

assign tmp_8_fu_528_p4 = {{empty_fu_358_p2[3:2]}};

assign tmp_fu_401_p3 = empty_fu_358_p2[32'd3];

assign zext_ln35_1_fu_498_p1 = icmp_ln50_1_fu_492_p2;

assign zext_ln35_fu_482_p1 = icmp_ln50_fu_456_p2;

assign zext_ln50_fu_395_p1 = tmp_1_fu_364_p18;
