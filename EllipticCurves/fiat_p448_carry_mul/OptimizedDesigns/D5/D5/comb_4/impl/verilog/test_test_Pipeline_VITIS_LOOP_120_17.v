...
output  [63:0] add245_3986_out;
output   add245_3986_out_ap_vld;

reg ap_idle;
reg add245_3986_out_ap_vld;
...
reg   [63:0] add245_3986_fu_72;
wire   [63:0] add_ln126_4_fu_465_p2;
wire    ap_loop_init;
...
always @ (*) begin
    if (((tmp_fu_221_p3 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add245_3986_out_ap_vld = 1'b1;
    end else begin
        add245_3986_out_ap_vld = 1'b0;
    end
end
...
assign add245_3986_out = add245_3986_fu_72;
...
assign add_ln126_4_fu_465_p2 = (add245_3986_fu_72 + add_ln126_3_fu_459_p2);
...
assign mul_ln126_1_fu_191_p10 = tmp_3_fu_294_p18;
...
assign mul_ln126_2_fu_195_p10 = tmp_5_fu_343_p18;
...
assign mul_ln126_3_fu_199_p10 = tmp_1_fu_239_p18;
...
assign mul_ln126_fu_187_p10 = tmp_7_fu_392_p18;
