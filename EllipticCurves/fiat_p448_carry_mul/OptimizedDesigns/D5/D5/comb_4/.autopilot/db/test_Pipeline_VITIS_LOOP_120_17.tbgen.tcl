...
set C_modelArgList {
	...
	{ add245_3986_out int 64 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "arg1_r_11_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add245_3986_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ add245_3986_out sc_out sc_lv 64 signal 16 } 
	{ add245_3986_out_ap_vld sc_out sc_logic 1 outvld 16 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add245_3986_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add245_3986_out", "role": "default" }} , 
 	{ "name": "add245_3986_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add245_3986_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
		...
		"Port" : [
			...
			{"Name" : "add245_3986_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	test_Pipeline_VITIS_LOOP_120_17 {
		...
		add245_3986_out {Type O LastRead -1 FirstWrite 1}}}
...
set Spec2ImplPortList { 
	...
	add245_3986_out { ap_vld {  { add245_3986_out out_data 1 64 }  { add245_3986_out_ap_vld out_vld 1 1 } } }
}
