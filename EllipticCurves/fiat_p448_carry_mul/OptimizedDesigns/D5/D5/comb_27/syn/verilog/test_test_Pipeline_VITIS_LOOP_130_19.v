...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        arg2_r_10_reload,
        add289_5466_out,
        add289_5466_out_ap_vld,
        add289_4465_out,
        add289_4465_out_ap_vld,
        add289_3464_out,
        add289_3464_out_ap_vld,
        add289_2463_out,
        add289_2463_out_ap_vld,
        add289_1462_out,
        add289_1462_out_ap_vld,
        add289461_out,
        add289461_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add212_6474_reload;
input  [63:0] add212_5473_reload;
input  [63:0] add212_4472_reload;
input  [63:0] add212_3471_reload;
input  [63:0] add212_2470_reload;
input  [63:0] add212_1469_reload;
...
output  [63:0] add289_5466_out;
output   add289_5466_out_ap_vld;
output  [63:0] add289_4465_out;
output   add289_4465_out_ap_vld;
output  [63:0] add289_3464_out;
output   add289_3464_out_ap_vld;
output  [63:0] add289_2463_out;
output   add289_2463_out_ap_vld;
output  [63:0] add289_1462_out;
output   add289_1462_out_ap_vld;
output  [63:0] add289461_out;
output   add289461_out_ap_vld;

reg ap_idle;
reg add289_5466_out_ap_vld;
reg add289_4465_out_ap_vld;
reg add289_3464_out_ap_vld;
reg add289_2463_out_ap_vld;
reg add289_1462_out_ap_vld;
reg add289461_out_ap_vld;
...
wire  signed [2:0] sub_ln35_43_fu_410_p2;
reg  signed [2:0] sub_ln35_43_reg_948;
...
reg   [63:0] add289461_fu_100;
wire   [63:0] add_ln143_fu_495_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add289_1462_fu_104;
wire   [63:0] add_ln143_1_fu_524_p2;
reg   [63:0] add289_2463_fu_108;
wire   [63:0] add_ln143_2_fu_586_p2;
reg   [63:0] add289_3464_fu_112;
wire   [63:0] add_ln143_3_fu_647_p2;
reg   [63:0] add289_4465_fu_116;
wire   [63:0] add_ln143_4_fu_713_p2;
reg   [63:0] add289_5466_fu_120;
...
wire  signed [3:0] tmp_70_fu_533_p17;
wire   [31:0] tmp_70_fu_533_p18;
...
wire   [3:0] tmp_73_fu_728_p17;
wire   [31:0] tmp_73_fu_728_p18;
...
mux_16_4_32_1_1_U345(
    ...
    .din16(tmp_70_fu_533_p17),
    .dout(tmp_70_fu_533_p18)
);
...
mux_16_4_32_1_1_U348(
    ...
    .din14(arg2_r_14_reload),
    .din15(arg2_r_15_reload),
    .din16(tmp_73_fu_728_p17),
    .dout(tmp_73_fu_728_p18)
);
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289461_fu_100 <= add212_1469_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289461_fu_100 <= add_ln143_fu_495_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_1462_fu_104 <= add212_2470_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_1462_fu_104 <= add_ln143_1_fu_524_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_2463_fu_108 <= add212_3471_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_2463_fu_108 <= add_ln143_2_fu_586_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_3464_fu_112 <= add212_4472_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_3464_fu_112 <= add_ln143_3_fu_647_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_4465_fu_116 <= add212_5473_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_4465_fu_116 <= add_ln143_4_fu_713_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_5466_fu_120 <= add212_6474_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_5466_fu_120 <= add_ln143_5_fu_765_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln130_fu_350_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        sub_ln35_43_reg_948 <= sub_ln35_43_fu_410_p2;
...
always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289461_out_ap_vld = 1'b1;
    end else begin
        add289461_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1462_out_ap_vld = 1'b1;
    end else begin
        add289_1462_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2463_out_ap_vld = 1'b1;
    end else begin
        add289_2463_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_3464_out_ap_vld = 1'b1;
    end else begin
        add289_3464_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_4465_out_ap_vld = 1'b1;
    end else begin
        add289_4465_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_5466_out_ap_vld = 1'b1;
    end else begin
        add289_5466_out_ap_vld = 1'b0;
    end
end
...
assign add289461_out = add289461_fu_100;

assign add289_1462_out = add289_1462_fu_104;

assign add289_2463_out = add289_2463_fu_108;

assign add289_3464_out = add289_3464_fu_112;

assign add289_4465_out = add289_4465_fu_116;

assign add289_5466_out = add289_5466_fu_120;

assign add_ln130_fu_444_p2 = ($signed(ap_sig_allocacmp_i_4) + $signed(3'd7));

assign add_ln143_1_fu_524_p2 = (and_ln143_1_fu_518_p2 + add289_1462_fu_104);

assign add_ln143_2_fu_586_p2 = (and_ln143_2_fu_580_p2 + add289_2463_fu_108);

assign add_ln143_3_fu_647_p2 = (and_ln143_3_fu_641_p2 + add289_3464_fu_112);

assign add_ln143_4_fu_713_p2 = (and_ln143_4_fu_707_p2 + add289_4465_fu_116);

assign add_ln143_5_fu_765_p2 = (mul_ln143_5_fu_304_p2 + add289_5466_fu_120);

assign add_ln143_fu_495_p2 = (and_ln143_fu_489_p2 + add289461_fu_100);
...
assign sub_ln35_18_fu_426_p2 = ($signed(sub_ln35_43_fu_410_p2) - $signed(zext_ln35_10_fu_422_p1));

assign sub_ln35_19_fu_656_p2 = ($signed(sext_ln143_1_fu_592_p1) - $signed(zext_ln144_fu_653_p1));

assign sub_ln35_43_fu_410_p2 = (select_ln143_2_fu_392_p3 - zext_ln35_fu_406_p1);

assign tmp_70_fu_533_p17 = sub_ln35_43_reg_948;

assign tmp_73_fu_728_p17 = (sub_ln35_19_fu_656_p2 - zext_ln144_1_fu_719_p1);
