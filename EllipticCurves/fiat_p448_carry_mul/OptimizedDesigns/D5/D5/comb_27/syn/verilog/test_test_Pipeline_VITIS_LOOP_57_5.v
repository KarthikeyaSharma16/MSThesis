...
module test_test_Pipeline_VITIS_LOOP_57_5 (
        ...
        arg2_r_9_reload,
        add102_6496_out,
        add102_6496_out_ap_vld,
        add102_5495_out,
        add102_5495_out_ap_vld,
        add102_4494_out,
        add102_4494_out_ap_vld,
        add102_3493_out,
        add102_3493_out_ap_vld,
        add102_2492_out,
        add102_2492_out_ap_vld,
        add102_1491_out,
        add102_1491_out_ap_vld,
        add102490_out,
        add102490_out_ap_vld
);
...
output  [63:0] add102_6496_out;
output   add102_6496_out_ap_vld;
output  [63:0] add102_5495_out;
output   add102_5495_out_ap_vld;
output  [63:0] add102_4494_out;
output   add102_4494_out_ap_vld;
output  [63:0] add102_3493_out;
output   add102_3493_out_ap_vld;
output  [63:0] add102_2492_out;
output   add102_2492_out_ap_vld;
output  [63:0] add102_1491_out;
output   add102_1491_out_ap_vld;
output  [63:0] add102490_out;
output   add102490_out_ap_vld;

reg ap_idle;
reg add102_6496_out_ap_vld;
reg add102_5495_out_ap_vld;
reg add102_4494_out_ap_vld;
reg add102_3493_out_ap_vld;
reg add102_2492_out_ap_vld;
reg add102_1491_out_ap_vld;
reg add102490_out_ap_vld;
...
reg   [63:0] add102490_fu_96;
wire   [63:0] add_ln70_fu_431_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add102_1491_fu_100;
wire   [63:0] add_ln70_1_fu_476_p2;
reg   [63:0] add102_2492_fu_104;
wire   [63:0] add_ln70_2_fu_632_p2;
reg   [63:0] add102_3493_fu_108;
wire   [63:0] add_ln70_3_fu_689_p2;
reg   [63:0] add102_4494_fu_112;
wire   [63:0] add_ln70_4_fu_745_p2;
reg   [63:0] add102_5495_fu_116;
wire   [63:0] add_ln70_5_fu_809_p2;
reg   [63:0] add102_6496_fu_120;
...
always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102490_out_ap_vld = 1'b1;
    end else begin
        add102490_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_1491_out_ap_vld = 1'b1;
    end else begin
        add102_1491_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_2492_out_ap_vld = 1'b1;
    end else begin
        add102_2492_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_3493_out_ap_vld = 1'b1;
    end else begin
        add102_3493_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_4494_out_ap_vld = 1'b1;
    end else begin
        add102_4494_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_5495_out_ap_vld = 1'b1;
    end else begin
        add102_5495_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_6496_out_ap_vld = 1'b1;
    end else begin
        add102_6496_out_ap_vld = 1'b0;
    end
end
...
assign add102490_out = add102490_fu_96;

assign add102_1491_out = add102_1491_fu_100;

assign add102_2492_out = add102_2492_fu_104;

assign add102_3493_out = add102_3493_fu_108;

assign add102_4494_out = add102_4494_fu_112;

assign add102_5495_out = add102_5495_fu_116;

assign add102_6496_out = add102_6496_fu_120;

assign add_ln57_fu_540_p2 = ($signed(i_fu_124) + $signed(4'd15));

assign add_ln70_1_fu_476_p2 = (and_ln70_1_fu_470_p2 + add102_1491_fu_100);

assign add_ln70_2_fu_632_p2 = (and_ln70_2_fu_626_p2 + add102_2492_fu_104);

assign add_ln70_3_fu_689_p2 = (and_ln70_3_fu_683_p2 + add102_3493_fu_108);

assign add_ln70_4_fu_745_p2 = (and_ln70_4_fu_739_p2 + add102_4494_fu_112);

assign add_ln70_5_fu_809_p2 = (and_ln70_5_fu_803_p2 + add102_5495_fu_116);

assign add_ln70_6_fu_860_p2 = (mul_ln70_6_fu_291_p2 + add102_6496_fu_120);

assign add_ln70_fu_431_p2 = (and_ln70_fu_425_p2 + add102490_fu_96);
