...
output  [63:0] add245_3501_out;
output   add245_3501_out_ap_vld;

reg ap_idle;
reg add245_3501_out_ap_vld;
...
wire   [31:0] tmp_77_fu_294_p18;
wire   [31:0] select_ln126_1_fu_332_p3;
wire   [31:0] tmp_78_fu_343_p18;
wire   [31:0] select_ln126_2_fu_381_p3;
wire   [31:0] tmp_79_fu_392_p18;
...
always @ (*) begin
    if (((tmp_fu_221_p3 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add245_3501_out_ap_vld = 1'b1;
    end else begin
        add245_3501_out_ap_vld = 1'b0;
    end
end
...
assign add245_3501_out = add245_3501_fu_72;
...
assign add_ln126_4_fu_465_p2 = (add245_3501_fu_72 + add_ln126_3_fu_459_p2);
...
assign mul_ln126_1_fu_191_p10 = tmp_77_fu_294_p18;
...
assign mul_ln126_2_fu_195_p10 = tmp_78_fu_343_p18;
...
assign mul_ln126_fu_187_p10 = tmp_79_fu_392_p18;
