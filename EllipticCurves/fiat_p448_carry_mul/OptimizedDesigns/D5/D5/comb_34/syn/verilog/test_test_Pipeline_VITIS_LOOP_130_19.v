...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        arg2_r_10_reload,
        add289_5246_out,
        add289_5246_out_ap_vld,
        add289_4245_out,
        add289_4245_out_ap_vld,
        add289_3244_out,
        add289_3244_out_ap_vld,
        add289_2243_out,
        add289_2243_out_ap_vld,
        add289_1242_out,
        add289_1242_out_ap_vld,
        add289241_out,
        add289241_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add212_6254_reload;
input  [63:0] add212_5253_reload;
input  [63:0] add212_4252_reload;
input  [63:0] add212_3251_reload;
input  [63:0] add212_2250_reload;
input  [63:0] add212_1249_reload;
...
output  [63:0] add289_5246_out;
output   add289_5246_out_ap_vld;
output  [63:0] add289_4245_out;
output   add289_4245_out_ap_vld;
output  [63:0] add289_3244_out;
output   add289_3244_out_ap_vld;
output  [63:0] add289_2243_out;
output   add289_2243_out_ap_vld;
output  [63:0] add289_1242_out;
output   add289_1242_out_ap_vld;
output  [63:0] add289241_out;
output   add289241_out_ap_vld;

reg ap_idle;
reg add289_5246_out_ap_vld;
reg add289_4245_out_ap_vld;
reg add289_3244_out_ap_vld;
reg add289_2243_out_ap_vld;
reg add289_1242_out_ap_vld;
reg add289241_out_ap_vld;
...
wire   [2:0] zext_ln35_2_fu_422_p1;
...
wire  signed [3:0] tmp_19_fu_533_p17;
wire   [31:0] tmp_19_fu_533_p18;
...
wire   [3:0] sub_ln35_7_fu_656_p2;
wire   [31:0] tmp_21_fu_662_p18;
...
wire   [3:0] tmp_22_fu_728_p17;
wire   [31:0] tmp_22_fu_728_p18;
...
mux_16_4_32_1_1_U249(
    ...
    .din16(tmp_19_fu_533_p17),
    .dout(tmp_19_fu_533_p18)
);
...
mux_16_4_32_1_1_U252(
    ...
    .din14(arg2_r_14_reload),
    .din15(arg2_r_15_reload),
    .din16(tmp_22_fu_728_p17),
    .dout(tmp_22_fu_728_p18)
);
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289241_fu_100 <= add212_1249_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289241_fu_100 <= add_ln143_fu_495_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_1242_fu_104 <= add212_2250_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_1242_fu_104 <= add_ln143_1_fu_524_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_2243_fu_108 <= add212_3251_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_2243_fu_108 <= add_ln143_2_fu_586_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_3244_fu_112 <= add212_4252_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_3244_fu_112 <= add_ln143_3_fu_647_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_4245_fu_116 <= add212_5253_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_4245_fu_116 <= add_ln143_4_fu_713_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_5246_fu_120 <= add212_6254_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_5246_fu_120 <= add_ln143_5_fu_765_p2;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289241_out_ap_vld = 1'b1;
    end else begin
        add289241_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1242_out_ap_vld = 1'b1;
    end else begin
        add289_1242_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2243_out_ap_vld = 1'b1;
    end else begin
        add289_2243_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_3244_out_ap_vld = 1'b1;
    end else begin
        add289_3244_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_4245_out_ap_vld = 1'b1;
    end else begin
        add289_4245_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_5246_out_ap_vld = 1'b1;
    end else begin
        add289_5246_out_ap_vld = 1'b0;
    end
end
...
assign add289241_out = add289241_fu_100;

assign add289_1242_out = add289_1242_fu_104;

assign add289_2243_out = add289_2243_fu_108;

assign add289_3244_out = add289_3244_fu_112;

assign add289_4245_out = add289_4245_fu_116;

assign add289_5246_out = add289_5246_fu_120;

assign add_ln130_fu_444_p2 = ($signed(ap_sig_allocacmp_i_3) + $signed(3'd7));

assign add_ln143_1_fu_524_p2 = (and_ln143_1_fu_518_p2 + add289_1242_fu_104);

assign add_ln143_2_fu_586_p2 = (and_ln143_2_fu_580_p2 + add289_2243_fu_108);

assign add_ln143_3_fu_647_p2 = (and_ln143_3_fu_641_p2 + add289_3244_fu_112);

assign add_ln143_4_fu_713_p2 = (and_ln143_4_fu_707_p2 + add289_4245_fu_116);

assign add_ln143_5_fu_765_p2 = (mul_ln143_5_fu_304_p2 + add289_5246_fu_120);

assign add_ln143_fu_495_p2 = (and_ln143_fu_489_p2 + add289241_fu_100);
...
assign sext_ln143_1_fu_592_p1 = $signed(sub_ln35_6_reg_958);

assign sub_ln35_6_fu_426_p2 = ($signed(sub_ln35_fu_410_p2) - $signed(zext_ln35_2_fu_422_p1));

assign sub_ln35_7_fu_656_p2 = ($signed(sext_ln143_1_fu_592_p1) - $signed(zext_ln144_fu_653_p1));

assign sub_ln35_fu_410_p2 = (select_ln143_2_fu_392_p3 - zext_ln35_fu_406_p1);

assign tmp_19_fu_533_p17 = sub_ln35_reg_948;

assign tmp_22_fu_728_p17 = (sub_ln35_7_fu_656_p2 - zext_ln144_1_fu_719_p1);
...
assign zext_ln35_2_fu_422_p1 = icmp_ln143_2_fu_416_p2;
