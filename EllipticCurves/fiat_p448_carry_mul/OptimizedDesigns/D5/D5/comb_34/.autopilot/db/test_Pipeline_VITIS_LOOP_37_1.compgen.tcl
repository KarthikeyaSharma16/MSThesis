...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_6283_out \
    op interface \
    ports { add_6283_out { O 64 vector } add_6283_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_5282_out \
    op interface \
    ports { add_5282_out { O 64 vector } add_5282_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_4281_out \
    op interface \
    ports { add_4281_out { O 64 vector } add_4281_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_3280_out \
    op interface \
    ports { add_3280_out { O 64 vector } add_3280_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add_2279_out { O 64 vector } add_2279_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_1278_out \
    op interface \
    ports { add_1278_out { O 64 vector } add_1278_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add277_out \
    op interface \
    ports { add277_out { O 64 vector } add277_out_ap_vld { O 1 bit } } \
} "
}
