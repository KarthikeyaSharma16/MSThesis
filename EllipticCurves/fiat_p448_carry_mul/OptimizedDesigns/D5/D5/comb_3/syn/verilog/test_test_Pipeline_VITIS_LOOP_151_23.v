...
module test_test_Pipeline_VITIS_LOOP_151_23 (
        ...
        arg1_r_9_reload,
        add346_5498_out,
        add346_5498_out_ap_vld,
        add346_4497_out,
        add346_4497_out_ap_vld,
        add346_3496_out,
        add346_3496_out_ap_vld,
        add346_277495_out,
        add346_277495_out_ap_vld,
        add346_162494_out,
        add346_162494_out_ap_vld,
        add346493_out,
        add346493_out_ap_vld
);
...
output  [63:0] add346_5498_out;
output   add346_5498_out_ap_vld;
output  [63:0] add346_4497_out;
output   add346_4497_out_ap_vld;
output  [63:0] add346_3496_out;
output   add346_3496_out_ap_vld;
output  [63:0] add346_277495_out;
output   add346_277495_out_ap_vld;
output  [63:0] add346_162494_out;
output   add346_162494_out_ap_vld;
output  [63:0] add346493_out;
output   add346493_out_ap_vld;

reg ap_idle;
reg add346_5498_out_ap_vld;
reg add346_4497_out_ap_vld;
reg add346_3496_out_ap_vld;
reg add346_277495_out_ap_vld;
reg add346_162494_out_ap_vld;
reg add346493_out_ap_vld;
...
reg   [63:0] add346493_fu_122;
wire   [63:0] add_ln165_2_fu_946_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add346_162494_fu_126;
wire   [63:0] add_ln165_5_fu_977_p2;
reg   [63:0] add346_277495_fu_130;
wire   [63:0] add_ln165_8_fu_1022_p2;
reg   [63:0] add346_3496_fu_134;
wire   [63:0] add_ln165_11_fu_1080_p2;
reg   [63:0] add346_4497_fu_138;
wire   [63:0] add_ln165_13_fu_1157_p2;
reg   [63:0] add346_5498_fu_142;
...
always @ (*) begin
    if (((icmp_ln151_fu_467_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346493_out_ap_vld = 1'b1;
    end else begin
        add346493_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_467_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_162494_out_ap_vld = 1'b1;
    end else begin
        add346_162494_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_467_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_277495_out_ap_vld = 1'b1;
    end else begin
        add346_277495_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_467_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_3496_out_ap_vld = 1'b1;
    end else begin
        add346_3496_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_467_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_4497_out_ap_vld = 1'b1;
    end else begin
        add346_4497_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_467_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_5498_out_ap_vld = 1'b1;
    end else begin
        add346_5498_out_ap_vld = 1'b0;
    end
end
...
assign add346493_out = add346493_fu_122;

assign add346_162494_out = add346_162494_fu_126;

assign add346_277495_out = add346_277495_fu_130;

assign add346_3496_out = add346_3496_fu_134;

assign add346_4497_out = add346_4497_fu_138;

assign add346_5498_out = add346_5498_fu_142;
...
assign add_ln165_11_fu_1080_p2 = (add346_3496_fu_134 + add_ln165_10_fu_1074_p2);

assign add_ln165_12_fu_1151_p2 = (and_ln165_7_fu_1145_p2 + and_ln165_6_fu_1132_p2);

assign add_ln165_13_fu_1157_p2 = (add346_4497_fu_138 + add_ln165_12_fu_1151_p2);

assign add_ln165_14_fu_1216_p2 = (and_ln165_8_fu_1210_p2 + add346_5498_fu_142);

assign add_ln165_1_fu_940_p2 = (add_ln165_fu_934_p2 + mul_ln165_1_fu_368_p2);

assign add_ln165_2_fu_946_p2 = (add346493_fu_122 + add_ln165_1_fu_940_p2);
...
assign add_ln165_5_fu_977_p2 = (add346_162494_fu_126 + add_ln165_4_fu_971_p2);
...
assign add_ln165_8_fu_1022_p2 = (add346_277495_fu_130 + add_ln165_7_fu_1016_p2);
...
assign tmp_68_fu_667_p17 = sub_ln35_18_fu_658_p2;

assign tmp_69_fu_713_p17 = $signed(sub_ln35_19_fu_703_p2);

assign tmp_72_fu_812_p17 = sub_ln35_20_fu_803_p2;

assign tmp_73_fu_852_p17 = $signed(sub_ln35_21_fu_842_p2);

assign tmp_76_fu_1098_p17 = sub_ln35_22_fu_1089_p2;

assign tmp_77_fu_1176_p17 = $signed(sub_ln35_23_fu_1166_p2);
