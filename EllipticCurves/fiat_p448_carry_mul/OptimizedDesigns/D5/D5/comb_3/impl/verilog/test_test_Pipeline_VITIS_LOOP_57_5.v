...
module test_test_Pipeline_VITIS_LOOP_57_5 (
        ...
        arg2_r_9_reload,
        add102_6534_out,
        add102_6534_out_ap_vld,
        add102_5533_out,
        add102_5533_out_ap_vld,
        add102_4532_out,
        add102_4532_out_ap_vld,
        add102_3531_out,
        add102_3531_out_ap_vld,
        add102_2530_out,
        add102_2530_out_ap_vld,
        add102_1529_out,
        add102_1529_out_ap_vld,
        add102528_out,
        add102528_out_ap_vld
);
...
output  [63:0] add102_6534_out;
output   add102_6534_out_ap_vld;
output  [63:0] add102_5533_out;
output   add102_5533_out_ap_vld;
output  [63:0] add102_4532_out;
output   add102_4532_out_ap_vld;
output  [63:0] add102_3531_out;
output   add102_3531_out_ap_vld;
output  [63:0] add102_2530_out;
output   add102_2530_out_ap_vld;
output  [63:0] add102_1529_out;
output   add102_1529_out_ap_vld;
output  [63:0] add102528_out;
output   add102528_out_ap_vld;

reg ap_idle;
reg add102_6534_out_ap_vld;
reg add102_5533_out_ap_vld;
reg add102_4532_out_ap_vld;
reg add102_3531_out_ap_vld;
reg add102_2530_out_ap_vld;
reg add102_1529_out_ap_vld;
reg add102528_out_ap_vld;
...
wire  signed [2:0] sub_ln35_24_fu_486_p2;
reg  signed [2:0] sub_ln35_24_reg_1089;
...
reg   [63:0] add102528_fu_96;
wire   [63:0] add_ln70_fu_431_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add102_1529_fu_100;
wire   [63:0] add_ln70_1_fu_476_p2;
reg   [63:0] add102_2530_fu_104;
wire   [63:0] add_ln70_2_fu_632_p2;
reg   [63:0] add102_3531_fu_108;
wire   [63:0] add_ln70_3_fu_689_p2;
reg   [63:0] add102_4532_fu_112;
wire   [63:0] add_ln70_4_fu_745_p2;
reg   [63:0] add102_5533_fu_116;
wire   [63:0] add_ln70_5_fu_809_p2;
reg   [63:0] add102_6534_fu_120;
...
wire   [2:0] sub_ln35_25_fu_502_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add102_1529_fu_100 <= 64'd0;
        end else if (((icmp_ln57_fu_342_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add102_1529_fu_100 <= add_ln70_1_fu_476_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add102_2530_fu_104 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add102_2530_fu_104 <= add_ln70_2_fu_632_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add102_3531_fu_108 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add102_3531_fu_108 <= add_ln70_3_fu_689_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add102_4532_fu_112 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add102_4532_fu_112 <= add_ln70_4_fu_745_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add102_5533_fu_116 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add102_5533_fu_116 <= add_ln70_5_fu_809_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            add102_6534_fu_120 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add102_6534_fu_120 <= add_ln70_6_fu_860_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln57_fu_342_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        sub_ln35_24_reg_1089 <= sub_ln35_24_fu_486_p2;
...
always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102528_out_ap_vld = 1'b1;
    end else begin
        add102528_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_1529_out_ap_vld = 1'b1;
    end else begin
        add102_1529_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_2530_out_ap_vld = 1'b1;
    end else begin
        add102_2530_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_3531_out_ap_vld = 1'b1;
    end else begin
        add102_3531_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_4532_out_ap_vld = 1'b1;
    end else begin
        add102_4532_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_5533_out_ap_vld = 1'b1;
    end else begin
        add102_5533_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_6534_out_ap_vld = 1'b1;
    end else begin
        add102_6534_out_ap_vld = 1'b0;
    end
end
...
assign add102528_out = add102528_fu_96;

assign add102_1529_out = add102_1529_fu_100;

assign add102_2530_out = add102_2530_fu_104;

assign add102_3531_out = add102_3531_fu_108;

assign add102_4532_out = add102_4532_fu_112;

assign add102_5533_out = add102_5533_fu_116;

assign add102_6534_out = add102_6534_fu_120;

assign add_ln57_fu_540_p2 = ($signed(i_fu_124) + $signed(4'd15));

assign add_ln70_1_fu_476_p2 = (and_ln70_1_fu_470_p2 + add102_1529_fu_100);

assign add_ln70_2_fu_632_p2 = (and_ln70_2_fu_626_p2 + add102_2530_fu_104);

assign add_ln70_3_fu_689_p2 = (and_ln70_3_fu_683_p2 + add102_3531_fu_108);

assign add_ln70_4_fu_745_p2 = (and_ln70_4_fu_739_p2 + add102_4532_fu_112);

assign add_ln70_5_fu_809_p2 = (and_ln70_5_fu_803_p2 + add102_5533_fu_116);

assign add_ln70_6_fu_860_p2 = (mul_ln70_6_fu_291_p2 + add102_6534_fu_120);

assign add_ln70_fu_431_p2 = (and_ln70_fu_425_p2 + add102528_fu_96);
...
assign sext_ln70_1_fu_508_p1 = $signed(sub_ln35_25_fu_502_p2);

assign sub_ln35_1_fu_754_p2 = (sub_ln35_reg_1109 - zext_ln71_1_fu_751_p1);

assign sub_ln35_24_fu_486_p2 = (select_ln70_2_fu_437_p3 - zext_ln35_fu_482_p1);

assign sub_ln35_25_fu_502_p2 = ($signed(sub_ln35_24_fu_486_p2) - $signed(zext_ln35_1_fu_498_p1));

assign sub_ln35_fu_522_p2 = ($signed(sext_ln70_1_fu_508_p1) - $signed(zext_ln71_fu_518_p1));

assign tmp_2_fu_579_p17 = sub_ln35_24_reg_1089;
