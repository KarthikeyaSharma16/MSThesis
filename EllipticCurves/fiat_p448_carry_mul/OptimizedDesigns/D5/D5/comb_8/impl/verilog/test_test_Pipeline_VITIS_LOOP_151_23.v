...
module test_test_Pipeline_VITIS_LOOP_151_23 (
        ...
        arg1_r_13_reload,
        add346_2_1380_out,
        add346_2_1380_out_ap_vld,
        add346_2379_out,
        add346_2379_out_ap_vld,
        add346_176_1378_out,
        add346_176_1378_out_ap_vld,
        add346_176377_out,
        add346_176377_out_ap_vld,
        add346_190376_out,
        add346_190376_out_ap_vld,
        add346375_out,
        add346375_out_ap_vld
);
...
output  [63:0] add346_2_1380_out;
output   add346_2_1380_out_ap_vld;
output  [63:0] add346_2379_out;
output   add346_2379_out_ap_vld;
output  [63:0] add346_176_1378_out;
output   add346_176_1378_out_ap_vld;
output  [63:0] add346_176377_out;
output   add346_176377_out_ap_vld;
output  [63:0] add346_190376_out;
output   add346_190376_out_ap_vld;
output  [63:0] add346375_out;
output   add346375_out_ap_vld;

reg ap_idle;
reg add346_2_1380_out_ap_vld;
reg add346_2379_out_ap_vld;
reg add346_176_1378_out_ap_vld;
reg add346_176377_out_ap_vld;
reg add346_190376_out_ap_vld;
reg add346375_out_ap_vld;
...
wire   [31:0] tmp_22_fu_548_p17;
reg   [31:0] tmp_22_reg_1438;
...
reg   [63:0] add346375_fu_122;
wire   [63:0] add_ln165_1_fu_837_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add346_190376_fu_126;
wire   [63:0] add_ln165_3_fu_862_p2;
reg   [63:0] add346_176377_fu_130;
wire   [63:0] add_ln165_5_fu_900_p2;
reg   [63:0] add346_176_1378_fu_134;
wire   [63:0] add_ln165_7_fu_968_p2;
reg   [63:0] add346_2379_fu_138;
wire   [63:0] add_ln165_9_fu_1045_p2;
reg   [63:0] add346_2_1380_fu_142;
...
wire   [31:0] tmp_17_fu_660_p7;
wire   [31:0] tmp_18_fu_678_p7;
wire  signed [3:0] tmp_19_fu_699_p17;
wire   [31:0] tmp_19_fu_699_p18;
wire   [2:0] zext_ln35_2_fu_726_p1;
wire  signed [2:0] sub_ln35_7_fu_729_p2;
wire  signed [3:0] tmp_20_fu_738_p17;
wire   [31:0] tmp_20_fu_738_p18;
wire   [2:0] zext_ln35_3_fu_765_p1;
wire   [2:0] sub_ln35_8_fu_768_p2;
wire  signed [3:0] tmp_21_fu_778_p17;
wire   [31:0] tmp_21_fu_778_p18;
wire   [31:0] tmp_23_fu_814_p7;
...
wire  signed [3:0] tmp_24_fu_909_p17;
wire   [31:0] tmp_24_fu_909_p18;
...
wire  signed [3:0] tmp_25_fu_986_p17;
wire   [31:0] tmp_25_fu_986_p18;
...
wire  signed [3:0] tmp_26_fu_1064_p17;
wire   [31:0] tmp_26_fu_1064_p18;
...
always @ (*) begin
    if (((icmp_ln151_fu_451_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346375_out_ap_vld = 1'b1;
    end else begin
        add346375_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_451_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_176377_out_ap_vld = 1'b1;
    end else begin
        add346_176377_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_451_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_176_1378_out_ap_vld = 1'b1;
    end else begin
        add346_176_1378_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_451_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_190376_out_ap_vld = 1'b1;
    end else begin
        add346_190376_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_451_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_2379_out_ap_vld = 1'b1;
    end else begin
        add346_2379_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_451_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_2_1380_out_ap_vld = 1'b1;
    end else begin
        add346_2_1380_out_ap_vld = 1'b0;
    end
end
...
assign add346375_out = add346375_fu_122;

assign add346_176377_out = add346_176377_fu_130;

assign add346_176_1378_out = add346_176_1378_fu_134;

assign add346_190376_out = add346_190376_fu_126;

assign add346_2379_out = add346_2379_fu_138;

assign add346_2_1380_out = add346_2_1380_fu_142;
...
assign add_ln165_10_fu_1104_p2 = (and_ln165_7_fu_1098_p2 + add346_2_1380_fu_142);

assign add_ln165_1_fu_837_p2 = (add346375_fu_122 + add_ln165_fu_831_p2);

assign add_ln165_2_fu_856_p2 = (mul_ln165_3_fu_376_p2 + and_ln165_fu_850_p2);

assign add_ln165_3_fu_862_p2 = (add346_190376_fu_126 + add_ln165_2_fu_856_p2);

assign add_ln165_4_fu_894_p2 = (and_ln165_2_fu_888_p2 + and_ln165_1_fu_875_p2);

assign add_ln165_5_fu_900_p2 = (add346_176377_fu_130 + add_ln165_4_fu_894_p2);

assign add_ln165_6_fu_962_p2 = (and_ln165_4_fu_956_p2 + and_ln165_3_fu_943_p2);

assign add_ln165_7_fu_968_p2 = (add346_176_1378_fu_134 + add_ln165_6_fu_962_p2);

assign add_ln165_8_fu_1039_p2 = (and_ln165_6_fu_1033_p2 + and_ln165_5_fu_1020_p2);

assign add_ln165_9_fu_1045_p2 = (add346_2379_fu_138 + add_ln165_8_fu_1039_p2);
...
assign mul_ln165_4_fu_380_p00 = tmp_19_fu_699_p18;
...
assign tmp_19_fu_699_p17 = sub_ln35_6_reg_1415;

assign tmp_20_fu_738_p17 = sub_ln35_7_fu_729_p2;

assign tmp_21_fu_778_p17 = $signed(sub_ln35_8_fu_768_p2);

assign tmp_24_fu_909_p17 = sub_ln35_9_reg_1448;

assign tmp_25_fu_986_p17 = sub_ln35_10_fu_977_p2;

assign tmp_26_fu_1064_p17 = $signed(sub_ln35_11_fu_1054_p2);

assign zext_ln165_1_fu_672_p1 = tmp_17_fu_660_p7;

assign zext_ln165_2_fu_690_p1 = tmp_18_fu_678_p7;

assign zext_ln165_6_fu_805_p1 = tmp_22_reg_1438;
