...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        arg1_r_5_reload,
        add289_5656_out,
        add289_5656_out_ap_vld,
        add289_4655_out,
        add289_4655_out_ap_vld,
        add289_3654_out,
        add289_3654_out_ap_vld,
        add289_2653_out,
        add289_2653_out_ap_vld,
        add289_1103652_out,
        add289_1103652_out_ap_vld,
        add289651_out,
        add289651_out_ap_vld
);
...
output  [63:0] add289_5656_out;
output   add289_5656_out_ap_vld;
output  [63:0] add289_4655_out;
output   add289_4655_out_ap_vld;
output  [63:0] add289_3654_out;
output   add289_3654_out_ap_vld;
output  [63:0] add289_2653_out;
output   add289_2653_out_ap_vld;
output  [63:0] add289_1103652_out;
output   add289_1103652_out_ap_vld;
output  [63:0] add289651_out;
output   add289651_out_ap_vld;

reg ap_idle;
reg add289_5656_out_ap_vld;
reg add289_4655_out_ap_vld;
reg add289_3654_out_ap_vld;
reg add289_2653_out_ap_vld;
reg add289_1103652_out_ap_vld;
reg add289651_out_ap_vld;
...
reg   [63:0] add289651_fu_106;
wire   [63:0] add_ln143_fu_543_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add289_1103652_fu_110;
wire   [63:0] add_ln143_2_fu_796_p2;
reg   [63:0] add289_2653_fu_114;
wire   [63:0] add_ln143_4_fu_851_p2;
reg   [63:0] add289_3654_fu_118;
wire   [63:0] add_ln143_6_fu_942_p2;
reg   [63:0] add289_4655_fu_122;
wire   [63:0] add_ln143_8_fu_1019_p2;
reg   [63:0] add289_5656_fu_126;
...
wire   [2:0] zext_ln35_6_fu_857_p1;
...
always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289651_out_ap_vld = 1'b1;
    end else begin
        add289651_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1103652_out_ap_vld = 1'b1;
    end else begin
        add289_1103652_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2653_out_ap_vld = 1'b1;
    end else begin
        add289_2653_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_3654_out_ap_vld = 1'b1;
    end else begin
        add289_3654_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_4655_out_ap_vld = 1'b1;
    end else begin
        add289_4655_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_5656_out_ap_vld = 1'b1;
    end else begin
        add289_5656_out_ap_vld = 1'b0;
    end
end
...
assign add289651_out = add289651_fu_106;

assign add289_1103652_out = add289_1103652_fu_110;

assign add289_2653_out = add289_2653_fu_114;

assign add289_3654_out = add289_3654_fu_118;

assign add289_4655_out = add289_4655_fu_122;

assign add289_5656_out = add289_5656_fu_126;

assign add_ln130_fu_492_p2 = ($signed(ap_sig_allocacmp_i_4) + $signed(3'd6));

assign add_ln143_10_fu_1078_p2 = (add289_5656_fu_126 + add_ln143_9_fu_1072_p2);

assign add_ln143_1_fu_790_p2 = (and_ln143_2_fu_784_p2 + and_ln143_1_fu_771_p2);

assign add_ln143_2_fu_796_p2 = (add289_1103652_fu_110 + add_ln143_1_fu_790_p2);

assign add_ln143_3_fu_845_p2 = (and_ln143_4_fu_839_p2 + and_ln143_3_fu_826_p2);

assign add_ln143_4_fu_851_p2 = (add289_2653_fu_114 + add_ln143_3_fu_845_p2);

assign add_ln143_5_fu_936_p2 = (and_ln143_6_fu_930_p2 + and_ln143_5_fu_917_p2);

assign add_ln143_6_fu_942_p2 = (add289_3654_fu_118 + add_ln143_5_fu_936_p2);

assign add_ln143_7_fu_1013_p2 = (and_ln143_7_fu_1007_p2 + mul_ln143_7_fu_318_p2);

assign add_ln143_8_fu_1019_p2 = (add289_4655_fu_122 + add_ln143_7_fu_1013_p2);

assign add_ln143_9_fu_1072_p2 = (mul_ln143_10_fu_330_p2 + mul_ln143_9_fu_326_p2);

assign add_ln143_fu_543_p2 = (and_ln143_fu_537_p2 + add289651_fu_106);
...
assign sub_ln35_10_fu_951_p2 = ($signed(sub_ln35_9_fu_860_p2) - $signed(zext_ln35_fu_948_p1));

assign sub_ln35_6_fu_569_p2 = (select_ln143_3_fu_549_p3 - zext_ln35_4_fu_566_p1);

assign sub_ln35_7_fu_622_p2 = ($signed(sub_ln35_6_fu_569_p2) - $signed(zext_ln35_5_fu_619_p1));

assign sub_ln35_8_fu_674_p2 = ($signed(sext_ln143_8_fu_628_p1) - $signed(zext_ln144_fu_671_p1));

assign sub_ln35_9_fu_860_p2 = (select_ln143_6_fu_802_p3 - zext_ln35_6_fu_857_p1);

assign tmp_12_fu_579_p17 = sub_ln35_6_fu_569_p2;

assign tmp_17_fu_870_p17 = sub_ln35_9_fu_860_p2;

assign tmp_19_fu_1034_p17 = ($signed(sext_ln143_10_fu_957_p1) - $signed(zext_ln144_1_fu_1025_p1));

assign tmp_20_fu_440_p3 = {{1'd1}, {ap_sig_allocacmp_i_4}};
...
assign zext_ln35_4_fu_566_p1 = icmp_ln143_1_reg_1271;

assign zext_ln35_5_fu_619_p1 = icmp_ln143_2_reg_1277;

assign zext_ln35_6_fu_857_p1 = icmp_ln143_5_reg_1301;

assign zext_ln35_fu_948_p1 = icmp_ln143_6_reg_1307;
