...
output  [63:0] add_6693_out;
output   add_6693_out_ap_vld;
output  [63:0] add_5692_out;
output   add_5692_out_ap_vld;
output  [63:0] add_4691_out;
output   add_4691_out_ap_vld;
output  [63:0] add_3690_out;
output   add_3690_out_ap_vld;
output  [63:0] add_2689_out;
output   add_2689_out_ap_vld;
output  [63:0] add_1688_out;
output   add_1688_out_ap_vld;
output  [63:0] add687_out;
output   add687_out_ap_vld;

reg ap_idle;
reg add_6693_out_ap_vld;
reg add_5692_out_ap_vld;
reg add_4691_out_ap_vld;
reg add_3690_out_ap_vld;
reg add_2689_out_ap_vld;
reg add_1688_out_ap_vld;
reg add687_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add687_out_ap_vld = 1'b1;
    end else begin
        add687_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1688_out_ap_vld = 1'b1;
    end else begin
        add_1688_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2689_out_ap_vld = 1'b1;
    end else begin
        add_2689_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3690_out_ap_vld = 1'b1;
    end else begin
        add_3690_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_4691_out_ap_vld = 1'b1;
    end else begin
        add_4691_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_5692_out_ap_vld = 1'b1;
    end else begin
        add_5692_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6693_out_ap_vld = 1'b1;
    end else begin
        add_6693_out_ap_vld = 1'b0;
    end
end
...
assign add687_out = arr_7_fu_100;

assign add_1688_out = arr_8_fu_104;

assign add_2689_out = arr_9_fu_108;

assign add_3690_out = arr_10_fu_112;

assign add_4691_out = arr_11_fu_116;

assign add_5692_out = arr_12_fu_120;

assign add_6693_out = arr_13_fu_124;
