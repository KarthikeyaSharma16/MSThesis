...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        add212_4301_reload,
        add212_3300_reload,
        add212_2255299_reload,
        add212_1245298_reload,
        arg1_r_3_reload,
        arg1_r_4_reload,
        arg1_r_5_reload,
        arg1_r_6_reload,
        ...
        arg1_r_2_reload,
        arg1_r_1_reload,
        add289_1203_2295_out,
        add289_1203_2295_out_ap_vld,
        add289_1203_1294_out,
        add289_1203_1294_out_ap_vld,
        add289_1203293_out,
        add289_1203293_out_ap_vld,
        add289_2232292_out,
        add289_2232292_out_ap_vld,
        add289_1219291_out,
        add289_1219291_out_ap_vld,
        add289290_out,
        add289290_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add212_6303_reload;
input  [63:0] add212_5302_reload;
input  [63:0] add212_4301_reload;
input  [63:0] add212_3300_reload;
input  [63:0] add212_2255299_reload;
input  [63:0] add212_1245298_reload;
...
output  [63:0] add289_1203_2295_out;
output   add289_1203_2295_out_ap_vld;
output  [63:0] add289_1203_1294_out;
output   add289_1203_1294_out_ap_vld;
output  [63:0] add289_1203293_out;
output   add289_1203293_out_ap_vld;
output  [63:0] add289_2232292_out;
output   add289_2232292_out_ap_vld;
output  [63:0] add289_1219291_out;
output   add289_1219291_out_ap_vld;
output  [63:0] add289290_out;
output   add289290_out_ap_vld;

reg ap_idle;
reg add289_1203_2295_out_ap_vld;
reg add289_1203_1294_out_ap_vld;
reg add289_1203293_out_ap_vld;
reg add289_2232292_out_ap_vld;
reg add289_1219291_out_ap_vld;
reg add289290_out_ap_vld;
...
wire  signed [2:0] sub_ln35_17_fu_460_p2;
reg  signed [2:0] sub_ln35_17_reg_1524;
...
wire  signed [2:0] sub_ln35_19_fu_502_p2;
reg  signed [2:0] sub_ln35_19_reg_1547;
wire   [0:0] icmp_ln143_8_fu_508_p2;
reg   [0:0] icmp_ln143_8_reg_1553;
reg   [63:0] add289290_fu_108;
wire   [63:0] add_ln143_fu_581_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add289_1219291_fu_112;
wire   [63:0] add_ln143_2_fu_843_p2;
reg   [63:0] add289_2232292_fu_116;
wire   [63:0] add_ln143_5_fu_1066_p2;
reg   [63:0] add289_1203293_fu_120;
wire   [63:0] add_ln143_8_fu_1120_p2;
reg   [63:0] add289_1203_1294_fu_124;
wire   [63:0] add_ln143_11_fu_1194_p2;
reg   [63:0] add289_1203_2295_fu_128;
...
wire  signed [2:0] sub_ln35_15_fu_607_p2;
wire  signed [3:0] tmp_50_fu_617_p17;
wire   [31:0] tmp_50_fu_617_p18;
wire   [2:0] zext_ln35_6_fu_657_p1;
wire   [2:0] sub_ln35_16_fu_660_p2;
wire  signed [3:0] sext_ln143_9_fu_666_p1;
wire   [31:0] tmp_51_fu_670_p18;
wire   [31:0] tmp_52_fu_709_p18;
wire   [31:0] tmp_53_fu_748_p18;
wire   [31:0] tmp_55_fu_787_p9;
...
wire  signed [3:0] tmp_56_fu_862_p17;
wire   [31:0] tmp_56_fu_862_p18;
wire   [2:0] zext_ln35_8_fu_902_p1;
wire   [2:0] sub_ln35_18_fu_905_p2;
wire  signed [3:0] sext_ln143_11_fu_910_p1;
wire   [31:0] tmp_57_fu_914_p18;
wire   [31:0] tmp_58_fu_953_p18;
wire   [31:0] tmp_59_fu_992_p9;
...
wire  signed [3:0] tmp_60_fu_1129_p17;
wire   [31:0] tmp_60_fu_1129_p18;
...
wire   [2:0] sub_ln35_20_fu_1203_p2;
wire  signed [3:0] tmp_61_fu_1212_p17;
wire   [31:0] tmp_61_fu_1212_p18;
...
always @ (*) begin
    if (((icmp_ln130_fu_394_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289290_out_ap_vld = 1'b1;
    end else begin
        add289290_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_394_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1203293_out_ap_vld = 1'b1;
    end else begin
        add289_1203293_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_394_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1203_1294_out_ap_vld = 1'b1;
    end else begin
        add289_1203_1294_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_394_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1203_2295_out_ap_vld = 1'b1;
    end else begin
        add289_1203_2295_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_394_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1219291_out_ap_vld = 1'b1;
    end else begin
        add289_1219291_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_394_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2232292_out_ap_vld = 1'b1;
    end else begin
        add289_2232292_out_ap_vld = 1'b0;
    end
end
...
assign add289290_out = add289290_fu_108;

assign add289_1203293_out = add289_1203293_fu_120;

assign add289_1203_1294_out = add289_1203_1294_fu_124;

assign add289_1203_2295_out = add289_1203_2295_fu_128;

assign add289_1219291_out = add289_1219291_fu_112;

assign add289_2232292_out = add289_2232292_fu_116;
...
assign add_ln143_11_fu_1194_p2 = (add289_1203_1294_fu_124 + add_ln143_10_fu_1188_p2);
...
assign add_ln143_14_fu_1263_p2 = (add289_1203_2295_fu_128 + add_ln143_13_fu_1257_p2);

assign add_ln143_1_fu_837_p2 = (and_ln143_2_fu_831_p2 + and_ln143_1_fu_818_p2);

assign add_ln143_2_fu_843_p2 = (add289_1219291_fu_112 + add_ln143_1_fu_837_p2);
...
assign add_ln143_5_fu_1066_p2 = (add289_2232292_fu_116 + add_ln143_4_fu_1060_p2);
...
assign add_ln143_8_fu_1120_p2 = (add289_1203293_fu_120 + add_ln143_7_fu_1114_p2);

assign add_ln143_9_fu_1182_p2 = (mul_ln143_11_fu_336_p2 + and_ln143_8_fu_1176_p2);

assign add_ln143_fu_581_p2 = (and_ln143_fu_575_p2 + add289290_fu_108);
...
assign icmp_ln143_3_fu_436_p2 = ((tmp_54_fu_428_p3 > 4'd13) ? 1'b1 : 1'b0);

assign icmp_ln143_4_fu_450_p2 = ((tmp_54_fu_428_p3 > 4'd12) ? 1'b1 : 1'b0);

assign icmp_ln143_5_fu_466_p2 = ((tmp_54_fu_428_p3 > 4'd11) ? 1'b1 : 1'b0);
...
assign mul_ln143_4_fu_308_p00 = tmp_50_fu_617_p18;
...
assign sext_ln143_11_fu_910_p1 = $signed(sub_ln35_18_fu_905_p2);

assign sext_ln143_9_fu_666_p1 = $signed(sub_ln35_16_fu_660_p2);

assign sub_ln35_15_fu_607_p2 = (select_ln143_4_fu_587_p3 - zext_ln35_fu_604_p1);

assign sub_ln35_16_fu_660_p2 = ($signed(sub_ln35_15_fu_607_p2) - $signed(zext_ln35_6_fu_657_p1));

assign sub_ln35_17_fu_460_p2 = (select_ln143_7_fu_442_p3 - zext_ln35_7_fu_456_p1);

assign sub_ln35_18_fu_905_p2 = ($signed(sub_ln35_17_reg_1524) - $signed(zext_ln35_8_fu_902_p1));

assign sub_ln35_19_fu_502_p2 = (select_ln143_11_fu_484_p3 - zext_ln35_9_fu_498_p1);

assign sub_ln35_20_fu_1203_p2 = ($signed(sub_ln35_19_reg_1547) - $signed(zext_ln35_10_fu_1200_p1));

assign tmp_50_fu_617_p17 = sub_ln35_15_fu_607_p2;

assign tmp_54_fu_428_p3 = {{1'd1}, {ap_sig_allocacmp_i_4}};

assign tmp_56_fu_862_p17 = sub_ln35_17_reg_1524;

assign tmp_60_fu_1129_p17 = sub_ln35_19_reg_1547;

assign tmp_61_fu_1212_p17 = $signed(sub_ln35_20_fu_1203_p2);

assign zext_ln130_fu_400_p1 = ap_sig_allocacmp_i_4;

assign zext_ln143_11_fu_1007_p1 = tmp_59_fu_992_p9;

assign zext_ln143_6_fu_802_p1 = tmp_55_fu_787_p9;
