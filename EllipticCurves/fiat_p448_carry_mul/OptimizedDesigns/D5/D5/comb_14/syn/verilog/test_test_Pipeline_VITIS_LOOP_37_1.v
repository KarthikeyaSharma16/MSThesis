...
output  [63:0] add_6332_out;
output   add_6332_out_ap_vld;
output  [63:0] add_5331_out;
output   add_5331_out_ap_vld;
output  [63:0] add_4330_out;
output   add_4330_out_ap_vld;
output  [63:0] add_3329_out;
output   add_3329_out_ap_vld;
output  [63:0] add_2328_out;
output   add_2328_out_ap_vld;
output  [63:0] add_1327_out;
output   add_1327_out_ap_vld;
output  [63:0] add326_out;
output   add326_out_ap_vld;

reg ap_idle;
reg add_6332_out_ap_vld;
reg add_5331_out_ap_vld;
reg add_4330_out_ap_vld;
reg add_3329_out_ap_vld;
reg add_2328_out_ap_vld;
reg add_1327_out_ap_vld;
reg add326_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add326_out_ap_vld = 1'b1;
    end else begin
        add326_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1327_out_ap_vld = 1'b1;
    end else begin
        add_1327_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2328_out_ap_vld = 1'b1;
    end else begin
        add_2328_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3329_out_ap_vld = 1'b1;
    end else begin
        add_3329_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_4330_out_ap_vld = 1'b1;
    end else begin
        add_4330_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_5331_out_ap_vld = 1'b1;
    end else begin
        add_5331_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6332_out_ap_vld = 1'b1;
    end else begin
        add_6332_out_ap_vld = 1'b0;
    end
end
...
assign add326_out = arr_71_fu_100;

assign add_1327_out = arr_72_fu_104;

assign add_2328_out = arr_73_fu_108;

assign add_3329_out = arr_74_fu_112;

assign add_4330_out = arr_75_fu_116;

assign add_5331_out = arr_76_fu_120;

assign add_6332_out = arr_77_fu_124;
