...
module test_test_Pipeline_VITIS_LOOP_57_5 (
        ...
        arg2_r_9_reload,
        add102_6325_out,
        add102_6325_out_ap_vld,
        add102_5324_out,
        add102_5324_out_ap_vld,
        add102_4323_out,
        add102_4323_out_ap_vld,
        add102_3322_out,
        add102_3322_out_ap_vld,
        add102_2321_out,
        add102_2321_out_ap_vld,
        add102_1320_out,
        add102_1320_out_ap_vld,
        add102319_out,
        add102319_out_ap_vld
);
...
output  [63:0] add102_6325_out;
output   add102_6325_out_ap_vld;
output  [63:0] add102_5324_out;
output   add102_5324_out_ap_vld;
output  [63:0] add102_4323_out;
output   add102_4323_out_ap_vld;
output  [63:0] add102_3322_out;
output   add102_3322_out_ap_vld;
output  [63:0] add102_2321_out;
output   add102_2321_out_ap_vld;
output  [63:0] add102_1320_out;
output   add102_1320_out_ap_vld;
output  [63:0] add102319_out;
output   add102319_out_ap_vld;

reg ap_idle;
reg add102_6325_out_ap_vld;
reg add102_5324_out_ap_vld;
reg add102_4323_out_ap_vld;
reg add102_3322_out_ap_vld;
reg add102_2321_out_ap_vld;
reg add102_1320_out_ap_vld;
reg add102319_out_ap_vld;
...
wire  signed [2:0] sub_ln35_23_fu_486_p2;
reg  signed [2:0] sub_ln35_23_reg_1089;
...
wire   [2:0] sub_ln35_24_fu_502_p2;
...
always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102319_out_ap_vld = 1'b1;
    end else begin
        add102319_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_1320_out_ap_vld = 1'b1;
    end else begin
        add102_1320_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_2321_out_ap_vld = 1'b1;
    end else begin
        add102_2321_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_3322_out_ap_vld = 1'b1;
    end else begin
        add102_3322_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_4323_out_ap_vld = 1'b1;
    end else begin
        add102_4323_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_5324_out_ap_vld = 1'b1;
    end else begin
        add102_5324_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_6325_out_ap_vld = 1'b1;
    end else begin
        add102_6325_out_ap_vld = 1'b0;
    end
end
...
assign add102319_out = arr_fu_96;

assign add102_1320_out = arr_58_fu_100;

assign add102_2321_out = arr_59_fu_104;

assign add102_3322_out = arr_60_fu_108;

assign add102_4323_out = arr_61_fu_112;

assign add102_5324_out = arr_62_fu_116;

assign add102_6325_out = arr_63_fu_120;
...
assign sext_ln70_1_fu_508_p1 = $signed(sub_ln35_24_fu_502_p2);

assign sub_ln35_23_fu_486_p2 = (select_ln70_2_fu_437_p3 - zext_ln35_2_fu_482_p1);

assign sub_ln35_24_fu_502_p2 = ($signed(sub_ln35_23_fu_486_p2) - $signed(zext_ln35_3_fu_498_p1));
...
assign tmp_9_fu_579_p17 = sub_ln35_23_reg_1089;
