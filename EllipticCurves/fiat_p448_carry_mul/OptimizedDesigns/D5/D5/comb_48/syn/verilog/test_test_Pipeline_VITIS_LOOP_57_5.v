...
module test_test_Pipeline_VITIS_LOOP_57_5 (
        ...
        arg2_r_9_reload,
        add102_6403_out,
        add102_6403_out_ap_vld,
        add102_5402_out,
        add102_5402_out_ap_vld,
        add102_4401_out,
        add102_4401_out_ap_vld,
        add102_3400_out,
        add102_3400_out_ap_vld,
        add102_2399_out,
        add102_2399_out_ap_vld,
        add102_1398_out,
        add102_1398_out_ap_vld,
        add102397_out,
        add102397_out_ap_vld
);
...
output  [63:0] add102_6403_out;
output   add102_6403_out_ap_vld;
output  [63:0] add102_5402_out;
output   add102_5402_out_ap_vld;
output  [63:0] add102_4401_out;
output   add102_4401_out_ap_vld;
output  [63:0] add102_3400_out;
output   add102_3400_out_ap_vld;
output  [63:0] add102_2399_out;
output   add102_2399_out_ap_vld;
output  [63:0] add102_1398_out;
output   add102_1398_out_ap_vld;
output  [63:0] add102397_out;
output   add102397_out_ap_vld;

reg ap_idle;
reg add102_6403_out_ap_vld;
reg add102_5402_out_ap_vld;
reg add102_4401_out_ap_vld;
reg add102_3400_out_ap_vld;
reg add102_2399_out_ap_vld;
reg add102_1398_out_ap_vld;
reg add102397_out_ap_vld;
...
reg   [63:0] add102397_fu_96;
wire   [63:0] add_ln70_fu_431_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add102_1398_fu_100;
wire   [63:0] add_ln70_1_fu_476_p2;
reg   [63:0] add102_2399_fu_104;
wire   [63:0] add_ln70_2_fu_632_p2;
reg   [63:0] add102_3400_fu_108;
wire   [63:0] add_ln70_3_fu_689_p2;
reg   [63:0] add102_4401_fu_112;
wire   [63:0] add_ln70_4_fu_745_p2;
reg   [63:0] add102_5402_fu_116;
wire   [63:0] add_ln70_5_fu_809_p2;
reg   [63:0] add102_6403_fu_120;
...
always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102397_out_ap_vld = 1'b1;
    end else begin
        add102397_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_1398_out_ap_vld = 1'b1;
    end else begin
        add102_1398_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_2399_out_ap_vld = 1'b1;
    end else begin
        add102_2399_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_3400_out_ap_vld = 1'b1;
    end else begin
        add102_3400_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_4401_out_ap_vld = 1'b1;
    end else begin
        add102_4401_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_5402_out_ap_vld = 1'b1;
    end else begin
        add102_5402_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_6403_out_ap_vld = 1'b1;
    end else begin
        add102_6403_out_ap_vld = 1'b0;
    end
end
...
assign add102397_out = add102397_fu_96;

assign add102_1398_out = add102_1398_fu_100;

assign add102_2399_out = add102_2399_fu_104;

assign add102_3400_out = add102_3400_fu_108;

assign add102_4401_out = add102_4401_fu_112;

assign add102_5402_out = add102_5402_fu_116;

assign add102_6403_out = add102_6403_fu_120;

assign add_ln57_fu_540_p2 = ($signed(i_fu_124) + $signed(4'd15));

assign add_ln70_1_fu_476_p2 = (and_ln70_1_fu_470_p2 + add102_1398_fu_100);

assign add_ln70_2_fu_632_p2 = (and_ln70_2_fu_626_p2 + add102_2399_fu_104);

assign add_ln70_3_fu_689_p2 = (and_ln70_3_fu_683_p2 + add102_3400_fu_108);

assign add_ln70_4_fu_745_p2 = (and_ln70_4_fu_739_p2 + add102_4401_fu_112);

assign add_ln70_5_fu_809_p2 = (and_ln70_5_fu_803_p2 + add102_5402_fu_116);

assign add_ln70_6_fu_860_p2 = (mul_ln70_6_fu_291_p2 + add102_6403_fu_120);

assign add_ln70_fu_431_p2 = (and_ln70_fu_425_p2 + add102397_fu_96);
...
assign tmp_10_fu_824_p17 = (sub_ln35_3_fu_754_p2 - zext_ln71_2_fu_815_p1);
