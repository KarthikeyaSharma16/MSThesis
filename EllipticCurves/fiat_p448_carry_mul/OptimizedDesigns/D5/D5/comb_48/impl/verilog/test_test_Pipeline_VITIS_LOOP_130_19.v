...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        arg2_r_10_reload,
        add289_5373_out,
        add289_5373_out_ap_vld,
        add289_4372_out,
        add289_4372_out_ap_vld,
        add289_3371_out,
        add289_3371_out_ap_vld,
        add289_2370_out,
        add289_2370_out_ap_vld,
        add289_1369_out,
        add289_1369_out_ap_vld,
        add289368_out,
        add289368_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add212_6381_reload;
input  [63:0] add212_5380_reload;
input  [63:0] add212_4379_reload;
input  [63:0] add212_3378_reload;
input  [63:0] add212_2377_reload;
input  [63:0] add212_1376_reload;
...
output  [63:0] add289_5373_out;
output   add289_5373_out_ap_vld;
output  [63:0] add289_4372_out;
output   add289_4372_out_ap_vld;
output  [63:0] add289_3371_out;
output   add289_3371_out_ap_vld;
output  [63:0] add289_2370_out;
output   add289_2370_out_ap_vld;
output  [63:0] add289_1369_out;
output   add289_1369_out_ap_vld;
output  [63:0] add289368_out;
output   add289368_out_ap_vld;

reg ap_idle;
reg add289_5373_out_ap_vld;
reg add289_4372_out_ap_vld;
reg add289_3371_out_ap_vld;
reg add289_2370_out_ap_vld;
reg add289_1369_out_ap_vld;
reg add289368_out_ap_vld;
...
reg   [63:0] add289368_fu_100;
wire   [63:0] add_ln143_fu_495_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add289_1369_fu_104;
wire   [63:0] add_ln143_1_fu_524_p2;
reg   [63:0] add289_2370_fu_108;
wire   [63:0] add_ln143_2_fu_586_p2;
reg   [63:0] add289_3371_fu_112;
wire   [63:0] add_ln143_3_fu_647_p2;
reg   [63:0] add289_4372_fu_116;
wire   [63:0] add_ln143_4_fu_713_p2;
reg   [63:0] add289_5373_fu_120;
...
wire  signed [3:0] tmp_11_fu_533_p17;
wire   [31:0] tmp_11_fu_533_p18;
...
wire   [3:0] tmp_14_fu_728_p17;
wire   [31:0] tmp_14_fu_728_p18;
...
always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289368_out_ap_vld = 1'b1;
    end else begin
        add289368_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1369_out_ap_vld = 1'b1;
    end else begin
        add289_1369_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2370_out_ap_vld = 1'b1;
    end else begin
        add289_2370_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_3371_out_ap_vld = 1'b1;
    end else begin
        add289_3371_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_4372_out_ap_vld = 1'b1;
    end else begin
        add289_4372_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_5373_out_ap_vld = 1'b1;
    end else begin
        add289_5373_out_ap_vld = 1'b0;
    end
end
...
assign add289368_out = add289368_fu_100;

assign add289_1369_out = add289_1369_fu_104;

assign add289_2370_out = add289_2370_fu_108;

assign add289_3371_out = add289_3371_fu_112;

assign add289_4372_out = add289_4372_fu_116;

assign add289_5373_out = add289_5373_fu_120;

assign add_ln130_fu_444_p2 = ($signed(ap_sig_allocacmp_i_3) + $signed(3'd7));

assign add_ln143_1_fu_524_p2 = (and_ln143_1_fu_518_p2 + add289_1369_fu_104);

assign add_ln143_2_fu_586_p2 = (and_ln143_2_fu_580_p2 + add289_2370_fu_108);

assign add_ln143_3_fu_647_p2 = (and_ln143_3_fu_641_p2 + add289_3371_fu_112);

assign add_ln143_4_fu_713_p2 = (and_ln143_4_fu_707_p2 + add289_4372_fu_116);

assign add_ln143_5_fu_765_p2 = (mul_ln143_5_fu_304_p2 + add289_5373_fu_120);

assign add_ln143_fu_495_p2 = (and_ln143_fu_489_p2 + add289368_fu_100);
...
assign tmp_11_fu_533_p17 = sub_ln35_reg_948;

assign tmp_14_fu_728_p17 = (sub_ln35_7_fu_656_p2 - zext_ln144_1_fu_719_p1);
