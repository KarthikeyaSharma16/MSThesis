...
module test_test_Pipeline_VITIS_LOOP_57_5 (
        ...
        arg2_r_9_reload,
        add102_6395_out,
        add102_6395_out_ap_vld,
        add102_5394_out,
        add102_5394_out_ap_vld,
        add102_4393_out,
        add102_4393_out_ap_vld,
        add102_3392_out,
        add102_3392_out_ap_vld,
        add102_2391_out,
        add102_2391_out_ap_vld,
        add102_1390_out,
        add102_1390_out_ap_vld,
        add102389_out,
        add102389_out_ap_vld
);
...
output  [63:0] add102_6395_out;
output   add102_6395_out_ap_vld;
output  [63:0] add102_5394_out;
output   add102_5394_out_ap_vld;
output  [63:0] add102_4393_out;
output   add102_4393_out_ap_vld;
output  [63:0] add102_3392_out;
output   add102_3392_out_ap_vld;
output  [63:0] add102_2391_out;
output   add102_2391_out_ap_vld;
output  [63:0] add102_1390_out;
output   add102_1390_out_ap_vld;
output  [63:0] add102389_out;
output   add102389_out_ap_vld;

reg ap_idle;
reg add102_6395_out_ap_vld;
reg add102_5394_out_ap_vld;
reg add102_4393_out_ap_vld;
reg add102_3392_out_ap_vld;
reg add102_2391_out_ap_vld;
reg add102_1390_out_ap_vld;
reg add102389_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102389_out_ap_vld = 1'b1;
    end else begin
        add102389_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_1390_out_ap_vld = 1'b1;
    end else begin
        add102_1390_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_2391_out_ap_vld = 1'b1;
    end else begin
        add102_2391_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_3392_out_ap_vld = 1'b1;
    end else begin
        add102_3392_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_4393_out_ap_vld = 1'b1;
    end else begin
        add102_4393_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_5394_out_ap_vld = 1'b1;
    end else begin
        add102_5394_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_6395_out_ap_vld = 1'b1;
    end else begin
        add102_6395_out_ap_vld = 1'b0;
    end
end
...
assign add102389_out = arr_fu_96;

assign add102_1390_out = arr_1_fu_100;

assign add102_2391_out = arr_2_fu_104;

assign add102_3392_out = arr_3_fu_108;

assign add102_4393_out = arr_4_fu_112;

assign add102_5394_out = arr_5_fu_116;

assign add102_6395_out = arr_6_fu_120;
