...
module test_test_Pipeline_VITIS_LOOP_151_23 (
        ...
        arg2_r_14_reload,
        add346_1_2359_out,
        add346_1_2359_out_ap_vld,
        add346_1_1358_out,
        add346_1_1358_out_ap_vld,
        add346_1357_out,
        add346_1357_out_ap_vld,
        add346_2356_out,
        add346_2356_out_ap_vld,
        add346_161355_out,
        add346_161355_out_ap_vld,
        add346354_out,
        add346354_out_ap_vld
);
...
output  [63:0] add346_1_2359_out;
output   add346_1_2359_out_ap_vld;
output  [63:0] add346_1_1358_out;
output   add346_1_1358_out_ap_vld;
output  [63:0] add346_1357_out;
output   add346_1357_out_ap_vld;
output  [63:0] add346_2356_out;
output   add346_2356_out_ap_vld;
output  [63:0] add346_161355_out;
output   add346_161355_out_ap_vld;
output  [63:0] add346354_out;
output   add346354_out_ap_vld;

reg ap_idle;
reg add346_1_2359_out_ap_vld;
reg add346_1_1358_out_ap_vld;
reg add346_1357_out_ap_vld;
reg add346_2356_out_ap_vld;
reg add346_161355_out_ap_vld;
reg add346354_out_ap_vld;
...
wire   [31:0] tmp_46_fu_494_p8;
wire   [63:0] mul_ln165_fu_362_p2;
wire   [31:0] tmp_47_fu_517_p8;
...
always @ (*) begin
    if (((icmp_ln151_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346354_out_ap_vld = 1'b1;
    end else begin
        add346354_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_1357_out_ap_vld = 1'b1;
    end else begin
        add346_1357_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_161355_out_ap_vld = 1'b1;
    end else begin
        add346_161355_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_1_1358_out_ap_vld = 1'b1;
    end else begin
        add346_1_1358_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_1_2359_out_ap_vld = 1'b1;
    end else begin
        add346_1_2359_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_2356_out_ap_vld = 1'b1;
    end else begin
        add346_2356_out_ap_vld = 1'b0;
    end
end
...
assign add346354_out = add346354_fu_120;

assign add346_1357_out = add346_1357_fu_132;

assign add346_161355_out = add346_161355_fu_124;

assign add346_1_1358_out = add346_1_1358_fu_136;

assign add346_1_2359_out = add346_1_2359_fu_140;

assign add346_2356_out = add346_2356_fu_128;

assign add_ln151_fu_741_p2 = ($signed(i_fu_148) + $signed(4'd15));

assign add_ln158_fu_435_p2 = (k_fu_144 + 3'd1);

assign add_ln165_1_fu_554_p2 = (and_ln165_fu_548_p2 + add346_161355_fu_124);

assign add_ln165_2_fu_621_p2 = (and_ln165_1_fu_615_p2 + add346_2356_fu_128);

assign add_ln165_3_fu_798_p2 = (and_ln165_2_fu_792_p2 + add346_1357_fu_132);

assign add_ln165_4_fu_821_p2 = (and_ln165_3_fu_815_p2 + add346_1_1358_fu_136);

assign add_ln165_5_fu_844_p2 = (and_ln165_4_fu_838_p2 + add346_1_2359_fu_140);

assign add_ln165_fu_511_p2 = (mul_ln165_fu_362_p2 + add346354_fu_120);
...
assign tmp_51_fu_713_p17 = (sub_ln35_16_fu_669_p2 - zext_ln166_2_fu_703_p1);
