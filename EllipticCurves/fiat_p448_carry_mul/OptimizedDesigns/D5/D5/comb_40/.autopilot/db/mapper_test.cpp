...
using hls::sim::Byte;
extern "C" void test(Byte<4>*, int, int, int);
...
__xlx_out1_arg1_arg2__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_arg1)[i]);
  ...
  int __xlx_size_param_arg1 = 16;
  int __xlx_offset_param_arg1 = 16;
  int __xlx_offset_byte_param_arg1 = 16*4;
for (size_t i = 0; i < 16; ++i){
__xlx_out1_arg1_arg2__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_arg2)[i]);
}
  int __xlx_size_param_arg2 = 16;
  int __xlx_offset_param_arg2 = 32;
  int __xlx_offset_byte_param_arg2 = 32*4;
  // DUT call
