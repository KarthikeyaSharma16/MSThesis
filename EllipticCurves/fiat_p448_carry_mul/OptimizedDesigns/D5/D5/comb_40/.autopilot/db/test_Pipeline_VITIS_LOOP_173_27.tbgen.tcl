...
set C_modelArgList {
	...
	{ add385346_out int 64 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "arr_65", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add385346_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ arr_65 sc_in sc_lv 64 signal 0 } 
	{ arg1_r_8_reload sc_in sc_lv 32 signal 1 } 
	{ arg1_r_9_reload sc_in sc_lv 32 signal 2 } 
	{ arg1_r_10_reload sc_in sc_lv 32 signal 3 } 
	{ arg1_r_11_reload sc_in sc_lv 32 signal 4 } 
	{ arg1_r_12_reload sc_in sc_lv 32 signal 5 } 
	{ arg1_r_13_reload sc_in sc_lv 32 signal 6 } 
	{ arg1_r_14_reload sc_in sc_lv 32 signal 7 } 
	{ arg1_r_15_reload sc_in sc_lv 32 signal 8 } 
	...
	{ add385346_out sc_out sc_lv 64 signal 17 } 
	{ add385346_out_ap_vld sc_out sc_logic 1 outvld 17 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "arr_65", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "arr_65", "role": "default" }} , 
 	...
 	{ "name": "add385346_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add385346_out", "role": "default" }} , 
 	{ "name": "add385346_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add385346_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "arr_65", "Type" : "None", "Direction" : "I"},
			...
			{"Name" : "add385346_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_173_27", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter1", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U317", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_16_4_32_1_1_U318", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_8_3_32_1_1_U319", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	test_Pipeline_VITIS_LOOP_173_27 {
		arr_65 {Type I LastRead 0 FirstWrite -1}
		...
		add385346_out {Type O LastRead -1 FirstWrite 1}}}
...
set Spec2ImplPortList { 
	arr_65 { ap_none {  { arr_65 in_data 0 64 } } }
	...
	add385346_out { ap_vld {  { add385346_out out_data 1 64 }  { add385346_out_ap_vld out_vld 1 1 } } }
}
