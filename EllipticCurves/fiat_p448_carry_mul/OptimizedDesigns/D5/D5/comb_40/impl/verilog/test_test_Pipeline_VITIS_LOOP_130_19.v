...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        arg2_r_10_reload,
        add289_2_1358_out,
        add289_2_1358_out_ap_vld,
        add289_2357_out,
        add289_2357_out_ap_vld,
        add289_1_1356_out,
        add289_1_1356_out_ap_vld,
        add289_1355_out,
        add289_1355_out_ap_vld,
        add289_189354_out,
        add289_189354_out_ap_vld,
        add289353_out,
        add289353_out_ap_vld
);
...
output  [63:0] add289_2_1358_out;
output   add289_2_1358_out_ap_vld;
output  [63:0] add289_2357_out;
output   add289_2357_out_ap_vld;
output  [63:0] add289_1_1356_out;
output   add289_1_1356_out_ap_vld;
output  [63:0] add289_1355_out;
output   add289_1355_out_ap_vld;
output  [63:0] add289_189354_out;
output   add289_189354_out_ap_vld;
output  [63:0] add289353_out;
output   add289353_out_ap_vld;

reg ap_idle;
reg add289_2_1358_out_ap_vld;
reg add289_2357_out_ap_vld;
reg add289_1_1356_out_ap_vld;
reg add289_1355_out_ap_vld;
reg add289_189354_out_ap_vld;
reg add289353_out_ap_vld;
...
wire   [31:0] tmp_44_fu_366_p9;
reg   [31:0] tmp_44_reg_932;
...
wire   [2:0] zext_ln35_8_fu_406_p1;
wire   [2:0] zext_ln35_9_fu_422_p1;
...
wire  signed [3:0] tmp_45_fu_533_p17;
wire   [31:0] tmp_45_fu_533_p18;
...
wire   [3:0] sub_ln35_13_fu_656_p2;
wire   [31:0] tmp_47_fu_662_p18;
...
wire   [3:0] tmp_48_fu_728_p17;
wire   [31:0] tmp_48_fu_728_p18;
...
always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289353_out_ap_vld = 1'b1;
    end else begin
        add289353_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1355_out_ap_vld = 1'b1;
    end else begin
        add289_1355_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_189354_out_ap_vld = 1'b1;
    end else begin
        add289_189354_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1_1356_out_ap_vld = 1'b1;
    end else begin
        add289_1_1356_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2357_out_ap_vld = 1'b1;
    end else begin
        add289_2357_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2_1358_out_ap_vld = 1'b1;
    end else begin
        add289_2_1358_out_ap_vld = 1'b0;
    end
end
...
assign add289353_out = add289353_fu_100;

assign add289_1355_out = add289_1355_fu_108;

assign add289_189354_out = add289_189354_fu_104;

assign add289_1_1356_out = add289_1_1356_fu_112;

assign add289_2357_out = add289_2357_fu_116;

assign add289_2_1358_out = add289_2_1358_fu_120;

assign add_ln130_fu_444_p2 = ($signed(ap_sig_allocacmp_i_4) + $signed(3'd7));

assign add_ln143_1_fu_524_p2 = (and_ln143_1_fu_518_p2 + add289_189354_fu_104);

assign add_ln143_2_fu_586_p2 = (and_ln143_2_fu_580_p2 + add289_1355_fu_108);

assign add_ln143_3_fu_647_p2 = (and_ln143_3_fu_641_p2 + add289_1_1356_fu_112);

assign add_ln143_4_fu_713_p2 = (and_ln143_4_fu_707_p2 + add289_2357_fu_116);

assign add_ln143_5_fu_765_p2 = (mul_ln143_5_fu_304_p2 + add289_2_1358_fu_120);

assign add_ln143_fu_495_p2 = (and_ln143_fu_489_p2 + add289353_fu_100);
...
assign sext_ln143_1_fu_592_p1 = $signed(sub_ln35_12_reg_958);

assign sub_ln35_12_fu_426_p2 = ($signed(sub_ln35_fu_410_p2) - $signed(zext_ln35_9_fu_422_p1));

assign sub_ln35_13_fu_656_p2 = ($signed(sext_ln143_1_fu_592_p1) - $signed(zext_ln144_fu_653_p1));

assign sub_ln35_fu_410_p2 = (select_ln143_2_fu_392_p3 - zext_ln35_8_fu_406_p1);

assign tmp_45_fu_533_p17 = sub_ln35_reg_948;

assign tmp_48_fu_728_p17 = (sub_ln35_13_fu_656_p2 - zext_ln144_1_fu_719_p1);

assign zext_ln130_fu_356_p1 = ap_sig_allocacmp_i_4;

assign zext_ln143_fu_473_p1 = tmp_44_reg_932;

assign zext_ln144_1_fu_719_p1 = icmp_ln143_4_reg_969;

assign zext_ln144_fu_653_p1 = icmp_ln143_3_reg_963;

assign zext_ln35_8_fu_406_p1 = icmp_ln143_1_fu_400_p2;

assign zext_ln35_9_fu_422_p1 = icmp_ln143_2_fu_416_p2;
