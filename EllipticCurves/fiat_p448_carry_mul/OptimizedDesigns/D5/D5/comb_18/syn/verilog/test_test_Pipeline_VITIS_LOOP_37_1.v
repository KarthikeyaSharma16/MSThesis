...
output  [63:0] add_6194_out;
output   add_6194_out_ap_vld;
output  [63:0] add_5193_out;
output   add_5193_out_ap_vld;
output  [63:0] add_4192_out;
output   add_4192_out_ap_vld;
output  [63:0] add_3191_out;
output   add_3191_out_ap_vld;
output  [63:0] add_2190_out;
output   add_2190_out_ap_vld;
output  [63:0] add_1189_out;
output   add_1189_out_ap_vld;
output  [63:0] add188_out;
output   add188_out_ap_vld;

reg ap_idle;
reg add_6194_out_ap_vld;
reg add_5193_out_ap_vld;
reg add_4192_out_ap_vld;
reg add_3191_out_ap_vld;
reg add_2190_out_ap_vld;
reg add_1189_out_ap_vld;
reg add188_out_ap_vld;
...
wire  signed [2:0] sub_ln35_12_fu_486_p2;
reg  signed [2:0] sub_ln35_12_reg_1099;
...
wire   [2:0] sub_ln35_13_fu_502_p2;
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add188_out_ap_vld = 1'b1;
    end else begin
        add188_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1189_out_ap_vld = 1'b1;
    end else begin
        add_1189_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2190_out_ap_vld = 1'b1;
    end else begin
        add_2190_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3191_out_ap_vld = 1'b1;
    end else begin
        add_3191_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_4192_out_ap_vld = 1'b1;
    end else begin
        add_4192_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6194_out_ap_vld = 1'b1;
    end else begin
        add_6194_out_ap_vld = 1'b0;
    end
end
...
assign add188_out = arr_71_fu_100;

assign add_1189_out = arr_72_fu_104;

assign add_2190_out = arr_73_fu_108;

assign add_3191_out = arr_74_fu_112;

assign add_4192_out = arr_75_fu_116;

assign add_5193_out = arr_76_fu_120;

assign add_6194_out = arr_77_fu_124;
...
assign sext_ln50_1_fu_508_p1 = $signed(sub_ln35_13_fu_502_p2);

assign sub_ln35_12_fu_486_p2 = (select_ln50_2_fu_437_p3 - zext_ln35_fu_482_p1);

assign sub_ln35_13_fu_502_p2 = ($signed(sub_ln35_12_fu_486_p2) - $signed(zext_ln35_1_fu_498_p1));
...
assign tmp_2_fu_589_p17 = sub_ln35_12_reg_1099;
