...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        add212_4487_reload,
        add212_3486_reload,
        add212_2181485_reload,
        add212_1172484_reload,
        arg1_r_1_reload,
        arg1_r_2_reload,
        arg1_r_3_reload,
        arg1_r_4_reload,
        ...
        arg2_r_10_reload,
        add289_5481_out,
        add289_5481_out_ap_vld,
        add289_4480_out,
        add289_4480_out_ap_vld,
        add289_3479_out,
        add289_3479_out_ap_vld,
        add289_2478_out,
        add289_2478_out_ap_vld,
        add289_1477_out,
        add289_1477_out_ap_vld,
        add289476_out,
        add289476_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add212_6489_reload;
input  [63:0] add212_5488_reload;
input  [63:0] add212_4487_reload;
input  [63:0] add212_3486_reload;
input  [63:0] add212_2181485_reload;
input  [63:0] add212_1172484_reload;
...
output  [63:0] add289_5481_out;
output   add289_5481_out_ap_vld;
output  [63:0] add289_4480_out;
output   add289_4480_out_ap_vld;
output  [63:0] add289_3479_out;
output   add289_3479_out_ap_vld;
output  [63:0] add289_2478_out;
output   add289_2478_out_ap_vld;
output  [63:0] add289_1477_out;
output   add289_1477_out_ap_vld;
output  [63:0] add289476_out;
output   add289476_out_ap_vld;

reg ap_idle;
reg add289_5481_out_ap_vld;
reg add289_4480_out_ap_vld;
reg add289_3479_out_ap_vld;
reg add289_2478_out_ap_vld;
reg add289_1477_out_ap_vld;
reg add289476_out_ap_vld;
...
reg   [63:0] add289476_fu_100;
wire   [63:0] add_ln143_fu_495_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add289_1477_fu_104;
wire   [63:0] add_ln143_1_fu_524_p2;
reg   [63:0] add289_2478_fu_108;
wire   [63:0] add_ln143_2_fu_586_p2;
reg   [63:0] add289_3479_fu_112;
wire   [63:0] add_ln143_3_fu_647_p2;
reg   [63:0] add289_4480_fu_116;
wire   [63:0] add_ln143_4_fu_713_p2;
reg   [63:0] add289_5481_fu_120;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289476_fu_100 <= add212_1172484_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289476_fu_100 <= add_ln143_fu_495_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_1477_fu_104 <= add212_2181485_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_1477_fu_104 <= add_ln143_1_fu_524_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_2478_fu_108 <= add212_3486_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_2478_fu_108 <= add_ln143_2_fu_586_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_3479_fu_112 <= add212_4487_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_3479_fu_112 <= add_ln143_3_fu_647_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_4480_fu_116 <= add212_5488_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_4480_fu_116 <= add_ln143_4_fu_713_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_5481_fu_120 <= add212_6489_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_5481_fu_120 <= add_ln143_5_fu_765_p2;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289476_out_ap_vld = 1'b1;
    end else begin
        add289476_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1477_out_ap_vld = 1'b1;
    end else begin
        add289_1477_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2478_out_ap_vld = 1'b1;
    end else begin
        add289_2478_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_3479_out_ap_vld = 1'b1;
    end else begin
        add289_3479_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_4480_out_ap_vld = 1'b1;
    end else begin
        add289_4480_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_5481_out_ap_vld = 1'b1;
    end else begin
        add289_5481_out_ap_vld = 1'b0;
    end
end
...
assign add289476_out = add289476_fu_100;

assign add289_1477_out = add289_1477_fu_104;

assign add289_2478_out = add289_2478_fu_108;

assign add289_3479_out = add289_3479_fu_112;

assign add289_4480_out = add289_4480_fu_116;

assign add289_5481_out = add289_5481_fu_120;

assign add_ln130_fu_444_p2 = ($signed(ap_sig_allocacmp_i_4) + $signed(3'd7));

assign add_ln143_1_fu_524_p2 = (and_ln143_1_fu_518_p2 + add289_1477_fu_104);

assign add_ln143_2_fu_586_p2 = (and_ln143_2_fu_580_p2 + add289_2478_fu_108);

assign add_ln143_3_fu_647_p2 = (and_ln143_3_fu_641_p2 + add289_3479_fu_112);

assign add_ln143_4_fu_713_p2 = (and_ln143_4_fu_707_p2 + add289_4480_fu_116);

assign add_ln143_5_fu_765_p2 = (mul_ln143_5_fu_304_p2 + add289_5481_fu_120);

assign add_ln143_fu_495_p2 = (and_ln143_fu_489_p2 + add289476_fu_100);
