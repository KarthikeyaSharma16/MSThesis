...
output  [63:0] add_6285_out;
output   add_6285_out_ap_vld;
output  [63:0] add_5284_out;
output   add_5284_out_ap_vld;
output  [63:0] add_4283_out;
output   add_4283_out_ap_vld;
output  [63:0] add_3282_out;
output   add_3282_out_ap_vld;
output  [63:0] add_2281_out;
output   add_2281_out_ap_vld;
output  [63:0] add_1280_out;
output   add_1280_out_ap_vld;
output  [63:0] add279_out;
output   add279_out_ap_vld;

reg ap_idle;
reg add_6285_out_ap_vld;
reg add_5284_out_ap_vld;
reg add_4283_out_ap_vld;
reg add_3282_out_ap_vld;
reg add_2281_out_ap_vld;
reg add_1280_out_ap_vld;
reg add279_out_ap_vld;
...
reg  signed [2:0] sub_ln35_24_reg_1099;
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add279_out_ap_vld = 1'b1;
    end else begin
        add279_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1280_out_ap_vld = 1'b1;
    end else begin
        add_1280_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2281_out_ap_vld = 1'b1;
    end else begin
        add_2281_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3282_out_ap_vld = 1'b1;
    end else begin
        add_3282_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_4283_out_ap_vld = 1'b1;
    end else begin
        add_4283_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_5284_out_ap_vld = 1'b1;
    end else begin
        add_5284_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6285_out_ap_vld = 1'b1;
    end else begin
        add_6285_out_ap_vld = 1'b0;
    end
end
...
assign add279_out = arr_71_fu_100;

assign add_1280_out = arr_72_fu_104;

assign add_2281_out = arr_73_fu_108;

assign add_3282_out = arr_74_fu_112;

assign add_4283_out = arr_75_fu_116;

assign add_5284_out = arr_76_fu_120;

assign add_6285_out = arr_77_fu_124;
...
assign icmp_ln50_3_fu_538_p2 = ((tmp_69_fu_528_p4 != 2'd0) ? 1'b1 : 1'b0);
...
assign select_ln50_1_fu_417_p3 = ((tmp_68_fu_409_p3[0:0] == 1'b1) ? 64'd18446744073709551615 : 64'd0);

assign select_ln50_2_fu_437_p3 = ((tmp_67_fu_401_p3[0:0] == 1'b1) ? 3'd6 : 3'd7);
...
assign select_ln50_fu_445_p3 = ((tmp_67_fu_401_p3[0:0] == 1'b1) ? arg2_r_14_reload : arg2_r_15_reload);

assign sext_ln50_1_fu_508_p1 = $signed(sub_ln35_25_fu_502_p2);

assign sub_ln35_1_fu_764_p2 = (sub_ln35_reg_1119 - zext_ln51_1_fu_761_p1);

assign sub_ln35_24_fu_486_p2 = (select_ln50_2_fu_437_p3 - zext_ln35_fu_482_p1);
...
assign tmp_2_fu_589_p17 = sub_ln35_24_reg_1099;

assign tmp_67_fu_401_p3 = empty_fu_358_p2[32'd3];

assign tmp_68_fu_409_p3 = empty_fu_358_p2[32'd3];

assign tmp_69_fu_528_p4 = {{empty_fu_358_p2[3:2]}};
