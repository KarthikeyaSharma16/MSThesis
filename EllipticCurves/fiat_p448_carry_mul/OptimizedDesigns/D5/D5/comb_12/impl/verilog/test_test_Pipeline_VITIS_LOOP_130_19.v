...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        arg2_r_10_reload,
        add289_2_1377_out,
        add289_2_1377_out_ap_vld,
        add289_2376_out,
        add289_2376_out_ap_vld,
        add289_1_1375_out,
        add289_1_1375_out_ap_vld,
        add289_1374_out,
        add289_1374_out_ap_vld,
        add289_176373_out,
        add289_176373_out_ap_vld,
        add289372_out,
        add289372_out_ap_vld
);
...
output  [63:0] add289_2_1377_out;
output   add289_2_1377_out_ap_vld;
output  [63:0] add289_2376_out;
output   add289_2376_out_ap_vld;
output  [63:0] add289_1_1375_out;
output   add289_1_1375_out_ap_vld;
output  [63:0] add289_1374_out;
output   add289_1374_out_ap_vld;
output  [63:0] add289_176373_out;
output   add289_176373_out_ap_vld;
output  [63:0] add289372_out;
output   add289372_out_ap_vld;

reg ap_idle;
reg add289_2_1377_out_ap_vld;
reg add289_2376_out_ap_vld;
reg add289_1_1375_out_ap_vld;
reg add289_1374_out_ap_vld;
reg add289_176373_out_ap_vld;
reg add289372_out_ap_vld;
...
wire   [31:0] tmp_63_fu_366_p9;
reg   [31:0] tmp_63_reg_932;
...
reg   [63:0] add289372_fu_100;
wire   [63:0] add_ln143_fu_495_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add289_176373_fu_104;
wire   [63:0] add_ln143_1_fu_524_p2;
reg   [63:0] add289_1374_fu_108;
wire   [63:0] add_ln143_2_fu_586_p2;
reg   [63:0] add289_1_1375_fu_112;
wire   [63:0] add_ln143_3_fu_647_p2;
reg   [63:0] add289_2376_fu_116;
wire   [63:0] add_ln143_4_fu_713_p2;
reg   [63:0] add289_2_1377_fu_120;
...
wire  signed [3:0] tmp_64_fu_533_p17;
wire   [31:0] tmp_64_fu_533_p18;
...
wire   [3:0] tmp_67_fu_728_p17;
wire   [31:0] tmp_67_fu_728_p18;
...
mux_16_4_32_1_1_U249(
    ...
    .din16(tmp_64_fu_533_p17),
    .dout(tmp_64_fu_533_p18)
);
...
mux_16_4_32_1_1_U252(
    ...
    .din14(arg2_r_14_reload),
    .din15(arg2_r_15_reload),
    .din16(tmp_67_fu_728_p17),
    .dout(tmp_67_fu_728_p18)
);
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289372_fu_100 <= arr_51;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289372_fu_100 <= add_ln143_fu_495_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_1374_fu_108 <= arr_53;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_1374_fu_108 <= add_ln143_2_fu_586_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_176373_fu_104 <= arr_52;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_176373_fu_104 <= add_ln143_1_fu_524_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_1_1375_fu_112 <= arr_54;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_1_1375_fu_112 <= add_ln143_3_fu_647_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_2376_fu_116 <= arr_55;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_2376_fu_116 <= add_ln143_4_fu_713_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_2_1377_fu_120 <= arr_56;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_2_1377_fu_120 <= add_ln143_5_fu_765_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln130_fu_350_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_63_reg_932 <= tmp_63_fu_366_p9;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289372_out_ap_vld = 1'b1;
    end else begin
        add289372_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1374_out_ap_vld = 1'b1;
    end else begin
        add289_1374_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_176373_out_ap_vld = 1'b1;
    end else begin
        add289_176373_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1_1375_out_ap_vld = 1'b1;
    end else begin
        add289_1_1375_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2376_out_ap_vld = 1'b1;
    end else begin
        add289_2376_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2_1377_out_ap_vld = 1'b1;
    end else begin
        add289_2_1377_out_ap_vld = 1'b0;
    end
end
...
assign add289372_out = add289372_fu_100;

assign add289_1374_out = add289_1374_fu_108;

assign add289_176373_out = add289_176373_fu_104;

assign add289_1_1375_out = add289_1_1375_fu_112;

assign add289_2376_out = add289_2376_fu_116;

assign add289_2_1377_out = add289_2_1377_fu_120;

assign add_ln130_fu_444_p2 = ($signed(ap_sig_allocacmp_i_4) + $signed(3'd7));

assign add_ln143_1_fu_524_p2 = (and_ln143_1_fu_518_p2 + add289_176373_fu_104);

assign add_ln143_2_fu_586_p2 = (and_ln143_2_fu_580_p2 + add289_1374_fu_108);

assign add_ln143_3_fu_647_p2 = (and_ln143_3_fu_641_p2 + add289_1_1375_fu_112);

assign add_ln143_4_fu_713_p2 = (and_ln143_4_fu_707_p2 + add289_2376_fu_116);

assign add_ln143_5_fu_765_p2 = (mul_ln143_5_fu_304_p2 + add289_2_1377_fu_120);

assign add_ln143_fu_495_p2 = (and_ln143_fu_489_p2 + add289372_fu_100);
...
assign tmp_64_fu_533_p17 = sub_ln35_44_reg_948;

assign tmp_67_fu_728_p17 = (sub_ln35_16_fu_656_p2 - zext_ln144_1_fu_719_p1);

assign zext_ln130_fu_356_p1 = ap_sig_allocacmp_i_4;

assign zext_ln143_fu_473_p1 = tmp_63_reg_932;
