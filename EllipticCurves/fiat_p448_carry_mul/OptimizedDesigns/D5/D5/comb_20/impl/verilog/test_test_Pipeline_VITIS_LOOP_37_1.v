...
output  [63:0] add_6485_out;
output   add_6485_out_ap_vld;
output  [63:0] add_5484_out;
output   add_5484_out_ap_vld;
output  [63:0] add_4483_out;
output   add_4483_out_ap_vld;
output  [63:0] add_3482_out;
output   add_3482_out_ap_vld;
output  [63:0] add_2481_out;
output   add_2481_out_ap_vld;
output  [63:0] add_1480_out;
output   add_1480_out_ap_vld;
output  [63:0] add479_out;
output   add479_out_ap_vld;

reg ap_idle;
reg add_6485_out_ap_vld;
reg add_5484_out_ap_vld;
reg add_4483_out_ap_vld;
reg add_3482_out_ap_vld;
reg add_2481_out_ap_vld;
reg add_1480_out_ap_vld;
reg add479_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add479_out_ap_vld = 1'b1;
    end else begin
        add479_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1480_out_ap_vld = 1'b1;
    end else begin
        add_1480_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2481_out_ap_vld = 1'b1;
    end else begin
        add_2481_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3482_out_ap_vld = 1'b1;
    end else begin
        add_3482_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_4483_out_ap_vld = 1'b1;
    end else begin
        add_4483_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_5484_out_ap_vld = 1'b1;
    end else begin
        add_5484_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6485_out_ap_vld = 1'b1;
    end else begin
        add_6485_out_ap_vld = 1'b0;
    end
end
...
assign add479_out = add479_fu_100;

assign add_1480_out = add_1480_fu_104;

assign add_2481_out = add_2481_fu_108;

assign add_3482_out = add_3482_fu_112;

assign add_4483_out = add_4483_fu_116;

assign add_5484_out = add_5484_fu_120;

assign add_6485_out = add_6485_fu_124;

assign add_ln37_fu_550_p2 = ($signed(i_fu_128) + $signed(4'd15));

assign add_ln50_1_fu_476_p2 = (and_ln50_1_fu_470_p2 + add_1480_fu_104);

assign add_ln50_2_fu_642_p2 = (and_ln50_2_fu_636_p2 + add_2481_fu_108);

assign add_ln50_3_fu_699_p2 = (and_ln50_3_fu_693_p2 + add_3482_fu_112);

assign add_ln50_4_fu_755_p2 = (and_ln50_4_fu_749_p2 + add_4483_fu_116);

assign add_ln50_5_fu_819_p2 = (and_ln50_5_fu_813_p2 + add_5484_fu_120);

assign add_ln50_6_fu_870_p2 = (mul_ln50_6_fu_295_p2 + add_6485_fu_124);

assign add_ln50_fu_431_p2 = (and_ln50_fu_425_p2 + add479_fu_100);
...
assign tmp_2_fu_589_p17 = sub_ln35_27_reg_1099;
