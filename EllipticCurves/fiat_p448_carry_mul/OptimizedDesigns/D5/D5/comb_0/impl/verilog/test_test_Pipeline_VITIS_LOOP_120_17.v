...
output  [63:0] add245_3270_out;
output   add245_3270_out_ap_vld;

reg ap_idle;
reg add245_3270_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_221_p3 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add245_3270_out_ap_vld = 1'b1;
    end else begin
        add245_3270_out_ap_vld = 1'b0;
    end
end
...
assign add245_3270_out = arr_fu_72;
...
assign add_ln126_fu_430_p2 = (k_1_fu_76 + 5'd4);
...
assign mul_ln126_1_fu_191_p10 = tmp_s_fu_294_p18;
...
assign mul_ln126_2_fu_195_p10 = tmp_74_fu_343_p18;
...
assign mul_ln126_3_fu_199_p10 = tmp_73_fu_239_p18;
...
assign mul_ln126_fu_187_p10 = tmp_75_fu_392_p18;
...
assign trunc_ln120_fu_235_p1 = k_1_fu_76[3:0];
