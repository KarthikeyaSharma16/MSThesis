...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        arg2_r_10_reload,
        add289_5269_out,
        add289_5269_out_ap_vld,
        add289_4268_out,
        add289_4268_out_ap_vld,
        add289_3267_out,
        add289_3267_out_ap_vld,
        add289_2266_out,
        add289_2266_out_ap_vld,
        add289_1265_out,
        add289_1265_out_ap_vld,
        add289264_out,
        add289264_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add212_6277_reload;
input  [63:0] add212_5276_reload;
input  [63:0] add212_4275_reload;
input  [63:0] add212_3274_reload;
input  [63:0] add212_2273_reload;
input  [63:0] add212_1272_reload;
...
output  [63:0] add289_5269_out;
output   add289_5269_out_ap_vld;
output  [63:0] add289_4268_out;
output   add289_4268_out_ap_vld;
output  [63:0] add289_3267_out;
output   add289_3267_out_ap_vld;
output  [63:0] add289_2266_out;
output   add289_2266_out_ap_vld;
output  [63:0] add289_1265_out;
output   add289_1265_out_ap_vld;
output  [63:0] add289264_out;
output   add289264_out_ap_vld;

reg ap_idle;
reg add289_5269_out_ap_vld;
reg add289_4268_out_ap_vld;
reg add289_3267_out_ap_vld;
reg add289_2266_out_ap_vld;
reg add289_1265_out_ap_vld;
reg add289264_out_ap_vld;
...
reg   [63:0] add289264_fu_100;
wire   [63:0] add_ln143_fu_495_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add289_1265_fu_104;
wire   [63:0] add_ln143_1_fu_524_p2;
reg   [63:0] add289_2266_fu_108;
wire   [63:0] add_ln143_2_fu_586_p2;
reg   [63:0] add289_3267_fu_112;
wire   [63:0] add_ln143_3_fu_647_p2;
reg   [63:0] add289_4268_fu_116;
wire   [63:0] add_ln143_4_fu_713_p2;
reg   [63:0] add289_5269_fu_120;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289264_fu_100 <= add212_1272_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289264_fu_100 <= add_ln143_fu_495_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_1265_fu_104 <= add212_2273_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_1265_fu_104 <= add_ln143_1_fu_524_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_2266_fu_108 <= add212_3274_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_2266_fu_108 <= add_ln143_2_fu_586_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_3267_fu_112 <= add212_4275_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_3267_fu_112 <= add_ln143_3_fu_647_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_4268_fu_116 <= add212_5276_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_4268_fu_116 <= add_ln143_4_fu_713_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_5269_fu_120 <= add212_6277_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_5269_fu_120 <= add_ln143_5_fu_765_p2;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289264_out_ap_vld = 1'b1;
    end else begin
        add289264_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1265_out_ap_vld = 1'b1;
    end else begin
        add289_1265_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2266_out_ap_vld = 1'b1;
    end else begin
        add289_2266_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_3267_out_ap_vld = 1'b1;
    end else begin
        add289_3267_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_4268_out_ap_vld = 1'b1;
    end else begin
        add289_4268_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_5269_out_ap_vld = 1'b1;
    end else begin
        add289_5269_out_ap_vld = 1'b0;
    end
end
...
assign add289264_out = add289264_fu_100;

assign add289_1265_out = add289_1265_fu_104;

assign add289_2266_out = add289_2266_fu_108;

assign add289_3267_out = add289_3267_fu_112;

assign add289_4268_out = add289_4268_fu_116;

assign add289_5269_out = add289_5269_fu_120;

assign add_ln130_fu_444_p2 = ($signed(ap_sig_allocacmp_i_4) + $signed(3'd7));

assign add_ln143_1_fu_524_p2 = (and_ln143_1_fu_518_p2 + add289_1265_fu_104);

assign add_ln143_2_fu_586_p2 = (and_ln143_2_fu_580_p2 + add289_2266_fu_108);

assign add_ln143_3_fu_647_p2 = (and_ln143_3_fu_641_p2 + add289_3267_fu_112);

assign add_ln143_4_fu_713_p2 = (and_ln143_4_fu_707_p2 + add289_4268_fu_116);

assign add_ln143_5_fu_765_p2 = (mul_ln143_5_fu_304_p2 + add289_5269_fu_120);

assign add_ln143_fu_495_p2 = (and_ln143_fu_489_p2 + add289264_fu_100);
