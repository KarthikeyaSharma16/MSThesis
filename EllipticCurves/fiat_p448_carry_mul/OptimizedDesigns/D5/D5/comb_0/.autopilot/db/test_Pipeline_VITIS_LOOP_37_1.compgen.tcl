...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_6306_out \
    op interface \
    ports { add_6306_out { O 64 vector } add_6306_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_5305_out \
    op interface \
    ports { add_5305_out { O 64 vector } add_5305_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_4304_out \
    op interface \
    ports { add_4304_out { O 64 vector } add_4304_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_3303_out \
    op interface \
    ports { add_3303_out { O 64 vector } add_3303_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_2302_out \
    op interface \
    ports { add_2302_out { O 64 vector } add_2302_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_1301_out \
    op interface \
    ports { add_1301_out { O 64 vector } add_1301_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add300_out \
    op interface \
    ports { add300_out { O 64 vector } add300_out_ap_vld { O 1 bit } } \
} "
}
