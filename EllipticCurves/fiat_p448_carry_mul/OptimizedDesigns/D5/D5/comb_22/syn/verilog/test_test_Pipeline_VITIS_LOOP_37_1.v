...
output  [63:0] add_6376_out;
output   add_6376_out_ap_vld;
output  [63:0] add_5375_out;
output   add_5375_out_ap_vld;
output  [63:0] add_4374_out;
output   add_4374_out_ap_vld;
output  [63:0] add_3373_out;
output   add_3373_out_ap_vld;
output  [63:0] add_2372_out;
output   add_2372_out_ap_vld;
output  [63:0] add_1371_out;
output   add_1371_out_ap_vld;
output  [63:0] add370_out;
output   add370_out_ap_vld;

reg ap_idle;
reg add_6376_out_ap_vld;
reg add_5375_out_ap_vld;
reg add_4374_out_ap_vld;
reg add_3373_out_ap_vld;
reg add_2372_out_ap_vld;
reg add_1371_out_ap_vld;
reg add370_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add370_out_ap_vld = 1'b1;
    end else begin
        add370_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1371_out_ap_vld = 1'b1;
    end else begin
        add_1371_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2372_out_ap_vld = 1'b1;
    end else begin
        add_2372_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3373_out_ap_vld = 1'b1;
    end else begin
        add_3373_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_4374_out_ap_vld = 1'b1;
    end else begin
        add_4374_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6376_out_ap_vld = 1'b1;
    end else begin
        add_6376_out_ap_vld = 1'b0;
    end
end
...
assign add370_out = add370_fu_100;

assign add_1371_out = add_1371_fu_104;

assign add_2372_out = add_2372_fu_108;

assign add_3373_out = add_3373_fu_112;

assign add_4374_out = add_4374_fu_116;

assign add_5375_out = add_5375_fu_120;

assign add_6376_out = add_6376_fu_124;

assign add_ln37_fu_550_p2 = ($signed(i_fu_128) + $signed(4'd15));

assign add_ln50_1_fu_476_p2 = (and_ln50_1_fu_470_p2 + add_1371_fu_104);

assign add_ln50_2_fu_642_p2 = (and_ln50_2_fu_636_p2 + add_2372_fu_108);

assign add_ln50_3_fu_699_p2 = (and_ln50_3_fu_693_p2 + add_3373_fu_112);

assign add_ln50_4_fu_755_p2 = (and_ln50_4_fu_749_p2 + add_4374_fu_116);

assign add_ln50_5_fu_819_p2 = (and_ln50_5_fu_813_p2 + add_5375_fu_120);

assign add_ln50_6_fu_870_p2 = (mul_ln50_6_fu_295_p2 + add_6376_fu_124);

assign add_ln50_fu_431_p2 = (and_ln50_fu_425_p2 + add370_fu_100);
