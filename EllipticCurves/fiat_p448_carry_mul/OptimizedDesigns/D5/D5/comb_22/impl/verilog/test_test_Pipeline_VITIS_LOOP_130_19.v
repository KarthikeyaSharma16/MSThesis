...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        arg1_r_1_reload,
        add289_5339_out,
        add289_5339_out_ap_vld,
        add289_4338_out,
        add289_4338_out_ap_vld,
        add289_3337_out,
        add289_3337_out_ap_vld,
        add289_2188336_out,
        add289_2188336_out_ap_vld,
        add289_1174335_out,
        add289_1174335_out_ap_vld,
        add289334_out,
        add289334_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add212_6347_reload;
input  [63:0] add212_5346_reload;
input  [63:0] add212_4345_reload;
input  [63:0] add212_3344_reload;
input  [63:0] add212_2343_reload;
input  [63:0] add212_1342_reload;
...
output  [63:0] add289_5339_out;
output   add289_5339_out_ap_vld;
output  [63:0] add289_4338_out;
output   add289_4338_out_ap_vld;
output  [63:0] add289_3337_out;
output   add289_3337_out_ap_vld;
output  [63:0] add289_2188336_out;
output   add289_2188336_out_ap_vld;
output  [63:0] add289_1174335_out;
output   add289_1174335_out_ap_vld;
output  [63:0] add289334_out;
output   add289334_out_ap_vld;

reg ap_idle;
reg add289_5339_out_ap_vld;
reg add289_4338_out_ap_vld;
reg add289_3337_out_ap_vld;
reg add289_2188336_out_ap_vld;
reg add289_1174335_out_ap_vld;
reg add289334_out_ap_vld;
...
wire  signed [2:0] sub_ln35_20_fu_460_p2;
reg  signed [2:0] sub_ln35_20_reg_1524;
...
wire  signed [2:0] sub_ln35_22_fu_502_p2;
reg  signed [2:0] sub_ln35_22_reg_1547;
wire   [0:0] icmp_ln143_8_fu_508_p2;
reg   [0:0] icmp_ln143_8_reg_1553;
reg   [63:0] add289334_fu_108;
wire   [63:0] add_ln143_fu_581_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add289_1174335_fu_112;
wire   [63:0] add_ln143_2_fu_843_p2;
reg   [63:0] add289_2188336_fu_116;
wire   [63:0] add_ln143_5_fu_1066_p2;
reg   [63:0] add289_3337_fu_120;
wire   [63:0] add_ln143_8_fu_1120_p2;
reg   [63:0] add289_4338_fu_124;
wire   [63:0] add_ln143_11_fu_1194_p2;
reg   [63:0] add289_5339_fu_128;
...
wire  signed [2:0] sub_ln35_18_fu_607_p2;
wire  signed [3:0] tmp_65_fu_617_p17;
wire   [31:0] tmp_65_fu_617_p18;
wire   [2:0] zext_ln35_10_fu_657_p1;
wire   [2:0] sub_ln35_19_fu_660_p2;
wire  signed [3:0] sext_ln143_9_fu_666_p1;
wire   [31:0] tmp_66_fu_670_p18;
wire   [31:0] tmp_67_fu_709_p18;
wire   [31:0] tmp_68_fu_748_p18;
wire   [31:0] tmp_70_fu_787_p9;
...
wire  signed [3:0] tmp_71_fu_862_p17;
wire   [31:0] tmp_71_fu_862_p18;
wire   [2:0] zext_ln35_12_fu_902_p1;
wire   [2:0] sub_ln35_21_fu_905_p2;
wire  signed [3:0] sext_ln143_11_fu_910_p1;
wire   [31:0] tmp_72_fu_914_p18;
wire   [31:0] tmp_73_fu_953_p18;
wire   [31:0] tmp_74_fu_992_p9;
...
wire  signed [3:0] tmp_75_fu_1129_p17;
wire   [31:0] tmp_75_fu_1129_p18;
...
wire   [2:0] sub_ln35_23_fu_1203_p2;
wire  signed [3:0] tmp_76_fu_1212_p17;
wire   [31:0] tmp_76_fu_1212_p18;
...
mux_16_4_32_1_1_U350(
    ...
    .din16(tmp_65_fu_617_p17),
    .dout(tmp_65_fu_617_p18)
);
...
mux_16_4_32_1_1_U355(
    ...
    .din14(arg2_r_14_reload),
    .din15(arg2_r_15_reload),
    .din16(tmp_71_fu_862_p17),
    .dout(tmp_71_fu_862_p18)
);
...
mux_16_4_32_1_1_U359(
    ...
    .din14(arg2_r_14_reload),
    .din15(arg2_r_15_reload),
    .din16(tmp_75_fu_1129_p17),
    .dout(tmp_75_fu_1129_p18)
);
...
mux_16_4_32_1_1_U360(
    ...
    .din14(arg2_r_14_reload),
    .din15(arg2_r_15_reload),
    .din16(tmp_76_fu_1212_p17),
    .dout(tmp_76_fu_1212_p18)
);
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289334_fu_108 <= add212_1342_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289334_fu_108 <= add_ln143_fu_581_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_1174335_fu_112 <= add212_2343_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_1174335_fu_112 <= add_ln143_2_fu_843_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_2188336_fu_116 <= add212_3344_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_2188336_fu_116 <= add_ln143_5_fu_1066_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_3337_fu_120 <= add212_4345_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_3337_fu_120 <= add_ln143_8_fu_1120_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_4338_fu_124 <= add212_5346_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_4338_fu_124 <= add_ln143_11_fu_1194_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add289_5339_fu_128 <= add212_6347_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add289_5339_fu_128 <= add_ln143_14_fu_1263_p2;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln130_fu_394_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289334_out_ap_vld = 1'b1;
    end else begin
        add289334_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_394_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1174335_out_ap_vld = 1'b1;
    end else begin
        add289_1174335_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_394_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2188336_out_ap_vld = 1'b1;
    end else begin
        add289_2188336_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_394_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_3337_out_ap_vld = 1'b1;
    end else begin
        add289_3337_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_394_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_4338_out_ap_vld = 1'b1;
    end else begin
        add289_4338_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_394_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_5339_out_ap_vld = 1'b1;
    end else begin
        add289_5339_out_ap_vld = 1'b0;
    end
end
...
assign add289334_out = add289334_fu_108;

assign add289_1174335_out = add289_1174335_fu_112;

assign add289_2188336_out = add289_2188336_fu_116;

assign add289_3337_out = add289_3337_fu_120;

assign add289_4338_out = add289_4338_fu_124;

assign add289_5339_out = add289_5339_fu_128;
...
assign add_ln143_11_fu_1194_p2 = (add289_4338_fu_124 + add_ln143_10_fu_1188_p2);
...
assign add_ln143_14_fu_1263_p2 = (add289_5339_fu_128 + add_ln143_13_fu_1257_p2);

assign add_ln143_1_fu_837_p2 = (and_ln143_2_fu_831_p2 + and_ln143_1_fu_818_p2);

assign add_ln143_2_fu_843_p2 = (add289_1174335_fu_112 + add_ln143_1_fu_837_p2);
...
assign add_ln143_5_fu_1066_p2 = (add289_2188336_fu_116 + add_ln143_4_fu_1060_p2);
...
assign add_ln143_8_fu_1120_p2 = (add289_3337_fu_120 + add_ln143_7_fu_1114_p2);

assign add_ln143_9_fu_1182_p2 = (mul_ln143_11_fu_336_p2 + and_ln143_8_fu_1176_p2);

assign add_ln143_fu_581_p2 = (and_ln143_fu_575_p2 + add289334_fu_108);
...
assign empty_41_fu_472_p2 = (zext_ln130_fu_400_p1 + 4'd7);
...
assign icmp_ln143_3_fu_436_p2 = ((tmp_69_fu_428_p3 > 4'd13) ? 1'b1 : 1'b0);

assign icmp_ln143_4_fu_450_p2 = ((tmp_69_fu_428_p3 > 4'd12) ? 1'b1 : 1'b0);

assign icmp_ln143_5_fu_466_p2 = ((tmp_69_fu_428_p3 > 4'd11) ? 1'b1 : 1'b0);

assign icmp_ln143_6_fu_478_p2 = ((empty_41_fu_472_p2 > 4'd12) ? 1'b1 : 1'b0);

assign icmp_ln143_7_fu_492_p2 = ((empty_41_fu_472_p2 > 4'd11) ? 1'b1 : 1'b0);

assign icmp_ln143_8_fu_508_p2 = ((empty_41_fu_472_p2 > 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln143_fu_410_p2 = ((empty_fu_404_p2 == 4'd15) ? 1'b1 : 1'b0);

assign mul_ln143_10_fu_332_p0 = mul_ln143_10_fu_332_p00;

assign mul_ln143_10_fu_332_p00 = tmp_67_fu_709_p18;

assign mul_ln143_10_fu_332_p1 = zext_ln143_fu_558_p1;

assign mul_ln143_11_fu_336_p0 = mul_ln143_11_fu_336_p00;

assign mul_ln143_11_fu_336_p00 = tmp_72_fu_914_p18;

assign mul_ln143_11_fu_336_p1 = zext_ln143_6_fu_802_p1;

assign mul_ln143_12_fu_340_p0 = mul_ln143_12_fu_340_p00;

assign mul_ln143_12_fu_340_p00 = tmp_76_fu_1212_p18;

assign mul_ln143_12_fu_340_p1 = zext_ln143_11_fu_1007_p1;

assign mul_ln143_13_fu_344_p0 = mul_ln143_13_fu_344_p00;

assign mul_ln143_13_fu_344_p00 = tmp_68_fu_748_p18;

assign mul_ln143_13_fu_344_p1 = zext_ln143_fu_558_p1;

assign mul_ln143_14_fu_348_p0 = mul_ln143_14_fu_348_p00;

assign mul_ln143_14_fu_348_p00 = tmp_73_fu_953_p18;
...
assign mul_ln143_4_fu_308_p00 = tmp_65_fu_617_p18;
...
assign sext_ln143_11_fu_910_p1 = $signed(sub_ln35_21_fu_905_p2);

assign sext_ln143_9_fu_666_p1 = $signed(sub_ln35_19_fu_660_p2);

assign sub_ln35_18_fu_607_p2 = (select_ln143_4_fu_587_p3 - zext_ln35_fu_604_p1);

assign sub_ln35_19_fu_660_p2 = ($signed(sub_ln35_18_fu_607_p2) - $signed(zext_ln35_10_fu_657_p1));

assign sub_ln35_20_fu_460_p2 = (select_ln143_7_fu_442_p3 - zext_ln35_11_fu_456_p1);

assign sub_ln35_21_fu_905_p2 = ($signed(sub_ln35_20_reg_1524) - $signed(zext_ln35_12_fu_902_p1));

assign sub_ln35_22_fu_502_p2 = (select_ln143_11_fu_484_p3 - zext_ln35_13_fu_498_p1);

assign sub_ln35_23_fu_1203_p2 = ($signed(sub_ln35_22_reg_1547) - $signed(zext_ln35_14_fu_1200_p1));

assign tmp_65_fu_617_p17 = sub_ln35_18_fu_607_p2;

assign tmp_69_fu_428_p3 = {{1'd1}, {ap_sig_allocacmp_i_3}};

assign tmp_71_fu_862_p17 = sub_ln35_20_reg_1524;

assign tmp_75_fu_1129_p17 = sub_ln35_22_reg_1547;

assign tmp_76_fu_1212_p17 = $signed(sub_ln35_23_fu_1203_p2);

assign zext_ln130_fu_400_p1 = ap_sig_allocacmp_i_3;

assign zext_ln143_11_fu_1007_p1 = tmp_74_fu_992_p9;

assign zext_ln143_6_fu_802_p1 = tmp_70_fu_787_p9;
