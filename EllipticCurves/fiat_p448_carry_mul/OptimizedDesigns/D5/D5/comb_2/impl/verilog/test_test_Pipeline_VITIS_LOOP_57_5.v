...
module test_test_Pipeline_VITIS_LOOP_57_5 (
        ...
        arg2_r_9_reload,
        add102_6360_out,
        add102_6360_out_ap_vld,
        add102_5359_out,
        add102_5359_out_ap_vld,
        add102_4358_out,
        add102_4358_out_ap_vld,
        add102_3357_out,
        add102_3357_out_ap_vld,
        add102_2356_out,
        add102_2356_out_ap_vld,
        add102_1355_out,
        add102_1355_out_ap_vld,
        add102354_out,
        add102354_out_ap_vld
);
...
output  [63:0] add102_6360_out;
output   add102_6360_out_ap_vld;
output  [63:0] add102_5359_out;
output   add102_5359_out_ap_vld;
output  [63:0] add102_4358_out;
output   add102_4358_out_ap_vld;
output  [63:0] add102_3357_out;
output   add102_3357_out_ap_vld;
output  [63:0] add102_2356_out;
output   add102_2356_out_ap_vld;
output  [63:0] add102_1355_out;
output   add102_1355_out_ap_vld;
output  [63:0] add102354_out;
output   add102354_out_ap_vld;

reg ap_idle;
reg add102_6360_out_ap_vld;
reg add102_5359_out_ap_vld;
reg add102_4358_out_ap_vld;
reg add102_3357_out_ap_vld;
reg add102_2356_out_ap_vld;
reg add102_1355_out_ap_vld;
reg add102354_out_ap_vld;
...
wire  signed [2:0] sub_ln35_32_fu_486_p2;
reg  signed [2:0] sub_ln35_32_reg_1089;
...
wire   [3:0] sub_ln35_3_fu_522_p2;
reg   [3:0] sub_ln35_3_reg_1109;
wire   [0:0] icmp_ln70_3_fu_528_p2;
reg   [0:0] icmp_ln70_3_reg_1115;
wire   [0:0] icmp_ln70_4_fu_534_p2;
reg   [0:0] icmp_ln70_4_reg_1121;
reg   [63:0] arr_fu_96;
wire   [63:0] arr_51_fu_431_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] arr_45_fu_100;
wire   [63:0] arr_52_fu_476_p2;
reg   [63:0] arr_46_fu_104;
wire   [63:0] arr_53_fu_632_p2;
reg   [63:0] arr_47_fu_108;
wire   [63:0] arr_54_fu_689_p2;
reg   [63:0] arr_48_fu_112;
wire   [63:0] arr_55_fu_745_p2;
reg   [63:0] arr_49_fu_116;
wire   [63:0] arr_56_fu_809_p2;
reg   [63:0] arr_50_fu_120;
wire   [63:0] arr_57_fu_860_p2;
reg   [3:0] i_fu_124;
...
wire   [31:0] tmp_7_fu_364_p18;
wire   [4:0] empty_fu_358_p2;
wire   [0:0] tmp_11_fu_409_p3;
...
wire   [3:0] sub_ln35_4_fu_754_p2;
wire   [31:0] tmp_8_fu_759_p18;
...
wire   [3:0] tmp_10_fu_824_p17;
wire   [31:0] tmp_10_fu_824_p18;
...
always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102354_out_ap_vld = 1'b1;
    end else begin
        add102354_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_1355_out_ap_vld = 1'b1;
    end else begin
        add102_1355_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_2356_out_ap_vld = 1'b1;
    end else begin
        add102_2356_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_3357_out_ap_vld = 1'b1;
    end else begin
        add102_3357_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_4358_out_ap_vld = 1'b1;
    end else begin
        add102_4358_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_5359_out_ap_vld = 1'b1;
    end else begin
        add102_5359_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_6360_out_ap_vld = 1'b1;
    end else begin
        add102_6360_out_ap_vld = 1'b0;
    end
end
...
assign add102354_out = arr_fu_96;

assign add102_1355_out = arr_45_fu_100;

assign add102_2356_out = arr_46_fu_104;

assign add102_3357_out = arr_47_fu_108;

assign add102_4358_out = arr_48_fu_112;

assign add102_5359_out = arr_49_fu_116;

assign add102_6360_out = arr_50_fu_120;

assign add_ln57_fu_540_p2 = ($signed(i_fu_124) + $signed(4'd15));
...
assign arr_51_fu_431_p2 = (and_ln70_fu_425_p2 + arr_fu_96);

assign arr_52_fu_476_p2 = (and_ln70_1_fu_470_p2 + arr_45_fu_100);

assign arr_53_fu_632_p2 = (and_ln70_2_fu_626_p2 + arr_46_fu_104);

assign arr_54_fu_689_p2 = (and_ln70_3_fu_683_p2 + arr_47_fu_108);

assign arr_55_fu_745_p2 = (and_ln70_4_fu_739_p2 + arr_48_fu_112);

assign arr_56_fu_809_p2 = (and_ln70_5_fu_803_p2 + arr_49_fu_116);

assign arr_57_fu_860_p2 = (mul_ln70_6_fu_291_p2 + arr_50_fu_120);

assign conv36_cast_fu_295_p1 = conv36;

assign empty_fu_358_p2 = (zext_ln57_fu_354_p1 + 5'd1);

assign icmp_ln57_fu_342_p2 = ((i_fu_124 > 4'd8) ? 1'b1 : 1'b0);
...
assign select_ln70_1_fu_417_p3 = ((tmp_11_fu_409_p3[0:0] == 1'b1) ? 64'd18446744073709551615 : 64'd0);

assign select_ln70_2_fu_437_p3 = ((tmp_fu_401_p3[0:0] == 1'b1) ? 3'd6 : 3'd7);
...
assign select_ln70_fu_445_p3 = ((tmp_fu_401_p3[0:0] == 1'b1) ? arg2_r_14_reload : arg2_r_15_reload);

assign sext_ln70_1_fu_508_p1 = $signed(sub_ln35_33_fu_502_p2);

assign sub_ln35_32_fu_486_p2 = (select_ln70_2_fu_437_p3 - zext_ln35_2_fu_482_p1);

assign sub_ln35_33_fu_502_p2 = ($signed(sub_ln35_32_fu_486_p2) - $signed(zext_ln35_3_fu_498_p1));

assign sub_ln35_3_fu_522_p2 = ($signed(sext_ln70_1_fu_508_p1) - $signed(zext_ln71_fu_518_p1));

assign sub_ln35_4_fu_754_p2 = (sub_ln35_3_reg_1109 - zext_ln71_1_fu_751_p1);

assign tmp_10_fu_824_p17 = (sub_ln35_4_fu_754_p2 - zext_ln71_2_fu_815_p1);

assign tmp_11_fu_409_p3 = empty_fu_358_p2[32'd4];

assign tmp_9_fu_579_p17 = sub_ln35_32_reg_1089;

assign tmp_fu_401_p3 = empty_fu_358_p2[32'd4];

assign zext_ln35_2_fu_482_p1 = icmp_ln70_fu_456_p2;

assign zext_ln35_3_fu_498_p1 = icmp_ln70_1_fu_492_p2;

assign zext_ln57_fu_354_p1 = i_fu_124;

assign zext_ln70_fu_395_p1 = tmp_7_fu_364_p18;
