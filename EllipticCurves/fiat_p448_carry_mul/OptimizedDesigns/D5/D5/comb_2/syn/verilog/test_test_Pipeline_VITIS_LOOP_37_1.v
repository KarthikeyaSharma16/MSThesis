...
output  [63:0] add_6367_out;
output   add_6367_out_ap_vld;
output  [63:0] add_5366_out;
output   add_5366_out_ap_vld;
output  [63:0] add_4365_out;
output   add_4365_out_ap_vld;
output  [63:0] add_3364_out;
output   add_3364_out_ap_vld;
output  [63:0] add_2363_out;
output   add_2363_out_ap_vld;
output  [63:0] add_1362_out;
output   add_1362_out_ap_vld;
output  [63:0] add361_out;
output   add361_out_ap_vld;

reg ap_idle;
reg add_6367_out_ap_vld;
reg add_5366_out_ap_vld;
reg add_4365_out_ap_vld;
reg add_3364_out_ap_vld;
reg add_2363_out_ap_vld;
reg add_1362_out_ap_vld;
reg add361_out_ap_vld;
...
wire   [63:0] arr_66_fu_642_p2;
reg   [63:0] arr_61_fu_112;
wire   [63:0] arr_67_fu_699_p2;
reg   [63:0] arr_62_fu_116;
wire   [63:0] arr_68_fu_755_p2;
reg   [63:0] arr_63_fu_120;
wire   [63:0] arr_69_fu_819_p2;
reg   [63:0] arr_64_fu_124;
wire   [63:0] arr_70_fu_870_p2;
reg   [3:0] i_2_fu_128;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            arr_59_fu_104 <= arr_65_fu_476_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            arr_60_fu_108 <= arr_66_fu_642_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            arr_61_fu_112 <= arr_67_fu_699_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            arr_62_fu_116 <= arr_68_fu_755_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            arr_63_fu_120 <= arr_69_fu_819_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            arr_64_fu_124 <= arr_70_fu_870_p2;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add361_out_ap_vld = 1'b1;
    end else begin
        add361_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1362_out_ap_vld = 1'b1;
    end else begin
        add_1362_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3364_out_ap_vld = 1'b1;
    end else begin
        add_3364_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_5366_out_ap_vld = 1'b1;
    end else begin
        add_5366_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6367_out_ap_vld = 1'b1;
    end else begin
        add_6367_out_ap_vld = 1'b0;
    end
end
...
assign add361_out = arr_58_fu_100;

assign add_1362_out = arr_59_fu_104;

assign add_2363_out = arr_60_fu_108;

assign add_3364_out = arr_61_fu_112;

assign add_4365_out = arr_62_fu_116;

assign add_5366_out = arr_63_fu_120;

assign add_6367_out = arr_64_fu_124;
...
assign arr_65_fu_476_p2 = (and_ln50_1_fu_470_p2 + arr_59_fu_104);

assign arr_66_fu_642_p2 = (and_ln50_2_fu_636_p2 + arr_60_fu_108);

assign arr_67_fu_699_p2 = (and_ln50_3_fu_693_p2 + arr_61_fu_112);

assign arr_68_fu_755_p2 = (and_ln50_4_fu_749_p2 + arr_62_fu_116);

assign arr_69_fu_819_p2 = (and_ln50_5_fu_813_p2 + arr_63_fu_120);

assign arr_70_fu_870_p2 = (mul_ln50_6_fu_295_p2 + arr_64_fu_124);

assign arr_fu_431_p2 = (and_ln50_fu_425_p2 + arr_58_fu_100);
