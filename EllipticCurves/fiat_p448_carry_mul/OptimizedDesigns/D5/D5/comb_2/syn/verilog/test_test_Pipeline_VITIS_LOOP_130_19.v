...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        add212_4336_reload,
        add212_3335_reload,
        add212_2112334_reload,
        add212_1103333_reload,
        arg1_r_1_reload,
        arg1_r_2_reload,
        arg1_r_3_reload,
        arg1_r_4_reload,
        ...
        arg2_r_10_reload,
        add289_2_1330_out,
        add289_2_1330_out_ap_vld,
        add289_2329_out,
        add289_2329_out_ap_vld,
        add289_1_1328_out,
        add289_1_1328_out_ap_vld,
        add289_1327_out,
        add289_1327_out_ap_vld,
        add289_191326_out,
        add289_191326_out_ap_vld,
        add289325_out,
        add289325_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add212_6338_reload;
input  [63:0] add212_5337_reload;
input  [63:0] add212_4336_reload;
input  [63:0] add212_3335_reload;
input  [63:0] add212_2112334_reload;
input  [63:0] add212_1103333_reload;
...
output  [63:0] add289_2_1330_out;
output   add289_2_1330_out_ap_vld;
output  [63:0] add289_2329_out;
output   add289_2329_out_ap_vld;
output  [63:0] add289_1_1328_out;
output   add289_1_1328_out_ap_vld;
output  [63:0] add289_1327_out;
output   add289_1327_out_ap_vld;
output  [63:0] add289_191326_out;
output   add289_191326_out_ap_vld;
output  [63:0] add289325_out;
output   add289325_out_ap_vld;

reg ap_idle;
reg add289_2_1330_out_ap_vld;
reg add289_2329_out_ap_vld;
reg add289_1_1328_out_ap_vld;
reg add289_1327_out_ap_vld;
reg add289_191326_out_ap_vld;
reg add289325_out_ap_vld;
...
wire   [31:0] tmp_83_fu_366_p9;
reg   [31:0] tmp_83_reg_932;
...
reg   [63:0] add289325_fu_100;
wire   [63:0] add_ln143_fu_495_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add289_191326_fu_104;
wire   [63:0] add_ln143_1_fu_524_p2;
reg   [63:0] add289_1327_fu_108;
wire   [63:0] add_ln143_2_fu_586_p2;
reg   [63:0] add289_1_1328_fu_112;
wire   [63:0] add_ln143_3_fu_647_p2;
reg   [63:0] add289_2329_fu_116;
wire   [63:0] add_ln143_4_fu_713_p2;
reg   [63:0] add289_2_1330_fu_120;
...
wire   [2:0] zext_ln35_14_fu_406_p1;
wire   [2:0] zext_ln35_fu_422_p1;
...
wire  signed [3:0] tmp_84_fu_533_p17;
wire   [31:0] tmp_84_fu_533_p18;
...
wire   [3:0] tmp_s_fu_728_p17;
wire   [31:0] tmp_s_fu_728_p18;
...
always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289325_out_ap_vld = 1'b1;
    end else begin
        add289325_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1327_out_ap_vld = 1'b1;
    end else begin
        add289_1327_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_191326_out_ap_vld = 1'b1;
    end else begin
        add289_191326_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1_1328_out_ap_vld = 1'b1;
    end else begin
        add289_1_1328_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2329_out_ap_vld = 1'b1;
    end else begin
        add289_2329_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2_1330_out_ap_vld = 1'b1;
    end else begin
        add289_2_1330_out_ap_vld = 1'b0;
    end
end
...
assign add289325_out = add289325_fu_100;

assign add289_1327_out = add289_1327_fu_108;

assign add289_191326_out = add289_191326_fu_104;

assign add289_1_1328_out = add289_1_1328_fu_112;

assign add289_2329_out = add289_2329_fu_116;

assign add289_2_1330_out = add289_2_1330_fu_120;

assign add_ln130_fu_444_p2 = ($signed(ap_sig_allocacmp_i_6) + $signed(3'd7));

assign add_ln143_1_fu_524_p2 = (and_ln143_1_fu_518_p2 + add289_191326_fu_104);

assign add_ln143_2_fu_586_p2 = (and_ln143_2_fu_580_p2 + add289_1327_fu_108);

assign add_ln143_3_fu_647_p2 = (and_ln143_3_fu_641_p2 + add289_1_1328_fu_112);

assign add_ln143_4_fu_713_p2 = (and_ln143_4_fu_707_p2 + add289_2329_fu_116);

assign add_ln143_5_fu_765_p2 = (mul_ln143_5_fu_304_p2 + add289_2_1330_fu_120);

assign add_ln143_fu_495_p2 = (and_ln143_fu_489_p2 + add289325_fu_100);
...
assign icmp_ln130_fu_350_p2 = ((ap_sig_allocacmp_i_6 == 3'd0) ? 1'b1 : 1'b0);
...
assign sub_ln35_21_fu_426_p2 = ($signed(sub_ln35_fu_410_p2) - $signed(zext_ln35_fu_422_p1));

assign sub_ln35_22_fu_656_p2 = ($signed(sext_ln143_1_fu_592_p1) - $signed(zext_ln144_fu_653_p1));

assign sub_ln35_fu_410_p2 = (select_ln143_2_fu_392_p3 - zext_ln35_14_fu_406_p1);

assign tmp_84_fu_533_p17 = sub_ln35_reg_948;

assign tmp_s_fu_728_p17 = (sub_ln35_22_fu_656_p2 - zext_ln144_1_fu_719_p1);

assign zext_ln130_fu_356_p1 = ap_sig_allocacmp_i_6;

assign zext_ln143_fu_473_p1 = tmp_83_reg_932;

assign zext_ln144_1_fu_719_p1 = icmp_ln143_4_reg_969;

assign zext_ln144_fu_653_p1 = icmp_ln143_3_reg_963;

assign zext_ln35_14_fu_406_p1 = icmp_ln143_1_fu_400_p2;

assign zext_ln35_fu_422_p1 = icmp_ln143_2_fu_416_p2;
