...
output  [63:0] add_6302_out;
output   add_6302_out_ap_vld;
output  [63:0] add_5301_out;
output   add_5301_out_ap_vld;
output  [63:0] add_4300_out;
output   add_4300_out_ap_vld;
output  [63:0] add_3299_out;
output   add_3299_out_ap_vld;
output  [63:0] add_2298_out;
output   add_2298_out_ap_vld;
output  [63:0] add_1297_out;
output   add_1297_out_ap_vld;
output  [63:0] add296_out;
output   add296_out_ap_vld;

reg ap_idle;
reg add_6302_out_ap_vld;
reg add_5301_out_ap_vld;
reg add_4300_out_ap_vld;
reg add_3299_out_ap_vld;
reg add_2298_out_ap_vld;
reg add_1297_out_ap_vld;
reg add296_out_ap_vld;
...
reg  signed [2:0] sub_ln35_27_reg_1099;
...
reg   [63:0] arr_14_fu_100;
wire   [63:0] arr_fu_431_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] arr_15_fu_104;
wire   [63:0] arr_21_fu_476_p2;
reg   [63:0] arr_16_fu_108;
wire   [63:0] arr_22_fu_642_p2;
reg   [63:0] arr_17_fu_112;
wire   [63:0] arr_23_fu_699_p2;
reg   [63:0] arr_18_fu_116;
wire   [63:0] arr_24_fu_755_p2;
reg   [63:0] arr_19_fu_120;
wire   [63:0] arr_25_fu_819_p2;
reg   [63:0] arr_20_fu_124;
wire   [63:0] arr_26_fu_870_p2;
reg   [3:0] i_2_fu_128;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            arr_15_fu_104 <= arr_21_fu_476_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            arr_16_fu_108 <= arr_22_fu_642_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            arr_17_fu_112 <= arr_23_fu_699_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            arr_18_fu_116 <= arr_24_fu_755_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            arr_19_fu_120 <= arr_25_fu_819_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            arr_20_fu_124 <= arr_26_fu_870_p2;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add296_out_ap_vld = 1'b1;
    end else begin
        add296_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1297_out_ap_vld = 1'b1;
    end else begin
        add_1297_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2298_out_ap_vld = 1'b1;
    end else begin
        add_2298_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3299_out_ap_vld = 1'b1;
    end else begin
        add_3299_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_4300_out_ap_vld = 1'b1;
    end else begin
        add_4300_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_5301_out_ap_vld = 1'b1;
    end else begin
        add_5301_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6302_out_ap_vld = 1'b1;
    end else begin
        add_6302_out_ap_vld = 1'b0;
    end
end
...
assign add296_out = arr_14_fu_100;

assign add_1297_out = arr_15_fu_104;

assign add_2298_out = arr_16_fu_108;

assign add_3299_out = arr_17_fu_112;

assign add_4300_out = arr_18_fu_116;

assign add_5301_out = arr_19_fu_120;

assign add_6302_out = arr_20_fu_124;
...
assign arr_21_fu_476_p2 = (and_ln50_1_fu_470_p2 + arr_15_fu_104);

assign arr_22_fu_642_p2 = (and_ln50_2_fu_636_p2 + arr_16_fu_108);

assign arr_23_fu_699_p2 = (and_ln50_3_fu_693_p2 + arr_17_fu_112);

assign arr_24_fu_755_p2 = (and_ln50_4_fu_749_p2 + arr_18_fu_116);

assign arr_25_fu_819_p2 = (and_ln50_5_fu_813_p2 + arr_19_fu_120);

assign arr_26_fu_870_p2 = (mul_ln50_6_fu_295_p2 + arr_20_fu_124);

assign arr_fu_431_p2 = (and_ln50_fu_425_p2 + arr_14_fu_100);
...
assign icmp_ln50_3_fu_538_p2 = ((tmp_68_fu_528_p4 != 2'd0) ? 1'b1 : 1'b0);
...
assign select_ln50_1_fu_417_p3 = ((tmp_67_fu_409_p3[0:0] == 1'b1) ? 64'd18446744073709551615 : 64'd0);
...
assign sext_ln50_1_fu_508_p1 = $signed(sub_ln35_28_fu_502_p2);

assign sub_ln35_1_fu_764_p2 = (sub_ln35_reg_1119 - zext_ln51_1_fu_761_p1);

assign sub_ln35_27_fu_486_p2 = (select_ln50_2_fu_437_p3 - zext_ln35_fu_482_p1);
...
assign tmp_3_fu_589_p17 = sub_ln35_27_reg_1099;

assign tmp_67_fu_409_p3 = empty_fu_358_p2[32'd3];

assign tmp_68_fu_528_p4 = {{empty_fu_358_p2[3:2]}};
