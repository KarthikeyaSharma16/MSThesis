...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        arg2_r_10_reload,
        add289_5346_out,
        add289_5346_out_ap_vld,
        add289_4345_out,
        add289_4345_out_ap_vld,
        add289_3344_out,
        add289_3344_out_ap_vld,
        add289_2343_out,
        add289_2343_out_ap_vld,
        add289_1342_out,
        add289_1342_out_ap_vld,
        add289341_out,
        add289341_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add212_6354_reload;
input  [63:0] add212_5353_reload;
input  [63:0] add212_4352_reload;
input  [63:0] add212_3351_reload;
input  [63:0] add212_2350_reload;
input  [63:0] add212_1349_reload;
...
output  [63:0] add289_5346_out;
output   add289_5346_out_ap_vld;
output  [63:0] add289_4345_out;
output   add289_4345_out_ap_vld;
output  [63:0] add289_3344_out;
output   add289_3344_out_ap_vld;
output  [63:0] add289_2343_out;
output   add289_2343_out_ap_vld;
output  [63:0] add289_1342_out;
output   add289_1342_out_ap_vld;
output  [63:0] add289341_out;
output   add289341_out_ap_vld;

reg ap_idle;
reg add289_5346_out_ap_vld;
reg add289_4345_out_ap_vld;
reg add289_3344_out_ap_vld;
reg add289_2343_out_ap_vld;
reg add289_1342_out_ap_vld;
reg add289341_out_ap_vld;
...
wire  signed [2:0] sub_ln35_27_fu_410_p2;
reg  signed [2:0] sub_ln35_27_reg_948;
...
reg   [63:0] arr_fu_100;
wire   [63:0] arr_58_fu_495_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] arr_53_fu_104;
wire   [63:0] arr_59_fu_524_p2;
reg   [63:0] arr_54_fu_108;
wire   [63:0] arr_60_fu_586_p2;
reg   [63:0] arr_55_fu_112;
wire   [63:0] arr_61_fu_647_p2;
reg   [63:0] arr_56_fu_116;
wire   [63:0] arr_62_fu_713_p2;
reg   [63:0] arr_57_fu_120;
wire   [63:0] arr_63_fu_765_p2;
reg   [2:0] i_fu_124;
...
wire   [2:0] zext_ln35_6_fu_422_p1;
...
wire  signed [3:0] tmp_44_fu_533_p17;
wire   [31:0] tmp_44_fu_533_p18;
...
wire   [3:0] tmp_47_fu_728_p17;
wire   [31:0] tmp_47_fu_728_p18;
...
always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289341_out_ap_vld = 1'b1;
    end else begin
        add289341_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1342_out_ap_vld = 1'b1;
    end else begin
        add289_1342_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2343_out_ap_vld = 1'b1;
    end else begin
        add289_2343_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_3344_out_ap_vld = 1'b1;
    end else begin
        add289_3344_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_4345_out_ap_vld = 1'b1;
    end else begin
        add289_4345_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_5346_out_ap_vld = 1'b1;
    end else begin
        add289_5346_out_ap_vld = 1'b0;
    end
end
...
assign add289341_out = arr_fu_100;

assign add289_1342_out = arr_53_fu_104;

assign add289_2343_out = arr_54_fu_108;

assign add289_3344_out = arr_55_fu_112;

assign add289_4345_out = arr_56_fu_116;

assign add289_5346_out = arr_57_fu_120;

assign add_ln130_fu_444_p2 = ($signed(ap_sig_allocacmp_i_2) + $signed(3'd7));
...
assign arr_58_fu_495_p2 = (and_ln143_fu_489_p2 + arr_fu_100);

assign arr_59_fu_524_p2 = (and_ln143_1_fu_518_p2 + arr_53_fu_104);

assign arr_60_fu_586_p2 = (and_ln143_2_fu_580_p2 + arr_54_fu_108);

assign arr_61_fu_647_p2 = (and_ln143_3_fu_641_p2 + arr_55_fu_112);

assign arr_62_fu_713_p2 = (and_ln143_4_fu_707_p2 + arr_56_fu_116);

assign arr_63_fu_765_p2 = (mul_ln143_5_fu_304_p2 + arr_57_fu_120);

assign conv36_cast_fu_308_p1 = conv36;

assign empty_fu_360_p2 = ($signed(zext_ln130_fu_356_p1) + $signed(4'd9));

assign icmp_ln130_fu_350_p2 = ((ap_sig_allocacmp_i_2 == 3'd0) ? 1'b1 : 1'b0);
...
assign sub_ln35_27_fu_410_p2 = (select_ln143_2_fu_392_p3 - zext_ln35_fu_406_p1);

assign sub_ln35_9_fu_426_p2 = ($signed(sub_ln35_27_fu_410_p2) - $signed(zext_ln35_6_fu_422_p1));

assign tmp_44_fu_533_p17 = sub_ln35_27_reg_948;

assign tmp_47_fu_728_p17 = (sub_ln35_10_fu_656_p2 - zext_ln144_1_fu_719_p1);

assign zext_ln130_fu_356_p1 = ap_sig_allocacmp_i_2;
...
assign zext_ln35_6_fu_422_p1 = icmp_ln143_2_fu_416_p2;
