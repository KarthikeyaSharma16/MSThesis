...
output  [63:0] add_6234_out;
output   add_6234_out_ap_vld;
output  [63:0] add_5233_out;
output   add_5233_out_ap_vld;
output  [63:0] add_4232_out;
output   add_4232_out_ap_vld;
output  [63:0] add_3231_out;
output   add_3231_out_ap_vld;
output  [63:0] add_2230_out;
output   add_2230_out_ap_vld;
output  [63:0] add_1229_out;
output   add_1229_out_ap_vld;
output  [63:0] add228_out;
...
reg add_3231_out_ap_vld;
reg add_2230_out_ap_vld;
reg add_1229_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1229_out_ap_vld = 1'b1;
    end else begin
        add_1229_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2230_out_ap_vld = 1'b1;
    end else begin
        add_2230_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3231_out_ap_vld = 1'b1;
    end else begin
        add_3231_out_ap_vld = 1'b0;
    end
end
...
assign add228_out = arr_58_fu_100;

assign add_1229_out = arr_59_fu_104;

assign add_2230_out = arr_60_fu_108;

assign add_3231_out = arr_61_fu_112;

assign add_4232_out = arr_62_fu_116;

assign add_5233_out = arr_63_fu_120;

assign add_6234_out = arr_64_fu_124;
