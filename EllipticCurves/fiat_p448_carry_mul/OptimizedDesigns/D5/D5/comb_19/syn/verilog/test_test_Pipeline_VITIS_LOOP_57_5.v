...
module test_test_Pipeline_VITIS_LOOP_57_5 (
        ...
        arg2_r_9_reload,
        add102_6227_out,
        add102_6227_out_ap_vld,
        add102_5226_out,
        add102_5226_out_ap_vld,
        add102_4225_out,
        add102_4225_out_ap_vld,
        add102_3224_out,
        add102_3224_out_ap_vld,
        add102_2223_out,
        add102_2223_out_ap_vld,
        add102_1222_out,
        add102_1222_out_ap_vld,
        add102221_out,
        add102221_out_ap_vld
);
...
output  [63:0] add102_6227_out;
output   add102_6227_out_ap_vld;
output  [63:0] add102_5226_out;
output   add102_5226_out_ap_vld;
output  [63:0] add102_4225_out;
output   add102_4225_out_ap_vld;
output  [63:0] add102_3224_out;
output   add102_3224_out_ap_vld;
output  [63:0] add102_2223_out;
output   add102_2223_out_ap_vld;
output  [63:0] add102_1222_out;
output   add102_1222_out_ap_vld;
output  [63:0] add102221_out;
output   add102221_out_ap_vld;

reg ap_idle;
reg add102_6227_out_ap_vld;
reg add102_5226_out_ap_vld;
reg add102_4225_out_ap_vld;
reg add102_3224_out_ap_vld;
reg add102_2223_out_ap_vld;
reg add102_1222_out_ap_vld;
reg add102221_out_ap_vld;
...
wire  signed [2:0] sub_ln35_fu_486_p2;
reg  signed [2:0] sub_ln35_reg_1089;
...
wire   [2:0] sub_ln35_11_fu_502_p2;
...
always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102221_out_ap_vld = 1'b1;
    end else begin
        add102221_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_1222_out_ap_vld = 1'b1;
    end else begin
        add102_1222_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_2223_out_ap_vld = 1'b1;
    end else begin
        add102_2223_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_3224_out_ap_vld = 1'b1;
    end else begin
        add102_3224_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_4225_out_ap_vld = 1'b1;
    end else begin
        add102_4225_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_5226_out_ap_vld = 1'b1;
    end else begin
        add102_5226_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_6227_out_ap_vld = 1'b1;
    end else begin
        add102_6227_out_ap_vld = 1'b0;
    end
end
...
assign add102221_out = arr_fu_96;

assign add102_1222_out = arr_45_fu_100;

assign add102_2223_out = arr_46_fu_104;

assign add102_3224_out = arr_47_fu_108;

assign add102_4225_out = arr_48_fu_112;

assign add102_5226_out = arr_49_fu_116;

assign add102_6227_out = arr_50_fu_120;
...
assign select_ln70_1_fu_417_p3 = ((tmp_4_fu_409_p3[0:0] == 1'b1) ? 64'd18446744073709551615 : 64'd0);
...
assign sext_ln70_1_fu_508_p1 = $signed(sub_ln35_11_fu_502_p2);

assign sub_ln35_11_fu_502_p2 = ($signed(sub_ln35_fu_486_p2) - $signed(zext_ln35_1_fu_498_p1));
...
assign sub_ln35_fu_486_p2 = (select_ln70_2_fu_437_p3 - zext_ln35_fu_482_p1);

assign tmp_10_fu_824_p17 = (sub_ln35_4_fu_754_p2 - zext_ln71_2_fu_815_p1);

assign tmp_4_fu_409_p3 = empty_fu_358_p2[32'd4];

assign tmp_9_fu_579_p17 = sub_ln35_reg_1089;
