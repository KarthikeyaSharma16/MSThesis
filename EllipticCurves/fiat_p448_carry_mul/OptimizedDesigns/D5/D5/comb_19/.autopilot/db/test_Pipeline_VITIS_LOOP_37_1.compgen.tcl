...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add_6234_out { O 64 vector } add_6234_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add_5233_out { O 64 vector } add_5233_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add_4232_out { O 64 vector } add_4232_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_3231_out \
    op interface \
    ports { add_3231_out { O 64 vector } add_3231_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_2230_out \
    op interface \
    ports { add_2230_out { O 64 vector } add_2230_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_1229_out \
    op interface \
    ports { add_1229_out { O 64 vector } add_1229_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add228_out { O 64 vector } add228_out_ap_vld { O 1 bit } } \
} "
}
