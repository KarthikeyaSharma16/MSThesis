...
module test_test_Pipeline_VITIS_LOOP_57_5 (
        ...
        arg2_r_9_reload,
        add102_6309_out,
        add102_6309_out_ap_vld,
        add102_5308_out,
        add102_5308_out_ap_vld,
        add102_4307_out,
        add102_4307_out_ap_vld,
        add102_3306_out,
        add102_3306_out_ap_vld,
        add102_2305_out,
        add102_2305_out_ap_vld,
        add102_1304_out,
        add102_1304_out_ap_vld,
        add102303_out,
        add102303_out_ap_vld
);
...
output  [63:0] add102_6309_out;
output   add102_6309_out_ap_vld;
output  [63:0] add102_5308_out;
output   add102_5308_out_ap_vld;
output  [63:0] add102_4307_out;
output   add102_4307_out_ap_vld;
output  [63:0] add102_3306_out;
output   add102_3306_out_ap_vld;
output  [63:0] add102_2305_out;
output   add102_2305_out_ap_vld;
output  [63:0] add102_1304_out;
output   add102_1304_out_ap_vld;
output  [63:0] add102303_out;
output   add102303_out_ap_vld;

reg ap_idle;
reg add102_6309_out_ap_vld;
reg add102_5308_out_ap_vld;
reg add102_4307_out_ap_vld;
reg add102_3306_out_ap_vld;
reg add102_2305_out_ap_vld;
reg add102_1304_out_ap_vld;
reg add102303_out_ap_vld;
...
wire  signed [2:0] sub_ln35_20_fu_486_p2;
reg  signed [2:0] sub_ln35_20_reg_1089;
...
reg   [63:0] arr_fu_96;
wire   [63:0] arr_7_fu_431_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] arr_1_fu_100;
wire   [63:0] arr_8_fu_476_p2;
reg   [63:0] arr_2_fu_104;
wire   [63:0] arr_9_fu_632_p2;
reg   [63:0] arr_3_fu_108;
wire   [63:0] arr_10_fu_689_p2;
reg   [63:0] arr_4_fu_112;
wire   [63:0] arr_11_fu_745_p2;
reg   [63:0] arr_5_fu_116;
wire   [63:0] arr_12_fu_809_p2;
reg   [63:0] arr_6_fu_120;
wire   [63:0] arr_13_fu_860_p2;
reg   [3:0] i_fu_124;
...
wire   [2:0] sub_ln35_21_fu_502_p2;
...
always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102303_out_ap_vld = 1'b1;
    end else begin
        add102303_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_1304_out_ap_vld = 1'b1;
    end else begin
        add102_1304_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_2305_out_ap_vld = 1'b1;
    end else begin
        add102_2305_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_3306_out_ap_vld = 1'b1;
    end else begin
        add102_3306_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_4307_out_ap_vld = 1'b1;
    end else begin
        add102_4307_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_5308_out_ap_vld = 1'b1;
    end else begin
        add102_5308_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln57_fu_342_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add102_6309_out_ap_vld = 1'b1;
    end else begin
        add102_6309_out_ap_vld = 1'b0;
    end
end
...
assign add102303_out = arr_fu_96;

assign add102_1304_out = arr_1_fu_100;

assign add102_2305_out = arr_2_fu_104;

assign add102_3306_out = arr_3_fu_108;

assign add102_4307_out = arr_4_fu_112;

assign add102_5308_out = arr_5_fu_116;

assign add102_6309_out = arr_6_fu_120;
...
assign arr_10_fu_689_p2 = (and_ln70_3_fu_683_p2 + arr_3_fu_108);

assign arr_11_fu_745_p2 = (and_ln70_4_fu_739_p2 + arr_4_fu_112);

assign arr_12_fu_809_p2 = (and_ln70_5_fu_803_p2 + arr_5_fu_116);

assign arr_13_fu_860_p2 = (mul_ln70_6_fu_291_p2 + arr_6_fu_120);

assign arr_7_fu_431_p2 = (and_ln70_fu_425_p2 + arr_fu_96);

assign arr_8_fu_476_p2 = (and_ln70_1_fu_470_p2 + arr_1_fu_100);

assign arr_9_fu_632_p2 = (and_ln70_2_fu_626_p2 + arr_2_fu_104);
...
assign select_ln70_1_fu_417_p3 = ((tmp_43_fu_409_p3[0:0] == 1'b1) ? 64'd18446744073709551615 : 64'd0);
...
assign sext_ln70_1_fu_508_p1 = $signed(sub_ln35_21_fu_502_p2);

assign sub_ln35_20_fu_486_p2 = (select_ln70_2_fu_437_p3 - zext_ln35_2_fu_482_p1);

assign sub_ln35_21_fu_502_p2 = ($signed(sub_ln35_20_fu_486_p2) - $signed(zext_ln35_3_fu_498_p1));
...
assign tmp_43_fu_409_p3 = empty_fu_358_p2[32'd4];

assign tmp_9_fu_579_p17 = sub_ln35_20_reg_1089;
