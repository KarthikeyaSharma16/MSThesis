...
output  [63:0] add_6316_out;
output   add_6316_out_ap_vld;
output  [63:0] add_5315_out;
output   add_5315_out_ap_vld;
output  [63:0] add_4314_out;
output   add_4314_out_ap_vld;
output  [63:0] add_3313_out;
output   add_3313_out_ap_vld;
output  [63:0] add_2312_out;
output   add_2312_out_ap_vld;
output  [63:0] add_1311_out;
output   add_1311_out_ap_vld;
output  [63:0] add310_out;
output   add310_out_ap_vld;

reg ap_idle;
reg add_6316_out_ap_vld;
reg add_5315_out_ap_vld;
reg add_4314_out_ap_vld;
reg add_3313_out_ap_vld;
reg add_2312_out_ap_vld;
reg add_1311_out_ap_vld;
reg add310_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add310_out_ap_vld = 1'b1;
    end else begin
        add310_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_1311_out_ap_vld = 1'b1;
    end else begin
        add_1311_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_2312_out_ap_vld = 1'b1;
    end else begin
        add_2312_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_3313_out_ap_vld = 1'b1;
    end else begin
        add_3313_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_4314_out_ap_vld = 1'b1;
    end else begin
        add_4314_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_5315_out_ap_vld = 1'b1;
    end else begin
        add_5315_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln37_fu_346_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add_6316_out_ap_vld = 1'b1;
    end else begin
        add_6316_out_ap_vld = 1'b0;
    end
end
...
assign add310_out = arr_14_fu_100;

assign add_1311_out = arr_15_fu_104;

assign add_2312_out = arr_16_fu_108;

assign add_3313_out = arr_17_fu_112;

assign add_4314_out = arr_18_fu_116;

assign add_5315_out = arr_19_fu_120;

assign add_6316_out = arr_20_fu_124;
