...
output  [63:0] add245_3332_out;
output   add245_3332_out_ap_vld;

reg ap_idle;
reg add245_3332_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_221_p3 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add245_3332_out_ap_vld = 1'b1;
    end else begin
        add245_3332_out_ap_vld = 1'b0;
    end
end
...
assign add245_3332_out = arr_fu_72;

assign add_ln120_fu_471_p2 = ($signed(i_4_fu_80) + $signed(4'd12));
...
assign arr_76_fu_465_p2 = (arr_fu_72 + add_ln126_3_fu_459_p2);
...
assign mul_ln126_1_fu_191_p10 = tmp_26_fu_294_p18;
...
assign mul_ln126_2_fu_195_p10 = tmp_27_fu_343_p18;
...
assign mul_ln126_3_fu_199_p10 = tmp_25_fu_239_p18;
...
assign mul_ln126_fu_187_p10 = tmp_28_fu_392_p18;
...
assign tmp_fu_221_p3 = i_4_fu_80[32'd3];
