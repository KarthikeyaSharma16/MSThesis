...
module test_test_Pipeline_VITIS_LOOP_130_19 (
        ...
        add212_4337_reload,
        add212_3336_reload,
        add212_2127335_reload,
        add212_1117334_reload,
        arg1_r_2_reload,
        arg1_r_4_reload,
        arg1_r_6_reload,
        conv36,
        ...
        arg1_r_5_reload,
        add289_2_1331_out,
        add289_2_1331_out_ap_vld,
        add289_2330_out,
        add289_2330_out_ap_vld,
        add289_189_1329_out,
        add289_189_1329_out_ap_vld,
        add289_189328_out,
        add289_189328_out_ap_vld,
        add289_1104327_out,
        add289_1104327_out_ap_vld,
        add289326_out,
        add289326_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add212_6339_reload;
input  [63:0] add212_5338_reload;
input  [63:0] add212_4337_reload;
input  [63:0] add212_3336_reload;
input  [63:0] add212_2127335_reload;
input  [63:0] add212_1117334_reload;
...
output  [63:0] add289_2_1331_out;
output   add289_2_1331_out_ap_vld;
output  [63:0] add289_2330_out;
output   add289_2330_out_ap_vld;
output  [63:0] add289_189_1329_out;
output   add289_189_1329_out_ap_vld;
output  [63:0] add289_189328_out;
output   add289_189328_out_ap_vld;
output  [63:0] add289_1104327_out;
output   add289_1104327_out_ap_vld;
output  [63:0] add289326_out;
output   add289326_out_ap_vld;

reg ap_idle;
reg add289_2_1331_out_ap_vld;
reg add289_2330_out_ap_vld;
reg add289_189_1329_out_ap_vld;
reg add289_189328_out_ap_vld;
reg add289_1104327_out_ap_vld;
reg add289326_out_ap_vld;
...
wire   [31:0] tmp_24_fu_396_p9;
reg   [31:0] tmp_24_reg_1259;
...
wire   [31:0] tmp_30_fu_448_p9;
reg   [31:0] tmp_30_reg_1289;
...
reg   [63:0] arr_fu_106;
wire   [63:0] arr_70_fu_543_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] arr_65_fu_110;
wire   [63:0] arr_71_fu_796_p2;
reg   [63:0] arr_66_fu_114;
wire   [63:0] arr_72_fu_851_p2;
reg   [63:0] arr_67_fu_118;
wire   [63:0] arr_73_fu_942_p2;
reg   [63:0] arr_68_fu_122;
wire   [63:0] arr_74_fu_1019_p2;
reg   [63:0] arr_69_fu_126;
wire   [63:0] arr_75_fu_1078_p2;
reg   [2:0] i_fu_130;
...
wire  signed [2:0] sub_ln35_3_fu_569_p2;
wire  signed [3:0] tmp_25_fu_579_p17;
wire   [31:0] tmp_25_fu_579_p18;
wire   [2:0] zext_ln35_1_fu_619_p1;
wire   [2:0] sub_ln35_4_fu_622_p2;
wire  signed [3:0] sext_ln143_8_fu_628_p1;
wire   [31:0] tmp_26_fu_632_p18;
wire   [3:0] zext_ln144_fu_671_p1;
wire   [3:0] sub_ln35_5_fu_674_p2;
wire   [31:0] tmp_27_fu_680_p18;
wire   [31:0] tmp_28_fu_718_p18;
...
wire   [63:0] add_ln143_2_fu_845_p2;
wire   [2:0] select_ln143_6_fu_802_p3;
wire   [2:0] zext_ln35_2_fu_857_p1;
wire  signed [2:0] sub_ln35_6_fu_860_p2;
wire  signed [3:0] tmp_31_fu_870_p17;
wire   [31:0] tmp_31_fu_870_p18;
...
wire   [63:0] add_ln143_4_fu_936_p2;
wire   [2:0] zext_ln35_3_fu_948_p1;
wire   [2:0] sub_ln35_7_fu_951_p2;
wire  signed [3:0] sext_ln143_10_fu_957_p1;
wire   [31:0] tmp_32_fu_961_p18;
...
wire   [63:0] add_ln143_6_fu_1013_p2;
wire   [3:0] zext_ln144_1_fu_1025_p1;
wire   [3:0] tmp_33_fu_1034_p17;
wire   [31:0] tmp_33_fu_1034_p18;
wire   [63:0] mul_ln143_10_fu_330_p2;
wire   [63:0] mul_ln143_9_fu_326_p2;
wire   [63:0] add_ln143_8_fu_1072_p2;
reg    ap_done_reg;
...
mux_16_4_32_1_1_U232(
    ...
    .din16(tmp_25_fu_579_p17),
    .dout(tmp_25_fu_579_p18)
);
...
mux_16_4_32_1_1_U234(
    ...
    .din14(arg2_r_14_reload),
    .din15(arg2_r_15_reload),
    .din16(sub_ln35_5_fu_674_p2),
    .dout(tmp_27_fu_680_p18)
);
...
mux_16_4_32_1_1_U236(
    ...
    .din14(arg2_r_14_reload),
    .din15(arg2_r_15_reload),
    .din16(tmp_31_fu_870_p17),
    .dout(tmp_31_fu_870_p18)
);
...
mux_16_4_32_1_1_U238(
    ...
    .din14(arg2_r_14_reload),
    .din15(arg2_r_15_reload),
    .din16(tmp_33_fu_1034_p17),
    .dout(tmp_33_fu_1034_p18)
);
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            arr_65_fu_110 <= add212_2127335_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            arr_65_fu_110 <= arr_71_fu_796_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            arr_66_fu_114 <= add212_3336_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            arr_66_fu_114 <= arr_72_fu_851_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            arr_67_fu_118 <= add212_4337_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            arr_67_fu_118 <= arr_73_fu_942_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            arr_68_fu_122 <= add212_5338_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            arr_68_fu_122 <= arr_74_fu_1019_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            arr_69_fu_126 <= add212_6339_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            arr_69_fu_126 <= arr_75_fu_1078_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            arr_fu_106 <= add212_1117334_reload;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            arr_fu_106 <= arr_70_fu_543_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln130_fu_376_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_24_reg_1259 <= tmp_24_fu_396_p9;
        tmp_30_reg_1289 <= tmp_30_fu_448_p9;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289326_out_ap_vld = 1'b1;
    end else begin
        add289326_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_1104327_out_ap_vld = 1'b1;
    end else begin
        add289_1104327_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_189328_out_ap_vld = 1'b1;
    end else begin
        add289_189328_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_189_1329_out_ap_vld = 1'b1;
    end else begin
        add289_189_1329_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2330_out_ap_vld = 1'b1;
    end else begin
        add289_2330_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln130_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add289_2_1331_out_ap_vld = 1'b1;
    end else begin
        add289_2_1331_out_ap_vld = 1'b0;
    end
end
...
assign add289326_out = arr_fu_106;

assign add289_1104327_out = arr_65_fu_110;

assign add289_189328_out = arr_66_fu_114;

assign add289_189_1329_out = arr_67_fu_118;

assign add289_2330_out = arr_68_fu_122;

assign add289_2_1331_out = arr_69_fu_126;

assign add_ln130_fu_492_p2 = ($signed(ap_sig_allocacmp_i_4) + $signed(3'd6));

assign add_ln143_2_fu_845_p2 = (and_ln143_4_fu_839_p2 + and_ln143_3_fu_826_p2);

assign add_ln143_4_fu_936_p2 = (and_ln143_6_fu_930_p2 + and_ln143_5_fu_917_p2);

assign add_ln143_6_fu_1013_p2 = (and_ln143_7_fu_1007_p2 + mul_ln143_7_fu_318_p2);

assign add_ln143_8_fu_1072_p2 = (mul_ln143_10_fu_330_p2 + mul_ln143_9_fu_326_p2);

assign add_ln143_fu_790_p2 = (and_ln143_2_fu_784_p2 + and_ln143_1_fu_771_p2);
...
assign arr_70_fu_543_p2 = (and_ln143_fu_537_p2 + arr_fu_106);

assign arr_71_fu_796_p2 = (arr_65_fu_110 + add_ln143_fu_790_p2);

assign arr_72_fu_851_p2 = (arr_66_fu_114 + add_ln143_2_fu_845_p2);

assign arr_73_fu_942_p2 = (arr_67_fu_118 + add_ln143_4_fu_936_p2);

assign arr_74_fu_1019_p2 = (arr_68_fu_122 + add_ln143_6_fu_1013_p2);

assign arr_75_fu_1078_p2 = (arr_69_fu_126 + add_ln143_8_fu_1072_p2);

assign conv36_cast_fu_334_p1 = conv36;

assign empty_fu_382_p2 = (ap_sig_allocacmp_i_4 | 3'd1);

assign icmp_ln130_fu_376_p2 = ((ap_sig_allocacmp_i_4 == 3'd0) ? 1'b1 : 1'b0);
...
assign icmp_ln143_4_fu_468_p2 = ((tmp_29_fu_440_p3 == 4'd14) ? 1'b1 : 1'b0);

assign icmp_ln143_5_fu_474_p2 = ((tmp_29_fu_440_p3 > 4'd12) ? 1'b1 : 1'b0);

assign icmp_ln143_6_fu_480_p2 = ((tmp_29_fu_440_p3 > 4'd11) ? 1'b1 : 1'b0);

assign icmp_ln143_7_fu_486_p2 = ((tmp_29_fu_440_p3 > 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln143_fu_416_p2 = ((tmp_s_fu_388_p3 == 4'd15) ? 1'b1 : 1'b0);

assign mul_ln143_10_fu_330_p0 = mul_ln143_10_fu_330_p00;

assign mul_ln143_10_fu_330_p00 = tmp_33_fu_1034_p18;
...
assign mul_ln143_3_fu_302_p00 = tmp_25_fu_579_p18;
...
assign sext_ln143_10_fu_957_p1 = $signed(sub_ln35_7_fu_951_p2);

assign sext_ln143_8_fu_628_p1 = $signed(sub_ln35_4_fu_622_p2);

assign sub_ln35_3_fu_569_p2 = (select_ln143_3_fu_549_p3 - zext_ln35_fu_566_p1);

assign sub_ln35_4_fu_622_p2 = ($signed(sub_ln35_3_fu_569_p2) - $signed(zext_ln35_1_fu_619_p1));

assign sub_ln35_5_fu_674_p2 = ($signed(sext_ln143_8_fu_628_p1) - $signed(zext_ln144_fu_671_p1));

assign sub_ln35_6_fu_860_p2 = (select_ln143_6_fu_802_p3 - zext_ln35_2_fu_857_p1);

assign sub_ln35_7_fu_951_p2 = ($signed(sub_ln35_6_fu_860_p2) - $signed(zext_ln35_3_fu_948_p1));

assign tmp_25_fu_579_p17 = sub_ln35_3_fu_569_p2;

assign tmp_29_fu_440_p3 = {{1'd1}, {ap_sig_allocacmp_i_4}};

assign tmp_31_fu_870_p17 = sub_ln35_6_fu_860_p2;

assign tmp_33_fu_1034_p17 = ($signed(sext_ln143_10_fu_957_p1) - $signed(zext_ln144_1_fu_1025_p1));

assign tmp_s_fu_388_p3 = {{1'd1}, {empty_fu_382_p2}};

assign zext_ln143_6_fu_756_p1 = tmp_30_reg_1289;

assign zext_ln143_fu_521_p1 = tmp_24_reg_1259;

assign zext_ln144_1_fu_1025_p1 = icmp_ln143_7_reg_1313;

assign zext_ln144_fu_671_p1 = icmp_ln143_3_reg_1283;

assign zext_ln35_1_fu_619_p1 = icmp_ln143_2_reg_1277;

assign zext_ln35_2_fu_857_p1 = icmp_ln143_5_reg_1301;

assign zext_ln35_3_fu_948_p1 = icmp_ln143_6_reg_1307;
