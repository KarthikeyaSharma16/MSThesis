...
module test_test_Pipeline_VITIS_LOOP_151_23 (
        ...
        add289_4497_reload,
        add289_3496_reload,
        add289_289495_reload,
        add289_175494_reload,
        add289493_reload,
        arr_28,
        arg1_r_9_reload,
        arg1_r_10_reload,
        ...
        arg2_r_14_reload,
        add346_2_1492_out,
        add346_2_1492_out_ap_vld,
        add346_2491_out,
        add346_2491_out_ap_vld,
        add346_1_1490_out,
        add346_1_1490_out_ap_vld,
        add346_1489_out,
        add346_1489_out_ap_vld,
        add346_161488_out,
        add346_161488_out_ap_vld,
        add346487_out,
        add346487_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add289_4497_reload;
input  [63:0] add289_3496_reload;
input  [63:0] add289_289495_reload;
input  [63:0] add289_175494_reload;
input  [63:0] add289493_reload;
input  [63:0] arr_28;
...
output  [63:0] add346_2_1492_out;
output   add346_2_1492_out_ap_vld;
output  [63:0] add346_2491_out;
output   add346_2491_out_ap_vld;
output  [63:0] add346_1_1490_out;
output   add346_1_1490_out_ap_vld;
output  [63:0] add346_1489_out;
output   add346_1489_out_ap_vld;
output  [63:0] add346_161488_out;
output   add346_161488_out_ap_vld;
output  [63:0] add346487_out;
output   add346487_out_ap_vld;

reg ap_idle;
reg add346_2_1492_out_ap_vld;
reg add346_2491_out_ap_vld;
reg add346_1_1490_out_ap_vld;
reg add346_1489_out_ap_vld;
reg add346_161488_out_ap_vld;
reg add346487_out_ap_vld;
...
wire   [31:0] tmp_2_fu_494_p8;
wire   [63:0] mul_ln165_fu_362_p2;
wire   [31:0] tmp_3_fu_517_p8;
...
always @ (*) begin
    if (((icmp_ln151_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346487_out_ap_vld = 1'b1;
    end else begin
        add346487_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_1489_out_ap_vld = 1'b1;
    end else begin
        add346_1489_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_161488_out_ap_vld = 1'b1;
    end else begin
        add346_161488_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_1_1490_out_ap_vld = 1'b1;
    end else begin
        add346_1_1490_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_2491_out_ap_vld = 1'b1;
    end else begin
        add346_2491_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln151_fu_429_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add346_2_1492_out_ap_vld = 1'b1;
    end else begin
        add346_2_1492_out_ap_vld = 1'b0;
    end
end
...
assign add346487_out = add346487_fu_120;

assign add346_1489_out = add346_1489_fu_128;

assign add346_161488_out = add346_161488_fu_124;

assign add346_1_1490_out = add346_1_1490_fu_132;

assign add346_2491_out = add346_2491_fu_136;

assign add346_2_1492_out = add346_2_1492_fu_140;

assign add_ln151_fu_741_p2 = ($signed(i_fu_148) + $signed(4'd15));

assign add_ln158_fu_435_p2 = (k_fu_144 + 3'd1);

assign add_ln165_1_fu_554_p2 = (and_ln165_fu_548_p2 + add346_161488_fu_124);

assign add_ln165_2_fu_621_p2 = (and_ln165_1_fu_615_p2 + add346_1489_fu_128);

assign add_ln165_3_fu_798_p2 = (and_ln165_2_fu_792_p2 + add346_1_1490_fu_132);

assign add_ln165_4_fu_821_p2 = (and_ln165_3_fu_815_p2 + add346_2491_fu_136);

assign add_ln165_5_fu_844_p2 = (and_ln165_4_fu_838_p2 + add346_2_1492_fu_140);

assign add_ln165_fu_511_p2 = (mul_ln165_fu_362_p2 + add346487_fu_120);
...
assign tmp_7_fu_713_p17 = (sub_ln35_1_fu_669_p2 - zext_ln166_2_fu_703_p1);
