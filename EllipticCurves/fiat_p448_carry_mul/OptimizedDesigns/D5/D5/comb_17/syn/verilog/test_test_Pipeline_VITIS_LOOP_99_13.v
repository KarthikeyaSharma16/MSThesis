...
module test_test_Pipeline_VITIS_LOOP_99_13 (
        ...
        ap_idle,
        ap_ready,
        add159_1_1233_reload,
        add159_1232_reload,
        add159_4231_reload,
        add159_3230_reload,
        add159_2123229_reload,
        add159_1109228_reload,
        add159227_reload,
        arg1_r_9_reload,
        arg1_r_10_reload,
        arg1_r_11_reload,
        ...
        add212_298222_out,
        add212_298222_out_ap_vld,
        add212_188221_out,
        add212_188221_out_ap_vld,
        add212220_out,
...
output   ap_idle;
output   ap_ready;
input  [63:0] add159_1_1233_reload;
input  [63:0] add159_1232_reload;
input  [63:0] add159_4231_reload;
input  [63:0] add159_3230_reload;
input  [63:0] add159_2123229_reload;
input  [63:0] add159_1109228_reload;
...
output  [63:0] add212_298222_out;
output   add212_298222_out_ap_vld;
output  [63:0] add212_188221_out;
output   add212_188221_out_ap_vld;
...
reg add212_298222_out_ap_vld;
reg add212_188221_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln99_fu_517_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add212_188221_out_ap_vld = 1'b1;
    end else begin
        add212_188221_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln99_fu_517_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add212_298222_out_ap_vld = 1'b1;
    end else begin
        add212_298222_out_ap_vld = 1'b0;
    end
end
...
assign add212220_out = arr_fu_114;

assign add212_188221_out = arr_1_fu_118;

assign add212_298222_out = arr_2_fu_122;

assign add212_3223_out = arr_3_fu_126;

assign add212_4224_out = arr_4_fu_130;

assign add212_5225_out = arr_5_fu_134;

assign add212_6226_out = arr_6_fu_138;
