...
output  [63:0] add245_3219_out;
output   add245_3219_out_ap_vld;

reg ap_idle;
reg add245_3219_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_221_p3 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add245_3219_out_ap_vld = 1'b1;
    end else begin
        add245_3219_out_ap_vld = 1'b0;
    end
end
...
assign add245_3219_out = arr_fu_72;
...
assign arr_69_fu_465_p2 = (arr_fu_72 + add_ln126_3_fu_459_p2);
