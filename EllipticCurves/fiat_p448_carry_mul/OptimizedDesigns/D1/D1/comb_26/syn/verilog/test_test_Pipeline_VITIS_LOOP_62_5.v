...
module test_test_Pipeline_VITIS_LOOP_62_5 (
        ...
        p_out7,
        p_out7_ap_vld,
        add169_1317_1745_out,
        add169_1317_1745_out_ap_vld,
        add169_1317744_out,
        add169_1317744_out_ap_vld,
        add169_4468743_out,
        add169_4468743_out_ap_vld,
        add169_3440742_out,
        add169_3440742_out_ap_vld,
        add169_2411741_out,
        add169_2411741_out_ap_vld,
        add169_1382740_out,
        add169_1382740_out_ap_vld,
        add169739_out,
        add169739_out_ap_vld
);
...
output  [63:0] add138766_out;
output   add138766_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;
output  [63:0] p_out1;
...
output  [63:0] add169_1317_1745_out;
output   add169_1317_1745_out_ap_vld;
output  [63:0] add169_1317744_out;
output   add169_1317744_out_ap_vld;
output  [63:0] add169_4468743_out;
output   add169_4468743_out_ap_vld;
output  [63:0] add169_3440742_out;
output   add169_3440742_out_ap_vld;
output  [63:0] add169_2411741_out;
output   add169_2411741_out_ap_vld;
output  [63:0] add169_1382740_out;
output   add169_1382740_out_ap_vld;
output  [63:0] add169739_out;
output   add169739_out_ap_vld;

reg ap_idle;
reg add138766_out_ap_vld;
reg p_out_ap_vld;
reg p_out1_ap_vld;
reg p_out2_ap_vld;
reg p_out3_ap_vld;
...
reg p_out6_ap_vld;
reg p_out7_ap_vld;
reg add169_1317_1745_out_ap_vld;
reg add169_1317744_out_ap_vld;
reg add169_4468743_out_ap_vld;
reg add169_3440742_out_ap_vld;
reg add169_2411741_out_ap_vld;
reg add169_1382740_out_ap_vld;
reg add169739_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add138766_out_ap_vld = 1'b1;
    end else begin
        add138766_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169739_out_ap_vld = 1'b1;
    end else begin
        add169739_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169_1317744_out_ap_vld = 1'b1;
    end else begin
        add169_1317744_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169_1317_1745_out_ap_vld = 1'b1;
    end else begin
        add169_1317_1745_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169_1382740_out_ap_vld = 1'b1;
    end else begin
        add169_1382740_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169_2411741_out_ap_vld = 1'b1;
    end else begin
        add169_2411741_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169_3440742_out_ap_vld = 1'b1;
    end else begin
        add169_3440742_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169_4468743_out_ap_vld = 1'b1;
    end else begin
        add169_4468743_out_ap_vld = 1'b0;
    end
end
...
assign add138766_out = arr_38_fu_290;

assign add169739_out = arr_23_fu_230;

assign add169_1317744_out = arr_28_fu_250;

assign add169_1317_1745_out = arr_29_fu_254;

assign add169_1382740_out = arr_24_fu_234;

assign add169_2411741_out = arr_25_fu_238;

assign add169_3440742_out = arr_26_fu_242;

assign add169_4468743_out = arr_27_fu_246;
