...
module test_test_Pipeline_VITIS_LOOP_62_5 (
        ...
        p_out7_ap_vld,
        add169_6127_out,
        add169_6127_out_ap_vld,
        add169_5126_out,
        add169_5126_out_ap_vld,
        add169_4125_out,
        add169_4125_out_ap_vld,
        add169_3124_out,
        add169_3124_out_ap_vld,
        add169_2123_out,
        add169_2123_out_ap_vld,
        add169_1122_out,
        add169_1122_out_ap_vld,
        add169121_out,
        add169121_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add47_14142_reload;
input  [63:0] add47_13141_reload;
input  [63:0] add47_12140_reload;
input  [63:0] add47_11139_reload;
input  [63:0] add47_10138_reload;
input  [63:0] add47_9137_reload;
input  [63:0] add47_8136_reload;
input  [63:0] add47_6134_reload;
input  [63:0] add47_5133_reload;
input  [63:0] add47_4132_reload;
input  [63:0] add47_3131_reload;
input  [63:0] add47_2130_reload;
input  [63:0] add47_1129_reload;
input  [63:0] add47128_reload;
...
input  [31:0] conv36;
output  [63:0] add138144_out;
output   add138144_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;
output  [63:0] p_out1;
...
output  [63:0] add169_6127_out;
output   add169_6127_out_ap_vld;
output  [63:0] add169_5126_out;
output   add169_5126_out_ap_vld;
output  [63:0] add169_4125_out;
output   add169_4125_out_ap_vld;
output  [63:0] add169_3124_out;
output   add169_3124_out_ap_vld;
output  [63:0] add169_2123_out;
output   add169_2123_out_ap_vld;
output  [63:0] add169_1122_out;
output   add169_1122_out_ap_vld;
output  [63:0] add169121_out;
output   add169121_out_ap_vld;

reg ap_idle;
reg add138144_out_ap_vld;
reg p_out_ap_vld;
reg p_out1_ap_vld;
reg p_out2_ap_vld;
reg p_out3_ap_vld;
...
reg p_out6_ap_vld;
reg p_out7_ap_vld;
reg add169_6127_out_ap_vld;
reg add169_5126_out_ap_vld;
reg add169_4125_out_ap_vld;
reg add169_3124_out_ap_vld;
reg add169_2123_out_ap_vld;
reg add169_1122_out_ap_vld;
reg add169121_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add138144_out_ap_vld = 1'b1;
    end else begin
        add138144_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169121_out_ap_vld = 1'b1;
    end else begin
        add169121_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169_1122_out_ap_vld = 1'b1;
    end else begin
        add169_1122_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169_2123_out_ap_vld = 1'b1;
    end else begin
        add169_2123_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169_3124_out_ap_vld = 1'b1;
    end else begin
        add169_3124_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169_4125_out_ap_vld = 1'b1;
    end else begin
        add169_4125_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169_5126_out_ap_vld = 1'b1;
    end else begin
        add169_5126_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169_6127_out_ap_vld = 1'b1;
    end else begin
        add169_6127_out_ap_vld = 1'b0;
    end
end
...
assign add138144_out = arr_31_fu_282;

assign add169121_out = arr_fu_222;

assign add169_1122_out = arr_1_fu_226;

assign add169_2123_out = arr_2_fu_230;

assign add169_3124_out = arr_3_fu_234;

assign add169_4125_out = arr_4_fu_238;

assign add169_5126_out = arr_5_fu_242;

assign add169_6127_out = arr_6_fu_246;
