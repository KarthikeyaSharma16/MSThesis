...
module test_test_Pipeline_VITIS_LOOP_62_5 (
        ...
        add169_1_2764_out,
        add169_1_2764_out_ap_vld,
        add169_1_1763_out,
        add169_1_1763_out_ap_vld,
        add169_1762_out,
        add169_1762_out_ap_vld,
        add169_271761_out,
        add169_271761_out_ap_vld,
        add169_142760_out,
        add169_142760_out_ap_vld,
        add169759_out,
        add169759_out_ap_vld
);
...
input  [31:0] conv36;
output  [63:0] add138782_out;
output   add138782_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;
output  [63:0] p_out1;
...
output  [63:0] add169_1_2764_out;
output   add169_1_2764_out_ap_vld;
output  [63:0] add169_1_1763_out;
output   add169_1_1763_out_ap_vld;
output  [63:0] add169_1762_out;
output   add169_1762_out_ap_vld;
output  [63:0] add169_271761_out;
output   add169_271761_out_ap_vld;
output  [63:0] add169_142760_out;
output   add169_142760_out_ap_vld;
output  [63:0] add169759_out;
output   add169759_out_ap_vld;

reg ap_idle;
reg add138782_out_ap_vld;
reg p_out_ap_vld;
reg p_out1_ap_vld;
reg p_out2_ap_vld;
reg p_out3_ap_vld;
...
reg add169_1_2764_out_ap_vld;
reg add169_1_1763_out_ap_vld;
reg add169_1762_out_ap_vld;
reg add169_271761_out_ap_vld;
reg add169_142760_out_ap_vld;
reg add169759_out_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add138782_out_ap_vld = 1'b1;
    end else begin
        add138782_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169759_out_ap_vld = 1'b1;
    end else begin
        add169759_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_142760_out_ap_vld = 1'b1;
    end else begin
        add169_142760_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_1762_out_ap_vld = 1'b1;
    end else begin
        add169_1762_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_1_1763_out_ap_vld = 1'b1;
    end else begin
        add169_1_1763_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_1_2764_out_ap_vld = 1'b1;
    end else begin
        add169_1_2764_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_271761_out_ap_vld = 1'b1;
    end else begin
        add169_271761_out_ap_vld = 1'b0;
    end
end
...
assign add138782_out = arr_38_fu_268;

assign add169759_out = arr_23_fu_208;

assign add169_142760_out = arr_24_fu_212;

assign add169_1762_out = arr_26_fu_220;

assign add169_1_1763_out = arr_27_fu_224;

assign add169_1_2764_out = arr_28_fu_228;

assign add169_271761_out = arr_25_fu_216;

assign add169_2765_out = arr_29_fu_232;
