...
module test_test_Pipeline_VITIS_LOOP_88_9 (
        ...
        arg2_r_10_reload,
        add280_141720_out,
        add280_141720_out_ap_vld,
        add256_51715_out,
        add256_51715_out_ap_vld,
        add256_41712_out,
        add256_41712_out_ap_vld,
        add256_31709_out,
        add256_31709_out_ap_vld,
        add256_21706_out,
        add256_21706_out_ap_vld,
        add256_11703_out,
        add256_11703_out_ap_vld,
        add2561700_out,
        add2561700_out_ap_vld
);
...
output  [63:0] add280_141720_out;
output   add280_141720_out_ap_vld;
output  [63:0] add256_51715_out;
output   add256_51715_out_ap_vld;
output  [63:0] add256_41712_out;
output   add256_41712_out_ap_vld;
output  [63:0] add256_31709_out;
output   add256_31709_out_ap_vld;
output  [63:0] add256_21706_out;
output   add256_21706_out_ap_vld;
output  [63:0] add256_11703_out;
output   add256_11703_out_ap_vld;
output  [63:0] add2561700_out;
output   add2561700_out_ap_vld;

reg ap_idle;
reg add280_141720_out_ap_vld;
reg add256_51715_out_ap_vld;
reg add256_41712_out_ap_vld;
reg add256_31709_out_ap_vld;
reg add256_21706_out_ap_vld;
reg add256_11703_out_ap_vld;
reg add2561700_out_ap_vld;
...
wire   [31:0] tmp_8_fu_805_p17;
reg   [31:0] tmp_8_reg_1652;
...
reg   [63:0] add2561700_fu_148;
wire   [63:0] add_ln103_fu_604_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add256_11703_fu_152;
wire   [63:0] add_ln106_fu_1049_p2;
reg   [63:0] add256_21706_fu_156;
wire   [63:0] add_ln106_1_fu_1078_p2;
reg   [63:0] add256_31709_fu_160;
wire   [63:0] add_ln106_2_fu_1140_p2;
reg   [63:0] add256_41712_fu_164;
wire   [63:0] add_ln106_3_fu_1201_p2;
reg   [63:0] add256_51715_fu_168;
wire   [63:0] add_ln106_4_fu_1267_p2;
reg   [63:0] add280_141720_fu_172;
...
wire   [3:0] tmp_5_fu_682_p17;
wire   [31:0] tmp_5_fu_682_p18;
wire   [3:0] tmp_6_fu_725_p17;
wire   [31:0] tmp_6_fu_725_p18;
wire   [3:0] tmp_7_fu_768_p17;
wire   [31:0] tmp_7_fu_768_p18;
...
wire  signed [3:0] tmp_s_fu_1087_p17;
wire   [31:0] tmp_s_fu_1087_p18;
...
always @ (*) begin
    if (((icmp_ln88_fu_516_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add2561700_out_ap_vld = 1'b1;
    end else begin
        add2561700_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln88_fu_516_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add256_11703_out_ap_vld = 1'b1;
    end else begin
        add256_11703_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln88_fu_516_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add256_21706_out_ap_vld = 1'b1;
    end else begin
        add256_21706_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln88_fu_516_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add256_31709_out_ap_vld = 1'b1;
    end else begin
        add256_31709_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln88_fu_516_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add256_41712_out_ap_vld = 1'b1;
    end else begin
        add256_41712_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln88_fu_516_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add256_51715_out_ap_vld = 1'b1;
    end else begin
        add256_51715_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln88_fu_516_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add280_141720_out_ap_vld = 1'b1;
    end else begin
        add280_141720_out_ap_vld = 1'b0;
    end
end
...
assign add2561700_out = add2561700_fu_148;

assign add256_11703_out = add256_11703_fu_152;

assign add256_21706_out = add256_21706_fu_156;

assign add256_31709_out = add256_31709_fu_160;

assign add256_41712_out = add256_41712_fu_164;

assign add256_51715_out = add256_51715_fu_168;

assign add280_141720_out = add280_141720_fu_172;

assign add_ln103_1_fu_942_p2 = (mul_ln103_1_reg_1627 + add256_11703_fu_152);

assign add_ln103_2_fu_960_p2 = (mul_ln103_2_reg_1632 + add256_21706_fu_156);

assign add_ln103_3_fu_978_p2 = (mul_ln103_3_reg_1637 + add256_31709_fu_160);

assign add_ln103_4_fu_996_p2 = (mul_ln103_4_reg_1642 + add256_41712_fu_164);

assign add_ln103_5_fu_1014_p2 = (mul_ln103_5_reg_1647 + add256_51715_fu_168);

assign add_ln103_fu_604_p2 = (mul_ln103_fu_421_p2 + add2561700_fu_148);
...
assign add_ln106_5_fu_1319_p2 = (mul_ln106_5_fu_465_p2 + add280_141720_fu_172);
...
assign icmp_ln106_3_fu_891_p2 = ((tmp_4_fu_881_p4 == 2'd1) ? 1'b1 : 1'b0);
...
assign mul_ln106_2_fu_453_p00 = tmp_s_fu_1087_p18;
...
assign select_ln101_1_fu_965_p3 = ((icmp_ln101_1_fu_955_p2[0:0] == 1'b1) ? add_ln103_2_fu_960_p2 : add256_21706_fu_156);

assign select_ln101_2_fu_983_p3 = ((icmp_ln101_2_fu_973_p2[0:0] == 1'b1) ? add_ln103_3_fu_978_p2 : add256_31709_fu_160);

assign select_ln101_3_fu_1001_p3 = ((icmp_ln101_3_fu_991_p2[0:0] == 1'b1) ? add_ln103_4_fu_996_p2 : add256_41712_fu_164);

assign select_ln101_4_fu_1019_p3 = ((icmp_ln101_4_fu_1009_p2[0:0] == 1'b1) ? add_ln103_5_fu_1014_p2 : add256_51715_fu_168);

assign select_ln101_fu_947_p3 = ((icmp_ln101_fu_937_p2[0:0] == 1'b1) ? add_ln103_1_fu_942_p2 : add256_11703_fu_152);
...
assign tmp_4_fu_881_p4 = {{empty_fu_529_p2[3:2]}};

assign tmp_5_fu_682_p17 = ($signed(4'd12) - $signed(i_fu_176));

assign tmp_6_fu_725_p17 = ($signed(4'd11) - $signed(i_fu_176));

assign tmp_7_fu_768_p17 = ($signed(4'd10) - $signed(i_fu_176));

assign tmp_s_fu_1087_p17 = sub_ln98_3_reg_1668;

assign trunc_ln103_fu_535_p1 = empty_fu_529_p2[2:0];

assign trunc_ln88_fu_525_p1 = i_fu_176[2:0];

assign zext_ln103_fu_569_p1 = tmp_fu_539_p17;

assign zext_ln106_fu_1027_p1 = tmp_8_reg_1652;
