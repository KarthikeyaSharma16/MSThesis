...
module test_test_Pipeline_VITIS_LOOP_62_5 (
        ...
        p_out7,
        p_out7_ap_vld,
        add169_1725_11125_out,
        add169_1725_11125_out_ap_vld,
        add169_17251124_out,
        add169_17251124_out_ap_vld,
        add169_41123_out,
        add169_41123_out_ap_vld,
        add169_31122_out,
        add169_31122_out_ap_vld,
        add169_28191121_out,
        add169_28191121_out_ap_vld,
        add169_17901120_out,
        add169_17901120_out_ap_vld,
        add1691119_out,
        add1691119_out_ap_vld
);
...
output  [63:0] add1381144_out;
output   add1381144_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;
output  [63:0] p_out1;
...
output  [63:0] add169_1725_11125_out;
output   add169_1725_11125_out_ap_vld;
output  [63:0] add169_17251124_out;
output   add169_17251124_out_ap_vld;
output  [63:0] add169_41123_out;
output   add169_41123_out_ap_vld;
output  [63:0] add169_31122_out;
output   add169_31122_out_ap_vld;
output  [63:0] add169_28191121_out;
output   add169_28191121_out_ap_vld;
output  [63:0] add169_17901120_out;
output   add169_17901120_out_ap_vld;
output  [63:0] add1691119_out;
output   add1691119_out_ap_vld;

reg ap_idle;
reg add1381144_out_ap_vld;
reg p_out_ap_vld;
reg p_out1_ap_vld;
reg p_out2_ap_vld;
reg p_out3_ap_vld;
...
reg p_out6_ap_vld;
reg p_out7_ap_vld;
reg add169_1725_11125_out_ap_vld;
reg add169_17251124_out_ap_vld;
reg add169_41123_out_ap_vld;
reg add169_31122_out_ap_vld;
reg add169_28191121_out_ap_vld;
reg add169_17901120_out_ap_vld;
reg add1691119_out_ap_vld;
...
reg   [63:0] add1691119_fu_226;
wire   [63:0] add_ln78_1_fu_3525_p2;
reg   [63:0] add169_17901120_fu_230;
wire   [63:0] add_ln78_2_fu_3587_p2;
reg   [63:0] add169_28191121_fu_234;
wire   [63:0] add_ln80_6_fu_3668_p2;
reg   [63:0] add169_31122_fu_238;
wire   [63:0] add_ln80_12_fu_3759_p2;
reg   [63:0] add169_41123_fu_242;
wire   [63:0] add_ln80_18_fu_3883_p2;
reg   [63:0] add169_17251124_fu_246;
wire   [63:0] add_ln80_24_fu_4002_p2;
reg   [63:0] add169_1725_11125_fu_250;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add1381144_fu_286 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add1381144_fu_286 <= select_ln70_6_fu_4922_p3;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add1691119_fu_226 <= arr;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add1691119_fu_226 <= add_ln78_1_fu_3525_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add169_17251124_fu_246 <= arr_5;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add169_17251124_fu_246 <= add_ln80_24_fu_4002_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add169_1725_11125_fu_250 <= arr_6;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add169_1725_11125_fu_250 <= add_ln80_30_fu_4120_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add169_17901120_fu_230 <= arr_1;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add169_17901120_fu_230 <= add_ln78_2_fu_3587_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add169_28191121_fu_234 <= arr_2;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add169_28191121_fu_234 <= add_ln80_6_fu_3668_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add169_31122_fu_238 <= arr_3;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add169_31122_fu_238 <= add_ln80_12_fu_3759_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add169_41123_fu_242 <= arr_4;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add169_41123_fu_242 <= add_ln80_18_fu_3883_p2;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add1381144_out_ap_vld = 1'b1;
    end else begin
        add1381144_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add1691119_out_ap_vld = 1'b1;
    end else begin
        add1691119_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add169_17251124_out_ap_vld = 1'b1;
    end else begin
        add169_17251124_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add169_1725_11125_out_ap_vld = 1'b1;
    end else begin
        add169_1725_11125_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add169_17901120_out_ap_vld = 1'b1;
    end else begin
        add169_17901120_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add169_28191121_out_ap_vld = 1'b1;
    end else begin
        add169_28191121_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add169_31122_out_ap_vld = 1'b1;
    end else begin
        add169_31122_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add169_41123_out_ap_vld = 1'b1;
    end else begin
        add169_41123_out_ap_vld = 1'b0;
    end
end
...
assign add1381144_out = add1381144_fu_286;

assign add1691119_out = add1691119_fu_226;

assign add169_17251124_out = add169_17251124_fu_246;

assign add169_1725_11125_out = add169_1725_11125_fu_250;

assign add169_17901120_out = add169_17901120_fu_230;

assign add169_28191121_out = add169_28191121_fu_234;

assign add169_31122_out = add169_31122_fu_238;

assign add169_41123_out = add169_41123_fu_242;
...
assign add_ln70_fu_4436_p2 = (tmp15_reg_6718 + add1381144_fu_286);

assign add_ln78_1_fu_3525_p2 = (add1691119_fu_226 + add_ln78_4_fu_3520_p2);

assign add_ln78_2_fu_3587_p2 = (add169_17901120_fu_230 + add_ln78_8_fu_3581_p2);
...
assign add_ln80_12_fu_3759_p2 = (add169_31122_fu_238 + add_ln80_11_fu_3753_p2);
...
assign add_ln80_18_fu_3883_p2 = (add169_41123_fu_242 + add_ln80_17_fu_3877_p2);
...
assign add_ln80_24_fu_4002_p2 = (add169_17251124_fu_246 + add_ln80_23_fu_3996_p2);
...
assign add_ln80_30_fu_4120_p2 = (add169_1725_11125_fu_250 + add_ln80_29_fu_4114_p2);
...
assign add_ln80_6_fu_3668_p2 = (add169_28191121_fu_234 + add_ln80_5_fu_3662_p2);
...
assign select_ln70_fu_4441_p3 = ((tmp_46_reg_6292_pp0_iter1_reg[0:0] == 1'b1) ? add_ln70_fu_4436_p2 : add1381144_fu_286);
