...
module test_test_Pipeline_VITIS_LOOP_62_5 (
        ...
        p_out7_ap_vld,
        add169_2490933_out,
        add169_2490933_out_ap_vld,
        add169_1461_2932_out,
        add169_1461_2932_out_ap_vld,
        add169_1461_1931_out,
        add169_1461_1931_out_ap_vld,
        add169_1461930_out,
        add169_1461930_out_ap_vld,
        add169_2613929_out,
        add169_2613929_out_ap_vld,
        add169_1584928_out,
        add169_1584928_out_ap_vld,
        add169927_out,
        add169927_out_ap_vld
);
...
output  [63:0] add138954_out;
output   add138954_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;
output  [63:0] p_out1;
...
output  [63:0] add169_2490933_out;
output   add169_2490933_out_ap_vld;
output  [63:0] add169_1461_2932_out;
output   add169_1461_2932_out_ap_vld;
output  [63:0] add169_1461_1931_out;
output   add169_1461_1931_out_ap_vld;
output  [63:0] add169_1461930_out;
output   add169_1461930_out_ap_vld;
output  [63:0] add169_2613929_out;
output   add169_2613929_out_ap_vld;
output  [63:0] add169_1584928_out;
output   add169_1584928_out_ap_vld;
output  [63:0] add169927_out;
output   add169927_out_ap_vld;

reg ap_idle;
reg add138954_out_ap_vld;
reg p_out_ap_vld;
reg p_out1_ap_vld;
reg p_out2_ap_vld;
reg p_out3_ap_vld;
...
reg p_out6_ap_vld;
reg p_out7_ap_vld;
reg add169_2490933_out_ap_vld;
reg add169_1461_2932_out_ap_vld;
reg add169_1461_1931_out_ap_vld;
reg add169_1461930_out_ap_vld;
reg add169_2613929_out_ap_vld;
reg add169_1584928_out_ap_vld;
reg add169927_out_ap_vld;
...
reg   [63:0] add169927_fu_230;
wire   [63:0] add_ln78_3_fu_5325_p2;
reg   [63:0] add169_1584928_fu_234;
wire   [63:0] add_ln78_6_fu_7069_p2;
reg   [63:0] add169_2613929_fu_238;
wire   [63:0] add_ln78_8_fu_7079_p2;
reg   [63:0] add169_1461930_fu_242;
wire   [63:0] add_ln78_9_fu_7089_p2;
reg   [63:0] add169_1461_1931_fu_246;
wire   [63:0] add_ln80_10_fu_7099_p2;
reg   [63:0] add169_1461_2932_fu_250;
wire   [63:0] add_ln80_20_fu_7109_p2;
reg   [63:0] add169_2490933_fu_254;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add138954_out_ap_vld = 1'b1;
    end else begin
        add138954_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169927_out_ap_vld = 1'b1;
    end else begin
        add169927_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169_1461930_out_ap_vld = 1'b1;
    end else begin
        add169_1461930_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169_1461_1931_out_ap_vld = 1'b1;
    end else begin
        add169_1461_1931_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169_1461_2932_out_ap_vld = 1'b1;
    end else begin
        add169_1461_2932_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169_1584928_out_ap_vld = 1'b1;
    end else begin
        add169_1584928_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169_2490933_out_ap_vld = 1'b1;
    end else begin
        add169_2490933_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9109 == 1'd1))) begin
        add169_2613929_out_ap_vld = 1'b1;
    end else begin
        add169_2613929_out_ap_vld = 1'b0;
    end
end
...
assign add138954_out = add138954_fu_290;

assign add169927_out = add169927_fu_230;

assign add169_1461930_out = add169_1461930_fu_242;

assign add169_1461_1931_out = add169_1461_1931_fu_246;

assign add169_1461_2932_out = add169_1461_2932_fu_250;

assign add169_1584928_out = add169_1584928_fu_234;

assign add169_2490933_out = add169_2490933_fu_254;

assign add169_2613929_out = add169_2613929_fu_238;
...
assign add_ln70_fu_6202_p2 = (tmp15_reg_9764 + add138954_fu_290);
...
assign add_ln78_3_fu_5325_p2 = (add169927_fu_230 + add_ln78_5_fu_5319_p2);
...
assign add_ln78_6_fu_7069_p2 = (add169_1584928_fu_234 + add_ln78_14_fu_7065_p2);

assign add_ln78_7_fu_5363_p2 = (and_ln80_3_fu_2540_p2 + and_ln80_18_fu_3308_p2);

assign add_ln78_8_fu_7079_p2 = (add169_2613929_fu_238 + add_ln78_21_fu_7075_p2);

assign add_ln78_9_fu_7089_p2 = (add169_1461930_fu_242 + add_ln78_29_fu_7085_p2);

assign add_ln78_fu_5296_p2 = (and_ln80_fu_2485_p2 + and_ln78_fu_3263_p2);

assign add_ln80_10_fu_7099_p2 = (add169_1461_1931_fu_246 + add_ln80_9_fu_7095_p2);
...
assign add_ln80_20_fu_7109_p2 = (add169_1461_2932_fu_250 + add_ln80_19_fu_7105_p2);
...
assign add_ln80_30_fu_7119_p2 = (add169_2490933_fu_254 + add_ln80_29_fu_7115_p2);
...
assign select_ln70_fu_6207_p3 = ((tmp_46_reg_9132_pp0_iter2_reg[0:0] == 1'b1) ? add_ln70_fu_6202_p2 : add138954_fu_290);
