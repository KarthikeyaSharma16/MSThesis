...
set C_modelArgList {
	...
	{ sext_ln149 int 62 regular  }
	{ zext_ln131 int 28 regular  }
	{ out1_w_1 int 29 regular  }
	{ zext_ln133 int 28 regular  }
	{ zext_ln134 int 28 regular  }
	{ zext_ln135 int 28 regular  }
	{ zext_ln136 int 28 regular  }
	{ zext_ln137 int 28 regular  }
	{ zext_ln138 int 28 regular  }
	{ zext_ln139 int 28 regular  }
	{ out1_w_9 int 29 regular  }
	{ zext_ln141 int 28 regular  }
	{ zext_ln142 int 28 regular  }
	{ zext_ln143 int 28 regular  }
	{ zext_ln144 int 28 regular  }
	{ zext_ln145 int 28 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln149", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln131", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "out1_w_1", "interface" : "wire", "bitwidth" : 29, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln133", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln134", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln135", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln136", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln137", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln138", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln139", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "out1_w_9", "interface" : "wire", "bitwidth" : 29, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln141", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln142", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln143", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln144", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln145", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln149 sc_in sc_lv 62 signal 1 } 
	{ zext_ln131 sc_in sc_lv 28 signal 2 } 
	{ out1_w_1 sc_in sc_lv 29 signal 3 } 
	{ zext_ln133 sc_in sc_lv 28 signal 4 } 
	{ zext_ln134 sc_in sc_lv 28 signal 5 } 
	{ zext_ln135 sc_in sc_lv 28 signal 6 } 
	{ zext_ln136 sc_in sc_lv 28 signal 7 } 
	{ zext_ln137 sc_in sc_lv 28 signal 8 } 
	{ zext_ln138 sc_in sc_lv 28 signal 9 } 
	{ zext_ln139 sc_in sc_lv 28 signal 10 } 
	{ out1_w_9 sc_in sc_lv 29 signal 11 } 
	{ zext_ln141 sc_in sc_lv 28 signal 12 } 
	{ zext_ln142 sc_in sc_lv 28 signal 13 } 
	{ zext_ln143 sc_in sc_lv 28 signal 14 } 
	{ zext_ln144 sc_in sc_lv 28 signal 15 } 
	{ zext_ln145 sc_in sc_lv 28 signal 16 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln149", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln149", "role": "default" }} , 
 	{ "name": "zext_ln131", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln131", "role": "default" }} , 
 	{ "name": "out1_w_1", "direction": "in", "datatype": "sc_lv", "bitwidth":29, "type": "signal", "bundle":{"name": "out1_w_1", "role": "default" }} , 
 	{ "name": "zext_ln133", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln133", "role": "default" }} , 
 	{ "name": "zext_ln134", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln134", "role": "default" }} , 
 	{ "name": "zext_ln135", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln135", "role": "default" }} , 
 	{ "name": "zext_ln136", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln136", "role": "default" }} , 
 	{ "name": "zext_ln137", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln137", "role": "default" }} , 
 	{ "name": "zext_ln138", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln138", "role": "default" }} , 
 	{ "name": "zext_ln139", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln139", "role": "default" }} , 
 	{ "name": "out1_w_9", "direction": "in", "datatype": "sc_lv", "bitwidth":29, "type": "signal", "bundle":{"name": "out1_w_9", "role": "default" }} , 
 	{ "name": "zext_ln141", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln141", "role": "default" }} , 
 	{ "name": "zext_ln142", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln142", "role": "default" }} , 
 	{ "name": "zext_ln143", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln143", "role": "default" }} , 
 	{ "name": "zext_ln144", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln144", "role": "default" }} , 
 	{ "name": "zext_ln145", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "zext_ln145", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_16_4_29_1_1_U307", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln149 { ap_none {  { sext_ln149 in_data 0 62 } } }
	zext_ln131 { ap_none {  { zext_ln131 in_data 0 28 } } }
	out1_w_1 { ap_none {  { out1_w_1 in_data 0 29 } } }
	zext_ln133 { ap_none {  { zext_ln133 in_data 0 28 } } }
	zext_ln134 { ap_none {  { zext_ln134 in_data 0 28 } } }
	zext_ln135 { ap_none {  { zext_ln135 in_data 0 28 } } }
	zext_ln136 { ap_none {  { zext_ln136 in_data 0 28 } } }
	zext_ln137 { ap_none {  { zext_ln137 in_data 0 28 } } }
	zext_ln138 { ap_none {  { zext_ln138 in_data 0 28 } } }
	zext_ln139 { ap_none {  { zext_ln139 in_data 0 28 } } }
	out1_w_9 { ap_none {  { out1_w_9 in_data 0 29 } } }
	zext_ln141 { ap_none {  { zext_ln141 in_data 0 28 } } }
	zext_ln142 { ap_none {  { zext_ln142 in_data 0 28 } } }
	zext_ln143 { ap_none {  { zext_ln143 in_data 0 28 } } }
	zext_ln144 { ap_none {  { zext_ln144 in_data 0 28 } } }
	zext_ln145 { ap_none {  { zext_ln145 in_data 0 28 } } }
