...
module test_test_Pipeline_VITIS_LOOP_62_5 (
        ...
        p_out7_ap_vld,
        add169_1_1340_out,
        add169_1_1340_out_ap_vld,
        add169_1339_out,
        add169_1339_out_ap_vld,
        add169_4338_out,
        add169_4338_out_ap_vld,
        add169_3337_out,
        add169_3337_out_ap_vld,
        add169_2336_out,
        add169_2336_out_ap_vld,
        add169_1228335_out,
        add169_1228335_out_ap_vld,
        add169334_out,
        add169334_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add47_14355_reload;
input  [63:0] add47_13354_reload;
input  [63:0] add47_12353_reload;
input  [63:0] add47_11352_reload;
input  [63:0] add47_10351_reload;
input  [63:0] add47_9350_reload;
input  [63:0] add47_8349_reload;
input  [63:0] add47_6347_reload;
input  [63:0] add47_5346_reload;
input  [63:0] add47_4345_reload;
input  [63:0] add47_3344_reload;
input  [63:0] add47_2343_reload;
input  [63:0] add47_1342_reload;
input  [63:0] add47341_reload;
...
input  [31:0] conv36;
output  [63:0] add138357_out;
output   add138357_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;
output  [63:0] p_out1;
...
output  [63:0] add169_1_1340_out;
output   add169_1_1340_out_ap_vld;
output  [63:0] add169_1339_out;
output   add169_1339_out_ap_vld;
output  [63:0] add169_4338_out;
output   add169_4338_out_ap_vld;
output  [63:0] add169_3337_out;
output   add169_3337_out_ap_vld;
output  [63:0] add169_2336_out;
output   add169_2336_out_ap_vld;
output  [63:0] add169_1228335_out;
output   add169_1228335_out_ap_vld;
output  [63:0] add169334_out;
output   add169334_out_ap_vld;

reg ap_idle;
reg add138357_out_ap_vld;
reg p_out_ap_vld;
reg p_out1_ap_vld;
reg p_out2_ap_vld;
reg p_out3_ap_vld;
...
reg p_out6_ap_vld;
reg p_out7_ap_vld;
reg add169_1_1340_out_ap_vld;
reg add169_1339_out_ap_vld;
reg add169_4338_out_ap_vld;
reg add169_3337_out_ap_vld;
reg add169_2336_out_ap_vld;
reg add169_1228335_out_ap_vld;
reg add169334_out_ap_vld;
...
reg   [63:0] add169334_fu_222;
wire   [63:0] add_ln80_1_fu_1047_p2;
reg   [63:0] add169_1228335_fu_226;
wire   [63:0] add_ln80_3_fu_1141_p2;
reg   [63:0] add169_2336_fu_230;
wire   [63:0] add_ln80_5_fu_1590_p2;
reg   [63:0] add169_3337_fu_234;
wire   [63:0] add_ln80_7_fu_1684_p2;
reg   [63:0] add169_4338_fu_238;
wire   [63:0] add_ln80_9_fu_1781_p2;
reg   [63:0] add169_1339_fu_242;
wire   [63:0] add_ln80_11_fu_1879_p2;
reg   [63:0] add169_1_1340_fu_246;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add138357_out_ap_vld = 1'b1;
    end else begin
        add138357_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169334_out_ap_vld = 1'b1;
    end else begin
        add169334_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169_1228335_out_ap_vld = 1'b1;
    end else begin
        add169_1228335_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169_1339_out_ap_vld = 1'b1;
    end else begin
        add169_1339_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169_1_1340_out_ap_vld = 1'b1;
    end else begin
        add169_1_1340_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169_2336_out_ap_vld = 1'b1;
    end else begin
        add169_2336_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169_3337_out_ap_vld = 1'b1;
    end else begin
        add169_3337_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3134 == 1'd1))) begin
        add169_4338_out_ap_vld = 1'b1;
    end else begin
        add169_4338_out_ap_vld = 1'b0;
    end
end
...
assign add138357_out = add138357_fu_282;

assign add169334_out = add169334_fu_222;

assign add169_1228335_out = add169_1228335_fu_226;

assign add169_1339_out = add169_1339_fu_242;

assign add169_1_1340_out = add169_1_1340_fu_246;

assign add169_2336_out = add169_2336_fu_230;

assign add169_3337_out = add169_3337_fu_234;

assign add169_4338_out = add169_4338_fu_238;

assign add_ln62_fu_1325_p2 = ($signed(i_fu_290) + $signed(4'd15));

assign add_ln68_fu_887_p2 = (k_fu_286 + 4'd1);

assign add_ln70_fu_1470_p2 = (tmp15_fu_770_p2 + add138357_fu_282);

assign add_ln80_10_fu_1775_p2 = (and_ln80_9_fu_1769_p2 + and_ln80_8_fu_1757_p2);

assign add_ln80_11_fu_1879_p2 = (add169_1339_fu_242 + add_ln80_12_fu_1873_p2);

assign add_ln80_12_fu_1873_p2 = (and_ln80_11_fu_1867_p2 + and_ln80_10_fu_1855_p2);

assign add_ln80_13_fu_1971_p2 = (add169_1_1340_fu_246 + add_ln80_22_fu_1965_p2);
...
assign add_ln80_1_fu_1047_p2 = (add169334_fu_222 + add_ln80_2_fu_1041_p2);
...
assign add_ln80_3_fu_1141_p2 = (add169_1228335_fu_226 + add_ln80_4_fu_1135_p2);

assign add_ln80_4_fu_1135_p2 = (and_ln80_3_fu_1129_p2 + and_ln80_2_fu_1115_p2);

assign add_ln80_5_fu_1590_p2 = (add169_2336_fu_230 + add_ln80_6_fu_1584_p2);

assign add_ln80_6_fu_1584_p2 = (and_ln80_5_fu_1578_p2 + and_ln80_4_fu_1566_p2);

assign add_ln80_7_fu_1684_p2 = (add169_3337_fu_234 + add_ln80_8_fu_1678_p2);

assign add_ln80_8_fu_1678_p2 = (and_ln80_7_fu_1672_p2 + and_ln80_6_fu_1660_p2);

assign add_ln80_9_fu_1781_p2 = (add169_4338_fu_238 + add_ln80_10_fu_1775_p2);
...
assign select_ln70_fu_1476_p3 = ((tmp_1_reg_3138[0:0] == 1'b1) ? add_ln70_fu_1470_p2 : add138357_fu_282);
