...
module test_test_Pipeline_VITIS_LOOP_62_5 (
        ...
        p_out7_ap_vld,
        add169_1_11374_out,
        add169_1_11374_out_ap_vld,
        add169_11373_out,
        add169_11373_out_ap_vld,
        add169_41372_out,
        add169_41372_out_ap_vld,
        add169_31371_out,
        add169_31371_out_ap_vld,
        add169_21370_out,
        add169_21370_out_ap_vld,
        add169_16201369_out,
        add169_16201369_out_ap_vld,
        add1691368_out,
        add1691368_out_ap_vld
);
...
input  [31:0] conv36;
output  [63:0] add1381391_out;
output   add1381391_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;
output  [63:0] p_out1;
...
output  [63:0] add169_1_11374_out;
output   add169_1_11374_out_ap_vld;
output  [63:0] add169_11373_out;
output   add169_11373_out_ap_vld;
output  [63:0] add169_41372_out;
output   add169_41372_out_ap_vld;
output  [63:0] add169_31371_out;
output   add169_31371_out_ap_vld;
output  [63:0] add169_21370_out;
output   add169_21370_out_ap_vld;
output  [63:0] add169_16201369_out;
output   add169_16201369_out_ap_vld;
output  [63:0] add1691368_out;
output   add1691368_out_ap_vld;

reg ap_idle;
reg add1381391_out_ap_vld;
reg p_out_ap_vld;
reg p_out1_ap_vld;
reg p_out2_ap_vld;
reg p_out3_ap_vld;
...
reg p_out6_ap_vld;
reg p_out7_ap_vld;
reg add169_1_11374_out_ap_vld;
reg add169_11373_out_ap_vld;
reg add169_41372_out_ap_vld;
reg add169_31371_out_ap_vld;
reg add169_21370_out_ap_vld;
reg add169_16201369_out_ap_vld;
reg add1691368_out_ap_vld;
...
reg   [63:0] add1691368_fu_208;
wire   [63:0] add_ln80_1_fu_991_p2;
reg   [63:0] add169_16201369_fu_212;
wire   [63:0] add_ln80_3_fu_1085_p2;
reg   [63:0] add169_21370_fu_216;
wire   [63:0] add_ln80_5_fu_1534_p2;
reg   [63:0] add169_31371_fu_220;
wire   [63:0] add_ln80_7_fu_1628_p2;
reg   [63:0] add169_41372_fu_224;
wire   [63:0] add_ln80_9_fu_1725_p2;
reg   [63:0] add169_11373_fu_228;
wire   [63:0] add_ln80_11_fu_1823_p2;
reg   [63:0] add169_1_11374_fu_232;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add1381391_out_ap_vld = 1'b1;
    end else begin
        add1381391_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add1691368_out_ap_vld = 1'b1;
    end else begin
        add1691368_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_11373_out_ap_vld = 1'b1;
    end else begin
        add169_11373_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_16201369_out_ap_vld = 1'b1;
    end else begin
        add169_16201369_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_1_11374_out_ap_vld = 1'b1;
    end else begin
        add169_1_11374_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_21370_out_ap_vld = 1'b1;
    end else begin
        add169_21370_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_31371_out_ap_vld = 1'b1;
    end else begin
        add169_31371_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_41372_out_ap_vld = 1'b1;
    end else begin
        add169_41372_out_ap_vld = 1'b0;
    end
end
...
assign add1381391_out = add1381391_fu_268;

assign add1691368_out = add1691368_fu_208;

assign add169_11373_out = add169_11373_fu_228;

assign add169_16201369_out = add169_16201369_fu_212;

assign add169_1_11374_out = add169_1_11374_fu_232;

assign add169_21370_out = add169_21370_fu_216;

assign add169_31371_out = add169_31371_fu_220;

assign add169_41372_out = add169_41372_fu_224;

assign add_ln62_fu_1269_p2 = ($signed(i_fu_276) + $signed(4'd15));

assign add_ln68_fu_831_p2 = (k_fu_272 + 4'd1);

assign add_ln70_fu_1414_p2 = (tmp15_fu_714_p2 + add1381391_fu_268);

assign add_ln80_10_fu_1719_p2 = (and_ln80_9_fu_1713_p2 + and_ln80_8_fu_1701_p2);

assign add_ln80_11_fu_1823_p2 = (add169_11373_fu_228 + add_ln80_12_fu_1817_p2);

assign add_ln80_12_fu_1817_p2 = (and_ln80_11_fu_1811_p2 + and_ln80_10_fu_1799_p2);

assign add_ln80_13_fu_1915_p2 = (add169_1_11374_fu_232 + add_ln80_22_fu_1909_p2);
...
assign add_ln80_1_fu_991_p2 = (add1691368_fu_208 + add_ln80_2_fu_985_p2);
...
assign add_ln80_3_fu_1085_p2 = (add169_16201369_fu_212 + add_ln80_4_fu_1079_p2);

assign add_ln80_4_fu_1079_p2 = (and_ln80_3_fu_1073_p2 + and_ln80_2_fu_1059_p2);

assign add_ln80_5_fu_1534_p2 = (add169_21370_fu_216 + add_ln80_6_fu_1528_p2);

assign add_ln80_6_fu_1528_p2 = (and_ln80_5_fu_1522_p2 + and_ln80_4_fu_1510_p2);

assign add_ln80_7_fu_1628_p2 = (add169_31371_fu_220 + add_ln80_8_fu_1622_p2);

assign add_ln80_8_fu_1622_p2 = (and_ln80_7_fu_1616_p2 + and_ln80_6_fu_1604_p2);

assign add_ln80_9_fu_1725_p2 = (add169_41372_fu_224 + add_ln80_10_fu_1719_p2);
...
assign select_ln70_fu_1420_p3 = ((tmp_23_reg_3082[0:0] == 1'b1) ? add_ln70_fu_1414_p2 : add1381391_fu_268);
