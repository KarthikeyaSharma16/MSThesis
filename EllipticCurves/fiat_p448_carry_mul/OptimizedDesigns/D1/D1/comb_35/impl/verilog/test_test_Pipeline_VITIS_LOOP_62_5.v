...
module test_test_Pipeline_VITIS_LOOP_62_5 (
        ...
        p_out7_ap_vld,
        add169_23741179_out,
        add169_23741179_out_ap_vld,
        add169_1345_21178_out,
        add169_1345_21178_out_ap_vld,
        add169_1345_11177_out,
        add169_1345_11177_out_ap_vld,
        add169_13451176_out,
        add169_13451176_out_ap_vld,
        add169_24351175_out,
        add169_24351175_out_ap_vld,
        add169_14061174_out,
        add169_14061174_out_ap_vld,
        add1691173_out,
        add1691173_out_ap_vld
);
...
output  [63:0] add1381198_out;
output   add1381198_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;
output  [63:0] p_out1;
...
output  [63:0] add169_23741179_out;
output   add169_23741179_out_ap_vld;
output  [63:0] add169_1345_21178_out;
output   add169_1345_21178_out_ap_vld;
output  [63:0] add169_1345_11177_out;
output   add169_1345_11177_out_ap_vld;
output  [63:0] add169_13451176_out;
output   add169_13451176_out_ap_vld;
output  [63:0] add169_24351175_out;
output   add169_24351175_out_ap_vld;
output  [63:0] add169_14061174_out;
output   add169_14061174_out_ap_vld;
output  [63:0] add1691173_out;
output   add1691173_out_ap_vld;

reg ap_idle;
reg add1381198_out_ap_vld;
reg p_out_ap_vld;
reg p_out1_ap_vld;
reg p_out2_ap_vld;
reg p_out3_ap_vld;
...
reg p_out6_ap_vld;
reg p_out7_ap_vld;
reg add169_23741179_out_ap_vld;
reg add169_1345_21178_out_ap_vld;
reg add169_1345_11177_out_ap_vld;
reg add169_13451176_out_ap_vld;
reg add169_24351175_out_ap_vld;
reg add169_14061174_out_ap_vld;
reg add1691173_out_ap_vld;
...
reg   [63:0] add1691173_fu_226;
wire   [63:0] add_ln78_1_fu_3525_p2;
reg   [63:0] add169_14061174_fu_230;
wire   [63:0] add_ln78_2_fu_3587_p2;
reg   [63:0] add169_24351175_fu_234;
wire   [63:0] add_ln80_6_fu_3668_p2;
reg   [63:0] add169_13451176_fu_238;
wire   [63:0] add_ln80_12_fu_3759_p2;
reg   [63:0] add169_1345_11177_fu_242;
wire   [63:0] add_ln80_18_fu_3883_p2;
reg   [63:0] add169_1345_21178_fu_246;
wire   [63:0] add_ln80_24_fu_4002_p2;
reg   [63:0] add169_23741179_fu_250;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add1381198_out_ap_vld = 1'b1;
    end else begin
        add1381198_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add1691173_out_ap_vld = 1'b1;
    end else begin
        add1691173_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add169_13451176_out_ap_vld = 1'b1;
    end else begin
        add169_13451176_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add169_1345_11177_out_ap_vld = 1'b1;
    end else begin
        add169_1345_11177_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add169_1345_21178_out_ap_vld = 1'b1;
    end else begin
        add169_1345_21178_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add169_14061174_out_ap_vld = 1'b1;
    end else begin
        add169_14061174_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add169_23741179_out_ap_vld = 1'b1;
    end else begin
        add169_23741179_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_6282 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add169_24351175_out_ap_vld = 1'b1;
    end else begin
        add169_24351175_out_ap_vld = 1'b0;
    end
end
...
assign add1381198_out = add1381198_fu_286;

assign add1691173_out = add1691173_fu_226;

assign add169_13451176_out = add169_13451176_fu_238;

assign add169_1345_11177_out = add169_1345_11177_fu_242;

assign add169_1345_21178_out = add169_1345_21178_fu_246;

assign add169_14061174_out = add169_14061174_fu_230;

assign add169_23741179_out = add169_23741179_fu_250;

assign add169_24351175_out = add169_24351175_fu_234;
...
assign add_ln70_fu_4436_p2 = (tmp15_reg_6718 + add1381198_fu_286);

assign add_ln78_1_fu_3525_p2 = (add1691173_fu_226 + add_ln78_4_fu_3520_p2);

assign add_ln78_2_fu_3587_p2 = (add169_14061174_fu_230 + add_ln78_8_fu_3581_p2);
...
assign add_ln80_12_fu_3759_p2 = (add169_13451176_fu_238 + add_ln80_11_fu_3753_p2);
...
assign add_ln80_18_fu_3883_p2 = (add169_1345_11177_fu_242 + add_ln80_17_fu_3877_p2);
...
assign add_ln80_24_fu_4002_p2 = (add169_1345_21178_fu_246 + add_ln80_23_fu_3996_p2);
...
assign add_ln80_30_fu_4120_p2 = (add169_23741179_fu_250 + add_ln80_29_fu_4114_p2);
...
assign add_ln80_6_fu_3668_p2 = (add169_24351175_fu_234 + add_ln80_5_fu_3662_p2);
...
assign select_ln70_fu_4441_p3 = ((tmp_46_reg_6292_pp0_iter1_reg[0:0] == 1'b1) ? add_ln70_fu_4436_p2 : add1381198_fu_286);
