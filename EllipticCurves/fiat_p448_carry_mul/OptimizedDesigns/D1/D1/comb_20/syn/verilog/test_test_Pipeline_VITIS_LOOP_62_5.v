...
module test_test_Pipeline_VITIS_LOOP_62_5 (
        ...
        p_out7_ap_vld,
        add169_6421_out,
        add169_6421_out_ap_vld,
        add169_5420_out,
        add169_5420_out_ap_vld,
        add169_4306419_out,
        add169_4306419_out_ap_vld,
        add169_3278418_out,
        add169_3278418_out_ap_vld,
        add169_2250417_out,
        add169_2250417_out_ap_vld,
        add169_1222416_out,
        add169_1222416_out_ap_vld,
        add169415_out,
        add169415_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add47_14436_reload;
input  [63:0] add47_13435_reload;
input  [63:0] add47_12434_reload;
input  [63:0] add47_11433_reload;
input  [63:0] add47_10432_reload;
input  [63:0] add47_9431_reload;
input  [63:0] add47_8430_reload;
input  [63:0] add47_6428_reload;
input  [63:0] add47_5427_reload;
input  [63:0] add47_4426_reload;
input  [63:0] add47_3425_reload;
input  [63:0] add47_2424_reload;
input  [63:0] add47_1423_reload;
input  [63:0] add47422_reload;
...
output  [63:0] add138442_out;
output   add138442_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;
output  [63:0] p_out1;
...
output  [63:0] add169_6421_out;
output   add169_6421_out_ap_vld;
output  [63:0] add169_5420_out;
output   add169_5420_out_ap_vld;
output  [63:0] add169_4306419_out;
output   add169_4306419_out_ap_vld;
output  [63:0] add169_3278418_out;
output   add169_3278418_out_ap_vld;
output  [63:0] add169_2250417_out;
output   add169_2250417_out_ap_vld;
output  [63:0] add169_1222416_out;
output   add169_1222416_out_ap_vld;
output  [63:0] add169415_out;
output   add169415_out_ap_vld;

reg ap_idle;
reg add138442_out_ap_vld;
reg p_out_ap_vld;
reg p_out1_ap_vld;
reg p_out2_ap_vld;
reg p_out3_ap_vld;
...
reg p_out6_ap_vld;
reg p_out7_ap_vld;
reg add169_6421_out_ap_vld;
reg add169_5420_out_ap_vld;
reg add169_4306419_out_ap_vld;
reg add169_3278418_out_ap_vld;
reg add169_2250417_out_ap_vld;
reg add169_1222416_out_ap_vld;
reg add169415_out_ap_vld;
...
reg   [63:0] add169415_fu_244;
wire   [63:0] add_ln78_3_fu_5381_p2;
reg   [63:0] add169_1222416_fu_248;
wire   [63:0] add_ln78_6_fu_7125_p2;
reg   [63:0] add169_2250417_fu_252;
wire   [63:0] add_ln78_8_fu_7135_p2;
reg   [63:0] add169_3278418_fu_256;
wire   [63:0] add_ln78_9_fu_7145_p2;
reg   [63:0] add169_4306419_fu_260;
wire   [63:0] add_ln80_10_fu_7155_p2;
reg   [63:0] add169_5420_fu_264;
wire   [63:0] add_ln80_20_fu_7165_p2;
reg   [63:0] add169_6421_fu_268;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9165 == 1'd1))) begin
        add138442_out_ap_vld = 1'b1;
    end else begin
        add138442_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9165 == 1'd1))) begin
        add169415_out_ap_vld = 1'b1;
    end else begin
        add169415_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9165 == 1'd1))) begin
        add169_1222416_out_ap_vld = 1'b1;
    end else begin
        add169_1222416_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9165 == 1'd1))) begin
        add169_2250417_out_ap_vld = 1'b1;
    end else begin
        add169_2250417_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9165 == 1'd1))) begin
        add169_3278418_out_ap_vld = 1'b1;
    end else begin
        add169_3278418_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9165 == 1'd1))) begin
        add169_4306419_out_ap_vld = 1'b1;
    end else begin
        add169_4306419_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9165 == 1'd1))) begin
        add169_5420_out_ap_vld = 1'b1;
    end else begin
        add169_5420_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_9165 == 1'd1))) begin
        add169_6421_out_ap_vld = 1'b1;
    end else begin
        add169_6421_out_ap_vld = 1'b0;
    end
end
...
assign add138442_out = add138442_fu_304;

assign add169415_out = add169415_fu_244;

assign add169_1222416_out = add169_1222416_fu_248;

assign add169_2250417_out = add169_2250417_fu_252;

assign add169_3278418_out = add169_3278418_fu_256;

assign add169_4306419_out = add169_4306419_fu_260;

assign add169_5420_out = add169_5420_fu_264;

assign add169_6421_out = add169_6421_fu_268;
...
assign add_ln70_fu_6258_p2 = (tmp15_reg_9820 + add138442_fu_304);
...
assign add_ln78_3_fu_5381_p2 = (add169415_fu_244 + add_ln78_5_fu_5375_p2);
...
assign add_ln78_6_fu_7125_p2 = (add169_1222416_fu_248 + add_ln78_14_fu_7121_p2);

assign add_ln78_7_fu_5419_p2 = (and_ln80_3_fu_2596_p2 + and_ln80_18_fu_3364_p2);

assign add_ln78_8_fu_7135_p2 = (add169_2250417_fu_252 + add_ln78_21_fu_7131_p2);

assign add_ln78_9_fu_7145_p2 = (add169_3278418_fu_256 + add_ln78_29_fu_7141_p2);

assign add_ln78_fu_5352_p2 = (and_ln80_fu_2541_p2 + and_ln78_fu_3319_p2);

assign add_ln80_10_fu_7155_p2 = (add169_4306419_fu_260 + add_ln80_9_fu_7151_p2);
...
assign add_ln80_20_fu_7165_p2 = (add169_5420_fu_264 + add_ln80_19_fu_7161_p2);
...
assign add_ln80_30_fu_7175_p2 = (add169_6421_fu_268 + add_ln80_29_fu_7171_p2);
...
assign select_ln70_fu_6263_p3 = ((tmp_1_reg_9188_pp0_iter2_reg[0:0] == 1'b1) ? add_ln70_fu_6258_p2 : add138442_fu_304);
