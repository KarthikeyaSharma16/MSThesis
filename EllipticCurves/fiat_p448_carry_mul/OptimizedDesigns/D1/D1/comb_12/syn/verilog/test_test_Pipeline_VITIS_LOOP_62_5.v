...
module test_test_Pipeline_VITIS_LOOP_62_5 (
        ...
        p_out7_ap_vld,
        add169_6921_out,
        add169_6921_out_ap_vld,
        add169_5920_out,
        add169_5920_out_ap_vld,
        add169_4919_out,
        add169_4919_out_ap_vld,
        add169_3918_out,
        add169_3918_out_ap_vld,
        add169_2917_out,
        add169_2917_out_ap_vld,
        add169_1916_out,
        add169_1916_out_ap_vld,
        add169915_out,
        add169915_out_ap_vld
);
...
input  [31:0] conv36;
output  [63:0] add138938_out;
output   add138938_out_ap_vld;
output  [63:0] p_out;
output   p_out_ap_vld;
output  [63:0] p_out1;
...
output  [63:0] add169_6921_out;
output   add169_6921_out_ap_vld;
output  [63:0] add169_5920_out;
output   add169_5920_out_ap_vld;
output  [63:0] add169_4919_out;
output   add169_4919_out_ap_vld;
output  [63:0] add169_3918_out;
output   add169_3918_out_ap_vld;
output  [63:0] add169_2917_out;
output   add169_2917_out_ap_vld;
output  [63:0] add169_1916_out;
output   add169_1916_out_ap_vld;
output  [63:0] add169915_out;
output   add169915_out_ap_vld;

reg ap_idle;
reg add138938_out_ap_vld;
reg p_out_ap_vld;
reg p_out1_ap_vld;
reg p_out2_ap_vld;
reg p_out3_ap_vld;
...
reg p_out6_ap_vld;
reg p_out7_ap_vld;
reg add169_6921_out_ap_vld;
reg add169_5920_out_ap_vld;
reg add169_4919_out_ap_vld;
reg add169_3918_out_ap_vld;
reg add169_2917_out_ap_vld;
reg add169_1916_out_ap_vld;
reg add169915_out_ap_vld;
...
reg   [63:0] add169915_fu_208;
wire   [63:0] add_ln80_1_fu_991_p2;
reg   [63:0] add169_1916_fu_212;
wire   [63:0] add_ln80_3_fu_1085_p2;
reg   [63:0] add169_2917_fu_216;
wire   [63:0] add_ln80_5_fu_1534_p2;
reg   [63:0] add169_3918_fu_220;
wire   [63:0] add_ln80_7_fu_1628_p2;
reg   [63:0] add169_4919_fu_224;
wire   [63:0] add_ln80_9_fu_1725_p2;
reg   [63:0] add169_5920_fu_228;
wire   [63:0] add_ln80_11_fu_1823_p2;
reg   [63:0] add169_6921_fu_232;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add138938_fu_268 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add138938_fu_268 <= select_ln70_fu_1420_p3;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add169_1916_fu_212 <= arr_1;
        end else if (((icmp_ln62_fu_825_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add169_1916_fu_212 <= add_ln80_3_fu_1085_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add169_2917_fu_216 <= arr_2;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add169_2917_fu_216 <= add_ln80_5_fu_1534_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add169_3918_fu_220 <= arr_3;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add169_3918_fu_220 <= add_ln80_7_fu_1628_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add169_4919_fu_224 <= arr_4;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add169_4919_fu_224 <= add_ln80_9_fu_1725_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add169_5920_fu_228 <= arr_5;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add169_5920_fu_228 <= add_ln80_11_fu_1823_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            add169_6921_fu_232 <= arr_6;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            add169_6921_fu_232 <= add_ln80_13_fu_1915_p2;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add138938_out_ap_vld = 1'b1;
    end else begin
        add138938_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169915_out_ap_vld = 1'b1;
    end else begin
        add169915_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_1916_out_ap_vld = 1'b1;
    end else begin
        add169_1916_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_2917_out_ap_vld = 1'b1;
    end else begin
        add169_2917_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_3918_out_ap_vld = 1'b1;
    end else begin
        add169_3918_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_4919_out_ap_vld = 1'b1;
    end else begin
        add169_4919_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_5920_out_ap_vld = 1'b1;
    end else begin
        add169_5920_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln62_reg_3078 == 1'd1))) begin
        add169_6921_out_ap_vld = 1'b1;
    end else begin
        add169_6921_out_ap_vld = 1'b0;
    end
end
...
assign add138938_out = add138938_fu_268;

assign add169915_out = add169915_fu_208;

assign add169_1916_out = add169_1916_fu_212;

assign add169_2917_out = add169_2917_fu_216;

assign add169_3918_out = add169_3918_fu_220;

assign add169_4919_out = add169_4919_fu_224;

assign add169_5920_out = add169_5920_fu_228;

assign add169_6921_out = add169_6921_fu_232;

assign add_ln62_fu_1269_p2 = ($signed(i_fu_276) + $signed(4'd15));

assign add_ln68_fu_831_p2 = (k_fu_272 + 4'd1);

assign add_ln70_fu_1414_p2 = (tmp15_fu_714_p2 + add138938_fu_268);

assign add_ln80_10_fu_1719_p2 = (and_ln80_9_fu_1713_p2 + and_ln80_8_fu_1701_p2);

assign add_ln80_11_fu_1823_p2 = (add169_5920_fu_228 + add_ln80_12_fu_1817_p2);

assign add_ln80_12_fu_1817_p2 = (and_ln80_11_fu_1811_p2 + and_ln80_10_fu_1799_p2);

assign add_ln80_13_fu_1915_p2 = (add169_6921_fu_232 + add_ln80_22_fu_1909_p2);
...
assign add_ln80_1_fu_991_p2 = (add169915_fu_208 + add_ln80_2_fu_985_p2);
...
assign add_ln80_3_fu_1085_p2 = (add169_1916_fu_212 + add_ln80_4_fu_1079_p2);

assign add_ln80_4_fu_1079_p2 = (and_ln80_3_fu_1073_p2 + and_ln80_2_fu_1059_p2);

assign add_ln80_5_fu_1534_p2 = (add169_2917_fu_216 + add_ln80_6_fu_1528_p2);

assign add_ln80_6_fu_1528_p2 = (and_ln80_5_fu_1522_p2 + and_ln80_4_fu_1510_p2);

assign add_ln80_7_fu_1628_p2 = (add169_3918_fu_220 + add_ln80_8_fu_1622_p2);

assign add_ln80_8_fu_1622_p2 = (and_ln80_7_fu_1616_p2 + and_ln80_6_fu_1604_p2);

assign add_ln80_9_fu_1725_p2 = (add169_4919_fu_224 + add_ln80_10_fu_1719_p2);
...
assign select_ln70_fu_1420_p3 = ((tmp_23_reg_3082[0:0] == 1'b1) ? add_ln70_fu_1414_p2 : add138938_fu_268);
