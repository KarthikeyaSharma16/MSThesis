...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_reload,
        add59_1_4309_out,
        add59_1_4309_out_ap_vld,
        add59_1_3308_out,
        add59_1_3308_out_ap_vld,
        add59_1_2227307_out,
        add59_1_2227307_out_ap_vld,
        add59_1_1207306_out,
        add59_1_1207306_out_ap_vld,
        add59_1305_out,
        add59_1305_out_ap_vld,
        add59_4304_out,
        add59_4304_out_ap_vld,
        add59_3303_out,
        add59_3303_out_ap_vld,
        add59_2298302_out,
        add59_2298302_out_ap_vld,
        add59_1280301_out,
        add59_1280301_out_ap_vld
);
...
output  [63:0] add59_1_4309_out;
output   add59_1_4309_out_ap_vld;
output  [63:0] add59_1_3308_out;
output   add59_1_3308_out_ap_vld;
output  [63:0] add59_1_2227307_out;
output   add59_1_2227307_out_ap_vld;
output  [63:0] add59_1_1207306_out;
output   add59_1_1207306_out_ap_vld;
output  [63:0] add59_1305_out;
output   add59_1305_out_ap_vld;
output  [63:0] add59_4304_out;
output   add59_4304_out_ap_vld;
output  [63:0] add59_3303_out;
output   add59_3303_out_ap_vld;
output  [63:0] add59_2298302_out;
output   add59_2298302_out_ap_vld;
output  [63:0] add59_1280301_out;
output   add59_1280301_out_ap_vld;

reg ap_idle;
reg add59_1_4309_out_ap_vld;
reg add59_1_3308_out_ap_vld;
reg add59_1_2227307_out_ap_vld;
reg add59_1_1207306_out_ap_vld;
reg add59_1305_out_ap_vld;
reg add59_4304_out_ap_vld;
reg add59_3303_out_ap_vld;
reg add59_2298302_out_ap_vld;
reg add59_1280301_out_ap_vld;
...
reg   [63:0] add59_1280301_fu_122;
wire   [63:0] add_ln49_2_fu_1164_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add59_2298302_fu_126;
wire   [63:0] add_ln49_4_fu_1195_p2;
reg   [63:0] add59_3303_fu_130;
wire   [63:0] add_ln49_7_fu_1243_p2;
reg   [63:0] add59_4304_fu_134;
wire   [63:0] add_ln49_11_fu_1291_p2;
reg   [63:0] add59_1305_fu_138;
wire   [63:0] add_ln49_15_fu_1369_p2;
reg   [63:0] add59_1_1207306_fu_142;
wire   [63:0] add_ln49_18_fu_1412_p2;
reg   [63:0] add59_1_2227307_fu_146;
wire   [63:0] add_ln49_21_fu_1442_p2;
reg   [63:0] add59_1_3308_fu_150;
wire   [63:0] add_ln49_24_fu_1470_p2;
reg   [63:0] add59_1_4309_fu_154;
wire   [63:0] add_ln49_27_fu_1492_p2;
reg   [3:0] i1_fu_158;
...
always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1280301_out_ap_vld = 1'b1;
    end else begin
        add59_1280301_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1305_out_ap_vld = 1'b1;
    end else begin
        add59_1305_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_1207306_out_ap_vld = 1'b1;
    end else begin
        add59_1_1207306_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_2227307_out_ap_vld = 1'b1;
    end else begin
        add59_1_2227307_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_3308_out_ap_vld = 1'b1;
    end else begin
        add59_1_3308_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_4309_out_ap_vld = 1'b1;
    end else begin
        add59_1_4309_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2298302_out_ap_vld = 1'b1;
    end else begin
        add59_2298302_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3303_out_ap_vld = 1'b1;
    end else begin
        add59_3303_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4304_out_ap_vld = 1'b1;
    end else begin
        add59_4304_out_ap_vld = 1'b0;
    end
end
...
assign add59_1280301_out = add59_1280301_fu_122;

assign add59_1305_out = add59_1305_fu_138;

assign add59_1_1207306_out = add59_1_1207306_fu_142;

assign add59_1_2227307_out = add59_1_2227307_fu_146;

assign add59_1_3308_out = add59_1_3308_fu_150;

assign add59_1_4309_out = add59_1_4309_fu_154;

assign add59_2298302_out = add59_2298302_fu_126;

assign add59_3303_out = add59_3303_fu_130;

assign add59_4304_out = add59_4304_fu_134;
...
assign add_ln49_11_fu_1291_p2 = (add59_4304_fu_134 + add_ln49_10_fu_1285_p2);
...
assign add_ln49_15_fu_1369_p2 = (add59_1305_fu_138 + add_ln49_14_fu_1363_p2);
...
assign add_ln49_18_fu_1412_p2 = (add59_1_1207306_fu_142 + add_ln49_17_fu_1406_p2);

assign add_ln49_19_fu_1430_p2 = (and_ln49_16_fu_1424_p2 + mul_ln49_32_fu_401_p2);

assign add_ln49_1_fu_684_p2 = (ap_sig_allocacmp_i1_1 + 4'd5);

assign add_ln49_20_fu_1436_p2 = (add_ln49_19_fu_1430_p2 + and_ln49_15_fu_1418_p2);

assign add_ln49_21_fu_1442_p2 = (add59_1_2227307_fu_146 + add_ln49_20_fu_1436_p2);
...
assign add_ln49_24_fu_1470_p2 = (add59_1_3308_fu_150 + add_ln49_23_fu_1464_p2);
...
assign add_ln49_27_fu_1492_p2 = (add59_1_4309_fu_154 + add_ln49_26_fu_1486_p2);

assign add_ln49_2_fu_1164_p2 = (and_ln49_fu_1158_p2 + add59_1280301_fu_122);

assign add_ln49_3_fu_1189_p2 = (and_ln49_2_fu_1183_p2 + and_ln49_1_fu_1170_p2);

assign add_ln49_4_fu_1195_p2 = (add59_2298302_fu_126 + add_ln49_3_fu_1189_p2);
...
assign add_ln49_7_fu_1243_p2 = (add59_3303_fu_130 + add_ln49_6_fu_1237_p2);

assign add_ln49_8_fu_767_p2 = (ap_sig_allocacmp_i1_1 + 4'd6);
...
assign and_ln48_1_fu_669_p2 = (icmp_ln49_fu_635_p2 & cmp32_1230_fu_641_p2);
...
assign and_ln48_4_fu_964_p2 = (icmp_ln49_2_fu_807_p2 & cmp32_1230_fu_641_p2);

assign and_ln48_5_fu_979_p2 = (icmp_ln49_3_fu_914_p2 & cmp32_1230_fu_641_p2);
...
assign cmp32_1230_fu_641_p2 = (empty_fu_576_p1 ^ 1'd1);
...
assign tmp_4_fu_696_p11 = ($signed(4'd14) - $signed(ap_sig_allocacmp_i1_1));

assign tmp_6_fu_779_p11 = ($signed(4'd13) - $signed(ap_sig_allocacmp_i1_1));

assign tmp_7_fu_846_p11 = ($signed(4'd12) - $signed(ap_sig_allocacmp_i1_1));

assign tmp_8_fu_880_p11 = ($signed(4'd11) - $signed(ap_sig_allocacmp_i1_1));

assign tmp_9_fu_936_p11 = ($signed(4'd10) - $signed(ap_sig_allocacmp_i1_1));
