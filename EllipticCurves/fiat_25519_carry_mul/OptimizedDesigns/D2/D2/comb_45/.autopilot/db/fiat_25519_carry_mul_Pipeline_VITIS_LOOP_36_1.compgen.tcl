...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_9256_out \
    op interface \
    ports { add59_9256_out { O 64 vector } add59_9256_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_8255_out \
    op interface \
    ports { add59_8255_out { O 64 vector } add59_8255_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_7254_out \
    op interface \
    ports { add59_7254_out { O 64 vector } add59_7254_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_6253_out \
    op interface \
    ports { add59_6253_out { O 64 vector } add59_6253_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_5252_out \
    op interface \
    ports { add59_5252_out { O 64 vector } add59_5252_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_4251_out \
    op interface \
    ports { add59_4251_out { O 64 vector } add59_4251_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_3250_out \
    op interface \
    ports { add59_3250_out { O 64 vector } add59_3250_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_2249_out \
    op interface \
    ports { add59_2249_out { O 64 vector } add59_2249_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_1248_out \
    op interface \
    ports { add59_1248_out { O 64 vector } add59_1248_out_ap_vld { O 1 bit } } \
} "
}
