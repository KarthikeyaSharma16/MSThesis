; ModuleID = '/export/hdd/scratch/km304/MSThesis/EllipticCurves/fiat_25519_carry_mul/OptimizedDesigns/D2/D2/comb_23/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline
define void @apatb_fiat_25519_carry_mul_ir(i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="10" "maxi" %out1, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="10" "maxi" %arg1, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="10" "maxi" %arg2) local_unnamed_addr #0 {
entry:
  %out1_copy = alloca [10 x i32], align 512
  %arg1_copy = alloca [10 x i32], align 512
  %arg2_copy = alloca [10 x i32], align 512
  %0 = bitcast i32* %out1 to [10 x i32]*
  %1 = bitcast i32* %arg1 to [10 x i32]*
  %2 = bitcast i32* %arg2 to [10 x i32]*
  call fastcc void @copy_in([10 x i32]* nonnull %0, [10 x i32]* nonnull align 512 %out1_copy, [10 x i32]* nonnull %1, [10 x i32]* nonnull align 512 %arg1_copy, [10 x i32]* nonnull %2, [10 x i32]* nonnull align 512 %arg2_copy)
  call void @apatb_fiat_25519_carry_mul_hw([10 x i32]* %out1_copy, [10 x i32]* %arg1_copy, [10 x i32]* %arg2_copy)
  call void @copy_back([10 x i32]* %0, [10 x i32]* %out1_copy, [10 x i32]* %1, [10 x i32]* %arg1_copy, [10 x i32]* %2, [10 x i32]* %arg2_copy)
  ret void
}
...
declare void @apatb_fiat_25519_carry_mul_hw([10 x i32]*, [10 x i32]*, [10 x i32]*)
...
define void @fiat_25519_carry_mul_hw_stub_wrapper([10 x i32]*, [10 x i32]*, [10 x i32]*) #5 {
entry:
  ...
  call void @fiat_25519_carry_mul_hw_stub(i32* %3, i32* %4, i32* %5)
  call void @copy_in([10 x i32]* null, [10 x i32]* %0, [10 x i32]* null, [10 x i32]* %1, [10 x i32]* null, [10 x i32]* %2)
  ret void
}

declare void @fiat_25519_carry_mul_hw_stub(i32*, i32*, i32*)
