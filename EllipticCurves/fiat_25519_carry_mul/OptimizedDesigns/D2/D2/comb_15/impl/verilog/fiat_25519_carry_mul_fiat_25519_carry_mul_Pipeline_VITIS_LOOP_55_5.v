...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_9_reload,
        add129_9165_out,
        add129_9165_out_ap_vld,
        add129_8164_out,
        add129_8164_out_ap_vld,
        add129_7163_out,
        add129_7163_out_ap_vld,
        add129_6162_out,
        add129_6162_out_ap_vld,
        add129_5161_out,
        add129_5161_out_ap_vld,
        add129_4160_out,
        add129_4160_out_ap_vld,
        add129_3159_out,
        add129_3159_out_ap_vld,
        add129_2158_out,
        add129_2158_out_ap_vld,
        add129_1157_out,
        add129_1157_out_ap_vld,
        add129156_out,
        add129156_out_ap_vld
);
...
output  [63:0] add129_9165_out;
output   add129_9165_out_ap_vld;
output  [63:0] add129_8164_out;
output   add129_8164_out_ap_vld;
output  [63:0] add129_7163_out;
output   add129_7163_out_ap_vld;
output  [63:0] add129_6162_out;
output   add129_6162_out_ap_vld;
output  [63:0] add129_5161_out;
output   add129_5161_out_ap_vld;
output  [63:0] add129_4160_out;
output   add129_4160_out_ap_vld;
output  [63:0] add129_3159_out;
output   add129_3159_out_ap_vld;
output  [63:0] add129_2158_out;
output   add129_2158_out_ap_vld;
output  [63:0] add129_1157_out;
output   add129_1157_out_ap_vld;
output  [63:0] add129156_out;
output   add129156_out_ap_vld;

reg ap_idle;
reg add129_9165_out_ap_vld;
reg add129_8164_out_ap_vld;
reg add129_7163_out_ap_vld;
reg add129_6162_out_ap_vld;
reg add129_5161_out_ap_vld;
reg add129_4160_out_ap_vld;
reg add129_3159_out_ap_vld;
reg add129_2158_out_ap_vld;
reg add129_1157_out_ap_vld;
reg add129156_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129156_out_ap_vld = 1'b1;
    end else begin
        add129156_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1157_out_ap_vld = 1'b1;
    end else begin
        add129_1157_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_2158_out_ap_vld = 1'b1;
    end else begin
        add129_2158_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_3159_out_ap_vld = 1'b1;
    end else begin
        add129_3159_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_4160_out_ap_vld = 1'b1;
    end else begin
        add129_4160_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_5161_out_ap_vld = 1'b1;
    end else begin
        add129_5161_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_6162_out_ap_vld = 1'b1;
    end else begin
        add129_6162_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_7163_out_ap_vld = 1'b1;
    end else begin
        add129_7163_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_8164_out_ap_vld = 1'b1;
    end else begin
        add129_8164_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_9165_out_ap_vld = 1'b1;
    end else begin
        add129_9165_out_ap_vld = 1'b0;
    end
end
...
assign add129156_out = add129156_fu_158;

assign add129_1157_out = add129_1157_fu_162;

assign add129_2158_out = add129_2158_fu_166;

assign add129_3159_out = add129_3159_fu_170;

assign add129_4160_out = add129_4160_fu_174;

assign add129_5161_out = add129_5161_fu_178;

assign add129_6162_out = add129_6162_fu_182;

assign add129_7163_out = add129_7163_fu_186;

assign add129_8164_out = add129_8164_fu_190;

assign add129_9165_out = add129_9165_fu_194;
...
assign add_ln68_10_fu_1131_p2 = (and_ln68_6_fu_1125_p2 + add129_7163_fu_186);

assign add_ln68_11_fu_1137_p2 = (zext_ln67_fu_586_p1 + 5'd8);

assign add_ln68_12_fu_1196_p2 = (and_ln68_7_fu_1190_p2 + add129_8164_fu_190);

assign add_ln68_13_fu_1281_p2 = (and_ln68_8_fu_1275_p2 + add129_9165_fu_194);

assign add_ln68_1_fu_731_p2 = (and_ln68_fu_725_p2 + add129_1157_fu_162);

assign add_ln68_2_fu_737_p2 = (i1_fu_198 + 4'd2);

assign add_ln68_3_fu_788_p2 = (and_ln68_1_fu_782_p2 + add129_2158_fu_166);

assign add_ln68_4_fu_864_p2 = (and_ln68_2_fu_858_p2 + add129_3159_fu_170);

assign add_ln68_5_fu_870_p2 = (i1_fu_198 + 4'd4);

assign add_ln68_6_fu_919_p2 = (and_ln68_3_fu_913_p2 + add129_4160_fu_174);

assign add_ln68_7_fu_993_p2 = (and_ln68_4_fu_987_p2 + add129_5161_fu_178);

assign add_ln68_8_fu_999_p2 = (i1_fu_198 + 4'd6);

assign add_ln68_9_fu_1046_p2 = (and_ln68_5_fu_1040_p2 + add129_6162_fu_182);

assign add_ln68_fu_659_p2 = (mul_ln68_fu_446_p2 + add129156_fu_158);
