...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_9_reload,
        add129_967_out,
        add129_967_out_ap_vld,
        add129_866_out,
        add129_866_out_ap_vld,
        add129_765_out,
        add129_765_out_ap_vld,
        add129_664_out,
        add129_664_out_ap_vld,
        add129_563_out,
        add129_563_out_ap_vld,
        add129_462_out,
        add129_462_out_ap_vld,
        add129_361_out,
        add129_361_out_ap_vld,
        add129_260_out,
        add129_260_out_ap_vld,
        add129_159_out,
        add129_159_out_ap_vld,
        add12958_out,
        add12958_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add59_977_reload;
input  [63:0] add59_876_reload;
input  [63:0] add59_775_reload;
input  [63:0] add59_674_reload;
input  [63:0] add59_573_reload;
input  [63:0] add59_472_reload;
input  [63:0] add59_371_reload;
input  [63:0] add59_270_reload;
input  [63:0] add59_169_reload;
...
output  [63:0] add129_967_out;
output   add129_967_out_ap_vld;
output  [63:0] add129_866_out;
output   add129_866_out_ap_vld;
output  [63:0] add129_765_out;
output   add129_765_out_ap_vld;
output  [63:0] add129_664_out;
output   add129_664_out_ap_vld;
output  [63:0] add129_563_out;
output   add129_563_out_ap_vld;
output  [63:0] add129_462_out;
output   add129_462_out_ap_vld;
output  [63:0] add129_361_out;
output   add129_361_out_ap_vld;
output  [63:0] add129_260_out;
output   add129_260_out_ap_vld;
output  [63:0] add129_159_out;
output   add129_159_out_ap_vld;
output  [63:0] add12958_out;
output   add12958_out_ap_vld;

reg ap_idle;
reg add129_967_out_ap_vld;
reg add129_866_out_ap_vld;
reg add129_765_out_ap_vld;
reg add129_664_out_ap_vld;
reg add129_563_out_ap_vld;
reg add129_462_out_ap_vld;
reg add129_361_out_ap_vld;
reg add129_260_out_ap_vld;
reg add129_159_out_ap_vld;
reg add12958_out_ap_vld;
...
reg   [63:0] add12958_fu_158;
wire   [63:0] add_ln68_fu_655_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add129_159_fu_162;
wire   [63:0] add_ln68_1_fu_731_p2;
reg   [63:0] add129_260_fu_166;
wire   [63:0] add_ln68_2_fu_788_p2;
reg   [63:0] add129_361_fu_170;
wire   [63:0] add_ln68_3_fu_864_p2;
reg   [63:0] add129_462_fu_174;
wire   [63:0] add_ln68_4_fu_919_p2;
reg   [63:0] add129_563_fu_178;
wire   [63:0] add_ln68_5_fu_993_p2;
reg   [63:0] add129_664_fu_182;
wire   [63:0] add_ln68_6_fu_1046_p2;
reg   [63:0] add129_765_fu_186;
wire   [63:0] add_ln68_7_fu_1131_p2;
reg   [63:0] add129_866_fu_190;
wire   [63:0] add_ln68_8_fu_1196_p2;
reg   [63:0] add129_967_fu_194;
wire   [63:0] add_ln68_9_fu_1281_p2;
reg   [3:0] i1_fu_198;
wire   [3:0] indvars_iv_next79_fu_550_p2;
wire    ap_block_pp0_stage0_01001;
wire   [31:0] mul_ln68_fu_446_p0;
wire   [31:0] mul_ln68_fu_446_p1;
wire   [63:0] zext_ln68_fu_614_p1;
...
wire   [31:0] tmp_4_fu_598_p12;
wire   [3:0] tmp_s_fu_634_p11;
wire   [31:0] tmp_s_fu_634_p12;
wire   [63:0] mul_ln68_fu_446_p2;
wire   [0:0] empty_fu_661_p1;
wire   [0:0] icmp_ln67_1_fu_665_p2;
wire   [3:0] tmp_1_fu_683_p10;
wire   [31:0] tmp_1_fu_683_p11;
...
wire   [3:0] empty_24_fu_794_p2;
wire   [0:0] icmp_ln67_2_fu_800_p2;
wire   [2:0] tmp_3_fu_818_p8;
wire   [31:0] tmp_3_fu_818_p9;
...
always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add12958_out_ap_vld = 1'b1;
    end else begin
        add12958_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_159_out_ap_vld = 1'b1;
    end else begin
        add129_159_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_260_out_ap_vld = 1'b1;
    end else begin
        add129_260_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_361_out_ap_vld = 1'b1;
    end else begin
        add129_361_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_462_out_ap_vld = 1'b1;
    end else begin
        add129_462_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_563_out_ap_vld = 1'b1;
    end else begin
        add129_563_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_664_out_ap_vld = 1'b1;
    end else begin
        add129_664_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_765_out_ap_vld = 1'b1;
    end else begin
        add129_765_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_866_out_ap_vld = 1'b1;
    end else begin
        add129_866_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_967_out_ap_vld = 1'b1;
    end else begin
        add129_967_out_ap_vld = 1'b0;
    end
end
...
assign add12958_out = add12958_fu_158;

assign add129_159_out = add129_159_fu_162;

assign add129_260_out = add129_260_fu_166;

assign add129_361_out = add129_361_fu_170;

assign add129_462_out = add129_462_fu_174;

assign add129_563_out = add129_563_fu_178;

assign add129_664_out = add129_664_fu_182;

assign add129_765_out = add129_765_fu_186;

assign add129_866_out = add129_866_fu_190;

assign add129_967_out = add129_967_fu_194;

assign add_ln68_1_fu_731_p2 = (and_ln68_fu_725_p2 + add129_159_fu_162);

assign add_ln68_2_fu_788_p2 = (and_ln68_1_fu_782_p2 + add129_260_fu_166);

assign add_ln68_3_fu_864_p2 = (and_ln68_2_fu_858_p2 + add129_361_fu_170);

assign add_ln68_4_fu_919_p2 = (and_ln68_3_fu_913_p2 + add129_462_fu_174);

assign add_ln68_5_fu_993_p2 = (and_ln68_4_fu_987_p2 + add129_563_fu_178);

assign add_ln68_6_fu_1046_p2 = (and_ln68_5_fu_1040_p2 + add129_664_fu_182);

assign add_ln68_7_fu_1131_p2 = (and_ln68_6_fu_1125_p2 + add129_765_fu_186);

assign add_ln68_8_fu_1196_p2 = (and_ln68_7_fu_1190_p2 + add129_866_fu_190);

assign add_ln68_9_fu_1281_p2 = (and_ln68_8_fu_1275_p2 + add129_967_fu_194);

assign add_ln68_fu_655_p2 = (mul_ln68_fu_446_p2 + add12958_fu_158);

assign and_ln67_1_fu_806_p2 = (icmp_ln67_2_fu_800_p2 & empty_fu_661_p1);

assign and_ln67_2_fu_937_p2 = (icmp_ln67_3_fu_931_p2 & empty_fu_661_p1);

assign and_ln67_3_fu_1064_p2 = (icmp_ln67_4_fu_1058_p2 & empty_fu_661_p1);

assign and_ln67_4_fu_1214_p2 = (icmp_ln67_5_fu_1208_p2 & empty_fu_661_p1);

assign and_ln67_fu_671_p2 = (icmp_ln67_1_fu_665_p2 & empty_fu_661_p1);
...
assign empty_24_fu_794_p2 = (i1_fu_198 + 4'd3);

assign empty_25_fu_870_p2 = (i1_fu_198 + 4'd4);

assign empty_26_fu_925_p2 = (i1_fu_198 + 4'd5);

assign empty_27_fu_999_p2 = (i1_fu_198 + 4'd6);

assign empty_28_fu_1052_p2 = (zext_ln67_fu_586_p1 + 5'd7);

assign empty_29_fu_1137_p2 = (zext_ln67_fu_586_p1 + 5'd8);

assign empty_30_fu_1202_p2 = (zext_ln67_fu_586_p1 + 5'd9);

assign empty_fu_661_p1 = i1_fu_198[0:0];

assign icmp_ln67_1_fu_665_p2 = ((indvars_iv_next79_fu_550_p2 < 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln67_2_fu_800_p2 = ((empty_24_fu_794_p2 < 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln67_3_fu_931_p2 = ((empty_26_fu_925_p2 < 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln67_4_fu_1058_p2 = ((empty_28_fu_1052_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln67_5_fu_1208_p2 = ((empty_30_fu_1202_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln67_fu_544_p2 = ((i1_fu_198 == 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_1_fu_899_p2 = ((empty_25_fu_870_p2 < 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_2_fu_1026_p2 = ((empty_27_fu_999_p2 < 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_3_fu_1176_p2 = ((empty_29_fu_1137_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_fu_768_p2 = ((empty_23_fu_737_p2 < 4'd10) ? 1'b1 : 1'b0);

assign indvars_iv_next79_fu_550_p2 = (i1_fu_198 + 4'd1);

assign mul_ln68_1_fu_450_p0 = mul_ln68_1_fu_450_p00;

assign mul_ln68_1_fu_450_p00 = select_ln68_fu_704_p3;

assign mul_ln68_1_fu_450_p1 = zext_ln68_fu_614_p1;

assign mul_ln68_2_fu_454_p0 = mul_ln68_2_fu_454_p00;

assign mul_ln68_2_fu_454_p00 = tmp_2_fu_749_p10;

assign mul_ln68_2_fu_454_p1 = zext_ln68_fu_614_p1;

assign mul_ln68_3_fu_458_p0 = mul_ln68_3_fu_458_p00;

assign mul_ln68_3_fu_458_p00 = select_ln68_1_fu_837_p3;

assign mul_ln68_3_fu_458_p1 = zext_ln68_fu_614_p1;

assign mul_ln68_4_fu_462_p0 = mul_ln68_4_fu_462_p00;

assign mul_ln68_4_fu_462_p00 = tmp_5_fu_882_p8;

assign mul_ln68_4_fu_462_p1 = zext_ln68_fu_614_p1;

assign mul_ln68_5_fu_466_p0 = mul_ln68_5_fu_466_p00;

assign mul_ln68_5_fu_466_p00 = select_ln68_2_fu_966_p3;

assign mul_ln68_5_fu_466_p1 = zext_ln68_fu_614_p1;

assign mul_ln68_6_fu_470_p0 = mul_ln68_6_fu_470_p00;

assign mul_ln68_6_fu_470_p00 = tmp_7_fu_1011_p6;

assign mul_ln68_6_fu_470_p1 = zext_ln68_fu_614_p1;

assign mul_ln68_7_fu_474_p0 = mul_ln68_7_fu_474_p00;

assign mul_ln68_7_fu_474_p00 = select_ln68_3_fu_1104_p3;

assign mul_ln68_7_fu_474_p1 = zext_ln68_fu_614_p1;

assign mul_ln68_8_fu_478_p0 = mul_ln68_8_fu_478_p00;

assign mul_ln68_8_fu_478_p00 = tmp_9_fu_1149_p12;

assign mul_ln68_8_fu_478_p1 = zext_ln68_fu_614_p1;

assign mul_ln68_9_fu_482_p0 = mul_ln68_9_fu_482_p00;

assign mul_ln68_9_fu_482_p00 = select_ln68_4_fu_1254_p3;

assign mul_ln68_9_fu_482_p1 = zext_ln68_fu_614_p1;

assign mul_ln68_fu_446_p0 = mul_ln68_fu_446_p00;

assign mul_ln68_fu_446_p00 = tmp_s_fu_634_p12;

assign mul_ln68_fu_446_p1 = zext_ln68_fu_614_p1;
...
assign select_ln68_1_fu_837_p3 = ((and_ln67_1_fu_806_p2[0:0] == 1'b1) ? shl_ln68_1_fu_831_p2 : tmp_3_fu_818_p9);
...
assign select_ln68_fu_704_p3 = ((and_ln67_fu_671_p2[0:0] == 1'b1) ? shl_ln68_fu_698_p2 : tmp_1_fu_683_p11);

assign shl_ln68_1_fu_831_p2 = tmp_3_fu_818_p9 << 32'd1;
...
assign shl_ln68_fu_698_p2 = tmp_1_fu_683_p11 << 32'd1;

assign tmp_10_fu_1226_p11 = (4'd0 - i1_fu_198);

assign tmp_1_fu_683_p10 = ($signed(4'd8) - $signed(i1_fu_198));

assign tmp_2_fu_749_p9 = (trunc_ln55_1_fu_594_p1 ^ 3'd7);

assign tmp_3_fu_818_p8 = ($signed(3'd6) - $signed(trunc_ln55_1_fu_594_p1));
...
assign tmp_s_fu_634_p11 = ($signed(4'd9) - $signed(i1_fu_198));
...
assign zext_ln68_fu_614_p1 = tmp_4_fu_598_p12;
