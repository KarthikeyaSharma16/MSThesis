...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_9123_out \
    op interface \
    ports { add59_9123_out { O 64 vector } add59_9123_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_8122_out \
    op interface \
    ports { add59_8122_out { O 64 vector } add59_8122_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_7121_out \
    op interface \
    ports { add59_7121_out { O 64 vector } add59_7121_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_6120_out \
    op interface \
    ports { add59_6120_out { O 64 vector } add59_6120_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_5119_out \
    op interface \
    ports { add59_5119_out { O 64 vector } add59_5119_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_4118_out \
    op interface \
    ports { add59_4118_out { O 64 vector } add59_4118_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_3117_out \
    op interface \
    ports { add59_3117_out { O 64 vector } add59_3117_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_2116_out \
    op interface \
    ports { add59_2116_out { O 64 vector } add59_2116_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_1115_out \
    op interface \
    ports { add59_1115_out { O 64 vector } add59_1115_out_ap_vld { O 1 bit } } \
} "
}
