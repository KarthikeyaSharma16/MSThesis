...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add59_9123_out,
        add59_9123_out_ap_vld,
        add59_8122_out,
        add59_8122_out_ap_vld,
        add59_7121_out,
        add59_7121_out_ap_vld,
        add59_6120_out,
        add59_6120_out_ap_vld,
        add59_5119_out,
        add59_5119_out_ap_vld,
        add59_4118_out,
        add59_4118_out_ap_vld,
        add59_3117_out,
        add59_3117_out_ap_vld,
        add59_2116_out,
        add59_2116_out_ap_vld,
        add59_1115_out,
        add59_1115_out_ap_vld
);
...
output  [63:0] add59_9123_out;
output   add59_9123_out_ap_vld;
output  [63:0] add59_8122_out;
output   add59_8122_out_ap_vld;
output  [63:0] add59_7121_out;
output   add59_7121_out_ap_vld;
output  [63:0] add59_6120_out;
output   add59_6120_out_ap_vld;
output  [63:0] add59_5119_out;
output   add59_5119_out_ap_vld;
output  [63:0] add59_4118_out;
output   add59_4118_out_ap_vld;
output  [63:0] add59_3117_out;
output   add59_3117_out_ap_vld;
output  [63:0] add59_2116_out;
output   add59_2116_out_ap_vld;
output  [63:0] add59_1115_out;
output   add59_1115_out_ap_vld;

reg ap_idle;
reg add59_9123_out_ap_vld;
reg add59_8122_out_ap_vld;
reg add59_7121_out_ap_vld;
reg add59_6120_out_ap_vld;
reg add59_5119_out_ap_vld;
reg add59_4118_out_ap_vld;
reg add59_3117_out_ap_vld;
reg add59_2116_out_ap_vld;
reg add59_1115_out_ap_vld;
...
reg   [3:0] i1_fu_158;
wire   [3:0] indvars_iv_next151_fu_482_p2;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1115_out_ap_vld = 1'b1;
    end else begin
        add59_1115_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2116_out_ap_vld = 1'b1;
    end else begin
        add59_2116_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3117_out_ap_vld = 1'b1;
    end else begin
        add59_3117_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4118_out_ap_vld = 1'b1;
    end else begin
        add59_4118_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_5119_out_ap_vld = 1'b1;
    end else begin
        add59_5119_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_6120_out_ap_vld = 1'b1;
    end else begin
        add59_6120_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_7121_out_ap_vld = 1'b1;
    end else begin
        add59_7121_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_8122_out_ap_vld = 1'b1;
    end else begin
        add59_8122_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_9123_out_ap_vld = 1'b1;
    end else begin
        add59_9123_out_ap_vld = 1'b0;
    end
end
...
assign add59_1115_out = arr_9_fu_122;

assign add59_2116_out = arr_10_fu_126;

assign add59_3117_out = arr_11_fu_130;

assign add59_4118_out = arr_12_fu_134;

assign add59_5119_out = arr_13_fu_138;

assign add59_6120_out = arr_14_fu_142;

assign add59_7121_out = arr_15_fu_146;

assign add59_8122_out = arr_16_fu_150;

assign add59_9123_out = arr_17_fu_154;
...
assign empty_26_fu_568_p2 = (ap_sig_allocacmp_i1_3 + 4'd2);

assign empty_27_fu_613_p2 = (ap_sig_allocacmp_i1_3 + 4'd3);

assign empty_28_fu_673_p2 = (ap_sig_allocacmp_i1_3 + 4'd4);

assign empty_29_fu_718_p2 = (ap_sig_allocacmp_i1_3 + 4'd5);

assign empty_30_fu_778_p2 = (ap_sig_allocacmp_i1_3 + 4'd6);

assign empty_31_fu_823_p2 = (zext_ln36_fu_474_p1 + 5'd7);

assign empty_32_fu_883_p2 = (zext_ln36_fu_474_p1 + 5'd8);

assign empty_fu_478_p1 = ap_sig_allocacmp_i1_3[0:0];

assign icmp_ln36_fu_468_p2 = ((ap_sig_allocacmp_i1_3 == 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln48_1_fu_619_p2 = ((empty_27_fu_613_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln48_2_fu_724_p2 = ((empty_29_fu_718_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln48_3_fu_829_p2 = ((empty_31_fu_823_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln48_fu_488_p2 = ((indvars_iv_next151_fu_482_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_1_fu_712_p2 = ((empty_28_fu_673_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_2_fu_817_p2 = ((empty_30_fu_778_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_922_p2 = ((empty_32_fu_883_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_fu_607_p2 = ((empty_26_fu_568_p2 > 4'd9) ? 1'b1 : 1'b0);

assign indvars_iv_next151_fu_482_p2 = (ap_sig_allocacmp_i1_3 + 4'd1);
