...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_9_reload,
        add129_4_1241_out,
        add129_4_1241_out_ap_vld,
        add129_4240_out,
        add129_4240_out_ap_vld,
        add129_3_1239_out,
        add129_3_1239_out_ap_vld,
        add129_3238_out,
        add129_3238_out_ap_vld,
        add129_2_1237_out,
        add129_2_1237_out_ap_vld,
        add129_2236_out,
        add129_2236_out_ap_vld,
        add129_1_1235_out,
        add129_1_1235_out_ap_vld,
        add129_1234_out,
        add129_1234_out_ap_vld,
        add129_128233_out,
        add129_128233_out_ap_vld,
        add129232_out,
        add129232_out_ap_vld
);
...
output  [63:0] add129_4_1241_out;
output   add129_4_1241_out_ap_vld;
output  [63:0] add129_4240_out;
output   add129_4240_out_ap_vld;
output  [63:0] add129_3_1239_out;
output   add129_3_1239_out_ap_vld;
output  [63:0] add129_3238_out;
output   add129_3238_out_ap_vld;
output  [63:0] add129_2_1237_out;
output   add129_2_1237_out_ap_vld;
output  [63:0] add129_2236_out;
output   add129_2236_out_ap_vld;
output  [63:0] add129_1_1235_out;
output   add129_1_1235_out_ap_vld;
output  [63:0] add129_1234_out;
output   add129_1234_out_ap_vld;
output  [63:0] add129_128233_out;
output   add129_128233_out_ap_vld;
output  [63:0] add129232_out;
output   add129232_out_ap_vld;

reg ap_idle;
reg add129_4_1241_out_ap_vld;
reg add129_4240_out_ap_vld;
reg add129_3_1239_out_ap_vld;
reg add129_3238_out_ap_vld;
reg add129_2_1237_out_ap_vld;
reg add129_2236_out_ap_vld;
reg add129_1_1235_out_ap_vld;
reg add129_1234_out_ap_vld;
reg add129_128233_out_ap_vld;
reg add129232_out_ap_vld;
...
reg   [63:0] add129232_fu_158;
wire   [63:0] add_ln68_fu_659_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add129_128233_fu_162;
wire   [63:0] add_ln68_1_fu_731_p2;
reg   [63:0] add129_1234_fu_166;
wire   [63:0] add_ln68_2_fu_788_p2;
reg   [63:0] add129_1_1235_fu_170;
wire   [63:0] add_ln68_3_fu_864_p2;
reg   [63:0] add129_2236_fu_174;
wire   [63:0] add_ln68_4_fu_919_p2;
reg   [63:0] add129_2_1237_fu_178;
wire   [63:0] add_ln68_5_fu_993_p2;
reg   [63:0] add129_3238_fu_182;
wire   [63:0] add_ln68_6_fu_1046_p2;
reg   [63:0] add129_3_1239_fu_186;
wire   [63:0] add_ln68_7_fu_1131_p2;
reg   [63:0] add129_4240_fu_190;
wire   [63:0] add_ln68_8_fu_1196_p2;
reg   [63:0] add129_4_1241_fu_194;
...
always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129232_out_ap_vld = 1'b1;
    end else begin
        add129232_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1234_out_ap_vld = 1'b1;
    end else begin
        add129_1234_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_128233_out_ap_vld = 1'b1;
    end else begin
        add129_128233_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_1235_out_ap_vld = 1'b1;
    end else begin
        add129_1_1235_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_2236_out_ap_vld = 1'b1;
    end else begin
        add129_2236_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_2_1237_out_ap_vld = 1'b1;
    end else begin
        add129_2_1237_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_3238_out_ap_vld = 1'b1;
    end else begin
        add129_3238_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_3_1239_out_ap_vld = 1'b1;
    end else begin
        add129_3_1239_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_4240_out_ap_vld = 1'b1;
    end else begin
        add129_4240_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_4_1241_out_ap_vld = 1'b1;
    end else begin
        add129_4_1241_out_ap_vld = 1'b0;
    end
end
...
assign add129232_out = add129232_fu_158;

assign add129_1234_out = add129_1234_fu_166;

assign add129_128233_out = add129_128233_fu_162;

assign add129_1_1235_out = add129_1_1235_fu_170;

assign add129_2236_out = add129_2236_fu_174;

assign add129_2_1237_out = add129_2_1237_fu_178;

assign add129_3238_out = add129_3238_fu_182;

assign add129_3_1239_out = add129_3_1239_fu_186;

assign add129_4240_out = add129_4240_fu_190;

assign add129_4_1241_out = add129_4_1241_fu_194;
...
assign add_ln68_1_fu_731_p2 = (and_ln68_fu_725_p2 + add129_128233_fu_162);

assign add_ln68_2_fu_788_p2 = (and_ln68_1_fu_782_p2 + add129_1234_fu_166);

assign add_ln68_3_fu_864_p2 = (and_ln68_2_fu_858_p2 + add129_1_1235_fu_170);

assign add_ln68_4_fu_919_p2 = (and_ln68_3_fu_913_p2 + add129_2236_fu_174);

assign add_ln68_5_fu_993_p2 = (and_ln68_4_fu_987_p2 + add129_2_1237_fu_178);

assign add_ln68_6_fu_1046_p2 = (and_ln68_5_fu_1040_p2 + add129_3238_fu_182);

assign add_ln68_7_fu_1131_p2 = (and_ln68_6_fu_1125_p2 + add129_3_1239_fu_186);

assign add_ln68_8_fu_1196_p2 = (and_ln68_7_fu_1190_p2 + add129_4240_fu_190);

assign add_ln68_9_fu_1281_p2 = (and_ln68_8_fu_1275_p2 + add129_4_1241_fu_194);

assign add_ln68_fu_659_p2 = (mul_ln68_fu_446_p2 + add129232_fu_158);
...
assign empty_23_fu_870_p2 = (i1_fu_198 + 4'd4);

assign empty_24_fu_999_p2 = (i1_fu_198 + 4'd6);

assign empty_25_fu_1137_p2 = (zext_ln67_fu_586_p1 + 5'd8);
...
assign icmp_ln68_1_fu_899_p2 = ((empty_23_fu_870_p2 < 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_2_fu_1026_p2 = ((empty_24_fu_999_p2 < 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_3_fu_1176_p2 = ((empty_25_fu_1137_p2 < 5'd10) ? 1'b1 : 1'b0);
