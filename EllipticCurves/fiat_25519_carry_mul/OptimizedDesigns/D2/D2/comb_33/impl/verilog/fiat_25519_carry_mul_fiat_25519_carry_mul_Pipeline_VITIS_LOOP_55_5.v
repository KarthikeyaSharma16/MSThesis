...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        ap_idle,
        ap_ready,
        add59_4_148199_reload,
        add59_4198_reload,
        add59_3_168197_reload,
        add59_3196_reload,
        add59_2_188195_reload,
        add59_2194_reload,
        add59_1_1108193_reload,
        add59_1192_reload,
        add59_1178191_reload,
        arg1_r_reload,
        arg1_r_1_reload,
        arg1_r_2_reload,
        arg1_r_3_reload,
        ...
        arg2_r_9_reload,
        add129_4_1189_out,
        add129_4_1189_out_ap_vld,
        add129_4188_out,
        add129_4188_out_ap_vld,
        add129_3_1187_out,
        add129_3_1187_out_ap_vld,
        add129_3186_out,
        add129_3186_out_ap_vld,
        add129_2_1185_out,
        add129_2_1185_out_ap_vld,
        add129_2184_out,
        add129_2184_out_ap_vld,
        add129_1_1183_out,
        add129_1_1183_out_ap_vld,
        add129_1182_out,
        add129_1182_out_ap_vld,
        add129_128181_out,
        add129_128181_out_ap_vld,
        add129180_out,
        add129180_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add59_4_148199_reload;
input  [63:0] add59_4198_reload;
input  [63:0] add59_3_168197_reload;
input  [63:0] add59_3196_reload;
input  [63:0] add59_2_188195_reload;
input  [63:0] add59_2194_reload;
input  [63:0] add59_1_1108193_reload;
input  [63:0] add59_1192_reload;
input  [63:0] add59_1178191_reload;
...
output  [63:0] add129_4_1189_out;
output   add129_4_1189_out_ap_vld;
output  [63:0] add129_4188_out;
output   add129_4188_out_ap_vld;
output  [63:0] add129_3_1187_out;
output   add129_3_1187_out_ap_vld;
output  [63:0] add129_3186_out;
output   add129_3186_out_ap_vld;
output  [63:0] add129_2_1185_out;
output   add129_2_1185_out_ap_vld;
output  [63:0] add129_2184_out;
output   add129_2184_out_ap_vld;
output  [63:0] add129_1_1183_out;
output   add129_1_1183_out_ap_vld;
output  [63:0] add129_1182_out;
output   add129_1182_out_ap_vld;
output  [63:0] add129_128181_out;
output   add129_128181_out_ap_vld;
output  [63:0] add129180_out;
output   add129180_out_ap_vld;

reg ap_idle;
reg add129_4_1189_out_ap_vld;
reg add129_4188_out_ap_vld;
reg add129_3_1187_out_ap_vld;
reg add129_3186_out_ap_vld;
reg add129_2_1185_out_ap_vld;
reg add129_2184_out_ap_vld;
reg add129_1_1183_out_ap_vld;
reg add129_1182_out_ap_vld;
reg add129_128181_out_ap_vld;
reg add129180_out_ap_vld;
...
reg   [63:0] add129180_fu_158;
wire   [63:0] add_ln68_fu_659_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add129_128181_fu_162;
wire   [63:0] add_ln68_1_fu_731_p2;
reg   [63:0] add129_1182_fu_166;
wire   [63:0] add_ln68_2_fu_788_p2;
reg   [63:0] add129_1_1183_fu_170;
wire   [63:0] add_ln68_3_fu_864_p2;
reg   [63:0] add129_2184_fu_174;
wire   [63:0] add_ln68_4_fu_919_p2;
reg   [63:0] add129_2_1185_fu_178;
wire   [63:0] add_ln68_5_fu_993_p2;
reg   [63:0] add129_3186_fu_182;
wire   [63:0] add_ln68_6_fu_1046_p2;
reg   [63:0] add129_3_1187_fu_186;
wire   [63:0] add_ln68_7_fu_1131_p2;
reg   [63:0] add129_4188_fu_190;
wire   [63:0] add_ln68_8_fu_1196_p2;
reg   [63:0] add129_4_1189_fu_194;
...
always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129180_out_ap_vld = 1'b1;
    end else begin
        add129180_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1182_out_ap_vld = 1'b1;
    end else begin
        add129_1182_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_128181_out_ap_vld = 1'b1;
    end else begin
        add129_128181_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_1183_out_ap_vld = 1'b1;
    end else begin
        add129_1_1183_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_2184_out_ap_vld = 1'b1;
    end else begin
        add129_2184_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_2_1185_out_ap_vld = 1'b1;
    end else begin
        add129_2_1185_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_3186_out_ap_vld = 1'b1;
    end else begin
        add129_3186_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_3_1187_out_ap_vld = 1'b1;
    end else begin
        add129_3_1187_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_4188_out_ap_vld = 1'b1;
    end else begin
        add129_4188_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_4_1189_out_ap_vld = 1'b1;
    end else begin
        add129_4_1189_out_ap_vld = 1'b0;
    end
end
...
assign add129180_out = add129180_fu_158;

assign add129_1182_out = add129_1182_fu_166;

assign add129_128181_out = add129_128181_fu_162;

assign add129_1_1183_out = add129_1_1183_fu_170;

assign add129_2184_out = add129_2184_fu_174;

assign add129_2_1185_out = add129_2_1185_fu_178;

assign add129_3186_out = add129_3186_fu_182;

assign add129_3_1187_out = add129_3_1187_fu_186;

assign add129_4188_out = add129_4188_fu_190;

assign add129_4_1189_out = add129_4_1189_fu_194;
...
assign add_ln68_1_fu_731_p2 = (and_ln68_fu_725_p2 + add129_128181_fu_162);

assign add_ln68_2_fu_788_p2 = (and_ln68_1_fu_782_p2 + add129_1182_fu_166);

assign add_ln68_3_fu_864_p2 = (and_ln68_2_fu_858_p2 + add129_1_1183_fu_170);

assign add_ln68_4_fu_919_p2 = (and_ln68_3_fu_913_p2 + add129_2184_fu_174);

assign add_ln68_5_fu_993_p2 = (and_ln68_4_fu_987_p2 + add129_2_1185_fu_178);

assign add_ln68_6_fu_1046_p2 = (and_ln68_5_fu_1040_p2 + add129_3186_fu_182);

assign add_ln68_7_fu_1131_p2 = (and_ln68_6_fu_1125_p2 + add129_3_1187_fu_186);

assign add_ln68_8_fu_1196_p2 = (and_ln68_7_fu_1190_p2 + add129_4188_fu_190);

assign add_ln68_9_fu_1281_p2 = (and_ln68_8_fu_1275_p2 + add129_4_1189_fu_194);

assign add_ln68_fu_659_p2 = (mul_ln68_fu_446_p2 + add129180_fu_158);
...
assign zext_ln68_fu_618_p1 = tmp_4_fu_602_p12;
