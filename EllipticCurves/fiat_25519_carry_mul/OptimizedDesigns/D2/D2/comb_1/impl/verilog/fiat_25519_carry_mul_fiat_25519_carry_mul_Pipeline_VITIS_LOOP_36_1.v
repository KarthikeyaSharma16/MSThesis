...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add59_931_out,
        add59_931_out_ap_vld,
        add59_830_out,
        add59_830_out_ap_vld,
        add59_729_out,
        add59_729_out_ap_vld,
        add59_628_out,
        add59_628_out_ap_vld,
        add59_527_out,
        add59_527_out_ap_vld,
        add59_426_out,
        add59_426_out_ap_vld,
        add59_325_out,
        add59_325_out_ap_vld,
        add59_224_out,
        add59_224_out_ap_vld,
        add59_123_out,
        add59_123_out_ap_vld
);
...
output  [63:0] add59_931_out;
output   add59_931_out_ap_vld;
output  [63:0] add59_830_out;
output   add59_830_out_ap_vld;
output  [63:0] add59_729_out;
output   add59_729_out_ap_vld;
output  [63:0] add59_628_out;
output   add59_628_out_ap_vld;
output  [63:0] add59_527_out;
output   add59_527_out_ap_vld;
output  [63:0] add59_426_out;
output   add59_426_out_ap_vld;
output  [63:0] add59_325_out;
output   add59_325_out_ap_vld;
output  [63:0] add59_224_out;
output   add59_224_out_ap_vld;
output  [63:0] add59_123_out;
output   add59_123_out_ap_vld;

reg ap_idle;
reg add59_931_out_ap_vld;
reg add59_830_out_ap_vld;
reg add59_729_out_ap_vld;
reg add59_628_out_ap_vld;
reg add59_527_out_ap_vld;
reg add59_426_out_ap_vld;
reg add59_325_out_ap_vld;
reg add59_224_out_ap_vld;
reg add59_123_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_123_out_ap_vld = 1'b1;
    end else begin
        add59_123_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_224_out_ap_vld = 1'b1;
    end else begin
        add59_224_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_325_out_ap_vld = 1'b1;
    end else begin
        add59_325_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_426_out_ap_vld = 1'b1;
    end else begin
        add59_426_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_527_out_ap_vld = 1'b1;
    end else begin
        add59_527_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_628_out_ap_vld = 1'b1;
    end else begin
        add59_628_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_729_out_ap_vld = 1'b1;
    end else begin
        add59_729_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_830_out_ap_vld = 1'b1;
    end else begin
        add59_830_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_931_out_ap_vld = 1'b1;
    end else begin
        add59_931_out_ap_vld = 1'b0;
    end
end
...
assign add59_123_out = arr_9_fu_122;

assign add59_224_out = arr_10_fu_126;

assign add59_325_out = arr_11_fu_130;

assign add59_426_out = arr_12_fu_134;

assign add59_527_out = arr_13_fu_138;

assign add59_628_out = arr_14_fu_142;

assign add59_729_out = arr_15_fu_146;

assign add59_830_out = arr_16_fu_150;

assign add59_931_out = arr_17_fu_154;
...
assign add_ln49_6_fu_778_p2 = (ap_sig_allocacmp_i1_2 + 4'd6);

assign add_ln49_9_fu_883_p2 = (zext_ln36_fu_474_p1 + 5'd8);
...
assign icmp_ln49_2_fu_817_p2 = ((add_ln49_6_fu_778_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_922_p2 = ((add_ln49_9_fu_883_p2 > 5'd9) ? 1'b1 : 1'b0);
