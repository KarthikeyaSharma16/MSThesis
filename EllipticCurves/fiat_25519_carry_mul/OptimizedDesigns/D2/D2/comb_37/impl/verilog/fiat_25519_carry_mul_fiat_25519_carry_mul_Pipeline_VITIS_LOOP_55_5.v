...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        zext_ln68_23,
        add129_1_482387_out,
        add129_1_482387_out_ap_vld,
        add129_1_364386_out,
        add129_1_364386_out_ap_vld,
        add129_1_246385_out,
        add129_1_246385_out_ap_vld,
        add129_1_128384_out,
        add129_1_128384_out_ap_vld,
        add129_1383_out,
        add129_1383_out_ap_vld,
        add129_4189382_out,
        add129_4189382_out_ap_vld,
        add129_3171381_out,
        add129_3171381_out_ap_vld,
        add129_2153380_out,
        add129_2153380_out_ap_vld,
        add129_1135379_out,
        add129_1135379_out_ap_vld,
        add129378_out,
        add129378_out_ap_vld
);
...
output  [63:0] add129_1_482387_out;
output   add129_1_482387_out_ap_vld;
output  [63:0] add129_1_364386_out;
output   add129_1_364386_out_ap_vld;
output  [63:0] add129_1_246385_out;
output   add129_1_246385_out_ap_vld;
output  [63:0] add129_1_128384_out;
output   add129_1_128384_out_ap_vld;
output  [63:0] add129_1383_out;
output   add129_1383_out_ap_vld;
output  [63:0] add129_4189382_out;
output   add129_4189382_out_ap_vld;
output  [63:0] add129_3171381_out;
output   add129_3171381_out_ap_vld;
output  [63:0] add129_2153380_out;
output   add129_2153380_out_ap_vld;
output  [63:0] add129_1135379_out;
output   add129_1135379_out_ap_vld;
output  [63:0] add129378_out;
output   add129378_out_ap_vld;

reg ap_idle;
reg add129_1_482387_out_ap_vld;
reg add129_1_364386_out_ap_vld;
reg add129_1_246385_out_ap_vld;
reg add129_1_128384_out_ap_vld;
reg add129_1383_out_ap_vld;
reg add129_4189382_out_ap_vld;
reg add129_3171381_out_ap_vld;
reg add129_2153380_out_ap_vld;
reg add129_1135379_out_ap_vld;
reg add129378_out_ap_vld;
...
reg   [63:0] add129378_fu_160;
wire   [63:0] add_ln68_7_fu_1259_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add129_1135379_fu_164;
wire   [63:0] add_ln68_12_fu_1302_p2;
reg   [63:0] add129_2153380_fu_168;
wire   [63:0] add_ln68_17_fu_1351_p2;
reg   [63:0] add129_3171381_fu_172;
wire   [63:0] add_ln68_22_fu_1431_p2;
reg   [63:0] add129_4189382_fu_176;
wire   [63:0] add_ln68_28_fu_1507_p2;
reg   [63:0] add129_1383_fu_180;
wire   [63:0] add_ln68_43_fu_1742_p2;
reg   [63:0] add129_1_128384_fu_184;
wire   [63:0] add_ln68_38_fu_1682_p2;
reg   [63:0] add129_1_246385_fu_188;
wire   [63:0] add_ln68_34_fu_1634_p2;
reg   [63:0] add129_1_364386_fu_192;
wire   [63:0] add_ln68_31_fu_1598_p2;
reg   [63:0] add129_1_482387_fu_196;
...
wire   [31:0] tmp_10_fu_1200_p5;
wire   [31:0] tmp_11_fu_1214_p8;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129378_fu_160 <= 64'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add129378_fu_160 <= add_ln68_7_fu_1259_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1135379_fu_164 <= arr;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add129_1135379_fu_164 <= add_ln68_12_fu_1302_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1383_fu_180 <= arr_4;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add129_1383_fu_180 <= add_ln68_43_fu_1742_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1_128384_fu_184 <= arr_5;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add129_1_128384_fu_184 <= add_ln68_38_fu_1682_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1_246385_fu_188 <= arr_6;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add129_1_246385_fu_188 <= add_ln68_34_fu_1634_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1_364386_fu_192 <= arr_7;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add129_1_364386_fu_192 <= add_ln68_31_fu_1598_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1_482387_fu_196 <= arr_8;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add129_1_482387_fu_196 <= add_ln68_29_fu_1549_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_2153380_fu_168 <= arr_1;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add129_2153380_fu_168 <= add_ln68_17_fu_1351_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_3171381_fu_172 <= arr_2;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add129_3171381_fu_172 <= add_ln68_22_fu_1431_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_4189382_fu_176 <= arr_3;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
            add129_4189382_fu_176 <= add_ln68_28_fu_1507_p2;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129378_out_ap_vld = 1'b1;
    end else begin
        add129378_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1135379_out_ap_vld = 1'b1;
    end else begin
        add129_1135379_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1383_out_ap_vld = 1'b1;
    end else begin
        add129_1383_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_128384_out_ap_vld = 1'b1;
    end else begin
        add129_1_128384_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_246385_out_ap_vld = 1'b1;
    end else begin
        add129_1_246385_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_364386_out_ap_vld = 1'b1;
    end else begin
        add129_1_364386_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_482387_out_ap_vld = 1'b1;
    end else begin
        add129_1_482387_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_2153380_out_ap_vld = 1'b1;
    end else begin
        add129_2153380_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_3171381_out_ap_vld = 1'b1;
    end else begin
        add129_3171381_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_4189382_out_ap_vld = 1'b1;
    end else begin
        add129_4189382_out_ap_vld = 1'b0;
    end
end
...
assign add129378_out = add129378_fu_160;

assign add129_1135379_out = add129_1135379_fu_164;

assign add129_1383_out = add129_1383_fu_180;

assign add129_1_128384_out = add129_1_128384_fu_184;

assign add129_1_246385_out = add129_1_246385_fu_188;

assign add129_1_364386_out = add129_1_364386_fu_192;

assign add129_1_482387_out = add129_1_482387_fu_196;

assign add129_2153380_out = add129_2153380_fu_168;

assign add129_3171381_out = add129_3171381_fu_172;

assign add129_4189382_out = add129_4189382_fu_176;
...
assign add_ln68_12_fu_1302_p2 = (add129_1135379_fu_164 + add_ln68_11_fu_1296_p2);
...
assign add_ln68_17_fu_1351_p2 = (add129_2153380_fu_168 + add_ln68_16_fu_1345_p2);
...
assign add_ln68_1_fu_740_p2 = (ap_sig_allocacmp_i1_2 + 4'd6);
...
assign add_ln68_22_fu_1431_p2 = (add129_3171381_fu_172 + add_ln68_21_fu_1425_p2);
...
assign add_ln68_28_fu_1507_p2 = (add129_4189382_fu_176 + add_ln68_27_fu_1501_p2);

assign add_ln68_29_fu_1549_p2 = (and_ln68_10_fu_1543_p2 + add129_1_482387_fu_196);
...
assign add_ln68_31_fu_1598_p2 = (add129_1_364386_fu_192 + add_ln68_30_fu_1592_p2);
...
assign add_ln68_34_fu_1634_p2 = (add129_1_246385_fu_188 + add_ln68_33_fu_1628_p2);
...
assign add_ln68_38_fu_1682_p2 = (add129_1_128384_fu_184 + add_ln68_37_fu_1676_p2);
...
assign add_ln68_43_fu_1742_p2 = (add129_1383_fu_180 + add_ln68_42_fu_1736_p2);
...
assign add_ln68_7_fu_1259_p2 = (add129378_fu_160 + add_ln68_6_fu_1253_p2);
...
assign icmp_ln68_1_fu_734_p2 = ((i1_3_fu_722_p2 < 4'd10) ? 1'b1 : 1'b0);
...
assign icmp_ln68_fu_676_p2 = ((ap_sig_allocacmp_i1_2 < 4'd10) ? 1'b1 : 1'b0);
...
assign select_ln68_6_fu_1367_p3 = ((and_ln67_2_fu_1357_p2[0:0] == 1'b1) ? shl_ln68_6_fu_1361_p2 : tmp_10_fu_1200_p5);

assign select_ln68_7_fu_1522_p3 = ((and_ln67_3_fu_1513_p2[0:0] == 1'b1) ? shl_ln68_7_fu_1517_p2 : arg2_r_reload);

assign select_ln68_8_fu_1566_p3 = ((and_ln67_4_fu_1555_p2[0:0] == 1'b1) ? shl_ln68_8_fu_1560_p2 : tmp_12_fu_1437_p4);
...
assign shl_ln68_6_fu_1361_p2 = tmp_10_fu_1200_p5 << 32'd1;

assign shl_ln68_7_fu_1517_p2 = arg2_r_reload << 32'd1;

assign shl_ln68_8_fu_1560_p2 = tmp_12_fu_1437_p4 << 32'd1;
...
assign trunc_ln68_fu_682_p1 = ap_sig_allocacmp_i1_2[0:0];
...
assign zext_ln68_15_fu_1164_p1 = tmp_s_fu_1153_p8;

assign zext_ln68_16_fu_1194_p1 = select_ln68_5_fu_1186_p3;

assign zext_ln68_17_fu_1208_p1 = tmp_10_fu_1200_p5;

assign zext_ln68_18_fu_1225_p1 = tmp_11_fu_1214_p8;
...
assign zext_ln68_24_fu_686_p1 = ap_sig_allocacmp_i1_2;
