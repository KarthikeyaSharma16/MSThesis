...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_9183_out \
    op interface \
    ports { add59_9183_out { O 64 vector } add59_9183_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_8182_out \
    op interface \
    ports { add59_8182_out { O 64 vector } add59_8182_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_7181_out \
    op interface \
    ports { add59_7181_out { O 64 vector } add59_7181_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_6180_out \
    op interface \
    ports { add59_6180_out { O 64 vector } add59_6180_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_5179_out \
    op interface \
    ports { add59_5179_out { O 64 vector } add59_5179_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_4178_out \
    op interface \
    ports { add59_4178_out { O 64 vector } add59_4178_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_3177_out \
    op interface \
    ports { add59_3177_out { O 64 vector } add59_3177_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_2176_out \
    op interface \
    ports { add59_2176_out { O 64 vector } add59_2176_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_1175_out \
    op interface \
    ports { add59_1175_out { O 64 vector } add59_1175_out_ap_vld { O 1 bit } } \
} "
}
