...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_9_reload,
        add129_921_out,
        add129_921_out_ap_vld,
        add129_820_out,
        add129_820_out_ap_vld,
        add129_719_out,
        add129_719_out_ap_vld,
        add129_618_out,
        add129_618_out_ap_vld,
        add129_517_out,
        add129_517_out_ap_vld,
        add129_416_out,
        add129_416_out_ap_vld,
        add129_315_out,
        add129_315_out_ap_vld,
        add129_214_out,
        add129_214_out_ap_vld,
        add129_113_out,
        add129_113_out_ap_vld,
        add12912_out,
        add12912_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add59_931_reload;
input  [63:0] add59_830_reload;
input  [63:0] add59_729_reload;
input  [63:0] add59_628_reload;
input  [63:0] add59_527_reload;
input  [63:0] add59_426_reload;
input  [63:0] add59_325_reload;
input  [63:0] add59_224_reload;
input  [63:0] add59_123_reload;
...
output  [63:0] add129_921_out;
output   add129_921_out_ap_vld;
output  [63:0] add129_820_out;
output   add129_820_out_ap_vld;
output  [63:0] add129_719_out;
output   add129_719_out_ap_vld;
output  [63:0] add129_618_out;
output   add129_618_out_ap_vld;
output  [63:0] add129_517_out;
output   add129_517_out_ap_vld;
output  [63:0] add129_416_out;
output   add129_416_out_ap_vld;
output  [63:0] add129_315_out;
output   add129_315_out_ap_vld;
output  [63:0] add129_214_out;
output   add129_214_out_ap_vld;
output  [63:0] add129_113_out;
output   add129_113_out_ap_vld;
output  [63:0] add12912_out;
output   add12912_out_ap_vld;

reg ap_idle;
reg add129_921_out_ap_vld;
reg add129_820_out_ap_vld;
reg add129_719_out_ap_vld;
reg add129_618_out_ap_vld;
reg add129_517_out_ap_vld;
reg add129_416_out_ap_vld;
reg add129_315_out_ap_vld;
reg add129_214_out_ap_vld;
reg add129_113_out_ap_vld;
reg add12912_out_ap_vld;
...
wire   [31:0] tmp_s_fu_598_p12;
wire   [3:0] tmp_1_fu_634_p11;
wire   [31:0] tmp_1_fu_634_p12;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_113_fu_162 <= add59_123_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_113_fu_162 <= add_ln68_1_fu_731_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_214_fu_166 <= add59_224_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_214_fu_166 <= add_ln68_2_fu_788_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_315_fu_170 <= add59_325_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_315_fu_170 <= add_ln68_3_fu_864_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_416_fu_174 <= add59_426_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_416_fu_174 <= add_ln68_4_fu_919_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_517_fu_178 <= add59_527_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_517_fu_178 <= add_ln68_5_fu_993_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_618_fu_182 <= add59_628_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_618_fu_182 <= add_ln68_6_fu_1046_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_719_fu_186 <= add59_729_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_719_fu_186 <= add_ln68_7_fu_1131_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_820_fu_190 <= add59_830_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_820_fu_190 <= add_ln68_8_fu_1196_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_921_fu_194 <= add59_931_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_921_fu_194 <= add_ln68_9_fu_1281_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            i1_fu_198 <= indvars_iv_next33_fu_550_p2;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add12912_out_ap_vld = 1'b1;
    end else begin
        add12912_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_113_out_ap_vld = 1'b1;
    end else begin
        add129_113_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_214_out_ap_vld = 1'b1;
    end else begin
        add129_214_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_315_out_ap_vld = 1'b1;
    end else begin
        add129_315_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_416_out_ap_vld = 1'b1;
    end else begin
        add129_416_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_517_out_ap_vld = 1'b1;
    end else begin
        add129_517_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_618_out_ap_vld = 1'b1;
    end else begin
        add129_618_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_719_out_ap_vld = 1'b1;
    end else begin
        add129_719_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_820_out_ap_vld = 1'b1;
    end else begin
        add129_820_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_921_out_ap_vld = 1'b1;
    end else begin
        add129_921_out_ap_vld = 1'b0;
    end
end
...
assign add12912_out = add12912_fu_158;

assign add129_113_out = add129_113_fu_162;

assign add129_214_out = add129_214_fu_166;

assign add129_315_out = add129_315_fu_170;

assign add129_416_out = add129_416_fu_174;

assign add129_517_out = add129_517_fu_178;

assign add129_618_out = add129_618_fu_182;

assign add129_719_out = add129_719_fu_186;

assign add129_820_out = add129_820_fu_190;

assign add129_921_out = add129_921_fu_194;

assign add_ln68_1_fu_731_p2 = (and_ln68_fu_725_p2 + add129_113_fu_162);

assign add_ln68_2_fu_788_p2 = (and_ln68_1_fu_782_p2 + add129_214_fu_166);

assign add_ln68_3_fu_864_p2 = (and_ln68_2_fu_858_p2 + add129_315_fu_170);

assign add_ln68_4_fu_919_p2 = (and_ln68_3_fu_913_p2 + add129_416_fu_174);

assign add_ln68_5_fu_993_p2 = (and_ln68_4_fu_987_p2 + add129_517_fu_178);

assign add_ln68_6_fu_1046_p2 = (and_ln68_5_fu_1040_p2 + add129_618_fu_182);

assign add_ln68_7_fu_1131_p2 = (and_ln68_6_fu_1125_p2 + add129_719_fu_186);

assign add_ln68_8_fu_1196_p2 = (and_ln68_7_fu_1190_p2 + add129_820_fu_190);

assign add_ln68_9_fu_1281_p2 = (and_ln68_8_fu_1275_p2 + add129_921_fu_194);

assign add_ln68_fu_655_p2 = (mul_ln68_fu_446_p2 + add12912_fu_158);
...
assign icmp_ln67_1_fu_665_p2 = ((indvars_iv_next33_fu_550_p2 < 4'd10) ? 1'b1 : 1'b0);
...
assign indvars_iv_next33_fu_550_p2 = (i1_fu_198 + 4'd1);
...
assign mul_ln68_fu_446_p00 = tmp_1_fu_634_p12;
...
assign tmp_1_fu_634_p11 = ($signed(4'd9) - $signed(i1_fu_198));
...
assign zext_ln68_fu_614_p1 = tmp_s_fu_598_p12;
