...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add59_1_4216_out,
        add59_1_4216_out_ap_vld,
        add59_1_3215_out,
        add59_1_3215_out_ap_vld,
        add59_1_2214_out,
        add59_1_2214_out_ap_vld,
        add59_1_1213_out,
        add59_1_1213_out_ap_vld,
        add59_1212_out,
        add59_1212_out_ap_vld,
        add59_4211_out,
        add59_4211_out_ap_vld,
        add59_3210_out,
        add59_3210_out_ap_vld,
        add59_2209_out,
        add59_2209_out_ap_vld,
        add59_1205208_out,
        add59_1205208_out_ap_vld
);
...
output  [63:0] add59_1_4216_out;
output   add59_1_4216_out_ap_vld;
output  [63:0] add59_1_3215_out;
output   add59_1_3215_out_ap_vld;
output  [63:0] add59_1_2214_out;
output   add59_1_2214_out_ap_vld;
output  [63:0] add59_1_1213_out;
output   add59_1_1213_out_ap_vld;
output  [63:0] add59_1212_out;
output   add59_1212_out_ap_vld;
output  [63:0] add59_4211_out;
output   add59_4211_out_ap_vld;
output  [63:0] add59_3210_out;
output   add59_3210_out_ap_vld;
output  [63:0] add59_2209_out;
output   add59_2209_out_ap_vld;
output  [63:0] add59_1205208_out;
output   add59_1205208_out_ap_vld;

reg ap_idle;
reg add59_1_4216_out_ap_vld;
reg add59_1_3215_out_ap_vld;
reg add59_1_2214_out_ap_vld;
reg add59_1_1213_out_ap_vld;
reg add59_1212_out_ap_vld;
reg add59_4211_out_ap_vld;
reg add59_3210_out_ap_vld;
reg add59_2209_out_ap_vld;
reg add59_1205208_out_ap_vld;
...
wire   [4:0] add_ln49_10_fu_916_p2;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1205208_out_ap_vld = 1'b1;
    end else begin
        add59_1205208_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1212_out_ap_vld = 1'b1;
    end else begin
        add59_1212_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_1213_out_ap_vld = 1'b1;
    end else begin
        add59_1_1213_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_2214_out_ap_vld = 1'b1;
    end else begin
        add59_1_2214_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_3215_out_ap_vld = 1'b1;
    end else begin
        add59_1_3215_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_4216_out_ap_vld = 1'b1;
    end else begin
        add59_1_4216_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2209_out_ap_vld = 1'b1;
    end else begin
        add59_2209_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3210_out_ap_vld = 1'b1;
    end else begin
        add59_3210_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4211_out_ap_vld = 1'b1;
    end else begin
        add59_4211_out_ap_vld = 1'b0;
    end
end
...
assign add59_1205208_out = add59_1205208_fu_122;

assign add59_1212_out = add59_1212_fu_138;

assign add59_1_1213_out = add59_1_1213_fu_142;

assign add59_1_2214_out = add59_1_2214_fu_146;

assign add59_1_3215_out = add59_1_3215_fu_150;

assign add59_1_4216_out = add59_1_4216_fu_154;

assign add59_2209_out = add59_2209_fu_126;

assign add59_3210_out = add59_3210_fu_130;

assign add59_4211_out = add59_4211_fu_134;
...
assign add_ln49_10_fu_916_p2 = (zext_ln36_fu_474_p1 + 5'd8);

assign add_ln49_11_fu_1192_p2 = (and_ln49_7_fu_1186_p2 + add59_1_3215_fu_150);

assign add_ln49_12_fu_1202_p2 = (mul_ln49_17_fu_371_p2 + add59_1_4216_fu_154);

assign add_ln49_1_fu_568_p2 = (ap_sig_allocacmp_i1_1 + 4'd2);

assign add_ln49_2_fu_1054_p2 = (and_ln49_1_fu_1048_p2 + add59_2209_fu_126);

assign add_ln49_3_fu_1077_p2 = (and_ln49_2_fu_1071_p2 + add59_3210_fu_130);

assign add_ln49_4_fu_673_p2 = (ap_sig_allocacmp_i1_1 + 4'd4);

assign add_ln49_5_fu_1100_p2 = (and_ln49_3_fu_1094_p2 + add59_4211_fu_134);

assign add_ln49_6_fu_1123_p2 = (and_ln49_4_fu_1117_p2 + add59_1212_fu_138);

assign add_ln49_7_fu_811_p2 = (ap_sig_allocacmp_i1_1 + 4'd6);

assign add_ln49_8_fu_1146_p2 = (and_ln49_5_fu_1140_p2 + add59_1_1213_fu_142);

assign add_ln49_9_fu_1169_p2 = (and_ln49_6_fu_1163_p2 + add59_1_2214_fu_146);

assign add_ln49_fu_1031_p2 = (and_ln49_fu_1025_p2 + add59_1205208_fu_122);
...
assign empty_22_fu_718_p2 = (ap_sig_allocacmp_i1_1 + 4'd5);
...
assign icmp_ln48_2_fu_724_p2 = ((empty_22_fu_718_p2 > 4'd9) ? 1'b1 : 1'b0);
...
assign icmp_ln49_2_fu_817_p2 = ((add_ln49_7_fu_811_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_922_p2 = ((add_ln49_10_fu_916_p2 > 5'd9) ? 1'b1 : 1'b0);
...
assign tmp_6_fu_784_p11 = ($signed(4'd13) - $signed(ap_sig_allocacmp_i1_1));

assign tmp_7_fu_856_p11 = ($signed(4'd12) - $signed(ap_sig_allocacmp_i1_1));

assign tmp_8_fu_889_p11 = ($signed(4'd11) - $signed(ap_sig_allocacmp_i1_1));
