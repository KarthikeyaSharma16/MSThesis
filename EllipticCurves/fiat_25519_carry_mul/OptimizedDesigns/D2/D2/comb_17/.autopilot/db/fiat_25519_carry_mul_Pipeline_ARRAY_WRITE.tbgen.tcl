...
set C_modelArgList {
	...
	{ zext_ln75 int 26 regular  }
	{ zext_ln76 int 25 regular  }
	{ out1_w_2 int 27 regular  }
	{ zext_ln78 int 25 regular  }
	{ zext_ln79 int 26 regular  }
	{ zext_ln80 int 25 regular  }
	{ zext_ln81 int 26 regular  }
	{ zext_ln82 int 25 regular  }
	{ zext_ln83 int 26 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "zext_ln75", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln76", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "out1_w_2", "interface" : "wire", "bitwidth" : 27, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln78", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln79", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln80", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln81", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln82", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln83", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln87 sc_in sc_lv 62 signal 1 } 
	{ zext_ln75 sc_in sc_lv 26 signal 2 } 
	{ zext_ln76 sc_in sc_lv 25 signal 3 } 
	{ out1_w_2 sc_in sc_lv 27 signal 4 } 
	{ zext_ln78 sc_in sc_lv 25 signal 5 } 
	{ zext_ln79 sc_in sc_lv 26 signal 6 } 
	{ zext_ln80 sc_in sc_lv 25 signal 7 } 
	{ zext_ln81 sc_in sc_lv 26 signal 8 } 
	{ zext_ln82 sc_in sc_lv 25 signal 9 } 
	{ zext_ln83 sc_in sc_lv 26 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln75", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln75", "role": "default" }} , 
 	{ "name": "zext_ln76", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln76", "role": "default" }} , 
 	{ "name": "out1_w_2", "direction": "in", "datatype": "sc_lv", "bitwidth":27, "type": "signal", "bundle":{"name": "out1_w_2", "role": "default" }} , 
 	{ "name": "zext_ln78", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln78", "role": "default" }} , 
 	{ "name": "zext_ln79", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln79", "role": "default" }} , 
 	{ "name": "zext_ln80", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln80", "role": "default" }} , 
 	{ "name": "zext_ln81", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln81", "role": "default" }} , 
 	{ "name": "zext_ln82", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln82", "role": "default" }} , 
 	{ "name": "zext_ln83", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln83", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_10_4_27_1_1_U211", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln75 { ap_none {  { zext_ln75 in_data 0 26 } } }
	zext_ln76 { ap_none {  { zext_ln76 in_data 0 25 } } }
	out1_w_2 { ap_none {  { out1_w_2 in_data 0 27 } } }
	zext_ln78 { ap_none {  { zext_ln78 in_data 0 25 } } }
	zext_ln79 { ap_none {  { zext_ln79 in_data 0 26 } } }
	zext_ln80 { ap_none {  { zext_ln80 in_data 0 25 } } }
	zext_ln81 { ap_none {  { zext_ln81 in_data 0 26 } } }
	zext_ln82 { ap_none {  { zext_ln82 in_data 0 25 } } }
	zext_ln83 { ap_none {  { zext_ln83 in_data 0 26 } } }
