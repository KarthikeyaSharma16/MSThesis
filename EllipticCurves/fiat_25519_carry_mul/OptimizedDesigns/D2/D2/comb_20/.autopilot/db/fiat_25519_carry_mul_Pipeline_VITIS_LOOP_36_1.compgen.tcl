...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_967_out \
    op interface \
    ports { add59_967_out { O 64 vector } add59_967_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_866_out \
    op interface \
    ports { add59_866_out { O 64 vector } add59_866_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_765_out \
    op interface \
    ports { add59_765_out { O 64 vector } add59_765_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_664_out \
    op interface \
    ports { add59_664_out { O 64 vector } add59_664_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_563_out \
    op interface \
    ports { add59_563_out { O 64 vector } add59_563_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_462_out \
    op interface \
    ports { add59_462_out { O 64 vector } add59_462_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_361_out \
    op interface \
    ports { add59_361_out { O 64 vector } add59_361_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 107 \
    name add59_24660_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add59_24660_out \
    op interface \
    ports { add59_24660_out { O 64 vector } add59_24660_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 108 \
    name add59_12859_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add59_12859_out \
    op interface \
    ports { add59_12859_out { O 64 vector } add59_12859_out_ap_vld { O 1 bit } } \
} "
}
