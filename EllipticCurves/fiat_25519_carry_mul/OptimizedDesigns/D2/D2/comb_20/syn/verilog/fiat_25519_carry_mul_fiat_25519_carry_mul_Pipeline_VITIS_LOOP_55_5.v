...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_9_reload,
        add129_957_out,
        add129_957_out_ap_vld,
        add129_856_out,
        add129_856_out_ap_vld,
        add129_755_out,
        add129_755_out_ap_vld,
        add129_654_out,
        add129_654_out_ap_vld,
        add129_553_out,
        add129_553_out_ap_vld,
        add129_452_out,
...
output   ap_idle;
output   ap_ready;
input  [63:0] add59_967_reload;
input  [63:0] add59_866_reload;
input  [63:0] add59_765_reload;
input  [63:0] add59_664_reload;
input  [63:0] add59_563_reload;
input  [63:0] add59_462_reload;
input  [63:0] add59_361_reload;
input  [63:0] add59_24660_reload;
input  [63:0] add59_12859_reload;
...
output  [63:0] add129_957_out;
output   add129_957_out_ap_vld;
output  [63:0] add129_856_out;
output   add129_856_out_ap_vld;
output  [63:0] add129_755_out;
output   add129_755_out_ap_vld;
output  [63:0] add129_654_out;
output   add129_654_out_ap_vld;
output  [63:0] add129_553_out;
output   add129_553_out_ap_vld;
...
output  [63:0] add129_149_out;
output   add129_149_out_ap_vld;
output  [63:0] add12948_out;
output   add12948_out_ap_vld;

reg ap_idle;
reg add129_957_out_ap_vld;
reg add129_856_out_ap_vld;
reg add129_755_out_ap_vld;
reg add129_654_out_ap_vld;
reg add129_553_out_ap_vld;
reg add129_452_out_ap_vld;
reg add129_351_out_ap_vld;
reg add129_250_out_ap_vld;
reg add129_149_out_ap_vld;
...
reg   [63:0] add129_553_fu_178;
wire   [63:0] add_ln68_7_fu_993_p2;
reg   [63:0] add129_654_fu_182;
wire   [63:0] add_ln68_9_fu_1046_p2;
reg   [63:0] add129_755_fu_186;
wire   [63:0] add_ln68_10_fu_1131_p2;
reg   [63:0] add129_856_fu_190;
wire   [63:0] add_ln68_12_fu_1196_p2;
reg   [63:0] add129_957_fu_194;
...
always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_149_out_ap_vld = 1'b1;
    end else begin
        add129_149_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_553_out_ap_vld = 1'b1;
    end else begin
        add129_553_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_654_out_ap_vld = 1'b1;
    end else begin
        add129_654_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_755_out_ap_vld = 1'b1;
    end else begin
        add129_755_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_856_out_ap_vld = 1'b1;
    end else begin
        add129_856_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_957_out_ap_vld = 1'b1;
    end else begin
        add129_957_out_ap_vld = 1'b0;
    end
end
...
assign add129_149_out = add129_149_fu_162;
...
assign add129_553_out = add129_553_fu_178;

assign add129_654_out = add129_654_fu_182;

assign add129_755_out = add129_755_fu_186;

assign add129_856_out = add129_856_fu_190;

assign add129_957_out = add129_957_fu_194;
...
assign add_ln68_10_fu_1131_p2 = (and_ln68_6_fu_1125_p2 + add129_755_fu_186);

assign add_ln68_11_fu_1137_p2 = (zext_ln67_fu_586_p1 + 5'd8);

assign add_ln68_12_fu_1196_p2 = (and_ln68_7_fu_1190_p2 + add129_856_fu_190);

assign add_ln68_13_fu_1281_p2 = (and_ln68_8_fu_1275_p2 + add129_957_fu_194);

assign add_ln68_1_fu_731_p2 = (and_ln68_fu_725_p2 + add129_149_fu_162);
...
assign add_ln68_7_fu_993_p2 = (and_ln68_4_fu_987_p2 + add129_553_fu_178);

assign add_ln68_8_fu_999_p2 = (i1_fu_198 + 4'd6);

assign add_ln68_9_fu_1046_p2 = (and_ln68_5_fu_1040_p2 + add129_654_fu_182);
