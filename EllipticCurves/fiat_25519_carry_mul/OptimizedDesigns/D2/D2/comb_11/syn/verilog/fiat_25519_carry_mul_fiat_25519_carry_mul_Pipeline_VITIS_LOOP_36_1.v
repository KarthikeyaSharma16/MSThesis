...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add59_4_1225_out,
        add59_4_1225_out_ap_vld,
        add59_4224_out,
        add59_4224_out_ap_vld,
        add59_3_1223_out,
        add59_3_1223_out_ap_vld,
        add59_3222_out,
        add59_3222_out_ap_vld,
        add59_2_1221_out,
        add59_2_1221_out_ap_vld,
        add59_2220_out,
        add59_2220_out_ap_vld,
        add59_1_1219_out,
        add59_1_1219_out_ap_vld,
        add59_1218_out,
        add59_1218_out_ap_vld,
        add59_1214217_out,
        add59_1214217_out_ap_vld
);
...
output  [63:0] add59_4_1225_out;
output   add59_4_1225_out_ap_vld;
output  [63:0] add59_4224_out;
output   add59_4224_out_ap_vld;
output  [63:0] add59_3_1223_out;
output   add59_3_1223_out_ap_vld;
output  [63:0] add59_3222_out;
output   add59_3222_out_ap_vld;
output  [63:0] add59_2_1221_out;
output   add59_2_1221_out_ap_vld;
output  [63:0] add59_2220_out;
output   add59_2220_out_ap_vld;
output  [63:0] add59_1_1219_out;
output   add59_1_1219_out_ap_vld;
output  [63:0] add59_1218_out;
output   add59_1218_out_ap_vld;
output  [63:0] add59_1214217_out;
output   add59_1214217_out_ap_vld;

reg ap_idle;
reg add59_4_1225_out_ap_vld;
reg add59_4224_out_ap_vld;
reg add59_3_1223_out_ap_vld;
reg add59_3222_out_ap_vld;
reg add59_2_1221_out_ap_vld;
reg add59_2220_out_ap_vld;
reg add59_1_1219_out_ap_vld;
reg add59_1218_out_ap_vld;
reg add59_1214217_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1214217_out_ap_vld = 1'b1;
    end else begin
        add59_1214217_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1218_out_ap_vld = 1'b1;
    end else begin
        add59_1218_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_1219_out_ap_vld = 1'b1;
    end else begin
        add59_1_1219_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2220_out_ap_vld = 1'b1;
    end else begin
        add59_2220_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2_1221_out_ap_vld = 1'b1;
    end else begin
        add59_2_1221_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3222_out_ap_vld = 1'b1;
    end else begin
        add59_3222_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3_1223_out_ap_vld = 1'b1;
    end else begin
        add59_3_1223_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4224_out_ap_vld = 1'b1;
    end else begin
        add59_4224_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4_1225_out_ap_vld = 1'b1;
    end else begin
        add59_4_1225_out_ap_vld = 1'b0;
    end
end
...
assign add59_1214217_out = add59_1214217_fu_122;

assign add59_1218_out = add59_1218_fu_126;

assign add59_1_1219_out = add59_1_1219_fu_130;

assign add59_2220_out = add59_2220_fu_134;

assign add59_2_1221_out = add59_2_1221_fu_138;

assign add59_3222_out = add59_3222_fu_142;

assign add59_3_1223_out = add59_3_1223_fu_146;

assign add59_4224_out = add59_4224_fu_150;

assign add59_4_1225_out = add59_4_1225_fu_154;
...
assign add_ln49_1_fu_1054_p2 = (and_ln49_1_fu_1048_p2 + add59_1218_fu_126);

assign add_ln49_2_fu_1077_p2 = (and_ln49_2_fu_1071_p2 + add59_1_1219_fu_130);

assign add_ln49_3_fu_1100_p2 = (and_ln49_3_fu_1094_p2 + add59_2220_fu_134);

assign add_ln49_4_fu_1123_p2 = (and_ln49_4_fu_1117_p2 + add59_2_1221_fu_138);

assign add_ln49_5_fu_1146_p2 = (and_ln49_5_fu_1140_p2 + add59_3222_fu_142);

assign add_ln49_6_fu_1169_p2 = (and_ln49_6_fu_1163_p2 + add59_3_1223_fu_146);

assign add_ln49_7_fu_1192_p2 = (and_ln49_7_fu_1186_p2 + add59_4224_fu_150);

assign add_ln49_8_fu_1202_p2 = (mul_ln49_17_fu_371_p2 + add59_4_1225_fu_154);

assign add_ln49_fu_1031_p2 = (and_ln49_fu_1025_p2 + add59_1214217_fu_122);
...
assign empty_23_fu_673_p2 = (ap_sig_allocacmp_i1_1 + 4'd4);

assign empty_24_fu_778_p2 = (ap_sig_allocacmp_i1_1 + 4'd6);

assign empty_25_fu_883_p2 = (zext_ln36_fu_474_p1 + 5'd8);
...
assign icmp_ln49_1_fu_712_p2 = ((empty_23_fu_673_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_2_fu_817_p2 = ((empty_24_fu_778_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_922_p2 = ((empty_25_fu_883_p2 > 5'd9) ? 1'b1 : 1'b0);
