...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_9169_out \
    op interface \
    ports { add59_9169_out { O 64 vector } add59_9169_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_8168_out \
    op interface \
    ports { add59_8168_out { O 64 vector } add59_8168_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_7167_out \
    op interface \
    ports { add59_7167_out { O 64 vector } add59_7167_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_6166_out \
    op interface \
    ports { add59_6166_out { O 64 vector } add59_6166_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_5165_out \
    op interface \
    ports { add59_5165_out { O 64 vector } add59_5165_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_4164_out \
    op interface \
    ports { add59_4164_out { O 64 vector } add59_4164_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_3163_out \
    op interface \
    ports { add59_3163_out { O 64 vector } add59_3163_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_2162_out \
    op interface \
    ports { add59_2162_out { O 64 vector } add59_2162_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_1161_out \
    op interface \
    ports { add59_1161_out { O 64 vector } add59_1161_out_ap_vld { O 1 bit } } \
} "
}
