...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add59_9103_out,
        add59_9103_out_ap_vld,
        add59_8102_out,
        add59_8102_out_ap_vld,
        add59_7101_out,
        add59_7101_out_ap_vld,
        add59_6100_out,
        add59_6100_out_ap_vld,
        add59_599_out,
        add59_599_out_ap_vld,
        add59_498_out,
        add59_498_out_ap_vld,
        add59_397_out,
        add59_397_out_ap_vld,
        add59_296_out,
        add59_296_out_ap_vld,
        add59_195_out,
        add59_195_out_ap_vld
);
...
output  [63:0] add59_9103_out;
output   add59_9103_out_ap_vld;
output  [63:0] add59_8102_out;
output   add59_8102_out_ap_vld;
output  [63:0] add59_7101_out;
output   add59_7101_out_ap_vld;
output  [63:0] add59_6100_out;
output   add59_6100_out_ap_vld;
output  [63:0] add59_599_out;
output   add59_599_out_ap_vld;
output  [63:0] add59_498_out;
output   add59_498_out_ap_vld;
output  [63:0] add59_397_out;
output   add59_397_out_ap_vld;
output  [63:0] add59_296_out;
output   add59_296_out_ap_vld;
output  [63:0] add59_195_out;
output   add59_195_out_ap_vld;

reg ap_idle;
reg add59_9103_out_ap_vld;
reg add59_8102_out_ap_vld;
reg add59_7101_out_ap_vld;
reg add59_6100_out_ap_vld;
reg add59_599_out_ap_vld;
reg add59_498_out_ap_vld;
reg add59_397_out_ap_vld;
reg add59_296_out_ap_vld;
reg add59_195_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_195_out_ap_vld = 1'b1;
    end else begin
        add59_195_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_296_out_ap_vld = 1'b1;
    end else begin
        add59_296_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_397_out_ap_vld = 1'b1;
    end else begin
        add59_397_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_498_out_ap_vld = 1'b1;
    end else begin
        add59_498_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_599_out_ap_vld = 1'b1;
    end else begin
        add59_599_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_6100_out_ap_vld = 1'b1;
    end else begin
        add59_6100_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_7101_out_ap_vld = 1'b1;
    end else begin
        add59_7101_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_8102_out_ap_vld = 1'b1;
    end else begin
        add59_8102_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_9103_out_ap_vld = 1'b1;
    end else begin
        add59_9103_out_ap_vld = 1'b0;
    end
end
...
assign add59_195_out = arr_9_fu_122;

assign add59_296_out = arr_10_fu_126;

assign add59_397_out = arr_11_fu_130;

assign add59_498_out = arr_12_fu_134;

assign add59_599_out = arr_13_fu_138;

assign add59_6100_out = arr_14_fu_142;

assign add59_7101_out = arr_15_fu_146;

assign add59_8102_out = arr_16_fu_150;

assign add59_9103_out = arr_17_fu_154;
...
assign add_ln49_6_fu_778_p2 = (ap_sig_allocacmp_i1_3 + 4'd6);
