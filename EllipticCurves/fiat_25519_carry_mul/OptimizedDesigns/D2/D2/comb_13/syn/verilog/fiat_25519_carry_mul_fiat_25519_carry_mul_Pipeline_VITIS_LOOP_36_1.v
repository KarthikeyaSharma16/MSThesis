...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add59_1_467_out,
        add59_1_467_out_ap_vld,
        add59_1_366_out,
        add59_1_366_out_ap_vld,
        add59_1_265_out,
        add59_1_265_out_ap_vld,
        add59_1_164_out,
        add59_1_164_out_ap_vld,
        add59_163_out,
        add59_163_out_ap_vld,
        add59_462_out,
        add59_462_out_ap_vld,
        add59_361_out,
        add59_361_out_ap_vld,
        add59_260_out,
        add59_260_out_ap_vld,
        add59_14659_out,
...
output  [63:0] add59_1_467_out;
output   add59_1_467_out_ap_vld;
output  [63:0] add59_1_366_out;
output   add59_1_366_out_ap_vld;
output  [63:0] add59_1_265_out;
output   add59_1_265_out_ap_vld;
output  [63:0] add59_1_164_out;
output   add59_1_164_out_ap_vld;
output  [63:0] add59_163_out;
output   add59_163_out_ap_vld;
output  [63:0] add59_462_out;
output   add59_462_out_ap_vld;
output  [63:0] add59_361_out;
output   add59_361_out_ap_vld;
output  [63:0] add59_260_out;
output   add59_260_out_ap_vld;
output  [63:0] add59_14659_out;
output   add59_14659_out_ap_vld;

reg ap_idle;
reg add59_1_467_out_ap_vld;
reg add59_1_366_out_ap_vld;
reg add59_1_265_out_ap_vld;
reg add59_1_164_out_ap_vld;
reg add59_163_out_ap_vld;
reg add59_462_out_ap_vld;
reg add59_361_out_ap_vld;
reg add59_260_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_163_out_ap_vld = 1'b1;
    end else begin
        add59_163_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_164_out_ap_vld = 1'b1;
    end else begin
        add59_1_164_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_265_out_ap_vld = 1'b1;
    end else begin
        add59_1_265_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_366_out_ap_vld = 1'b1;
    end else begin
        add59_1_366_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_467_out_ap_vld = 1'b1;
    end else begin
        add59_1_467_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_260_out_ap_vld = 1'b1;
    end else begin
        add59_260_out_ap_vld = 1'b0;
    end
end
...
assign add59_163_out = arr_13_fu_138;

assign add59_1_164_out = arr_14_fu_142;

assign add59_1_265_out = arr_15_fu_146;

assign add59_1_366_out = arr_16_fu_150;

assign add59_1_467_out = arr_17_fu_154;

assign add59_260_out = arr_10_fu_126;
...
assign empty_24_fu_718_p2 = (ap_sig_allocacmp_i1_2 + 4'd5);
...
assign icmp_ln48_2_fu_724_p2 = ((empty_24_fu_718_p2 > 4'd9) ? 1'b1 : 1'b0);
