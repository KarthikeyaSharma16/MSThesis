...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_reload,
        add59_1_4160_out,
        add59_1_4160_out_ap_vld,
        add59_1_3159_out,
        add59_1_3159_out_ap_vld,
        add59_1_268158_out,
        add59_1_268158_out_ap_vld,
        add59_1_148157_out,
        add59_1_148157_out_ap_vld,
        add59_1156_out,
        add59_1156_out_ap_vld,
        add59_4155_out,
        add59_4155_out_ap_vld,
        add59_3154_out,
        add59_3154_out_ap_vld,
        add59_2139153_out,
        add59_2139153_out_ap_vld,
        add59_1121152_out,
        add59_1121152_out_ap_vld
);
...
output  [63:0] add59_1_4160_out;
output   add59_1_4160_out_ap_vld;
output  [63:0] add59_1_3159_out;
output   add59_1_3159_out_ap_vld;
output  [63:0] add59_1_268158_out;
output   add59_1_268158_out_ap_vld;
output  [63:0] add59_1_148157_out;
output   add59_1_148157_out_ap_vld;
output  [63:0] add59_1156_out;
output   add59_1156_out_ap_vld;
output  [63:0] add59_4155_out;
output   add59_4155_out_ap_vld;
output  [63:0] add59_3154_out;
output   add59_3154_out_ap_vld;
output  [63:0] add59_2139153_out;
output   add59_2139153_out_ap_vld;
output  [63:0] add59_1121152_out;
output   add59_1121152_out_ap_vld;

reg ap_idle;
reg add59_1_4160_out_ap_vld;
reg add59_1_3159_out_ap_vld;
reg add59_1_268158_out_ap_vld;
reg add59_1_148157_out_ap_vld;
reg add59_1156_out_ap_vld;
reg add59_4155_out_ap_vld;
reg add59_3154_out_ap_vld;
reg add59_2139153_out_ap_vld;
reg add59_1121152_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1121152_out_ap_vld = 1'b1;
    end else begin
        add59_1121152_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_148157_out_ap_vld = 1'b1;
    end else begin
        add59_1_148157_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_268158_out_ap_vld = 1'b1;
    end else begin
        add59_1_268158_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_3159_out_ap_vld = 1'b1;
    end else begin
        add59_1_3159_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_4160_out_ap_vld = 1'b1;
    end else begin
        add59_1_4160_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2139153_out_ap_vld = 1'b1;
    end else begin
        add59_2139153_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3154_out_ap_vld = 1'b1;
    end else begin
        add59_3154_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4155_out_ap_vld = 1'b1;
    end else begin
        add59_4155_out_ap_vld = 1'b0;
    end
end
...
assign add59_1121152_out = arr_9_fu_122;

assign add59_1156_out = arr_13_fu_138;

assign add59_1_148157_out = arr_14_fu_142;

assign add59_1_268158_out = arr_15_fu_146;

assign add59_1_3159_out = arr_16_fu_150;

assign add59_1_4160_out = arr_17_fu_154;

assign add59_2139153_out = arr_10_fu_126;

assign add59_3154_out = arr_11_fu_130;

assign add59_4155_out = arr_12_fu_134;
...
assign and_ln48_1_fu_669_p2 = (icmp_ln49_fu_635_p2 & cmp32_171_fu_641_p2);
...
assign and_ln48_4_fu_964_p2 = (icmp_ln49_2_fu_807_p2 & cmp32_171_fu_641_p2);

assign and_ln48_5_fu_979_p2 = (icmp_ln49_3_fu_914_p2 & cmp32_171_fu_641_p2);
...
assign cmp32_171_fu_641_p2 = (empty_fu_576_p1 ^ 1'd1);
