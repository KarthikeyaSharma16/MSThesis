...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        add59_1_4160_reload,
        add59_1_3159_reload,
        add59_1_268158_reload,
        add59_1_148157_reload,
        add59_1156_reload,
        add59_4155_reload,
        add59_3154_reload,
        add59_2139153_reload,
        add59_1121152_reload,
        arg1_r_reload,
        arg1_r_1_reload,
        arg1_r_2_reload,
        arg1_r_3_reload,
        ...
        arg2_r_9_reload,
        add129_1_4150_out,
        add129_1_4150_out_ap_vld,
        add129_1_3149_out,
        add129_1_3149_out_ap_vld,
        add129_1_2148_out,
        add129_1_2148_out_ap_vld,
        add129_1_1147_out,
        add129_1_1147_out_ap_vld,
        add129_1146_out,
        add129_1146_out_ap_vld,
        add129_4145_out,
        add129_4145_out_ap_vld,
        add129_3144_out,
        add129_3144_out_ap_vld,
        add129_2143_out,
        add129_2143_out_ap_vld,
        add129_128142_out,
        add129_128142_out_ap_vld,
        add129141_out,
        add129141_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add59_1_4160_reload;
input  [63:0] add59_1_3159_reload;
input  [63:0] add59_1_268158_reload;
input  [63:0] add59_1_148157_reload;
input  [63:0] add59_1156_reload;
input  [63:0] add59_4155_reload;
input  [63:0] add59_3154_reload;
input  [63:0] add59_2139153_reload;
input  [63:0] add59_1121152_reload;
...
output  [63:0] add129_1_4150_out;
output   add129_1_4150_out_ap_vld;
output  [63:0] add129_1_3149_out;
output   add129_1_3149_out_ap_vld;
output  [63:0] add129_1_2148_out;
output   add129_1_2148_out_ap_vld;
output  [63:0] add129_1_1147_out;
output   add129_1_1147_out_ap_vld;
output  [63:0] add129_1146_out;
output   add129_1146_out_ap_vld;
output  [63:0] add129_4145_out;
output   add129_4145_out_ap_vld;
output  [63:0] add129_3144_out;
output   add129_3144_out_ap_vld;
output  [63:0] add129_2143_out;
output   add129_2143_out_ap_vld;
output  [63:0] add129_128142_out;
output   add129_128142_out_ap_vld;
output  [63:0] add129141_out;
output   add129141_out_ap_vld;

reg ap_idle;
reg add129_1_4150_out_ap_vld;
reg add129_1_3149_out_ap_vld;
reg add129_1_2148_out_ap_vld;
reg add129_1_1147_out_ap_vld;
reg add129_1146_out_ap_vld;
reg add129_4145_out_ap_vld;
reg add129_3144_out_ap_vld;
reg add129_2143_out_ap_vld;
reg add129_128142_out_ap_vld;
reg add129141_out_ap_vld;
...
reg   [63:0] add129141_fu_158;
wire   [63:0] add_ln68_fu_659_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add129_128142_fu_162;
wire   [63:0] add_ln68_1_fu_731_p2;
reg   [63:0] add129_2143_fu_166;
wire   [63:0] add_ln68_3_fu_788_p2;
reg   [63:0] add129_3144_fu_170;
wire   [63:0] add_ln68_4_fu_864_p2;
reg   [63:0] add129_4145_fu_174;
wire   [63:0] add_ln68_6_fu_919_p2;
reg   [63:0] add129_1146_fu_178;
wire   [63:0] add_ln68_7_fu_993_p2;
reg   [63:0] add129_1_1147_fu_182;
wire   [63:0] add_ln68_9_fu_1046_p2;
reg   [63:0] add129_1_2148_fu_186;
wire   [63:0] add_ln68_10_fu_1131_p2;
reg   [63:0] add129_1_3149_fu_190;
wire   [63:0] add_ln68_12_fu_1196_p2;
reg   [63:0] add129_1_4150_fu_194;
...
wire   [31:0] tmp_2_fu_602_p12;
wire   [3:0] tmp_s_fu_638_p11;
wire   [31:0] tmp_s_fu_638_p12;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1146_fu_178 <= add59_1156_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_1146_fu_178 <= add_ln68_7_fu_993_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_128142_fu_162 <= add59_1121152_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_128142_fu_162 <= add_ln68_1_fu_731_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1_1147_fu_182 <= add59_1_148157_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_1_1147_fu_182 <= add_ln68_9_fu_1046_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1_2148_fu_186 <= add59_1_268158_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_1_2148_fu_186 <= add_ln68_10_fu_1131_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1_3149_fu_190 <= add59_1_3159_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_1_3149_fu_190 <= add_ln68_12_fu_1196_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1_4150_fu_194 <= add59_1_4160_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_1_4150_fu_194 <= add_ln68_13_fu_1281_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_2143_fu_166 <= add59_2139153_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_2143_fu_166 <= add_ln68_3_fu_788_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_3144_fu_170 <= add59_3154_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_3144_fu_170 <= add_ln68_4_fu_864_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_4145_fu_174 <= add59_4155_reload;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_4145_fu_174 <= add_ln68_6_fu_919_p2;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129141_out_ap_vld = 1'b1;
    end else begin
        add129141_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_128142_out_ap_vld = 1'b1;
    end else begin
        add129_128142_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_1147_out_ap_vld = 1'b1;
    end else begin
        add129_1_1147_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_2148_out_ap_vld = 1'b1;
    end else begin
        add129_1_2148_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_3149_out_ap_vld = 1'b1;
    end else begin
        add129_1_3149_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_4150_out_ap_vld = 1'b1;
    end else begin
        add129_1_4150_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_2143_out_ap_vld = 1'b1;
    end else begin
        add129_2143_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_3144_out_ap_vld = 1'b1;
    end else begin
        add129_3144_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_4145_out_ap_vld = 1'b1;
    end else begin
        add129_4145_out_ap_vld = 1'b0;
    end
end
...
assign add129141_out = add129141_fu_158;

assign add129_1146_out = add129_1146_fu_178;

assign add129_128142_out = add129_128142_fu_162;

assign add129_1_1147_out = add129_1_1147_fu_182;

assign add129_1_2148_out = add129_1_2148_fu_186;

assign add129_1_3149_out = add129_1_3149_fu_190;

assign add129_1_4150_out = add129_1_4150_fu_194;

assign add129_2143_out = add129_2143_fu_166;

assign add129_3144_out = add129_3144_fu_170;

assign add129_4145_out = add129_4145_fu_174;
...
assign add_ln68_10_fu_1131_p2 = (and_ln68_6_fu_1125_p2 + add129_1_2148_fu_186);

assign add_ln68_11_fu_1137_p2 = (zext_ln67_fu_586_p1 + 5'd8);

assign add_ln68_12_fu_1196_p2 = (and_ln68_7_fu_1190_p2 + add129_1_3149_fu_190);

assign add_ln68_13_fu_1281_p2 = (and_ln68_8_fu_1275_p2 + add129_1_4150_fu_194);

assign add_ln68_1_fu_731_p2 = (and_ln68_fu_725_p2 + add129_128142_fu_162);

assign add_ln68_2_fu_737_p2 = (i1_fu_198 + 4'd2);

assign add_ln68_3_fu_788_p2 = (and_ln68_1_fu_782_p2 + add129_2143_fu_166);

assign add_ln68_4_fu_864_p2 = (and_ln68_2_fu_858_p2 + add129_3144_fu_170);

assign add_ln68_5_fu_870_p2 = (i1_fu_198 + 4'd4);

assign add_ln68_6_fu_919_p2 = (and_ln68_3_fu_913_p2 + add129_4145_fu_174);

assign add_ln68_7_fu_993_p2 = (and_ln68_4_fu_987_p2 + add129_1146_fu_178);

assign add_ln68_8_fu_999_p2 = (i1_fu_198 + 4'd6);

assign add_ln68_9_fu_1046_p2 = (and_ln68_5_fu_1040_p2 + add129_1_1147_fu_182);

assign add_ln68_fu_659_p2 = (mul_ln68_fu_446_p2 + add129141_fu_158);
...
assign mul_ln68_fu_446_p00 = tmp_s_fu_638_p12;
...
assign tmp_s_fu_638_p11 = ($signed(4'd9) - $signed(i1_fu_198));
...
assign zext_ln68_fu_618_p1 = tmp_2_fu_602_p12;
