...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add59_4_167_out,
        add59_4_167_out_ap_vld,
        add59_466_out,
        add59_466_out_ap_vld,
        add59_3_165_out,
        add59_3_165_out_ap_vld,
        add59_364_out,
        add59_364_out_ap_vld,
        add59_2_163_out,
        add59_2_163_out_ap_vld,
        add59_262_out,
        add59_262_out_ap_vld,
        add59_1_161_out,
        add59_1_161_out_ap_vld,
        add59_160_out,
        add59_160_out_ap_vld,
        add59_14659_out,
        add59_14659_out_ap_vld
);
...
output  [63:0] add59_4_167_out;
output   add59_4_167_out_ap_vld;
output  [63:0] add59_466_out;
output   add59_466_out_ap_vld;
output  [63:0] add59_3_165_out;
output   add59_3_165_out_ap_vld;
output  [63:0] add59_364_out;
output   add59_364_out_ap_vld;
output  [63:0] add59_2_163_out;
output   add59_2_163_out_ap_vld;
output  [63:0] add59_262_out;
output   add59_262_out_ap_vld;
output  [63:0] add59_1_161_out;
output   add59_1_161_out_ap_vld;
output  [63:0] add59_160_out;
output   add59_160_out_ap_vld;
output  [63:0] add59_14659_out;
output   add59_14659_out_ap_vld;

reg ap_idle;
reg add59_4_167_out_ap_vld;
reg add59_466_out_ap_vld;
reg add59_3_165_out_ap_vld;
reg add59_364_out_ap_vld;
reg add59_2_163_out_ap_vld;
reg add59_262_out_ap_vld;
reg add59_1_161_out_ap_vld;
reg add59_160_out_ap_vld;
reg add59_14659_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_14659_out_ap_vld = 1'b1;
    end else begin
        add59_14659_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_160_out_ap_vld = 1'b1;
    end else begin
        add59_160_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_161_out_ap_vld = 1'b1;
    end else begin
        add59_1_161_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_262_out_ap_vld = 1'b1;
    end else begin
        add59_262_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2_163_out_ap_vld = 1'b1;
    end else begin
        add59_2_163_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_364_out_ap_vld = 1'b1;
    end else begin
        add59_364_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3_165_out_ap_vld = 1'b1;
    end else begin
        add59_3_165_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_466_out_ap_vld = 1'b1;
    end else begin
        add59_466_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4_167_out_ap_vld = 1'b1;
    end else begin
        add59_4_167_out_ap_vld = 1'b0;
    end
end
...
assign add59_14659_out = arr_9_fu_122;

assign add59_160_out = arr_10_fu_126;

assign add59_1_161_out = arr_11_fu_130;

assign add59_262_out = arr_12_fu_134;

assign add59_2_163_out = arr_13_fu_138;

assign add59_364_out = arr_14_fu_142;

assign add59_3_165_out = arr_15_fu_146;

assign add59_466_out = arr_16_fu_150;

assign add59_4_167_out = arr_17_fu_154;
...
assign empty_27_fu_568_p2 = (ap_sig_allocacmp_i1_2 + 4'd2);

assign empty_28_fu_673_p2 = (ap_sig_allocacmp_i1_2 + 4'd4);

assign empty_29_fu_778_p2 = (ap_sig_allocacmp_i1_2 + 4'd6);

assign empty_30_fu_883_p2 = (zext_ln36_fu_474_p1 + 5'd8);
...
assign icmp_ln49_2_fu_817_p2 = ((empty_29_fu_778_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_922_p2 = ((empty_30_fu_883_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_fu_607_p2 = ((empty_27_fu_568_p2 > 4'd9) ? 1'b1 : 1'b0);
