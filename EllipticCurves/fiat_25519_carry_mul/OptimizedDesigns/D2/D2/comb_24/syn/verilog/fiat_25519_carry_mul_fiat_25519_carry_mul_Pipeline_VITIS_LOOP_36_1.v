...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add59_4_1163_out,
        add59_4_1163_out_ap_vld,
        add59_4162_out,
        add59_4162_out_ap_vld,
        add59_3_1161_out,
        add59_3_1161_out_ap_vld,
        add59_3160_out,
        add59_3160_out_ap_vld,
        add59_2_1159_out,
        add59_2_1159_out_ap_vld,
        add59_2158_out,
        add59_2158_out_ap_vld,
        add59_1_1157_out,
        add59_1_1157_out_ap_vld,
        add59_1156_out,
        add59_1156_out_ap_vld,
        add59_1142155_out,
        add59_1142155_out_ap_vld
);
...
output  [63:0] add59_4_1163_out;
output   add59_4_1163_out_ap_vld;
output  [63:0] add59_4162_out;
output   add59_4162_out_ap_vld;
output  [63:0] add59_3_1161_out;
output   add59_3_1161_out_ap_vld;
output  [63:0] add59_3160_out;
output   add59_3160_out_ap_vld;
output  [63:0] add59_2_1159_out;
output   add59_2_1159_out_ap_vld;
output  [63:0] add59_2158_out;
output   add59_2158_out_ap_vld;
output  [63:0] add59_1_1157_out;
output   add59_1_1157_out_ap_vld;
output  [63:0] add59_1156_out;
output   add59_1156_out_ap_vld;
output  [63:0] add59_1142155_out;
output   add59_1142155_out_ap_vld;

reg ap_idle;
reg add59_4_1163_out_ap_vld;
reg add59_4162_out_ap_vld;
reg add59_3_1161_out_ap_vld;
reg add59_3160_out_ap_vld;
reg add59_2_1159_out_ap_vld;
reg add59_2158_out_ap_vld;
reg add59_1_1157_out_ap_vld;
reg add59_1156_out_ap_vld;
reg add59_1142155_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1142155_out_ap_vld = 1'b1;
    end else begin
        add59_1142155_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1156_out_ap_vld = 1'b1;
    end else begin
        add59_1156_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_1157_out_ap_vld = 1'b1;
    end else begin
        add59_1_1157_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2158_out_ap_vld = 1'b1;
    end else begin
        add59_2158_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2_1159_out_ap_vld = 1'b1;
    end else begin
        add59_2_1159_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3160_out_ap_vld = 1'b1;
    end else begin
        add59_3160_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3_1161_out_ap_vld = 1'b1;
    end else begin
        add59_3_1161_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4162_out_ap_vld = 1'b1;
    end else begin
        add59_4162_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4_1163_out_ap_vld = 1'b1;
    end else begin
        add59_4_1163_out_ap_vld = 1'b0;
    end
end
...
assign add59_1142155_out = arr_9_fu_122;

assign add59_1156_out = arr_10_fu_126;

assign add59_1_1157_out = arr_11_fu_130;

assign add59_2158_out = arr_12_fu_134;

assign add59_2_1159_out = arr_13_fu_138;

assign add59_3160_out = arr_14_fu_142;

assign add59_3_1161_out = arr_15_fu_146;

assign add59_4162_out = arr_16_fu_150;

assign add59_4_1163_out = arr_17_fu_154;

assign add_ln48_1_fu_613_p2 = (ap_sig_allocacmp_i1_2 + 4'd3);

assign add_ln48_2_fu_718_p2 = (ap_sig_allocacmp_i1_2 + 4'd5);
...
assign empty_23_fu_568_p2 = (ap_sig_allocacmp_i1_2 + 4'd2);

assign empty_24_fu_673_p2 = (ap_sig_allocacmp_i1_2 + 4'd4);

assign empty_25_fu_778_p2 = (ap_sig_allocacmp_i1_2 + 4'd6);

assign empty_26_fu_883_p2 = (zext_ln36_fu_474_p1 + 5'd8);
...
assign icmp_ln49_1_fu_712_p2 = ((empty_24_fu_673_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_2_fu_817_p2 = ((empty_25_fu_778_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_922_p2 = ((empty_26_fu_883_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_fu_607_p2 = ((empty_23_fu_568_p2 > 4'd9) ? 1'b1 : 1'b0);
