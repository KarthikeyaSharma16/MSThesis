...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_9210_out \
    op interface \
    ports { add59_9210_out { O 64 vector } add59_9210_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_8209_out \
    op interface \
    ports { add59_8209_out { O 64 vector } add59_8209_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_7208_out \
    op interface \
    ports { add59_7208_out { O 64 vector } add59_7208_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_6207_out \
    op interface \
    ports { add59_6207_out { O 64 vector } add59_6207_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_5206_out \
    op interface \
    ports { add59_5206_out { O 64 vector } add59_5206_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_4205_out \
    op interface \
    ports { add59_4205_out { O 64 vector } add59_4205_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_3204_out \
    op interface \
    ports { add59_3204_out { O 64 vector } add59_3204_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_2203_out \
    op interface \
    ports { add59_2203_out { O 64 vector } add59_2203_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_1202_out \
    op interface \
    ports { add59_1202_out { O 64 vector } add59_1202_out_ap_vld { O 1 bit } } \
} "
}
