...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add59_952_out,
        add59_952_out_ap_vld,
        add59_851_out,
        add59_851_out_ap_vld,
        add59_750_out,
        add59_750_out_ap_vld,
        add59_649_out,
        add59_649_out_ap_vld,
        add59_548_out,
        add59_548_out_ap_vld,
        add59_447_out,
        add59_447_out_ap_vld,
        add59_346_out,
        add59_346_out_ap_vld,
        add59_245_out,
        add59_245_out_ap_vld,
        add59_144_out,
        add59_144_out_ap_vld
);
...
output  [63:0] add59_952_out;
output   add59_952_out_ap_vld;
output  [63:0] add59_851_out;
output   add59_851_out_ap_vld;
output  [63:0] add59_750_out;
output   add59_750_out_ap_vld;
output  [63:0] add59_649_out;
output   add59_649_out_ap_vld;
output  [63:0] add59_548_out;
output   add59_548_out_ap_vld;
output  [63:0] add59_447_out;
output   add59_447_out_ap_vld;
output  [63:0] add59_346_out;
output   add59_346_out_ap_vld;
output  [63:0] add59_245_out;
output   add59_245_out_ap_vld;
output  [63:0] add59_144_out;
output   add59_144_out_ap_vld;

reg ap_idle;
reg add59_952_out_ap_vld;
reg add59_851_out_ap_vld;
reg add59_750_out_ap_vld;
reg add59_649_out_ap_vld;
reg add59_548_out_ap_vld;
reg add59_447_out_ap_vld;
reg add59_346_out_ap_vld;
reg add59_245_out_ap_vld;
reg add59_144_out_ap_vld;
...
reg   [3:0] i1_fu_158;
wire   [3:0] indvars_iv_next74_fu_482_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln36_fu_468_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i1_fu_158 <= indvars_iv_next74_fu_482_p2;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_144_out_ap_vld = 1'b1;
    end else begin
        add59_144_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_245_out_ap_vld = 1'b1;
    end else begin
        add59_245_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_346_out_ap_vld = 1'b1;
    end else begin
        add59_346_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_447_out_ap_vld = 1'b1;
    end else begin
        add59_447_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_548_out_ap_vld = 1'b1;
    end else begin
        add59_548_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_649_out_ap_vld = 1'b1;
    end else begin
        add59_649_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_750_out_ap_vld = 1'b1;
    end else begin
        add59_750_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_851_out_ap_vld = 1'b1;
    end else begin
        add59_851_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_952_out_ap_vld = 1'b1;
    end else begin
        add59_952_out_ap_vld = 1'b0;
    end
end
...
assign add59_144_out = arr_9_fu_122;

assign add59_245_out = arr_10_fu_126;

assign add59_346_out = arr_11_fu_130;

assign add59_447_out = arr_12_fu_134;

assign add59_548_out = arr_13_fu_138;

assign add59_649_out = arr_14_fu_142;

assign add59_750_out = arr_15_fu_146;

assign add59_851_out = arr_16_fu_150;

assign add59_952_out = arr_17_fu_154;
...
assign empty_29_fu_568_p2 = (ap_sig_allocacmp_i1_2 + 4'd2);

assign empty_30_fu_613_p2 = (ap_sig_allocacmp_i1_2 + 4'd3);

assign empty_31_fu_673_p2 = (ap_sig_allocacmp_i1_2 + 4'd4);

assign empty_32_fu_718_p2 = (ap_sig_allocacmp_i1_2 + 4'd5);

assign empty_33_fu_778_p2 = (ap_sig_allocacmp_i1_2 + 4'd6);

assign empty_34_fu_823_p2 = (zext_ln36_fu_474_p1 + 5'd7);

assign empty_35_fu_883_p2 = (zext_ln36_fu_474_p1 + 5'd8);

assign empty_fu_478_p1 = ap_sig_allocacmp_i1_2[0:0];

assign icmp_ln36_fu_468_p2 = ((ap_sig_allocacmp_i1_2 == 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln48_1_fu_619_p2 = ((empty_30_fu_613_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln48_2_fu_724_p2 = ((empty_32_fu_718_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln48_3_fu_829_p2 = ((empty_34_fu_823_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln48_fu_488_p2 = ((indvars_iv_next74_fu_482_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_1_fu_712_p2 = ((empty_31_fu_673_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_2_fu_817_p2 = ((empty_33_fu_778_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_922_p2 = ((empty_35_fu_883_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_fu_607_p2 = ((empty_29_fu_568_p2 > 4'd9) ? 1'b1 : 1'b0);

assign indvars_iv_next74_fu_482_p2 = (ap_sig_allocacmp_i1_2 + 4'd1);
...
assign tmp_6_fu_790_p11 = ($signed(4'd13) - $signed(ap_sig_allocacmp_i1_2));

assign tmp_7_fu_856_p11 = ($signed(4'd12) - $signed(ap_sig_allocacmp_i1_2));

assign tmp_8_fu_895_p11 = ($signed(4'd11) - $signed(ap_sig_allocacmp_i1_2));
