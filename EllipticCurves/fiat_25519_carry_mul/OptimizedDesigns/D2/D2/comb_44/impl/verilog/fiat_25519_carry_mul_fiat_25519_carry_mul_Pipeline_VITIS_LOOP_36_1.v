...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add59_4_1243_out,
        add59_4_1243_out_ap_vld,
        add59_4242_out,
        add59_4242_out_ap_vld,
        add59_3_1241_out,
        add59_3_1241_out_ap_vld,
        add59_3240_out,
        add59_3240_out_ap_vld,
        add59_2_1239_out,
        add59_2_1239_out_ap_vld,
        add59_2238_out,
        add59_2238_out_ap_vld,
        add59_1_1237_out,
        add59_1_1237_out_ap_vld,
        add59_1236_out,
        add59_1236_out_ap_vld,
        add59_1222235_out,
        add59_1222235_out_ap_vld
);
...
output  [63:0] add59_4_1243_out;
output   add59_4_1243_out_ap_vld;
output  [63:0] add59_4242_out;
output   add59_4242_out_ap_vld;
output  [63:0] add59_3_1241_out;
output   add59_3_1241_out_ap_vld;
output  [63:0] add59_3240_out;
output   add59_3240_out_ap_vld;
output  [63:0] add59_2_1239_out;
output   add59_2_1239_out_ap_vld;
output  [63:0] add59_2238_out;
output   add59_2238_out_ap_vld;
output  [63:0] add59_1_1237_out;
output   add59_1_1237_out_ap_vld;
output  [63:0] add59_1236_out;
output   add59_1236_out_ap_vld;
output  [63:0] add59_1222235_out;
output   add59_1222235_out_ap_vld;

reg ap_idle;
reg add59_4_1243_out_ap_vld;
reg add59_4242_out_ap_vld;
reg add59_3_1241_out_ap_vld;
reg add59_3240_out_ap_vld;
reg add59_2_1239_out_ap_vld;
reg add59_2238_out_ap_vld;
reg add59_1_1237_out_ap_vld;
reg add59_1236_out_ap_vld;
reg add59_1222235_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1222235_out_ap_vld = 1'b1;
    end else begin
        add59_1222235_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1236_out_ap_vld = 1'b1;
    end else begin
        add59_1236_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_1237_out_ap_vld = 1'b1;
    end else begin
        add59_1_1237_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2238_out_ap_vld = 1'b1;
    end else begin
        add59_2238_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2_1239_out_ap_vld = 1'b1;
    end else begin
        add59_2_1239_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3240_out_ap_vld = 1'b1;
    end else begin
        add59_3240_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3_1241_out_ap_vld = 1'b1;
    end else begin
        add59_3_1241_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4242_out_ap_vld = 1'b1;
    end else begin
        add59_4242_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4_1243_out_ap_vld = 1'b1;
    end else begin
        add59_4_1243_out_ap_vld = 1'b0;
    end
end
...
assign add59_1222235_out = arr_9_fu_122;

assign add59_1236_out = arr_10_fu_126;

assign add59_1_1237_out = arr_11_fu_130;

assign add59_2238_out = arr_12_fu_134;

assign add59_2_1239_out = arr_13_fu_138;

assign add59_3240_out = arr_14_fu_142;

assign add59_3_1241_out = arr_15_fu_146;

assign add59_4242_out = arr_16_fu_150;

assign add59_4_1243_out = arr_17_fu_154;

assign add_ln48_1_fu_613_p2 = (ap_sig_allocacmp_i1_3 + 4'd3);

assign add_ln48_2_fu_718_p2 = (ap_sig_allocacmp_i1_3 + 4'd5);

assign add_ln48_3_fu_823_p2 = (zext_ln36_fu_474_p1 + 5'd7);

assign add_ln48_fu_482_p2 = (ap_sig_allocacmp_i1_3 + 4'd1);
...
assign empty_23_fu_568_p2 = (ap_sig_allocacmp_i1_3 + 4'd2);

assign empty_24_fu_673_p2 = (ap_sig_allocacmp_i1_3 + 4'd4);

assign empty_25_fu_778_p2 = (ap_sig_allocacmp_i1_3 + 4'd6);

assign empty_26_fu_883_p2 = (zext_ln36_fu_474_p1 + 5'd8);

assign empty_fu_478_p1 = ap_sig_allocacmp_i1_3[0:0];

assign icmp_ln36_fu_468_p2 = ((ap_sig_allocacmp_i1_3 == 4'd10) ? 1'b1 : 1'b0);
...
assign tmp_1_fu_541_p11 = (4'd2 - ap_sig_allocacmp_i1_3);

assign tmp_2_fu_580_p11 = (4'd1 - ap_sig_allocacmp_i1_3);

assign tmp_3_fu_646_p11 = (4'd0 - ap_sig_allocacmp_i1_3);

assign tmp_4_fu_685_p11 = (ap_sig_allocacmp_i1_3 ^ 4'd15);

assign tmp_5_fu_751_p11 = ($signed(4'd14) - $signed(ap_sig_allocacmp_i1_3));

assign tmp_6_fu_790_p11 = ($signed(4'd13) - $signed(ap_sig_allocacmp_i1_3));

assign tmp_7_fu_856_p11 = ($signed(4'd12) - $signed(ap_sig_allocacmp_i1_3));

assign tmp_8_fu_895_p11 = ($signed(4'd11) - $signed(ap_sig_allocacmp_i1_3));

assign tmp_9_fu_943_p11 = ($signed(4'd10) - $signed(ap_sig_allocacmp_i1_3));

assign zext_ln36_fu_474_p1 = ap_sig_allocacmp_i1_3;
