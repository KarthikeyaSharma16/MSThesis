...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg1_r_9_reload,
        add129_1_4108_out,
        add129_1_4108_out_ap_vld,
        add129_1_3107_out,
        add129_1_3107_out_ap_vld,
        add129_1_2106_out,
        add129_1_2106_out_ap_vld,
        add129_1_128105_out,
        add129_1_128105_out_ap_vld,
        add129_1104_out,
        add129_1104_out_ap_vld,
        add129_4103_out,
        add129_4103_out_ap_vld,
        add129_3102_out,
        add129_3102_out_ap_vld,
        add129_2101_out,
        add129_2101_out_ap_vld,
        add129_179100_out,
        add129_179100_out_ap_vld,
        add12999_out,
        add12999_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add59_1_4118_reload;
input  [63:0] add59_1_3117_reload;
input  [63:0] add59_1_2116_reload;
input  [63:0] add59_1_1115_reload;
input  [63:0] add59_1114_reload;
input  [63:0] add59_4113_reload;
input  [63:0] add59_3112_reload;
input  [63:0] add59_2111_reload;
input  [63:0] add59_197110_reload;
...
output  [63:0] add129_1_4108_out;
output   add129_1_4108_out_ap_vld;
output  [63:0] add129_1_3107_out;
output   add129_1_3107_out_ap_vld;
output  [63:0] add129_1_2106_out;
output   add129_1_2106_out_ap_vld;
output  [63:0] add129_1_128105_out;
output   add129_1_128105_out_ap_vld;
output  [63:0] add129_1104_out;
output   add129_1104_out_ap_vld;
output  [63:0] add129_4103_out;
output   add129_4103_out_ap_vld;
output  [63:0] add129_3102_out;
output   add129_3102_out_ap_vld;
output  [63:0] add129_2101_out;
output   add129_2101_out_ap_vld;
output  [63:0] add129_179100_out;
output   add129_179100_out_ap_vld;
output  [63:0] add12999_out;
output   add12999_out_ap_vld;

reg ap_idle;
reg add129_1_4108_out_ap_vld;
reg add129_1_3107_out_ap_vld;
reg add129_1_2106_out_ap_vld;
reg add129_1_128105_out_ap_vld;
reg add129_1104_out_ap_vld;
reg add129_4103_out_ap_vld;
reg add129_3102_out_ap_vld;
reg add129_2101_out_ap_vld;
reg add129_179100_out_ap_vld;
reg add12999_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add12999_out_ap_vld = 1'b1;
    end else begin
        add12999_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1104_out_ap_vld = 1'b1;
    end else begin
        add129_1104_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_179100_out_ap_vld = 1'b1;
    end else begin
        add129_179100_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_128105_out_ap_vld = 1'b1;
    end else begin
        add129_1_128105_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_2106_out_ap_vld = 1'b1;
    end else begin
        add129_1_2106_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_3107_out_ap_vld = 1'b1;
    end else begin
        add129_1_3107_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_4108_out_ap_vld = 1'b1;
    end else begin
        add129_1_4108_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_2101_out_ap_vld = 1'b1;
    end else begin
        add129_2101_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_3102_out_ap_vld = 1'b1;
    end else begin
        add129_3102_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_4103_out_ap_vld = 1'b1;
    end else begin
        add129_4103_out_ap_vld = 1'b0;
    end
end
...
assign add12999_out = add12999_fu_160;

assign add129_1104_out = add129_1104_fu_180;

assign add129_179100_out = add129_179100_fu_164;

assign add129_1_128105_out = add129_1_128105_fu_184;

assign add129_1_2106_out = add129_1_2106_fu_188;

assign add129_1_3107_out = add129_1_3107_fu_192;

assign add129_1_4108_out = add129_1_4108_fu_196;

assign add129_2101_out = add129_2101_fu_168;

assign add129_3102_out = add129_3102_fu_172;

assign add129_4103_out = add129_4103_fu_176;

assign add_ln68_10_fu_1011_p2 = (add129_3102_fu_172 + add_ln68_9_fu_1005_p2);

assign add_ln68_11_fu_1017_p2 = (i1_fu_200 + 4'd5);

assign add_ln68_12_fu_1074_p2 = (and_ln68_6_fu_1068_p2 + and_ln68_5_fu_1054_p2);

assign add_ln68_13_fu_1080_p2 = (add129_4103_fu_176 + add_ln68_12_fu_1074_p2);
