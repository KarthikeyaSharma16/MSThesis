...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add59_1_4118_out,
        add59_1_4118_out_ap_vld,
        add59_1_3117_out,
        add59_1_3117_out_ap_vld,
        add59_1_2116_out,
        add59_1_2116_out_ap_vld,
        add59_1_1115_out,
        add59_1_1115_out_ap_vld,
        add59_1114_out,
        add59_1114_out_ap_vld,
        add59_4113_out,
        add59_4113_out_ap_vld,
        add59_3112_out,
        add59_3112_out_ap_vld,
        add59_2111_out,
        add59_2111_out_ap_vld,
        add59_197110_out,
        add59_197110_out_ap_vld
);
...
output  [63:0] add59_1_4118_out;
output   add59_1_4118_out_ap_vld;
output  [63:0] add59_1_3117_out;
output   add59_1_3117_out_ap_vld;
output  [63:0] add59_1_2116_out;
output   add59_1_2116_out_ap_vld;
output  [63:0] add59_1_1115_out;
output   add59_1_1115_out_ap_vld;
output  [63:0] add59_1114_out;
output   add59_1114_out_ap_vld;
output  [63:0] add59_4113_out;
output   add59_4113_out_ap_vld;
output  [63:0] add59_3112_out;
output   add59_3112_out_ap_vld;
output  [63:0] add59_2111_out;
output   add59_2111_out_ap_vld;
output  [63:0] add59_197110_out;
output   add59_197110_out_ap_vld;

reg ap_idle;
reg add59_1_4118_out_ap_vld;
reg add59_1_3117_out_ap_vld;
reg add59_1_2116_out_ap_vld;
reg add59_1_1115_out_ap_vld;
reg add59_1114_out_ap_vld;
reg add59_4113_out_ap_vld;
reg add59_3112_out_ap_vld;
reg add59_2111_out_ap_vld;
reg add59_197110_out_ap_vld;
...
wire   [63:0] arr_fu_1031_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] arr_10_fu_126;
wire   [63:0] arr_18_fu_1054_p2;
reg   [63:0] arr_11_fu_130;
wire   [63:0] arr_19_fu_1077_p2;
reg   [63:0] arr_12_fu_134;
wire   [63:0] arr_20_fu_1100_p2;
reg   [63:0] arr_13_fu_138;
wire   [63:0] arr_21_fu_1123_p2;
reg   [63:0] arr_14_fu_142;
wire   [63:0] arr_22_fu_1146_p2;
reg   [63:0] arr_15_fu_146;
wire   [63:0] arr_23_fu_1169_p2;
reg   [63:0] arr_16_fu_150;
wire   [63:0] arr_24_fu_1192_p2;
reg   [63:0] arr_17_fu_154;
wire   [63:0] arr_25_fu_1202_p2;
reg   [3:0] i1_fu_158;
...
wire  signed [31:0] tmp_6_fu_784_p12;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1114_out_ap_vld = 1'b1;
    end else begin
        add59_1114_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_197110_out_ap_vld = 1'b1;
    end else begin
        add59_197110_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_1115_out_ap_vld = 1'b1;
    end else begin
        add59_1_1115_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_2116_out_ap_vld = 1'b1;
    end else begin
        add59_1_2116_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_3117_out_ap_vld = 1'b1;
    end else begin
        add59_1_3117_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_4118_out_ap_vld = 1'b1;
    end else begin
        add59_1_4118_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2111_out_ap_vld = 1'b1;
    end else begin
        add59_2111_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3112_out_ap_vld = 1'b1;
    end else begin
        add59_3112_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4113_out_ap_vld = 1'b1;
    end else begin
        add59_4113_out_ap_vld = 1'b0;
    end
end
...
assign add59_1114_out = arr_13_fu_138;

assign add59_197110_out = arr_9_fu_122;

assign add59_1_1115_out = arr_14_fu_142;

assign add59_1_2116_out = arr_15_fu_146;

assign add59_1_3117_out = arr_16_fu_150;

assign add59_1_4118_out = arr_17_fu_154;

assign add59_2111_out = arr_10_fu_126;

assign add59_3112_out = arr_11_fu_130;

assign add59_4113_out = arr_12_fu_134;

assign add_ln48_1_fu_613_p2 = (ap_sig_allocacmp_i1_2 + 4'd3);

assign add_ln48_2_fu_823_p2 = (zext_ln36_fu_474_p1 + 5'd7);

assign add_ln48_fu_482_p2 = (ap_sig_allocacmp_i1_2 + 4'd1);

assign add_ln49_3_fu_673_p2 = (ap_sig_allocacmp_i1_2 + 4'd4);

assign add_ln49_6_fu_811_p2 = (ap_sig_allocacmp_i1_2 + 4'd6);

assign add_ln49_9_fu_916_p2 = (zext_ln36_fu_474_p1 + 5'd8);

assign add_ln49_fu_568_p2 = (ap_sig_allocacmp_i1_2 + 4'd2);
...
assign arr_18_fu_1054_p2 = (and_ln49_1_fu_1048_p2 + arr_10_fu_126);

assign arr_19_fu_1077_p2 = (and_ln49_2_fu_1071_p2 + arr_11_fu_130);

assign arr_20_fu_1100_p2 = (and_ln49_3_fu_1094_p2 + arr_12_fu_134);

assign arr_21_fu_1123_p2 = (and_ln49_4_fu_1117_p2 + arr_13_fu_138);

assign arr_22_fu_1146_p2 = (and_ln49_5_fu_1140_p2 + arr_14_fu_142);

assign arr_23_fu_1169_p2 = (and_ln49_6_fu_1163_p2 + arr_15_fu_146);

assign arr_24_fu_1192_p2 = (and_ln49_7_fu_1186_p2 + arr_16_fu_150);

assign arr_25_fu_1202_p2 = (mul_ln49_17_fu_371_p2 + arr_17_fu_154);

assign arr_fu_1031_p2 = (and_ln49_fu_1025_p2 + arr_9_fu_122);

assign empty_23_fu_718_p2 = (ap_sig_allocacmp_i1_2 + 4'd5);

assign empty_fu_478_p1 = ap_sig_allocacmp_i1_2[0:0];

assign icmp_ln36_fu_468_p2 = ((ap_sig_allocacmp_i1_2 == 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln48_1_fu_619_p2 = ((add_ln48_1_fu_613_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln48_2_fu_724_p2 = ((empty_23_fu_718_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln48_3_fu_829_p2 = ((add_ln48_2_fu_823_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln48_fu_488_p2 = ((add_ln48_fu_482_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_1_fu_712_p2 = ((add_ln49_3_fu_673_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_2_fu_817_p2 = ((add_ln49_6_fu_811_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_922_p2 = ((add_ln49_9_fu_916_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_fu_607_p2 = ((add_ln49_fu_568_p2 > 4'd9) ? 1'b1 : 1'b0);
...
assign tmp_1_fu_541_p11 = (4'd2 - ap_sig_allocacmp_i1_2);

assign tmp_2_fu_580_p11 = (4'd1 - ap_sig_allocacmp_i1_2);

assign tmp_3_fu_646_p11 = (4'd0 - ap_sig_allocacmp_i1_2);

assign tmp_4_fu_685_p11 = (ap_sig_allocacmp_i1_2 ^ 4'd15);

assign tmp_5_fu_751_p11 = ($signed(4'd14) - $signed(ap_sig_allocacmp_i1_2));

assign tmp_6_fu_784_p11 = ($signed(4'd13) - $signed(ap_sig_allocacmp_i1_2));

assign tmp_7_fu_856_p11 = ($signed(4'd12) - $signed(ap_sig_allocacmp_i1_2));

assign tmp_8_fu_889_p11 = ($signed(4'd11) - $signed(ap_sig_allocacmp_i1_2));

assign tmp_9_fu_943_p11 = ($signed(4'd10) - $signed(ap_sig_allocacmp_i1_2));

assign zext_ln36_fu_474_p1 = ap_sig_allocacmp_i1_2;
