...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_1_reload,
        add59_1_4211_out,
        add59_1_4211_out_ap_vld,
        add59_1_3210_out,
        add59_1_3210_out_ap_vld,
        add59_1_2119209_out,
        add59_1_2119209_out_ap_vld,
        add59_1_199208_out,
        add59_1_199208_out_ap_vld,
        add59_1207_out,
        add59_1207_out_ap_vld,
        add59_4206_out,
        add59_4206_out_ap_vld,
        add59_3205_out,
        add59_3205_out_ap_vld,
        add59_2190204_out,
        add59_2190204_out_ap_vld,
        add59_1172203_out,
        add59_1172203_out_ap_vld
);
...
output  [63:0] add59_1_4211_out;
output   add59_1_4211_out_ap_vld;
output  [63:0] add59_1_3210_out;
output   add59_1_3210_out_ap_vld;
output  [63:0] add59_1_2119209_out;
output   add59_1_2119209_out_ap_vld;
output  [63:0] add59_1_199208_out;
output   add59_1_199208_out_ap_vld;
output  [63:0] add59_1207_out;
output   add59_1207_out_ap_vld;
output  [63:0] add59_4206_out;
output   add59_4206_out_ap_vld;
output  [63:0] add59_3205_out;
output   add59_3205_out_ap_vld;
output  [63:0] add59_2190204_out;
output   add59_2190204_out_ap_vld;
output  [63:0] add59_1172203_out;
output   add59_1172203_out_ap_vld;

reg ap_idle;
reg add59_1_4211_out_ap_vld;
reg add59_1_3210_out_ap_vld;
reg add59_1_2119209_out_ap_vld;
reg add59_1_199208_out_ap_vld;
reg add59_1207_out_ap_vld;
reg add59_4206_out_ap_vld;
reg add59_3205_out_ap_vld;
reg add59_2190204_out_ap_vld;
reg add59_1172203_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1172203_out_ap_vld = 1'b1;
    end else begin
        add59_1172203_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1207_out_ap_vld = 1'b1;
    end else begin
        add59_1207_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_199208_out_ap_vld = 1'b1;
    end else begin
        add59_1_199208_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_2119209_out_ap_vld = 1'b1;
    end else begin
        add59_1_2119209_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_3210_out_ap_vld = 1'b1;
    end else begin
        add59_1_3210_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_4211_out_ap_vld = 1'b1;
    end else begin
        add59_1_4211_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2190204_out_ap_vld = 1'b1;
    end else begin
        add59_2190204_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_3205_out_ap_vld = 1'b1;
    end else begin
        add59_3205_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_562_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4206_out_ap_vld = 1'b1;
    end else begin
        add59_4206_out_ap_vld = 1'b0;
    end
end
...
assign add59_1172203_out = arr_9_fu_122;

assign add59_1207_out = arr_13_fu_138;

assign add59_1_199208_out = arr_14_fu_142;

assign add59_1_2119209_out = arr_15_fu_146;

assign add59_1_3210_out = arr_16_fu_150;

assign add59_1_4211_out = arr_17_fu_154;

assign add59_2190204_out = arr_10_fu_126;

assign add59_3205_out = arr_11_fu_130;

assign add59_4206_out = arr_12_fu_134;
...
assign add_ln49_1_fu_684_p2 = (ap_sig_allocacmp_i1_2 + 4'd5);
...
assign add_ln49_8_fu_767_p2 = (ap_sig_allocacmp_i1_2 + 4'd6);
...
assign and_ln48_1_fu_669_p2 = (icmp_ln49_fu_635_p2 & cmp32_1122_fu_641_p2);
...
assign and_ln48_4_fu_964_p2 = (icmp_ln49_2_fu_807_p2 & cmp32_1122_fu_641_p2);

assign and_ln48_5_fu_979_p2 = (icmp_ln49_3_fu_914_p2 & cmp32_1122_fu_641_p2);
...
assign cmp32_1122_fu_641_p2 = (empty_fu_576_p1 ^ 1'd1);
...
assign tmp_4_fu_696_p11 = ($signed(4'd14) - $signed(ap_sig_allocacmp_i1_2));

assign tmp_6_fu_779_p11 = ($signed(4'd13) - $signed(ap_sig_allocacmp_i1_2));

assign tmp_7_fu_846_p11 = ($signed(4'd12) - $signed(ap_sig_allocacmp_i1_2));

assign tmp_8_fu_880_p11 = ($signed(4'd11) - $signed(ap_sig_allocacmp_i1_2));

assign tmp_9_fu_936_p11 = ($signed(4'd10) - $signed(ap_sig_allocacmp_i1_2));
