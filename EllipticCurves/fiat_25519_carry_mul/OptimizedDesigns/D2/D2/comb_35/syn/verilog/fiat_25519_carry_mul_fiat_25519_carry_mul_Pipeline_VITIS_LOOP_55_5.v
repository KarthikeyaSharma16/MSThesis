...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        zext_ln68_23,
        add129_1_482218_out,
        add129_1_482218_out_ap_vld,
        add129_1_364217_out,
        add129_1_364217_out_ap_vld,
        add129_1_246216_out,
        add129_1_246216_out_ap_vld,
        add129_1_128215_out,
        add129_1_128215_out_ap_vld,
        add129_1214_out,
        add129_1214_out_ap_vld,
        add129_4189213_out,
        add129_4189213_out_ap_vld,
        add129_3171212_out,
        add129_3171212_out_ap_vld,
        add129_2153211_out,
        add129_2153211_out_ap_vld,
        add129_1135210_out,
        add129_1135210_out_ap_vld,
        add129209_out,
        add129209_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add59_1_4228_reload;
input  [63:0] add59_1_3227_reload;
input  [63:0] add59_1_2226_reload;
input  [63:0] add59_1_1225_reload;
input  [63:0] add59_1224_reload;
input  [63:0] add59_4223_reload;
input  [63:0] add59_3222_reload;
input  [63:0] add59_2221_reload;
input  [63:0] add59_1207220_reload;
...
output  [63:0] add129_1_482218_out;
output   add129_1_482218_out_ap_vld;
output  [63:0] add129_1_364217_out;
output   add129_1_364217_out_ap_vld;
output  [63:0] add129_1_246216_out;
output   add129_1_246216_out_ap_vld;
output  [63:0] add129_1_128215_out;
output   add129_1_128215_out_ap_vld;
output  [63:0] add129_1214_out;
output   add129_1214_out_ap_vld;
output  [63:0] add129_4189213_out;
output   add129_4189213_out_ap_vld;
output  [63:0] add129_3171212_out;
output   add129_3171212_out_ap_vld;
output  [63:0] add129_2153211_out;
output   add129_2153211_out_ap_vld;
output  [63:0] add129_1135210_out;
output   add129_1135210_out_ap_vld;
output  [63:0] add129209_out;
output   add129209_out_ap_vld;

reg ap_idle;
reg add129_1_482218_out_ap_vld;
reg add129_1_364217_out_ap_vld;
reg add129_1_246216_out_ap_vld;
reg add129_1_128215_out_ap_vld;
reg add129_1214_out_ap_vld;
reg add129_4189213_out_ap_vld;
reg add129_3171212_out_ap_vld;
reg add129_2153211_out_ap_vld;
reg add129_1135210_out_ap_vld;
reg add129209_out_ap_vld;
...
reg   [63:0] add129209_fu_160;
wire   [63:0] add_ln68_7_fu_1259_p2;
wire    ap_block_pp0_stage0;
wire    ap_loop_init;
reg   [63:0] add129_1135210_fu_164;
wire   [63:0] add_ln68_12_fu_1302_p2;
reg   [63:0] add129_2153211_fu_168;
wire   [63:0] add_ln68_17_fu_1351_p2;
reg   [63:0] add129_3171212_fu_172;
wire   [63:0] add_ln68_22_fu_1431_p2;
reg   [63:0] add129_4189213_fu_176;
wire   [63:0] add_ln68_28_fu_1507_p2;
reg   [63:0] add129_1214_fu_180;
wire   [63:0] add_ln68_43_fu_1742_p2;
reg   [63:0] add129_1_128215_fu_184;
wire   [63:0] add_ln68_38_fu_1682_p2;
reg   [63:0] add129_1_246216_fu_188;
wire   [63:0] add_ln68_34_fu_1634_p2;
reg   [63:0] add129_1_364217_fu_192;
wire   [63:0] add_ln68_31_fu_1598_p2;
reg   [63:0] add129_1_482218_fu_196;
...
always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129209_out_ap_vld = 1'b1;
    end else begin
        add129209_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1135210_out_ap_vld = 1'b1;
    end else begin
        add129_1135210_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1214_out_ap_vld = 1'b1;
    end else begin
        add129_1214_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_128215_out_ap_vld = 1'b1;
    end else begin
        add129_1_128215_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_246216_out_ap_vld = 1'b1;
    end else begin
        add129_1_246216_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_364217_out_ap_vld = 1'b1;
    end else begin
        add129_1_364217_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_482218_out_ap_vld = 1'b1;
    end else begin
        add129_1_482218_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_2153211_out_ap_vld = 1'b1;
    end else begin
        add129_2153211_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_3171212_out_ap_vld = 1'b1;
    end else begin
        add129_3171212_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_676_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_4189213_out_ap_vld = 1'b1;
    end else begin
        add129_4189213_out_ap_vld = 1'b0;
    end
end
...
assign add129209_out = add129209_fu_160;

assign add129_1135210_out = add129_1135210_fu_164;

assign add129_1214_out = add129_1214_fu_180;

assign add129_1_128215_out = add129_1_128215_fu_184;

assign add129_1_246216_out = add129_1_246216_fu_188;

assign add129_1_364217_out = add129_1_364217_fu_192;

assign add129_1_482218_out = add129_1_482218_fu_196;

assign add129_2153211_out = add129_2153211_fu_168;

assign add129_3171212_out = add129_3171212_fu_172;

assign add129_4189213_out = add129_4189213_fu_176;
...
assign add_ln68_12_fu_1302_p2 = (add129_1135210_fu_164 + add_ln68_11_fu_1296_p2);
...
assign add_ln68_17_fu_1351_p2 = (add129_2153211_fu_168 + add_ln68_16_fu_1345_p2);
...
assign add_ln68_22_fu_1431_p2 = (add129_3171212_fu_172 + add_ln68_21_fu_1425_p2);
...
assign add_ln68_28_fu_1507_p2 = (add129_4189213_fu_176 + add_ln68_27_fu_1501_p2);

assign add_ln68_29_fu_1549_p2 = (and_ln68_10_fu_1543_p2 + add129_1_482218_fu_196);
...
assign add_ln68_31_fu_1598_p2 = (add129_1_364217_fu_192 + add_ln68_30_fu_1592_p2);
...
assign add_ln68_34_fu_1634_p2 = (add129_1_246216_fu_188 + add_ln68_33_fu_1628_p2);
...
assign add_ln68_38_fu_1682_p2 = (add129_1_128215_fu_184 + add_ln68_37_fu_1676_p2);
...
assign add_ln68_43_fu_1742_p2 = (add129_1214_fu_180 + add_ln68_42_fu_1736_p2);
...
assign add_ln68_7_fu_1259_p2 = (add129209_fu_160 + add_ln68_6_fu_1253_p2);
...
assign mul_ln68_1_fu_458_p10 = tmp_2_fu_878_p11;
...
assign select_ln68_fu_901_p3 = ((trunc_ln68_reg_2090[0:0] == 1'b1) ? shl_ln68_fu_895_p2 : tmp_2_fu_878_p11);
...
assign shl_ln68_fu_895_p2 = tmp_2_fu_878_p11 << 32'd1;
...
assign zext_ln68_fu_840_p1 = tmp_s_fu_829_p8;
