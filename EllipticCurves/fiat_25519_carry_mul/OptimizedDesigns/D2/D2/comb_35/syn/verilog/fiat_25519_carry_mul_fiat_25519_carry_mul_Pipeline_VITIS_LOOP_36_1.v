...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add59_1_4228_out,
        add59_1_4228_out_ap_vld,
        add59_1_3227_out,
        add59_1_3227_out_ap_vld,
        add59_1_2226_out,
        add59_1_2226_out_ap_vld,
        add59_1_1225_out,
        add59_1_1225_out_ap_vld,
        add59_1224_out,
        add59_1224_out_ap_vld,
        add59_4223_out,
        add59_4223_out_ap_vld,
        add59_3222_out,
        add59_3222_out_ap_vld,
        add59_2221_out,
        add59_2221_out_ap_vld,
        add59_1207220_out,
        add59_1207220_out_ap_vld
);
...
output  [63:0] add59_1_4228_out;
output   add59_1_4228_out_ap_vld;
output  [63:0] add59_1_3227_out;
output   add59_1_3227_out_ap_vld;
output  [63:0] add59_1_2226_out;
output   add59_1_2226_out_ap_vld;
output  [63:0] add59_1_1225_out;
output   add59_1_1225_out_ap_vld;
output  [63:0] add59_1224_out;
output   add59_1224_out_ap_vld;
output  [63:0] add59_4223_out;
output   add59_4223_out_ap_vld;
output  [63:0] add59_3222_out;
output   add59_3222_out_ap_vld;
output  [63:0] add59_2221_out;
output   add59_2221_out_ap_vld;
output  [63:0] add59_1207220_out;
output   add59_1207220_out_ap_vld;

reg ap_idle;
reg add59_1_4228_out_ap_vld;
reg add59_1_3227_out_ap_vld;
reg add59_1_2226_out_ap_vld;
reg add59_1_1225_out_ap_vld;
reg add59_1224_out_ap_vld;
reg add59_4223_out_ap_vld;
reg add59_3222_out_ap_vld;
reg add59_2221_out_ap_vld;
reg add59_1207220_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1207220_out_ap_vld = 1'b1;
    end else begin
        add59_1207220_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1224_out_ap_vld = 1'b1;
    end else begin
        add59_1224_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_1225_out_ap_vld = 1'b1;
    end else begin
        add59_1_1225_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_2226_out_ap_vld = 1'b1;
    end else begin
        add59_1_2226_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_3227_out_ap_vld = 1'b1;
    end else begin
        add59_1_3227_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_1_4228_out_ap_vld = 1'b1;
    end else begin
        add59_1_4228_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_2221_out_ap_vld = 1'b1;
    end else begin
        add59_2221_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add59_4223_out_ap_vld = 1'b1;
    end else begin
        add59_4223_out_ap_vld = 1'b0;
    end
end
...
assign add59_1207220_out = arr_9_fu_122;

assign add59_1224_out = arr_13_fu_138;

assign add59_1_1225_out = arr_14_fu_142;

assign add59_1_2226_out = arr_15_fu_146;

assign add59_1_3227_out = arr_16_fu_150;

assign add59_1_4228_out = arr_17_fu_154;

assign add59_2221_out = arr_10_fu_126;

assign add59_3222_out = arr_11_fu_130;

assign add59_4223_out = arr_12_fu_134;
...
assign add_ln49_3_fu_673_p2 = (ap_sig_allocacmp_i1_3 + 4'd4);

assign add_ln49_6_fu_811_p2 = (ap_sig_allocacmp_i1_3 + 4'd6);

assign add_ln49_9_fu_916_p2 = (zext_ln36_fu_474_p1 + 5'd8);

assign add_ln49_fu_568_p2 = (ap_sig_allocacmp_i1_3 + 4'd2);
...
assign empty_23_fu_718_p2 = (ap_sig_allocacmp_i1_3 + 4'd5);
...
assign tmp_6_fu_784_p11 = ($signed(4'd13) - $signed(ap_sig_allocacmp_i1_3));

assign tmp_7_fu_856_p11 = ($signed(4'd12) - $signed(ap_sig_allocacmp_i1_3));

assign tmp_8_fu_889_p11 = ($signed(4'd11) - $signed(ap_sig_allocacmp_i1_3));
