...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_9_reload,
        add129_9205_out,
        add129_9205_out_ap_vld,
        add129_8204_out,
        add129_8204_out_ap_vld,
        add129_7203_out,
        add129_7203_out_ap_vld,
        add129_6202_out,
        add129_6202_out_ap_vld,
        add129_5201_out,
        add129_5201_out_ap_vld,
        add129_4200_out,
        add129_4200_out_ap_vld,
        add129_3199_out,
        add129_3199_out_ap_vld,
        add129_2198_out,
        add129_2198_out_ap_vld,
        add129_1197_out,
        add129_1197_out_ap_vld,
        add129196_out,
        add129196_out_ap_vld
);
...
output  [63:0] add129_9205_out;
output   add129_9205_out_ap_vld;
output  [63:0] add129_8204_out;
output   add129_8204_out_ap_vld;
output  [63:0] add129_7203_out;
output   add129_7203_out_ap_vld;
output  [63:0] add129_6202_out;
output   add129_6202_out_ap_vld;
output  [63:0] add129_5201_out;
output   add129_5201_out_ap_vld;
output  [63:0] add129_4200_out;
output   add129_4200_out_ap_vld;
output  [63:0] add129_3199_out;
output   add129_3199_out_ap_vld;
output  [63:0] add129_2198_out;
output   add129_2198_out_ap_vld;
output  [63:0] add129_1197_out;
output   add129_1197_out_ap_vld;
output  [63:0] add129196_out;
output   add129196_out_ap_vld;

reg ap_idle;
reg add129_9205_out_ap_vld;
reg add129_8204_out_ap_vld;
reg add129_7203_out_ap_vld;
reg add129_6202_out_ap_vld;
reg add129_5201_out_ap_vld;
reg add129_4200_out_ap_vld;
reg add129_3199_out_ap_vld;
reg add129_2198_out_ap_vld;
reg add129_1197_out_ap_vld;
reg add129196_out_ap_vld;
...
wire   [4:0] empty_29_fu_1202_p2;
wire   [0:0] icmp_ln67_5_fu_1208_p2;
wire   [3:0] tmp_s_fu_1226_p11;
wire   [31:0] tmp_s_fu_1226_p12;
...
always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129196_out_ap_vld = 1'b1;
    end else begin
        add129196_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_2198_out_ap_vld = 1'b1;
    end else begin
        add129_2198_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_3199_out_ap_vld = 1'b1;
    end else begin
        add129_3199_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_4200_out_ap_vld = 1'b1;
    end else begin
        add129_4200_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_5201_out_ap_vld = 1'b1;
    end else begin
        add129_5201_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_6202_out_ap_vld = 1'b1;
    end else begin
        add129_6202_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_7203_out_ap_vld = 1'b1;
    end else begin
        add129_7203_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_8204_out_ap_vld = 1'b1;
    end else begin
        add129_8204_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_9205_out_ap_vld = 1'b1;
    end else begin
        add129_9205_out_ap_vld = 1'b0;
    end
end
...
assign add129196_out = add129196_fu_158;

assign add129_1197_out = add129_1197_fu_162;

assign add129_2198_out = add129_2198_fu_166;

assign add129_3199_out = add129_3199_fu_170;

assign add129_4200_out = add129_4200_fu_174;

assign add129_5201_out = add129_5201_fu_178;

assign add129_6202_out = add129_6202_fu_182;

assign add129_7203_out = add129_7203_fu_186;

assign add129_8204_out = add129_8204_fu_190;

assign add129_9205_out = add129_9205_fu_194;

assign add_ln68_1_fu_731_p2 = (and_ln68_fu_725_p2 + add129_1197_fu_162);

assign add_ln68_2_fu_788_p2 = (and_ln68_1_fu_782_p2 + add129_2198_fu_166);

assign add_ln68_3_fu_864_p2 = (and_ln68_2_fu_858_p2 + add129_3199_fu_170);

assign add_ln68_4_fu_919_p2 = (and_ln68_3_fu_913_p2 + add129_4200_fu_174);

assign add_ln68_5_fu_993_p2 = (and_ln68_4_fu_987_p2 + add129_5201_fu_178);

assign add_ln68_6_fu_1046_p2 = (and_ln68_5_fu_1040_p2 + add129_6202_fu_182);

assign add_ln68_7_fu_1131_p2 = (and_ln68_6_fu_1125_p2 + add129_7203_fu_186);

assign add_ln68_8_fu_1196_p2 = (and_ln68_7_fu_1190_p2 + add129_8204_fu_190);

assign add_ln68_9_fu_1281_p2 = (and_ln68_8_fu_1275_p2 + add129_9205_fu_194);

assign add_ln68_fu_655_p2 = (mul_ln68_fu_446_p2 + add129196_fu_158);
...
assign empty_22_fu_737_p2 = (i1_fu_198 + 4'd2);

assign empty_23_fu_794_p2 = (i1_fu_198 + 4'd3);

assign empty_24_fu_870_p2 = (i1_fu_198 + 4'd4);

assign empty_25_fu_925_p2 = (i1_fu_198 + 4'd5);

assign empty_26_fu_999_p2 = (i1_fu_198 + 4'd6);

assign empty_27_fu_1052_p2 = (zext_ln67_fu_586_p1 + 5'd7);

assign empty_28_fu_1137_p2 = (zext_ln67_fu_586_p1 + 5'd8);

assign empty_29_fu_1202_p2 = (zext_ln67_fu_586_p1 + 5'd9);

assign empty_fu_661_p1 = i1_fu_198[0:0];

assign icmp_ln67_1_fu_665_p2 = ((indvars_iv_next217_fu_550_p2 < 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln67_2_fu_800_p2 = ((empty_23_fu_794_p2 < 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln67_3_fu_931_p2 = ((empty_25_fu_925_p2 < 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln67_4_fu_1058_p2 = ((empty_27_fu_1052_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln67_5_fu_1208_p2 = ((empty_29_fu_1202_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln67_fu_544_p2 = ((i1_fu_198 == 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_1_fu_899_p2 = ((empty_24_fu_870_p2 < 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_2_fu_1026_p2 = ((empty_26_fu_999_p2 < 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_3_fu_1176_p2 = ((empty_28_fu_1137_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_fu_768_p2 = ((empty_22_fu_737_p2 < 4'd10) ? 1'b1 : 1'b0);

assign indvars_iv_next217_fu_550_p2 = (i1_fu_198 + 4'd1);
...
assign select_ln68_4_fu_1254_p3 = ((and_ln67_4_fu_1214_p2[0:0] == 1'b1) ? shl_ln68_4_fu_1248_p2 : tmp_s_fu_1226_p12);
...
assign shl_ln68_4_fu_1248_p2 = tmp_s_fu_1226_p12 << 32'd1;
...
assign tmp_s_fu_1226_p11 = (4'd0 - i1_fu_198);
...
assign zext_ln68_fu_614_p1 = tmp_fu_598_p12;
