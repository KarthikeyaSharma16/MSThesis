...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg1_r_9_reload,
        add129_1_4277_out,
        add129_1_4277_out_ap_vld,
        add129_1_3276_out,
        add129_1_3276_out_ap_vld,
        add129_1_2275_out,
        add129_1_2275_out_ap_vld,
        add129_1_128274_out,
        add129_1_128274_out_ap_vld,
        add129_1273_out,
        add129_1273_out_ap_vld,
        add129_4272_out,
        add129_4272_out_ap_vld,
        add129_3271_out,
        add129_3271_out_ap_vld,
        add129_2270_out,
        add129_2270_out_ap_vld,
        add129_179269_out,
        add129_179269_out_ap_vld,
        add129268_out,
        add129268_out_ap_vld
);
...
output  [63:0] add129_1_4277_out;
output   add129_1_4277_out_ap_vld;
output  [63:0] add129_1_3276_out;
output   add129_1_3276_out_ap_vld;
output  [63:0] add129_1_2275_out;
output   add129_1_2275_out_ap_vld;
output  [63:0] add129_1_128274_out;
output   add129_1_128274_out_ap_vld;
output  [63:0] add129_1273_out;
output   add129_1273_out_ap_vld;
output  [63:0] add129_4272_out;
output   add129_4272_out_ap_vld;
output  [63:0] add129_3271_out;
output   add129_3271_out_ap_vld;
output  [63:0] add129_2270_out;
output   add129_2270_out_ap_vld;
output  [63:0] add129_179269_out;
output   add129_179269_out_ap_vld;
output  [63:0] add129268_out;
output   add129268_out_ap_vld;

reg ap_idle;
reg add129_1_4277_out_ap_vld;
reg add129_1_3276_out_ap_vld;
reg add129_1_2275_out_ap_vld;
reg add129_1_128274_out_ap_vld;
reg add129_1273_out_ap_vld;
reg add129_4272_out_ap_vld;
reg add129_3271_out_ap_vld;
reg add129_2270_out_ap_vld;
reg add129_179269_out_ap_vld;
reg add129268_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129268_out_ap_vld = 1'b1;
    end else begin
        add129268_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1273_out_ap_vld = 1'b1;
    end else begin
        add129_1273_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_179269_out_ap_vld = 1'b1;
    end else begin
        add129_179269_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_128274_out_ap_vld = 1'b1;
    end else begin
        add129_1_128274_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_2275_out_ap_vld = 1'b1;
    end else begin
        add129_1_2275_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_3276_out_ap_vld = 1'b1;
    end else begin
        add129_1_3276_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_4277_out_ap_vld = 1'b1;
    end else begin
        add129_1_4277_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_2270_out_ap_vld = 1'b1;
    end else begin
        add129_2270_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_3271_out_ap_vld = 1'b1;
    end else begin
        add129_3271_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln68_fu_582_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_4272_out_ap_vld = 1'b1;
    end else begin
        add129_4272_out_ap_vld = 1'b0;
    end
end
...
assign add129268_out = add129268_fu_160;

assign add129_1273_out = add129_1273_fu_180;

assign add129_179269_out = add129_179269_fu_164;

assign add129_1_128274_out = add129_1_128274_fu_184;

assign add129_1_2275_out = add129_1_2275_fu_188;

assign add129_1_3276_out = add129_1_3276_fu_192;

assign add129_1_4277_out = add129_1_4277_fu_196;

assign add129_2270_out = add129_2270_fu_168;

assign add129_3271_out = add129_3271_fu_172;

assign add129_4272_out = add129_4272_fu_176;

assign add_ln68_10_fu_1011_p2 = (add129_3271_fu_172 + add_ln68_9_fu_1005_p2);

assign add_ln68_11_fu_1017_p2 = (i1_fu_200 + 4'd5);

assign add_ln68_12_fu_1074_p2 = (and_ln68_6_fu_1068_p2 + and_ln68_5_fu_1054_p2);

assign add_ln68_13_fu_1080_p2 = (add129_4272_fu_176 + add_ln68_12_fu_1074_p2);
