...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_985_out \
    op interface \
    ports { add59_985_out { O 64 vector } add59_985_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_884_out \
    op interface \
    ports { add59_884_out { O 64 vector } add59_884_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_783_out \
    op interface \
    ports { add59_783_out { O 64 vector } add59_783_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_682_out \
    op interface \
    ports { add59_682_out { O 64 vector } add59_682_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_581_out \
    op interface \
    ports { add59_581_out { O 64 vector } add59_581_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_480_out \
    op interface \
    ports { add59_480_out { O 64 vector } add59_480_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add59_379_out \
    op interface \
    ports { add59_379_out { O 64 vector } add59_379_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 107 \
    name add59_26478_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add59_26478_out \
    op interface \
    ports { add59_26478_out { O 64 vector } add59_26478_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 108 \
    name add59_14677_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add59_14677_out \
    op interface \
    ports { add59_14677_out { O 64 vector } add59_14677_out_ap_vld { O 1 bit } } \
} "
}
