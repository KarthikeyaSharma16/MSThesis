...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_9_reload,
        add129_1_4226_out,
        add129_1_4226_out_ap_vld,
        add129_1_3225_out,
        add129_1_3225_out_ap_vld,
        add129_1_2224_out,
        add129_1_2224_out_ap_vld,
        add129_1_1223_out,
        add129_1_1223_out_ap_vld,
        add129_1222_out,
        add129_1222_out_ap_vld,
        add129_4221_out,
...
output  [63:0] add129_1_4226_out;
output   add129_1_4226_out_ap_vld;
output  [63:0] add129_1_3225_out;
output   add129_1_3225_out_ap_vld;
output  [63:0] add129_1_2224_out;
output   add129_1_2224_out_ap_vld;
output  [63:0] add129_1_1223_out;
output   add129_1_1223_out_ap_vld;
output  [63:0] add129_1222_out;
output   add129_1222_out_ap_vld;
...
output  [63:0] add129_128218_out;
output   add129_128218_out_ap_vld;
output  [63:0] add129217_out;
output   add129217_out_ap_vld;

reg ap_idle;
reg add129_1_4226_out_ap_vld;
reg add129_1_3225_out_ap_vld;
reg add129_1_2224_out_ap_vld;
reg add129_1_1223_out_ap_vld;
reg add129_1222_out_ap_vld;
reg add129_4221_out_ap_vld;
reg add129_3220_out_ap_vld;
reg add129_2219_out_ap_vld;
reg add129_128218_out_ap_vld;
...
reg   [63:0] add129217_fu_158;
wire   [63:0] add_ln68_fu_659_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add129_128218_fu_162;
wire   [63:0] add_ln68_1_fu_731_p2;
reg   [63:0] add129_2219_fu_166;
wire   [63:0] add_ln68_3_fu_788_p2;
reg   [63:0] add129_3220_fu_170;
wire   [63:0] add_ln68_4_fu_864_p2;
reg   [63:0] add129_4221_fu_174;
wire   [63:0] add_ln68_6_fu_919_p2;
reg   [63:0] add129_1222_fu_178;
wire   [63:0] add_ln68_7_fu_993_p2;
reg   [63:0] add129_1_1223_fu_182;
wire   [63:0] add_ln68_9_fu_1046_p2;
reg   [63:0] add129_1_2224_fu_186;
wire   [63:0] add_ln68_10_fu_1131_p2;
reg   [63:0] add129_1_3225_fu_190;
wire   [63:0] add_ln68_12_fu_1196_p2;
reg   [63:0] add129_1_4226_fu_194;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1222_fu_178 <= arr_4;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_1222_fu_178 <= add_ln68_7_fu_993_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_128218_fu_162 <= arr;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_128218_fu_162 <= add_ln68_1_fu_731_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1_1223_fu_182 <= arr_5;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_1_1223_fu_182 <= add_ln68_9_fu_1046_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1_2224_fu_186 <= arr_6;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_1_2224_fu_186 <= add_ln68_10_fu_1131_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1_3225_fu_190 <= arr_7;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_1_3225_fu_190 <= add_ln68_12_fu_1196_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_1_4226_fu_194 <= arr_8;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_1_4226_fu_194 <= add_ln68_13_fu_1281_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_2219_fu_166 <= arr_1;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_2219_fu_166 <= add_ln68_3_fu_788_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_3220_fu_170 <= arr_2;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_3220_fu_170 <= add_ln68_4_fu_864_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add129_4221_fu_174 <= arr_3;
        end else if (((icmp_ln67_fu_544_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add129_4221_fu_174 <= add_ln68_6_fu_919_p2;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1222_out_ap_vld = 1'b1;
    end else begin
        add129_1222_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_128218_out_ap_vld = 1'b1;
    end else begin
        add129_128218_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_1223_out_ap_vld = 1'b1;
    end else begin
        add129_1_1223_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_2224_out_ap_vld = 1'b1;
    end else begin
        add129_1_2224_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_3225_out_ap_vld = 1'b1;
    end else begin
        add129_1_3225_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_fu_544_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add129_1_4226_out_ap_vld = 1'b1;
    end else begin
        add129_1_4226_out_ap_vld = 1'b0;
    end
end
...
assign add129217_out = add129217_fu_158;

assign add129_1222_out = add129_1222_fu_178;

assign add129_128218_out = add129_128218_fu_162;

assign add129_1_1223_out = add129_1_1223_fu_182;

assign add129_1_2224_out = add129_1_2224_fu_186;

assign add129_1_3225_out = add129_1_3225_fu_190;

assign add129_1_4226_out = add129_1_4226_fu_194;

assign add129_2219_out = add129_2219_fu_166;

assign add129_3220_out = add129_3220_fu_170;

assign add129_4221_out = add129_4221_fu_174;
...
assign add_ln68_10_fu_1131_p2 = (and_ln68_6_fu_1125_p2 + add129_1_2224_fu_186);

assign add_ln68_11_fu_1137_p2 = (zext_ln67_fu_586_p1 + 5'd8);

assign add_ln68_12_fu_1196_p2 = (and_ln68_7_fu_1190_p2 + add129_1_3225_fu_190);

assign add_ln68_13_fu_1281_p2 = (and_ln68_8_fu_1275_p2 + add129_1_4226_fu_194);

assign add_ln68_1_fu_731_p2 = (and_ln68_fu_725_p2 + add129_128218_fu_162);

assign add_ln68_2_fu_737_p2 = (i1_fu_198 + 4'd2);

assign add_ln68_3_fu_788_p2 = (and_ln68_1_fu_782_p2 + add129_2219_fu_166);

assign add_ln68_4_fu_864_p2 = (and_ln68_2_fu_858_p2 + add129_3220_fu_170);

assign add_ln68_5_fu_870_p2 = (i1_fu_198 + 4'd4);

assign add_ln68_6_fu_919_p2 = (and_ln68_3_fu_913_p2 + add129_4221_fu_174);

assign add_ln68_7_fu_993_p2 = (and_ln68_4_fu_987_p2 + add129_1222_fu_178);

assign add_ln68_8_fu_999_p2 = (i1_fu_198 + 4'd6);

assign add_ln68_9_fu_1046_p2 = (and_ln68_5_fu_1040_p2 + add129_1_1223_fu_182);

assign add_ln68_fu_659_p2 = (mul_ln68_fu_446_p2 + add129217_fu_158);
...
assign empty_22_fu_925_p2 = (i1_fu_198 + 4'd5);
...
assign icmp_ln67_3_fu_931_p2 = ((empty_22_fu_925_p2 < 4'd10) ? 1'b1 : 1'b0);
...
assign zext_ln68_fu_618_p1 = tmp_fu_602_p12;
