...
set C_modelArgList {
	...
	{ zext_ln63 int 26 regular  }
	{ zext_ln64 int 25 regular  }
	{ out1_w_2 int 27 regular  }
	{ zext_ln66 int 25 regular  }
	{ zext_ln67 int 26 regular  }
	{ zext_ln68 int 25 regular  }
	{ zext_ln69 int 26 regular  }
	{ zext_ln70 int 25 regular  }
	{ zext_ln71 int 26 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "zext_ln63", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln64", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "out1_w_2", "interface" : "wire", "bitwidth" : 27, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln66", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln67", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln68", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln69", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln70", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln71", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln75 sc_in sc_lv 62 signal 1 } 
	{ zext_ln63 sc_in sc_lv 26 signal 2 } 
	{ zext_ln64 sc_in sc_lv 25 signal 3 } 
	{ out1_w_2 sc_in sc_lv 27 signal 4 } 
	{ zext_ln66 sc_in sc_lv 25 signal 5 } 
	{ zext_ln67 sc_in sc_lv 26 signal 6 } 
	{ zext_ln68 sc_in sc_lv 25 signal 7 } 
	{ zext_ln69 sc_in sc_lv 26 signal 8 } 
	{ zext_ln70 sc_in sc_lv 25 signal 9 } 
	{ zext_ln71 sc_in sc_lv 26 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln63", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln63", "role": "default" }} , 
 	{ "name": "zext_ln64", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln64", "role": "default" }} , 
 	{ "name": "out1_w_2", "direction": "in", "datatype": "sc_lv", "bitwidth":27, "type": "signal", "bundle":{"name": "out1_w_2", "role": "default" }} , 
 	{ "name": "zext_ln66", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln66", "role": "default" }} , 
 	{ "name": "zext_ln67", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln67", "role": "default" }} , 
 	{ "name": "zext_ln68", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln68", "role": "default" }} , 
 	{ "name": "zext_ln69", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln69", "role": "default" }} , 
 	{ "name": "zext_ln70", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln70", "role": "default" }} , 
 	{ "name": "zext_ln71", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln71", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_10_4_27_1_1_U152", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln63 { ap_none {  { zext_ln63 in_data 0 26 } } }
	zext_ln64 { ap_none {  { zext_ln64 in_data 0 25 } } }
	out1_w_2 { ap_none {  { out1_w_2 in_data 0 27 } } }
	zext_ln66 { ap_none {  { zext_ln66 in_data 0 25 } } }
	zext_ln67 { ap_none {  { zext_ln67 in_data 0 26 } } }
	zext_ln68 { ap_none {  { zext_ln68 in_data 0 25 } } }
	zext_ln69 { ap_none {  { zext_ln69 in_data 0 26 } } }
	zext_ln70 { ap_none {  { zext_ln70 in_data 0 25 } } }
	zext_ln71 { ap_none {  { zext_ln71 in_data 0 26 } } }
