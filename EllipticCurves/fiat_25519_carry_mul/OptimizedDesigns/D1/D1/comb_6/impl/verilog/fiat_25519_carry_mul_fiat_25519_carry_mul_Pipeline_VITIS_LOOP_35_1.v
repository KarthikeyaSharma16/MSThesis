...
output  [63:0] add7138_out;
output   add7138_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln35_fu_520_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add7138_out_ap_vld = 1'b1;
    end else begin
        add7138_out_ap_vld = 1'b0;
    end
end
...
assign add7138_out = add7138_fu_148;
...
assign add_ln55_fu_599_p2 = (mul_ln55_fu_402_p2 + add7138_fu_148);
