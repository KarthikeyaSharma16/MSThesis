...
begin
    mux_10_4_27_1_1_U101 : component fiat_25519_carry_mul_mux_10_4_27_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 27,
    ...
    tmp_4_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln63),27));
    tmp_4_fu_222_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln14),27));
    tmp_4_fu_222_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln64),27));
    tmp_4_fu_222_p4 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln66),27));
    tmp_4_fu_222_p5 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln67),27));
    tmp_4_fu_222_p6 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln68),27));
    tmp_4_fu_222_p7 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln69),27));
    tmp_4_fu_222_p8 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln70),27));
    tmp_4_fu_222_p9 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln71),27));
end behav;
