...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_39_1 (
        ...
        zext_ln67_18,
        add65_1_4101571_out,
        add65_1_4101571_out_ap_vld,
        add65_1_378570_out,
        add65_1_378570_out_ap_vld,
        add65_1_255569_out,
        add65_1_255569_out_ap_vld,
        add65_1_132568_out,
        add65_1_132568_out_ap_vld,
        add65_1567_out,
        add65_1567_out_ap_vld,
        add65_4235566_out,
        add65_4235566_out_ap_vld,
        add65_3212565_out,
        add65_3212565_out_ap_vld,
        add65_2189564_out,
        add65_2189564_out_ap_vld,
        add65_1166563_out,
        add65_1166563_out_ap_vld,
        add65562_out,
        add65562_out_ap_vld
);
...
output  [63:0] add65_1_4101571_out;
output   add65_1_4101571_out_ap_vld;
output  [63:0] add65_1_378570_out;
output   add65_1_378570_out_ap_vld;
output  [63:0] add65_1_255569_out;
output   add65_1_255569_out_ap_vld;
output  [63:0] add65_1_132568_out;
output   add65_1_132568_out_ap_vld;
output  [63:0] add65_1567_out;
output   add65_1567_out_ap_vld;
output  [63:0] add65_4235566_out;
output   add65_4235566_out_ap_vld;
output  [63:0] add65_3212565_out;
output   add65_3212565_out_ap_vld;
output  [63:0] add65_2189564_out;
output   add65_2189564_out_ap_vld;
output  [63:0] add65_1166563_out;
output   add65_1166563_out_ap_vld;
output  [63:0] add65562_out;
output   add65562_out_ap_vld;

reg ap_idle;
reg add65_1_4101571_out_ap_vld;
reg add65_1_378570_out_ap_vld;
reg add65_1_255569_out_ap_vld;
reg add65_1_132568_out_ap_vld;
reg add65_1567_out_ap_vld;
reg add65_4235566_out_ap_vld;
reg add65_3212565_out_ap_vld;
reg add65_2189564_out_ap_vld;
reg add65_1166563_out_ap_vld;
reg add65562_out_ap_vld;
...
reg   [63:0] add65562_fu_162;
wire   [63:0] add_ln67_4_fu_1762_p2;
reg   [63:0] add65_1166563_fu_166;
wire   [63:0] add_ln67_10_fu_1840_p2;
reg   [63:0] add65_2189564_fu_170;
wire   [63:0] add_ln67_17_fu_2682_p2;
reg   [63:0] add65_3212565_fu_174;
wire   [63:0] add_ln67_25_fu_2692_p2;
reg   [63:0] add65_4235566_fu_178;
wire   [63:0] add_ln67_34_fu_2702_p2;
reg   [63:0] add65_1567_fu_182;
wire   [63:0] add_ln67_44_fu_2722_p2;
reg   [63:0] add65_1_132568_fu_186;
wire   [63:0] add_ln67_53_fu_2732_p2;
reg   [63:0] add65_1_255569_fu_190;
wire   [63:0] add_ln67_61_fu_2742_p2;
reg   [63:0] add65_1_378570_fu_194;
wire   [63:0] add_ln67_68_fu_2752_p2;
reg   [63:0] add65_1_4101571_fu_198;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_16_reg_3049 == 1'd1))) begin
        add65562_out_ap_vld = 1'b1;
    end else begin
        add65562_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_16_reg_3049 == 1'd1))) begin
        add65_1166563_out_ap_vld = 1'b1;
    end else begin
        add65_1166563_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_16_reg_3049 == 1'd1))) begin
        add65_1567_out_ap_vld = 1'b1;
    end else begin
        add65_1567_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_16_reg_3049 == 1'd1))) begin
        add65_1_132568_out_ap_vld = 1'b1;
    end else begin
        add65_1_132568_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_16_reg_3049 == 1'd1))) begin
        add65_1_255569_out_ap_vld = 1'b1;
    end else begin
        add65_1_255569_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_16_reg_3049 == 1'd1))) begin
        add65_1_378570_out_ap_vld = 1'b1;
    end else begin
        add65_1_378570_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_16_reg_3049 == 1'd1))) begin
        add65_1_4101571_out_ap_vld = 1'b1;
    end else begin
        add65_1_4101571_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_16_reg_3049 == 1'd1))) begin
        add65_2189564_out_ap_vld = 1'b1;
    end else begin
        add65_2189564_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_16_reg_3049 == 1'd1))) begin
        add65_3212565_out_ap_vld = 1'b1;
    end else begin
        add65_3212565_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_16_reg_3049 == 1'd1))) begin
        add65_4235566_out_ap_vld = 1'b1;
    end else begin
        add65_4235566_out_ap_vld = 1'b0;
    end
end
...
assign add65562_out = add65562_fu_162;

assign add65_1166563_out = add65_1166563_fu_166;

assign add65_1567_out = add65_1567_fu_182;

assign add65_1_132568_out = add65_1_132568_fu_186;

assign add65_1_255569_out = add65_1_255569_fu_190;

assign add65_1_378570_out = add65_1_378570_fu_194;

assign add65_1_4101571_out = add65_1_4101571_fu_198;

assign add65_2189564_out = add65_2189564_fu_170;

assign add65_3212565_out = add65_3212565_fu_174;

assign add65_4235566_out = add65_4235566_fu_178;
...
assign add_ln67_10_fu_1840_p2 = (add65_1166563_fu_166 + add_ln67_9_fu_1834_p2);

assign add_ln67_11_fu_1975_p2 = (and_ln67_3_fu_1950_p2 + mul_ln67_15_fu_462_p2);
...
assign add_ln67_17_fu_2682_p2 = (add65_2189564_fu_170 + add_ln67_16_fu_2678_p2);
...
assign add_ln67_25_fu_2692_p2 = (add65_3212565_fu_174 + add_ln67_24_fu_2688_p2);
...
assign add_ln67_34_fu_2702_p2 = (add65_4235566_fu_178 + add_ln67_33_fu_2698_p2);
...
assign add_ln67_44_fu_2722_p2 = (add_ln67_43_fu_2717_p2 + add65_1567_fu_182);
...
assign add_ln67_4_fu_1762_p2 = (add65562_fu_162 + add_ln67_3_fu_1756_p2);
...
assign add_ln67_53_fu_2732_p2 = (add65_1_132568_fu_186 + add_ln67_52_fu_2728_p2);
...
assign add_ln67_61_fu_2742_p2 = (add65_1_255569_fu_190 + add_ln67_60_fu_2738_p2);
...
assign add_ln67_68_fu_2752_p2 = (add65_1_378570_fu_194 + add_ln67_67_fu_2748_p2);
...
assign add_ln67_74_fu_2636_p2 = (add65_1_4101571_fu_198 + add_ln67_73_fu_2630_p2);
...
assign and_ln66_2_fu_1913_p2 = (icmp_ln67_reg_3242 & cmp32_1104_reg_3129);

assign and_ln66_3_fu_2111_p2 = (trunc_ln39_reg_3053 & icmp_ln66_2_reg_3260);

assign and_ln66_4_fu_2140_p2 = (icmp_ln67_1_reg_3254 & cmp32_1104_reg_3129);
...
assign select_ln67_2_fu_1702_p3 = ((trunc_ln39_reg_3053[0:0] == 1'b1) ? shl_ln67_2_fu_1697_p2 : tmp_10_reg_3194);

assign select_ln67_3_fu_1723_p3 = ((trunc_ln39_reg_3053[0:0] == 1'b1) ? tmp_2_reg_3182 : shl_ln67_3_fu_1718_p2);
...
assign shl_ln67_2_fu_1697_p2 = tmp_10_reg_3194 << 32'd1;

assign shl_ln67_3_fu_1718_p2 = tmp_2_reg_3182 << 32'd1;
...
assign zext_ln67_2_fu_1668_p1 = $unsigned(tmp_10_reg_3194);

assign zext_ln67_3_fu_1686_p1 = select_ln67_1_fu_1679_p3;

assign zext_ln67_4_fu_1692_p1 = $unsigned(tmp_2_reg_3182);
