...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_39_1 (
        ...
        arg2_r_3_reload,
        add65_942_out,
        add65_942_out_ap_vld,
        add65_841_out,
        add65_841_out_ap_vld,
        add65_740_out,
        add65_740_out_ap_vld,
        add65_639_out,
        add65_639_out_ap_vld,
        add65_538_out,
        add65_538_out_ap_vld,
        add65_437_out,
        add65_437_out_ap_vld,
        add65_336_out,
        add65_336_out_ap_vld,
        add65_235_out,
        add65_235_out_ap_vld,
        add65_134_out,
        add65_134_out_ap_vld,
        add6533_out,
        add6533_out_ap_vld
);
...
output  [63:0] add65_942_out;
output   add65_942_out_ap_vld;
output  [63:0] add65_841_out;
output   add65_841_out_ap_vld;
output  [63:0] add65_740_out;
output   add65_740_out_ap_vld;
output  [63:0] add65_639_out;
output   add65_639_out_ap_vld;
output  [63:0] add65_538_out;
output   add65_538_out_ap_vld;
output  [63:0] add65_437_out;
output   add65_437_out_ap_vld;
output  [63:0] add65_336_out;
output   add65_336_out_ap_vld;
output  [63:0] add65_235_out;
output   add65_235_out_ap_vld;
output  [63:0] add65_134_out;
output   add65_134_out_ap_vld;
output  [63:0] add6533_out;
output   add6533_out_ap_vld;

reg ap_idle;
reg add65_942_out_ap_vld;
reg add65_841_out_ap_vld;
reg add65_740_out_ap_vld;
reg add65_639_out_ap_vld;
reg add65_538_out_ap_vld;
reg add65_437_out_ap_vld;
reg add65_336_out_ap_vld;
reg add65_235_out_ap_vld;
reg add65_134_out_ap_vld;
reg add6533_out_ap_vld;
...
always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add6533_out_ap_vld = 1'b1;
    end else begin
        add6533_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_134_out_ap_vld = 1'b1;
    end else begin
        add65_134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_235_out_ap_vld = 1'b1;
    end else begin
        add65_235_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_336_out_ap_vld = 1'b1;
    end else begin
        add65_336_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_437_out_ap_vld = 1'b1;
    end else begin
        add65_437_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_538_out_ap_vld = 1'b1;
    end else begin
        add65_538_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_639_out_ap_vld = 1'b1;
    end else begin
        add65_639_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_740_out_ap_vld = 1'b1;
    end else begin
        add65_740_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_841_out_ap_vld = 1'b1;
    end else begin
        add65_841_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_942_out_ap_vld = 1'b1;
    end else begin
        add65_942_out_ap_vld = 1'b0;
    end
end
...
assign add6533_out = add6533_fu_164;

assign add65_134_out = add65_134_fu_168;

assign add65_235_out = add65_235_fu_172;

assign add65_336_out = add65_336_fu_176;

assign add65_437_out = add65_437_fu_180;

assign add65_538_out = add65_538_fu_184;

assign add65_639_out = add65_639_fu_188;

assign add65_740_out = add65_740_fu_192;

assign add65_841_out = add65_841_fu_196;

assign add65_942_out = add65_942_fu_200;
...
assign add_ln67_10_fu_1623_p2 = (add65_538_fu_184 + add_ln67_9_fu_1617_p2);

assign add_ln67_11_fu_1684_p2 = (and_ln67_11_fu_1678_p2 + and_ln67_10_fu_1664_p2);

assign add_ln67_12_fu_1690_p2 = (add65_639_fu_188 + add_ln67_11_fu_1684_p2);

assign add_ln67_13_fu_1743_p2 = (and_ln67_12_fu_1724_p2 + and_ln67_13_fu_1737_p2);

assign add_ln67_14_fu_1749_p2 = (add65_740_fu_192 + add_ln67_13_fu_1743_p2);

assign add_ln67_15_fu_1793_p2 = (and_ln67_14_fu_1773_p2 + and_ln67_15_fu_1787_p2);

assign add_ln67_16_fu_1799_p2 = (add65_841_fu_196 + add_ln67_15_fu_1793_p2);

assign add_ln67_17_fu_1860_p2 = (and_ln67_16_fu_1840_p2 + and_ln67_17_fu_1854_p2);

assign add_ln67_18_fu_1866_p2 = (add65_942_fu_200 + add_ln67_17_fu_1860_p2);

assign add_ln67_1_fu_1319_p2 = (and_ln67_1_fu_1313_p2 + and_ln67_fu_1300_p2);

assign add_ln67_2_fu_1325_p2 = (add65_134_fu_168 + add_ln67_1_fu_1319_p2);

assign add_ln67_3_fu_1390_p2 = (and_ln67_3_fu_1384_p2 + and_ln67_2_fu_1370_p2);

assign add_ln67_4_fu_1396_p2 = (add65_235_fu_172 + add_ln67_3_fu_1390_p2);

assign add_ln67_5_fu_1470_p2 = (and_ln67_5_fu_1464_p2 + and_ln67_4_fu_1451_p2);

assign add_ln67_6_fu_1476_p2 = (add65_336_fu_176 + add_ln67_5_fu_1470_p2);

assign add_ln67_7_fu_1539_p2 = (and_ln67_7_fu_1533_p2 + and_ln67_6_fu_1519_p2);

assign add_ln67_8_fu_1545_p2 = (add65_437_fu_180 + add_ln67_7_fu_1539_p2);

assign add_ln67_9_fu_1617_p2 = (and_ln67_9_fu_1611_p2 + and_ln67_8_fu_1598_p2);

assign add_ln67_fu_1244_p2 = (mul_ln67_fu_398_p2 + add6533_fu_164);
