...
#pragma HLS ARRAY_PARTITION variable=out1_w type=complete dim=1
 ...
 VITIS_LOOP_39_1: for(int i1 = 9; i1 >= 0; i1 -= 2)
    {
#pragma HLS PIPELINE II=1
 VITIS_LOOP_42_2: for(int i2 = 0; i2 < 10; i2 += 1)
        {
#pragma HLS PIPELINE II=1
 VITIS_LOOP_45_3: for (int i = 0; i < 2; i++)
            {
#pragma HLS UNROLL
...
#pragma HLS UNROLL
 int c = ((i1-i) % 2 == 1 && (i2+j) % 2 == 1 && (i1-i + i2+j >= 10 && i1-i <= 9))? c_2 : c_1;
        ...
        VITIS_LOOP_57_5: for(int i2 = 0; i2 < 10; i2 += 1)
        {
#pragma HLS PIPELINE II=1
 VITIS_LOOP_60_6: for (int i = 0; i < 2; i++)
            {
#pragma HLS UNROLL
 VITIS_LOOP_63_7: for (int j = 0; j < 1; j++)
                {
#pragma HLS UNROLL
