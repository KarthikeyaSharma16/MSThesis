...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_39_1 (
        ...
        arg2_r_3_reload,
        add65_962_out,
        add65_962_out_ap_vld,
        add65_861_out,
        add65_861_out_ap_vld,
        add65_760_out,
        add65_760_out_ap_vld,
        add65_659_out,
        add65_659_out_ap_vld,
        add65_558_out,
        add65_558_out_ap_vld,
        add65_457_out,
        add65_457_out_ap_vld,
        add65_356_out,
        add65_356_out_ap_vld,
        add65_255_out,
        add65_255_out_ap_vld,
        add65_154_out,
        add65_154_out_ap_vld,
        add6553_out,
        add6553_out_ap_vld
);
...
output  [63:0] add65_962_out;
output   add65_962_out_ap_vld;
output  [63:0] add65_861_out;
output   add65_861_out_ap_vld;
output  [63:0] add65_760_out;
output   add65_760_out_ap_vld;
output  [63:0] add65_659_out;
output   add65_659_out_ap_vld;
output  [63:0] add65_558_out;
output   add65_558_out_ap_vld;
output  [63:0] add65_457_out;
output   add65_457_out_ap_vld;
output  [63:0] add65_356_out;
output   add65_356_out_ap_vld;
output  [63:0] add65_255_out;
output   add65_255_out_ap_vld;
output  [63:0] add65_154_out;
output   add65_154_out_ap_vld;
output  [63:0] add6553_out;
output   add6553_out_ap_vld;

reg ap_idle;
reg add65_962_out_ap_vld;
reg add65_861_out_ap_vld;
reg add65_760_out_ap_vld;
reg add65_659_out_ap_vld;
reg add65_558_out_ap_vld;
reg add65_457_out_ap_vld;
reg add65_356_out_ap_vld;
reg add65_255_out_ap_vld;
reg add65_154_out_ap_vld;
reg add6553_out_ap_vld;
...
wire   [4:0] add_ln51_4_fu_1209_p2;
...
always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add6553_out_ap_vld = 1'b1;
    end else begin
        add6553_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_154_out_ap_vld = 1'b1;
    end else begin
        add65_154_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_255_out_ap_vld = 1'b1;
    end else begin
        add65_255_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_356_out_ap_vld = 1'b1;
    end else begin
        add65_356_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_457_out_ap_vld = 1'b1;
    end else begin
        add65_457_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_558_out_ap_vld = 1'b1;
    end else begin
        add65_558_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_659_out_ap_vld = 1'b1;
    end else begin
        add65_659_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_760_out_ap_vld = 1'b1;
    end else begin
        add65_760_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_861_out_ap_vld = 1'b1;
    end else begin
        add65_861_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_962_out_ap_vld = 1'b1;
    end else begin
        add65_962_out_ap_vld = 1'b0;
    end
end
...
assign add6553_out = add6553_fu_164;

assign add65_154_out = add65_154_fu_168;

assign add65_255_out = add65_255_fu_172;

assign add65_356_out = add65_356_fu_176;

assign add65_457_out = add65_457_fu_180;

assign add65_558_out = add65_558_fu_184;

assign add65_659_out = add65_659_fu_188;

assign add65_760_out = add65_760_fu_192;

assign add65_861_out = add65_861_fu_196;

assign add65_962_out = add65_962_fu_200;
...
assign add_ln51_2_fu_800_p2 = (ap_sig_allocacmp_i1_1 + 5'd5);

assign add_ln51_3_fu_893_p2 = (ap_sig_allocacmp_i1_1 + 5'd7);

assign add_ln51_4_fu_1209_p2 = (i1_1_reg_2138 + 5'd9);
...
assign add_ln67_10_fu_1623_p2 = (add65_558_fu_184 + add_ln67_9_fu_1617_p2);

assign add_ln67_11_fu_1684_p2 = (and_ln67_11_fu_1678_p2 + and_ln67_10_fu_1664_p2);

assign add_ln67_12_fu_1690_p2 = (add65_659_fu_188 + add_ln67_11_fu_1684_p2);

assign add_ln67_13_fu_1743_p2 = (and_ln67_12_fu_1724_p2 + and_ln67_13_fu_1737_p2);

assign add_ln67_14_fu_1749_p2 = (add65_760_fu_192 + add_ln67_13_fu_1743_p2);

assign add_ln67_15_fu_1793_p2 = (and_ln67_14_fu_1773_p2 + and_ln67_15_fu_1787_p2);

assign add_ln67_16_fu_1799_p2 = (add65_861_fu_196 + add_ln67_15_fu_1793_p2);

assign add_ln67_17_fu_1860_p2 = (and_ln67_16_fu_1840_p2 + and_ln67_17_fu_1854_p2);

assign add_ln67_18_fu_1866_p2 = (add65_962_fu_200 + add_ln67_17_fu_1860_p2);

assign add_ln67_1_fu_1319_p2 = (and_ln67_1_fu_1313_p2 + and_ln67_fu_1300_p2);

assign add_ln67_2_fu_1325_p2 = (add65_154_fu_168 + add_ln67_1_fu_1319_p2);

assign add_ln67_3_fu_1390_p2 = (and_ln67_3_fu_1384_p2 + and_ln67_2_fu_1370_p2);

assign add_ln67_4_fu_1396_p2 = (add65_255_fu_172 + add_ln67_3_fu_1390_p2);

assign add_ln67_5_fu_1470_p2 = (and_ln67_5_fu_1464_p2 + and_ln67_4_fu_1451_p2);

assign add_ln67_6_fu_1476_p2 = (add65_356_fu_176 + add_ln67_5_fu_1470_p2);

assign add_ln67_7_fu_1539_p2 = (and_ln67_7_fu_1533_p2 + and_ln67_6_fu_1519_p2);

assign add_ln67_8_fu_1545_p2 = (add65_457_fu_180 + add_ln67_7_fu_1539_p2);

assign add_ln67_9_fu_1617_p2 = (and_ln67_9_fu_1611_p2 + and_ln67_8_fu_1598_p2);

assign add_ln67_fu_1244_p2 = (mul_ln67_fu_398_p2 + add6553_fu_164);
...
assign icmp_ln51_2_fu_806_p2 = (($signed(add_ln51_2_fu_800_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);

assign icmp_ln51_3_fu_899_p2 = ((add_ln51_3_fu_893_p2 > 5'd9) ? 1'b1 : 1'b0);
...
assign icmp_ln66_2_fu_1052_p2 = (($signed(add_ln51_2_fu_800_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln66_3_fu_1058_p2 = ((add_ln51_3_fu_893_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln66_4_fu_1805_p2 = ((add_ln51_4_fu_1209_p2 < 5'd10) ? 1'b1 : 1'b0);
