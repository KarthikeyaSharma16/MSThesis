...
attribute shreg_extract : string;
    ...
    signal icmp_ln86_fu_210_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln86_fu_216_p2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    mux_10_4_27_1_1_U134 : component fiat_25519_carry_mul_mux_10_4_27_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 27,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln86_fu_210_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_78 <= add_ln86_fu_216_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln86_fu_210_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln86_fu_216_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv4_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln86_fu_210_p2)
    begin
        if (((icmp_ln86_fu_210_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln86_fu_210_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv4_A) else "0";
    ...
    tmp_s_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln74),27));
    tmp_s_fu_222_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln14),27));
    tmp_s_fu_222_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln75),27));
    tmp_s_fu_222_p4 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln77),27));
    tmp_s_fu_222_p5 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln78),27));
    tmp_s_fu_222_p6 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln79),27));
    tmp_s_fu_222_p7 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln80),27));
    tmp_s_fu_222_p8 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln81),27));
    tmp_s_fu_222_p9 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln82),27));
end behav;
