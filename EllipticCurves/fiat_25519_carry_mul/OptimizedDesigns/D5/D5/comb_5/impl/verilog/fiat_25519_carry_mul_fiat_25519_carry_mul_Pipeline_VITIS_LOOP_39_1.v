...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_39_1 (
        ...
        arg2_r_3_reload,
        add65_4_181_out,
        add65_4_181_out_ap_vld,
        add65_480_out,
        add65_480_out_ap_vld,
        add65_3_179_out,
        add65_3_179_out_ap_vld,
        add65_378_out,
        add65_378_out_ap_vld,
        add65_2_177_out,
        add65_2_177_out_ap_vld,
        add65_276_out,
        add65_276_out_ap_vld,
        add65_1_175_out,
        add65_1_175_out_ap_vld,
        add65_174_out,
        add65_174_out_ap_vld,
        add65_13273_out,
        add65_13273_out_ap_vld,
        add6572_out,
        add6572_out_ap_vld
);
...
output  [63:0] add65_4_181_out;
output   add65_4_181_out_ap_vld;
output  [63:0] add65_480_out;
output   add65_480_out_ap_vld;
output  [63:0] add65_3_179_out;
output   add65_3_179_out_ap_vld;
output  [63:0] add65_378_out;
output   add65_378_out_ap_vld;
output  [63:0] add65_2_177_out;
output   add65_2_177_out_ap_vld;
output  [63:0] add65_276_out;
output   add65_276_out_ap_vld;
output  [63:0] add65_1_175_out;
output   add65_1_175_out_ap_vld;
output  [63:0] add65_174_out;
output   add65_174_out_ap_vld;
output  [63:0] add65_13273_out;
output   add65_13273_out_ap_vld;
output  [63:0] add6572_out;
output   add6572_out_ap_vld;

reg ap_idle;
reg add65_4_181_out_ap_vld;
reg add65_480_out_ap_vld;
reg add65_3_179_out_ap_vld;
reg add65_378_out_ap_vld;
reg add65_2_177_out_ap_vld;
reg add65_276_out_ap_vld;
reg add65_1_175_out_ap_vld;
reg add65_174_out_ap_vld;
reg add65_13273_out_ap_vld;
...
wire   [4:0] empty_22_fu_1137_p2;
wire   [4:0] empty_23_fu_1156_p2;
wire   [4:0] empty_24_fu_1175_p2;
wire   [4:0] empty_25_fu_1194_p2;
...
always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_13273_out_ap_vld = 1'b1;
    end else begin
        add65_13273_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_174_out_ap_vld = 1'b1;
    end else begin
        add65_174_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_1_175_out_ap_vld = 1'b1;
    end else begin
        add65_1_175_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_276_out_ap_vld = 1'b1;
    end else begin
        add65_276_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_2_177_out_ap_vld = 1'b1;
    end else begin
        add65_2_177_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_3_179_out_ap_vld = 1'b1;
    end else begin
        add65_3_179_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_480_out_ap_vld = 1'b1;
    end else begin
        add65_480_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_4_181_out_ap_vld = 1'b1;
    end else begin
        add65_4_181_out_ap_vld = 1'b0;
    end
end
...
assign add65_13273_out = add65_13273_fu_168;

assign add65_174_out = add65_174_fu_172;

assign add65_1_175_out = add65_1_175_fu_176;

assign add65_276_out = add65_276_fu_180;

assign add65_2_177_out = add65_2_177_fu_184;

assign add65_378_out = add65_378_fu_188;

assign add65_3_179_out = add65_3_179_fu_192;

assign add65_480_out = add65_480_fu_196;

assign add65_4_181_out = add65_4_181_fu_200;
...
assign add_ln67_10_fu_1623_p2 = (add65_2_177_fu_184 + add_ln67_9_fu_1617_p2);

assign add_ln67_11_fu_1684_p2 = (and_ln67_11_fu_1678_p2 + and_ln67_10_fu_1664_p2);

assign add_ln67_12_fu_1690_p2 = (add65_378_fu_188 + add_ln67_11_fu_1684_p2);

assign add_ln67_13_fu_1743_p2 = (and_ln67_12_fu_1724_p2 + and_ln67_13_fu_1737_p2);

assign add_ln67_14_fu_1749_p2 = (add65_3_179_fu_192 + add_ln67_13_fu_1743_p2);

assign add_ln67_15_fu_1793_p2 = (and_ln67_14_fu_1773_p2 + and_ln67_15_fu_1787_p2);

assign add_ln67_16_fu_1799_p2 = (add65_480_fu_196 + add_ln67_15_fu_1793_p2);

assign add_ln67_17_fu_1860_p2 = (and_ln67_16_fu_1840_p2 + and_ln67_17_fu_1854_p2);

assign add_ln67_18_fu_1866_p2 = (add65_4_181_fu_200 + add_ln67_17_fu_1860_p2);

assign add_ln67_1_fu_1319_p2 = (and_ln67_1_fu_1313_p2 + and_ln67_fu_1300_p2);

assign add_ln67_2_fu_1325_p2 = (add65_13273_fu_168 + add_ln67_1_fu_1319_p2);

assign add_ln67_3_fu_1390_p2 = (and_ln67_3_fu_1384_p2 + and_ln67_2_fu_1370_p2);

assign add_ln67_4_fu_1396_p2 = (add65_174_fu_172 + add_ln67_3_fu_1390_p2);

assign add_ln67_5_fu_1470_p2 = (and_ln67_5_fu_1464_p2 + and_ln67_4_fu_1451_p2);

assign add_ln67_6_fu_1476_p2 = (add65_1_175_fu_176 + add_ln67_5_fu_1470_p2);

assign add_ln67_7_fu_1539_p2 = (and_ln67_7_fu_1533_p2 + and_ln67_6_fu_1519_p2);

assign add_ln67_8_fu_1545_p2 = (add65_276_fu_180 + add_ln67_7_fu_1539_p2);

assign add_ln67_9_fu_1617_p2 = (and_ln67_9_fu_1611_p2 + and_ln67_8_fu_1598_p2);

assign add_ln67_fu_1244_p2 = (mul_ln67_fu_398_p2 + add6572_fu_164);
...
assign empty_22_fu_1137_p2 = (i1_1_reg_2138 + 5'd2);

assign empty_23_fu_1156_p2 = (i1_1_reg_2138 + 5'd4);

assign empty_24_fu_1175_p2 = (i1_1_reg_2138 + 5'd6);

assign empty_25_fu_1194_p2 = (i1_1_reg_2138 + 5'd8);
...
assign icmp_ln52_1_fu_1165_p2 = (($signed(empty_23_fu_1156_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);

assign icmp_ln52_2_fu_1184_p2 = (($signed(empty_24_fu_1175_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);

assign icmp_ln52_3_fu_1203_p2 = ((empty_25_fu_1194_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln52_fu_1146_p2 = (($signed(empty_22_fu_1137_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);
...
assign icmp_ln67_1_fu_1505_p2 = (($signed(empty_23_fu_1156_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln67_2_fu_1650_p2 = (($signed(empty_24_fu_1175_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln67_3_fu_1759_p2 = ((empty_25_fu_1194_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln67_fu_1356_p2 = (($signed(empty_22_fu_1137_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);
