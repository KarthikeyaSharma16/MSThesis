...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_39_1 (
        ...
        arg2_r_3_reload,
        add65_4_161_out,
        add65_4_161_out_ap_vld,
        add65_460_out,
        add65_460_out_ap_vld,
        add65_3_159_out,
        add65_3_159_out_ap_vld,
        add65_358_out,
        add65_358_out_ap_vld,
        add65_2_157_out,
        add65_2_157_out_ap_vld,
        add65_256_out,
        add65_256_out_ap_vld,
        add65_1_155_out,
        add65_1_155_out_ap_vld,
        add65_154_out,
        add65_154_out_ap_vld,
        add65_13253_out,
        add65_13253_out_ap_vld,
        add6552_out,
        add6552_out_ap_vld
);
...
output  [63:0] add65_4_161_out;
output   add65_4_161_out_ap_vld;
output  [63:0] add65_460_out;
output   add65_460_out_ap_vld;
output  [63:0] add65_3_159_out;
output   add65_3_159_out_ap_vld;
output  [63:0] add65_358_out;
output   add65_358_out_ap_vld;
output  [63:0] add65_2_157_out;
output   add65_2_157_out_ap_vld;
output  [63:0] add65_256_out;
output   add65_256_out_ap_vld;
output  [63:0] add65_1_155_out;
output   add65_1_155_out_ap_vld;
output  [63:0] add65_154_out;
output   add65_154_out_ap_vld;
output  [63:0] add65_13253_out;
output   add65_13253_out_ap_vld;
output  [63:0] add6552_out;
output   add6552_out_ap_vld;

reg ap_idle;
reg add65_4_161_out_ap_vld;
reg add65_460_out_ap_vld;
reg add65_3_159_out_ap_vld;
reg add65_358_out_ap_vld;
reg add65_2_157_out_ap_vld;
reg add65_256_out_ap_vld;
reg add65_1_155_out_ap_vld;
reg add65_154_out_ap_vld;
reg add65_13253_out_ap_vld;
reg add6552_out_ap_vld;
...
always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add6552_out_ap_vld = 1'b1;
    end else begin
        add6552_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_13253_out_ap_vld = 1'b1;
    end else begin
        add65_13253_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_1_155_out_ap_vld = 1'b1;
    end else begin
        add65_1_155_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_256_out_ap_vld = 1'b1;
    end else begin
        add65_256_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_2_157_out_ap_vld = 1'b1;
    end else begin
        add65_2_157_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_3_159_out_ap_vld = 1'b1;
    end else begin
        add65_3_159_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_460_out_ap_vld = 1'b1;
    end else begin
        add65_460_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_4_161_out_ap_vld = 1'b1;
    end else begin
        add65_4_161_out_ap_vld = 1'b0;
    end
end
...
assign add6552_out = add6552_fu_164;

assign add65_13253_out = add65_13253_fu_168;

assign add65_154_out = add65_154_fu_172;

assign add65_1_155_out = add65_1_155_fu_176;

assign add65_256_out = add65_256_fu_180;

assign add65_2_157_out = add65_2_157_fu_184;

assign add65_358_out = add65_358_fu_188;

assign add65_3_159_out = add65_3_159_fu_192;

assign add65_460_out = add65_460_fu_196;

assign add65_4_161_out = add65_4_161_fu_200;
...
assign add_ln67_10_fu_1623_p2 = (add65_2_157_fu_184 + add_ln67_9_fu_1617_p2);

assign add_ln67_11_fu_1684_p2 = (and_ln67_11_fu_1678_p2 + and_ln67_10_fu_1664_p2);

assign add_ln67_12_fu_1690_p2 = (add65_358_fu_188 + add_ln67_11_fu_1684_p2);

assign add_ln67_13_fu_1743_p2 = (and_ln67_12_fu_1724_p2 + and_ln67_13_fu_1737_p2);

assign add_ln67_14_fu_1749_p2 = (add65_3_159_fu_192 + add_ln67_13_fu_1743_p2);

assign add_ln67_15_fu_1793_p2 = (and_ln67_14_fu_1773_p2 + and_ln67_15_fu_1787_p2);

assign add_ln67_16_fu_1799_p2 = (add65_460_fu_196 + add_ln67_15_fu_1793_p2);

assign add_ln67_17_fu_1860_p2 = (and_ln67_16_fu_1840_p2 + and_ln67_17_fu_1854_p2);

assign add_ln67_18_fu_1866_p2 = (add65_4_161_fu_200 + add_ln67_17_fu_1860_p2);

assign add_ln67_1_fu_1319_p2 = (and_ln67_1_fu_1313_p2 + and_ln67_fu_1300_p2);

assign add_ln67_2_fu_1325_p2 = (add65_13253_fu_168 + add_ln67_1_fu_1319_p2);

assign add_ln67_3_fu_1390_p2 = (and_ln67_3_fu_1384_p2 + and_ln67_2_fu_1370_p2);

assign add_ln67_4_fu_1396_p2 = (add65_154_fu_172 + add_ln67_3_fu_1390_p2);

assign add_ln67_5_fu_1470_p2 = (and_ln67_5_fu_1464_p2 + and_ln67_4_fu_1451_p2);

assign add_ln67_6_fu_1476_p2 = (add65_1_155_fu_176 + add_ln67_5_fu_1470_p2);

assign add_ln67_7_fu_1539_p2 = (and_ln67_7_fu_1533_p2 + and_ln67_6_fu_1519_p2);

assign add_ln67_8_fu_1545_p2 = (add65_256_fu_180 + add_ln67_7_fu_1539_p2);

assign add_ln67_9_fu_1617_p2 = (and_ln67_9_fu_1611_p2 + and_ln67_8_fu_1598_p2);

assign add_ln67_fu_1244_p2 = (mul_ln67_fu_398_p2 + add6552_fu_164);
