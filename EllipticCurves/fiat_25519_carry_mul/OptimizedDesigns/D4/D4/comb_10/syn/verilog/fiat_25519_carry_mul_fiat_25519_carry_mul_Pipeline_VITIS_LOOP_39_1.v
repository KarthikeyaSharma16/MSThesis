...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_39_1 (
        ...
        arg2_r_9_reload,
        add65_940_out,
        add65_940_out_ap_vld,
        add65_839_out,
        add65_839_out_ap_vld,
        add65_738_out,
        add65_738_out_ap_vld,
        add65_637_out,
        add65_637_out_ap_vld,
        add65_536_out,
        add65_536_out_ap_vld,
        add65_435_out,
        add65_435_out_ap_vld,
        add65_334_out,
        add65_334_out_ap_vld,
        add65_233_out,
        add65_233_out_ap_vld,
        add65_132_out,
        add65_132_out_ap_vld,
        add6531_out,
        add6531_out_ap_vld
);
...
output  [63:0] add65_940_out;
output   add65_940_out_ap_vld;
output  [63:0] add65_839_out;
output   add65_839_out_ap_vld;
output  [63:0] add65_738_out;
output   add65_738_out_ap_vld;
output  [63:0] add65_637_out;
output   add65_637_out_ap_vld;
output  [63:0] add65_536_out;
output   add65_536_out_ap_vld;
output  [63:0] add65_435_out;
output   add65_435_out_ap_vld;
output  [63:0] add65_334_out;
output   add65_334_out_ap_vld;
output  [63:0] add65_233_out;
output   add65_233_out_ap_vld;
output  [63:0] add65_132_out;
output   add65_132_out_ap_vld;
output  [63:0] add6531_out;
output   add6531_out_ap_vld;

reg ap_idle;
reg add65_940_out_ap_vld;
reg add65_839_out_ap_vld;
reg add65_738_out_ap_vld;
reg add65_637_out_ap_vld;
reg add65_536_out_ap_vld;
reg add65_435_out_ap_vld;
reg add65_334_out_ap_vld;
reg add65_233_out_ap_vld;
reg add65_132_out_ap_vld;
reg add6531_out_ap_vld;
...
always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add6531_out_ap_vld = 1'b1;
    end else begin
        add6531_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_132_out_ap_vld = 1'b1;
    end else begin
        add65_132_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_233_out_ap_vld = 1'b1;
    end else begin
        add65_233_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_334_out_ap_vld = 1'b1;
    end else begin
        add65_334_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_435_out_ap_vld = 1'b1;
    end else begin
        add65_435_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_536_out_ap_vld = 1'b1;
    end else begin
        add65_536_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_637_out_ap_vld = 1'b1;
    end else begin
        add65_637_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_738_out_ap_vld = 1'b1;
    end else begin
        add65_738_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_839_out_ap_vld = 1'b1;
    end else begin
        add65_839_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_940_out_ap_vld = 1'b1;
    end else begin
        add65_940_out_ap_vld = 1'b0;
    end
end
...
assign add6531_out = add6531_fu_164;

assign add65_132_out = add65_132_fu_168;

assign add65_233_out = add65_233_fu_172;

assign add65_334_out = add65_334_fu_176;

assign add65_435_out = add65_435_fu_180;

assign add65_536_out = add65_536_fu_184;

assign add65_637_out = add65_637_fu_188;

assign add65_738_out = add65_738_fu_192;

assign add65_839_out = add65_839_fu_196;

assign add65_940_out = add65_940_fu_200;
...
assign add_ln54_10_fu_1580_p2 = (add65_536_fu_184 + add_ln54_9_fu_1574_p2);

assign add_ln54_11_fu_1656_p2 = (and_ln54_11_fu_1650_p2 + and_ln54_10_fu_1636_p2);

assign add_ln54_12_fu_1662_p2 = (add65_637_fu_188 + add_ln54_11_fu_1656_p2);

assign add_ln54_13_fu_1719_p2 = (and_ln54_12_fu_1700_p2 + and_ln54_13_fu_1713_p2);

assign add_ln54_14_fu_1725_p2 = (add65_738_fu_192 + add_ln54_13_fu_1719_p2);

assign add_ln54_15_fu_1784_p2 = (and_ln54_14_fu_1764_p2 + and_ln54_15_fu_1778_p2);

assign add_ln54_16_fu_1790_p2 = (add65_839_fu_196 + add_ln54_15_fu_1784_p2);

assign add_ln54_17_fu_1860_p2 = (and_ln54_16_fu_1840_p2 + and_ln54_17_fu_1854_p2);

assign add_ln54_18_fu_1866_p2 = (add65_940_fu_200 + add_ln54_17_fu_1860_p2);

assign add_ln54_1_fu_1238_p2 = (and_ln54_1_fu_1232_p2 + and_ln54_fu_1219_p2);

assign add_ln54_2_fu_1244_p2 = (add65_132_fu_168 + add_ln54_1_fu_1238_p2);

assign add_ln54_3_fu_1324_p2 = (and_ln54_3_fu_1318_p2 + and_ln54_2_fu_1304_p2);

assign add_ln54_4_fu_1330_p2 = (add65_233_fu_172 + add_ln54_3_fu_1324_p2);

assign add_ln54_5_fu_1408_p2 = (and_ln54_5_fu_1402_p2 + and_ln54_4_fu_1389_p2);

assign add_ln54_6_fu_1414_p2 = (add65_334_fu_176 + add_ln54_5_fu_1408_p2);

assign add_ln54_7_fu_1492_p2 = (and_ln54_7_fu_1486_p2 + and_ln54_6_fu_1472_p2);

assign add_ln54_8_fu_1498_p2 = (add65_435_fu_180 + add_ln54_7_fu_1492_p2);

assign add_ln54_9_fu_1574_p2 = (and_ln54_9_fu_1568_p2 + and_ln54_8_fu_1555_p2);

assign add_ln54_fu_1159_p2 = (mul_ln54_fu_398_p2 + add6531_fu_164);
