...
__attribute__((sdx_kernel("fiat_25519_carry_mul", 0))) void fiat_25519_carry_mul(uint32_t out1[10], uint32_t arg1[10], uint32_t arg2[10])
{
#line 15 "/export/hdd/scratch/km304/MSThesis/EllipticCurves/fiat_25519_carry_mul/OptimizedDesigns/D4/run_script.tcl"
#pragma HLSDIRECTIVE TOP name=fiat_25519_carry_mul
# 4 "d4.cpp"

#line 19 "/export/hdd/scratch/km304/MSThesis/EllipticCurves/fiat_25519_carry_mul/OptimizedDesigns/D4/run_script.tcl"
#pragma HLSDIRECTIVE TOP name=fiat_25519_carry_mul
# 4 "d4.cpp"
...
#pragma HLS UNROLL
 int c = ((i1-i) % 2 == 1 && (i2+j) % 2 == 1 && (i1-i + i2+j >= 10 && i1-i <= 9))? c_2 : c_1;
                    ...
                    c = ((i1-i) %2 == 1 && (i2+j)%2 == 1 && (i1-i + i2+j <= 9)) ? c_4 : c_3;
