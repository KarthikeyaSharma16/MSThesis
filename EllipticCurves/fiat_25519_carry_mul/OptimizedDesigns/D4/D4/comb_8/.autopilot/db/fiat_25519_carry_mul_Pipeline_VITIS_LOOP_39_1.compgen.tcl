...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add65_9328_out \
    op interface \
    ports { add65_9328_out { O 64 vector } add65_9328_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add65_8327_out \
    op interface \
    ports { add65_8327_out { O 64 vector } add65_8327_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add65_7326_out \
    op interface \
    ports { add65_7326_out { O 64 vector } add65_7326_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add65_6325_out \
    op interface \
    ports { add65_6325_out { O 64 vector } add65_6325_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add65_5324_out \
    op interface \
    ports { add65_5324_out { O 64 vector } add65_5324_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add65_4323_out \
    op interface \
    ports { add65_4323_out { O 64 vector } add65_4323_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add65_2321_out \
    op interface \
    ports { add65_2321_out { O 64 vector } add65_2321_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add65_1320_out \
    op interface \
    ports { add65_1320_out { O 64 vector } add65_1320_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add65319_out \
    op interface \
    ports { add65319_out { O 64 vector } add65319_out_ap_vld { O 1 bit } } \
} "
}
