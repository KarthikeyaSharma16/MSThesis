...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_39_1 (
        ...
        arg2_r_9_reload,
        add65_936_out,
        add65_936_out_ap_vld,
        add65_835_out,
        add65_835_out_ap_vld,
        add65_734_out,
        add65_734_out_ap_vld,
        add65_633_out,
        add65_633_out_ap_vld,
        add65_532_out,
        add65_532_out_ap_vld,
        add65_431_out,
        add65_431_out_ap_vld,
        add65_330_out,
        add65_330_out_ap_vld,
        add65_229_out,
        add65_229_out_ap_vld,
        add65_128_out,
        add65_128_out_ap_vld,
        add6527_out,
        add6527_out_ap_vld
);
...
output  [63:0] add65_936_out;
output   add65_936_out_ap_vld;
output  [63:0] add65_835_out;
output   add65_835_out_ap_vld;
output  [63:0] add65_734_out;
output   add65_734_out_ap_vld;
output  [63:0] add65_633_out;
output   add65_633_out_ap_vld;
output  [63:0] add65_532_out;
output   add65_532_out_ap_vld;
output  [63:0] add65_431_out;
output   add65_431_out_ap_vld;
output  [63:0] add65_330_out;
output   add65_330_out_ap_vld;
output  [63:0] add65_229_out;
output   add65_229_out_ap_vld;
output  [63:0] add65_128_out;
output   add65_128_out_ap_vld;
output  [63:0] add6527_out;
output   add6527_out_ap_vld;

reg ap_idle;
reg add65_936_out_ap_vld;
reg add65_835_out_ap_vld;
reg add65_734_out_ap_vld;
reg add65_633_out_ap_vld;
reg add65_532_out_ap_vld;
reg add65_431_out_ap_vld;
reg add65_330_out_ap_vld;
reg add65_229_out_ap_vld;
reg add65_128_out_ap_vld;
reg add6527_out_ap_vld;
...
always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add6527_out_ap_vld = 1'b1;
    end else begin
        add6527_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_128_out_ap_vld = 1'b1;
    end else begin
        add65_128_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_229_out_ap_vld = 1'b1;
    end else begin
        add65_229_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_330_out_ap_vld = 1'b1;
    end else begin
        add65_330_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_431_out_ap_vld = 1'b1;
    end else begin
        add65_431_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_532_out_ap_vld = 1'b1;
    end else begin
        add65_532_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_633_out_ap_vld = 1'b1;
    end else begin
        add65_633_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_734_out_ap_vld = 1'b1;
    end else begin
        add65_734_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_835_out_ap_vld = 1'b1;
    end else begin
        add65_835_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_936_out_ap_vld = 1'b1;
    end else begin
        add65_936_out_ap_vld = 1'b0;
    end
end
...
assign add6527_out = add6527_fu_164;

assign add65_128_out = add65_128_fu_168;

assign add65_229_out = add65_229_fu_172;

assign add65_330_out = add65_330_fu_176;

assign add65_431_out = add65_431_fu_180;

assign add65_532_out = add65_532_fu_184;

assign add65_633_out = add65_633_fu_188;

assign add65_734_out = add65_734_fu_192;

assign add65_835_out = add65_835_fu_196;

assign add65_936_out = add65_936_fu_200;

assign add_ln39_fu_1064_p2 = ($signed(ap_sig_allocacmp_i1_1) + $signed(5'd31));

assign add_ln54_10_fu_1580_p2 = (add65_532_fu_184 + add_ln54_9_fu_1574_p2);

assign add_ln54_11_fu_1656_p2 = (and_ln54_11_fu_1650_p2 + and_ln54_10_fu_1636_p2);

assign add_ln54_12_fu_1662_p2 = (add65_633_fu_188 + add_ln54_11_fu_1656_p2);

assign add_ln54_13_fu_1719_p2 = (and_ln54_12_fu_1700_p2 + and_ln54_13_fu_1713_p2);

assign add_ln54_14_fu_1725_p2 = (add65_734_fu_192 + add_ln54_13_fu_1719_p2);

assign add_ln54_15_fu_1784_p2 = (and_ln54_14_fu_1764_p2 + and_ln54_15_fu_1778_p2);

assign add_ln54_16_fu_1790_p2 = (add65_835_fu_196 + add_ln54_15_fu_1784_p2);

assign add_ln54_17_fu_1860_p2 = (and_ln54_16_fu_1840_p2 + and_ln54_17_fu_1854_p2);

assign add_ln54_18_fu_1866_p2 = (add65_936_fu_200 + add_ln54_17_fu_1860_p2);

assign add_ln54_1_fu_1238_p2 = (and_ln54_1_fu_1232_p2 + and_ln54_fu_1219_p2);

assign add_ln54_2_fu_1244_p2 = (add65_128_fu_168 + add_ln54_1_fu_1238_p2);

assign add_ln54_3_fu_1324_p2 = (and_ln54_3_fu_1318_p2 + and_ln54_2_fu_1304_p2);

assign add_ln54_4_fu_1330_p2 = (add65_229_fu_172 + add_ln54_3_fu_1324_p2);

assign add_ln54_5_fu_1408_p2 = (and_ln54_5_fu_1402_p2 + and_ln54_4_fu_1389_p2);

assign add_ln54_6_fu_1414_p2 = (add65_330_fu_176 + add_ln54_5_fu_1408_p2);

assign add_ln54_7_fu_1492_p2 = (and_ln54_7_fu_1486_p2 + and_ln54_6_fu_1472_p2);

assign add_ln54_8_fu_1498_p2 = (add65_431_fu_180 + add_ln54_7_fu_1492_p2);

assign add_ln54_9_fu_1574_p2 = (and_ln54_9_fu_1568_p2 + and_ln54_8_fu_1555_p2);

assign add_ln54_fu_1159_p2 = (mul_ln54_fu_398_p2 + add6527_fu_164);

assign and_ln51_1_fu_725_p2 = (icmp_ln51_1_fu_719_p2 & empty_fu_610_p1);

assign and_ln51_2_fu_824_p2 = (icmp_ln51_2_fu_818_p2 & empty_fu_610_p1);

assign and_ln51_3_fu_923_p2 = (icmp_ln51_3_fu_917_p2 & empty_fu_610_p1);

assign and_ln51_4_fu_1016_p2 = (icmp_ln51_4_fu_1010_p2 & empty_fu_610_p1);

assign and_ln51_fu_626_p2 = (icmp_ln51_fu_620_p2 & empty_fu_610_p1);

assign and_ln53_1_fu_1340_p2 = (icmp_ln53_1_reg_2220 & empty_reg_2163);

assign and_ln53_2_fu_1508_p2 = (icmp_ln53_2_reg_2241 & empty_reg_2163);

assign and_ln53_3_fu_1672_p2 = (icmp_ln53_3_reg_2262 & empty_reg_2163);

assign and_ln53_4_fu_1811_p2 = (icmp_ln53_4_fu_1805_p2 & empty_reg_2163);

assign and_ln53_fu_1169_p2 = (icmp_ln53_reg_2188 & empty_reg_2163);
...
assign empty_23_fu_1250_p2 = (i1_1_reg_2138 + 5'd2);

assign empty_24_fu_713_p2 = (ap_sig_allocacmp_i1_1 + 5'd3);

assign empty_25_fu_1420_p2 = (i1_1_reg_2138 + 5'd4);

assign empty_26_fu_812_p2 = (ap_sig_allocacmp_i1_1 + 5'd5);

assign empty_27_fu_1586_p2 = (i1_1_reg_2138 + 5'd6);

assign empty_28_fu_911_p2 = (ap_sig_allocacmp_i1_1 + 5'd7);

assign empty_29_fu_1731_p2 = (i1_1_reg_2138 + 5'd8);

assign empty_30_fu_1796_p2 = (i1_1_reg_2138 + 5'd9);

assign empty_fu_610_p1 = ap_sig_allocacmp_i1_1[0:0];

assign icmp_ln51_1_fu_719_p2 = (($signed(empty_24_fu_713_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);

assign icmp_ln51_2_fu_818_p2 = (($signed(empty_26_fu_812_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);

assign icmp_ln51_3_fu_917_p2 = ((empty_28_fu_911_p2 > 5'd9) ? 1'b1 : 1'b0);
...
assign icmp_ln52_1_fu_1429_p2 = (($signed(empty_25_fu_1420_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);

assign icmp_ln52_2_fu_1595_p2 = (($signed(empty_27_fu_1586_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);

assign icmp_ln52_3_fu_1740_p2 = ((empty_29_fu_1731_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln52_fu_1259_p2 = (($signed(empty_23_fu_1250_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);

assign icmp_ln53_1_fu_773_p2 = (($signed(empty_24_fu_713_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln53_2_fu_872_p2 = (($signed(empty_26_fu_812_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln53_3_fu_971_p2 = ((empty_28_fu_911_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln53_4_fu_1805_p2 = ((empty_30_fu_1796_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln53_fu_674_p2 = (($signed(empty_22_fu_614_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln54_1_fu_1458_p2 = (($signed(empty_25_fu_1420_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln54_2_fu_1622_p2 = (($signed(empty_27_fu_1586_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln54_3_fu_1750_p2 = ((empty_29_fu_1731_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln54_fu_1290_p2 = (($signed(empty_23_fu_1250_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);
