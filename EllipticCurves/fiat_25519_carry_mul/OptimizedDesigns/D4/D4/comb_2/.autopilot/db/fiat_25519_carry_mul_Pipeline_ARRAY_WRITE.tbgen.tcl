...
set C_modelArgList {
	...
	{ zext_ln61 int 26 regular  }
	{ zext_ln62 int 25 regular  }
	{ out1_w_2 int 27 regular  }
	{ zext_ln64 int 25 regular  }
	{ zext_ln65 int 26 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "arg1","offset": { "type": "dynamic","port_name": "arg1","bundle": "control"},"direction": "READONLY"},{"cName": "arg2","offset": { "type": "dynamic","port_name": "arg2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "zext_ln61", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln62", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "out1_w_2", "interface" : "wire", "bitwidth" : 27, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln64", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln65", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln61 sc_in sc_lv 26 signal 2 } 
	{ zext_ln62 sc_in sc_lv 25 signal 3 } 
	{ out1_w_2 sc_in sc_lv 27 signal 4 } 
	{ zext_ln64 sc_in sc_lv 25 signal 5 } 
	{ zext_ln65 sc_in sc_lv 26 signal 6 } 
	{ zext_ln66 sc_in sc_lv 25 signal 7 } 
	{ zext_ln67 sc_in sc_lv 26 signal 8 } 
	{ zext_ln68 sc_in sc_lv 25 signal 9 } 
	{ zext_ln69 sc_in sc_lv 26 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln61", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln61", "role": "default" }} , 
 	{ "name": "zext_ln62", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "zext_ln62", "role": "default" }} , 
 	...
 	{ "name": "zext_ln65", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "zext_ln65", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_10_4_27_1_1_U134", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln61 { ap_none {  { zext_ln61 in_data 0 26 } } }
	zext_ln62 { ap_none {  { zext_ln62 in_data 0 25 } } }
	out1_w_2 { ap_none {  { out1_w_2 in_data 0 27 } } }
	zext_ln64 { ap_none {  { zext_ln64 in_data 0 25 } } }
	zext_ln65 { ap_none {  { zext_ln65 in_data 0 26 } } }
