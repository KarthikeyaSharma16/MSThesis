...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_39_1 (
        ...
        arg2_r_9_reload,
        add65_4_178_out,
        add65_4_178_out_ap_vld,
        add65_477_out,
        add65_477_out_ap_vld,
        add65_3_176_out,
        add65_3_176_out_ap_vld,
        add65_375_out,
        add65_375_out_ap_vld,
        add65_2_174_out,
        add65_2_174_out_ap_vld,
        add65_273_out,
        add65_273_out_ap_vld,
        add65_1_172_out,
        add65_1_172_out_ap_vld,
        add65_171_out,
        add65_171_out_ap_vld,
        add65_12970_out,
        add65_12970_out_ap_vld,
        add6569_out,
        add6569_out_ap_vld
);
...
output  [63:0] add65_4_178_out;
output   add65_4_178_out_ap_vld;
output  [63:0] add65_477_out;
output   add65_477_out_ap_vld;
output  [63:0] add65_3_176_out;
output   add65_3_176_out_ap_vld;
output  [63:0] add65_375_out;
output   add65_375_out_ap_vld;
output  [63:0] add65_2_174_out;
output   add65_2_174_out_ap_vld;
output  [63:0] add65_273_out;
output   add65_273_out_ap_vld;
output  [63:0] add65_1_172_out;
output   add65_1_172_out_ap_vld;
output  [63:0] add65_171_out;
output   add65_171_out_ap_vld;
output  [63:0] add65_12970_out;
output   add65_12970_out_ap_vld;
output  [63:0] add6569_out;
output   add6569_out_ap_vld;

reg ap_idle;
reg add65_4_178_out_ap_vld;
reg add65_477_out_ap_vld;
reg add65_3_176_out_ap_vld;
reg add65_375_out_ap_vld;
reg add65_2_174_out_ap_vld;
reg add65_273_out_ap_vld;
reg add65_1_172_out_ap_vld;
reg add65_171_out_ap_vld;
reg add65_12970_out_ap_vld;
reg add6569_out_ap_vld;
...
wire   [4:0] add_ln51_4_fu_1796_p2;
...
always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add6569_out_ap_vld = 1'b1;
    end else begin
        add6569_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_12970_out_ap_vld = 1'b1;
    end else begin
        add65_12970_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_171_out_ap_vld = 1'b1;
    end else begin
        add65_171_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_1_172_out_ap_vld = 1'b1;
    end else begin
        add65_1_172_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_273_out_ap_vld = 1'b1;
    end else begin
        add65_273_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_2_174_out_ap_vld = 1'b1;
    end else begin
        add65_2_174_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_3_176_out_ap_vld = 1'b1;
    end else begin
        add65_3_176_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_477_out_ap_vld = 1'b1;
    end else begin
        add65_477_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_16_fu_572_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add65_4_178_out_ap_vld = 1'b1;
    end else begin
        add65_4_178_out_ap_vld = 1'b0;
    end
end
...
assign add6569_out = add6569_fu_164;

assign add65_12970_out = add65_12970_fu_168;

assign add65_171_out = add65_171_fu_172;

assign add65_1_172_out = add65_1_172_fu_176;

assign add65_273_out = add65_273_fu_180;

assign add65_2_174_out = add65_2_174_fu_184;

assign add65_375_out = add65_375_fu_188;

assign add65_3_176_out = add65_3_176_fu_192;

assign add65_477_out = add65_477_fu_196;

assign add65_4_178_out = add65_4_178_fu_200;
...
assign add_ln51_2_fu_812_p2 = (ap_sig_allocacmp_i1_1 + 5'd5);

assign add_ln51_3_fu_911_p2 = (ap_sig_allocacmp_i1_1 + 5'd7);

assign add_ln51_4_fu_1796_p2 = (i1_1_reg_2138 + 5'd9);

assign add_ln51_fu_614_p2 = (ap_sig_allocacmp_i1_1 + 5'd1);

assign add_ln54_10_fu_1580_p2 = (add65_2_174_fu_184 + add_ln54_9_fu_1574_p2);

assign add_ln54_11_fu_1656_p2 = (and_ln54_11_fu_1650_p2 + and_ln54_10_fu_1636_p2);

assign add_ln54_12_fu_1662_p2 = (add65_375_fu_188 + add_ln54_11_fu_1656_p2);

assign add_ln54_13_fu_1719_p2 = (and_ln54_12_fu_1700_p2 + and_ln54_13_fu_1713_p2);

assign add_ln54_14_fu_1725_p2 = (add65_3_176_fu_192 + add_ln54_13_fu_1719_p2);

assign add_ln54_15_fu_1784_p2 = (and_ln54_14_fu_1764_p2 + and_ln54_15_fu_1778_p2);

assign add_ln54_16_fu_1790_p2 = (add65_477_fu_196 + add_ln54_15_fu_1784_p2);

assign add_ln54_17_fu_1860_p2 = (and_ln54_16_fu_1840_p2 + and_ln54_17_fu_1854_p2);

assign add_ln54_18_fu_1866_p2 = (add65_4_178_fu_200 + add_ln54_17_fu_1860_p2);

assign add_ln54_1_fu_1238_p2 = (and_ln54_1_fu_1232_p2 + and_ln54_fu_1219_p2);

assign add_ln54_2_fu_1244_p2 = (add65_12970_fu_168 + add_ln54_1_fu_1238_p2);

assign add_ln54_3_fu_1324_p2 = (and_ln54_3_fu_1318_p2 + and_ln54_2_fu_1304_p2);

assign add_ln54_4_fu_1330_p2 = (add65_171_fu_172 + add_ln54_3_fu_1324_p2);

assign add_ln54_5_fu_1408_p2 = (and_ln54_5_fu_1402_p2 + and_ln54_4_fu_1389_p2);

assign add_ln54_6_fu_1414_p2 = (add65_1_172_fu_176 + add_ln54_5_fu_1408_p2);

assign add_ln54_7_fu_1492_p2 = (and_ln54_7_fu_1486_p2 + and_ln54_6_fu_1472_p2);

assign add_ln54_8_fu_1498_p2 = (add65_273_fu_180 + add_ln54_7_fu_1492_p2);

assign add_ln54_9_fu_1574_p2 = (and_ln54_9_fu_1568_p2 + and_ln54_8_fu_1555_p2);

assign add_ln54_fu_1159_p2 = (mul_ln54_fu_398_p2 + add6569_fu_164);
...
assign empty_22_fu_1250_p2 = (i1_1_reg_2138 + 5'd2);

assign empty_23_fu_1420_p2 = (i1_1_reg_2138 + 5'd4);

assign empty_24_fu_1586_p2 = (i1_1_reg_2138 + 5'd6);

assign empty_25_fu_1731_p2 = (i1_1_reg_2138 + 5'd8);
...
assign icmp_ln51_2_fu_818_p2 = (($signed(add_ln51_2_fu_812_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);

assign icmp_ln51_3_fu_917_p2 = ((add_ln51_3_fu_911_p2 > 5'd9) ? 1'b1 : 1'b0);
...
assign icmp_ln52_1_fu_1429_p2 = (($signed(empty_23_fu_1420_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);

assign icmp_ln52_2_fu_1595_p2 = (($signed(empty_24_fu_1586_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);

assign icmp_ln52_3_fu_1740_p2 = ((empty_25_fu_1731_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln52_fu_1259_p2 = (($signed(empty_22_fu_1250_p2) > $signed(5'd9)) ? 1'b1 : 1'b0);

assign icmp_ln53_1_fu_773_p2 = (($signed(add_ln51_1_fu_713_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln53_2_fu_872_p2 = (($signed(add_ln51_2_fu_812_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln53_3_fu_971_p2 = ((add_ln51_3_fu_911_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln53_4_fu_1805_p2 = ((add_ln51_4_fu_1796_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln53_fu_674_p2 = (($signed(add_ln51_fu_614_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln54_1_fu_1458_p2 = (($signed(empty_23_fu_1420_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln54_2_fu_1622_p2 = (($signed(empty_24_fu_1586_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln54_3_fu_1750_p2 = ((empty_25_fu_1731_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln54_fu_1290_p2 = (($signed(empty_22_fu_1250_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);
