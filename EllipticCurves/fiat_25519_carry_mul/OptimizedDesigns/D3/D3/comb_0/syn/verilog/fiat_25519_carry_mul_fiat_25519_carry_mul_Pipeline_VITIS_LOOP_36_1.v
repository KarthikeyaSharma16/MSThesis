...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_997_out,
        add55_997_out_ap_vld,
        add55_896_out,
        add55_896_out_ap_vld,
        add55_795_out,
        add55_795_out_ap_vld,
        add55_694_out,
        add55_694_out_ap_vld,
        add55_593_out,
        add55_593_out_ap_vld,
        add55_492_out,
        add55_492_out_ap_vld,
        add55_391_out,
        add55_391_out_ap_vld,
        add55_290_out,
        add55_290_out_ap_vld,
        add55_189_out,
        add55_189_out_ap_vld
);
...
output  [63:0] add55_997_out;
output   add55_997_out_ap_vld;
output  [63:0] add55_896_out;
output   add55_896_out_ap_vld;
output  [63:0] add55_795_out;
output   add55_795_out_ap_vld;
output  [63:0] add55_694_out;
output   add55_694_out_ap_vld;
output  [63:0] add55_593_out;
output   add55_593_out_ap_vld;
output  [63:0] add55_492_out;
output   add55_492_out_ap_vld;
output  [63:0] add55_391_out;
output   add55_391_out_ap_vld;
output  [63:0] add55_290_out;
output   add55_290_out_ap_vld;
output  [63:0] add55_189_out;
output   add55_189_out_ap_vld;

reg ap_idle;
reg add55_997_out_ap_vld;
reg add55_896_out_ap_vld;
reg add55_795_out_ap_vld;
reg add55_694_out_ap_vld;
reg add55_593_out_ap_vld;
reg add55_492_out_ap_vld;
reg add55_391_out_ap_vld;
reg add55_290_out_ap_vld;
reg add55_189_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_189_out_ap_vld = 1'b1;
    end else begin
        add55_189_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_492_out_ap_vld = 1'b1;
    end else begin
        add55_492_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_593_out_ap_vld = 1'b1;
    end else begin
        add55_593_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_694_out_ap_vld = 1'b1;
    end else begin
        add55_694_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_795_out_ap_vld = 1'b1;
    end else begin
        add55_795_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_896_out_ap_vld = 1'b1;
    end else begin
        add55_896_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_997_out_ap_vld = 1'b1;
    end else begin
        add55_997_out_ap_vld = 1'b0;
    end
end
...
assign add55_189_out = arr_9_fu_122;

assign add55_290_out = arr_10_fu_126;

assign add55_391_out = arr_11_fu_130;

assign add55_492_out = arr_12_fu_134;

assign add55_593_out = arr_13_fu_138;

assign add55_694_out = arr_14_fu_142;

assign add55_795_out = arr_15_fu_146;

assign add55_896_out = arr_16_fu_150;

assign add55_997_out = arr_17_fu_154;

assign add_ln36_fu_814_p2 = ($signed(ap_sig_allocacmp_i1_5) + $signed(4'd15));

assign add_ln49_10_fu_1042_p2 = (i1_5_reg_1319 + 4'd6);
...
assign add_ln49_8_fu_1007_p2 = (i1_5_reg_1319 + 4'd5);
