...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_9_reload,
        add120_987_out,
        add120_987_out_ap_vld,
        add120_886_out,
        add120_886_out_ap_vld,
        add120_785_out,
        add120_785_out_ap_vld,
        add120_684_out,
        add120_684_out_ap_vld,
        add120_583_out,
        add120_583_out_ap_vld,
        add120_47482_out,
        add120_47482_out_ap_vld,
        add120_35881_out,
        add120_35881_out_ap_vld,
        add120_24280_out,
        add120_24280_out_ap_vld,
        add120_12679_out,
        add120_12679_out_ap_vld,
        add12078_out,
        add12078_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_189_reload;
input  [63:0] add55_290_reload;
input  [63:0] add55_391_reload;
input  [63:0] add55_492_reload;
input  [63:0] add55_593_reload;
input  [63:0] add55_694_reload;
input  [63:0] add55_795_reload;
input  [63:0] add55_896_reload;
input  [63:0] add55_997_reload;
...
output  [63:0] add120_987_out;
output   add120_987_out_ap_vld;
output  [63:0] add120_886_out;
output   add120_886_out_ap_vld;
output  [63:0] add120_785_out;
output   add120_785_out_ap_vld;
output  [63:0] add120_684_out;
output   add120_684_out_ap_vld;
output  [63:0] add120_583_out;
output   add120_583_out_ap_vld;
output  [63:0] add120_47482_out;
output   add120_47482_out_ap_vld;
output  [63:0] add120_35881_out;
output   add120_35881_out_ap_vld;
output  [63:0] add120_24280_out;
output   add120_24280_out_ap_vld;
output  [63:0] add120_12679_out;
output   add120_12679_out_ap_vld;
output  [63:0] add12078_out;
output   add12078_out_ap_vld;

reg ap_idle;
reg add120_987_out_ap_vld;
reg add120_886_out_ap_vld;
reg add120_785_out_ap_vld;
reg add120_684_out_ap_vld;
reg add120_583_out_ap_vld;
reg add120_47482_out_ap_vld;
reg add120_35881_out_ap_vld;
reg add120_24280_out_ap_vld;
reg add120_12679_out_ap_vld;
reg add12078_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add12078_out_ap_vld = 1'b1;
    end else begin
        add12078_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_12679_out_ap_vld = 1'b1;
    end else begin
        add120_12679_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_24280_out_ap_vld = 1'b1;
    end else begin
        add120_24280_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_35881_out_ap_vld = 1'b1;
    end else begin
        add120_35881_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_47482_out_ap_vld = 1'b1;
    end else begin
        add120_47482_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_583_out_ap_vld = 1'b1;
    end else begin
        add120_583_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_684_out_ap_vld = 1'b1;
    end else begin
        add120_684_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_785_out_ap_vld = 1'b1;
    end else begin
        add120_785_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_886_out_ap_vld = 1'b1;
    end else begin
        add120_886_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_987_out_ap_vld = 1'b1;
    end else begin
        add120_987_out_ap_vld = 1'b0;
    end
end
...
assign add12078_out = add12078_fu_172;

assign add120_12679_out = add120_12679_fu_176;

assign add120_24280_out = add120_24280_fu_180;

assign add120_35881_out = add120_35881_fu_184;

assign add120_47482_out = add120_47482_fu_188;

assign add120_583_out = add120_583_fu_192;

assign add120_684_out = add120_684_fu_196;

assign add120_785_out = add120_785_fu_200;

assign add120_886_out = add120_886_fu_204;

assign add120_987_out = add120_987_fu_208;

assign add_ln55_fu_1765_p2 = ($signed(i1_1_fu_212) + $signed(5'd27));

assign add_ln68_10_fu_1411_p2 = (add120_24280_fu_180 + add_ln68_9_fu_1405_p2);
...
assign add_ln68_14_fu_1467_p2 = (add120_35881_fu_184 + add_ln68_13_fu_1461_p2);
...
assign add_ln68_19_fu_1835_p2 = (add_ln68_18_fu_1831_p2 + add120_47482_fu_188);
...
assign add_ln68_24_fu_1577_p2 = (add120_583_fu_192 + add_ln68_23_fu_1571_p2);
...
assign add_ln68_29_fu_1845_p2 = (add120_684_fu_196 + add_ln68_28_fu_1841_p2);
...
assign add_ln68_34_fu_1655_p2 = (add120_785_fu_200 + add_ln68_33_fu_1649_p2);
...
assign add_ln68_39_fu_1855_p2 = (add120_886_fu_204 + add_ln68_38_fu_1851_p2);
...
assign add_ln68_44_fu_1759_p2 = (add120_987_fu_208 + add_ln68_43_fu_1753_p2);

assign add_ln68_4_fu_922_p2 = (i1_1_fu_212 + 5'd1);

assign add_ln68_5_fu_1335_p2 = (and_ln68_fu_1329_p2 + add12078_fu_172);

assign add_ln68_6_fu_1361_p2 = (and_ln68_2_fu_1355_p2 + and_ln68_1_fu_1341_p2);

assign add_ln68_7_fu_1367_p2 = (add120_12679_fu_176 + add_ln68_6_fu_1361_p2);
