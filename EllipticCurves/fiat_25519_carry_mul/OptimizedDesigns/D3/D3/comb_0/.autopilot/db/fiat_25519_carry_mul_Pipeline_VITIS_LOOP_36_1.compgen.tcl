...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_997_out \
    op interface \
    ports { add55_997_out { O 64 vector } add55_997_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_896_out \
    op interface \
    ports { add55_896_out { O 64 vector } add55_896_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_795_out \
    op interface \
    ports { add55_795_out { O 64 vector } add55_795_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_694_out \
    op interface \
    ports { add55_694_out { O 64 vector } add55_694_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_593_out \
    op interface \
    ports { add55_593_out { O 64 vector } add55_593_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_492_out \
    op interface \
    ports { add55_492_out { O 64 vector } add55_492_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add55_391_out { O 64 vector } add55_391_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add55_290_out { O 64 vector } add55_290_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_189_out \
    op interface \
    ports { add55_189_out { O 64 vector } add55_189_out_ap_vld { O 1 bit } } \
} "
}
