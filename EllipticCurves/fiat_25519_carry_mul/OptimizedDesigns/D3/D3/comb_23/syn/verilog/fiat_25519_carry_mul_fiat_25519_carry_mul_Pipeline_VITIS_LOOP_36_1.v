...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_1_4114_out,
        add55_1_4114_out_ap_vld,
        add55_1_3113_out,
        add55_1_3113_out_ap_vld,
        add55_1_2112_out,
        add55_1_2112_out_ap_vld,
        add55_1_1111_out,
        add55_1_1111_out_ap_vld,
        add55_1110_out,
        add55_1110_out_ap_vld,
        add55_4109_out,
        add55_4109_out_ap_vld,
        add55_3108_out,
        add55_3108_out_ap_vld,
        add55_2107_out,
        add55_2107_out_ap_vld,
        add55_190106_out,
        add55_190106_out_ap_vld
);
...
output  [63:0] add55_1_4114_out;
output   add55_1_4114_out_ap_vld;
output  [63:0] add55_1_3113_out;
output   add55_1_3113_out_ap_vld;
output  [63:0] add55_1_2112_out;
output   add55_1_2112_out_ap_vld;
output  [63:0] add55_1_1111_out;
output   add55_1_1111_out_ap_vld;
output  [63:0] add55_1110_out;
output   add55_1110_out_ap_vld;
output  [63:0] add55_4109_out;
output   add55_4109_out_ap_vld;
output  [63:0] add55_3108_out;
output   add55_3108_out_ap_vld;
output  [63:0] add55_2107_out;
output   add55_2107_out_ap_vld;
output  [63:0] add55_190106_out;
output   add55_190106_out_ap_vld;

reg ap_idle;
reg add55_1_4114_out_ap_vld;
reg add55_1_3113_out_ap_vld;
reg add55_1_2112_out_ap_vld;
reg add55_1_1111_out_ap_vld;
reg add55_1110_out_ap_vld;
reg add55_4109_out_ap_vld;
reg add55_3108_out_ap_vld;
reg add55_2107_out_ap_vld;
reg add55_190106_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1110_out_ap_vld = 1'b1;
    end else begin
        add55_1110_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_190106_out_ap_vld = 1'b1;
    end else begin
        add55_190106_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_1111_out_ap_vld = 1'b1;
    end else begin
        add55_1_1111_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_2112_out_ap_vld = 1'b1;
    end else begin
        add55_1_2112_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_3113_out_ap_vld = 1'b1;
    end else begin
        add55_1_3113_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_4114_out_ap_vld = 1'b1;
    end else begin
        add55_1_4114_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2107_out_ap_vld = 1'b1;
    end else begin
        add55_2107_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3108_out_ap_vld = 1'b1;
    end else begin
        add55_3108_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4109_out_ap_vld = 1'b1;
    end else begin
        add55_4109_out_ap_vld = 1'b0;
    end
end
...
assign add55_1110_out = arr_13_fu_138;

assign add55_190106_out = arr_9_fu_122;

assign add55_1_1111_out = arr_14_fu_142;

assign add55_1_2112_out = arr_15_fu_146;

assign add55_1_3113_out = arr_16_fu_150;

assign add55_1_4114_out = arr_17_fu_154;

assign add55_2107_out = arr_10_fu_126;

assign add55_3108_out = arr_11_fu_130;

assign add55_4109_out = arr_12_fu_134;

assign add_ln36_fu_814_p2 = ($signed(ap_sig_allocacmp_i1_5) + $signed(4'd15));

assign add_ln49_11_fu_1077_p2 = (zext_ln36_fu_852_p1 + 5'd7);

assign add_ln49_13_fu_1113_p2 = (zext_ln36_fu_852_p1 + 5'd8);

assign add_ln49_2_fu_902_p2 = (i1_5_reg_1319 + 4'd2);

assign add_ln49_4_fu_937_p2 = (i1_5_reg_1319 + 4'd3);

assign add_ln49_6_fu_972_p2 = (i1_5_reg_1319 + 4'd4);

assign add_ln49_9_fu_1042_p2 = (i1_5_reg_1319 + 4'd6);

assign add_ln49_fu_867_p2 = (i1_5_reg_1319 + 4'd1);
...
assign empty_23_fu_1007_p2 = (i1_5_reg_1319 + 4'd5);

assign empty_fu_474_p1 = ap_sig_allocacmp_i1_5[0:0];

assign icmp_ln36_fu_468_p2 = ((ap_sig_allocacmp_i1_5 == 4'd0) ? 1'b1 : 1'b0);
...
assign tmp_1_fu_523_p11 = (4'd2 - ap_sig_allocacmp_i1_5);

assign tmp_2_fu_556_p11 = (4'd1 - ap_sig_allocacmp_i1_5);

assign tmp_3_fu_589_p11 = (4'd0 - ap_sig_allocacmp_i1_5);

assign tmp_4_fu_622_p11 = (ap_sig_allocacmp_i1_5 ^ 4'd15);

assign tmp_5_fu_655_p11 = ($signed(4'd14) - $signed(ap_sig_allocacmp_i1_5));

assign tmp_6_fu_688_p11 = ($signed(4'd13) - $signed(ap_sig_allocacmp_i1_5));

assign tmp_7_fu_721_p11 = ($signed(4'd12) - $signed(ap_sig_allocacmp_i1_5));

assign tmp_8_fu_754_p11 = ($signed(4'd11) - $signed(ap_sig_allocacmp_i1_5));

assign tmp_9_fu_787_p11 = ($signed(4'd10) - $signed(ap_sig_allocacmp_i1_5));

assign zext_ln36_fu_852_p1 = i1_5_reg_1319;
