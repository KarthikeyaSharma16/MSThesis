...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_1_470_out,
        add55_1_470_out_ap_vld,
        add55_1_369_out,
        add55_1_369_out_ap_vld,
        add55_1_268_out,
        add55_1_268_out_ap_vld,
        add55_1_167_out,
        add55_1_167_out_ap_vld,
        add55_166_out,
        add55_166_out_ap_vld,
        add55_465_out,
        add55_465_out_ap_vld,
        add55_364_out,
        add55_364_out_ap_vld,
        add55_263_out,
        add55_263_out_ap_vld,
        add55_14262_out,
        add55_14262_out_ap_vld
);
...
output  [63:0] add55_1_470_out;
output   add55_1_470_out_ap_vld;
output  [63:0] add55_1_369_out;
output   add55_1_369_out_ap_vld;
output  [63:0] add55_1_268_out;
output   add55_1_268_out_ap_vld;
output  [63:0] add55_1_167_out;
output   add55_1_167_out_ap_vld;
output  [63:0] add55_166_out;
output   add55_166_out_ap_vld;
output  [63:0] add55_465_out;
output   add55_465_out_ap_vld;
output  [63:0] add55_364_out;
output   add55_364_out_ap_vld;
output  [63:0] add55_263_out;
output   add55_263_out_ap_vld;
output  [63:0] add55_14262_out;
output   add55_14262_out_ap_vld;

reg ap_idle;
reg add55_1_470_out_ap_vld;
reg add55_1_369_out_ap_vld;
reg add55_1_268_out_ap_vld;
reg add55_1_167_out_ap_vld;
reg add55_166_out_ap_vld;
reg add55_465_out_ap_vld;
reg add55_364_out_ap_vld;
reg add55_263_out_ap_vld;
reg add55_14262_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_14262_out_ap_vld = 1'b1;
    end else begin
        add55_14262_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_166_out_ap_vld = 1'b1;
    end else begin
        add55_166_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_167_out_ap_vld = 1'b1;
    end else begin
        add55_1_167_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_268_out_ap_vld = 1'b1;
    end else begin
        add55_1_268_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_369_out_ap_vld = 1'b1;
    end else begin
        add55_1_369_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_470_out_ap_vld = 1'b1;
    end else begin
        add55_1_470_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_364_out_ap_vld = 1'b1;
    end else begin
        add55_364_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_465_out_ap_vld = 1'b1;
    end else begin
        add55_465_out_ap_vld = 1'b0;
    end
end
...
assign add55_14262_out = arr_9_fu_122;

assign add55_166_out = arr_13_fu_138;

assign add55_1_167_out = arr_14_fu_142;

assign add55_1_268_out = arr_15_fu_146;

assign add55_1_369_out = arr_16_fu_150;

assign add55_1_470_out = arr_17_fu_154;

assign add55_263_out = arr_10_fu_126;

assign add55_364_out = arr_11_fu_130;

assign add55_465_out = arr_12_fu_134;
...
assign empty_28_fu_1007_p2 = (i1_2_reg_1319 + 4'd5);
...
assign icmp_ln49_4_fu_1016_p2 = ((empty_28_fu_1007_p2 > 4'd9) ? 1'b1 : 1'b0);
