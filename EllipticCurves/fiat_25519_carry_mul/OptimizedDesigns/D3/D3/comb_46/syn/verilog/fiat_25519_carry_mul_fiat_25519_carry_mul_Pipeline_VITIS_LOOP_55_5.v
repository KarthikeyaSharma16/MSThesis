...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_6_reload,
        add120_4_160_out,
        add120_4_160_out_ap_vld,
        add120_459_out,
        add120_459_out_ap_vld,
        add120_3_158_out,
        add120_3_158_out_ap_vld,
        add120_357_out,
        add120_357_out_ap_vld,
        add120_2_156_out,
        add120_2_156_out_ap_vld,
        add120_255_out,
        add120_255_out_ap_vld,
        add120_1_154_out,
        add120_1_154_out_ap_vld,
        add120_153_out,
        add120_153_out_ap_vld,
        add120_12652_out,
        add120_12652_out_ap_vld,
        add12051_out,
        add12051_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_14262_reload;
input  [63:0] add55_263_reload;
input  [63:0] add55_364_reload;
input  [63:0] add55_465_reload;
input  [63:0] add55_166_reload;
input  [63:0] add55_1_167_reload;
input  [63:0] add55_1_268_reload;
input  [63:0] add55_1_369_reload;
input  [63:0] add55_1_470_reload;
...
output  [63:0] add120_4_160_out;
output   add120_4_160_out_ap_vld;
output  [63:0] add120_459_out;
output   add120_459_out_ap_vld;
output  [63:0] add120_3_158_out;
output   add120_3_158_out_ap_vld;
output  [63:0] add120_357_out;
output   add120_357_out_ap_vld;
output  [63:0] add120_2_156_out;
output   add120_2_156_out_ap_vld;
output  [63:0] add120_255_out;
output   add120_255_out_ap_vld;
output  [63:0] add120_1_154_out;
output   add120_1_154_out_ap_vld;
output  [63:0] add120_153_out;
output   add120_153_out_ap_vld;
output  [63:0] add120_12652_out;
output   add120_12652_out_ap_vld;
output  [63:0] add12051_out;
output   add12051_out_ap_vld;

reg ap_idle;
reg add120_4_160_out_ap_vld;
reg add120_459_out_ap_vld;
reg add120_3_158_out_ap_vld;
reg add120_357_out_ap_vld;
reg add120_2_156_out_ap_vld;
reg add120_255_out_ap_vld;
reg add120_1_154_out_ap_vld;
reg add120_153_out_ap_vld;
reg add120_12652_out_ap_vld;
reg add12051_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add12051_out_ap_vld = 1'b1;
    end else begin
        add12051_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_12652_out_ap_vld = 1'b1;
    end else begin
        add120_12652_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_153_out_ap_vld = 1'b1;
    end else begin
        add120_153_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_154_out_ap_vld = 1'b1;
    end else begin
        add120_1_154_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_255_out_ap_vld = 1'b1;
    end else begin
        add120_255_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2_156_out_ap_vld = 1'b1;
    end else begin
        add120_2_156_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_357_out_ap_vld = 1'b1;
    end else begin
        add120_357_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3_158_out_ap_vld = 1'b1;
    end else begin
        add120_3_158_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_459_out_ap_vld = 1'b1;
    end else begin
        add120_459_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4_160_out_ap_vld = 1'b1;
    end else begin
        add120_4_160_out_ap_vld = 1'b0;
    end
end
...
assign add12051_out = add12051_fu_166;

assign add120_12652_out = add120_12652_fu_170;

assign add120_153_out = add120_153_fu_174;

assign add120_1_154_out = add120_1_154_fu_178;

assign add120_255_out = add120_255_fu_182;

assign add120_2_156_out = add120_2_156_fu_186;

assign add120_357_out = add120_357_fu_190;

assign add120_3_158_out = add120_3_158_fu_194;

assign add120_459_out = add120_459_fu_198;

assign add120_4_160_out = add120_4_160_fu_202;

assign add_ln55_fu_1267_p2 = ($signed(i1_fu_206) + $signed(5'd31));

assign add_ln68_10_fu_1105_p2 = (i1_fu_206 + 5'd2);

assign add_ln68_11_fu_1156_p2 = (and_ln68_7_fu_1150_p2 + add120_3_158_fu_194);

assign add_ln68_12_fu_1228_p2 = (and_ln68_8_fu_1222_p2 + add120_459_fu_198);

assign add_ln68_13_fu_1261_p2 = (mul_ln68_9_fu_490_p2 + add120_4_160_fu_202);

assign add_ln68_1_fu_715_p2 = (i1_fu_206 + 5'd8);

assign add_ln68_2_fu_774_p2 = (and_ln68_1_fu_768_p2 + add120_12652_fu_170);

assign add_ln68_3_fu_853_p2 = (and_ln68_2_fu_847_p2 + add120_153_fu_174);

assign add_ln68_4_fu_859_p2 = (i1_fu_206 + 5'd6);

assign add_ln68_5_fu_906_p2 = (and_ln68_3_fu_900_p2 + add120_1_154_fu_178);

assign add_ln68_6_fu_974_p2 = (and_ln68_4_fu_968_p2 + add120_255_fu_182);

assign add_ln68_7_fu_980_p2 = (i1_fu_206 + 5'd4);

assign add_ln68_8_fu_1029_p2 = (and_ln68_5_fu_1023_p2 + add120_2_156_fu_186);

assign add_ln68_9_fu_1099_p2 = (and_ln68_6_fu_1093_p2 + add120_357_fu_190);

assign add_ln68_fu_709_p2 = (and_ln68_fu_703_p2 + add12051_fu_166);
