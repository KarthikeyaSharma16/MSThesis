...
using hls::sim::Byte;
extern "C" void fiat_25519_carry_mul(Byte<4>*, int, int, int);
extern "C" void apatb_fiat_25519_carry_mul_hw(volatile void * __xlx_apatb_param_out1, volatile void * __xlx_apatb_param_arg1, volatile void * __xlx_apatb_param_arg2) {
using hls::sim::createStream;
  // Collect __xlx_out1_arg1_arg2__tmp_vec
std::vector<Byte<4>> __xlx_out1_arg1_arg2__tmp_vec;
for (size_t i = 0; i < 10; ++i){
__xlx_out1_arg1_arg2__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_out1)[i]);
}
  int __xlx_size_param_out1 = 10;
  int __xlx_offset_param_out1 = 0;
  int __xlx_offset_byte_param_out1 = 0*4;
for (size_t i = 0; i < 10; ++i){
__xlx_out1_arg1_arg2__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_arg1)[i]);
}
  int __xlx_size_param_arg1 = 10;
  int __xlx_offset_param_arg1 = 10;
  int __xlx_offset_byte_param_arg1 = 10*4;
for (size_t i = 0; i < 10; ++i){
__xlx_out1_arg1_arg2__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_arg2)[i]);
}
  int __xlx_size_param_arg2 = 10;
  int __xlx_offset_param_arg2 = 20;
  int __xlx_offset_byte_param_arg2 = 20*4;
  // DUT call
  fiat_25519_carry_mul(__xlx_out1_arg1_arg2__tmp_vec.data(), __xlx_offset_byte_param_out1, __xlx_offset_byte_param_arg1, __xlx_offset_byte_param_arg2);
// print __xlx_apatb_param_out1
for (size_t i = 0; i < __xlx_size_param_out1; ++i) {
((Byte<4>*)__xlx_apatb_param_out1)[i] = __xlx_out1_arg1_arg2__tmp_vec[__xlx_offset_param_out1+i];
}
// print __xlx_apatb_param_arg1
for (size_t i = 0; i < __xlx_size_param_arg1; ++i) {
((Byte<4>*)__xlx_apatb_param_arg1)[i] = __xlx_out1_arg1_arg2__tmp_vec[__xlx_offset_param_arg1+i];
}
// print __xlx_apatb_param_arg2
for (size_t i = 0; i < __xlx_size_param_arg2; ++i) {
((Byte<4>*)__xlx_apatb_param_arg2)[i] = __xlx_out1_arg1_arg2__tmp_vec[__xlx_offset_param_arg2+i];
}
}
