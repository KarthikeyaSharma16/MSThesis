...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_9108_out \
    op interface \
    ports { add55_9108_out { O 64 vector } add55_9108_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_8107_out \
    op interface \
    ports { add55_8107_out { O 64 vector } add55_8107_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_7106_out \
    op interface \
    ports { add55_7106_out { O 64 vector } add55_7106_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_6105_out \
    op interface \
    ports { add55_6105_out { O 64 vector } add55_6105_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_5104_out \
    op interface \
    ports { add55_5104_out { O 64 vector } add55_5104_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_4103_out \
    op interface \
    ports { add55_4103_out { O 64 vector } add55_4103_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_3102_out \
    op interface \
    ports { add55_3102_out { O 64 vector } add55_3102_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_2101_out \
    op interface \
    ports { add55_2101_out { O 64 vector } add55_2101_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_1100_out \
    op interface \
    ports { add55_1100_out { O 64 vector } add55_1100_out_ap_vld { O 1 bit } } \
} "
}
