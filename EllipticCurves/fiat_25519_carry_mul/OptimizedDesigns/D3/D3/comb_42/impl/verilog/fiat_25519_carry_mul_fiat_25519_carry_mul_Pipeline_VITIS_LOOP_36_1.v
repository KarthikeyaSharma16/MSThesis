...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_4_172_out,
        add55_4_172_out_ap_vld,
        add55_471_out,
        add55_471_out_ap_vld,
        add55_3_170_out,
        add55_3_170_out_ap_vld,
        add55_369_out,
        add55_369_out_ap_vld,
        add55_2_168_out,
        add55_2_168_out_ap_vld,
        add55_267_out,
        add55_267_out_ap_vld,
        add55_1_166_out,
        add55_1_166_out_ap_vld,
        add55_165_out,
        add55_165_out_ap_vld,
        add55_14164_out,
        add55_14164_out_ap_vld
);
...
output  [63:0] add55_4_172_out;
output   add55_4_172_out_ap_vld;
output  [63:0] add55_471_out;
output   add55_471_out_ap_vld;
output  [63:0] add55_3_170_out;
output   add55_3_170_out_ap_vld;
output  [63:0] add55_369_out;
output   add55_369_out_ap_vld;
output  [63:0] add55_2_168_out;
output   add55_2_168_out_ap_vld;
output  [63:0] add55_267_out;
output   add55_267_out_ap_vld;
output  [63:0] add55_1_166_out;
output   add55_1_166_out_ap_vld;
output  [63:0] add55_165_out;
output   add55_165_out_ap_vld;
output  [63:0] add55_14164_out;
output   add55_14164_out_ap_vld;

reg ap_idle;
reg add55_4_172_out_ap_vld;
reg add55_471_out_ap_vld;
reg add55_3_170_out_ap_vld;
reg add55_369_out_ap_vld;
reg add55_2_168_out_ap_vld;
reg add55_267_out_ap_vld;
reg add55_1_166_out_ap_vld;
reg add55_165_out_ap_vld;
reg add55_14164_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_14164_out_ap_vld = 1'b1;
    end else begin
        add55_14164_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_165_out_ap_vld = 1'b1;
    end else begin
        add55_165_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_166_out_ap_vld = 1'b1;
    end else begin
        add55_1_166_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_267_out_ap_vld = 1'b1;
    end else begin
        add55_267_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2_168_out_ap_vld = 1'b1;
    end else begin
        add55_2_168_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_369_out_ap_vld = 1'b1;
    end else begin
        add55_369_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3_170_out_ap_vld = 1'b1;
    end else begin
        add55_3_170_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4_172_out_ap_vld = 1'b1;
    end else begin
        add55_4_172_out_ap_vld = 1'b0;
    end
end
...
assign add55_14164_out = arr_9_fu_122;

assign add55_165_out = arr_10_fu_126;

assign add55_1_166_out = arr_11_fu_130;

assign add55_267_out = arr_12_fu_134;

assign add55_2_168_out = arr_13_fu_138;

assign add55_369_out = arr_14_fu_142;

assign add55_3_170_out = arr_15_fu_146;

assign add55_471_out = arr_16_fu_150;

assign add55_4_172_out = arr_17_fu_154;
...
assign empty_28_fu_902_p2 = (i1_2_reg_1319 + 4'd2);

assign empty_29_fu_972_p2 = (i1_2_reg_1319 + 4'd4);

assign empty_30_fu_1042_p2 = (i1_2_reg_1319 + 4'd6);

assign empty_31_fu_1113_p2 = (zext_ln36_fu_852_p1 + 5'd8);
...
assign icmp_ln49_3_fu_981_p2 = ((empty_29_fu_972_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_4_fu_1016_p2 = ((add_ln49_6_fu_1007_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_5_fu_1051_p2 = ((empty_30_fu_1042_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_6_fu_1087_p2 = ((add_ln49_9_fu_1077_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_7_fu_1123_p2 = ((empty_31_fu_1113_p2 > 5'd9) ? 1'b1 : 1'b0);
