...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        ap_idle,
        ap_ready,
        add55_1145165_reload,
        add55_1166_reload,
        add55_1_184167_reload,
        add55_2168_reload,
        add55_2_169169_reload,
        add55_3170_reload,
        add55_3_154171_reload,
        add55_4172_reload,
        add55_4_139173_reload,
        arg1_r_reload,
        arg1_r_1_reload,
        arg1_r_2_reload,
        arg1_r_3_reload,
        ...
        arg2_r_6_reload,
        add120_1_4163_out,
        add120_1_4163_out_ap_vld,
        add120_1_3162_out,
        add120_1_3162_out_ap_vld,
        add120_1_2161_out,
        add120_1_2161_out_ap_vld,
        add120_1_1160_out,
        add120_1_1160_out_ap_vld,
        add120_1159_out,
        add120_1159_out_ap_vld,
        add120_4158_out,
        add120_4158_out_ap_vld,
        add120_3157_out,
        add120_3157_out_ap_vld,
        add120_2156_out,
        add120_2156_out_ap_vld,
        add120_124155_out,
        add120_124155_out_ap_vld,
        add120154_out,
        add120154_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_1145165_reload;
input  [63:0] add55_1166_reload;
input  [63:0] add55_1_184167_reload;
input  [63:0] add55_2168_reload;
input  [63:0] add55_2_169169_reload;
input  [63:0] add55_3170_reload;
input  [63:0] add55_3_154171_reload;
input  [63:0] add55_4172_reload;
input  [63:0] add55_4_139173_reload;
...
output  [63:0] add120_1_4163_out;
output   add120_1_4163_out_ap_vld;
output  [63:0] add120_1_3162_out;
output   add120_1_3162_out_ap_vld;
output  [63:0] add120_1_2161_out;
output   add120_1_2161_out_ap_vld;
output  [63:0] add120_1_1160_out;
output   add120_1_1160_out_ap_vld;
output  [63:0] add120_1159_out;
output   add120_1159_out_ap_vld;
output  [63:0] add120_4158_out;
output   add120_4158_out_ap_vld;
output  [63:0] add120_3157_out;
output   add120_3157_out_ap_vld;
output  [63:0] add120_2156_out;
output   add120_2156_out_ap_vld;
output  [63:0] add120_124155_out;
output   add120_124155_out_ap_vld;
output  [63:0] add120154_out;
output   add120154_out_ap_vld;

reg ap_idle;
reg add120_1_4163_out_ap_vld;
reg add120_1_3162_out_ap_vld;
reg add120_1_2161_out_ap_vld;
reg add120_1_1160_out_ap_vld;
reg add120_1159_out_ap_vld;
reg add120_4158_out_ap_vld;
reg add120_3157_out_ap_vld;
reg add120_2156_out_ap_vld;
reg add120_124155_out_ap_vld;
reg add120154_out_ap_vld;
...
reg   [63:0] add120154_fu_166;
wire   [63:0] add_ln68_fu_709_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add120_124155_fu_170;
wire   [63:0] add_ln68_2_fu_774_p2;
reg   [63:0] add120_2156_fu_174;
wire   [63:0] add_ln68_4_fu_853_p2;
reg   [63:0] add120_3157_fu_178;
wire   [63:0] add_ln68_6_fu_906_p2;
reg   [63:0] add120_4158_fu_182;
wire   [63:0] add_ln68_8_fu_974_p2;
reg   [63:0] add120_1159_fu_186;
wire   [63:0] add_ln68_9_fu_1029_p2;
reg   [63:0] add120_1_1160_fu_190;
wire   [63:0] add_ln68_11_fu_1099_p2;
reg   [63:0] add120_1_2161_fu_194;
wire   [63:0] add_ln68_13_fu_1156_p2;
reg   [63:0] add120_1_3162_fu_198;
wire   [63:0] add_ln68_15_fu_1228_p2;
reg   [63:0] add120_1_4163_fu_202;
wire   [63:0] add_ln68_16_fu_1261_p2;
reg   [4:0] i1_fu_206;
...
wire   [31:0] tmp_4_fu_612_p12;
wire   [3:0] tmp_s_fu_648_p11;
wire   [31:0] tmp_s_fu_648_p12;
...
wire   [3:0] tmp_1_fu_727_p11;
wire   [31:0] tmp_1_fu_727_p12;
...
wire   [3:0] tmp_2_fu_792_p11;
wire   [31:0] tmp_2_fu_792_p12;
wire   [31:0] shl_ln68_1_fu_814_p2;
wire   [31:0] select_ln68_1_fu_820_p3;
wire   [4:0] add_ln68_3_fu_780_p2;
...
wire   [1:0] tmp_3_fu_871_p5;
wire   [31:0] tmp_3_fu_871_p6;
wire   [4:0] add_ln68_5_fu_859_p2;
...
wire   [4:0] add_ln68_10_fu_1035_p2;
...
wire   [4:0] add_ln68_12_fu_1105_p2;
...
wire   [4:0] add_ln68_14_fu_1162_p2;
...
always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120154_out_ap_vld = 1'b1;
    end else begin
        add120154_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1159_out_ap_vld = 1'b1;
    end else begin
        add120_1159_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_124155_out_ap_vld = 1'b1;
    end else begin
        add120_124155_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_1160_out_ap_vld = 1'b1;
    end else begin
        add120_1_1160_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_2161_out_ap_vld = 1'b1;
    end else begin
        add120_1_2161_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_3162_out_ap_vld = 1'b1;
    end else begin
        add120_1_3162_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_4163_out_ap_vld = 1'b1;
    end else begin
        add120_1_4163_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2156_out_ap_vld = 1'b1;
    end else begin
        add120_2156_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3157_out_ap_vld = 1'b1;
    end else begin
        add120_3157_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4158_out_ap_vld = 1'b1;
    end else begin
        add120_4158_out_ap_vld = 1'b0;
    end
end
...
assign add120154_out = add120154_fu_166;

assign add120_1159_out = add120_1159_fu_186;

assign add120_124155_out = add120_124155_fu_170;

assign add120_1_1160_out = add120_1_1160_fu_190;

assign add120_1_2161_out = add120_1_2161_fu_194;

assign add120_1_3162_out = add120_1_3162_fu_198;

assign add120_1_4163_out = add120_1_4163_fu_202;

assign add120_2156_out = add120_2156_fu_174;

assign add120_3157_out = add120_3157_fu_178;

assign add120_4158_out = add120_4158_fu_182;

assign add_ln55_fu_1267_p2 = ($signed(i1_fu_206) + $signed(5'd31));

assign add_ln68_10_fu_1035_p2 = (i1_fu_206 + 5'd3);

assign add_ln68_11_fu_1099_p2 = (and_ln68_6_fu_1093_p2 + add120_1_1160_fu_190);

assign add_ln68_12_fu_1105_p2 = (i1_fu_206 + 5'd2);

assign add_ln68_13_fu_1156_p2 = (and_ln68_7_fu_1150_p2 + add120_1_2161_fu_194);

assign add_ln68_14_fu_1162_p2 = (i1_fu_206 + 5'd1);

assign add_ln68_15_fu_1228_p2 = (and_ln68_8_fu_1222_p2 + add120_1_3162_fu_198);

assign add_ln68_16_fu_1261_p2 = (mul_ln68_9_fu_490_p2 + add120_1_4163_fu_202);

assign add_ln68_1_fu_715_p2 = (i1_fu_206 + 5'd8);

assign add_ln68_2_fu_774_p2 = (and_ln68_1_fu_768_p2 + add120_124155_fu_170);

assign add_ln68_3_fu_780_p2 = (i1_fu_206 + 5'd7);

assign add_ln68_4_fu_853_p2 = (and_ln68_2_fu_847_p2 + add120_2156_fu_174);

assign add_ln68_5_fu_859_p2 = (i1_fu_206 + 5'd6);

assign add_ln68_6_fu_906_p2 = (and_ln68_3_fu_900_p2 + add120_3157_fu_178);

assign add_ln68_7_fu_912_p2 = (i1_fu_206 + 5'd5);

assign add_ln68_8_fu_974_p2 = (and_ln68_4_fu_968_p2 + add120_4158_fu_182);

assign add_ln68_9_fu_1029_p2 = (and_ln68_5_fu_1023_p2 + add120_1159_fu_186);

assign add_ln68_fu_709_p2 = (and_ln68_fu_703_p2 + add120154_fu_166);
...
assign empty_24_fu_980_p2 = (i1_fu_206 + 5'd4);

assign empty_fu_602_p1 = i1_fu_206[0:0];

assign icmp_ln68_1_fu_754_p2 = ((add_ln68_1_fu_715_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_2_fu_833_p2 = ((add_ln68_3_fu_780_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_3_fu_886_p2 = (($signed(add_ln68_5_fu_859_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_4_fu_954_p2 = (($signed(add_ln68_7_fu_912_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_5_fu_1009_p2 = (($signed(empty_24_fu_980_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_6_fu_1079_p2 = (($signed(add_ln68_10_fu_1035_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_7_fu_1136_p2 = (($signed(add_ln68_12_fu_1105_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_8_fu_1208_p2 = (($signed(add_ln68_14_fu_1162_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_fu_689_p2 = ((empty_23_fu_606_p2 < 5'd10) ? 1'b1 : 1'b0);

assign mul_ln68_1_fu_458_p0 = mul_ln68_1_fu_458_p00;

assign mul_ln68_1_fu_458_p00 = tmp_1_fu_727_p12;
...
assign mul_ln68_3_fu_466_p00 = tmp_3_fu_871_p6;
...
assign select_ln68_1_fu_820_p3 = ((empty_fu_602_p1[0:0] == 1'b1) ? shl_ln68_1_fu_814_p2 : tmp_2_fu_792_p12);
...
assign select_ln68_fu_676_p3 = ((empty_fu_602_p1[0:0] == 1'b1) ? shl_ln68_fu_670_p2 : tmp_s_fu_648_p12);

assign shl_ln68_1_fu_814_p2 = tmp_2_fu_792_p12 << 32'd1;
...
assign shl_ln68_fu_670_p2 = tmp_s_fu_648_p12 << 32'd1;

assign tmp_10_fu_1240_p11 = ($signed(4'd9) - $signed(trunc_ln55_fu_590_p1));

assign tmp_1_fu_727_p11 = (4'd1 - trunc_ln55_fu_590_p1);

assign tmp_2_fu_792_p11 = (4'd2 - trunc_ln55_fu_590_p1);

assign tmp_3_fu_871_p5 = (trunc_ln55_2_fu_598_p1 ^ 2'd3);
...
assign tmp_s_fu_648_p11 = (4'd0 - trunc_ln55_fu_590_p1);
...
assign zext_ln68_fu_628_p1 = tmp_4_fu_612_p12;
