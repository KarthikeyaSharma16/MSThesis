...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_7_reload,
        add120_1_4103_out,
        add120_1_4103_out_ap_vld,
        add120_1_3102_out,
        add120_1_3102_out_ap_vld,
        add120_1_2101_out,
        add120_1_2101_out_ap_vld,
        add120_1_124100_out,
        add120_1_124100_out_ap_vld,
        add120_199_out,
        add120_199_out_ap_vld,
        add120_498_out,
        add120_498_out_ap_vld,
        add120_397_out,
        add120_397_out_ap_vld,
        add120_296_out,
        add120_296_out_ap_vld,
        add120_17195_out,
        add120_17195_out_ap_vld,
        add12094_out,
        add12094_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_187105_reload;
input  [63:0] add55_2106_reload;
input  [63:0] add55_3107_reload;
input  [63:0] add55_4108_reload;
input  [63:0] add55_1109_reload;
input  [63:0] add55_1_1110_reload;
input  [63:0] add55_1_2111_reload;
input  [63:0] add55_1_3112_reload;
input  [63:0] add55_1_4113_reload;
...
output  [63:0] add120_1_4103_out;
output   add120_1_4103_out_ap_vld;
output  [63:0] add120_1_3102_out;
output   add120_1_3102_out_ap_vld;
output  [63:0] add120_1_2101_out;
output   add120_1_2101_out_ap_vld;
output  [63:0] add120_1_124100_out;
output   add120_1_124100_out_ap_vld;
output  [63:0] add120_199_out;
output   add120_199_out_ap_vld;
output  [63:0] add120_498_out;
output   add120_498_out_ap_vld;
output  [63:0] add120_397_out;
output   add120_397_out_ap_vld;
output  [63:0] add120_296_out;
output   add120_296_out_ap_vld;
output  [63:0] add120_17195_out;
output   add120_17195_out_ap_vld;
output  [63:0] add12094_out;
output   add12094_out_ap_vld;

reg ap_idle;
reg add120_1_4103_out_ap_vld;
reg add120_1_3102_out_ap_vld;
reg add120_1_2101_out_ap_vld;
reg add120_1_124100_out_ap_vld;
reg add120_199_out_ap_vld;
reg add120_498_out_ap_vld;
reg add120_397_out_ap_vld;
reg add120_296_out_ap_vld;
reg add120_17195_out_ap_vld;
reg add12094_out_ap_vld;
...
wire   [3:0] tmp_10_fu_1192_p10;
wire   [31:0] tmp_10_fu_1192_p11;
...
always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add12094_out_ap_vld = 1'b1;
    end else begin
        add12094_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_17195_out_ap_vld = 1'b1;
    end else begin
        add120_17195_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_199_out_ap_vld = 1'b1;
    end else begin
        add120_199_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_124100_out_ap_vld = 1'b1;
    end else begin
        add120_1_124100_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_2101_out_ap_vld = 1'b1;
    end else begin
        add120_1_2101_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_3102_out_ap_vld = 1'b1;
    end else begin
        add120_1_3102_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_4103_out_ap_vld = 1'b1;
    end else begin
        add120_1_4103_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_296_out_ap_vld = 1'b1;
    end else begin
        add120_296_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_397_out_ap_vld = 1'b1;
    end else begin
        add120_397_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_498_out_ap_vld = 1'b1;
    end else begin
        add120_498_out_ap_vld = 1'b0;
    end
end
...
assign add12094_out = add12094_fu_168;

assign add120_17195_out = add120_17195_fu_172;

assign add120_199_out = add120_199_fu_188;

assign add120_1_124100_out = add120_1_124100_fu_192;

assign add120_1_2101_out = add120_1_2101_fu_196;

assign add120_1_3102_out = add120_1_3102_fu_200;

assign add120_1_4103_out = add120_1_4103_fu_204;

assign add120_296_out = add120_296_fu_176;

assign add120_397_out = add120_397_fu_180;

assign add120_498_out = add120_498_fu_184;

assign add_ln55_fu_1377_p2 = ($signed(i1_fu_208) + $signed(5'd30));

assign add_ln68_10_fu_992_p2 = (add120_397_fu_180 + add_ln68_9_fu_986_p2);

assign add_ln68_11_fu_998_p2 = (i1_fu_208 + 5'd4);

assign add_ln68_12_fu_1053_p2 = (and_ln68_8_fu_1047_p2 + and_ln68_7_fu_1033_p2);

assign add_ln68_13_fu_1059_p2 = (add120_498_fu_184 + add_ln68_12_fu_1053_p2);
...
assign tmp_10_fu_1192_p10 = ($signed(4'd9) - $signed(trunc_ln55_fu_628_p1));
...
assign zext_ln68_12_fu_1207_p1 = tmp_10_fu_1192_p11;
