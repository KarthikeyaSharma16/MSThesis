...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        ap_idle,
        ap_ready,
        add55_1103140_reload,
        add55_2118141_reload,
        add55_3142_reload,
        add55_4143_reload,
        add55_1144_reload,
        add55_1_142145_reload,
        add55_1_258146_reload,
        add55_1_3147_reload,
        add55_1_4148_reload,
        arg1_r_reload,
        arg1_r_1_reload,
        ...
        arg2_r_6_reload,
        add120_4_1138_out,
        add120_4_1138_out_ap_vld,
        add120_4137_out,
        add120_4137_out_ap_vld,
        add120_3_1136_out,
        add120_3_1136_out_ap_vld,
        add120_3135_out,
        add120_3135_out_ap_vld,
        add120_2_1134_out,
        add120_2_1134_out_ap_vld,
        add120_2133_out,
        add120_2133_out_ap_vld,
        add120_1_1132_out,
        add120_1_1132_out_ap_vld,
        add120_1131_out,
        add120_1131_out_ap_vld,
        add120_126130_out,
        add120_126130_out_ap_vld,
        add120129_out,
        add120129_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_1103140_reload;
input  [63:0] add55_2118141_reload;
input  [63:0] add55_3142_reload;
input  [63:0] add55_4143_reload;
input  [63:0] add55_1144_reload;
input  [63:0] add55_1_142145_reload;
input  [63:0] add55_1_258146_reload;
input  [63:0] add55_1_3147_reload;
input  [63:0] add55_1_4148_reload;
...
output  [63:0] add120_4_1138_out;
output   add120_4_1138_out_ap_vld;
output  [63:0] add120_4137_out;
output   add120_4137_out_ap_vld;
output  [63:0] add120_3_1136_out;
output   add120_3_1136_out_ap_vld;
output  [63:0] add120_3135_out;
output   add120_3135_out_ap_vld;
output  [63:0] add120_2_1134_out;
output   add120_2_1134_out_ap_vld;
output  [63:0] add120_2133_out;
output   add120_2133_out_ap_vld;
output  [63:0] add120_1_1132_out;
output   add120_1_1132_out_ap_vld;
output  [63:0] add120_1131_out;
output   add120_1131_out_ap_vld;
output  [63:0] add120_126130_out;
output   add120_126130_out_ap_vld;
output  [63:0] add120129_out;
output   add120129_out_ap_vld;

reg ap_idle;
reg add120_4_1138_out_ap_vld;
reg add120_4137_out_ap_vld;
reg add120_3_1136_out_ap_vld;
reg add120_3135_out_ap_vld;
reg add120_2_1134_out_ap_vld;
reg add120_2133_out_ap_vld;
reg add120_1_1132_out_ap_vld;
reg add120_1131_out_ap_vld;
reg add120_126130_out_ap_vld;
reg add120129_out_ap_vld;
...
reg   [63:0] add120129_fu_166;
wire   [63:0] add_ln68_fu_709_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add120_126130_fu_170;
wire   [63:0] add_ln68_2_fu_774_p2;
reg   [63:0] add120_1131_fu_174;
wire   [63:0] add_ln68_3_fu_853_p2;
reg   [63:0] add120_1_1132_fu_178;
wire   [63:0] add_ln68_5_fu_906_p2;
reg   [63:0] add120_2133_fu_182;
wire   [63:0] add_ln68_6_fu_974_p2;
reg   [63:0] add120_2_1134_fu_186;
wire   [63:0] add_ln68_8_fu_1029_p2;
reg   [63:0] add120_3135_fu_190;
wire   [63:0] add_ln68_9_fu_1099_p2;
reg   [63:0] add120_3_1136_fu_194;
wire   [63:0] add_ln68_11_fu_1156_p2;
reg   [63:0] add120_4137_fu_198;
wire   [63:0] add_ln68_12_fu_1228_p2;
reg   [63:0] add120_4_1138_fu_202;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120129_fu_166 <= add55_1_4148_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120129_fu_166 <= add_ln68_fu_709_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_1131_fu_174 <= add55_1_258146_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_1131_fu_174 <= add_ln68_3_fu_853_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_126130_fu_170 <= add55_1_3147_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_126130_fu_170 <= add_ln68_2_fu_774_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_1_1132_fu_178 <= add55_1_142145_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_1_1132_fu_178 <= add_ln68_5_fu_906_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_2133_fu_182 <= add55_1144_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_2133_fu_182 <= add_ln68_6_fu_974_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_2_1134_fu_186 <= add55_4143_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_2_1134_fu_186 <= add_ln68_8_fu_1029_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_3135_fu_190 <= add55_3142_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_3135_fu_190 <= add_ln68_9_fu_1099_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_3_1136_fu_194 <= add55_2118141_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_3_1136_fu_194 <= add_ln68_11_fu_1156_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_4137_fu_198 <= add55_1103140_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_4137_fu_198 <= add_ln68_12_fu_1228_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_4_1138_fu_202 <= 64'd0;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_4_1138_fu_202 <= add_ln68_13_fu_1261_p2;
        end
    end
end
...
always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120129_out_ap_vld = 1'b1;
    end else begin
        add120129_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1131_out_ap_vld = 1'b1;
    end else begin
        add120_1131_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_126130_out_ap_vld = 1'b1;
    end else begin
        add120_126130_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_1132_out_ap_vld = 1'b1;
    end else begin
        add120_1_1132_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2133_out_ap_vld = 1'b1;
    end else begin
        add120_2133_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2_1134_out_ap_vld = 1'b1;
    end else begin
        add120_2_1134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3135_out_ap_vld = 1'b1;
    end else begin
        add120_3135_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3_1136_out_ap_vld = 1'b1;
    end else begin
        add120_3_1136_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4137_out_ap_vld = 1'b1;
    end else begin
        add120_4137_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4_1138_out_ap_vld = 1'b1;
    end else begin
        add120_4_1138_out_ap_vld = 1'b0;
    end
end
...
assign add120129_out = add120129_fu_166;

assign add120_1131_out = add120_1131_fu_174;

assign add120_126130_out = add120_126130_fu_170;

assign add120_1_1132_out = add120_1_1132_fu_178;

assign add120_2133_out = add120_2133_fu_182;

assign add120_2_1134_out = add120_2_1134_fu_186;

assign add120_3135_out = add120_3135_fu_190;

assign add120_3_1136_out = add120_3_1136_fu_194;

assign add120_4137_out = add120_4137_fu_198;

assign add120_4_1138_out = add120_4_1138_fu_202;

assign add_ln55_fu_1267_p2 = ($signed(i1_fu_206) + $signed(5'd31));

assign add_ln68_10_fu_1105_p2 = (i1_fu_206 + 5'd2);

assign add_ln68_11_fu_1156_p2 = (and_ln68_7_fu_1150_p2 + add120_3_1136_fu_194);

assign add_ln68_12_fu_1228_p2 = (and_ln68_8_fu_1222_p2 + add120_4137_fu_198);

assign add_ln68_13_fu_1261_p2 = (mul_ln68_9_fu_490_p2 + add120_4_1138_fu_202);

assign add_ln68_1_fu_715_p2 = (i1_fu_206 + 5'd8);

assign add_ln68_2_fu_774_p2 = (and_ln68_1_fu_768_p2 + add120_126130_fu_170);

assign add_ln68_3_fu_853_p2 = (and_ln68_2_fu_847_p2 + add120_1131_fu_174);

assign add_ln68_4_fu_859_p2 = (i1_fu_206 + 5'd6);

assign add_ln68_5_fu_906_p2 = (and_ln68_3_fu_900_p2 + add120_1_1132_fu_178);

assign add_ln68_6_fu_974_p2 = (and_ln68_4_fu_968_p2 + add120_2133_fu_182);

assign add_ln68_7_fu_980_p2 = (i1_fu_206 + 5'd4);

assign add_ln68_8_fu_1029_p2 = (and_ln68_5_fu_1023_p2 + add120_2_1134_fu_186);

assign add_ln68_9_fu_1099_p2 = (and_ln68_6_fu_1093_p2 + add120_3135_fu_190);

assign add_ln68_fu_709_p2 = (and_ln68_fu_703_p2 + add120129_fu_166);
