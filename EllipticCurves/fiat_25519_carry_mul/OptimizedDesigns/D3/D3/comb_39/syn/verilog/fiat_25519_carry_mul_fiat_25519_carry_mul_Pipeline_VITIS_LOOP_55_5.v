...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        ap_ready,
        add55_187120_reload,
        add55_2102121_reload,
        add55_3122_reload,
        add55_4123_reload,
        add55_1124_reload,
        add55_1_126125_reload,
        add55_1_242126_reload,
        add55_1_3127_reload,
        add55_1_4128_reload,
        arg1_r_reload,
        arg1_r_1_reload,
        ...
        arg2_r_6_reload,
        add120_9118_out,
        add120_9118_out_ap_vld,
        add120_8117_out,
        add120_8117_out_ap_vld,
        add120_7116_out,
        add120_7116_out_ap_vld,
        add120_6115_out,
        add120_6115_out_ap_vld,
        add120_5114_out,
        add120_5114_out_ap_vld,
        add120_4113_out,
        add120_4113_out_ap_vld,
        add120_3112_out,
        add120_3112_out_ap_vld,
        add120_2111_out,
        add120_2111_out_ap_vld,
        add120_1110_out,
        add120_1110_out_ap_vld,
        add120109_out,
        add120109_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_187120_reload;
input  [63:0] add55_2102121_reload;
input  [63:0] add55_3122_reload;
input  [63:0] add55_4123_reload;
input  [63:0] add55_1124_reload;
input  [63:0] add55_1_126125_reload;
input  [63:0] add55_1_242126_reload;
input  [63:0] add55_1_3127_reload;
input  [63:0] add55_1_4128_reload;
...
output  [63:0] add120_9118_out;
output   add120_9118_out_ap_vld;
output  [63:0] add120_8117_out;
output   add120_8117_out_ap_vld;
output  [63:0] add120_7116_out;
output   add120_7116_out_ap_vld;
output  [63:0] add120_6115_out;
output   add120_6115_out_ap_vld;
output  [63:0] add120_5114_out;
output   add120_5114_out_ap_vld;
output  [63:0] add120_4113_out;
output   add120_4113_out_ap_vld;
output  [63:0] add120_3112_out;
output   add120_3112_out_ap_vld;
output  [63:0] add120_2111_out;
output   add120_2111_out_ap_vld;
output  [63:0] add120_1110_out;
output   add120_1110_out_ap_vld;
output  [63:0] add120109_out;
output   add120109_out_ap_vld;

reg ap_idle;
reg add120_9118_out_ap_vld;
reg add120_8117_out_ap_vld;
reg add120_7116_out_ap_vld;
reg add120_6115_out_ap_vld;
reg add120_5114_out_ap_vld;
reg add120_4113_out_ap_vld;
reg add120_3112_out_ap_vld;
reg add120_2111_out_ap_vld;
reg add120_1110_out_ap_vld;
reg add120109_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120109_out_ap_vld = 1'b1;
    end else begin
        add120109_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1110_out_ap_vld = 1'b1;
    end else begin
        add120_1110_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2111_out_ap_vld = 1'b1;
    end else begin
        add120_2111_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3112_out_ap_vld = 1'b1;
    end else begin
        add120_3112_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4113_out_ap_vld = 1'b1;
    end else begin
        add120_4113_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_5114_out_ap_vld = 1'b1;
    end else begin
        add120_5114_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_6115_out_ap_vld = 1'b1;
    end else begin
        add120_6115_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_7116_out_ap_vld = 1'b1;
    end else begin
        add120_7116_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_8117_out_ap_vld = 1'b1;
    end else begin
        add120_8117_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_9118_out_ap_vld = 1'b1;
    end else begin
        add120_9118_out_ap_vld = 1'b0;
    end
end
...
assign add120109_out = add120109_fu_166;

assign add120_1110_out = add120_1110_fu_170;

assign add120_2111_out = add120_2111_fu_174;

assign add120_3112_out = add120_3112_fu_178;

assign add120_4113_out = add120_4113_fu_182;

assign add120_5114_out = add120_5114_fu_186;

assign add120_6115_out = add120_6115_fu_190;

assign add120_7116_out = add120_7116_fu_194;

assign add120_8117_out = add120_8117_fu_198;

assign add120_9118_out = add120_9118_fu_202;

assign add_ln55_fu_1267_p2 = ($signed(i1_fu_206) + $signed(5'd31));

assign add_ln68_10_fu_1029_p2 = (and_ln68_5_fu_1023_p2 + add120_5114_fu_186);

assign add_ln68_11_fu_1035_p2 = (i1_fu_206 + 5'd3);

assign add_ln68_12_fu_1099_p2 = (and_ln68_6_fu_1093_p2 + add120_6115_fu_190);

assign add_ln68_13_fu_1105_p2 = (i1_fu_206 + 5'd2);

assign add_ln68_14_fu_1156_p2 = (and_ln68_7_fu_1150_p2 + add120_7116_fu_194);

assign add_ln68_15_fu_1162_p2 = (i1_fu_206 + 5'd1);

assign add_ln68_16_fu_1228_p2 = (and_ln68_8_fu_1222_p2 + add120_8117_fu_198);

assign add_ln68_17_fu_1261_p2 = (mul_ln68_9_fu_490_p2 + add120_9118_fu_202);

assign add_ln68_1_fu_715_p2 = (i1_fu_206 + 5'd8);

assign add_ln68_2_fu_774_p2 = (and_ln68_1_fu_768_p2 + add120_1110_fu_170);

assign add_ln68_3_fu_780_p2 = (i1_fu_206 + 5'd7);

assign add_ln68_4_fu_853_p2 = (and_ln68_2_fu_847_p2 + add120_2111_fu_174);

assign add_ln68_5_fu_859_p2 = (i1_fu_206 + 5'd6);

assign add_ln68_6_fu_906_p2 = (and_ln68_3_fu_900_p2 + add120_3112_fu_178);

assign add_ln68_7_fu_912_p2 = (i1_fu_206 + 5'd5);

assign add_ln68_8_fu_974_p2 = (and_ln68_4_fu_968_p2 + add120_4113_fu_182);

assign add_ln68_9_fu_980_p2 = (i1_fu_206 + 5'd4);

assign add_ln68_fu_709_p2 = (and_ln68_fu_703_p2 + add120109_fu_166);
