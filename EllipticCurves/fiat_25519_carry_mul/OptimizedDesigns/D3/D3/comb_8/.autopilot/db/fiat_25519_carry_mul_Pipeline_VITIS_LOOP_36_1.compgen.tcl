...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_9142_out \
    op interface \
    ports { add55_9142_out { O 64 vector } add55_9142_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_8141_out \
    op interface \
    ports { add55_8141_out { O 64 vector } add55_8141_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_7140_out \
    op interface \
    ports { add55_7140_out { O 64 vector } add55_7140_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_6139_out \
    op interface \
    ports { add55_6139_out { O 64 vector } add55_6139_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_5138_out \
    op interface \
    ports { add55_5138_out { O 64 vector } add55_5138_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_4137_out \
    op interface \
    ports { add55_4137_out { O 64 vector } add55_4137_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_3136_out \
    op interface \
    ports { add55_3136_out { O 64 vector } add55_3136_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_2135_out \
    op interface \
    ports { add55_2135_out { O 64 vector } add55_2135_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_1134_out \
    op interface \
    ports { add55_1134_out { O 64 vector } add55_1134_out_ap_vld { O 1 bit } } \
} "
}
