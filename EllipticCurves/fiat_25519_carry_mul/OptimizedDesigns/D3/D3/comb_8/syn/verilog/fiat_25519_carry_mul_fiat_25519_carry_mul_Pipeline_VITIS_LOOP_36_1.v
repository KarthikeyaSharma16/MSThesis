...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_9142_out,
        add55_9142_out_ap_vld,
        add55_8141_out,
        add55_8141_out_ap_vld,
        add55_7140_out,
        add55_7140_out_ap_vld,
        add55_6139_out,
        add55_6139_out_ap_vld,
        add55_5138_out,
        add55_5138_out_ap_vld,
        add55_4137_out,
        add55_4137_out_ap_vld,
        add55_3136_out,
        add55_3136_out_ap_vld,
        add55_2135_out,
        add55_2135_out_ap_vld,
        add55_1134_out,
        add55_1134_out_ap_vld
);
...
output  [63:0] add55_9142_out;
output   add55_9142_out_ap_vld;
output  [63:0] add55_8141_out;
output   add55_8141_out_ap_vld;
output  [63:0] add55_7140_out;
output   add55_7140_out_ap_vld;
output  [63:0] add55_6139_out;
output   add55_6139_out_ap_vld;
output  [63:0] add55_5138_out;
output   add55_5138_out_ap_vld;
output  [63:0] add55_4137_out;
output   add55_4137_out_ap_vld;
output  [63:0] add55_3136_out;
output   add55_3136_out_ap_vld;
output  [63:0] add55_2135_out;
output   add55_2135_out_ap_vld;
output  [63:0] add55_1134_out;
output   add55_1134_out_ap_vld;

reg ap_idle;
reg add55_9142_out_ap_vld;
reg add55_8141_out_ap_vld;
reg add55_7140_out_ap_vld;
reg add55_6139_out_ap_vld;
reg add55_5138_out_ap_vld;
reg add55_4137_out_ap_vld;
reg add55_3136_out_ap_vld;
reg add55_2135_out_ap_vld;
reg add55_1134_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1134_out_ap_vld = 1'b1;
    end else begin
        add55_1134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2135_out_ap_vld = 1'b1;
    end else begin
        add55_2135_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3136_out_ap_vld = 1'b1;
    end else begin
        add55_3136_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4137_out_ap_vld = 1'b1;
    end else begin
        add55_4137_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_5138_out_ap_vld = 1'b1;
    end else begin
        add55_5138_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_6139_out_ap_vld = 1'b1;
    end else begin
        add55_6139_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_7140_out_ap_vld = 1'b1;
    end else begin
        add55_7140_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_8141_out_ap_vld = 1'b1;
    end else begin
        add55_8141_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_9142_out_ap_vld = 1'b1;
    end else begin
        add55_9142_out_ap_vld = 1'b0;
    end
end
...
assign add55_1134_out = arr_9_fu_122;

assign add55_2135_out = arr_10_fu_126;

assign add55_3136_out = arr_11_fu_130;

assign add55_4137_out = arr_12_fu_134;

assign add55_5138_out = arr_13_fu_138;

assign add55_6139_out = arr_14_fu_142;

assign add55_7140_out = arr_15_fu_146;

assign add55_8141_out = arr_16_fu_150;

assign add55_9142_out = arr_17_fu_154;
