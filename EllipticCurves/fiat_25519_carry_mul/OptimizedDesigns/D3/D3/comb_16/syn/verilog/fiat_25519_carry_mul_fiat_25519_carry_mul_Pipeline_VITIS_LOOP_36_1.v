...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_4_168_out,
        add55_4_168_out_ap_vld,
        add55_467_out,
        add55_467_out_ap_vld,
        add55_3_166_out,
        add55_3_166_out_ap_vld,
        add55_365_out,
        add55_365_out_ap_vld,
        add55_2_164_out,
        add55_2_164_out_ap_vld,
        add55_263_out,
        add55_263_out_ap_vld,
        add55_1_162_out,
        add55_1_162_out_ap_vld,
        add55_161_out,
        add55_161_out_ap_vld,
        add55_14160_out,
        add55_14160_out_ap_vld
);
...
output  [63:0] add55_4_168_out;
output   add55_4_168_out_ap_vld;
output  [63:0] add55_467_out;
output   add55_467_out_ap_vld;
output  [63:0] add55_3_166_out;
output   add55_3_166_out_ap_vld;
output  [63:0] add55_365_out;
output   add55_365_out_ap_vld;
output  [63:0] add55_2_164_out;
output   add55_2_164_out_ap_vld;
output  [63:0] add55_263_out;
output   add55_263_out_ap_vld;
output  [63:0] add55_1_162_out;
output   add55_1_162_out_ap_vld;
output  [63:0] add55_161_out;
output   add55_161_out_ap_vld;
output  [63:0] add55_14160_out;
output   add55_14160_out_ap_vld;

reg ap_idle;
reg add55_4_168_out_ap_vld;
reg add55_467_out_ap_vld;
reg add55_3_166_out_ap_vld;
reg add55_365_out_ap_vld;
reg add55_2_164_out_ap_vld;
reg add55_263_out_ap_vld;
reg add55_1_162_out_ap_vld;
reg add55_161_out_ap_vld;
reg add55_14160_out_ap_vld;
...
wire   [3:0] add_ln49_6_fu_1007_p2;
...
wire   [4:0] add_ln49_9_fu_1077_p2;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_14160_out_ap_vld = 1'b1;
    end else begin
        add55_14160_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_161_out_ap_vld = 1'b1;
    end else begin
        add55_161_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_162_out_ap_vld = 1'b1;
    end else begin
        add55_1_162_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_263_out_ap_vld = 1'b1;
    end else begin
        add55_263_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2_164_out_ap_vld = 1'b1;
    end else begin
        add55_2_164_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_365_out_ap_vld = 1'b1;
    end else begin
        add55_365_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3_166_out_ap_vld = 1'b1;
    end else begin
        add55_3_166_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_467_out_ap_vld = 1'b1;
    end else begin
        add55_467_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4_168_out_ap_vld = 1'b1;
    end else begin
        add55_4_168_out_ap_vld = 1'b0;
    end
end
...
assign add55_14160_out = arr_9_fu_122;

assign add55_161_out = arr_10_fu_126;

assign add55_1_162_out = arr_11_fu_130;

assign add55_263_out = arr_12_fu_134;

assign add55_2_164_out = arr_13_fu_138;

assign add55_365_out = arr_14_fu_142;

assign add55_3_166_out = arr_15_fu_146;

assign add55_467_out = arr_16_fu_150;

assign add55_4_168_out = arr_17_fu_154;

assign add_ln36_fu_814_p2 = ($signed(ap_sig_allocacmp_i1_2) + $signed(4'd15));

assign add_ln49_3_fu_937_p2 = (i1_2_reg_1319 + 4'd3);

assign add_ln49_6_fu_1007_p2 = (i1_2_reg_1319 + 4'd5);

assign add_ln49_9_fu_1077_p2 = (zext_ln36_fu_852_p1 + 5'd7);
...
assign empty_23_fu_902_p2 = (i1_2_reg_1319 + 4'd2);

assign empty_24_fu_972_p2 = (i1_2_reg_1319 + 4'd4);

assign empty_25_fu_1042_p2 = (i1_2_reg_1319 + 4'd6);

assign empty_26_fu_1113_p2 = (zext_ln36_fu_852_p1 + 5'd8);
...
assign icmp_ln49_2_fu_946_p2 = ((add_ln49_3_fu_937_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_981_p2 = ((empty_24_fu_972_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_4_fu_1016_p2 = ((add_ln49_6_fu_1007_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_5_fu_1051_p2 = ((empty_25_fu_1042_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_6_fu_1087_p2 = ((add_ln49_9_fu_1077_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_7_fu_1123_p2 = ((empty_26_fu_1113_p2 > 5'd9) ? 1'b1 : 1'b0);
