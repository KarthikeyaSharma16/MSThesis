...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg1_r_reload,
        add120_9232_out,
        add120_9232_out_ap_vld,
        add120_8231_out,
        add120_8231_out_ap_vld,
        add120_7230_out,
        add120_7230_out_ap_vld,
        add120_6229_out,
        add120_6229_out_ap_vld,
        add120_5228_out,
        add120_5228_out_ap_vld,
        add120_4227_out,
        add120_4227_out_ap_vld,
        add120_3226_out,
        add120_3226_out_ap_vld,
        add120_2225_out,
        add120_2225_out_ap_vld,
        add120_126224_out,
        add120_126224_out_ap_vld,
        add120223_out,
        add120223_out_ap_vld
);
...
output  [63:0] add120_9232_out;
output   add120_9232_out_ap_vld;
output  [63:0] add120_8231_out;
output   add120_8231_out_ap_vld;
output  [63:0] add120_7230_out;
output   add120_7230_out_ap_vld;
output  [63:0] add120_6229_out;
output   add120_6229_out_ap_vld;
output  [63:0] add120_5228_out;
output   add120_5228_out_ap_vld;
output  [63:0] add120_4227_out;
output   add120_4227_out_ap_vld;
output  [63:0] add120_3226_out;
output   add120_3226_out_ap_vld;
output  [63:0] add120_2225_out;
output   add120_2225_out_ap_vld;
output  [63:0] add120_126224_out;
output   add120_126224_out_ap_vld;
output  [63:0] add120223_out;
output   add120223_out_ap_vld;

reg ap_idle;
reg add120_9232_out_ap_vld;
reg add120_8231_out_ap_vld;
reg add120_7230_out_ap_vld;
reg add120_6229_out_ap_vld;
reg add120_5228_out_ap_vld;
reg add120_4227_out_ap_vld;
reg add120_3226_out_ap_vld;
reg add120_2225_out_ap_vld;
reg add120_126224_out_ap_vld;
reg add120223_out_ap_vld;
...
always @ (*) begin
    if (((tmp_11_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120223_out_ap_vld = 1'b1;
    end else begin
        add120223_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_11_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_126224_out_ap_vld = 1'b1;
    end else begin
        add120_126224_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_11_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2225_out_ap_vld = 1'b1;
    end else begin
        add120_2225_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_11_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3226_out_ap_vld = 1'b1;
    end else begin
        add120_3226_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_11_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4227_out_ap_vld = 1'b1;
    end else begin
        add120_4227_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_11_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_5228_out_ap_vld = 1'b1;
    end else begin
        add120_5228_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_11_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_6229_out_ap_vld = 1'b1;
    end else begin
        add120_6229_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_11_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_7230_out_ap_vld = 1'b1;
    end else begin
        add120_7230_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_11_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_8231_out_ap_vld = 1'b1;
    end else begin
        add120_8231_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_11_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_9232_out_ap_vld = 1'b1;
    end else begin
        add120_9232_out_ap_vld = 1'b0;
    end
end
...
assign add120223_out = add120223_fu_168;

assign add120_126224_out = add120_126224_fu_172;

assign add120_2225_out = add120_2225_fu_176;

assign add120_3226_out = add120_3226_fu_180;

assign add120_4227_out = add120_4227_fu_184;

assign add120_5228_out = add120_5228_fu_188;

assign add120_6229_out = add120_6229_fu_192;

assign add120_7230_out = add120_7230_fu_196;

assign add120_8231_out = add120_8231_fu_200;

assign add120_9232_out = add120_9232_fu_204;

assign add_ln55_fu_1377_p2 = ($signed(i1_fu_208) + $signed(5'd30));

assign add_ln68_10_fu_1106_p2 = (add120_126224_fu_172 + add_ln68_9_fu_1100_p2);

assign add_ln68_11_fu_1132_p2 = (and_ln68_4_fu_1126_p2 + and_ln68_3_fu_1112_p2);

assign add_ln68_12_fu_1138_p2 = (add120_2225_fu_176 + add_ln68_11_fu_1132_p2);

assign add_ln68_13_fu_1169_p2 = (and_ln68_6_fu_1163_p2 + and_ln68_5_fu_1149_p2);

assign add_ln68_14_fu_1175_p2 = (add120_3226_fu_180 + add_ln68_13_fu_1169_p2);

assign add_ln68_15_fu_1201_p2 = (and_ln68_8_fu_1195_p2 + and_ln68_7_fu_1181_p2);

assign add_ln68_16_fu_1207_p2 = (add120_4227_fu_184 + add_ln68_15_fu_1201_p2);

assign add_ln68_17_fu_1238_p2 = (and_ln68_10_fu_1232_p2 + and_ln68_9_fu_1218_p2);

assign add_ln68_18_fu_1244_p2 = (add120_5228_fu_188 + add_ln68_17_fu_1238_p2);

assign add_ln68_19_fu_1270_p2 = (and_ln68_12_fu_1264_p2 + and_ln68_11_fu_1250_p2);

assign add_ln68_1_fu_717_p2 = (i1_fu_208 + 5'd7);

assign add_ln68_20_fu_1276_p2 = (add120_6229_fu_192 + add_ln68_19_fu_1270_p2);

assign add_ln68_21_fu_1307_p2 = (and_ln68_14_fu_1301_p2 + and_ln68_13_fu_1287_p2);

assign add_ln68_22_fu_1313_p2 = (add120_7230_fu_196 + add_ln68_21_fu_1307_p2);

assign add_ln68_23_fu_1325_p2 = (mul_ln68_16_fu_520_p2 + and_ln68_15_fu_1319_p2);

assign add_ln68_24_fu_1331_p2 = (add120_8231_fu_200 + add_ln68_23_fu_1325_p2);

assign add_ln68_25_fu_1365_p2 = (mul_ln68_18_fu_528_p2 + mul_ln68_17_fu_524_p2);

assign add_ln68_26_fu_1371_p2 = (add120_9232_fu_204 + add_ln68_25_fu_1365_p2);
...
assign add_ln68_8_fu_1069_p2 = (and_ln68_fu_1063_p2 + add120223_fu_168);
...
assign zext_ln68_10_fu_1041_p1 = tmp_s_fu_1024_p12;
