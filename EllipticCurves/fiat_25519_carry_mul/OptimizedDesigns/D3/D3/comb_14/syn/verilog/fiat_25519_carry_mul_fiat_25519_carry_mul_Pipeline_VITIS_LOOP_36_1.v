...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_4_1213_out,
        add55_4_1213_out_ap_vld,
        add55_4212_out,
        add55_4212_out_ap_vld,
        add55_3_1211_out,
        add55_3_1211_out_ap_vld,
        add55_3210_out,
        add55_3210_out_ap_vld,
        add55_2_1209_out,
        add55_2_1209_out_ap_vld,
        add55_2208_out,
        add55_2208_out_ap_vld,
        add55_1_1207_out,
        add55_1_1207_out_ap_vld,
        add55_1206_out,
        add55_1206_out_ap_vld,
        add55_1176205_out,
        add55_1176205_out_ap_vld
);
...
output  [63:0] add55_4_1213_out;
output   add55_4_1213_out_ap_vld;
output  [63:0] add55_4212_out;
output   add55_4212_out_ap_vld;
output  [63:0] add55_3_1211_out;
output   add55_3_1211_out_ap_vld;
output  [63:0] add55_3210_out;
output   add55_3210_out_ap_vld;
output  [63:0] add55_2_1209_out;
output   add55_2_1209_out_ap_vld;
output  [63:0] add55_2208_out;
output   add55_2208_out_ap_vld;
output  [63:0] add55_1_1207_out;
output   add55_1_1207_out_ap_vld;
output  [63:0] add55_1206_out;
output   add55_1206_out_ap_vld;
output  [63:0] add55_1176205_out;
output   add55_1176205_out_ap_vld;

reg ap_idle;
reg add55_4_1213_out_ap_vld;
reg add55_4212_out_ap_vld;
reg add55_3_1211_out_ap_vld;
reg add55_3210_out_ap_vld;
reg add55_2_1209_out_ap_vld;
reg add55_2208_out_ap_vld;
reg add55_1_1207_out_ap_vld;
reg add55_1206_out_ap_vld;
reg add55_1176205_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1176205_out_ap_vld = 1'b1;
    end else begin
        add55_1176205_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1206_out_ap_vld = 1'b1;
    end else begin
        add55_1206_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_1207_out_ap_vld = 1'b1;
    end else begin
        add55_1_1207_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2208_out_ap_vld = 1'b1;
    end else begin
        add55_2208_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2_1209_out_ap_vld = 1'b1;
    end else begin
        add55_2_1209_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3210_out_ap_vld = 1'b1;
    end else begin
        add55_3210_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3_1211_out_ap_vld = 1'b1;
    end else begin
        add55_3_1211_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4212_out_ap_vld = 1'b1;
    end else begin
        add55_4212_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4_1213_out_ap_vld = 1'b1;
    end else begin
        add55_4_1213_out_ap_vld = 1'b0;
    end
end
...
assign add55_1176205_out = add55_1176205_fu_122;

assign add55_1206_out = add55_1206_fu_126;

assign add55_1_1207_out = add55_1_1207_fu_130;

assign add55_2208_out = add55_2208_fu_134;

assign add55_2_1209_out = add55_2_1209_fu_138;

assign add55_3210_out = add55_3210_fu_142;

assign add55_3_1211_out = add55_3_1211_fu_146;

assign add55_4212_out = add55_4212_fu_150;

assign add55_4_1213_out = add55_4_1213_fu_154;

assign add_ln36_fu_814_p2 = ($signed(ap_sig_allocacmp_i1_1) + $signed(4'd15));

assign add_ln49_10_fu_1107_p2 = (and_ln49_6_fu_1101_p2 + add55_3_1211_fu_146);

assign add_ln49_11_fu_1143_p2 = (and_ln49_7_fu_1137_p2 + add55_4212_fu_150);

assign add_ln49_12_fu_1153_p2 = (mul_ln49_17_fu_371_p2 + add55_4_1213_fu_154);

assign add_ln49_1_fu_896_p2 = (and_ln49_fu_890_p2 + add55_1176205_fu_122);

assign add_ln49_2_fu_931_p2 = (and_ln49_1_fu_925_p2 + add55_1206_fu_126);

assign add_ln49_3_fu_937_p2 = (i1_1_reg_1319 + 4'd3);

assign add_ln49_4_fu_966_p2 = (and_ln49_2_fu_960_p2 + add55_1_1207_fu_130);

assign add_ln49_5_fu_1001_p2 = (and_ln49_3_fu_995_p2 + add55_2208_fu_134);

assign add_ln49_6_fu_1007_p2 = (i1_1_reg_1319 + 4'd5);

assign add_ln49_7_fu_1036_p2 = (and_ln49_4_fu_1030_p2 + add55_2_1209_fu_138);

assign add_ln49_8_fu_1071_p2 = (and_ln49_5_fu_1065_p2 + add55_3210_fu_142);
