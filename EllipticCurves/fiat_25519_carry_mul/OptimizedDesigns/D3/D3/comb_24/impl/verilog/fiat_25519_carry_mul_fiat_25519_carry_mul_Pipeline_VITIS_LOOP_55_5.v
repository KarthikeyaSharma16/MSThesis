...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_6_reload,
        add120_4_1206_out,
        add120_4_1206_out_ap_vld,
        add120_4205_out,
        add120_4205_out_ap_vld,
        add120_3_1204_out,
        add120_3_1204_out_ap_vld,
        add120_3203_out,
        add120_3203_out_ap_vld,
        add120_2_1202_out,
        add120_2_1202_out_ap_vld,
        add120_2201_out,
        add120_2201_out_ap_vld,
        add120_1_1200_out,
        add120_1_1200_out_ap_vld,
        add120_1199_out,
        add120_1199_out_ap_vld,
        add120_126198_out,
        add120_126198_out_ap_vld,
        add120197_out,
...
output  [63:0] add120_4_1206_out;
output   add120_4_1206_out_ap_vld;
output  [63:0] add120_4205_out;
output   add120_4205_out_ap_vld;
output  [63:0] add120_3_1204_out;
output   add120_3_1204_out_ap_vld;
output  [63:0] add120_3203_out;
output   add120_3203_out_ap_vld;
output  [63:0] add120_2_1202_out;
output   add120_2_1202_out_ap_vld;
output  [63:0] add120_2201_out;
output   add120_2201_out_ap_vld;
output  [63:0] add120_1_1200_out;
output   add120_1_1200_out_ap_vld;
output  [63:0] add120_1199_out;
output   add120_1199_out_ap_vld;
output  [63:0] add120_126198_out;
output   add120_126198_out_ap_vld;
output  [63:0] add120197_out;
output   add120197_out_ap_vld;

reg ap_idle;
reg add120_4_1206_out_ap_vld;
reg add120_4205_out_ap_vld;
reg add120_3_1204_out_ap_vld;
reg add120_3203_out_ap_vld;
reg add120_2_1202_out_ap_vld;
reg add120_2201_out_ap_vld;
reg add120_1_1200_out_ap_vld;
reg add120_1199_out_ap_vld;
reg add120_126198_out_ap_vld;
...
reg   [63:0] add120197_fu_166;
wire   [63:0] add_ln68_fu_709_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add120_126198_fu_170;
wire   [63:0] add_ln68_2_fu_774_p2;
reg   [63:0] add120_1199_fu_174;
wire   [63:0] add_ln68_3_fu_853_p2;
reg   [63:0] add120_1_1200_fu_178;
wire   [63:0] add_ln68_5_fu_906_p2;
reg   [63:0] add120_2201_fu_182;
wire   [63:0] add_ln68_6_fu_974_p2;
reg   [63:0] add120_2_1202_fu_186;
wire   [63:0] add_ln68_8_fu_1029_p2;
reg   [63:0] add120_3203_fu_190;
wire   [63:0] add_ln68_9_fu_1099_p2;
reg   [63:0] add120_3_1204_fu_194;
wire   [63:0] add_ln68_11_fu_1156_p2;
reg   [63:0] add120_4205_fu_198;
wire   [63:0] add_ln68_12_fu_1228_p2;
reg   [63:0] add120_4_1206_fu_202;
...
always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1199_out_ap_vld = 1'b1;
    end else begin
        add120_1199_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_126198_out_ap_vld = 1'b1;
    end else begin
        add120_126198_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_1200_out_ap_vld = 1'b1;
    end else begin
        add120_1_1200_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2201_out_ap_vld = 1'b1;
    end else begin
        add120_2201_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2_1202_out_ap_vld = 1'b1;
    end else begin
        add120_2_1202_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3203_out_ap_vld = 1'b1;
    end else begin
        add120_3203_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3_1204_out_ap_vld = 1'b1;
    end else begin
        add120_3_1204_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4205_out_ap_vld = 1'b1;
    end else begin
        add120_4205_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4_1206_out_ap_vld = 1'b1;
    end else begin
        add120_4_1206_out_ap_vld = 1'b0;
    end
end
...
assign add120197_out = add120197_fu_166;

assign add120_1199_out = add120_1199_fu_174;

assign add120_126198_out = add120_126198_fu_170;

assign add120_1_1200_out = add120_1_1200_fu_178;

assign add120_2201_out = add120_2201_fu_182;

assign add120_2_1202_out = add120_2_1202_fu_186;

assign add120_3203_out = add120_3203_fu_190;

assign add120_3_1204_out = add120_3_1204_fu_194;

assign add120_4205_out = add120_4205_fu_198;

assign add120_4_1206_out = add120_4_1206_fu_202;

assign add_ln55_fu_1267_p2 = ($signed(i1_fu_206) + $signed(5'd31));

assign add_ln68_10_fu_1105_p2 = (i1_fu_206 + 5'd2);

assign add_ln68_11_fu_1156_p2 = (and_ln68_7_fu_1150_p2 + add120_3_1204_fu_194);

assign add_ln68_12_fu_1228_p2 = (and_ln68_8_fu_1222_p2 + add120_4205_fu_198);

assign add_ln68_13_fu_1261_p2 = (mul_ln68_9_fu_490_p2 + add120_4_1206_fu_202);

assign add_ln68_1_fu_715_p2 = (i1_fu_206 + 5'd8);

assign add_ln68_2_fu_774_p2 = (and_ln68_1_fu_768_p2 + add120_126198_fu_170);

assign add_ln68_3_fu_853_p2 = (and_ln68_2_fu_847_p2 + add120_1199_fu_174);

assign add_ln68_4_fu_859_p2 = (i1_fu_206 + 5'd6);

assign add_ln68_5_fu_906_p2 = (and_ln68_3_fu_900_p2 + add120_1_1200_fu_178);

assign add_ln68_6_fu_974_p2 = (and_ln68_4_fu_968_p2 + add120_2201_fu_182);

assign add_ln68_7_fu_980_p2 = (i1_fu_206 + 5'd4);

assign add_ln68_8_fu_1029_p2 = (and_ln68_5_fu_1023_p2 + add120_2_1202_fu_186);

assign add_ln68_9_fu_1099_p2 = (and_ln68_6_fu_1093_p2 + add120_3203_fu_190);

assign add_ln68_fu_709_p2 = (and_ln68_fu_703_p2 + add120197_fu_166);
...
assign empty_23_fu_780_p2 = (i1_fu_206 + 5'd7);

assign empty_24_fu_912_p2 = (i1_fu_206 + 5'd5);

assign empty_25_fu_1035_p2 = (i1_fu_206 + 5'd3);

assign empty_26_fu_1162_p2 = (i1_fu_206 + 5'd1);

assign empty_fu_602_p1 = i1_fu_206[0:0];

assign icmp_ln68_1_fu_754_p2 = ((add_ln68_1_fu_715_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_2_fu_833_p2 = ((empty_23_fu_780_p2 < 5'd10) ? 1'b1 : 1'b0);

assign icmp_ln68_3_fu_886_p2 = (($signed(add_ln68_4_fu_859_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_4_fu_954_p2 = (($signed(empty_24_fu_912_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_5_fu_1009_p2 = (($signed(add_ln68_7_fu_980_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_6_fu_1079_p2 = (($signed(empty_25_fu_1035_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_7_fu_1136_p2 = (($signed(add_ln68_10_fu_1105_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_8_fu_1208_p2 = (($signed(empty_26_fu_1162_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);
