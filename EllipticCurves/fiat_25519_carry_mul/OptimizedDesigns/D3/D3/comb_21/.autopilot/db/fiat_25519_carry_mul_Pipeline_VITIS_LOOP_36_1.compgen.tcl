...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_988_out \
    op interface \
    ports { add55_988_out { O 64 vector } add55_988_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_887_out \
    op interface \
    ports { add55_887_out { O 64 vector } add55_887_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_786_out \
    op interface \
    ports { add55_786_out { O 64 vector } add55_786_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_685_out \
    op interface \
    ports { add55_685_out { O 64 vector } add55_685_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_584_out \
    op interface \
    ports { add55_584_out { O 64 vector } add55_584_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_483_out \
    op interface \
    ports { add55_483_out { O 64 vector } add55_483_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_382_out \
    op interface \
    ports { add55_382_out { O 64 vector } add55_382_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_281_out \
    op interface \
    ports { add55_281_out { O 64 vector } add55_281_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_180_out \
    op interface \
    ports { add55_180_out { O 64 vector } add55_180_out_ap_vld { O 1 bit } } \
} "
}
