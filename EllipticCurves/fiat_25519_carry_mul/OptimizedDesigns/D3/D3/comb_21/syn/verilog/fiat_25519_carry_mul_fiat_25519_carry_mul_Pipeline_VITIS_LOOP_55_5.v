...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_6_reload,
        add120_978_out,
        add120_978_out_ap_vld,
        add120_877_out,
        add120_877_out_ap_vld,
        add120_776_out,
        add120_776_out_ap_vld,
        add120_675_out,
        add120_675_out_ap_vld,
        add120_574_out,
        add120_574_out_ap_vld,
        add120_473_out,
        add120_473_out_ap_vld,
        add120_372_out,
        add120_372_out_ap_vld,
        add120_271_out,
        add120_271_out_ap_vld,
        add120_170_out,
        add120_170_out_ap_vld,
        add12069_out,
        add12069_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_180_reload;
input  [63:0] add55_281_reload;
input  [63:0] add55_382_reload;
input  [63:0] add55_483_reload;
input  [63:0] add55_584_reload;
input  [63:0] add55_685_reload;
input  [63:0] add55_786_reload;
input  [63:0] add55_887_reload;
input  [63:0] add55_988_reload;
...
output  [63:0] add120_978_out;
output   add120_978_out_ap_vld;
output  [63:0] add120_877_out;
output   add120_877_out_ap_vld;
output  [63:0] add120_776_out;
output   add120_776_out_ap_vld;
output  [63:0] add120_675_out;
output   add120_675_out_ap_vld;
output  [63:0] add120_574_out;
output   add120_574_out_ap_vld;
output  [63:0] add120_473_out;
output   add120_473_out_ap_vld;
output  [63:0] add120_372_out;
output   add120_372_out_ap_vld;
output  [63:0] add120_271_out;
output   add120_271_out_ap_vld;
output  [63:0] add120_170_out;
output   add120_170_out_ap_vld;
output  [63:0] add12069_out;
output   add12069_out_ap_vld;

reg ap_idle;
reg add120_978_out_ap_vld;
reg add120_877_out_ap_vld;
reg add120_776_out_ap_vld;
reg add120_675_out_ap_vld;
reg add120_574_out_ap_vld;
reg add120_473_out_ap_vld;
reg add120_372_out_ap_vld;
reg add120_271_out_ap_vld;
reg add120_170_out_ap_vld;
reg add12069_out_ap_vld;
...
reg   [63:0] add12069_fu_166;
wire   [63:0] add_ln68_fu_709_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [63:0] add120_170_fu_170;
wire   [63:0] add_ln68_2_fu_774_p2;
reg   [63:0] add120_271_fu_174;
wire   [63:0] add_ln68_4_fu_853_p2;
reg   [63:0] add120_372_fu_178;
wire   [63:0] add_ln68_6_fu_906_p2;
reg   [63:0] add120_473_fu_182;
wire   [63:0] add_ln68_8_fu_974_p2;
reg   [63:0] add120_574_fu_186;
wire   [63:0] add_ln68_10_fu_1029_p2;
reg   [63:0] add120_675_fu_190;
wire   [63:0] add_ln68_12_fu_1099_p2;
reg   [63:0] add120_776_fu_194;
wire   [63:0] add_ln68_14_fu_1156_p2;
reg   [63:0] add120_877_fu_198;
wire   [63:0] add_ln68_16_fu_1228_p2;
reg   [63:0] add120_978_fu_202;
wire   [63:0] add_ln68_17_fu_1261_p2;
reg   [4:0] i1_fu_206;
...
wire   [4:0] add_ln68_11_fu_1035_p2;
...
wire   [4:0] add_ln68_13_fu_1105_p2;
...
wire   [4:0] add_ln68_15_fu_1162_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add12069_fu_166 <= add55_988_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add12069_fu_166 <= add_ln68_fu_709_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_170_fu_170 <= add55_887_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_170_fu_170 <= add_ln68_2_fu_774_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_271_fu_174 <= add55_786_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_271_fu_174 <= add_ln68_4_fu_853_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_372_fu_178 <= add55_685_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_372_fu_178 <= add_ln68_6_fu_906_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_473_fu_182 <= add55_584_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_473_fu_182 <= add_ln68_8_fu_974_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_574_fu_186 <= add55_483_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_574_fu_186 <= add_ln68_10_fu_1029_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_675_fu_190 <= add55_382_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_675_fu_190 <= add_ln68_12_fu_1099_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_776_fu_194 <= add55_281_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_776_fu_194 <= add_ln68_14_fu_1156_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_877_fu_198 <= add55_180_reload;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_877_fu_198 <= add_ln68_16_fu_1228_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_978_fu_202 <= 64'd0;
        end else if (((tmp_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_978_fu_202 <= add_ln68_17_fu_1261_p2;
        end
    end
end
...
always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add12069_out_ap_vld = 1'b1;
    end else begin
        add12069_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_170_out_ap_vld = 1'b1;
    end else begin
        add120_170_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_271_out_ap_vld = 1'b1;
    end else begin
        add120_271_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_372_out_ap_vld = 1'b1;
    end else begin
        add120_372_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_473_out_ap_vld = 1'b1;
    end else begin
        add120_473_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_574_out_ap_vld = 1'b1;
    end else begin
        add120_574_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_675_out_ap_vld = 1'b1;
    end else begin
        add120_675_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_776_out_ap_vld = 1'b1;
    end else begin
        add120_776_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_877_out_ap_vld = 1'b1;
    end else begin
        add120_877_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_978_out_ap_vld = 1'b1;
    end else begin
        add120_978_out_ap_vld = 1'b0;
    end
end
...
assign add12069_out = add12069_fu_166;

assign add120_170_out = add120_170_fu_170;

assign add120_271_out = add120_271_fu_174;

assign add120_372_out = add120_372_fu_178;

assign add120_473_out = add120_473_fu_182;

assign add120_574_out = add120_574_fu_186;

assign add120_675_out = add120_675_fu_190;

assign add120_776_out = add120_776_fu_194;

assign add120_877_out = add120_877_fu_198;

assign add120_978_out = add120_978_fu_202;

assign add_ln55_fu_1267_p2 = ($signed(i1_fu_206) + $signed(5'd31));

assign add_ln68_10_fu_1029_p2 = (and_ln68_5_fu_1023_p2 + add120_574_fu_186);

assign add_ln68_11_fu_1035_p2 = (i1_fu_206 + 5'd3);

assign add_ln68_12_fu_1099_p2 = (and_ln68_6_fu_1093_p2 + add120_675_fu_190);

assign add_ln68_13_fu_1105_p2 = (i1_fu_206 + 5'd2);

assign add_ln68_14_fu_1156_p2 = (and_ln68_7_fu_1150_p2 + add120_776_fu_194);

assign add_ln68_15_fu_1162_p2 = (i1_fu_206 + 5'd1);

assign add_ln68_16_fu_1228_p2 = (and_ln68_8_fu_1222_p2 + add120_877_fu_198);

assign add_ln68_17_fu_1261_p2 = (mul_ln68_9_fu_490_p2 + add120_978_fu_202);

assign add_ln68_1_fu_715_p2 = (i1_fu_206 + 5'd8);

assign add_ln68_2_fu_774_p2 = (and_ln68_1_fu_768_p2 + add120_170_fu_170);

assign add_ln68_3_fu_780_p2 = (i1_fu_206 + 5'd7);

assign add_ln68_4_fu_853_p2 = (and_ln68_2_fu_847_p2 + add120_271_fu_174);

assign add_ln68_5_fu_859_p2 = (i1_fu_206 + 5'd6);

assign add_ln68_6_fu_906_p2 = (and_ln68_3_fu_900_p2 + add120_372_fu_178);

assign add_ln68_7_fu_912_p2 = (i1_fu_206 + 5'd5);

assign add_ln68_8_fu_974_p2 = (and_ln68_4_fu_968_p2 + add120_473_fu_182);

assign add_ln68_9_fu_980_p2 = (i1_fu_206 + 5'd4);

assign add_ln68_fu_709_p2 = (and_ln68_fu_703_p2 + add12069_fu_166);
...
assign icmp_ln68_5_fu_1009_p2 = (($signed(add_ln68_9_fu_980_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_6_fu_1079_p2 = (($signed(add_ln68_11_fu_1035_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_7_fu_1136_p2 = (($signed(add_ln68_13_fu_1105_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);

assign icmp_ln68_8_fu_1208_p2 = (($signed(add_ln68_15_fu_1162_p2) < $signed(5'd10)) ? 1'b1 : 1'b0);
