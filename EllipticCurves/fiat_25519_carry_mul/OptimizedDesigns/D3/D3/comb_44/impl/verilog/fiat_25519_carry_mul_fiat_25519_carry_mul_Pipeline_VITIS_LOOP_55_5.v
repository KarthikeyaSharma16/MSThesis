...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_6_reload,
        add120_4_173_out,
        add120_4_173_out_ap_vld,
        add120_472_out,
        add120_472_out_ap_vld,
        add120_3_171_out,
        add120_3_171_out_ap_vld,
        add120_370_out,
        add120_370_out_ap_vld,
        add120_2_169_out,
        add120_2_169_out_ap_vld,
        add120_268_out,
        add120_268_out_ap_vld,
        add120_1_167_out,
        add120_1_167_out_ap_vld,
        add120_166_out,
        add120_166_out_ap_vld,
        add120_12665_out,
        add120_12665_out_ap_vld,
        add12064_out,
        add12064_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_14175_reload;
input  [63:0] add55_25676_reload;
input  [63:0] add55_377_reload;
input  [63:0] add55_478_reload;
input  [63:0] add55_579_reload;
input  [63:0] add55_680_reload;
input  [63:0] add55_781_reload;
input  [63:0] add55_882_reload;
input  [63:0] add55_983_reload;
...
output  [63:0] add120_4_173_out;
output   add120_4_173_out_ap_vld;
output  [63:0] add120_472_out;
output   add120_472_out_ap_vld;
output  [63:0] add120_3_171_out;
output   add120_3_171_out_ap_vld;
output  [63:0] add120_370_out;
output   add120_370_out_ap_vld;
output  [63:0] add120_2_169_out;
output   add120_2_169_out_ap_vld;
output  [63:0] add120_268_out;
output   add120_268_out_ap_vld;
output  [63:0] add120_1_167_out;
output   add120_1_167_out_ap_vld;
output  [63:0] add120_166_out;
output   add120_166_out_ap_vld;
output  [63:0] add120_12665_out;
output   add120_12665_out_ap_vld;
output  [63:0] add12064_out;
output   add12064_out_ap_vld;

reg ap_idle;
reg add120_4_173_out_ap_vld;
reg add120_472_out_ap_vld;
reg add120_3_171_out_ap_vld;
reg add120_370_out_ap_vld;
reg add120_2_169_out_ap_vld;
reg add120_268_out_ap_vld;
reg add120_1_167_out_ap_vld;
reg add120_166_out_ap_vld;
reg add120_12665_out_ap_vld;
reg add12064_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add12064_out_ap_vld = 1'b1;
    end else begin
        add12064_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_12665_out_ap_vld = 1'b1;
    end else begin
        add120_12665_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_166_out_ap_vld = 1'b1;
    end else begin
        add120_166_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_167_out_ap_vld = 1'b1;
    end else begin
        add120_1_167_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_268_out_ap_vld = 1'b1;
    end else begin
        add120_268_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2_169_out_ap_vld = 1'b1;
    end else begin
        add120_2_169_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_370_out_ap_vld = 1'b1;
    end else begin
        add120_370_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3_171_out_ap_vld = 1'b1;
    end else begin
        add120_3_171_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_472_out_ap_vld = 1'b1;
    end else begin
        add120_472_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4_173_out_ap_vld = 1'b1;
    end else begin
        add120_4_173_out_ap_vld = 1'b0;
    end
end
...
assign add12064_out = add12064_fu_166;

assign add120_12665_out = add120_12665_fu_170;

assign add120_166_out = add120_166_fu_174;

assign add120_1_167_out = add120_1_167_fu_178;

assign add120_268_out = add120_268_fu_182;

assign add120_2_169_out = add120_2_169_fu_186;

assign add120_370_out = add120_370_fu_190;

assign add120_3_171_out = add120_3_171_fu_194;

assign add120_472_out = add120_472_fu_198;

assign add120_4_173_out = add120_4_173_fu_202;

assign add_ln55_fu_1267_p2 = ($signed(i1_fu_206) + $signed(5'd31));

assign add_ln68_10_fu_1105_p2 = (i1_fu_206 + 5'd2);

assign add_ln68_11_fu_1156_p2 = (and_ln68_7_fu_1150_p2 + add120_3_171_fu_194);

assign add_ln68_12_fu_1228_p2 = (and_ln68_8_fu_1222_p2 + add120_472_fu_198);

assign add_ln68_13_fu_1261_p2 = (mul_ln68_9_fu_490_p2 + add120_4_173_fu_202);

assign add_ln68_1_fu_715_p2 = (i1_fu_206 + 5'd8);

assign add_ln68_2_fu_774_p2 = (and_ln68_1_fu_768_p2 + add120_12665_fu_170);

assign add_ln68_3_fu_853_p2 = (and_ln68_2_fu_847_p2 + add120_166_fu_174);

assign add_ln68_4_fu_859_p2 = (i1_fu_206 + 5'd6);

assign add_ln68_5_fu_906_p2 = (and_ln68_3_fu_900_p2 + add120_1_167_fu_178);

assign add_ln68_6_fu_974_p2 = (and_ln68_4_fu_968_p2 + add120_268_fu_182);

assign add_ln68_7_fu_980_p2 = (i1_fu_206 + 5'd4);

assign add_ln68_8_fu_1029_p2 = (and_ln68_5_fu_1023_p2 + add120_2_169_fu_186);

assign add_ln68_9_fu_1099_p2 = (and_ln68_6_fu_1093_p2 + add120_370_fu_190);

assign add_ln68_fu_709_p2 = (and_ln68_fu_703_p2 + add12064_fu_166);
