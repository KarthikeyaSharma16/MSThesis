...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_983_out \
    op interface \
    ports { add55_983_out { O 64 vector } add55_983_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_882_out \
    op interface \
    ports { add55_882_out { O 64 vector } add55_882_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_781_out \
    op interface \
    ports { add55_781_out { O 64 vector } add55_781_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_680_out \
    op interface \
    ports { add55_680_out { O 64 vector } add55_680_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_579_out \
    op interface \
    ports { add55_579_out { O 64 vector } add55_579_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_478_out \
    op interface \
    ports { add55_478_out { O 64 vector } add55_478_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_377_out \
    op interface \
    ports { add55_377_out { O 64 vector } add55_377_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 108 \
    name add55_25676_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add55_25676_out \
    op interface \
    ports { add55_25676_out { O 64 vector } add55_25676_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 109 \
    name add55_14175_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add55_14175_out \
    op interface \
    ports { add55_14175_out { O 64 vector } add55_14175_out_ap_vld { O 1 bit } } \
} "
}
