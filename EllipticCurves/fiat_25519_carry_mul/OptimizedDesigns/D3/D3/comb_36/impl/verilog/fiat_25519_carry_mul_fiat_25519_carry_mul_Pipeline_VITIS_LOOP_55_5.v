...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_7_reload,
        add120_1_4105_out,
        add120_1_4105_out_ap_vld,
        add120_1_3104_out,
        add120_1_3104_out_ap_vld,
        add120_1_2103_out,
        add120_1_2103_out_ap_vld,
        add120_1_124102_out,
        add120_1_124102_out_ap_vld,
        add120_1101_out,
        add120_1101_out_ap_vld,
        add120_4100_out,
        add120_4100_out_ap_vld,
        add120_399_out,
        add120_399_out_ap_vld,
        add120_298_out,
        add120_298_out_ap_vld,
        add120_17197_out,
        add120_17197_out_ap_vld,
        add12096_out,
        add12096_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_186107_reload;
input  [63:0] add55_1108_reload;
input  [63:0] add55_1_1109_reload;
input  [63:0] add55_2110_reload;
input  [63:0] add55_2_1111_reload;
input  [63:0] add55_3112_reload;
input  [63:0] add55_3_1113_reload;
input  [63:0] add55_4114_reload;
input  [63:0] add55_4_1115_reload;
...
output  [63:0] add120_1_4105_out;
output   add120_1_4105_out_ap_vld;
output  [63:0] add120_1_3104_out;
output   add120_1_3104_out_ap_vld;
output  [63:0] add120_1_2103_out;
output   add120_1_2103_out_ap_vld;
output  [63:0] add120_1_124102_out;
output   add120_1_124102_out_ap_vld;
output  [63:0] add120_1101_out;
output   add120_1101_out_ap_vld;
output  [63:0] add120_4100_out;
output   add120_4100_out_ap_vld;
output  [63:0] add120_399_out;
output   add120_399_out_ap_vld;
output  [63:0] add120_298_out;
output   add120_298_out_ap_vld;
output  [63:0] add120_17197_out;
output   add120_17197_out_ap_vld;
output  [63:0] add12096_out;
output   add12096_out_ap_vld;

reg ap_idle;
reg add120_1_4105_out_ap_vld;
reg add120_1_3104_out_ap_vld;
reg add120_1_2103_out_ap_vld;
reg add120_1_124102_out_ap_vld;
reg add120_1101_out_ap_vld;
reg add120_4100_out_ap_vld;
reg add120_399_out_ap_vld;
reg add120_298_out_ap_vld;
reg add120_17197_out_ap_vld;
reg add12096_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add12096_out_ap_vld = 1'b1;
    end else begin
        add12096_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1101_out_ap_vld = 1'b1;
    end else begin
        add120_1101_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_17197_out_ap_vld = 1'b1;
    end else begin
        add120_17197_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_124102_out_ap_vld = 1'b1;
    end else begin
        add120_1_124102_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_2103_out_ap_vld = 1'b1;
    end else begin
        add120_1_2103_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_3104_out_ap_vld = 1'b1;
    end else begin
        add120_1_3104_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_4105_out_ap_vld = 1'b1;
    end else begin
        add120_1_4105_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_298_out_ap_vld = 1'b1;
    end else begin
        add120_298_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_399_out_ap_vld = 1'b1;
    end else begin
        add120_399_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4100_out_ap_vld = 1'b1;
    end else begin
        add120_4100_out_ap_vld = 1'b0;
    end
end
...
assign add12096_out = add12096_fu_168;

assign add120_1101_out = add120_1101_fu_188;

assign add120_17197_out = add120_17197_fu_172;

assign add120_1_124102_out = add120_1_124102_fu_192;

assign add120_1_2103_out = add120_1_2103_fu_196;

assign add120_1_3104_out = add120_1_3104_fu_200;

assign add120_1_4105_out = add120_1_4105_fu_204;

assign add120_298_out = add120_298_fu_176;

assign add120_399_out = add120_399_fu_180;

assign add120_4100_out = add120_4100_fu_184;

assign add_ln55_fu_1377_p2 = ($signed(i1_fu_208) + $signed(5'd30));

assign add_ln68_10_fu_992_p2 = (add120_399_fu_180 + add_ln68_9_fu_986_p2);

assign add_ln68_11_fu_998_p2 = (i1_fu_208 + 5'd4);

assign add_ln68_12_fu_1053_p2 = (and_ln68_8_fu_1047_p2 + and_ln68_7_fu_1033_p2);

assign add_ln68_13_fu_1059_p2 = (add120_4100_fu_184 + add_ln68_12_fu_1053_p2);
...
assign add_ln68_18_fu_1244_p2 = (add120_1101_fu_188 + add_ln68_17_fu_1238_p2);

assign add_ln68_19_fu_1270_p2 = (and_ln68_11_fu_1250_p2 + and_ln68_12_fu_1264_p2);

assign add_ln68_1_fu_717_p2 = (i1_fu_208 + 5'd7);

assign add_ln68_20_fu_1276_p2 = (add120_1_124102_fu_192 + add_ln68_19_fu_1270_p2);

assign add_ln68_21_fu_1307_p2 = (and_ln68_14_fu_1301_p2 + and_ln68_13_fu_1287_p2);

assign add_ln68_22_fu_1313_p2 = (add120_1_2103_fu_196 + add_ln68_21_fu_1307_p2);

assign add_ln68_23_fu_1325_p2 = (and_ln68_15_fu_1319_p2 + mul_ln68_16_fu_520_p2);

assign add_ln68_24_fu_1331_p2 = (add120_1_3104_fu_200 + add_ln68_23_fu_1325_p2);

assign add_ln68_25_fu_1365_p2 = (mul_ln68_18_fu_528_p2 + mul_ln68_17_fu_524_p2);

assign add_ln68_26_fu_1371_p2 = (add120_1_4105_fu_204 + add_ln68_25_fu_1365_p2);

assign add_ln68_2_fu_769_p2 = (i1_fu_208 + 5'd6);

assign add_ln68_3_fu_802_p2 = (i1_fu_208 + 5'd5);

assign add_ln68_4_fu_886_p2 = (and_ln68_fu_880_p2 + add12096_fu_168);

assign add_ln68_5_fu_917_p2 = (and_ln68_2_fu_911_p2 + and_ln68_1_fu_897_p2);

assign add_ln68_6_fu_923_p2 = (add120_17197_fu_172 + add_ln68_5_fu_917_p2);

assign add_ln68_7_fu_949_p2 = (and_ln68_4_fu_943_p2 + and_ln68_3_fu_929_p2);

assign add_ln68_8_fu_955_p2 = (add120_298_fu_176 + add_ln68_7_fu_949_p2);
