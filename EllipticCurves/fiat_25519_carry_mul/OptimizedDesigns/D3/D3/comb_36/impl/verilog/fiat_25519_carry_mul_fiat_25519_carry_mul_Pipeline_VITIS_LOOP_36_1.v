...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_4_1115_out,
        add55_4_1115_out_ap_vld,
        add55_4114_out,
        add55_4114_out_ap_vld,
        add55_3_1113_out,
        add55_3_1113_out_ap_vld,
        add55_3112_out,
        add55_3112_out_ap_vld,
        add55_2_1111_out,
        add55_2_1111_out_ap_vld,
        add55_2110_out,
        add55_2110_out_ap_vld,
        add55_1_1109_out,
        add55_1_1109_out_ap_vld,
        add55_1108_out,
        add55_1108_out_ap_vld,
        add55_186107_out,
        add55_186107_out_ap_vld
);
...
output  [63:0] add55_4_1115_out;
output   add55_4_1115_out_ap_vld;
output  [63:0] add55_4114_out;
output   add55_4114_out_ap_vld;
output  [63:0] add55_3_1113_out;
output   add55_3_1113_out_ap_vld;
output  [63:0] add55_3112_out;
output   add55_3112_out_ap_vld;
output  [63:0] add55_2_1111_out;
output   add55_2_1111_out_ap_vld;
output  [63:0] add55_2110_out;
output   add55_2110_out_ap_vld;
output  [63:0] add55_1_1109_out;
output   add55_1_1109_out_ap_vld;
output  [63:0] add55_1108_out;
output   add55_1108_out_ap_vld;
output  [63:0] add55_186107_out;
output   add55_186107_out_ap_vld;

reg ap_idle;
reg add55_4_1115_out_ap_vld;
reg add55_4114_out_ap_vld;
reg add55_3_1113_out_ap_vld;
reg add55_3112_out_ap_vld;
reg add55_2_1111_out_ap_vld;
reg add55_2110_out_ap_vld;
reg add55_1_1109_out_ap_vld;
reg add55_1108_out_ap_vld;
reg add55_186107_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1108_out_ap_vld = 1'b1;
    end else begin
        add55_1108_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_186107_out_ap_vld = 1'b1;
    end else begin
        add55_186107_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_1109_out_ap_vld = 1'b1;
    end else begin
        add55_1_1109_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2110_out_ap_vld = 1'b1;
    end else begin
        add55_2110_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2_1111_out_ap_vld = 1'b1;
    end else begin
        add55_2_1111_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3112_out_ap_vld = 1'b1;
    end else begin
        add55_3112_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3_1113_out_ap_vld = 1'b1;
    end else begin
        add55_3_1113_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4114_out_ap_vld = 1'b1;
    end else begin
        add55_4114_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4_1115_out_ap_vld = 1'b1;
    end else begin
        add55_4_1115_out_ap_vld = 1'b0;
    end
end
...
assign add55_1108_out = arr_10_fu_126;

assign add55_186107_out = arr_9_fu_122;

assign add55_1_1109_out = arr_11_fu_130;

assign add55_2110_out = arr_12_fu_134;

assign add55_2_1111_out = arr_13_fu_138;

assign add55_3112_out = arr_14_fu_142;

assign add55_3_1113_out = arr_15_fu_146;

assign add55_4114_out = arr_16_fu_150;

assign add55_4_1115_out = arr_17_fu_154;
