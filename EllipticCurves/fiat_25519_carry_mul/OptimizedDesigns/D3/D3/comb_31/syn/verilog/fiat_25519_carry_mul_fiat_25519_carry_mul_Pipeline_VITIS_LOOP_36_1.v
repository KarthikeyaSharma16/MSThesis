...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_958_out,
        add55_958_out_ap_vld,
        add55_857_out,
        add55_857_out_ap_vld,
        add55_756_out,
        add55_756_out_ap_vld,
        add55_655_out,
        add55_655_out_ap_vld,
        add55_554_out,
        add55_554_out_ap_vld,
        add55_453_out,
        add55_453_out_ap_vld,
        add55_352_out,
        add55_352_out_ap_vld,
        add55_251_out,
        add55_251_out_ap_vld,
        add55_150_out,
        add55_150_out_ap_vld
);
...
output  [63:0] add55_958_out;
output   add55_958_out_ap_vld;
output  [63:0] add55_857_out;
output   add55_857_out_ap_vld;
output  [63:0] add55_756_out;
output   add55_756_out_ap_vld;
output  [63:0] add55_655_out;
output   add55_655_out_ap_vld;
output  [63:0] add55_554_out;
output   add55_554_out_ap_vld;
output  [63:0] add55_453_out;
output   add55_453_out_ap_vld;
output  [63:0] add55_352_out;
output   add55_352_out_ap_vld;
output  [63:0] add55_251_out;
output   add55_251_out_ap_vld;
output  [63:0] add55_150_out;
output   add55_150_out_ap_vld;

reg ap_idle;
reg add55_958_out_ap_vld;
reg add55_857_out_ap_vld;
reg add55_756_out_ap_vld;
reg add55_655_out_ap_vld;
reg add55_554_out_ap_vld;
reg add55_453_out_ap_vld;
reg add55_352_out_ap_vld;
reg add55_251_out_ap_vld;
reg add55_150_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_150_out_ap_vld = 1'b1;
    end else begin
        add55_150_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_251_out_ap_vld = 1'b1;
    end else begin
        add55_251_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_352_out_ap_vld = 1'b1;
    end else begin
        add55_352_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_453_out_ap_vld = 1'b1;
    end else begin
        add55_453_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_554_out_ap_vld = 1'b1;
    end else begin
        add55_554_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_655_out_ap_vld = 1'b1;
    end else begin
        add55_655_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_756_out_ap_vld = 1'b1;
    end else begin
        add55_756_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_857_out_ap_vld = 1'b1;
    end else begin
        add55_857_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_958_out_ap_vld = 1'b1;
    end else begin
        add55_958_out_ap_vld = 1'b0;
    end
end
...
assign add55_150_out = arr_9_fu_122;

assign add55_251_out = arr_10_fu_126;

assign add55_352_out = arr_11_fu_130;

assign add55_453_out = arr_12_fu_134;

assign add55_554_out = arr_13_fu_138;

assign add55_655_out = arr_14_fu_142;

assign add55_756_out = arr_15_fu_146;

assign add55_857_out = arr_16_fu_150;

assign add55_958_out = arr_17_fu_154;
