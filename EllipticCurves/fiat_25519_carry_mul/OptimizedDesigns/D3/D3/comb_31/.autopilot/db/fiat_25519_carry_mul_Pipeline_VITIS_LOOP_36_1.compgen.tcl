...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_958_out \
    op interface \
    ports { add55_958_out { O 64 vector } add55_958_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_857_out \
    op interface \
    ports { add55_857_out { O 64 vector } add55_857_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_756_out \
    op interface \
    ports { add55_756_out { O 64 vector } add55_756_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_655_out \
    op interface \
    ports { add55_655_out { O 64 vector } add55_655_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_554_out \
    op interface \
    ports { add55_554_out { O 64 vector } add55_554_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_453_out \
    op interface \
    ports { add55_453_out { O 64 vector } add55_453_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_352_out \
    op interface \
    ports { add55_352_out { O 64 vector } add55_352_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_251_out \
    op interface \
    ports { add55_251_out { O 64 vector } add55_251_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_150_out \
    op interface \
    ports { add55_150_out { O 64 vector } add55_150_out_ap_vld { O 1 bit } } \
} "
}
