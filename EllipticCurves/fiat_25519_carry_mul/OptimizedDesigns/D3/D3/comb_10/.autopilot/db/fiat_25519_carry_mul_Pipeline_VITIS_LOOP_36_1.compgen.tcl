...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_9149_out \
    op interface \
    ports { add55_9149_out { O 64 vector } add55_9149_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_8148_out \
    op interface \
    ports { add55_8148_out { O 64 vector } add55_8148_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_7147_out \
    op interface \
    ports { add55_7147_out { O 64 vector } add55_7147_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_6146_out \
    op interface \
    ports { add55_6146_out { O 64 vector } add55_6146_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_5145_out \
    op interface \
    ports { add55_5145_out { O 64 vector } add55_5145_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_4144_out \
    op interface \
    ports { add55_4144_out { O 64 vector } add55_4144_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_3143_out \
    op interface \
    ports { add55_3143_out { O 64 vector } add55_3143_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_2142_out \
    op interface \
    ports { add55_2142_out { O 64 vector } add55_2142_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_1141_out \
    op interface \
    ports { add55_1141_out { O 64 vector } add55_1141_out_ap_vld { O 1 bit } } \
} "
}
