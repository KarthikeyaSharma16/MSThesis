...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_9_reload,
        add120_9139_out,
        add120_9139_out_ap_vld,
        add120_8138_out,
        add120_8138_out_ap_vld,
        add120_7137_out,
        add120_7137_out_ap_vld,
        add120_6136_out,
        add120_6136_out_ap_vld,
        add120_5135_out,
        add120_5135_out_ap_vld,
        add120_4134_out,
        add120_4134_out_ap_vld,
        add120_3133_out,
        add120_3133_out_ap_vld,
        add120_2132_out,
        add120_2132_out_ap_vld,
        add120_1131_out,
        add120_1131_out_ap_vld,
        add120130_out,
        add120130_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_1141_reload;
input  [63:0] add55_2142_reload;
input  [63:0] add55_3143_reload;
input  [63:0] add55_4144_reload;
input  [63:0] add55_5145_reload;
input  [63:0] add55_6146_reload;
input  [63:0] add55_7147_reload;
input  [63:0] add55_8148_reload;
input  [63:0] add55_9149_reload;
...
output  [63:0] add120_9139_out;
output   add120_9139_out_ap_vld;
output  [63:0] add120_8138_out;
output   add120_8138_out_ap_vld;
output  [63:0] add120_7137_out;
output   add120_7137_out_ap_vld;
output  [63:0] add120_6136_out;
output   add120_6136_out_ap_vld;
output  [63:0] add120_5135_out;
output   add120_5135_out_ap_vld;
output  [63:0] add120_4134_out;
output   add120_4134_out_ap_vld;
output  [63:0] add120_3133_out;
output   add120_3133_out_ap_vld;
output  [63:0] add120_2132_out;
output   add120_2132_out_ap_vld;
output  [63:0] add120_1131_out;
output   add120_1131_out_ap_vld;
output  [63:0] add120130_out;
output   add120130_out_ap_vld;

reg ap_idle;
reg add120_9139_out_ap_vld;
reg add120_8138_out_ap_vld;
reg add120_7137_out_ap_vld;
reg add120_6136_out_ap_vld;
reg add120_5135_out_ap_vld;
reg add120_4134_out_ap_vld;
reg add120_3133_out_ap_vld;
reg add120_2132_out_ap_vld;
reg add120_1131_out_ap_vld;
reg add120130_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120130_out_ap_vld = 1'b1;
    end else begin
        add120130_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2132_out_ap_vld = 1'b1;
    end else begin
        add120_2132_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3133_out_ap_vld = 1'b1;
    end else begin
        add120_3133_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4134_out_ap_vld = 1'b1;
    end else begin
        add120_4134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_5135_out_ap_vld = 1'b1;
    end else begin
        add120_5135_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_6136_out_ap_vld = 1'b1;
    end else begin
        add120_6136_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_7137_out_ap_vld = 1'b1;
    end else begin
        add120_7137_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_8138_out_ap_vld = 1'b1;
    end else begin
        add120_8138_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_9139_out_ap_vld = 1'b1;
    end else begin
        add120_9139_out_ap_vld = 1'b0;
    end
end
...
assign add120130_out = add120130_fu_172;

assign add120_1131_out = add120_1131_fu_176;

assign add120_2132_out = add120_2132_fu_180;

assign add120_3133_out = add120_3133_fu_184;

assign add120_4134_out = add120_4134_fu_188;

assign add120_5135_out = add120_5135_fu_192;

assign add120_6136_out = add120_6136_fu_196;

assign add120_7137_out = add120_7137_fu_200;

assign add120_8138_out = add120_8138_fu_204;

assign add120_9139_out = add120_9139_fu_208;
...
assign add_ln68_14_fu_1835_p2 = (add_ln68_13_fu_1831_p2 + add120_4134_fu_188);
...
assign add_ln68_19_fu_1435_p2 = (add120_5135_fu_192 + add_ln68_18_fu_1429_p2);
...
assign add_ln68_24_fu_1845_p2 = (add120_6136_fu_196 + add_ln68_23_fu_1841_p2);
...
assign add_ln68_29_fu_1607_p2 = (add120_7137_fu_200 + add_ln68_28_fu_1601_p2);

assign add_ln68_2_fu_1015_p2 = (add120_1131_fu_176 + add_ln68_1_fu_1009_p2);
...
assign add_ln68_34_fu_1855_p2 = (add120_8138_fu_204 + add_ln68_33_fu_1851_p2);
...
assign add_ln68_39_fu_1759_p2 = (add120_9139_fu_208 + add_ln68_38_fu_1753_p2);
...
assign add_ln68_5_fu_1127_p2 = (add120_2132_fu_180 + add_ln68_4_fu_1121_p2);
...
assign add_ln68_9_fu_1224_p2 = (add120_3133_fu_184 + add_ln68_8_fu_1218_p2);

assign add_ln68_fu_950_p2 = (and_ln68_fu_944_p2 + add120130_fu_172);
