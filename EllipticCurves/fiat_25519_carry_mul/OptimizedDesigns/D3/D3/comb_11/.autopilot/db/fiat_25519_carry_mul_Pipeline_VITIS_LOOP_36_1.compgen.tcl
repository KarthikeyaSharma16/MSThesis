...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_9270_out \
    op interface \
    ports { add55_9270_out { O 64 vector } add55_9270_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_8269_out \
    op interface \
    ports { add55_8269_out { O 64 vector } add55_8269_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_7268_out \
    op interface \
    ports { add55_7268_out { O 64 vector } add55_7268_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_6267_out \
    op interface \
    ports { add55_6267_out { O 64 vector } add55_6267_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_5266_out \
    op interface \
    ports { add55_5266_out { O 64 vector } add55_5266_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_4265_out \
    op interface \
    ports { add55_4265_out { O 64 vector } add55_4265_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_3264_out \
    op interface \
    ports { add55_3264_out { O 64 vector } add55_3264_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_2263_out \
    op interface \
    ports { add55_2263_out { O 64 vector } add55_2263_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_1262_out \
    op interface \
    ports { add55_1262_out { O 64 vector } add55_1262_out_ap_vld { O 1 bit } } \
} "
}
