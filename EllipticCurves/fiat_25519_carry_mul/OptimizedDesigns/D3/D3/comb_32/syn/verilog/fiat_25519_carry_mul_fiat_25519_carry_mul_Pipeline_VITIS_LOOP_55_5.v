...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_6_reload,
        add120_9152_out,
        add120_9152_out_ap_vld,
        add120_8151_out,
        add120_8151_out_ap_vld,
        add120_7150_out,
        add120_7150_out_ap_vld,
        add120_6149_out,
        add120_6149_out_ap_vld,
        add120_5148_out,
        add120_5148_out_ap_vld,
        add120_4147_out,
        add120_4147_out_ap_vld,
        add120_3146_out,
        add120_3146_out_ap_vld,
        add120_2145_out,
        add120_2145_out_ap_vld,
        add120_1144_out,
        add120_1144_out_ap_vld,
        add120143_out,
        add120143_out_ap_vld
);
...
output  [63:0] add120_9152_out;
output   add120_9152_out_ap_vld;
output  [63:0] add120_8151_out;
output   add120_8151_out_ap_vld;
output  [63:0] add120_7150_out;
output   add120_7150_out_ap_vld;
output  [63:0] add120_6149_out;
output   add120_6149_out_ap_vld;
output  [63:0] add120_5148_out;
output   add120_5148_out_ap_vld;
output  [63:0] add120_4147_out;
output   add120_4147_out_ap_vld;
output  [63:0] add120_3146_out;
output   add120_3146_out_ap_vld;
output  [63:0] add120_2145_out;
output   add120_2145_out_ap_vld;
output  [63:0] add120_1144_out;
output   add120_1144_out_ap_vld;
output  [63:0] add120143_out;
output   add120143_out_ap_vld;

reg ap_idle;
reg add120_9152_out_ap_vld;
reg add120_8151_out_ap_vld;
reg add120_7150_out_ap_vld;
reg add120_6149_out_ap_vld;
reg add120_5148_out_ap_vld;
reg add120_4147_out_ap_vld;
reg add120_3146_out_ap_vld;
reg add120_2145_out_ap_vld;
reg add120_1144_out_ap_vld;
reg add120143_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_1144_fu_170 <= arr_7;
        end else if (((tmp_10_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_1144_fu_170 <= add_ln68_1_fu_774_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_2145_fu_174 <= arr_6;
        end else if (((tmp_10_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_2145_fu_174 <= add_ln68_2_fu_853_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_3146_fu_178 <= arr_5;
        end else if (((tmp_10_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_3146_fu_178 <= add_ln68_3_fu_906_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_4147_fu_182 <= arr_4;
        end else if (((tmp_10_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_4147_fu_182 <= add_ln68_4_fu_974_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_5148_fu_186 <= arr_3;
        end else if (((tmp_10_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_5148_fu_186 <= add_ln68_5_fu_1029_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_6149_fu_190 <= arr_2;
        end else if (((tmp_10_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_6149_fu_190 <= add_ln68_6_fu_1099_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_7150_fu_194 <= arr_1;
        end else if (((tmp_10_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_7150_fu_194 <= add_ln68_7_fu_1156_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_8151_fu_198 <= arr;
        end else if (((tmp_10_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_8151_fu_198 <= add_ln68_8_fu_1228_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            add120_9152_fu_202 <= 64'd0;
        end else if (((tmp_10_fu_552_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            add120_9152_fu_202 <= add_ln68_9_fu_1261_p2;
        end
    end
end
...
always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120143_out_ap_vld = 1'b1;
    end else begin
        add120143_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1144_out_ap_vld = 1'b1;
    end else begin
        add120_1144_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2145_out_ap_vld = 1'b1;
    end else begin
        add120_2145_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3146_out_ap_vld = 1'b1;
    end else begin
        add120_3146_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4147_out_ap_vld = 1'b1;
    end else begin
        add120_4147_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_5148_out_ap_vld = 1'b1;
    end else begin
        add120_5148_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_6149_out_ap_vld = 1'b1;
    end else begin
        add120_6149_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_7150_out_ap_vld = 1'b1;
    end else begin
        add120_7150_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_8151_out_ap_vld = 1'b1;
    end else begin
        add120_8151_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_10_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_9152_out_ap_vld = 1'b1;
    end else begin
        add120_9152_out_ap_vld = 1'b0;
    end
end
...
assign add120143_out = add120143_fu_166;

assign add120_1144_out = add120_1144_fu_170;

assign add120_2145_out = add120_2145_fu_174;

assign add120_3146_out = add120_3146_fu_178;

assign add120_4147_out = add120_4147_fu_182;

assign add120_5148_out = add120_5148_fu_186;

assign add120_6149_out = add120_6149_fu_190;

assign add120_7150_out = add120_7150_fu_194;

assign add120_8151_out = add120_8151_fu_198;

assign add120_9152_out = add120_9152_fu_202;

assign add_ln55_fu_1267_p2 = ($signed(i1_fu_206) + $signed(5'd31));

assign add_ln68_1_fu_774_p2 = (and_ln68_1_fu_768_p2 + add120_1144_fu_170);

assign add_ln68_2_fu_853_p2 = (and_ln68_2_fu_847_p2 + add120_2145_fu_174);

assign add_ln68_3_fu_906_p2 = (and_ln68_3_fu_900_p2 + add120_3146_fu_178);

assign add_ln68_4_fu_974_p2 = (and_ln68_4_fu_968_p2 + add120_4147_fu_182);

assign add_ln68_5_fu_1029_p2 = (and_ln68_5_fu_1023_p2 + add120_5148_fu_186);

assign add_ln68_6_fu_1099_p2 = (and_ln68_6_fu_1093_p2 + add120_6149_fu_190);

assign add_ln68_7_fu_1156_p2 = (and_ln68_7_fu_1150_p2 + add120_7150_fu_194);

assign add_ln68_8_fu_1228_p2 = (and_ln68_8_fu_1222_p2 + add120_8151_fu_198);

assign add_ln68_9_fu_1261_p2 = (mul_ln68_9_fu_490_p2 + add120_9152_fu_202);

assign add_ln68_fu_709_p2 = (and_ln68_fu_703_p2 + add120143_fu_166);
