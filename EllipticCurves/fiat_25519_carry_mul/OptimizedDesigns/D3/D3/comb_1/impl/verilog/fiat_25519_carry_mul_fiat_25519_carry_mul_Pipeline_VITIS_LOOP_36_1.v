...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_9151_out,
        add55_9151_out_ap_vld,
        add55_8150_out,
        add55_8150_out_ap_vld,
        add55_7149_out,
        add55_7149_out_ap_vld,
        add55_6148_out,
        add55_6148_out_ap_vld,
        add55_5147_out,
        add55_5147_out_ap_vld,
        add55_4146_out,
        add55_4146_out_ap_vld,
        add55_3145_out,
        add55_3145_out_ap_vld,
        add55_2144_out,
        add55_2144_out_ap_vld,
        add55_1143_out,
        add55_1143_out_ap_vld
);
...
output  [63:0] add55_9151_out;
output   add55_9151_out_ap_vld;
output  [63:0] add55_8150_out;
output   add55_8150_out_ap_vld;
output  [63:0] add55_7149_out;
output   add55_7149_out_ap_vld;
output  [63:0] add55_6148_out;
output   add55_6148_out_ap_vld;
output  [63:0] add55_5147_out;
output   add55_5147_out_ap_vld;
output  [63:0] add55_4146_out;
output   add55_4146_out_ap_vld;
output  [63:0] add55_3145_out;
output   add55_3145_out_ap_vld;
output  [63:0] add55_2144_out;
output   add55_2144_out_ap_vld;
output  [63:0] add55_1143_out;
output   add55_1143_out_ap_vld;

reg ap_idle;
reg add55_9151_out_ap_vld;
reg add55_8150_out_ap_vld;
reg add55_7149_out_ap_vld;
reg add55_6148_out_ap_vld;
reg add55_5147_out_ap_vld;
reg add55_4146_out_ap_vld;
reg add55_3145_out_ap_vld;
reg add55_2144_out_ap_vld;
reg add55_1143_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1143_out_ap_vld = 1'b1;
    end else begin
        add55_1143_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2144_out_ap_vld = 1'b1;
    end else begin
        add55_2144_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3145_out_ap_vld = 1'b1;
    end else begin
        add55_3145_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4146_out_ap_vld = 1'b1;
    end else begin
        add55_4146_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_5147_out_ap_vld = 1'b1;
    end else begin
        add55_5147_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_6148_out_ap_vld = 1'b1;
    end else begin
        add55_6148_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_7149_out_ap_vld = 1'b1;
    end else begin
        add55_7149_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_8150_out_ap_vld = 1'b1;
    end else begin
        add55_8150_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_9151_out_ap_vld = 1'b1;
    end else begin
        add55_9151_out_ap_vld = 1'b0;
    end
end
...
assign add55_1143_out = arr_9_fu_122;

assign add55_2144_out = arr_10_fu_126;

assign add55_3145_out = arr_11_fu_130;

assign add55_4146_out = arr_12_fu_134;

assign add55_5147_out = arr_13_fu_138;

assign add55_6148_out = arr_14_fu_142;

assign add55_7149_out = arr_15_fu_146;

assign add55_8150_out = arr_16_fu_150;

assign add55_9151_out = arr_17_fu_154;
...
assign empty_23_fu_867_p2 = (i1_2_reg_1319 + 4'd1);

assign empty_24_fu_902_p2 = (i1_2_reg_1319 + 4'd2);

assign empty_25_fu_937_p2 = (i1_2_reg_1319 + 4'd3);

assign empty_26_fu_972_p2 = (i1_2_reg_1319 + 4'd4);

assign empty_27_fu_1007_p2 = (i1_2_reg_1319 + 4'd5);

assign empty_28_fu_1042_p2 = (i1_2_reg_1319 + 4'd6);

assign empty_29_fu_1077_p2 = (zext_ln36_fu_852_p1 + 5'd7);

assign empty_30_fu_1113_p2 = (zext_ln36_fu_852_p1 + 5'd8);

assign empty_fu_500_p1 = ap_sig_allocacmp_i1_2[0:0];

assign icmp_ln36_fu_468_p2 = ((ap_sig_allocacmp_i1_2 == 4'd0) ? 1'b1 : 1'b0);

assign icmp_ln49_1_fu_911_p2 = ((empty_24_fu_902_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_2_fu_946_p2 = ((empty_25_fu_937_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_3_fu_981_p2 = ((empty_26_fu_972_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_4_fu_1016_p2 = ((empty_27_fu_1007_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_5_fu_1051_p2 = ((empty_28_fu_1042_p2 > 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_6_fu_1087_p2 = ((empty_29_fu_1077_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_7_fu_1123_p2 = ((empty_30_fu_1113_p2 > 5'd9) ? 1'b1 : 1'b0);

assign icmp_ln49_fu_876_p2 = ((empty_23_fu_867_p2 > 4'd9) ? 1'b1 : 1'b0);
