...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_9151_out \
    op interface \
    ports { add55_9151_out { O 64 vector } add55_9151_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_8150_out \
    op interface \
    ports { add55_8150_out { O 64 vector } add55_8150_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_7149_out \
    op interface \
    ports { add55_7149_out { O 64 vector } add55_7149_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_6148_out \
    op interface \
    ports { add55_6148_out { O 64 vector } add55_6148_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_5147_out \
    op interface \
    ports { add55_5147_out { O 64 vector } add55_5147_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_4146_out \
    op interface \
    ports { add55_4146_out { O 64 vector } add55_4146_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_3145_out \
    op interface \
    ports { add55_3145_out { O 64 vector } add55_3145_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_2144_out \
    op interface \
    ports { add55_2144_out { O 64 vector } add55_2144_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_1143_out \
    op interface \
    ports { add55_1143_out { O 64 vector } add55_1143_out_ap_vld { O 1 bit } } \
} "
}
