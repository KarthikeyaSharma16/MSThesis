...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_978_out \
    op interface \
    ports { add55_978_out { O 64 vector } add55_978_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_877_out \
    op interface \
    ports { add55_877_out { O 64 vector } add55_877_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_776_out \
    op interface \
    ports { add55_776_out { O 64 vector } add55_776_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_675_out \
    op interface \
    ports { add55_675_out { O 64 vector } add55_675_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_574_out \
    op interface \
    ports { add55_574_out { O 64 vector } add55_574_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_473_out \
    op interface \
    ports { add55_473_out { O 64 vector } add55_473_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_372_out \
    op interface \
    ports { add55_372_out { O 64 vector } add55_372_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 108 \
    name add55_25471_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add55_25471_out \
    op interface \
    ports { add55_25471_out { O 64 vector } add55_25471_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 109 \
    name add55_13970_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_add55_13970_out \
    op interface \
    ports { add55_13970_out { O 64 vector } add55_13970_out_ap_vld { O 1 bit } } \
} "
}
