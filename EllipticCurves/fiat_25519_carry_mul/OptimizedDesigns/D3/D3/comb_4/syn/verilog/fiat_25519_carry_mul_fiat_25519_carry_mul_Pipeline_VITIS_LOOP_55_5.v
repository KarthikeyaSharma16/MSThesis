...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_6_reload,
        add120_1_468_out,
        add120_1_468_out_ap_vld,
        add120_1_367_out,
        add120_1_367_out_ap_vld,
        add120_1_266_out,
        add120_1_266_out_ap_vld,
        add120_1_165_out,
        add120_1_165_out_ap_vld,
        add120_164_out,
        add120_164_out_ap_vld,
        add120_463_out,
        add120_463_out_ap_vld,
        add120_362_out,
        add120_362_out_ap_vld,
        add120_261_out,
        add120_261_out_ap_vld,
        add120_12460_out,
        add120_12460_out_ap_vld,
        add12059_out,
        add12059_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_13970_reload;
input  [63:0] add55_25471_reload;
input  [63:0] add55_372_reload;
input  [63:0] add55_473_reload;
input  [63:0] add55_574_reload;
input  [63:0] add55_675_reload;
input  [63:0] add55_776_reload;
input  [63:0] add55_877_reload;
input  [63:0] add55_978_reload;
...
output  [63:0] add120_1_468_out;
output   add120_1_468_out_ap_vld;
output  [63:0] add120_1_367_out;
output   add120_1_367_out_ap_vld;
output  [63:0] add120_1_266_out;
output   add120_1_266_out_ap_vld;
output  [63:0] add120_1_165_out;
output   add120_1_165_out_ap_vld;
output  [63:0] add120_164_out;
output   add120_164_out_ap_vld;
output  [63:0] add120_463_out;
output   add120_463_out_ap_vld;
output  [63:0] add120_362_out;
output   add120_362_out_ap_vld;
output  [63:0] add120_261_out;
output   add120_261_out_ap_vld;
output  [63:0] add120_12460_out;
output   add120_12460_out_ap_vld;
output  [63:0] add12059_out;
output   add12059_out_ap_vld;

reg ap_idle;
reg add120_1_468_out_ap_vld;
reg add120_1_367_out_ap_vld;
reg add120_1_266_out_ap_vld;
reg add120_1_165_out_ap_vld;
reg add120_164_out_ap_vld;
reg add120_463_out_ap_vld;
reg add120_362_out_ap_vld;
reg add120_261_out_ap_vld;
reg add120_12460_out_ap_vld;
reg add12059_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add12059_out_ap_vld = 1'b1;
    end else begin
        add12059_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_12460_out_ap_vld = 1'b1;
    end else begin
        add120_12460_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_164_out_ap_vld = 1'b1;
    end else begin
        add120_164_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_165_out_ap_vld = 1'b1;
    end else begin
        add120_1_165_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_266_out_ap_vld = 1'b1;
    end else begin
        add120_1_266_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_367_out_ap_vld = 1'b1;
    end else begin
        add120_1_367_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_468_out_ap_vld = 1'b1;
    end else begin
        add120_1_468_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_261_out_ap_vld = 1'b1;
    end else begin
        add120_261_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_362_out_ap_vld = 1'b1;
    end else begin
        add120_362_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_463_out_ap_vld = 1'b1;
    end else begin
        add120_463_out_ap_vld = 1'b0;
    end
end
...
assign add12059_out = add12059_fu_166;

assign add120_12460_out = add120_12460_fu_170;

assign add120_164_out = add120_164_fu_186;

assign add120_1_165_out = add120_1_165_fu_190;

assign add120_1_266_out = add120_1_266_fu_194;

assign add120_1_367_out = add120_1_367_fu_198;

assign add120_1_468_out = add120_1_468_fu_202;

assign add120_261_out = add120_261_fu_174;

assign add120_362_out = add120_362_fu_178;

assign add120_463_out = add120_463_fu_182;

assign add_ln55_fu_1267_p2 = ($signed(i1_fu_206) + $signed(5'd31));

assign add_ln68_10_fu_1035_p2 = (i1_fu_206 + 5'd3);

assign add_ln68_11_fu_1099_p2 = (and_ln68_6_fu_1093_p2 + add120_1_165_fu_190);

assign add_ln68_12_fu_1105_p2 = (i1_fu_206 + 5'd2);

assign add_ln68_13_fu_1156_p2 = (and_ln68_7_fu_1150_p2 + add120_1_266_fu_194);

assign add_ln68_14_fu_1162_p2 = (i1_fu_206 + 5'd1);

assign add_ln68_15_fu_1228_p2 = (and_ln68_8_fu_1222_p2 + add120_1_367_fu_198);

assign add_ln68_16_fu_1261_p2 = (mul_ln68_9_fu_490_p2 + add120_1_468_fu_202);

assign add_ln68_1_fu_715_p2 = (i1_fu_206 + 5'd8);

assign add_ln68_2_fu_774_p2 = (and_ln68_1_fu_768_p2 + add120_12460_fu_170);

assign add_ln68_3_fu_780_p2 = (i1_fu_206 + 5'd7);

assign add_ln68_4_fu_853_p2 = (and_ln68_2_fu_847_p2 + add120_261_fu_174);

assign add_ln68_5_fu_859_p2 = (i1_fu_206 + 5'd6);

assign add_ln68_6_fu_906_p2 = (and_ln68_3_fu_900_p2 + add120_362_fu_178);

assign add_ln68_7_fu_912_p2 = (i1_fu_206 + 5'd5);

assign add_ln68_8_fu_974_p2 = (and_ln68_4_fu_968_p2 + add120_463_fu_182);

assign add_ln68_9_fu_1029_p2 = (and_ln68_5_fu_1023_p2 + add120_164_fu_186);

assign add_ln68_fu_709_p2 = (and_ln68_fu_703_p2 + add12059_fu_166);
...
assign zext_ln68_fu_628_p1 = tmp_2_fu_612_p12;
