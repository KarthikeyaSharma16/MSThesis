...
attribute shreg_extract : string;
    ...
    signal tmp_2_fu_222_p12 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_2_reg_272 : STD_LOGIC_VECTOR (26 downto 0);
    ...
    signal tmp_2_fu_222_p1 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_2_fu_222_p2 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_2_fu_222_p4 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_2_fu_222_p5 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_2_fu_222_p6 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_2_fu_222_p7 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_2_fu_222_p8 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_2_fu_222_p9 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_2_fu_222_p10 : STD_LOGIC_VECTOR (26 downto 0);
...
begin
    mux_10_4_27_1_1_U110 : component fiat_25519_carry_mul_mux_10_4_27_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 27,
        ...
        dout_WIDTH => 27)
    port map (
        din0 => tmp_2_fu_222_p1,
        din1 => tmp_2_fu_222_p2,
        din2 => out1_w_2,
        din3 => tmp_2_fu_222_p4,
        din4 => tmp_2_fu_222_p5,
        din5 => tmp_2_fu_222_p6,
        din6 => tmp_2_fu_222_p7,
        din7 => tmp_2_fu_222_p8,
        din8 => tmp_2_fu_222_p9,
        din9 => tmp_2_fu_222_p10,
        din10 => ap_sig_allocacmp_i_1,
        dout => tmp_2_fu_222_p12);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln87_fu_210_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_2_reg_272 <= tmp_2_fu_222_p12;
            end if;
        end if;
    end process;
    ...
    m_axi_mem_WDATA <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2_reg_272),32));
    ...
    tmp_2_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln75),27));
    tmp_2_fu_222_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln14),27));
    tmp_2_fu_222_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln76),27));
    tmp_2_fu_222_p4 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln78),27));
    tmp_2_fu_222_p5 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln79),27));
    tmp_2_fu_222_p6 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln80),27));
    tmp_2_fu_222_p7 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln81),27));
    tmp_2_fu_222_p8 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln82),27));
    tmp_2_fu_222_p9 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln83),27));
end behav;
