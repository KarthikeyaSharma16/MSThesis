...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_9186_out \
    op interface \
    ports { add55_9186_out { O 64 vector } add55_9186_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_8185_out \
    op interface \
    ports { add55_8185_out { O 64 vector } add55_8185_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_7184_out \
    op interface \
    ports { add55_7184_out { O 64 vector } add55_7184_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_6183_out \
    op interface \
    ports { add55_6183_out { O 64 vector } add55_6183_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_5182_out \
    op interface \
    ports { add55_5182_out { O 64 vector } add55_5182_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_4181_out \
    op interface \
    ports { add55_4181_out { O 64 vector } add55_4181_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_3180_out \
    op interface \
    ports { add55_3180_out { O 64 vector } add55_3180_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_2179_out \
    op interface \
    ports { add55_2179_out { O 64 vector } add55_2179_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_1178_out \
    op interface \
    ports { add55_1178_out { O 64 vector } add55_1178_out_ap_vld { O 1 bit } } \
} "
}
