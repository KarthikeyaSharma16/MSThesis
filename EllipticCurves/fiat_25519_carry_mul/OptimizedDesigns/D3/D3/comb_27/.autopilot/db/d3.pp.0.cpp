...
__attribute__((sdx_kernel("fiat_25519_carry_mul", 0))) void fiat_25519_carry_mul(uint32_t out1[10], uint32_t arg1[10], uint32_t arg2[10])
{
#line 15 "/export/hdd/scratch/km304/MSThesis/EllipticCurves/fiat_25519_carry_mul/OptimizedDesigns/D3/run_script.tcl"
#pragma HLSDIRECTIVE TOP name=fiat_25519_carry_mul
# 4 "d3.cpp"

#line 19 "/export/hdd/scratch/km304/MSThesis/EllipticCurves/fiat_25519_carry_mul/OptimizedDesigns/D3/run_script.tcl"
#pragma HLSDIRECTIVE TOP name=fiat_25519_carry_mul
# 4 "d3.cpp"
...
#pragma HLS ARRAY_PARTITION variable=out1_w type=complete dim=1
 ...
 for (int i = 0; i < 10; i++)
 {
  arg2_r[i] = arg2[i];
    ...
    VITIS_LOOP_36_1: for(int i1 = 9; i1 > 0; i1 -= 3)
    {
#pragma HLS PIPELINE II=1
 VITIS_LOOP_39_2: for(int i2 = 0; i2 < 10; i2 += 10)
        {
#pragma HLS PIPELINE II=1
 VITIS_LOOP_42_3: for (int i = 0; i < 3; i++)
          {
#pragma HLS UNROLL
 VITIS_LOOP_45_4: for (int j = 0; j < 10; j++)
     {
#pragma HLS UNROLL
 int c = ((i1-i) % 2 == 1 && (i2+j) % 2 == 1) ? 0x26 : 0x13;
      arr[i2+j] += ((uint64_t)(arg1_r[i1-i]) * ((arg2_r[19 - (i1 - i + i2 + j)]) * c)) * (i1 - i + i2 + j >= 10);
     }
          }
        }
    }

    VITIS_LOOP_55_5: for(int i1 = 9; i1 >= 0; i1 -= 10)
    {
#pragma HLS PIPELINE II=1
 VITIS_LOOP_58_6: for(int i2 = 9; i2 >= 0; i2 -= 10)
        {
#pragma HLS PIPELINE II=1
 VITIS_LOOP_61_7: for (int i = 0; i < 10; i++)
         {
#pragma HLS UNROLL
 VITIS_LOOP_64_8: for (int j = 0; j < 10; j++)
    {
#pragma HLS UNROLL
 int c = ((i1-i) %2 == 1 && (i2-j)%2 == 1) ? 0x2 : 0x1;
