...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        ap_idle,
        ap_ready,
        add55_1192213_reload,
        add55_1214_reload,
        add55_1_1131215_reload,
        add55_2216_reload,
        add55_2_1116217_reload,
        add55_3218_reload,
        add55_3_1101219_reload,
        add55_4220_reload,
        add55_4_186221_reload,
        arg1_r_1_reload,
        arg1_r_2_reload,
        arg1_r_3_reload,
        arg1_r_4_reload,
        ...
        arg2_r_7_reload,
        add120_1_4211_out,
        add120_1_4211_out_ap_vld,
        add120_1_3210_out,
        add120_1_3210_out_ap_vld,
        add120_1_2209_out,
        add120_1_2209_out_ap_vld,
        add120_1_124208_out,
        add120_1_124208_out_ap_vld,
        add120_1207_out,
        add120_1207_out_ap_vld,
        add120_4206_out,
        add120_4206_out_ap_vld,
        add120_3205_out,
        add120_3205_out_ap_vld,
        add120_2204_out,
        add120_2204_out_ap_vld,
        add120_171203_out,
        add120_171203_out_ap_vld,
        add120202_out,
        add120202_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_1192213_reload;
input  [63:0] add55_1214_reload;
input  [63:0] add55_1_1131215_reload;
input  [63:0] add55_2216_reload;
input  [63:0] add55_2_1116217_reload;
input  [63:0] add55_3218_reload;
input  [63:0] add55_3_1101219_reload;
input  [63:0] add55_4220_reload;
input  [63:0] add55_4_186221_reload;
...
output  [63:0] add120_1_4211_out;
output   add120_1_4211_out_ap_vld;
output  [63:0] add120_1_3210_out;
output   add120_1_3210_out_ap_vld;
output  [63:0] add120_1_2209_out;
output   add120_1_2209_out_ap_vld;
output  [63:0] add120_1_124208_out;
output   add120_1_124208_out_ap_vld;
output  [63:0] add120_1207_out;
output   add120_1207_out_ap_vld;
output  [63:0] add120_4206_out;
output   add120_4206_out_ap_vld;
output  [63:0] add120_3205_out;
output   add120_3205_out_ap_vld;
output  [63:0] add120_2204_out;
output   add120_2204_out_ap_vld;
output  [63:0] add120_171203_out;
output   add120_171203_out_ap_vld;
output  [63:0] add120202_out;
output   add120202_out_ap_vld;

reg ap_idle;
reg add120_1_4211_out_ap_vld;
reg add120_1_3210_out_ap_vld;
reg add120_1_2209_out_ap_vld;
reg add120_1_124208_out_ap_vld;
reg add120_1207_out_ap_vld;
reg add120_4206_out_ap_vld;
reg add120_3205_out_ap_vld;
reg add120_2204_out_ap_vld;
reg add120_171203_out_ap_vld;
reg add120202_out_ap_vld;
...
wire   [31:0] tmp_4_fu_640_p12;
wire   [3:0] tmp_s_fu_682_p11;
wire   [31:0] tmp_s_fu_682_p12;
wire   [4:0] add_ln68_fu_670_p2;
wire   [3:0] tmp_1_fu_729_p11;
wire   [31:0] tmp_1_fu_729_p12;
wire   [31:0] shl_ln68_fu_752_p2;
wire   [4:0] add_ln68_1_fu_717_p2;
wire   [1:0] trunc_ln55_2_fu_636_p1;
wire   [1:0] tmp_2_fu_781_p4;
wire   [31:0] tmp_2_fu_781_p5;
wire   [4:0] add_ln68_2_fu_769_p2;
wire   [1:0] tmp_3_fu_814_p5;
wire   [31:0] tmp_3_fu_814_p6;
...
always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120202_out_ap_vld = 1'b1;
    end else begin
        add120202_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1207_out_ap_vld = 1'b1;
    end else begin
        add120_1207_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_171203_out_ap_vld = 1'b1;
    end else begin
        add120_171203_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_124208_out_ap_vld = 1'b1;
    end else begin
        add120_1_124208_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_2209_out_ap_vld = 1'b1;
    end else begin
        add120_1_2209_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_3210_out_ap_vld = 1'b1;
    end else begin
        add120_1_3210_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1_4211_out_ap_vld = 1'b1;
    end else begin
        add120_1_4211_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2204_out_ap_vld = 1'b1;
    end else begin
        add120_2204_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3205_out_ap_vld = 1'b1;
    end else begin
        add120_3205_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_590_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4206_out_ap_vld = 1'b1;
    end else begin
        add120_4206_out_ap_vld = 1'b0;
    end
end
...
assign add120202_out = add120202_fu_168;

assign add120_1207_out = add120_1207_fu_188;

assign add120_171203_out = add120_171203_fu_172;

assign add120_1_124208_out = add120_1_124208_fu_192;

assign add120_1_2209_out = add120_1_2209_fu_196;

assign add120_1_3210_out = add120_1_3210_fu_200;

assign add120_1_4211_out = add120_1_4211_fu_204;

assign add120_2204_out = add120_2204_fu_176;

assign add120_3205_out = add120_3205_fu_180;

assign add120_4206_out = add120_4206_fu_184;

assign add_ln55_fu_1377_p2 = ($signed(i1_fu_208) + $signed(5'd30));

assign add_ln68_10_fu_992_p2 = (add120_3205_fu_180 + add_ln68_9_fu_986_p2);

assign add_ln68_11_fu_998_p2 = (i1_fu_208 + 5'd4);

assign add_ln68_12_fu_1053_p2 = (and_ln68_8_fu_1047_p2 + and_ln68_7_fu_1033_p2);

assign add_ln68_13_fu_1059_p2 = (add120_4206_fu_184 + add_ln68_12_fu_1053_p2);
...
assign add_ln68_18_fu_1244_p2 = (add120_1207_fu_188 + add_ln68_17_fu_1238_p2);

assign add_ln68_19_fu_1270_p2 = (and_ln68_11_fu_1250_p2 + and_ln68_12_fu_1264_p2);

assign add_ln68_1_fu_717_p2 = (i1_fu_208 + 5'd7);

assign add_ln68_20_fu_1276_p2 = (add120_1_124208_fu_192 + add_ln68_19_fu_1270_p2);

assign add_ln68_21_fu_1307_p2 = (and_ln68_14_fu_1301_p2 + and_ln68_13_fu_1287_p2);

assign add_ln68_22_fu_1313_p2 = (add120_1_2209_fu_196 + add_ln68_21_fu_1307_p2);

assign add_ln68_23_fu_1325_p2 = (and_ln68_15_fu_1319_p2 + mul_ln68_16_fu_520_p2);

assign add_ln68_24_fu_1331_p2 = (add120_1_3210_fu_200 + add_ln68_23_fu_1325_p2);

assign add_ln68_25_fu_1365_p2 = (mul_ln68_18_fu_528_p2 + mul_ln68_17_fu_524_p2);

assign add_ln68_26_fu_1371_p2 = (add120_1_4211_fu_204 + add_ln68_25_fu_1365_p2);

assign add_ln68_2_fu_769_p2 = (i1_fu_208 + 5'd6);

assign add_ln68_3_fu_802_p2 = (i1_fu_208 + 5'd5);

assign add_ln68_4_fu_886_p2 = (and_ln68_fu_880_p2 + add120202_fu_168);

assign add_ln68_5_fu_917_p2 = (and_ln68_2_fu_911_p2 + and_ln68_1_fu_897_p2);

assign add_ln68_6_fu_923_p2 = (add120_171203_fu_172 + add_ln68_5_fu_917_p2);

assign add_ln68_7_fu_949_p2 = (and_ln68_4_fu_943_p2 + and_ln68_3_fu_929_p2);

assign add_ln68_8_fu_955_p2 = (add120_2204_fu_176 + add_ln68_7_fu_949_p2);
...
assign mul_ln68_2_fu_464_p10 = tmp_1_fu_729_p12;
...
assign mul_ln68_6_fu_480_p10 = tmp_3_fu_814_p6;
...
assign tmp_1_fu_729_p11 = (4'd2 - trunc_ln55_fu_628_p1);

assign tmp_2_fu_781_p4 = (trunc_ln55_2_fu_636_p1 ^ 2'd3);

assign tmp_3_fu_814_p5 = (2'd0 - trunc_ln55_2_fu_636_p1);
...
assign tmp_s_fu_682_p11 = (4'd1 - trunc_ln55_fu_628_p1);
...
assign zext_ln68_1_fu_705_p1 = tmp_s_fu_682_p12;

assign zext_ln68_3_fu_790_p1 = tmp_2_fu_781_p5;

assign zext_ln68_5_fu_858_p1 = tmp_5_fu_841_p12;

assign zext_ln68_8_fu_1021_p1 = tmp_6_fu_1010_p7;

assign zext_ln68_fu_657_p1 = tmp_4_fu_640_p12;
