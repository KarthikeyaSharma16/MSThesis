...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_9_reload,
        add120_9149_out,
        add120_9149_out_ap_vld,
        add120_8148_out,
        add120_8148_out_ap_vld,
        add120_7147_out,
        add120_7147_out_ap_vld,
        add120_6146_out,
        add120_6146_out_ap_vld,
        add120_5145_out,
        add120_5145_out_ap_vld,
        add120_4144_out,
        add120_4144_out_ap_vld,
        add120_3143_out,
        add120_3143_out_ap_vld,
        add120_2142_out,
        add120_2142_out_ap_vld,
        add120_1141_out,
        add120_1141_out_ap_vld,
        add120140_out,
        add120140_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_1113151_reload;
input  [63:0] add55_1152_reload;
input  [63:0] add55_1_1153_reload;
input  [63:0] add55_2154_reload;
input  [63:0] add55_2_1155_reload;
input  [63:0] add55_3156_reload;
input  [63:0] add55_3_1157_reload;
input  [63:0] add55_4158_reload;
input  [63:0] add55_4_1159_reload;
...
output  [63:0] add120_9149_out;
output   add120_9149_out_ap_vld;
output  [63:0] add120_8148_out;
output   add120_8148_out_ap_vld;
output  [63:0] add120_7147_out;
output   add120_7147_out_ap_vld;
output  [63:0] add120_6146_out;
output   add120_6146_out_ap_vld;
output  [63:0] add120_5145_out;
output   add120_5145_out_ap_vld;
output  [63:0] add120_4144_out;
output   add120_4144_out_ap_vld;
output  [63:0] add120_3143_out;
output   add120_3143_out_ap_vld;
output  [63:0] add120_2142_out;
output   add120_2142_out_ap_vld;
output  [63:0] add120_1141_out;
output   add120_1141_out_ap_vld;
output  [63:0] add120140_out;
output   add120140_out_ap_vld;

reg ap_idle;
reg add120_9149_out_ap_vld;
reg add120_8148_out_ap_vld;
reg add120_7147_out_ap_vld;
reg add120_6146_out_ap_vld;
reg add120_5145_out_ap_vld;
reg add120_4144_out_ap_vld;
reg add120_3143_out_ap_vld;
reg add120_2142_out_ap_vld;
reg add120_1141_out_ap_vld;
reg add120140_out_ap_vld;
...
wire   [31:0] tmp_1_fu_775_p12;
wire   [31:0] tmp_2_fu_806_p12;
wire   [31:0] tmp_3_fu_838_p12;
wire   [31:0] tmp_4_fu_877_p12;
...
always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120140_out_ap_vld = 1'b1;
    end else begin
        add120140_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1141_out_ap_vld = 1'b1;
    end else begin
        add120_1141_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2142_out_ap_vld = 1'b1;
    end else begin
        add120_2142_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3143_out_ap_vld = 1'b1;
    end else begin
        add120_3143_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4144_out_ap_vld = 1'b1;
    end else begin
        add120_4144_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_5145_out_ap_vld = 1'b1;
    end else begin
        add120_5145_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_6146_out_ap_vld = 1'b1;
    end else begin
        add120_6146_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_7147_out_ap_vld = 1'b1;
    end else begin
        add120_7147_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_8148_out_ap_vld = 1'b1;
    end else begin
        add120_8148_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_9149_out_ap_vld = 1'b1;
    end else begin
        add120_9149_out_ap_vld = 1'b0;
    end
end
...
assign add120140_out = add120140_fu_172;

assign add120_1141_out = add120_1141_fu_176;

assign add120_2142_out = add120_2142_fu_180;

assign add120_3143_out = add120_3143_fu_184;

assign add120_4144_out = add120_4144_fu_188;

assign add120_5145_out = add120_5145_fu_192;

assign add120_6146_out = add120_6146_fu_196;

assign add120_7147_out = add120_7147_fu_200;

assign add120_8148_out = add120_8148_fu_204;

assign add120_9149_out = add120_9149_fu_208;
...
assign add_ln68_14_fu_1835_p2 = (add_ln68_13_fu_1831_p2 + add120_4144_fu_188);
...
assign add_ln68_19_fu_1435_p2 = (add120_5145_fu_192 + add_ln68_18_fu_1429_p2);
...
assign add_ln68_24_fu_1845_p2 = (add120_6146_fu_196 + add_ln68_23_fu_1841_p2);
...
assign add_ln68_29_fu_1607_p2 = (add120_7147_fu_200 + add_ln68_28_fu_1601_p2);

assign add_ln68_2_fu_1015_p2 = (add120_1141_fu_176 + add_ln68_1_fu_1009_p2);
...
assign add_ln68_34_fu_1855_p2 = (add120_8148_fu_204 + add_ln68_33_fu_1851_p2);
...
assign add_ln68_39_fu_1759_p2 = (add120_9149_fu_208 + add_ln68_38_fu_1753_p2);
...
assign add_ln68_5_fu_1127_p2 = (add120_2142_fu_180 + add_ln68_4_fu_1121_p2);
...
assign add_ln68_9_fu_1224_p2 = (add120_3143_fu_184 + add_ln68_8_fu_1218_p2);

assign add_ln68_fu_950_p2 = (and_ln68_fu_944_p2 + add120140_fu_172);
...
assign zext_ln68_1_fu_795_p1 = tmp_1_fu_775_p12;

assign zext_ln68_2_fu_826_p1 = tmp_2_fu_806_p12;

assign zext_ln68_3_fu_858_p1 = tmp_3_fu_838_p12;

assign zext_ln68_4_fu_897_p1 = tmp_4_fu_877_p12;
