...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_9224_out \
    op interface \
    ports { add55_9224_out { O 64 vector } add55_9224_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_8223_out \
    op interface \
    ports { add55_8223_out { O 64 vector } add55_8223_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_7222_out \
    op interface \
    ports { add55_7222_out { O 64 vector } add55_7222_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_6221_out \
    op interface \
    ports { add55_6221_out { O 64 vector } add55_6221_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_5220_out \
    op interface \
    ports { add55_5220_out { O 64 vector } add55_5220_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_4219_out \
    op interface \
    ports { add55_4219_out { O 64 vector } add55_4219_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_3218_out \
    op interface \
    ports { add55_3218_out { O 64 vector } add55_3218_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_2217_out \
    op interface \
    ports { add55_2217_out { O 64 vector } add55_2217_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_1216_out \
    op interface \
    ports { add55_1216_out { O 64 vector } add55_1216_out_ap_vld { O 1 bit } } \
} "
}
