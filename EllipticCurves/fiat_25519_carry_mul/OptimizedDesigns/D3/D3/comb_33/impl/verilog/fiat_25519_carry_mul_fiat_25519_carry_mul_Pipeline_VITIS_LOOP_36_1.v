...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_9224_out,
        add55_9224_out_ap_vld,
        add55_8223_out,
        add55_8223_out_ap_vld,
        add55_7222_out,
        add55_7222_out_ap_vld,
        add55_6221_out,
        add55_6221_out_ap_vld,
        add55_5220_out,
        add55_5220_out_ap_vld,
        add55_4219_out,
        add55_4219_out_ap_vld,
        add55_3218_out,
        add55_3218_out_ap_vld,
        add55_2217_out,
        add55_2217_out_ap_vld,
        add55_1216_out,
        add55_1216_out_ap_vld
);
...
output  [63:0] add55_9224_out;
output   add55_9224_out_ap_vld;
output  [63:0] add55_8223_out;
output   add55_8223_out_ap_vld;
output  [63:0] add55_7222_out;
output   add55_7222_out_ap_vld;
output  [63:0] add55_6221_out;
output   add55_6221_out_ap_vld;
output  [63:0] add55_5220_out;
output   add55_5220_out_ap_vld;
output  [63:0] add55_4219_out;
output   add55_4219_out_ap_vld;
output  [63:0] add55_3218_out;
output   add55_3218_out_ap_vld;
output  [63:0] add55_2217_out;
output   add55_2217_out_ap_vld;
output  [63:0] add55_1216_out;
output   add55_1216_out_ap_vld;

reg ap_idle;
reg add55_9224_out_ap_vld;
reg add55_8223_out_ap_vld;
reg add55_7222_out_ap_vld;
reg add55_6221_out_ap_vld;
reg add55_5220_out_ap_vld;
reg add55_4219_out_ap_vld;
reg add55_3218_out_ap_vld;
reg add55_2217_out_ap_vld;
reg add55_1216_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1216_out_ap_vld = 1'b1;
    end else begin
        add55_1216_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2217_out_ap_vld = 1'b1;
    end else begin
        add55_2217_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4219_out_ap_vld = 1'b1;
    end else begin
        add55_4219_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_5220_out_ap_vld = 1'b1;
    end else begin
        add55_5220_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_6221_out_ap_vld = 1'b1;
    end else begin
        add55_6221_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_7222_out_ap_vld = 1'b1;
    end else begin
        add55_7222_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_8223_out_ap_vld = 1'b1;
    end else begin
        add55_8223_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_9224_out_ap_vld = 1'b1;
    end else begin
        add55_9224_out_ap_vld = 1'b0;
    end
end
...
assign add55_1216_out = add55_1216_fu_122;

assign add55_2217_out = add55_2217_fu_126;

assign add55_3218_out = add55_3218_fu_130;

assign add55_4219_out = add55_4219_fu_134;

assign add55_5220_out = add55_5220_fu_138;

assign add55_6221_out = add55_6221_fu_142;

assign add55_7222_out = add55_7222_fu_146;

assign add55_8223_out = add55_8223_fu_150;

assign add55_9224_out = add55_9224_fu_154;

assign add_ln36_fu_814_p2 = ($signed(ap_sig_allocacmp_i1_1) + $signed(4'd15));

assign add_ln49_1_fu_931_p2 = (and_ln49_1_fu_925_p2 + add55_2217_fu_126);

assign add_ln49_2_fu_966_p2 = (and_ln49_2_fu_960_p2 + add55_3218_fu_130);

assign add_ln49_3_fu_1001_p2 = (and_ln49_3_fu_995_p2 + add55_4219_fu_134);

assign add_ln49_4_fu_1036_p2 = (and_ln49_4_fu_1030_p2 + add55_5220_fu_138);

assign add_ln49_5_fu_1071_p2 = (and_ln49_5_fu_1065_p2 + add55_6221_fu_142);

assign add_ln49_6_fu_1107_p2 = (and_ln49_6_fu_1101_p2 + add55_7222_fu_146);

assign add_ln49_7_fu_1143_p2 = (and_ln49_7_fu_1137_p2 + add55_8223_fu_150);

assign add_ln49_8_fu_1153_p2 = (mul_ln49_17_fu_371_p2 + add55_9224_fu_154);

assign add_ln49_fu_896_p2 = (and_ln49_fu_890_p2 + add55_1216_fu_122);
