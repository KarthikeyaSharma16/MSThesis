...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_4_1116_out,
        add55_4_1116_out_ap_vld,
        add55_4115_out,
        add55_4115_out_ap_vld,
        add55_3_1114_out,
        add55_3_1114_out_ap_vld,
        add55_3113_out,
        add55_3113_out_ap_vld,
        add55_2_1112_out,
        add55_2_1112_out_ap_vld,
        add55_2111_out,
        add55_2111_out_ap_vld,
        add55_1_1110_out,
        add55_1_1110_out_ap_vld,
        add55_1109_out,
        add55_1109_out_ap_vld,
        add55_189108_out,
        add55_189108_out_ap_vld
);
...
output  [63:0] add55_4_1116_out;
output   add55_4_1116_out_ap_vld;
output  [63:0] add55_4115_out;
output   add55_4115_out_ap_vld;
output  [63:0] add55_3_1114_out;
output   add55_3_1114_out_ap_vld;
output  [63:0] add55_3113_out;
output   add55_3113_out_ap_vld;
output  [63:0] add55_2_1112_out;
output   add55_2_1112_out_ap_vld;
output  [63:0] add55_2111_out;
output   add55_2111_out_ap_vld;
output  [63:0] add55_1_1110_out;
output   add55_1_1110_out_ap_vld;
output  [63:0] add55_1109_out;
output   add55_1109_out_ap_vld;
output  [63:0] add55_189108_out;
output   add55_189108_out_ap_vld;

reg ap_idle;
reg add55_4_1116_out_ap_vld;
reg add55_4115_out_ap_vld;
reg add55_3_1114_out_ap_vld;
reg add55_3113_out_ap_vld;
reg add55_2_1112_out_ap_vld;
reg add55_2111_out_ap_vld;
reg add55_1_1110_out_ap_vld;
reg add55_1109_out_ap_vld;
reg add55_189108_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_189108_out_ap_vld = 1'b1;
    end else begin
        add55_189108_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2111_out_ap_vld = 1'b1;
    end else begin
        add55_2111_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_2_1112_out_ap_vld = 1'b1;
    end else begin
        add55_2_1112_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3113_out_ap_vld = 1'b1;
    end else begin
        add55_3113_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_3_1114_out_ap_vld = 1'b1;
    end else begin
        add55_3_1114_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4115_out_ap_vld = 1'b1;
    end else begin
        add55_4115_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4_1116_out_ap_vld = 1'b1;
    end else begin
        add55_4_1116_out_ap_vld = 1'b0;
    end
end
...
assign add55_1109_out = arr_10_fu_126;

assign add55_189108_out = arr_9_fu_122;

assign add55_1_1110_out = arr_11_fu_130;

assign add55_2111_out = arr_12_fu_134;

assign add55_2_1112_out = arr_13_fu_138;

assign add55_3113_out = arr_14_fu_142;

assign add55_3_1114_out = arr_15_fu_146;

assign add55_4115_out = arr_16_fu_150;

assign add55_4_1116_out = arr_17_fu_154;

assign add_ln36_fu_814_p2 = ($signed(ap_sig_allocacmp_i1_5) + $signed(4'd15));

assign add_ln49_3_fu_937_p2 = (i1_5_reg_1319 + 4'd3);

assign add_ln49_6_fu_1007_p2 = (i1_5_reg_1319 + 4'd5);
...
assign empty_23_fu_902_p2 = (i1_5_reg_1319 + 4'd2);

assign empty_24_fu_972_p2 = (i1_5_reg_1319 + 4'd4);

assign empty_25_fu_1042_p2 = (i1_5_reg_1319 + 4'd6);
