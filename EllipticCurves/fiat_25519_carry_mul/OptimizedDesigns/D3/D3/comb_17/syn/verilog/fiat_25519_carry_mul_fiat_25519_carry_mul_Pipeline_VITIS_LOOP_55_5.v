...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_9_reload,
        add120_9106_out,
        add120_9106_out_ap_vld,
        add120_8105_out,
        add120_8105_out_ap_vld,
        add120_7104_out,
        add120_7104_out_ap_vld,
        add120_6103_out,
        add120_6103_out_ap_vld,
        add120_5102_out,
        add120_5102_out_ap_vld,
        add120_474101_out,
        add120_474101_out_ap_vld,
        add120_358100_out,
        add120_358100_out_ap_vld,
        add120_24299_out,
        add120_24299_out_ap_vld,
        add120_12698_out,
        add120_12698_out_ap_vld,
        add12097_out,
        add12097_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_189108_reload;
input  [63:0] add55_1109_reload;
input  [63:0] add55_1_1110_reload;
input  [63:0] add55_2111_reload;
input  [63:0] add55_2_1112_reload;
input  [63:0] add55_3113_reload;
input  [63:0] add55_3_1114_reload;
input  [63:0] add55_4115_reload;
input  [63:0] add55_4_1116_reload;
...
output  [63:0] add120_9106_out;
output   add120_9106_out_ap_vld;
output  [63:0] add120_8105_out;
output   add120_8105_out_ap_vld;
output  [63:0] add120_7104_out;
output   add120_7104_out_ap_vld;
output  [63:0] add120_6103_out;
output   add120_6103_out_ap_vld;
output  [63:0] add120_5102_out;
output   add120_5102_out_ap_vld;
output  [63:0] add120_474101_out;
output   add120_474101_out_ap_vld;
output  [63:0] add120_358100_out;
output   add120_358100_out_ap_vld;
output  [63:0] add120_24299_out;
output   add120_24299_out_ap_vld;
output  [63:0] add120_12698_out;
output   add120_12698_out_ap_vld;
output  [63:0] add12097_out;
output   add12097_out_ap_vld;

reg ap_idle;
reg add120_9106_out_ap_vld;
reg add120_8105_out_ap_vld;
reg add120_7104_out_ap_vld;
reg add120_6103_out_ap_vld;
reg add120_5102_out_ap_vld;
reg add120_474101_out_ap_vld;
reg add120_358100_out_ap_vld;
reg add120_24299_out_ap_vld;
reg add120_12698_out_ap_vld;
reg add12097_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add12097_out_ap_vld = 1'b1;
    end else begin
        add12097_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_12698_out_ap_vld = 1'b1;
    end else begin
        add120_12698_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_24299_out_ap_vld = 1'b1;
    end else begin
        add120_24299_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_358100_out_ap_vld = 1'b1;
    end else begin
        add120_358100_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_474101_out_ap_vld = 1'b1;
    end else begin
        add120_474101_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_5102_out_ap_vld = 1'b1;
    end else begin
        add120_5102_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_6103_out_ap_vld = 1'b1;
    end else begin
        add120_6103_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_7104_out_ap_vld = 1'b1;
    end else begin
        add120_7104_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_8105_out_ap_vld = 1'b1;
    end else begin
        add120_8105_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_693_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_9106_out_ap_vld = 1'b1;
    end else begin
        add120_9106_out_ap_vld = 1'b0;
    end
end
...
assign add12097_out = add12097_fu_172;

assign add120_12698_out = add120_12698_fu_176;

assign add120_24299_out = add120_24299_fu_180;

assign add120_358100_out = add120_358100_fu_184;

assign add120_474101_out = add120_474101_fu_188;

assign add120_5102_out = add120_5102_fu_192;

assign add120_6103_out = add120_6103_fu_196;

assign add120_7104_out = add120_7104_fu_200;

assign add120_8105_out = add120_8105_fu_204;

assign add120_9106_out = add120_9106_fu_208;

assign add_ln55_fu_1765_p2 = ($signed(i1_1_fu_212) + $signed(5'd27));

assign add_ln68_10_fu_1411_p2 = (add120_24299_fu_180 + add_ln68_9_fu_1405_p2);
...
assign add_ln68_14_fu_1467_p2 = (add120_358100_fu_184 + add_ln68_13_fu_1461_p2);
...
assign add_ln68_19_fu_1835_p2 = (add_ln68_18_fu_1831_p2 + add120_474101_fu_188);
...
assign add_ln68_24_fu_1577_p2 = (add120_5102_fu_192 + add_ln68_23_fu_1571_p2);
...
assign add_ln68_29_fu_1845_p2 = (add120_6103_fu_196 + add_ln68_28_fu_1841_p2);
...
assign add_ln68_34_fu_1655_p2 = (add120_7104_fu_200 + add_ln68_33_fu_1649_p2);
...
assign add_ln68_39_fu_1855_p2 = (add120_8105_fu_204 + add_ln68_38_fu_1851_p2);
...
assign add_ln68_44_fu_1759_p2 = (add120_9106_fu_208 + add_ln68_43_fu_1753_p2);

assign add_ln68_4_fu_922_p2 = (i1_1_fu_212 + 5'd1);

assign add_ln68_5_fu_1335_p2 = (and_ln68_fu_1329_p2 + add12097_fu_172);

assign add_ln68_6_fu_1361_p2 = (and_ln68_2_fu_1355_p2 + and_ln68_1_fu_1341_p2);

assign add_ln68_7_fu_1367_p2 = (add120_12698_fu_176 + add_ln68_6_fu_1361_p2);
