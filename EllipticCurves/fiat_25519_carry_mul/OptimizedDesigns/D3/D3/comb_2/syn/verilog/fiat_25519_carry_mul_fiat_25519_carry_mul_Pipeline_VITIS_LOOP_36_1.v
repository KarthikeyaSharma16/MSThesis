...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_36_1 (
        ...
        arg2_r_2_reload,
        add55_1_4206_out,
        add55_1_4206_out_ap_vld,
        add55_1_3205_out,
        add55_1_3205_out_ap_vld,
        add55_1_2204_out,
        add55_1_2204_out_ap_vld,
        add55_1_1203_out,
        add55_1_1203_out_ap_vld,
        add55_1202_out,
        add55_1202_out_ap_vld,
        add55_4201_out,
        add55_4201_out_ap_vld,
        add55_3200_out,
        add55_3200_out_ap_vld,
        add55_2199_out,
        add55_2199_out_ap_vld,
        add55_1177198_out,
        add55_1177198_out_ap_vld
);
...
output  [63:0] add55_1_4206_out;
output   add55_1_4206_out_ap_vld;
output  [63:0] add55_1_3205_out;
output   add55_1_3205_out_ap_vld;
output  [63:0] add55_1_2204_out;
output   add55_1_2204_out_ap_vld;
output  [63:0] add55_1_1203_out;
output   add55_1_1203_out_ap_vld;
output  [63:0] add55_1202_out;
output   add55_1202_out_ap_vld;
output  [63:0] add55_4201_out;
output   add55_4201_out_ap_vld;
output  [63:0] add55_3200_out;
output   add55_3200_out_ap_vld;
output  [63:0] add55_2199_out;
output   add55_2199_out_ap_vld;
output  [63:0] add55_1177198_out;
output   add55_1177198_out_ap_vld;

reg ap_idle;
reg add55_1_4206_out_ap_vld;
reg add55_1_3205_out_ap_vld;
reg add55_1_2204_out_ap_vld;
reg add55_1_1203_out_ap_vld;
reg add55_1202_out_ap_vld;
reg add55_4201_out_ap_vld;
reg add55_3200_out_ap_vld;
reg add55_2199_out_ap_vld;
reg add55_1177198_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1177198_out_ap_vld = 1'b1;
    end else begin
        add55_1177198_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1202_out_ap_vld = 1'b1;
    end else begin
        add55_1202_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_1203_out_ap_vld = 1'b1;
    end else begin
        add55_1_1203_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_2204_out_ap_vld = 1'b1;
    end else begin
        add55_1_2204_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_3205_out_ap_vld = 1'b1;
    end else begin
        add55_1_3205_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_1_4206_out_ap_vld = 1'b1;
    end else begin
        add55_1_4206_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln36_fu_468_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add55_4201_out_ap_vld = 1'b1;
    end else begin
        add55_4201_out_ap_vld = 1'b0;
    end
end
...
assign add55_1177198_out = arr_9_fu_122;

assign add55_1202_out = arr_13_fu_138;

assign add55_1_1203_out = arr_14_fu_142;

assign add55_1_2204_out = arr_15_fu_146;

assign add55_1_3205_out = arr_16_fu_150;

assign add55_1_4206_out = arr_17_fu_154;

assign add55_2199_out = arr_10_fu_126;

assign add55_3200_out = arr_11_fu_130;

assign add55_4201_out = arr_12_fu_134;
