...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_933_out \
    op interface \
    ports { add55_933_out { O 64 vector } add55_933_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_832_out \
    op interface \
    ports { add55_832_out { O 64 vector } add55_832_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_731_out \
    op interface \
    ports { add55_731_out { O 64 vector } add55_731_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_630_out \
    op interface \
    ports { add55_630_out { O 64 vector } add55_630_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_529_out \
    op interface \
    ports { add55_529_out { O 64 vector } add55_529_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_428_out \
    op interface \
    ports { add55_428_out { O 64 vector } add55_428_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_327_out \
    op interface \
    ports { add55_327_out { O 64 vector } add55_327_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_226_out \
    op interface \
    ports { add55_226_out { O 64 vector } add55_226_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add55_125_out \
    op interface \
    ports { add55_125_out { O 64 vector } add55_125_out_ap_vld { O 1 bit } } \
} "
}
