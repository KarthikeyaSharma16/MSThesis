...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        arg2_r_6_reload,
        add120_923_out,
        add120_923_out_ap_vld,
        add120_822_out,
        add120_822_out_ap_vld,
        add120_721_out,
        add120_721_out_ap_vld,
        add120_620_out,
        add120_620_out_ap_vld,
        add120_519_out,
        add120_519_out_ap_vld,
        add120_418_out,
        add120_418_out_ap_vld,
        add120_317_out,
        add120_317_out_ap_vld,
        add120_216_out,
        add120_216_out_ap_vld,
        add120_115_out,
        add120_115_out_ap_vld,
        add12014_out,
        add12014_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_125_reload;
input  [63:0] add55_226_reload;
input  [63:0] add55_327_reload;
input  [63:0] add55_428_reload;
input  [63:0] add55_529_reload;
input  [63:0] add55_630_reload;
input  [63:0] add55_731_reload;
input  [63:0] add55_832_reload;
input  [63:0] add55_933_reload;
...
output  [63:0] add120_923_out;
output   add120_923_out_ap_vld;
output  [63:0] add120_822_out;
output   add120_822_out_ap_vld;
output  [63:0] add120_721_out;
output   add120_721_out_ap_vld;
output  [63:0] add120_620_out;
output   add120_620_out_ap_vld;
output  [63:0] add120_519_out;
output   add120_519_out_ap_vld;
output  [63:0] add120_418_out;
output   add120_418_out_ap_vld;
output  [63:0] add120_317_out;
output   add120_317_out_ap_vld;
output  [63:0] add120_216_out;
output   add120_216_out_ap_vld;
output  [63:0] add120_115_out;
output   add120_115_out_ap_vld;
output  [63:0] add12014_out;
output   add12014_out_ap_vld;

reg ap_idle;
reg add120_923_out_ap_vld;
reg add120_822_out_ap_vld;
reg add120_721_out_ap_vld;
reg add120_620_out_ap_vld;
reg add120_519_out_ap_vld;
reg add120_418_out_ap_vld;
reg add120_317_out_ap_vld;
reg add120_216_out_ap_vld;
reg add120_115_out_ap_vld;
reg add12014_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add12014_out_ap_vld = 1'b1;
    end else begin
        add12014_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_115_out_ap_vld = 1'b1;
    end else begin
        add120_115_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_216_out_ap_vld = 1'b1;
    end else begin
        add120_216_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_317_out_ap_vld = 1'b1;
    end else begin
        add120_317_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_418_out_ap_vld = 1'b1;
    end else begin
        add120_418_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_519_out_ap_vld = 1'b1;
    end else begin
        add120_519_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_620_out_ap_vld = 1'b1;
    end else begin
        add120_620_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_721_out_ap_vld = 1'b1;
    end else begin
        add120_721_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_822_out_ap_vld = 1'b1;
    end else begin
        add120_822_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_923_out_ap_vld = 1'b1;
    end else begin
        add120_923_out_ap_vld = 1'b0;
    end
end
...
assign add12014_out = add12014_fu_166;

assign add120_115_out = add120_115_fu_170;

assign add120_216_out = add120_216_fu_174;

assign add120_317_out = add120_317_fu_178;

assign add120_418_out = add120_418_fu_182;

assign add120_519_out = add120_519_fu_186;

assign add120_620_out = add120_620_fu_190;

assign add120_721_out = add120_721_fu_194;

assign add120_822_out = add120_822_fu_198;

assign add120_923_out = add120_923_fu_202;

assign add_ln55_fu_1267_p2 = ($signed(i1_fu_206) + $signed(5'd31));

assign add_ln68_10_fu_1029_p2 = (and_ln68_5_fu_1023_p2 + add120_519_fu_186);

assign add_ln68_11_fu_1035_p2 = (i1_fu_206 + 5'd3);

assign add_ln68_12_fu_1099_p2 = (and_ln68_6_fu_1093_p2 + add120_620_fu_190);

assign add_ln68_13_fu_1105_p2 = (i1_fu_206 + 5'd2);

assign add_ln68_14_fu_1156_p2 = (and_ln68_7_fu_1150_p2 + add120_721_fu_194);

assign add_ln68_15_fu_1162_p2 = (i1_fu_206 + 5'd1);

assign add_ln68_16_fu_1228_p2 = (and_ln68_8_fu_1222_p2 + add120_822_fu_198);

assign add_ln68_17_fu_1261_p2 = (mul_ln68_9_fu_490_p2 + add120_923_fu_202);

assign add_ln68_1_fu_715_p2 = (i1_fu_206 + 5'd8);

assign add_ln68_2_fu_774_p2 = (and_ln68_1_fu_768_p2 + add120_115_fu_170);

assign add_ln68_3_fu_780_p2 = (i1_fu_206 + 5'd7);

assign add_ln68_4_fu_853_p2 = (and_ln68_2_fu_847_p2 + add120_216_fu_174);

assign add_ln68_5_fu_859_p2 = (i1_fu_206 + 5'd6);

assign add_ln68_6_fu_906_p2 = (and_ln68_3_fu_900_p2 + add120_317_fu_178);

assign add_ln68_7_fu_912_p2 = (i1_fu_206 + 5'd5);

assign add_ln68_8_fu_974_p2 = (and_ln68_4_fu_968_p2 + add120_418_fu_182);

assign add_ln68_9_fu_980_p2 = (i1_fu_206 + 5'd4);

assign add_ln68_fu_709_p2 = (and_ln68_fu_703_p2 + add12014_fu_166);
