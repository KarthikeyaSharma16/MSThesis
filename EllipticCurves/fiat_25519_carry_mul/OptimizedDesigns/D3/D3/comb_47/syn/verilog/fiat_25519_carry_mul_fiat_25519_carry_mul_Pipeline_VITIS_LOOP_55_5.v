...
module fiat_25519_carry_mul_fiat_25519_carry_mul_Pipeline_VITIS_LOOP_55_5 (
        ...
        ap_idle,
        ap_ready,
        add55_1131150_reload,
        add55_1151_reload,
        add55_1_170152_reload,
        add55_2153_reload,
        add55_2_155154_reload,
        add55_3155_reload,
        add55_3_140156_reload,
        add55_4157_reload,
        add55_4_125158_reload,
        arg1_r_reload,
        arg1_r_1_reload,
        arg1_r_2_reload,
        arg1_r_3_reload,
        ...
        arg2_r_6_reload,
        add120_9148_out,
        add120_9148_out_ap_vld,
        add120_8147_out,
        add120_8147_out_ap_vld,
        add120_7146_out,
        add120_7146_out_ap_vld,
        add120_6145_out,
        add120_6145_out_ap_vld,
        add120_5144_out,
        add120_5144_out_ap_vld,
        add120_4143_out,
        add120_4143_out_ap_vld,
        add120_3142_out,
        add120_3142_out_ap_vld,
        add120_2141_out,
        add120_2141_out_ap_vld,
        add120_1140_out,
        add120_1140_out_ap_vld,
        add120139_out,
        add120139_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [63:0] add55_1131150_reload;
input  [63:0] add55_1151_reload;
input  [63:0] add55_1_170152_reload;
input  [63:0] add55_2153_reload;
input  [63:0] add55_2_155154_reload;
input  [63:0] add55_3155_reload;
input  [63:0] add55_3_140156_reload;
input  [63:0] add55_4157_reload;
input  [63:0] add55_4_125158_reload;
...
output  [63:0] add120_9148_out;
output   add120_9148_out_ap_vld;
output  [63:0] add120_8147_out;
output   add120_8147_out_ap_vld;
output  [63:0] add120_7146_out;
output   add120_7146_out_ap_vld;
output  [63:0] add120_6145_out;
output   add120_6145_out_ap_vld;
output  [63:0] add120_5144_out;
output   add120_5144_out_ap_vld;
output  [63:0] add120_4143_out;
output   add120_4143_out_ap_vld;
output  [63:0] add120_3142_out;
output   add120_3142_out_ap_vld;
output  [63:0] add120_2141_out;
output   add120_2141_out_ap_vld;
output  [63:0] add120_1140_out;
output   add120_1140_out_ap_vld;
output  [63:0] add120139_out;
output   add120139_out_ap_vld;

reg ap_idle;
reg add120_9148_out_ap_vld;
reg add120_8147_out_ap_vld;
reg add120_7146_out_ap_vld;
reg add120_6145_out_ap_vld;
reg add120_5144_out_ap_vld;
reg add120_4143_out_ap_vld;
reg add120_3142_out_ap_vld;
reg add120_2141_out_ap_vld;
reg add120_1140_out_ap_vld;
reg add120139_out_ap_vld;
...
always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120139_out_ap_vld = 1'b1;
    end else begin
        add120139_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_1140_out_ap_vld = 1'b1;
    end else begin
        add120_1140_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_2141_out_ap_vld = 1'b1;
    end else begin
        add120_2141_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_3142_out_ap_vld = 1'b1;
    end else begin
        add120_3142_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_4143_out_ap_vld = 1'b1;
    end else begin
        add120_4143_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_5144_out_ap_vld = 1'b1;
    end else begin
        add120_5144_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_6145_out_ap_vld = 1'b1;
    end else begin
        add120_6145_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_7146_out_ap_vld = 1'b1;
    end else begin
        add120_7146_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_8147_out_ap_vld = 1'b1;
    end else begin
        add120_8147_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_552_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        add120_9148_out_ap_vld = 1'b1;
    end else begin
        add120_9148_out_ap_vld = 1'b0;
    end
end
...
assign add120139_out = add120139_fu_166;

assign add120_1140_out = add120_1140_fu_170;

assign add120_2141_out = add120_2141_fu_174;

assign add120_3142_out = add120_3142_fu_178;

assign add120_4143_out = add120_4143_fu_182;

assign add120_5144_out = add120_5144_fu_186;

assign add120_6145_out = add120_6145_fu_190;

assign add120_7146_out = add120_7146_fu_194;

assign add120_8147_out = add120_8147_fu_198;

assign add120_9148_out = add120_9148_fu_202;

assign add_ln55_fu_1267_p2 = ($signed(i1_fu_206) + $signed(5'd31));

assign add_ln68_10_fu_1029_p2 = (and_ln68_5_fu_1023_p2 + add120_5144_fu_186);

assign add_ln68_11_fu_1035_p2 = (i1_fu_206 + 5'd3);

assign add_ln68_12_fu_1099_p2 = (and_ln68_6_fu_1093_p2 + add120_6145_fu_190);

assign add_ln68_13_fu_1105_p2 = (i1_fu_206 + 5'd2);

assign add_ln68_14_fu_1156_p2 = (and_ln68_7_fu_1150_p2 + add120_7146_fu_194);

assign add_ln68_15_fu_1162_p2 = (i1_fu_206 + 5'd1);

assign add_ln68_16_fu_1228_p2 = (and_ln68_8_fu_1222_p2 + add120_8147_fu_198);

assign add_ln68_17_fu_1261_p2 = (mul_ln68_9_fu_490_p2 + add120_9148_fu_202);

assign add_ln68_1_fu_715_p2 = (i1_fu_206 + 5'd8);

assign add_ln68_2_fu_774_p2 = (and_ln68_1_fu_768_p2 + add120_1140_fu_170);

assign add_ln68_3_fu_780_p2 = (i1_fu_206 + 5'd7);

assign add_ln68_4_fu_853_p2 = (and_ln68_2_fu_847_p2 + add120_2141_fu_174);

assign add_ln68_5_fu_859_p2 = (i1_fu_206 + 5'd6);

assign add_ln68_6_fu_906_p2 = (and_ln68_3_fu_900_p2 + add120_3142_fu_178);

assign add_ln68_7_fu_912_p2 = (i1_fu_206 + 5'd5);

assign add_ln68_8_fu_974_p2 = (and_ln68_4_fu_968_p2 + add120_4143_fu_182);

assign add_ln68_9_fu_980_p2 = (i1_fu_206 + 5'd4);

assign add_ln68_fu_709_p2 = (and_ln68_fu_703_p2 + add120139_fu_166);
